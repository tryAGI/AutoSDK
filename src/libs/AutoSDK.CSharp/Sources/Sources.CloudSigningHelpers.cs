...
{
    private static string GetCloudSigningHelperClassName(
        CSharpSettings settings)
    {
        var configuredClassName = settings.CloudSigningHelperClassName;
        if (string.IsNullOrWhiteSpace(configuredClassName))
        {
            configuredClassName = "CloudRequestSigner";
        }
    ...
    public static string GenerateCloudSigningHelpers(
        CSharpSettings settings,
        string className,
