...
{{
    ...
    {{
        ...
        /// </summary>
        public global::{settings.Namespace}.IAutoSDKAuthorizationProvider? AuthorizationProvider {{ get; set; }}
        ...
        public global::{settings.Namespace}.AutoSDKClientOptions UseAuthorizationProvider(
            global::{settings.Namespace}.IAutoSDKAuthorizationProvider provider)
        {{
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::{settings.Namespace}.AutoSDKAuthorizationProviderHook) == null)
            {{
                Hooks.Add(new global::{settings.Namespace}.AutoSDKAuthorizationProviderHook());
            }}
    ...
    {{
        ...
        public static global::{settings.Namespace}.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: ""Bearer"");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::{settings.Namespace}.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    {{
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::{settings.Namespace}.AutoSDKAuthorizationValue>?> ResolveAsync(
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::{settings.Namespace}.AutoSDKHook
    {{
        /// <inheritdoc />
        ...
        private static void ApplyAuthorization(
            ...
            global::{settings.Namespace}.AutoSDKAuthorizationValue authorization)
        {{
    ...
    {{
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::{settings.Namespace}.AutoSDKAuthorizationValue>? Authorizations {{ get; set; }}
    }}
