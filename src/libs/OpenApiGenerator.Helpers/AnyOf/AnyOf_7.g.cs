...
namespace AnyOfTypes
{
    ...
    public readonly struct AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh> : IEquatable<AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh>>
    {
