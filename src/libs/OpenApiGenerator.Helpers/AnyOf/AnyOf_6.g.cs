...
namespace AnyOfTypes
{
    ...
    public readonly struct AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> : IEquatable<AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>>
    {
        private readonly string _thisType => $"AnyOf<{typeof(TFirst).Name}, {typeof(TSecond).Name}, {typeof(TThird).Name}, {typeof(TFourth).Name}, {typeof(TFifth).Name}, {typeof(TSixth).Name}>";
        ...
        public static implicit operator AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(TFirst value) => new AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(value);

        public static implicit operator TFirst?(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> @this) => @this.First;
        ...
        public static implicit operator AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(TSecond value) => new AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(value);

        public static implicit operator TSecond?(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> @this) => @this.Second;
        ...
        public static implicit operator AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(TThird value) => new AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(value);

        public static implicit operator TThird?(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> @this) => @this.Third;
        ...
        public static implicit operator AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(TFourth value) => new AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(value);

        public static implicit operator TFourth?(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> @this) => @this.Fourth;
        ...
        public static implicit operator AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(TFifth value) => new AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(value);

        public static implicit operator TFifth?(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> @this) => @this.Fifth;
        ...
        public static implicit operator AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(TSixth value) => new AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>(value);

        public static implicit operator TSixth?(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> @this) => @this.Sixth;
        ...
        public bool Equals(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> other)
        {
        ...
        public static bool operator ==(AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> obj1, AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> obj2)
        {
            return EqualityComparer<AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth>>.Default.Equals(obj1, obj2);
        }
        ...
        {
            return obj is AnyOf<TFirst, TSecond, TThird, TFourth, TFifth, TSixth> o && Equals(o);
        }
