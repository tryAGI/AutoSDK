...
[TestClass]
public class CliSystemNetHttpJsonTests
{
    [TestMethod]
    public async Task Generate_WithSystemNetHttpJsonFlag_UsesHttpJsonHelpers_AndBuilds()
    {
        const string spec = """
openapi: 3.0.3
info:
...
""";
        ...
        await GenerateFromContentAsync(
            fileName: "system-net-http-json.yaml",
            specContent: spec,
