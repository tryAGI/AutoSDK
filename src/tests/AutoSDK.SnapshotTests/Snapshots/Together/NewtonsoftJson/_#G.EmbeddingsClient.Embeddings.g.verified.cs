    ...
    public partial class EmbeddingsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::G.EmbeddingsResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                var __responseValue = await global::G.EmbeddingsResponse.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
