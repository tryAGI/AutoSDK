//HintName: G.ObjectsClient.ObjectsReferencesDelete.g.cs
...
namespace G
{
    public partial class ObjectsClient
    {
        ...
        partial void PrepareObjectsReferencesDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? tenant,
            global::G.SingleRef request);
        partial void ProcessObjectsReferencesDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        {
            await ObjectsReferencesDeleteAsResponseAsync(
                id: id,
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> ObjectsReferencesDeleteAsResponseAsync(
            global::System.Guid id,
            string propertyName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareObjectsReferencesDeleteArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareObjectsReferencesDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ObjectsReferencesDelete",
                                methodName: "ObjectsReferencesDeleteAsync",
                                pathTemplate: "$\"/objects/{id}/references/{propertyName}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessObjectsReferencesDeleteResponse(
                    httpClient: HttpClient,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await ObjectsReferencesDeleteAsync(
                id: id,
                propertyName: propertyName,
                tenant: tenant,
                request: __request,
