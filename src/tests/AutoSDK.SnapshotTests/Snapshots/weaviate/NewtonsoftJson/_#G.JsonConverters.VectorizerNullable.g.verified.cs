...
{
    /// <inheritdoc />
    public sealed class VectorizerNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.Vectorizer?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VectorizerExtensions.ToValueString(value.Value));
            }
        }
    }
}
