...
{
    /// <inheritdoc />
    public sealed class ObjectsPatchConsistencyLevelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ObjectsPatchConsistencyLevel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ObjectsPatchConsistencyLevelExtensions.ToValueString(value));
        }
    }
}
