...
{
    /// <inheritdoc />
    public sealed class OpenAIFilePurposeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAIFilePurpose>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OpenAIFilePurposeExtensions.ToValueString(value));
        }
    }
}
