...
{
    /// <inheritdoc />
    public sealed class ComputerToolCallOutputStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ComputerToolCallOutputStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ComputerToolCallOutputStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
