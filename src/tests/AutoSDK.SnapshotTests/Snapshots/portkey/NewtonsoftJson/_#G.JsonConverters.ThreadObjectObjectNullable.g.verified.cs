...
{
    /// <inheritdoc />
    public sealed class ThreadObjectObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ThreadObjectObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ThreadObjectObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
