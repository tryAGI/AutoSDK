...
{
    /// <inheritdoc />
    public sealed class WorkspaceMemberRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WorkspaceMemberRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WorkspaceMemberRoleExtensions.ToValueString(value));
        }
    }
}
