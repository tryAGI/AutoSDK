...
namespace G
{
    ...
    public sealed partial class ModelPayAsYouGo
    {
        ...
        /// Price object (value is in USD cents)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("cache_write_input_token")]
        public global::G.ModelTokenPrice? CacheWriteInputToken { get; set; }

        /// <summary>
        /// Price object (value is in USD cents)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("cache_read_input_token")]
        public global::G.ModelTokenPrice? CacheReadInputToken { get; set; }

        /// <summary>
        /// Price object (value is in USD cents)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("request_audio_token")]
        public global::G.ModelTokenPrice? RequestAudioToken { get; set; }

        /// <summary>
        /// Price object (value is in USD cents)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("response_audio_token")]
        public global::G.ModelTokenPrice? ResponseAudioToken { get; set; }

        /// <summary>
        /// Price object (value is in USD cents)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("cache_read_audio_input_token")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("additional_units")]
