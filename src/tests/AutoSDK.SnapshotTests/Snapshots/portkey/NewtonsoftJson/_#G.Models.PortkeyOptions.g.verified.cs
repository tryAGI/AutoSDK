...
namespace G
{
    ...
    public sealed partial class PortkeyOptions
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("x-portkey-virtual-key", Required = global::Newtonsoft.Json.Required.Always)]
        public string XPortkeyVirtualKey { get; set; } = default!;

        /// <summary>
        /// The AWS S3 bucket to use for file upload during finetune
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("x-portkey-aws-s3-bucket")]
        public string? XPortkeyAwsS3Bucket { get; set; }

        /// <summary>
        /// Google Storage bucket to use for file upload during finetune
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("x-portkey-vertex-storage-bucket-name")]
