...
{
    /// <inheritdoc />
    public sealed class ChatCompletionMessageContentPartRedactedThinkingTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionMessageContentPartRedactedThinkingType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatCompletionMessageContentPartRedactedThinkingTypeExtensions.ToValueString(value));
        }
    }
}
