...
{
    /// <inheritdoc />
    public sealed class ResponseFunctionCallArgumentsDeltaEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseFunctionCallArgumentsDeltaEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseFunctionCallArgumentsDeltaEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
