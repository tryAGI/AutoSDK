...
{
    /// <inheritdoc />
    public sealed class WorkspaceMemberOrgRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WorkspaceMemberOrgRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WorkspaceMemberOrgRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
