...
{
    /// <inheritdoc />
    public sealed class GetIntegrationsTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetIntegrationsType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetIntegrationsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
