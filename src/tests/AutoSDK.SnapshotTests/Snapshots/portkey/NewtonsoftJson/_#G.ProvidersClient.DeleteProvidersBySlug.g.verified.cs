...
namespace G
{
    public partial class ProvidersClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_DeleteProvidersBySlugServers = new global::G.AutoSDKServer[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> DeleteProvidersBySlugAsResponseAsync(
            string slug,
            string? workspaceId = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
