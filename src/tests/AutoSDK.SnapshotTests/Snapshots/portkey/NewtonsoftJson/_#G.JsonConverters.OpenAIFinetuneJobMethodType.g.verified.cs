...
{
    /// <inheritdoc />
    public sealed class OpenAIFinetuneJobMethodTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAIFinetuneJobMethodType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OpenAIFinetuneJobMethodTypeExtensions.ToValueString(value));
        }
    }
}
