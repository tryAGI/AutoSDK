...
{
    /// <inheritdoc />
    public sealed class MessageDeltaContentImageUrlObjectImageUrlDetailNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MessageDeltaContentImageUrlObjectImageUrlDetail?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MessageDeltaContentImageUrlObjectImageUrlDetailExtensions.ToValueString(value.Value));
            }
        }
    }
}
