...
{
    /// <inheritdoc />
    public sealed class SecretReferenceListItemStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SecretReferenceListItemStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SecretReferenceListItemStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
