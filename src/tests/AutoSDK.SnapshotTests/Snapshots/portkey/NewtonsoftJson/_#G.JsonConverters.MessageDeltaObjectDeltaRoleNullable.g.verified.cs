...
{
    /// <inheritdoc />
    public sealed class MessageDeltaObjectDeltaRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MessageDeltaObjectDeltaRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MessageDeltaObjectDeltaRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
