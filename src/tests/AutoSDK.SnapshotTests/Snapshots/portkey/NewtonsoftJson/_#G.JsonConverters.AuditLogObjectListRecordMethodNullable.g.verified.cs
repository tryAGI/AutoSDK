...
{
    /// <inheritdoc />
    public sealed class AuditLogObjectListRecordMethodNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AuditLogObjectListRecordMethod?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AuditLogObjectListRecordMethodExtensions.ToValueString(value.Value));
            }
        }
    }
}
