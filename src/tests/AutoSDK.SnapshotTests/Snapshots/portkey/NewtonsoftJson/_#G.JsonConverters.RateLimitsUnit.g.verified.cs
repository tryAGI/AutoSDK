...
{
    /// <inheritdoc />
    public sealed class RateLimitsUnitJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RateLimitsUnit>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RateLimitsUnitExtensions.ToValueString(value));
        }
    }
}
