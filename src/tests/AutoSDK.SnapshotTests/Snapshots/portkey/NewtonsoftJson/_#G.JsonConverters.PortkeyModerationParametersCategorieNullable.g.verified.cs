...
{
    /// <inheritdoc />
    public sealed class PortkeyModerationParametersCategorieNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PortkeyModerationParametersCategorie?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PortkeyModerationParametersCategorieExtensions.ToValueString(value.Value));
            }
        }
    }
}
