...
{
    /// <inheritdoc />
    public sealed class GetAdminUsersRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAdminUsersRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetAdminUsersRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
