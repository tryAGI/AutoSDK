...
{
    /// <inheritdoc />
    public sealed class CreateSpeechRequestModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateSpeechRequestModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateSpeechRequestModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
