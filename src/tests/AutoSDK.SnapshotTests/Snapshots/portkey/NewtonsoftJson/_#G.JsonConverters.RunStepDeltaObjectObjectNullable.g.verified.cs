...
{
    /// <inheritdoc />
    public sealed class RunStepDeltaObjectObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RunStepDeltaObjectObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RunStepDeltaObjectObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
