...
{
    /// <inheritdoc />
    public sealed class AwsAssumedRoleAuthConfigAwsAuthTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AwsAssumedRoleAuthConfigAwsAuthType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AwsAssumedRoleAuthConfigAwsAuthTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
