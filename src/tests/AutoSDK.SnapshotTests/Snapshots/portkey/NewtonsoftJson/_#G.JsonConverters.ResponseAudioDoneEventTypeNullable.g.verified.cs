...
{
    /// <inheritdoc />
    public sealed class ResponseAudioDoneEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseAudioDoneEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseAudioDoneEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
