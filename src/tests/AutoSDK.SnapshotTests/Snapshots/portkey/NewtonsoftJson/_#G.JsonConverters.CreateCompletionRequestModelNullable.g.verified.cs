...
{
    /// <inheritdoc />
    public sealed class CreateCompletionRequestModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateCompletionRequestModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateCompletionRequestModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
