...
{
    /// <inheritdoc />
    public sealed class ResponseCodeInterpreterCallInterpretingEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseCodeInterpreterCallInterpretingEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseCodeInterpreterCallInterpretingEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
