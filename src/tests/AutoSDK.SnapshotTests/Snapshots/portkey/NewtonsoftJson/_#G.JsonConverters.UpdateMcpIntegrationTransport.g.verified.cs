...
{
    /// <inheritdoc />
    public sealed class UpdateMcpIntegrationTransportJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateMcpIntegrationTransport>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.UpdateMcpIntegrationTransportExtensions.ToValueString(value));
        }
    }
}
