...
{
    /// <inheritdoc />
    public sealed class AzureDefaultAuthConfigAzureAuthModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AzureDefaultAuthConfigAzureAuthMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AzureDefaultAuthConfigAzureAuthModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
