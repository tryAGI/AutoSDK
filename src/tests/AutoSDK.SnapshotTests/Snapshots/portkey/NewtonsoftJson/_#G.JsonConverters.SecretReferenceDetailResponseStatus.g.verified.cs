...
{
    /// <inheritdoc />
    public sealed class SecretReferenceDetailResponseStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SecretReferenceDetailResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SecretReferenceDetailResponseStatusExtensions.ToValueString(value));
        }
    }
}
