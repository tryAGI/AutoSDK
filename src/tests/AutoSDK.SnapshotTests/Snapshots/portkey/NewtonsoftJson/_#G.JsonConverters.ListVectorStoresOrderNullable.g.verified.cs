...
{
    /// <inheritdoc />
    public sealed class ListVectorStoresOrderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListVectorStoresOrder?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListVectorStoresOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
