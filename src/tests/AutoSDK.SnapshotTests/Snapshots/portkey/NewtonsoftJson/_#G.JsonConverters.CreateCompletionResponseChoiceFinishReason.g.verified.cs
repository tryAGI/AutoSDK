...
{
    /// <inheritdoc />
    public sealed class CreateCompletionResponseChoiceFinishReasonJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateCompletionResponseChoiceFinishReason>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateCompletionResponseChoiceFinishReasonExtensions.ToValueString(value));
        }
    }
}
