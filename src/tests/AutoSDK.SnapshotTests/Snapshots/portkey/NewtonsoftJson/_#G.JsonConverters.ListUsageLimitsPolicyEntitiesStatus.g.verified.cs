...
{
    /// <inheritdoc />
    public sealed class ListUsageLimitsPolicyEntitiesStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListUsageLimitsPolicyEntitiesStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ListUsageLimitsPolicyEntitiesStatusExtensions.ToValueString(value));
        }
    }
}
