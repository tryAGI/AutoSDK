...
{
    /// <inheritdoc />
    public sealed class PutAdminUsersRequestRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PutAdminUsersRequestRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PutAdminUsersRequestRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
