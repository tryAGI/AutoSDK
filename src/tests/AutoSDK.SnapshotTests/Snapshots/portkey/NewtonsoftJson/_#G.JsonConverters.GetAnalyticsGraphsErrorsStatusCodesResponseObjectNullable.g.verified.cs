...
{
    /// <inheritdoc />
    public sealed class GetAnalyticsGraphsErrorsStatusCodesResponseObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAnalyticsGraphsErrorsStatusCodesResponseObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetAnalyticsGraphsErrorsStatusCodesResponseObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
