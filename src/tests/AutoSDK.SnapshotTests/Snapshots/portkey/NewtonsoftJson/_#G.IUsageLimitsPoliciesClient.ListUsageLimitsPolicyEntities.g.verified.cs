...
namespace G
{
    public partial interface IUsageLimitsPoliciesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.UsageLimitsPolicyEntityListResponse>> ListUsageLimitsPolicyEntitiesAsResponseAsync(
            global::System.Guid policyUsageLimitsId,
            global::G.ListUsageLimitsPolicyEntitiesStatus? status = default,
            string? search = default,
            int? pageSize = default,
