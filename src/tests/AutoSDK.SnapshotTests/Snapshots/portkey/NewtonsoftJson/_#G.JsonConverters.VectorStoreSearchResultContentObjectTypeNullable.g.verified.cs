...
{
    /// <inheritdoc />
    public sealed class VectorStoreSearchResultContentObjectTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VectorStoreSearchResultContentObjectType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VectorStoreSearchResultContentObjectTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
