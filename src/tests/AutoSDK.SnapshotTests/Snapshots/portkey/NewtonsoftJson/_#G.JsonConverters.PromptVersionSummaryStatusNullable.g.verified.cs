...
{
    /// <inheritdoc />
    public sealed class PromptVersionSummaryStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PromptVersionSummaryStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PromptVersionSummaryStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
