...
{
    /// <inheritdoc />
    public sealed class EasyInputMessageRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EasyInputMessageRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EasyInputMessageRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
