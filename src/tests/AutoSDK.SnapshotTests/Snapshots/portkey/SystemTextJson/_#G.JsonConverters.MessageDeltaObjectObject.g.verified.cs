//HintName: G.JsonConverters.MessageDeltaObjectObject.g.cs
#nullable enable
...
namespace G.JsonConverters
{
    ...
    public sealed class MessageDeltaObjectObjectJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MessageDeltaObjectObject>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.MessageDeltaObjectObjectExtensions.ToEnum(stringValue) ?? default;
                    }
                ...
                {
                    return default(global::G.MessageDeltaObjectObject);
                }
                default:
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.MessageDeltaObjectObjectExtensions.ToValueString(value));
        }
    }
}
