...
namespace G.JsonConverters
{
    ...
    public class ModelIdsResponsesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModelIdsResponses>
    {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        @enum = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ModelIdsResponsesEnum>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsEnum)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Enum, typeof(global::G.ModelIdsResponsesEnum), options);
            }
        }
    }
}