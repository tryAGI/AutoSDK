...
{
    /// <inheritdoc />
    public sealed class AuditLogObjectListRecordUserTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AuditLogObjectListRecordUserType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AuditLogObjectListRecordUserTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
