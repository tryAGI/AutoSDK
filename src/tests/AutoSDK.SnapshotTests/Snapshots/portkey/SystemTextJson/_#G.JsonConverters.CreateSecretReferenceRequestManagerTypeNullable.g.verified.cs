...
{
    /// <inheritdoc />
    public sealed class CreateSecretReferenceRequestManagerTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateSecretReferenceRequestManagerType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateSecretReferenceRequestManagerTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
