...
{
    /// <inheritdoc />
    public sealed class AuditLogObjectListRecordMethodJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AuditLogObjectListRecordMethod>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AuditLogObjectListRecordMethodExtensions.ToValueString(value));
        }
    }
}
