...
{
    /// <inheritdoc />
    public sealed class PromptPartialVersionPromptVersionStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PromptPartialVersionPromptVersionStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PromptPartialVersionPromptVersionStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
