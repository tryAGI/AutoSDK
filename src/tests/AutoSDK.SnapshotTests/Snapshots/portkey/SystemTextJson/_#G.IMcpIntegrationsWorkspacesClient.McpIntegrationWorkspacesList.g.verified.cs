...
namespace G
{
    public partial interface IMcpIntegrationsWorkspacesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OneOf<global::G.McpIntegrationWorkspacesListResponse, global::G.McpIntegrationWorkspacesLegacyResponse>>> McpIntegrationWorkspacesListAsResponseAsync(
            string mcpIntegrationId,
            string? version = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
