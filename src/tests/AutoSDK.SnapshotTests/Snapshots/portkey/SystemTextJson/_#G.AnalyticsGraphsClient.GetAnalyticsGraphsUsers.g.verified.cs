//HintName: G.AnalyticsGraphsClient.GetAnalyticsGraphsUsers.g.cs
...
namespace G
{
    public partial class AnalyticsGraphsClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_GetAnalyticsGraphsUsersServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetAnalyticsGraphsUsersSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetAnalyticsGraphsUsersSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetAnalyticsGraphsUsersSecurityRequirement0,
            };
        partial void PrepareGetAnalyticsGraphsUsersArguments(
        ...
        partial void PrepareGetAnalyticsGraphsUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? spanId,
            string? promptSlug);
        partial void ProcessGetAnalyticsGraphsUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAnalyticsGraphsUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetAnalyticsGraphsUsersResponse> GetAnalyticsGraphsUsersAsync(
            string workspaceSlug,
            global::System.DateTime timeOfGenerationMin,
            global::System.DateTime timeOfGenerationMax,
        ...
        {
            var __response = await GetAnalyticsGraphsUsersAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetAnalyticsGraphsUsersResponse>> GetAnalyticsGraphsUsersAsResponseAsync(
            string workspaceSlug,
            global::System.DateTime timeOfGenerationMin,
            global::System.DateTime timeOfGenerationMax,
            int? totalUnitsMin = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAnalyticsGraphsUsersArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAnalyticsGraphsUsersSecurityRequirements,
                operationName: "GetAnalyticsGraphsUsersAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_GetAnalyticsGraphsUsersServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAnalyticsGraphsUsersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getAnalyticsGraphsUsers",
                                methodName: "GetAnalyticsGraphsUsersAsync",
                                pathTemplate: "\"/analytics/graphs/users\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAnalyticsGraphsUsersResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAnalyticsGraphsUsersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetAnalyticsGraphsUsersResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetAnalyticsGraphsUsersResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetAnalyticsGraphsUsersResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
