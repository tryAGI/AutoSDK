...
{
    /// <inheritdoc />
    public sealed class AzureContentSafetyParametersCategorieNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AzureContentSafetyParametersCategorie?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AzureContentSafetyParametersCategorieExtensions.ToValueString(value.Value));
            }
        }
    }
}
