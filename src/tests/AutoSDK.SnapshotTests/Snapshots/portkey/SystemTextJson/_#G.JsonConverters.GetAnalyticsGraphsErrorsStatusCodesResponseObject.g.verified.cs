...
{
    /// <inheritdoc />
    public sealed class GetAnalyticsGraphsErrorsStatusCodesResponseObjectJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAnalyticsGraphsErrorsStatusCodesResponseObject>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetAnalyticsGraphsErrorsStatusCodesResponseObjectExtensions.ToValueString(value));
        }
    }
}
