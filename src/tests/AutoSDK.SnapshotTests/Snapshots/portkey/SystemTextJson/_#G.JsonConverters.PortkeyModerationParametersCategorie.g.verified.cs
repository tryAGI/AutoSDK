...
{
    /// <inheritdoc />
    public sealed class PortkeyModerationParametersCategorieJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PortkeyModerationParametersCategorie>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PortkeyModerationParametersCategorieExtensions.ToValueString(value));
        }
    }
}
