...
{
    /// <inheritdoc />
    public sealed class PutAdminUsersRequestRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PutAdminUsersRequestRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PutAdminUsersRequestRoleExtensions.ToValueString(value));
        }
    }
}
