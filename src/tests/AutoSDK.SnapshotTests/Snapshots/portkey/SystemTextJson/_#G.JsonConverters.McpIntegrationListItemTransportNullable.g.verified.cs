...
{
    /// <inheritdoc />
    public sealed class McpIntegrationListItemTransportNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.McpIntegrationListItemTransport?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.McpIntegrationListItemTransportExtensions.ToValueString(value.Value));
            }
        }
    }
}
