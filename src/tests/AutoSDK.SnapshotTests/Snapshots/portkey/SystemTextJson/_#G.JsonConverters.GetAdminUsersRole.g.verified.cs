...
{
    /// <inheritdoc />
    public sealed class GetAdminUsersRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAdminUsersRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetAdminUsersRoleExtensions.ToValueString(value));
        }
    }
}
