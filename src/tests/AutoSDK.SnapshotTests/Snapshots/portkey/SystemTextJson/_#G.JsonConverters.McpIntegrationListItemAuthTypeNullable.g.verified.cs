...
{
    /// <inheritdoc />
    public sealed class McpIntegrationListItemAuthTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.McpIntegrationListItemAuthType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.McpIntegrationListItemAuthTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
