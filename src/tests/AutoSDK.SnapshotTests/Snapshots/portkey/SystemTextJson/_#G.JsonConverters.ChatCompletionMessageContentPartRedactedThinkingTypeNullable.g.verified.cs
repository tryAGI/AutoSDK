...
{
    /// <inheritdoc />
    public sealed class ChatCompletionMessageContentPartRedactedThinkingTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionMessageContentPartRedactedThinkingType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ChatCompletionMessageContentPartRedactedThinkingTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
