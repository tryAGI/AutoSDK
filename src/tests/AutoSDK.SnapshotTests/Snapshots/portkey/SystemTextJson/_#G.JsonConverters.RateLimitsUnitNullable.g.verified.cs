...
{
    /// <inheritdoc />
    public sealed class RateLimitsUnitNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RateLimitsUnit?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RateLimitsUnitExtensions.ToValueString(value.Value));
            }
        }
    }
}
