...
namespace G
{
    ...
    public sealed partial class CreateResponseVariant3
    {
        ...
        /// Learn more:<br/>
        /// - [Text inputs and outputs](https://platform.openai.com/docs/guides/text?api-mode=responses)<br/>
        /// - [Image inputs](https://platform.openai.com/docs/guides/images-vision?api-mode=responses)<br/>
        /// - [File inputs](https://platform.openai.com/docs/guides/pdf-files?api-mode=responses)<br/>
        /// - [Conversation state](https://platform.openai.com/docs/guides/conversation-state?api-mode=responses)<br/>
