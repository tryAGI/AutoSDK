//HintName: G.JsonConverters.GuardrailDetails.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class GuardrailDetailsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GuardrailDetails>
    {
        /// <inheritdoc />
        public override global::G.GuardrailDetails Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.GuardrailSummary? summary = default;
            global::G.GuardrailDetailsVariant2? guardrailDetailsVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.GuardrailDetails(
                summary,
