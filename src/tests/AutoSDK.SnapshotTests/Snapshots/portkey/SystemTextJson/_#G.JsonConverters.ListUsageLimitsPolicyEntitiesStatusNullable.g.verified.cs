...
{
    /// <inheritdoc />
    public sealed class ListUsageLimitsPolicyEntitiesStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListUsageLimitsPolicyEntitiesStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ListUsageLimitsPolicyEntitiesStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
