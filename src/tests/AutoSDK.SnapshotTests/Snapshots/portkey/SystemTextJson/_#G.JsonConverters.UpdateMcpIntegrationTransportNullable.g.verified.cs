...
{
    /// <inheritdoc />
    public sealed class UpdateMcpIntegrationTransportNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateMcpIntegrationTransport?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateMcpIntegrationTransportExtensions.ToValueString(value.Value));
            }
        }
    }
}
