...
{
    /// <inheritdoc />
    public sealed class OutputItemDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OutputItemDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.OutputItemDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
