...
{
    /// <inheritdoc />
    public sealed class OpenAIFinetuneJobMethodTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OpenAIFinetuneJobMethodType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.OpenAIFinetuneJobMethodTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
