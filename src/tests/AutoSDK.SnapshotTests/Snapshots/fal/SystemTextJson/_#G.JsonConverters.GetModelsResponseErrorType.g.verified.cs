...
{
    /// <inheritdoc />
    public sealed class GetModelsResponseErrorTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetModelsResponseErrorType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetModelsResponseErrorTypeExtensions.ToValueString(value));
        }
    }
}
