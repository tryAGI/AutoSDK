...
{
    /// <inheritdoc />
    public sealed class GetAnalyticsTimeframeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAnalyticsTimeframe>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetAnalyticsTimeframeExtensions.ToValueString(value));
        }
    }
}
