...
{
    /// <inheritdoc />
    public sealed class GetUsageResponseErrorType5NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetUsageResponseErrorType5?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetUsageResponseErrorType5Extensions.ToValueString(value.Value));
            }
        }
    }
}
