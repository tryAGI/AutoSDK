...
{
    /// <inheritdoc />
    public sealed class CreateComputeInstanceResponseRegionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateComputeInstanceResponseRegion>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateComputeInstanceResponseRegionExtensions.ToValueString(value));
        }
    }
}
