...
{
    /// <inheritdoc />
    public sealed class GetAnalyticsResponseErrorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAnalyticsResponseErrorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetAnalyticsResponseErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
