...
{
    /// <inheritdoc />
    public sealed class ServerlessLogsStreamRequestItemConditionTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ServerlessLogsStreamRequestItemConditionType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ServerlessLogsStreamRequestItemConditionTypeExtensions.ToValueString(value));
        }
    }
}
