...
{
    /// <inheritdoc />
    public sealed class GetModelsResponseModelMetadataKindJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetModelsResponseModelMetadataKind>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetModelsResponseModelMetadataKindExtensions.ToValueString(value));
        }
    }
}
