...
{
    /// <inheritdoc />
    public sealed class ServerlessGetMetricsResponseErrorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ServerlessGetMetricsResponseErrorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ServerlessGetMetricsResponseErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
