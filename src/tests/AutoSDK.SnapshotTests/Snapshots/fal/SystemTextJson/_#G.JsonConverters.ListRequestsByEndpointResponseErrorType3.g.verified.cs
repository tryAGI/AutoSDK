...
{
    /// <inheritdoc />
    public sealed class ListRequestsByEndpointResponseErrorType3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListRequestsByEndpointResponseErrorType3>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ListRequestsByEndpointResponseErrorType3Extensions.ToValueString(value));
        }
    }
}
