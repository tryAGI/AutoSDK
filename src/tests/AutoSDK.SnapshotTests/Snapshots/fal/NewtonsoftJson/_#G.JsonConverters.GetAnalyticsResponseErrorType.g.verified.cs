...
{
    /// <inheritdoc />
    public sealed class GetAnalyticsResponseErrorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAnalyticsResponseErrorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetAnalyticsResponseErrorTypeExtensions.ToValueString(value));
        }
    }
}
