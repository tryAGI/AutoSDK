...
{
    /// <inheritdoc />
    public sealed class GetUsageResponseErrorType5JsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetUsageResponseErrorType5>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetUsageResponseErrorType5Extensions.ToValueString(value));
        }
    }
}
