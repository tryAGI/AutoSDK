...
{
    /// <inheritdoc />
    public sealed class GetModelsResponseErrorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetModelsResponseErrorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetModelsResponseErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
