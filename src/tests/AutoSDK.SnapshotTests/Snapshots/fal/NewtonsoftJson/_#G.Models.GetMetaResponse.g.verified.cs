...
namespace G
{
    ...
    public sealed partial class GetMetaResponse
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("webhook_ip_ranges", Required = global::Newtonsoft.Json.Required.Always)]
        public global::System.Collections.Generic.IList<string> WebhookIpRanges { get; set; } = default!;
