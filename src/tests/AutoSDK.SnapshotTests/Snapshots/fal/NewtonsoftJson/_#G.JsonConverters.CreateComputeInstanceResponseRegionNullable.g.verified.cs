...
{
    /// <inheritdoc />
    public sealed class CreateComputeInstanceResponseRegionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateComputeInstanceResponseRegion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateComputeInstanceResponseRegionExtensions.ToValueString(value.Value));
            }
        }
    }
}
