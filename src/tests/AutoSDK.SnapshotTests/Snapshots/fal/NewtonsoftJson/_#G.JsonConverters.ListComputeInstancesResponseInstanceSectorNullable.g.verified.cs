...
{
    /// <inheritdoc />
    public sealed class ListComputeInstancesResponseInstanceSectorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListComputeInstancesResponseInstanceSector?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListComputeInstancesResponseInstanceSectorExtensions.ToValueString(value.Value));
            }
        }
    }
}
