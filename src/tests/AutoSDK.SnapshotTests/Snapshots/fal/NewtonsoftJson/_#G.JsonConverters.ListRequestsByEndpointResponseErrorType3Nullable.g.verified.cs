...
{
    /// <inheritdoc />
    public sealed class ListRequestsByEndpointResponseErrorType3NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListRequestsByEndpointResponseErrorType3?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListRequestsByEndpointResponseErrorType3Extensions.ToValueString(value.Value));
            }
        }
    }
}
