...
{
    /// <inheritdoc />
    public sealed class GetModelsResponseModelMetadataKindNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetModelsResponseModelMetadataKind?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetModelsResponseModelMetadataKindExtensions.ToValueString(value.Value));
            }
        }
    }
}
