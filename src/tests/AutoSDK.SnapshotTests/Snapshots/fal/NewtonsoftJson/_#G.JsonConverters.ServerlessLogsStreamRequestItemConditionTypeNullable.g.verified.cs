...
{
    /// <inheritdoc />
    public sealed class ServerlessLogsStreamRequestItemConditionTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ServerlessLogsStreamRequestItemConditionType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ServerlessLogsStreamRequestItemConditionTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
