...
namespace G
{
    public partial class AccountClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> GetFocusReportAsResponseAsync(
            global::G.GetFocusReportSource source,
            string? billingMonth = default,
            string? chargeMonth = default,
            global::G.AnyOf<global::System.DateTime?, string>? start = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::G.ApiException<global::G.GetFocusReportResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::G.ApiException<global::G.GetFocusReportResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::G.ApiException<global::G.GetFocusReportResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::G.ApiException<global::G.GetFocusReportResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::G.ApiException<global::G.GetFocusReportResponse5>.Create(
                                    statusCode: __response.StatusCode,
