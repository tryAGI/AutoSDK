//HintName: G.RoleOperationsV2Client.CreateVectordbRolesRevokePrivilege.g.cs
...
namespace G
{
    public partial class RoleOperationsV2Client
    {
        ...
        public async global::System.Threading.Tasks.Task CreateVectordbRolesRevokePrivilegeAsync(
        ...
        {
            await CreateVectordbRolesRevokePrivilegeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> CreateVectordbRolesRevokePrivilegeAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (authorization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectordbRolesRevokePrivilegeRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbRolesRevokePrivilege",
                                methodName: "CreateVectordbRolesRevokePrivilegeAsync",
                                pathTemplate: "\"/v2/vectordb/roles/revoke_privilege\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbRolesRevokePrivilegeResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateVectordbRolesRevokePrivilegeAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.CreateVectordbRolesRevokePrivilegeRequest
            {
                RoleName = roleName,
