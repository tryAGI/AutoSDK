//HintName: G.PartitionOperationsV2Client.CreateVectordbPartitionsDrop.g.cs
...
namespace G
{
    public partial class PartitionOperationsV2Client
    {
        ...
        public async global::System.Threading.Tasks.Task CreateVectordbPartitionsDropAsync(
            int requestTimeout,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbPartitionsDrop",
                                methodName: "CreateVectordbPartitionsDropAsync",
                                pathTemplate: "\"/v2/vectordb/partitions/drop\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbPartitionsDropResponse(
                    httpClient: HttpClient,
