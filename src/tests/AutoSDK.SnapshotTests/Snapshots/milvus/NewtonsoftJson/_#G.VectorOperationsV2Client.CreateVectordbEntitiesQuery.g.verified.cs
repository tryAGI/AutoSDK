...
namespace G
{
    public partial class VectorOperationsV2Client
    {
        ...
        {
            var __response = await CreateVectordbEntitiesQueryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CreateVectordbEntitiesQueryResponse>> CreateVectordbEntitiesQueryAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbEntitiesQuery",
                                methodName: "CreateVectordbEntitiesQueryAsync",
                                pathTemplate: "\"/v2/vectordb/entities/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CreateVectordbEntitiesQueryResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CreateVectordbEntitiesQueryResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CreateVectordbEntitiesQueryResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
