...
{
    /// <inheritdoc />
    public sealed class GetAnnotationConfigsResponseBodyDataItemDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
