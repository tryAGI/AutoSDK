...
{
    /// <inheritdoc />
    public sealed class PromptVersionInvocationParametersDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PromptVersionInvocationParametersDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PromptVersionInvocationParametersDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
