...
{
    /// <inheritdoc />
    public sealed class GetAnnotationConfigResponseBodyDataDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAnnotationConfigResponseBodyDataDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetAnnotationConfigResponseBodyDataDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
