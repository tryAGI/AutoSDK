//HintName: G.AnnotationsClient.ListTraceAnnotationsByTraceIds.g.cs
...
namespace G
{
    public partial class AnnotationsClient
    {
        partial void PrepareListTraceAnnotationsByTraceIdsArguments(
            ...
            ref string? cursor,
            ref int? limit);
        partial void PrepareListTraceAnnotationsByTraceIdsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? cursor,
            int? limit);
        partial void ProcessListTraceAnnotationsByTraceIdsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListTraceAnnotationsByTraceIdsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.TraceAnnotationsResponseBody> ListTraceAnnotationsByTraceIdsAsync(
            string projectIdentifier,
            global::System.Collections.Generic.IList<string> traceIds,
        ...
        {
            var __response = await ListTraceAnnotationsByTraceIdsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.TraceAnnotationsResponseBody>> ListTraceAnnotationsByTraceIdsAsResponseAsync(
            string projectIdentifier,
            global::System.Collections.Generic.IList<string> traceIds,
            global::System.Collections.Generic.IList<string>? includeAnnotationNames = default,
            global::System.Collections.Generic.IList<string>? excludeAnnotationNames = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListTraceAnnotationsByTraceIdsArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("trace_ids", traceIds, delimiter: ",", explode: true)
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListTraceAnnotationsByTraceIdsAsync",
                                pathTemplate: "$\"/v1/projects/{projectIdentifier}/trace_annotations\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListTraceAnnotationsByTraceIdsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListTraceAnnotationsByTraceIdsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.TraceAnnotationsResponseBody.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.TraceAnnotationsResponseBody>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.TraceAnnotationsResponseBody.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
