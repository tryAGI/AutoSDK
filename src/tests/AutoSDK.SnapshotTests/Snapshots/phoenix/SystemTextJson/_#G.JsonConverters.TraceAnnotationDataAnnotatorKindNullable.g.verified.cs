...
{
    /// <inheritdoc />
    public sealed class TraceAnnotationDataAnnotatorKindNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TraceAnnotationDataAnnotatorKind?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TraceAnnotationDataAnnotatorKindExtensions.ToValueString(value.Value));
            }
        }
    }
}
