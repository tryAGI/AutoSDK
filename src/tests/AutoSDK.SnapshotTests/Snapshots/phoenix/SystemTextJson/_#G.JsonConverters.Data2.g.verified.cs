//HintName: G.JsonConverters.Data2.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Data2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Data2>
    {
        /// <inheritdoc />
        public override global::G.Data2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.CreateUserResponseBodyDataDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.CreateUserResponseBodyDataDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.CreateUserResponseBodyDataDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.LocalUser? local = default;
            if (discriminator?.AuthMethod == global::G.CreateUserResponseBodyDataDiscriminatorAuthMethod.Local)
            {
            ...
            if (discriminator?.AuthMethod == global::G.CreateUserResponseBodyDataDiscriminatorAuthMethod.Oauth2)
            {
            ...
            if (discriminator?.AuthMethod == global::G.CreateUserResponseBodyDataDiscriminatorAuthMethod.Ldap)
            {
            ...
            var __value = new global::G.Data2(
