//HintName: G.JsonConverters.InvocationParameters2.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class InvocationParameters2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InvocationParameters2>
    {
        /// <inheritdoc />
        public override global::G.InvocationParameters2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.PromptVersionDataInvocationParametersDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.PromptVersionDataInvocationParametersDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.PromptVersionDataInvocationParametersDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.PromptOpenAIInvocationParameters? openai = default;
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Openai)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.AzureOpenai)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Anthropic)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Google)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Deepseek)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Xai)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Ollama)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Aws)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Cerebras)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Fireworks)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Groq)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Moonshot)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Perplexity)
            {
            ...
            if (discriminator?.Type == global::G.PromptVersionDataInvocationParametersDiscriminatorType.Together)
            {
            ...
            var __value = new global::G.InvocationParameters2(
                discriminator?.Type,
                openai,
        ...
        public override void Write(
            ...
            global::G.InvocationParameters2 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
