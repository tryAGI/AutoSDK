...
namespace G.JsonConverters
{
    ...
    public class DataItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DataItem>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.CategoricalAnnotationConfig? categorical = default;
            if (discriminator?.Type == global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminatorType.Categorical)
            {
            ...
            if (discriminator?.Type == global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminatorType.Continuous)
            {
            ...
            if (discriminator?.Type == global::G.GetAnnotationConfigsResponseBodyDataItemDiscriminatorType.Freeform)
            {
