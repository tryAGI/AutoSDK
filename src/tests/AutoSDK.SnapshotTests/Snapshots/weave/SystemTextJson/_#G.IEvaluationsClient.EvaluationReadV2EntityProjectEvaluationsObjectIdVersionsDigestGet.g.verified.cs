...
namespace G
{
    public partial interface IEvaluationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvaluationReadRes>> EvaluationReadV2EntityProjectEvaluationsObjectIdVersionsDigestGetAsResponseAsync(
            string entity,
            string project,
            string objectId,
            string digest,
