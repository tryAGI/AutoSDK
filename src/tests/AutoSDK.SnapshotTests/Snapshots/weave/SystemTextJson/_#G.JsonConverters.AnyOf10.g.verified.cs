//HintName: G.JsonConverters.AnyOf10.g.cs
#nullable enable

namespace G.JsonConverters
{
    /// <inheritdoc />
    public class AnyOfJsonConverter<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> : global::System.Text.Json.Serialization.JsonConverter<global::G.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>
    {
        /// <inheritdoc />
        public override global::G.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __value = new global::G.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
                value1,
        ...
        public override void Write(
            ...
            global::G.AnyOf<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
