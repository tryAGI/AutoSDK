...
namespace G
{
    public partial interface IPredictionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PredictionFinishRes>> PredictionFinishV2EntityProjectPredictionsPredictionIdFinishPostAsResponseAsync(
            string entity,
            string project,
            string predictionId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
