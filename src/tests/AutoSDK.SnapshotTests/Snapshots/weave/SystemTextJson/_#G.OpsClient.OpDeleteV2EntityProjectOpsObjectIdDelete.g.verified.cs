...
namespace G
{
    public partial class OpsClient
    {
        ...
        {
            var __response = await OpDeleteV2EntityProjectOpsObjectIdDeleteAsResponseAsync(
                entity: entity,
                project: project,
                objectId: objectId,
                digests: digests,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OpDeleteRes>> OpDeleteV2EntityProjectOpsObjectIdDeleteAsResponseAsync(
            string entity,
            string project,
            string objectId,
            global::System.Collections.Generic.IList<string>? digests = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpDeleteV2EntityProjectOpsObjectIdDelete",
                                methodName: "OpDeleteV2EntityProjectOpsObjectIdDeleteAsync",
                                pathTemplate: "$\"/v2/{entity}/{project}/ops/{objectId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.OpDeleteRes.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.OpDeleteRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.OpDeleteRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
