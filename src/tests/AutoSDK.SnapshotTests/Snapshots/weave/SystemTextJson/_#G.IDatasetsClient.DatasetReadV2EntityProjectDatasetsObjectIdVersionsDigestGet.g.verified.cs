...
namespace G
{
    public partial interface IDatasetsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DatasetReadRes>> DatasetReadV2EntityProjectDatasetsObjectIdVersionsDigestGetAsResponseAsync(
            string entity,
            string project,
            string objectId,
            string digest,
