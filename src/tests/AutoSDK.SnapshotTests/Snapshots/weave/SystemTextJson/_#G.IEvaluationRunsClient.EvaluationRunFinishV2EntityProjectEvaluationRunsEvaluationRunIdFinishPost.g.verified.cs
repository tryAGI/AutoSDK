...
namespace G
{
    public partial interface IEvaluationRunsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvaluationRunFinishRes>> EvaluationRunFinishV2EntityProjectEvaluationRunsEvaluationRunIdFinishPostAsResponseAsync(
            string entity,
            string project,
            string evaluationRunId,
