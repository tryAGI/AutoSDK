...
namespace G
{
    public partial class EvaluationsClient
    {
        ...
        {
            var __response = await EvaluationCreateV2EntityProjectEvaluationsPostAsResponseAsync(
                entity: entity,
                project: project,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvaluationCreateRes>> EvaluationCreateV2EntityProjectEvaluationsPostAsResponseAsync(
            string entity,
            string project,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvaluationCreateV2EntityProjectEvaluationsPost",
                                methodName: "EvaluationCreateV2EntityProjectEvaluationsPostAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.EvaluationCreateRes.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.EvaluationCreateRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.EvaluationCreateRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
