...
namespace G
{
    ...
    public sealed partial class CostQueryOutput
    {
        ...
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("llm_id")]
        public string? LlmId { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("prompt_token_cost")]
        public double? PromptTokenCost { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("completion_token_cost")]
