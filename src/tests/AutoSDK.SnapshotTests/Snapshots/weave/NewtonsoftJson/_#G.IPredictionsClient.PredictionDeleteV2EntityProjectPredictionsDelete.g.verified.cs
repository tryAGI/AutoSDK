...
namespace G
{
    public partial interface IPredictionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PredictionDeleteRes>> PredictionDeleteV2EntityProjectPredictionsDeleteAsResponseAsync(
            string entity,
            string project,
            global::System.Collections.Generic.IList<string> predictionIds,
            global::G.AutoSDKRequestOptions? requestOptions = default,
