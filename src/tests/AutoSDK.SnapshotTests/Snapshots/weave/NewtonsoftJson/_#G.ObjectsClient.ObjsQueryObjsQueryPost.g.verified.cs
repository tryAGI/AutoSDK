...
namespace G
{
    public partial class ObjectsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ObjsQueryObjsQueryPostSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ObjsQueryObjsQueryPostSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        {
            var __response = await ObjsQueryObjsQueryPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ObjQueryRes>> ObjsQueryObjsQueryPostAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ObjsQueryObjsQueryPost",
                                methodName: "ObjsQueryObjsQueryPostAsync",
                                pathTemplate: "\"/objs/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ObjQueryRes.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ObjQueryRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ObjQueryRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
