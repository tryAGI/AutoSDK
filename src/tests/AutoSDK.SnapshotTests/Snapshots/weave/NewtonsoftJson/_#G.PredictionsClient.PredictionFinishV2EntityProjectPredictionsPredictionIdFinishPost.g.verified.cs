...
namespace G
{
    public partial class PredictionsClient
    {
        ...
        {
            var __response = await PredictionFinishV2EntityProjectPredictionsPredictionIdFinishPostAsResponseAsync(
                entity: entity,
                project: project,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PredictionFinishRes>> PredictionFinishV2EntityProjectPredictionsPredictionIdFinishPostAsResponseAsync(
            string entity,
            string project,
            string predictionId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PredictionFinishV2EntityProjectPredictionsPredictionIdFinishPost",
                                methodName: "PredictionFinishV2EntityProjectPredictionsPredictionIdFinishPostAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PredictionFinishRes.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PredictionFinishRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PredictionFinishRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
