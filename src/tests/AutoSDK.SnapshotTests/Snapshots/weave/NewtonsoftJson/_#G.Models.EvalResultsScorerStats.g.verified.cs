...
namespace G
{
    ...
    public sealed partial class EvalResultsScorerStats
    {
        ...
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("scorer_key", Required = global::Newtonsoft.Json.Required.Always)]
        public string ScorerKey { get; set; } = default!;
        ...
        /// Default Value: 0
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("numeric_count")]
        public int? NumericCount { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("numeric_mean")]
        public double? NumericMean { get; set; }

        /// <summary>
        /// Default Value: 0
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("pass_true_count")]
        public int? PassTrueCount { get; set; }

        /// <summary>
        /// Default Value: 0
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("pass_known_count")]
        ...
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("pass_signal_coverage")]
