...
namespace G
{
    public partial interface IEvaluationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvaluationCreateRes>> EvaluationCreateV2EntityProjectEvaluationsPostAsResponseAsync(
            string entity,
            string project,
