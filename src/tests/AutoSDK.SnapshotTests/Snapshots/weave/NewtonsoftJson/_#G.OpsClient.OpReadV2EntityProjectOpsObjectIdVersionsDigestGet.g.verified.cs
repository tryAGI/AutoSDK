...
namespace G
{
    public partial class OpsClient
    {
        ...
        {
            var __response = await OpReadV2EntityProjectOpsObjectIdVersionsDigestGetAsResponseAsync(
                entity: entity,
                project: project,
                objectId: objectId,
                digest: digest,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OpReadRes>> OpReadV2EntityProjectOpsObjectIdVersionsDigestGetAsResponseAsync(
            string entity,
            string project,
            string objectId,
            string digest,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OpReadV2EntityProjectOpsObjectIdVersionsDigestGet",
                                methodName: "OpReadV2EntityProjectOpsObjectIdVersionsDigestGetAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.OpReadRes.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.OpReadRes>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.OpReadRes.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
