...
namespace G
{
    public partial interface IEvaluationRunsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvaluationRunDeleteRes>> EvaluationRunDeleteV2EntityProjectEvaluationRunsDeleteAsResponseAsync(
            string entity,
            string project,
            global::System.Collections.Generic.IList<string> evaluationRunIds,
            global::G.AutoSDKRequestOptions? requestOptions = default,
