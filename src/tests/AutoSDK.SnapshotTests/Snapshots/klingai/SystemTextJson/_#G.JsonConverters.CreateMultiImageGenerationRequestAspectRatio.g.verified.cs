...
{
    /// <inheritdoc />
    public sealed class CreateMultiImageGenerationRequestAspectRatioJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateMultiImageGenerationRequestAspectRatio>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateMultiImageGenerationRequestAspectRatioExtensions.ToValueString(value));
        }
    }
}
