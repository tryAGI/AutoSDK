...
{
    /// <inheritdoc />
    public sealed class CreateTextToVideoRequestDurationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTextToVideoRequestDuration>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateTextToVideoRequestDurationExtensions.ToValueString(value));
        }
    }
}
