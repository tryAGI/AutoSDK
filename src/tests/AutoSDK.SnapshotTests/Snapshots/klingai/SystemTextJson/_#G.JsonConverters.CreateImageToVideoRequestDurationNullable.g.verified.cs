...
{
    /// <inheritdoc />
    public sealed class CreateImageToVideoRequestDurationNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateImageToVideoRequestDuration?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateImageToVideoRequestDurationExtensions.ToValueString(value.Value));
            }
        }
    }
}
