...
{
    /// <inheritdoc />
    public sealed class CreateImageToVideoRequestDurationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateImageToVideoRequestDuration>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateImageToVideoRequestDurationExtensions.ToValueString(value));
        }
    }
}
