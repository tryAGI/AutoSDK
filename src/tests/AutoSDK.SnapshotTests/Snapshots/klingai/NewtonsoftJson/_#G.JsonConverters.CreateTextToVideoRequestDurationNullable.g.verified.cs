...
{
    /// <inheritdoc />
    public sealed class CreateTextToVideoRequestDurationNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTextToVideoRequestDuration?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTextToVideoRequestDurationExtensions.ToValueString(value.Value));
            }
        }
    }
}
