...
namespace G
{
    ...
    public sealed partial class ResourcePackage
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("resource_pack_name")]
        public string? ResourcePackName { get; set; }

        /// <summary>
        /// Unique resource package ID.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("resource_pack_id")]
        public string? ResourcePackId { get; set; }

        /// <summary>
        /// Type of the resource package.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("resource_pack_type")]
        public string? ResourcePackType { get; set; }

        /// <summary>
        /// Total quantity of credits in the package.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("total_quantity")]
        public double? TotalQuantity { get; set; }

        /// <summary>
        /// Remaining quantity of credits.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("remaining_quantity")]
        public double? RemainingQuantity { get; set; }

        /// <summary>
        /// Purchase timestamp (Unix milliseconds).
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("purchase_time")]
        public long? PurchaseTime { get; set; }

        /// <summary>
        /// Effective start timestamp.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("effective_time")]
        public long? EffectiveTime { get; set; }

        /// <summary>
        /// Expiration timestamp.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("invalid_time")]
