...
{
    /// <inheritdoc />
    public sealed class TopicExtractionJobStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TopicExtractionJobStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TopicExtractionJobStatusExtensions.ToValueString(value));
        }
    }
}
