//HintName: G.ICaptionsClient.GetCaptionsAsText.g.cs
#nullable enable
...
namespace G
{
    public partial interface ICaptionsClient
    {
        ...
        global::System.Threading.Tasks.Task<string> GetCaptionsAsTextAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> GetCaptionsAsTextAsResponseAsync(
            string id,
            global::G.GetCaptionsAccept? accept = default,
            int? speakerChannel = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
