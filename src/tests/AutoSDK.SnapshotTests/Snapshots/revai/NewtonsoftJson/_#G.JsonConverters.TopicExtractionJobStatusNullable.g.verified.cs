...
{
    /// <inheritdoc />
    public sealed class TopicExtractionJobStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TopicExtractionJobStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TopicExtractionJobStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
