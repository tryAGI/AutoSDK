...
namespace G
{
    public partial class V1GenerationClient
    {
            ...
            if (organization != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("Organization", organization.ToString());
                            ...
                            if (request.MaskImage != default)
                            {
                                ...
                                __contentMaskImage.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.MaskImagename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.MaskImagename) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Masking",
                                methodName: "MaskingAsync",
                                pathTemplate: "$\"/v1/generation/{engineId}/image-to-image/masking\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.Image>> MaskingAsync(
            ...
            global::G.MaskingAccept? accept = default,
            string? organization = default,
            global::System.IO.Stream? maskImage = default,
            string? maskImagename = default,
            double? cfgScale = default,
            global::G.ClipGuidancePreset? clipGuidancePreset = default,
            global::G.Sampler? sampler = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.MaskingRequestBody
            {
                InitImage = global::System.Array.Empty<byte>(),
                InitImagename = initImagename,
                MaskImage = global::System.Array.Empty<byte>(),
                MaskImagename = maskImagename,
                TextPrompts = textPrompts,
                CfgScale = cfgScale,
                ClipGuidancePreset = clipGuidancePreset,
            ...
            if (organization != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("Organization", organization.ToString());
                            ...
                            if (maskImage != default)
                            {

                                var __contentMaskImage = new global::System.Net.Http.StreamContent(maskImage);
                                __contentMaskImage.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.MaskImagename is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.MaskImagename) ?? string.Empty).ToLowerInvariant() switch
