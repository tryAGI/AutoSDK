...
namespace G
{
    public partial class ManageGlossariesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_GetGlossaryEntriesServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetGlossaryEntriesSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetGlossaryEntriesSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetGlossaryEntriesSecurityRequirement0,
            };
        partial void PrepareGetGlossaryEntriesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string glossaryId,
            ref global::G.GetGlossaryEntriesAccept? accept);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetGlossaryEntriesSecurityRequirements,
                operationName: "GetGlossaryEntriesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                path: $"/v2/glossaries/{glossaryId}/entries",
                                baseUri: ResolveBaseUri(
                                servers: s_GetGlossaryEntriesServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetGlossaryEntriesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetGlossaryEntriesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.GetGlossaryEntriesResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.GetGlossaryEntriesResponse.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.GetGlossaryEntriesResponse>.Create(
