...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersKanjiNumbersNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesNumbersKanjiNumbers?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesNumbersKanjiNumbersExtensions.ToValueString(value.Value));
            }
        }
    }
}
