...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesSpellingAndGrammarCompleteSentencesNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesSpellingAndGrammarCompleteSentences?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesSpellingAndGrammarCompleteSentencesExtensions.ToValueString(value.Value));
            }
        }
    }
}
