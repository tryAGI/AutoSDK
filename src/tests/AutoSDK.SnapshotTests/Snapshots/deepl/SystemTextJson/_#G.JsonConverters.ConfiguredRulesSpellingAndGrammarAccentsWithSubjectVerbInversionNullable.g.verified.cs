...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesSpellingAndGrammarAccentsWithSubjectVerbInversionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesSpellingAndGrammarAccentsWithSubjectVerbInversion?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesSpellingAndGrammarAccentsWithSubjectVerbInversionExtensions.ToValueString(value.Value));
            }
        }
    }
}
