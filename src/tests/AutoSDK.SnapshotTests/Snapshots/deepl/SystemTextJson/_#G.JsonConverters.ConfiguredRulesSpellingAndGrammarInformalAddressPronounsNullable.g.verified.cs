...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesSpellingAndGrammarInformalAddressPronounsNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesSpellingAndGrammarInformalAddressPronouns?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesSpellingAndGrammarInformalAddressPronounsExtensions.ToValueString(value.Value));
            }
        }
    }
}
