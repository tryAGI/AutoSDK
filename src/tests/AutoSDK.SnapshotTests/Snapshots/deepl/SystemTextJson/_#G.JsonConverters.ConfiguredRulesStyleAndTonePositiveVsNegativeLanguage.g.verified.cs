...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndTonePositiveVsNegativeLanguageJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndTonePositiveVsNegativeLanguage>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesStyleAndTonePositiveVsNegativeLanguageExtensions.ToValueString(value));
        }
    }
}
