...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationSerialCommaNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesPunctuationSerialComma?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesPunctuationSerialCommaExtensions.ToValueString(value.Value));
            }
        }
    }
}
