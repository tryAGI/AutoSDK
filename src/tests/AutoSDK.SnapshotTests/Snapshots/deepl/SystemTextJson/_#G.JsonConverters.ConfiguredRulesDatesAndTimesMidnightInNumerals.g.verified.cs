...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesDatesAndTimesMidnightInNumeralsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesDatesAndTimesMidnightInNumerals>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesDatesAndTimesMidnightInNumeralsExtensions.ToValueString(value));
        }
    }
}
