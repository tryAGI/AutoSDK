...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationEllipsisJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesPunctuationEllipsis>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesPunctuationEllipsisExtensions.ToValueString(value));
        }
    }
}
