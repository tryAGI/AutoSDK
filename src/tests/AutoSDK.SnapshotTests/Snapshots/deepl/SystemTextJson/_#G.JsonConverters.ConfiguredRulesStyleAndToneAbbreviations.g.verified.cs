...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneAbbreviationsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndToneAbbreviations>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesStyleAndToneAbbreviationsExtensions.ToValueString(value));
        }
    }
}
