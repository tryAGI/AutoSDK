...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersEquationFormulaReferenceNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesNumbersEquationFormulaReference?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesNumbersEquationFormulaReferenceExtensions.ToValueString(value.Value));
            }
        }
    }
}
