...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationUppercaseAcronymsNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesPunctuationUppercaseAcronyms?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesPunctuationUppercaseAcronymsExtensions.ToValueString(value.Value));
            }
        }
    }
}
