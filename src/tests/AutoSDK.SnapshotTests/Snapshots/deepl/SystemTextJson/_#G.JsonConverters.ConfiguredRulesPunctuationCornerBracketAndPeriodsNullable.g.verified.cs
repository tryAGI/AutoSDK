...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationCornerBracketAndPeriodsNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesPunctuationCornerBracketAndPeriods?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesPunctuationCornerBracketAndPeriodsExtensions.ToValueString(value.Value));
            }
        }
    }
}
