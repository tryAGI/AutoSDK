...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneDeclarativeEndingsNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndToneDeclarativeEndings?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesStyleAndToneDeclarativeEndingsExtensions.ToValueString(value.Value));
            }
        }
    }
}
