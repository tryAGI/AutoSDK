...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationSettingOffNonQuotedPhrasesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesPunctuationSettingOffNonQuotedPhrases>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesPunctuationSettingOffNonQuotedPhrasesExtensions.ToValueString(value));
        }
    }
}
