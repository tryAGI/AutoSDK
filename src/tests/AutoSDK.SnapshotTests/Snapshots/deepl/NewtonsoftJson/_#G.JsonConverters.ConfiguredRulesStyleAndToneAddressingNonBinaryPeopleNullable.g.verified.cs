...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneAddressingNonBinaryPeopleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesStyleAndToneAddressingNonBinaryPeople?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesStyleAndToneAddressingNonBinaryPeopleExtensions.ToValueString(value.Value));
            }
        }
    }
}
