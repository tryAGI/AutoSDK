...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersZeroFormatJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesNumbersZeroFormat>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ConfiguredRulesNumbersZeroFormatExtensions.ToValueString(value));
        }
    }
}
