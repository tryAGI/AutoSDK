...
{
    /// <inheritdoc />
    public sealed class GetGlossaryEntriesAcceptJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetGlossaryEntriesAccept>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetGlossaryEntriesAcceptExtensions.ToValueString(value));
        }
    }
}
