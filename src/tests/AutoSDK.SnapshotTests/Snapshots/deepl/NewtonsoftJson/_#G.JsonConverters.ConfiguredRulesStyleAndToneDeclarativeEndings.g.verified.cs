...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneDeclarativeEndingsJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesStyleAndToneDeclarativeEndings>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ConfiguredRulesStyleAndToneDeclarativeEndingsExtensions.ToValueString(value));
        }
    }
}
