...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationSettingOffNonQuotedPhrasesNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesPunctuationSettingOffNonQuotedPhrases?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesPunctuationSettingOffNonQuotedPhrasesExtensions.ToValueString(value.Value));
            }
        }
    }
}
