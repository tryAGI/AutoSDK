...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationEllipsisNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesPunctuationEllipsis?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesPunctuationEllipsisExtensions.ToValueString(value.Value));
            }
        }
    }
}
