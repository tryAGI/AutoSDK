...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersListOfMeasurementsWithUnitsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesNumbersListOfMeasurementsWithUnits?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesNumbersListOfMeasurementsWithUnitsExtensions.ToValueString(value.Value));
            }
        }
    }
}
