...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneModalVerbsJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesStyleAndToneModalVerbs>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ConfiguredRulesStyleAndToneModalVerbsExtensions.ToValueString(value));
        }
    }
}
