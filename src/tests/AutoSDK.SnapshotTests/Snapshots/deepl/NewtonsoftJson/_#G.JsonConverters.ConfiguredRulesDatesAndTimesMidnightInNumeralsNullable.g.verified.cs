...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesDatesAndTimesMidnightInNumeralsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesDatesAndTimesMidnightInNumerals?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesDatesAndTimesMidnightInNumeralsExtensions.ToValueString(value.Value));
            }
        }
    }
}
