...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesDatesAndTimesDatesInNumericalFormNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesDatesAndTimesDatesInNumericalForm?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesDatesAndTimesDatesInNumericalFormExtensions.ToValueString(value.Value));
            }
        }
    }
}
