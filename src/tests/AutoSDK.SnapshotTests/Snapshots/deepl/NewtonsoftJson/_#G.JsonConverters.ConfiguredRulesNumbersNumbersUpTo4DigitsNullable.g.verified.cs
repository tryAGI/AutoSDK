...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersNumbersUpTo4DigitsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesNumbersNumbersUpTo4Digits?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesNumbersNumbersUpTo4DigitsExtensions.ToValueString(value.Value));
            }
        }
    }
}
