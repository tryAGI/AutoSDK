...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersMathematicalExpressionSpacingNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesNumbersMathematicalExpressionSpacing?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesNumbersMathematicalExpressionSpacingExtensions.ToValueString(value.Value));
            }
        }
    }
}
