...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesDatesAndTimesCalendarEraNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConfiguredRulesDatesAndTimesCalendarEra?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConfiguredRulesDatesAndTimesCalendarEraExtensions.ToValueString(value.Value));
            }
        }
    }
}
