...
{
    /// <inheritdoc />
    public sealed class ListenV1ServerEventDiscriminatorMessageTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListenV1ServerEventDiscriminatorMessageType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListenV1ServerEventDiscriminatorMessageTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
