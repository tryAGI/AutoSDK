...
{
    /// <inheritdoc />
    public sealed class SpeakV1ServerEventDiscriminatorMessageTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SpeakV1ServerEventDiscriminatorMessageType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SpeakV1ServerEventDiscriminatorMessageTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
