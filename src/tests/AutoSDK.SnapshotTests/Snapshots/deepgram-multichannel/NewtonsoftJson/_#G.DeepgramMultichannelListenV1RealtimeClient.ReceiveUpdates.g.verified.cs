//HintName: G.DeepgramMultichannelListenV1RealtimeClient.ReceiveUpdates.g.cs
...
namespace G
{
    public sealed partial class DeepgramMultichannelListenV1RealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::G.ListenV1ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    var @event = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ListenV1ServerEvent>(json, JsonSerializerOptions);
