...
{
    /// <inheritdoc />
    public sealed class SpeakV1ServerEventDiscriminatorMessageTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SpeakV1ServerEventDiscriminatorMessageType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.SpeakV1ServerEventDiscriminatorMessageTypeExtensions.ToValueString(value));
        }
    }
}
