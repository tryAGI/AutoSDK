...
{
    /// <inheritdoc />
    public sealed class AgentsGetDeploymentCartesiaVersionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentsGetDeploymentCartesiaVersion>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AgentsGetDeploymentCartesiaVersionExtensions.ToValueString(value));
        }
    }
}
