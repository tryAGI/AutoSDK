...
{
    /// <inheritdoc />
    public sealed class AuthAccessTokenCartesiaVersionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AuthAccessTokenCartesiaVersion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AuthAccessTokenCartesiaVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
