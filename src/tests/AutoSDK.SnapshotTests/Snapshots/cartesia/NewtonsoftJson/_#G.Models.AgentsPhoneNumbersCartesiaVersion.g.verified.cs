//HintName: G.Models.AgentsPhoneNumbersCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class AgentsPhoneNumbersCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this AgentsPhoneNumbersCartesiaVersion value)
        {
            return value switch
            {
                AgentsPhoneNumbersCartesiaVersion.x20240610 => "2024-06-10",
                AgentsPhoneNumbersCartesiaVersion.x20241113 => "2024-11-13",
                AgentsPhoneNumbersCartesiaVersion.x20250416 => "2025-04-16",
                AgentsPhoneNumbersCartesiaVersion.x20251104 => "2025-11-04",
        ...
        public static AgentsPhoneNumbersCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => AgentsPhoneNumbersCartesiaVersion.x20240610,
                "2024-11-13" => AgentsPhoneNumbersCartesiaVersion.x20241113,
                "2025-04-16" => AgentsPhoneNumbersCartesiaVersion.x20250416,
                "2025-11-04" => AgentsPhoneNumbersCartesiaVersion.x20251104,
                _ => null,
            };
        }
    }
