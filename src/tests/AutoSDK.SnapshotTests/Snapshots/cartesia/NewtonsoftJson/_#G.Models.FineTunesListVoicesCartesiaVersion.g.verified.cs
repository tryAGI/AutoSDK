//HintName: G.Models.FineTunesListVoicesCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class FineTunesListVoicesCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this FineTunesListVoicesCartesiaVersion value)
        {
            return value switch
            {
                FineTunesListVoicesCartesiaVersion.x20240610 => "2024-06-10",
                FineTunesListVoicesCartesiaVersion.x20241113 => "2024-11-13",
                FineTunesListVoicesCartesiaVersion.x20250416 => "2025-04-16",
                FineTunesListVoicesCartesiaVersion.x20251104 => "2025-11-04",
        ...
        public static FineTunesListVoicesCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => FineTunesListVoicesCartesiaVersion.x20240610,
                "2024-11-13" => FineTunesListVoicesCartesiaVersion.x20241113,
                "2025-04-16" => FineTunesListVoicesCartesiaVersion.x20250416,
                "2025-11-04" => FineTunesListVoicesCartesiaVersion.x20251104,
                _ => null,
            };
        }
    }
