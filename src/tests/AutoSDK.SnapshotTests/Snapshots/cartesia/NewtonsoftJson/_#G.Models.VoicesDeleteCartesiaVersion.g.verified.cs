//HintName: G.Models.VoicesDeleteCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class VoicesDeleteCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this VoicesDeleteCartesiaVersion value)
        {
            return value switch
            {
                VoicesDeleteCartesiaVersion.x20240610 => "2024-06-10",
                VoicesDeleteCartesiaVersion.x20241113 => "2024-11-13",
                VoicesDeleteCartesiaVersion.x20250416 => "2025-04-16",
        ...
        public static VoicesDeleteCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => VoicesDeleteCartesiaVersion.x20240610,
                "2024-11-13" => VoicesDeleteCartesiaVersion.x20241113,
                "2025-04-16" => VoicesDeleteCartesiaVersion.x20250416,
