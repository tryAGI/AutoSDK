...
{
    /// <inheritdoc />
    public sealed class GenderPresentationNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GenderPresentation?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GenderPresentationExtensions.ToValueString(value.Value));
            }
        }
    }
}
