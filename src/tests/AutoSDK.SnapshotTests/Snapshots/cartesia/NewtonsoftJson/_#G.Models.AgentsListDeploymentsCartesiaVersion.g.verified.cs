//HintName: G.Models.AgentsListDeploymentsCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class AgentsListDeploymentsCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this AgentsListDeploymentsCartesiaVersion value)
        {
            return value switch
            {
                AgentsListDeploymentsCartesiaVersion.x20240610 => "2024-06-10",
                AgentsListDeploymentsCartesiaVersion.x20241113 => "2024-11-13",
                AgentsListDeploymentsCartesiaVersion.x20250416 => "2025-04-16",
                AgentsListDeploymentsCartesiaVersion.x20251104 => "2025-11-04",
        ...
        public static AgentsListDeploymentsCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => AgentsListDeploymentsCartesiaVersion.x20240610,
                "2024-11-13" => AgentsListDeploymentsCartesiaVersion.x20241113,
                "2025-04-16" => AgentsListDeploymentsCartesiaVersion.x20250416,
                "2025-11-04" => AgentsListDeploymentsCartesiaVersion.x20251104,
                _ => null,
            };
        }
    }
