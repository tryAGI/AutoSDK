...
namespace G
{
    ...
    public sealed partial class InfillBytesRequest
    {
        ...
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("left_audio")]
        public byte[]? LeftAudio { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("left_audioname")]
        public string? LeftAudioname { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("right_audio")]
        public byte[]? RightAudio { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("right_audioname")]
