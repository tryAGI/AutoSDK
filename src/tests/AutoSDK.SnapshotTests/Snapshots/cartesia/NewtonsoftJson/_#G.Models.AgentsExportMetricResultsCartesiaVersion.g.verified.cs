//HintName: G.Models.AgentsExportMetricResultsCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class AgentsExportMetricResultsCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this AgentsExportMetricResultsCartesiaVersion value)
        {
            return value switch
            {
                AgentsExportMetricResultsCartesiaVersion.x20240610 => "2024-06-10",
                AgentsExportMetricResultsCartesiaVersion.x20241113 => "2024-11-13",
                AgentsExportMetricResultsCartesiaVersion.x20250416 => "2025-04-16",
        ...
        public static AgentsExportMetricResultsCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => AgentsExportMetricResultsCartesiaVersion.x20240610,
                "2024-11-13" => AgentsExportMetricResultsCartesiaVersion.x20241113,
                "2025-04-16" => AgentsExportMetricResultsCartesiaVersion.x20250416,
