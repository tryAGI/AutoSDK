...
{
    /// <inheritdoc />
    public sealed class AgentsGetMetricCartesiaVersionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentsGetMetricCartesiaVersion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AgentsGetMetricCartesiaVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
