...
{
    /// <inheritdoc />
    public sealed class SttTranscribeRequestLanguageNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SttTranscribeRequestLanguage?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SttTranscribeRequestLanguageExtensions.ToValueString(value.Value));
            }
        }
    }
}
