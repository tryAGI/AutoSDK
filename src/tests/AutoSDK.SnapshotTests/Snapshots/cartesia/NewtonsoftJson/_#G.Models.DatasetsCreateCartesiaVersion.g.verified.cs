//HintName: G.Models.DatasetsCreateCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class DatasetsCreateCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this DatasetsCreateCartesiaVersion value)
        {
            return value switch
            {
                DatasetsCreateCartesiaVersion.x20240610 => "2024-06-10",
                DatasetsCreateCartesiaVersion.x20241113 => "2024-11-13",
                DatasetsCreateCartesiaVersion.x20250416 => "2025-04-16",
        ...
        public static DatasetsCreateCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => DatasetsCreateCartesiaVersion.x20240610,
                "2024-11-13" => DatasetsCreateCartesiaVersion.x20241113,
                "2025-04-16" => DatasetsCreateCartesiaVersion.x20250416,
