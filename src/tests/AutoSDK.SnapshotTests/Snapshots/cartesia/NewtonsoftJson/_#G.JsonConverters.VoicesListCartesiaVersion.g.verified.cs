...
{
    /// <inheritdoc />
    public sealed class VoicesListCartesiaVersionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VoicesListCartesiaVersion>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.VoicesListCartesiaVersionExtensions.ToValueString(value));
        }
    }
}
