//HintName: G.Models.PronunciationDictsDeleteCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class PronunciationDictsDeleteCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this PronunciationDictsDeleteCartesiaVersion value)
        {
            return value switch
            {
                PronunciationDictsDeleteCartesiaVersion.x20240610 => "2024-06-10",
                PronunciationDictsDeleteCartesiaVersion.x20241113 => "2024-11-13",
                PronunciationDictsDeleteCartesiaVersion.x20250416 => "2025-04-16",
        ...
        public static PronunciationDictsDeleteCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => PronunciationDictsDeleteCartesiaVersion.x20240610,
                "2024-11-13" => PronunciationDictsDeleteCartesiaVersion.x20241113,
                "2025-04-16" => PronunciationDictsDeleteCartesiaVersion.x20250416,
