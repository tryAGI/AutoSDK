...
{
    /// <inheritdoc />
    public sealed class VoicesCloneCartesiaVersionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VoicesCloneCartesiaVersion>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.VoicesCloneCartesiaVersionExtensions.ToValueString(value));
        }
    }
}
