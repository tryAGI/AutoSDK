//HintName: G.Models.AgentsListCallsCartesiaVersion.g.cs
...
namespace G
{
    ...
    public static class AgentsListCallsCartesiaVersionExtensions
    {
        ...
        public static string ToValueString(this AgentsListCallsCartesiaVersion value)
        {
            return value switch
            {
                AgentsListCallsCartesiaVersion.x20240610 => "2024-06-10",
                AgentsListCallsCartesiaVersion.x20241113 => "2024-11-13",
                AgentsListCallsCartesiaVersion.x20250416 => "2025-04-16",
        ...
        public static AgentsListCallsCartesiaVersion? ToEnum(string value)
        {
            return value switch
            {
                "2024-06-10" => AgentsListCallsCartesiaVersion.x20240610,
                "2024-11-13" => AgentsListCallsCartesiaVersion.x20241113,
                "2025-04-16" => AgentsListCallsCartesiaVersion.x20250416,
