...
{
    /// <inheritdoc />
    public sealed class AgentsGetMetricCartesiaVersionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsGetMetricCartesiaVersion>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AgentsGetMetricCartesiaVersionExtensions.ToValueString(value));
        }
    }
}
