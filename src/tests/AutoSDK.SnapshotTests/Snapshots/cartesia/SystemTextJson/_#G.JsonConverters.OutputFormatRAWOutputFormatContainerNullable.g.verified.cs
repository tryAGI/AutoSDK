...
{
    /// <inheritdoc />
    public sealed class OutputFormatRAWOutputFormatContainerNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OutputFormatRAWOutputFormatContainer?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.OutputFormatRAWOutputFormatContainerExtensions.ToValueString(value.Value));
            }
        }
    }
}
