...
{
    /// <inheritdoc />
    public sealed class AgentsListMetricResultsCartesiaVersionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsListMetricResultsCartesiaVersion?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentsListMetricResultsCartesiaVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
