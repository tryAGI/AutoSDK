...
{
    /// <inheritdoc />
    public sealed class AgentsAddMetricToAgentCartesiaVersionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsAddMetricToAgentCartesiaVersion?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentsAddMetricToAgentCartesiaVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
