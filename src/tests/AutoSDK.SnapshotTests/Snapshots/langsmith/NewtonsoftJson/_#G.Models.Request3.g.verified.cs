...
namespace G
{
    ...
    public sealed partial class Request3
    {
        ...
        /// Run to create (JSON)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("post.{run_id}")]
        public byte[]? Post_runId_ { get; set; }

        /// <summary>
        /// Run to create (JSON)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("post.{run_id}name")]
        public string? Post_runId_name { get; set; }

        /// <summary>
        /// Run to update (JSON)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("patch.{run_id}")]
        public byte[]? Patch_runId_ { get; set; }

        /// <summary>
        /// Run to update (JSON)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("patch.{run_id}name")]
        public string? Patch_runId_name { get; set; }

        /// <summary>
        /// Large inputs object (JSON) stored out‑of‑band
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("post.{run_id}.inputs")]
        public byte[]? Post_runId_Inputs { get; set; }

        /// <summary>
        /// Large inputs object (JSON) stored out‑of‑band
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("post.{run_id}.inputsname")]
        public string? Post_runId_Inputsname { get; set; }

        /// <summary>
        /// Large outputs object (JSON) stored out‑of‑band
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("patch.{run_id}.outputs")]
        public byte[]? Patch_runId_Outputs { get; set; }

        /// <summary>
        /// Large outputs object (JSON) stored out‑of‑band
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("patch.{run_id}.outputsname")]
        public string? Patch_runId_Outputsname { get; set; }

        /// <summary>
        /// Feedback object (JSON) – must include trace_id
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("feedback.{run_id}")]
        public byte[]? Feedback_runId_ { get; set; }

        /// <summary>
        /// Feedback object (JSON) – must include trace_id
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("feedback.{run_id}name")]
        public string? Feedback_runId_name { get; set; }

        /// <summary>
        /// Binary attachment linked to run {run_id}
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("attachment.{run_id}.{filename}")]
