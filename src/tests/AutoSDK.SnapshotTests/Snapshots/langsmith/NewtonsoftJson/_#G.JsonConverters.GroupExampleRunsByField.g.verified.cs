...
{
    /// <inheritdoc />
    public sealed class GroupExampleRunsByFieldJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GroupExampleRunsByField>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GroupExampleRunsByFieldExtensions.ToValueString(value));
        }
    }
}
