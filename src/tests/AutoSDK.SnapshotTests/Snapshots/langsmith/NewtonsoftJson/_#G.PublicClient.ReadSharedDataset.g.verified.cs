...
namespace G
{
    public partial class PublicClient
    {
        ...
        {
            var __response = await ReadSharedDatasetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DatasetPublicSchema>> ReadSharedDatasetAsResponseAsync(
            global::System.Guid shareToken,
            int? offset = default,
            int? limit = default,
            global::G.SortByDatasetColumn? sortBy = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReadSharedDataset",
                                methodName: "ReadSharedDatasetAsync",
                                pathTemplate: "$\"/api/v1/public/{shareToken}/datasets\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DatasetPublicSchema.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DatasetPublicSchema>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DatasetPublicSchema.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
