...
namespace G
{
    public partial class FeedbackClient
    {
        ...
        {
            var __response = await CreateFeedbackWithTokenPostAsResponseAsync(
                token: token,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> CreateFeedbackWithTokenPostAsResponseAsync(
            global::System.Guid token,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateFeedbackWithTokenPost",
                                methodName: "CreateFeedbackWithTokenPostAsync",
                                pathTemplate: "$\"/api/v1/feedback/tokens/{token}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
