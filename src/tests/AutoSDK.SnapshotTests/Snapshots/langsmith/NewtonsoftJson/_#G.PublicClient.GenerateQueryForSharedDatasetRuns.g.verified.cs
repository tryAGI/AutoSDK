...
namespace G
{
    public partial class PublicClient
    {
        ...
        {
            var __response = await GenerateQueryForSharedDatasetRunsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ResponseBodyForRunsGenerateQuery>> GenerateQueryForSharedDatasetRunsAsResponseAsync(
            global::System.Guid shareToken,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateQueryForSharedDatasetRuns",
                                methodName: "GenerateQueryForSharedDatasetRunsAsync",
                                pathTemplate: "$\"/api/v1/public/{shareToken}/datasets/runs/generate-query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ResponseBodyForRunsGenerateQuery.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ResponseBodyForRunsGenerateQuery>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ResponseBodyForRunsGenerateQuery.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
