//HintName: G.Models.PatchDatasetsExamplesRequest.g.cs
...
namespace G
{
    ...
    public sealed partial class PatchDatasetsExamplesRequest
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("{example_id}.inputs")]
        public byte[]? x_exampleId_Inputs { get; set; }

        /// <summary>
        /// The updated Example inputs as JSON
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("{example_id}.inputsname")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("{example_id}.attachments_operations")]
        public byte[]? x_exampleId_AttachmentsOperations { get; set; }

        /// <summary>
        /// JSON describing attachment operations (retain, rename)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("{example_id}.attachments_operationsname")]
        public string? x_exampleId_AttachmentsOperationsname { get; set; }

        /// <summary>
        /// New file attachment named {name}
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("{example_id}.attachment.{name}")]
        public byte[]? x_exampleId_Attachment_name_ { get; set; }

        /// <summary>
        /// New file attachment named {name}
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("{example_id}.attachment.{name}name")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchDatasetsExamplesRequest" /> class.
        /// </summary>
        ...
        /// New file attachment named {name}
        /// </param>
        public PatchDatasetsExamplesRequest(
            byte[] x_exampleId_,
