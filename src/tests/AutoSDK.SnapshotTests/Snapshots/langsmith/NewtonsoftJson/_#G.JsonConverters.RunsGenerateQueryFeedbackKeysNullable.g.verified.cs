...
{
    /// <inheritdoc />
    public sealed class RunsGenerateQueryFeedbackKeysNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RunsGenerateQueryFeedbackKeys?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RunsGenerateQueryFeedbackKeysExtensions.ToValueString(value.Value));
            }
        }
    }
}
