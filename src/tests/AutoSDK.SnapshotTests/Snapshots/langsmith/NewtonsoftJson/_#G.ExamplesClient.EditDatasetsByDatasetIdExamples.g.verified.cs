...
namespace G
{
    public partial class ExamplesClient
    {
        ...
        {
            await EditDatasetsByDatasetIdExamplesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> EditDatasetsByDatasetIdExamplesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                __httpRequest.VersionPolicy = global::System.Net.Http.HttpVersionPolicy.RequestVersionOrHigher;
                            ...
                            __contentx_exampleId_.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.x_exampleId_name is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.x_exampleId_name) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                            ...
                            if (request.x_exampleId_Inputs != default)
                            {
                                ...
                                __contentx_exampleId_Inputs.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Inputsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Inputsname) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                            ...
                            if (request.x_exampleId_Outputs != default)
                            {
                                ...
                                __contentx_exampleId_Outputs.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Outputsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Outputsname) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                            ...
                            if (request.x_exampleId_AttachmentsOperations != default)
                            {
                                ...
                                __contentx_exampleId_AttachmentsOperations.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_AttachmentsOperationsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_AttachmentsOperationsname) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
                            ...
                            if (request.x_exampleId_Attachment_name_ != default)
                            {
                                ...
                                __contentx_exampleId_Attachment_name_.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Attachment_name_name is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Attachment_name_name) ?? string.Empty).ToLowerInvariant() switch
                                        {
                                            ".aac" => "audio/aac",
                                            ".flac" => "audio/flac",
                                            ".gif" => "image/gif",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            x_exampleId_ = x_exampleId_ ?? throw new global::System.ArgumentNullException(nameof(x_exampleId_));
            var request = new global::G.PatchDatasetsExamplesRequest
            {
                x_exampleId_ = global::System.Array.Empty<byte>(),
                x_exampleId_name = x_exampleId_name,
                x_exampleId_Inputs = global::System.Array.Empty<byte>(),
                x_exampleId_Inputsname = x_exampleId_Inputsname,
                x_exampleId_Outputs = global::System.Array.Empty<byte>(),
                x_exampleId_Outputsname = x_exampleId_Outputsname,
                x_exampleId_AttachmentsOperations = global::System.Array.Empty<byte>(),
                x_exampleId_AttachmentsOperationsname = x_exampleId_AttachmentsOperationsname,
                x_exampleId_Attachment_name_ = global::System.Array.Empty<byte>(),
                x_exampleId_Attachment_name_name = x_exampleId_Attachment_name_name,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                __httpRequest.VersionPolicy = global::System.Net.Http.HttpVersionPolicy.RequestVersionOrHigher;
                            ...
                            var __httpRequestContent = new global::System.Net.Http.MultipartFormDataContent();
                            var __contentx_exampleId_ = new global::System.Net.Http.StreamContent(x_exampleId_);
                            __contentx_exampleId_.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.x_exampleId_name is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.x_exampleId_name) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (x_exampleId_Inputs != default)
                            {

                                var __contentx_exampleId_Inputs = new global::System.Net.Http.StreamContent(x_exampleId_Inputs);
                                __contentx_exampleId_Inputs.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Inputsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Inputsname) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (x_exampleId_Outputs != default)
                            {

                                var __contentx_exampleId_Outputs = new global::System.Net.Http.StreamContent(x_exampleId_Outputs);
                                __contentx_exampleId_Outputs.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Outputsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Outputsname) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (x_exampleId_AttachmentsOperations != default)
                            {

                                var __contentx_exampleId_AttachmentsOperations = new global::System.Net.Http.StreamContent(x_exampleId_AttachmentsOperations);
                                __contentx_exampleId_AttachmentsOperations.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_AttachmentsOperationsname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_AttachmentsOperationsname) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (x_exampleId_Attachment_name_ != default)
                            {

                                var __contentx_exampleId_Attachment_name_ = new global::System.Net.Http.StreamContent(x_exampleId_Attachment_name_);
                                __contentx_exampleId_Attachment_name_.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.x_exampleId_Attachment_name_name is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.x_exampleId_Attachment_name_name) ?? string.Empty).ToLowerInvariant() switch
