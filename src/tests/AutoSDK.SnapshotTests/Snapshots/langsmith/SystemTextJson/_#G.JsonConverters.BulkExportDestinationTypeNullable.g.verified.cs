...
{
    /// <inheritdoc />
    public sealed class BulkExportDestinationTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BulkExportDestinationType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.BulkExportDestinationTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
