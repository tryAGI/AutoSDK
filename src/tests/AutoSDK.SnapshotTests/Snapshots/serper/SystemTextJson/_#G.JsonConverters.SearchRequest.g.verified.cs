//HintName: G.JsonConverters.SearchRequest.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class SearchRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SearchRequest>
    {
        /// <inheritdoc />
        public override global::G.SearchRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.SearchRequestVariant2? searchRequestVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.SearchRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.SearchRequestVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.SearchRequestVariant2).Name}");
            ...
            var __value = new global::G.SearchRequest(
                @base,
