...
{
    /// <inheritdoc />
    public sealed class TranscriptBoostParamNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TranscriptBoostParam?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TranscriptBoostParamExtensions.ToValueString(value.Value));
            }
        }
    }
}
