...
{
    /// <inheritdoc />
    public sealed class SpeechModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SpeechModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SpeechModelExtensions.ToValueString(value));
        }
    }
}
