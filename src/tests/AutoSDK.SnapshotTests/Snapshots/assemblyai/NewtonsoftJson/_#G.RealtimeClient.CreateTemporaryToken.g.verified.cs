//HintName: G.RealtimeClient.CreateTemporaryToken.g.cs
...
namespace G
{
    public partial class RealtimeClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateTemporaryTokenSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateTemporaryTokenSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CreateTemporaryTokenSecurityRequirement0,
            };
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTemporaryTokenSecurityRequirements,
                operationName: "CreateTemporaryTokenAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateTemporaryTokenAsync",
                                pathTemplate: "\"/v2/realtime/token\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.RealtimeTemporaryTokenResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
