//HintName: G.BatchesClient.CreateBatch.g.cs
...
namespace G
{
    public partial class BatchesClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.DataResponseBatchId> CreateBatchAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.DataResponseBatchId.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.DataResponseBatchId.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
