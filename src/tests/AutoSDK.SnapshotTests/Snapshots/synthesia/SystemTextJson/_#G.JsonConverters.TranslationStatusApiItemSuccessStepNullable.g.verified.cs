...
{
    /// <inheritdoc />
    public sealed class TranslationStatusApiItemSuccessStepNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TranslationStatusApiItemSuccessStep?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TranslationStatusApiItemSuccessStepExtensions.ToValueString(value.Value));
            }
        }
    }
}
