...
{
    /// <inheritdoc />
    public sealed class UpdateVideoMetadataRequestVisibilityNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateVideoMetadataRequestVisibility?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateVideoMetadataRequestVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
