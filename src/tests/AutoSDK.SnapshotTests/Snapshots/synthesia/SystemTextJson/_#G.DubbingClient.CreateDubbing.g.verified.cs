...
namespace G
{
    public partial class DubbingClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateDubbingSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateDubbingSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CreateDubbingProjectApiResponseSuccess>> CreateDubbingAsResponseAsync(
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.OneOf<global::G.CreateDubbingProjectApiResponseFail, global::G.CreateDubbingResponse2>? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.OneOf<global::G.CreateDubbingProjectApiResponseFail, global::G.CreateDubbingResponse2>.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.OneOf<global::G.CreateDubbingProjectApiResponseFail, global::G.CreateDubbingResponse2>?>(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                global::G.CreateDubbingResponse3? __value_501 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_501 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_501 = global::G.CreateDubbingResponse3.FromJson(__content_501, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_501 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.CreateDubbingResponse3>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CreateDubbingProjectApiResponseSuccess.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CreateDubbingProjectApiResponseSuccess>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CreateDubbingProjectApiResponseSuccess.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
