...
{
    /// <inheritdoc />
    public sealed class InputVideoBackgroundSettingsShortBackgroundContentMatchModeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InputVideoBackgroundSettingsShortBackgroundContentMatchMode>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.InputVideoBackgroundSettingsShortBackgroundContentMatchModeExtensions.ToValueString(value));
        }
    }
}
