...
{
    /// <inheritdoc />
    public sealed class VideoResponseVisibilityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VideoResponseVisibility?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VideoResponseVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
