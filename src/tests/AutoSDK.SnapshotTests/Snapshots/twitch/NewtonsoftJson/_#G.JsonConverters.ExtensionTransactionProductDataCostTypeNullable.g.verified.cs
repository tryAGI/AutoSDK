...
{
    /// <inheritdoc />
    public sealed class ExtensionTransactionProductDataCostTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExtensionTransactionProductDataCostType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExtensionTransactionProductDataCostTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
