...
{
    /// <inheritdoc />
    public sealed class SendChatAnnouncementBodyColorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SendChatAnnouncementBodyColor?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SendChatAnnouncementBodyColorExtensions.ToValueString(value.Value));
            }
        }
    }
}
