...
{
    /// <inheritdoc />
    public sealed class ExtensionTransactionProductTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExtensionTransactionProductType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ExtensionTransactionProductTypeExtensions.ToValueString(value));
        }
    }
}
