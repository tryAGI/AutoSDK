...
{
    /// <inheritdoc />
    public sealed class GetCustomRewardRedemptionStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetCustomRewardRedemptionStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetCustomRewardRedemptionStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
