...
namespace G
{
    public partial class ExtensionsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetExtensionBitsProductsSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetExtensionBitsProductsSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetExtensionBitsProductsSecurityRequirement0,
            };
        ...
        {
            var __response = await GetExtensionBitsProductsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetExtensionBitsProductsResponse>> GetExtensionBitsProductsAsResponseAsync(
            bool? shouldIncludeAll = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetExtensionBitsProductsSecurityRequirements,
                operationName: "GetExtensionBitsProductsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetExtensionBitsProductsAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetExtensionBitsProductsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetExtensionBitsProductsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetExtensionBitsProductsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
