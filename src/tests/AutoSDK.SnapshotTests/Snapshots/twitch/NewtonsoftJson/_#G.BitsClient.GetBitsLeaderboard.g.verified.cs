...
namespace G
{
    public partial class BitsClient
    {
        ...
        {
            var __response = await GetBitsLeaderboardAsResponseAsync(
                count: count,
                period: period,
                startedAt: startedAt,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetBitsLeaderboardResponse>> GetBitsLeaderboardAsResponseAsync(
            int? count = default,
            global::G.GetBitsLeaderboardPeriod? period = default,
            global::System.DateTime? startedAt = default,
            string? userId = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetBitsLeaderboardAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetBitsLeaderboardResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetBitsLeaderboardResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetBitsLeaderboardResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
