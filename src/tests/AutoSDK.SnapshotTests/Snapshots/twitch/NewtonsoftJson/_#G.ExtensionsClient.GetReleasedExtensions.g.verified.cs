...
namespace G
{
    public partial class ExtensionsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetReleasedExtensionsSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetReleasedExtensionsSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetReleasedExtensionsSecurityRequirement0,
            };
        ...
        {
            var __response = await GetReleasedExtensionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetReleasedExtensionsResponse>> GetReleasedExtensionsAsResponseAsync(
            string extensionId,
            string? extensionVersion = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetReleasedExtensionsSecurityRequirements,
                operationName: "GetReleasedExtensionsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetReleasedExtensionsAsync",
                                pathTemplate: "\"/extensions/released\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetReleasedExtensionsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetReleasedExtensionsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetReleasedExtensionsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
