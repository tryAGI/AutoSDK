...
{
    /// <inheritdoc />
    public sealed class SetExtensionConfigurationSegmentBodySegmentNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SetExtensionConfigurationSegmentBodySegment?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SetExtensionConfigurationSegmentBodySegmentExtensions.ToValueString(value.Value));
            }
        }
    }
}
