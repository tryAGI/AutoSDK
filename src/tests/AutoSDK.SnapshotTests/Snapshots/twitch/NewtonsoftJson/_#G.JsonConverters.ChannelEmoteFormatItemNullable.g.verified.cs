...
{
    /// <inheritdoc />
    public sealed class ChannelEmoteFormatItemNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChannelEmoteFormatItem?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChannelEmoteFormatItemExtensions.ToValueString(value.Value));
            }
        }
    }
}
