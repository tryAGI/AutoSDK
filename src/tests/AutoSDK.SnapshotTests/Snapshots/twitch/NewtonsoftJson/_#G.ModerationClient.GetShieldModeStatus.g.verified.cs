...
namespace G
{
    public partial class ModerationClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetShieldModeStatusSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetShieldModeStatusSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetShieldModeStatusSecurityRequirement0,
            };
        ...
        {
            var __response = await GetShieldModeStatusAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetShieldModeStatusResponse>> GetShieldModeStatusAsResponseAsync(
            string broadcasterId,
            string moderatorId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetShieldModeStatusSecurityRequirements,
                operationName: "GetShieldModeStatusAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetShieldModeStatus",
                                methodName: "GetShieldModeStatusAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetShieldModeStatusResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetShieldModeStatusResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetShieldModeStatusResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
