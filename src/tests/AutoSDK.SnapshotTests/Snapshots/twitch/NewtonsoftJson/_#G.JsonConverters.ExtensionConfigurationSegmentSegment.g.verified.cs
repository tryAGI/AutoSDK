...
{
    /// <inheritdoc />
    public sealed class ExtensionConfigurationSegmentSegmentJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExtensionConfigurationSegmentSegment>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ExtensionConfigurationSegmentSegmentExtensions.ToValueString(value));
        }
    }
}
