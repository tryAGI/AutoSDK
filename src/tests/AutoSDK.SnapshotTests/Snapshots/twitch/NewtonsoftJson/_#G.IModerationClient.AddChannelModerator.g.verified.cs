//HintName: G.IModerationClient.AddChannelModerator.g.cs
#nullable enable
...
namespace G
{
    public partial interface IModerationClient
    {
        ...
        global::System.Threading.Tasks.Task AddChannelModeratorAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> AddChannelModeratorAsResponseAsync(
            string broadcasterId,
            string userId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
