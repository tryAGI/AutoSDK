...
namespace G
{
    public partial class StreamsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetStreamMarkersSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetStreamMarkersSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetStreamMarkersSecurityRequirement0,
            };
        ...
        {
            var __response = await GetStreamMarkersAsResponseAsync(
                userId: userId,
                videoId: videoId,
                first: first,
                before: before,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetStreamMarkersResponse>> GetStreamMarkersAsResponseAsync(
            string? userId = default,
            string? videoId = default,
            string? first = default,
            string? before = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetStreamMarkersSecurityRequirements,
                operationName: "GetStreamMarkersAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetStreamMarkersAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetStreamMarkersResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetStreamMarkersResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetStreamMarkersResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
