...
{
    /// <inheritdoc />
    public sealed class GetCustomRewardRedemptionSortJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetCustomRewardRedemptionSort>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetCustomRewardRedemptionSortExtensions.ToValueString(value));
        }
    }
}
