...
{
    /// <inheritdoc />
    public sealed class GlobalEmoteFormatItemJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GlobalEmoteFormatItem>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GlobalEmoteFormatItemExtensions.ToValueString(value));
        }
    }
}
