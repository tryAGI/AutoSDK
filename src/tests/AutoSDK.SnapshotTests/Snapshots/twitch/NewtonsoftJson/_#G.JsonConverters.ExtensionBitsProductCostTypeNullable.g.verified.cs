...
{
    /// <inheritdoc />
    public sealed class ExtensionBitsProductCostTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExtensionBitsProductCostType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExtensionBitsProductCostTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
