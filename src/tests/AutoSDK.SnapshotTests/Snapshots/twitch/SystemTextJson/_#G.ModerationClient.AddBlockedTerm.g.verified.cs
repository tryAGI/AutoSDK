...
namespace G
{
    public partial class ModerationClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_AddBlockedTermSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_AddBlockedTermSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_AddBlockedTermSecurityRequirement0,
            };
        ...
        {
            var __response = await AddBlockedTermAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AddBlockedTermResponse>> AddBlockedTermAsResponseAsync(
            string broadcasterId,
            string moderatorId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddBlockedTermSecurityRequirements,
                operationName: "AddBlockedTermAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddBlockedTerm",
                                methodName: "AddBlockedTermAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AddBlockedTermResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AddBlockedTermResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AddBlockedTermResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
