...
namespace G
{
    public partial class ModerationClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CheckAutomodStatusSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CheckAutomodStatusSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CheckAutomodStatusSecurityRequirement0,
            };
        ...
        {
            var __response = await CheckAutomodStatusAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CheckAutoModStatusResponse>> CheckAutomodStatusAsResponseAsync(
            string broadcasterId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CheckAutomodStatusSecurityRequirements,
                operationName: "CheckAutomodStatusAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CheckAutomodStatus",
                                methodName: "CheckAutomodStatusAsync",
                                pathTemplate: "\"/moderation/enforcements/status\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CheckAutoModStatusResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CheckAutoModStatusResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CheckAutoModStatusResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
