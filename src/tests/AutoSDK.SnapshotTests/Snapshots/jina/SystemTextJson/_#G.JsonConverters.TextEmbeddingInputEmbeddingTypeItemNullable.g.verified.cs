...
{
    /// <inheritdoc />
    public sealed class TextEmbeddingInputEmbeddingTypeItemNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TextEmbeddingInputEmbeddingTypeItem?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TextEmbeddingInputEmbeddingTypeItemExtensions.ToValueString(value.Value));
            }
        }
    }
}
