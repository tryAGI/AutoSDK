//HintName: G.AdminClient.GetUserFullDetailsByUserAsAdmin.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetUserFullDetailsByUserAsAdminArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.GetUserFullDetailsByUserRequest request);
        partial void PrepareGetUserFullDetailsByUserAsAdminRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.GetUserFullDetailsByUserRequest request);
        partial void ProcessGetUserFullDetailsByUserAsAdminResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetUserFullDetailsByUserAsAdminResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetUserFullDetailsByUserAsAdminAsync(
            global::G.GetUserFullDetailsByUserRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetUserFullDetailsByUserAsAdminArguments(
            ...
            PrepareGetUserFullDetailsByUserAsAdminRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetUserFullDetailsByUserAsAdminResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetUserFullDetailsByUserAsAdminResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetUserFullDetailsByUserAsAdminAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.GetUserFullDetailsByUserRequest
            {
                UserId = userId,
            };

            return await GetUserFullDetailsByUserAsAdminAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
