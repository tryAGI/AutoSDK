//HintName: G.TrainingClient.GetTestResultsByProject.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetTestResultsByProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.GetTestResultsByProjectRequest request);
        partial void PrepareGetTestResultsByProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.GetTestResultsByProjectRequest request);
        partial void ProcessGetTestResultsByProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTestResultsByProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.TrainingTestResult>> GetTestResultsByProjectAsync(
            global::G.GetTestResultsByProjectRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetTestResultsByProjectArguments(
            ...
            PrepareGetTestResultsByProjectRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetTestResultsByProjectResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetTestResultsByProjectResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::System.Collections.Generic.IList<global::G.TrainingTestResult>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    global::Newtonsoft.Json.JsonSerializer.Create(JsonSerializerOptions).Deserialize<global::System.Collections.Generic.IList<global::G.TrainingTestResult>?>(new global::Newtonsoft.Json.JsonTextReader(new global::System.IO.StreamReader(__content))) ??
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.TrainingTestResult>> GetTestResultsByProjectAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.GetTestResultsByProjectRequest
            {
                ProjectId = projectId,
            };

            return await GetTestResultsByProjectAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
