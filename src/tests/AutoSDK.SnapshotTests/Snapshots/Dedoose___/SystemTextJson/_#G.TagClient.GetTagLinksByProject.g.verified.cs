//HintName: G.TagClient.GetTagLinksByProject.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetTagLinksByProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.GetTagLinksByProjectRequest request);
        partial void PrepareGetTagLinksByProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.GetTagLinksByProjectRequest request);
        partial void ProcessGetTagLinksByProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTagLinksByProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.TagLink>> GetTagLinksByProjectAsync(
            global::G.GetTagLinksByProjectRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetTagLinksByProjectArguments(
            ...
            PrepareGetTagLinksByProjectRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetTagLinksByProjectResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetTagLinksByProjectResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.TagLink>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.TagLink>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.TagLink>> GetTagLinksByProjectAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.GetTagLinksByProjectRequest
            {
                ProjectId = projectId,
            };

            return await GetTagLinksByProjectAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
