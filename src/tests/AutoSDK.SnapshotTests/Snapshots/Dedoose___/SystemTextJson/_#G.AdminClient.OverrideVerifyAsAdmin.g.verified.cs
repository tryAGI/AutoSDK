//HintName: G.AdminClient.OverrideVerifyAsAdmin.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareOverrideVerifyAsAdminArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.OverrideVerifyRequest request);
        partial void PrepareOverrideVerifyAsAdminRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.OverrideVerifyRequest request);
        partial void ProcessOverrideVerifyAsAdminResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOverrideVerifyAsAdminResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> OverrideVerifyAsAdminAsync(
            global::G.OverrideVerifyRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareOverrideVerifyAsAdminArguments(
            ...
            PrepareOverrideVerifyAsAdminRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessOverrideVerifyAsAdminResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessOverrideVerifyAsAdminResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> OverrideVerifyAsAdminAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.OverrideVerifyRequest
            {
                UserId = userId,
            };

            return await OverrideVerifyAsAdminAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
