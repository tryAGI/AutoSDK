//HintName: G.TrainingClient.GetTestExcerpts.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetTestExcerptsArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.GetTestExcerptsRequest request);
        partial void PrepareGetTestExcerptsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.GetTestExcerptsRequest request);
        partial void ProcessGetTestExcerptsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTestExcerptsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.TrainingTestExcerpt>> GetTestExcerptsAsync(
            global::G.GetTestExcerptsRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetTestExcerptsArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetTestExcerptsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetTestExcerptsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.TrainingTestExcerpt>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.TrainingTestExcerpt>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.TrainingTestExcerpt>> GetTestExcerptsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.GetTestExcerptsRequest
            {
                ProjectId = projectId,
                TestId = testId,
            };

            return await GetTestExcerptsAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
