//HintName: G.DescriptorClient.GetProjectDescriptorLinks.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetProjectDescriptorLinksArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.GetProjectDescriptorLinksRequest request);
        partial void PrepareGetProjectDescriptorLinksRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.GetProjectDescriptorLinksRequest request);
        partial void ProcessGetProjectDescriptorLinksResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectDescriptorLinksResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.DescriptorLink>> GetProjectDescriptorLinksAsync(
            global::G.GetProjectDescriptorLinksRequest request,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectDescriptorLinksArguments(
            ...
            PrepareGetProjectDescriptorLinksRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetProjectDescriptorLinksResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetProjectDescriptorLinksResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.DescriptorLink>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.DescriptorLink>> GetProjectDescriptorLinksAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.GetProjectDescriptorLinksRequest
            {
                ProjectId = projectId,
            };

            return await GetProjectDescriptorLinksAsync(
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
