...
namespace G
{
    public partial class ValidateClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ValidateSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ValidateSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ValidationOutcome>> ValidateAsResponseAsync(
            string guardName,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ValidationOutcome.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ValidationOutcome>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ValidationOutcome.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
