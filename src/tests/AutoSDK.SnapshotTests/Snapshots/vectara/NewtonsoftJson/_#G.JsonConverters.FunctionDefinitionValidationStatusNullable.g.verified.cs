...
{
    /// <inheritdoc />
    public sealed class FunctionDefinitionValidationStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FunctionDefinitionValidationStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FunctionDefinitionValidationStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
