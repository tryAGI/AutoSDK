...
{
    /// <inheritdoc />
    public sealed class CreateDocumentRequestDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateDocumentRequestDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateDocumentRequestDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
