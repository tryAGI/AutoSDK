...
{
    /// <inheritdoc />
    public sealed class VertexAiAuthDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VertexAiAuthDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VertexAiAuthDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
