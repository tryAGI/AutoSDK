//HintName: G.IAgentSessionsClient.Update.g.cs
#nullable enable
...
namespace G
{
    public partial interface IAgentSessionsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.AgentSession> UpdateAsync(
            string agentKey,
            string sessionKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AgentSession>> UpdateAsResponseAsync(
            string agentKey,
            string sessionKey,
