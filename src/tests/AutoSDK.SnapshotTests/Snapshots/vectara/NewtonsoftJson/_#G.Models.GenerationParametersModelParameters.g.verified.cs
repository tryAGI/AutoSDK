...
namespace G
{
    ...
    public sealed partial class GenerationParametersModelParameters
    {
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.GenerationParametersModelParameters?> FromJsonStreamAsync(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.GenerationParametersModelParameters?>(serializer.Deserialize<global::G.GenerationParametersModelParameters>(jsonReader));
        }
