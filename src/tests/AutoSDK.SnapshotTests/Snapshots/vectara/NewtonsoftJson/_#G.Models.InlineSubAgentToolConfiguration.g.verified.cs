...
namespace G
{
    ...
    public sealed partial class InlineSubAgentToolConfiguration
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("sub_agent_configuration", Required = global::Newtonsoft.Json.Required.Always)]
        public global::G.SubAgentConfiguration SubAgentConfiguration { get; set; } = default!;
