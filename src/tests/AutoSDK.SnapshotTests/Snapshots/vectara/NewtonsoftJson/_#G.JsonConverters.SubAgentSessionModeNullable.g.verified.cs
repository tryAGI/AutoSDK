...
{
    /// <inheritdoc />
    public sealed class SubAgentSessionModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SubAgentSessionMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SubAgentSessionModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
