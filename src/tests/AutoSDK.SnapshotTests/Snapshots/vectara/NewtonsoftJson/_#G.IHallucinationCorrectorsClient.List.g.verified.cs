//HintName: G.IHallucinationCorrectorsClient.List.g.cs
#nullable enable
...
namespace G
{
    public partial interface IHallucinationCorrectorsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.ListHallucinationCorrectorsResponse> ListAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListHallucinationCorrectorsResponse>> ListAsResponseAsync(
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            string? filter = default,
            int? limit = default,
