...
namespace G
{
    public partial class UploadClient
    {
        ...
        {
            var __response = await FileAsResponseAsync(
                corpusKey: corpusKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Document>> FileAsResponseAsync(
            string corpusKey,
            ...
            if (requestTimeoutMillis != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("Request-Timeout-Millis", requestTimeoutMillis.ToString());
                            ...
                            if (request.TableExtractionConfig != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.TableExtractionConfig.ToJson(JsonSerializerOptions)),
