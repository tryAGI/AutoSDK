//HintName: G.IRerankersClient.List.g.cs
#nullable enable
...
namespace G
{
    public partial interface IRerankersClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.ListRerankersResponse> ListAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListRerankersResponse>> ListAsResponseAsync(
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            string? filter = default,
            int? limit = default,
