...
namespace G
{
    public partial class CorporaClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetFilterAttributeStatsSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetFilterAttributeStatsSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetFilterAttributeStatsSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void ProcessGetFilterAttributeStatsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetFilterAttributeStatsResponse> GetFilterAttributeStatsAsync(
            string corpusKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFilterAttributeStatsArguments(
            ...
            PrepareGetFilterAttributeStatsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetFilterAttributeStatsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetFilterAttributeStatsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.GetFilterAttributeStatsResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.GetFilterAttributeStatsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
