...
{
    /// <inheritdoc />
    public sealed class AgentRoleRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentRoleRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AgentRoleRoleExtensions.ToValueString(value));
        }
    }
}
