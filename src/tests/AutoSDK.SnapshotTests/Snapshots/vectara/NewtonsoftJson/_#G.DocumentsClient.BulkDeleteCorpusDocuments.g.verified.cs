//HintName: G.DocumentsClient.BulkDeleteCorpusDocuments.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareBulkDeleteCorpusDocumentsArguments(
            ...
            ref bool? async);
        partial void PrepareBulkDeleteCorpusDocumentsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? documentIds,
            bool? async);
        partial void ProcessBulkDeleteCorpusDocumentsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBulkDeleteCorpusDocumentsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.BulkDeleteDocumentsResponse> BulkDeleteCorpusDocumentsAsync(
            string corpusKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBulkDeleteCorpusDocumentsArguments(
            ...
            __pathBuilder
                ...
                .AddOptionalParameter("async", async?.ToString()) 
                ; 
            ...
            PrepareBulkDeleteCorpusDocumentsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessBulkDeleteCorpusDocumentsResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 504)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_504 = await global::G.Error.FromJsonStreamAsync(__contentStream_504, JsonSerializerOptions).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessBulkDeleteCorpusDocumentsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
