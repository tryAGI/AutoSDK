...
{
    /// <inheritdoc />
    public sealed class LLMOwnershipNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMOwnership?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.LLMOwnershipExtensions.ToValueString(value.Value));
            }
        }
    }
}
