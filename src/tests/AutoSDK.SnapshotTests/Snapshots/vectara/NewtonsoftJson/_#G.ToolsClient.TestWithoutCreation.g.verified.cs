...
namespace G
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TestWithoutCreationSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TestWithoutCreationSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_TestWithoutCreationSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_TestWithoutCreationSecurityRequirement0,
                s_TestWithoutCreationSecurityRequirement1,
            };
        partial void PrepareTestWithoutCreationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            global::G.TestLambdaToolRequest request);
        partial void PrepareTestWithoutCreationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            int? requestTimeoutMillis,
            global::G.TestLambdaToolRequest request);
        partial void ProcessTestWithoutCreationResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::G.TestLambdaToolResponse> TestWithoutCreationAsync(
        ...
        {
            var __response = await TestWithoutCreationAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.TestLambdaToolResponse>> TestWithoutCreationAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTestWithoutCreationArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TestWithoutCreationSecurityRequirements,
                operationName: "TestWithoutCreationAsync");
            ...
            if (requestTimeoutMillis != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTestWithoutCreationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TestWithoutCreation",
                                methodName: "TestWithoutCreationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTestWithoutCreationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTestWithoutCreationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.TestLambdaToolResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.TestLambdaToolResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.TestLambdaToolResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await TestWithoutCreationAsync(
                requestTimeout: requestTimeout,
                requestTimeoutMillis: requestTimeoutMillis,
                request: __request,
                requestOptions: requestOptions,
