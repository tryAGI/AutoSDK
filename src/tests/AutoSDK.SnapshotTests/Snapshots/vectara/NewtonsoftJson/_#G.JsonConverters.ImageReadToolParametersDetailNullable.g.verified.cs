...
{
    /// <inheritdoc />
    public sealed class ImageReadToolParametersDetailNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ImageReadToolParametersDetail?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ImageReadToolParametersDetailExtensions.ToValueString(value.Value));
            }
        }
    }
}
