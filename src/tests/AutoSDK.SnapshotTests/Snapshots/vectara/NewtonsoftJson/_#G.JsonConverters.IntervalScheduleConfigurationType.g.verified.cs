...
{
    /// <inheritdoc />
    public sealed class IntervalScheduleConfigurationTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IntervalScheduleConfigurationType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.IntervalScheduleConfigurationTypeExtensions.ToValueString(value));
        }
    }
}
