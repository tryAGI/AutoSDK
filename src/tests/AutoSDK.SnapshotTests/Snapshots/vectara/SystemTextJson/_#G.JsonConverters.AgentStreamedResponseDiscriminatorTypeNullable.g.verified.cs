...
{
    /// <inheritdoc />
    public sealed class AgentStreamedResponseDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentStreamedResponseDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentStreamedResponseDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
