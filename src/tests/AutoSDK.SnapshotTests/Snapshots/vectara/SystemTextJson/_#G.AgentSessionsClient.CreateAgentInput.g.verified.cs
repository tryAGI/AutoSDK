//HintName: G.AgentSessionsClient.CreateAgentInput.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCreateAgentInputArguments(
        ...
        partial void ProcessCreateAgentInputResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.AgentResponse> CreateAgentInputAsync(
            string agentKey,
            string sessionKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateAgentInputArguments(
            ...
            PrepareCreateAgentInputRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateAgentInputResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        __value_422 = await global::G.Error.FromJsonStreamAsync(__contentStream_422, JsonSerializerOptions).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if ((int)__response.StatusCode == 502)
            {
                ...
                try
                {
                    ...
                    {
                        var __contentStream_502 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_502 = await global::G.Error.FromJsonStreamAsync(__contentStream_502, JsonSerializerOptions).ConfigureAwait(false);
                    }
                }
                catch (global::System.Exception __ex)
                {
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateAgentInputResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.AgentResponse> CreateAgentInputAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.CreateInputRequest
            {
            };
