...
{
    /// <inheritdoc />
    public sealed class IntervalScheduleConfigurationTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.IntervalScheduleConfigurationType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.IntervalScheduleConfigurationTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
