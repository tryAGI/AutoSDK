//HintName: G.IGenerationPresetsClient.List.g.cs
#nullable enable
...
namespace G
{
    public partial interface IGenerationPresetsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.ListGenerationPresetsResponse> ListAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListGenerationPresetsResponse>> ListAsResponseAsync(
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            string? llmName = default,
            int? limit = default,
