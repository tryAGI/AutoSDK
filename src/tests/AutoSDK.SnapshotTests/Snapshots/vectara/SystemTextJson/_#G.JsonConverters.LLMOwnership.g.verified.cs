...
{
    /// <inheritdoc />
    public sealed class LLMOwnershipJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMOwnership>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.LLMOwnershipExtensions.ToValueString(value));
        }
    }
}
