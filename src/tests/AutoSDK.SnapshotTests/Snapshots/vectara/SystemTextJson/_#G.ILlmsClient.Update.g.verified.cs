//HintName: G.ILlmsClient.Update.g.cs
#nullable enable
...
namespace G
{
    public partial interface ILlmsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.Llm> UpdateAsync(
            string llmId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Llm>> UpdateAsResponseAsync(
            string llmId,
