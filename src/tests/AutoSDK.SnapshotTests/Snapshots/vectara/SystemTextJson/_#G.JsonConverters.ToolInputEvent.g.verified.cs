//HintName: G.JsonConverters.ToolInputEvent.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ToolInputEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ToolInputEvent>
    {
        /// <inheritdoc />
        public override global::G.ToolInputEvent Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ToolInputEventVariant2? toolInputEventVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ToolInputEventVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ToolInputEventVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ToolInputEventVariant2).Name}");
            ...
            var __value = new global::G.ToolInputEvent(
                agentBase,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsToolInputEventVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ToolInputEventVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ToolInputEventVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ToolInputEventVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ToolInputEventVariant2!, typeInfo);
            }
        }
    }
}