...
{
    /// <inheritdoc />
    public sealed class TemplatedReminderHookNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TemplatedReminderHook?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TemplatedReminderHookExtensions.ToValueString(value.Value));
            }
        }
    }
}
