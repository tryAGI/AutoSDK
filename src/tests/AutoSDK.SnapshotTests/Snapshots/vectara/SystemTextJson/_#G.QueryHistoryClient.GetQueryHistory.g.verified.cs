//HintName: G.QueryHistoryClient.GetQueryHistory.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetQueryHistoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string queryId);
        partial void PrepareGetQueryHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            int? requestTimeoutMillis,
            string queryId);
        partial void ProcessGetQueryHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetQueryHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.QueryHistory> GetQueryHistoryAsync(
            string queryId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetQueryHistoryArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetQueryHistoryResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetQueryHistoryResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.QueryHistory.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.QueryHistory.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
