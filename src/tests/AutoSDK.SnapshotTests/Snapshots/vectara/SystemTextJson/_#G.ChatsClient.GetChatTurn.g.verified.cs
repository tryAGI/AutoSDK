//HintName: G.ChatsClient.GetChatTurn.g.cs
    ...
    public partial class ChatsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::G.Turn.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.Turn.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
