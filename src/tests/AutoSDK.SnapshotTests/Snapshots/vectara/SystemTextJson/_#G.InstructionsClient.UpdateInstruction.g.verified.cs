//HintName: G.InstructionsClient.UpdateInstruction.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateInstructionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string instructionId,
            global::G.UpdateInstructionRequest request);
        partial void PrepareUpdateInstructionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            global::G.UpdateInstructionRequest request);
        partial void ProcessUpdateInstructionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateInstructionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Instruction> UpdateInstructionAsync(
            string instructionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateInstructionArguments(
            ...
            PrepareUpdateInstructionRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateInstructionResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateInstructionResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.Instruction.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.Instruction.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.Instruction> UpdateInstructionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UpdateInstructionRequest
            {
            };

            return await UpdateInstructionAsync(
                requestTimeout: requestTimeout,
                requestTimeoutMillis: requestTimeoutMillis,
                instructionId: instructionId,
                request: __request,
