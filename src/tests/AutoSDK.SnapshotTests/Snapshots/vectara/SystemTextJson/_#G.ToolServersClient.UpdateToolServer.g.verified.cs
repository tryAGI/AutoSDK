//HintName: G.ToolServersClient.UpdateToolServer.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateToolServerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string toolServerId,
            global::G.UpdateToolServerRequest request);
        partial void PrepareUpdateToolServerRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string toolServerId,
            global::G.UpdateToolServerRequest request);
        partial void ProcessUpdateToolServerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateToolServerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ToolServer> UpdateToolServerAsync(
            string toolServerId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateToolServerArguments(
            ...
            PrepareUpdateToolServerRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateToolServerResponse(
                httpClient: HttpClient,
            ...
            // Permissions do not allow updating this tool server.
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateToolServerResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.ToolServer.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.ToolServer.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.ToolServer> UpdateToolServerAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UpdateToolServerRequest
            {
                Name = name,
            ...
            return await UpdateToolServerAsync(
                requestTimeout: requestTimeout,
                requestTimeoutMillis: requestTimeoutMillis,
                toolServerId: toolServerId,
                request: __request,
