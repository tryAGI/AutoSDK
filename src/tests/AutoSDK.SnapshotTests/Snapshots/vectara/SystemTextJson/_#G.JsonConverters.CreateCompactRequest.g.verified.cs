//HintName: G.JsonConverters.CreateCompactRequest.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class CreateCompactRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateCompactRequest>
    {
        /// <inheritdoc />
        public override global::G.CreateCompactRequest Read(
        ...
        public override void Write(
            ...
            global::G.CreateCompactRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsCreateCompactRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.CreateCompactRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.CreateCompactRequestVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.CreateCompactRequestVariant2).Name}");
                var __element1 = global::System.Text.Json.JsonSerializer.SerializeToElement(value.CreateCompactRequestVariant2!, typeInfo);
