...
{
    /// <inheritdoc />
    public sealed class ParallelThinkingConfigModeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ParallelThinkingConfigMode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ParallelThinkingConfigModeExtensions.ToValueString(value));
        }
    }
}
