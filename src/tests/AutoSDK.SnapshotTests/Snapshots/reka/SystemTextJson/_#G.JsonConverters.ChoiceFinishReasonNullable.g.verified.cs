...
{
    /// <inheritdoc />
    public sealed class ChoiceFinishReasonNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChoiceFinishReason?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ChoiceFinishReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
