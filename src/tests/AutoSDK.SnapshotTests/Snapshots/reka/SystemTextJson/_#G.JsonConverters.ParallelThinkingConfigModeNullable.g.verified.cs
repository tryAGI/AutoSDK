...
{
    /// <inheritdoc />
    public sealed class ParallelThinkingConfigModeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ParallelThinkingConfigMode?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ParallelThinkingConfigModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
