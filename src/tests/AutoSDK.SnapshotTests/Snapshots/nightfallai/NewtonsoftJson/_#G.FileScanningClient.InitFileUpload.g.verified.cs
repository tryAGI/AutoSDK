//HintName: G.FileScanningClient.InitFileUpload.g.cs
...
namespace G
{
    public partial class FileScanningClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_InitFileUploadSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_InitFileUploadSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.InitFileUploadResponse> InitFileUploadAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.InitFileUploadResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.InitFileUploadResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
