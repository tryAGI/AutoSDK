//HintName: G.Models.EmbeddingsApiRequest.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class EmbeddingsApiRequest
    {
        /// <summary>
        ...
        /// Default Value: openapi-json-null-sentinel-value-2BF93600-0FE4-4250-987A-E5DDB203E464
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("output_dimension")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddingsApiRequest" /> class.
        /// </summary>
        /// <param name="input">
        /// A single text string, or a list of texts as a list of strings, such as `["I like cats", "I also like dogs"]`. Currently, we have two constraints on the list: &lt;ul&gt;  &lt;li&gt; The maximum length of the list is 128. &lt;/li&gt;  &lt;li&gt; The total number of tokens in the list is at most 1M for `voyage-3-lite`; 320K for `voyage-3` and `voyage-2`; and 120K for `voyage-3-large`, `voyage-code-3`, `voyage-large-2-instruct`, `voyage-finance-2`, `voyage-multilingual-2`, `voyage-law-2`, and `voyage-large-2`. &lt;/li&gt; &lt;ul&gt;
        /// </param>
        ...
        public EmbeddingsApiRequest(
            ...
            string model,
            global::G.EmbeddingsApiRequestInputType? inputType,
            bool? truncation,
            int? outputDimension,
            global::G.EmbeddingsApiRequestOutputDtype? outputDtype,
            global::G.EmbeddingsApiRequestEncodingFormat? encodingFormat)
        {
            this.Input = input;
