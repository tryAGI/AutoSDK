...
{
    /// <inheritdoc />
    public sealed class EmbeddingsApiRequestOutputDtypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EmbeddingsApiRequestOutputDtype>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.EmbeddingsApiRequestOutputDtypeExtensions.ToValueString(value));
        }
    }
}
