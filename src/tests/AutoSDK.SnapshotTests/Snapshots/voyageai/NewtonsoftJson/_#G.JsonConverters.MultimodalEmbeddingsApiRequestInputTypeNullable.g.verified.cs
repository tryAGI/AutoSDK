...
{
    /// <inheritdoc />
    public sealed class MultimodalEmbeddingsApiRequestInputTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MultimodalEmbeddingsApiRequestInputType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MultimodalEmbeddingsApiRequestInputTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
