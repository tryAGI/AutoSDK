...
{
    /// <inheritdoc />
    public sealed class EmbeddingsApiRequestOutputDtypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EmbeddingsApiRequestOutputDtype?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.EmbeddingsApiRequestOutputDtypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
