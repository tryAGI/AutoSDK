...
{
    /// <inheritdoc />
    public sealed class MultimodalEmbeddingsApiRequestInputTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MultimodalEmbeddingsApiRequestInputType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.MultimodalEmbeddingsApiRequestInputTypeExtensions.ToValueString(value));
        }
    }
}
