...
namespace G
{
    ...
    public sealed partial class StreamingStartRequestSdp
    {
        ...
        public static global::G.StreamingStartRequestSdp? FromJson(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            return global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.StreamingStartRequestSdp>(
                json,
                jsonSerializerOptions);
        }
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.StreamingStartRequestSdp?> FromJsonStream(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.StreamingStartRequestSdp?>(serializer.Deserialize<global::G.StreamingStartRequestSdp>(jsonReader));
        }
