//HintName: G.CreateVideoAPIClient.g.cs
...
namespace G
{
    ...
    /// **Guide**: [https://docs.heygen.com/docs/create-video&lt;br&gt;](https://docs.heygen.com/docs/create-video)**Reference**: [https://docs.heygen.com/reference/create-an-avatar-video-v2](https://docs.heygen.com/reference/create-an-avatar-video-v2)<br/>
