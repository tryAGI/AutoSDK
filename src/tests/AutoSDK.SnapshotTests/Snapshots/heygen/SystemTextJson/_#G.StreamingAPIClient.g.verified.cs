...
namespace G
{
    ...
    /// **Guide**: [https://docs.heygen.com/docs/streaming-api&lt;br&gt;](https://docs.heygen.com/docs/streaming-api)**Reference**: [https://docs.heygen.com/reference/new-session](https://docs.heygen.com/reference/new-session)<br/>
