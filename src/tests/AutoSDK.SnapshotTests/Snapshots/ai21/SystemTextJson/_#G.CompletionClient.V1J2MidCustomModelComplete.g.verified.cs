...
namespace G
{
    public partial class CompletionClient
    {
        ...
        {
            var __response = await V1J2MidCustomModelCompleteAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> V1J2MidCustomModelCompleteAsResponseAsync(
            string customModelName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "V1J2MidCustomModelComplete",
                                methodName: "V1J2MidCustomModelCompleteAsync",
                                pathTemplate: "$\"/studio/v1/j2-mid/{customModelName}/complete\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
