...
namespace G
{
    public partial class CompletionClient
    {
        ...
        {
            var __response = await V1J2JumboComplete2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> V1J2JumboComplete2AsResponseAsync(
            string customModelName,
