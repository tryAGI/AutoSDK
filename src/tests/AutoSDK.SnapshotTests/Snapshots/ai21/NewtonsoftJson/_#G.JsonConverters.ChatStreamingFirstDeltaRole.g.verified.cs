...
{
    /// <inheritdoc />
    public sealed class ChatStreamingFirstDeltaRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatStreamingFirstDeltaRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatStreamingFirstDeltaRoleExtensions.ToValueString(value));
        }
    }
}
