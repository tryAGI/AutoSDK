...
namespace G
{
    public partial class Api
    {
        ...
        {
            var __response = await GenerateOrgTokenStudioV1ConnectorsConnectedUsersOrganizationIdTokensPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ConnectorsToken>> GenerateOrgTokenStudioV1ConnectorsConnectedUsersOrganizationIdTokensPostAsResponseAsync(
            string organizationId,
            int? requestStartTime = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GenerateOrgTokenStudioV1ConnectorsConnectedUsersOrganizationIdTokensPost",
                                methodName: "GenerateOrgTokenStudioV1ConnectorsConnectedUsersOrganizationIdTokensPostAsync",
                                pathTemplate: "$\"/studio/v1/connectors/connected-users/{organizationId}/tokens\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ConnectorsToken.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ConnectorsToken>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ConnectorsToken.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
