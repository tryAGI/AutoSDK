...
namespace G
{
    public partial class ParaphraseClient
    {
        ...
        {
            var __response = await V1ParaphrazeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> V1ParaphrazeAsResponseAsync(
