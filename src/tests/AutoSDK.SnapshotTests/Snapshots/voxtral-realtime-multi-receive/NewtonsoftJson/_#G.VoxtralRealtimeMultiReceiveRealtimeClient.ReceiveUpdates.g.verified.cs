//HintName: G.VoxtralRealtimeMultiReceiveRealtimeClient.ReceiveUpdates.g.cs
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    ...
                    try
                    {
                        @event = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ServerEvent>(json, JsonSerializerOptions);
                    }
            ...
            string rawText)
        {
            ...
            if (@event.TranscriptionLanguage is { } __TranscriptionStreamLanguageReceived)
            {
                TranscriptionStreamLanguageReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.TranscriptionStreamLanguage>(
            ...
            if (@event.TranscriptionTextDelta is { } __TranscriptionStreamTextDeltaReceived)
            {
                TranscriptionStreamTextDeltaReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.TranscriptionStreamTextDelta>(
            ...
            if (@event.SessionCreated is { } __RealtimeTranscriptionSessionCreatedReceived)
            {
                RealtimeTranscriptionSessionCreatedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.RealtimeTranscriptionSessionCreated>(
            ...
            if (@event.Error is { } __RealtimeTranscriptionErrorReceived)
            {
                RealtimeTranscriptionErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.RealtimeTranscriptionError>(
