...
{
    /// <inheritdoc />
    public sealed class TranscriptionStreamTextDeltaTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TranscriptionStreamTextDeltaType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TranscriptionStreamTextDeltaTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
