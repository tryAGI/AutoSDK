...
{
    /// <inheritdoc />
    public sealed class TranscriptionStreamTextDeltaTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TranscriptionStreamTextDeltaType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TranscriptionStreamTextDeltaTypeExtensions.ToValueString(value));
        }
    }
}
