    ...
    public partial class StreamsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/streams?{string.Join("&", userId?.Select(static x => $"userId={x}") ?? global::System.Array.Empty<string>())}&{string.Join("&", userLogin?.Select(static x => $"userLogin={x}") ?? global::System.Array.Empty<string>())}&{string.Join("&", gameId?.Select(static x => $"gameId={x}") ?? global::System.Array.Empty<string>())}&type={(global::System.Uri.EscapeDataString(typeValue?.ToString() ?? string.Empty))}&{string.Join("&", language?.Select(static x => $"language={x}") ?? global::System.Array.Empty<string>())}&first={first}&before={before}&after={after}", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.GetStreamsResponse?>(__content, JsonSerializerOptions) ??
