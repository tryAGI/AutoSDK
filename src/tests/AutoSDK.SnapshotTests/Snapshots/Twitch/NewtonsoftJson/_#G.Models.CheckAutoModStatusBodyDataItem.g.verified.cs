...
namespace G
{
    ...
    public sealed partial class CheckAutoModStatusBodyDataItem
    {
        ...
        public static global::G.CheckAutoModStatusBodyDataItem? FromJson(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            return global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.CheckAutoModStatusBodyDataItem>(
                json,
                jsonSerializerOptions);
        }
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.CheckAutoModStatusBodyDataItem?> FromJsonStream(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.CheckAutoModStatusBodyDataItem?>(serializer.Deserialize<global::G.CheckAutoModStatusBodyDataItem>(jsonReader));
        }
