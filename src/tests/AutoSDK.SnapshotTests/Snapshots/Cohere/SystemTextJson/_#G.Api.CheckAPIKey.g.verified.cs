            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                else
                {
                    ...
                    __value_400 = await global::G.CheckAPIKeyResponse2.FromJsonStreamAsync(__contentStream_400, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                else
                {
                    ...
                    __value_401 = await global::G.CheckAPIKeyResponse3.FromJsonStreamAsync(__contentStream_401, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 403)
            {
                ...
                else
                {
                    ...
                    __value_403 = await global::G.CheckAPIKeyResponse4.FromJsonStreamAsync(__contentStream_403, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                else
                {
                    ...
                    __value_404 = await global::G.CheckAPIKeyResponse5.FromJsonStreamAsync(__contentStream_404, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                else
                {
                    ...
                    __value_422 = await global::G.CheckAPIKeyResponse6.FromJsonStreamAsync(__contentStream_422, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                else
                {
                    ...
                    __value_429 = await global::G.CheckAPIKeyResponse7.FromJsonStreamAsync(__contentStream_429, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 498)
            {
                ...
                else
                {
                    ...
                    __value_498 = await global::G.CheckAPIKeyResponse8.FromJsonStreamAsync(__contentStream_498, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 499)
            {
                ...
                else
                {
                    ...
                    __value_499 = await global::G.CheckAPIKeyResponse9.FromJsonStreamAsync(__contentStream_499, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                else
                {
                    ...
                    __value_500 = await global::G.CheckAPIKeyResponse10.FromJsonStreamAsync(__contentStream_500, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 501)
            {
                ...
                else
                {
                    ...
                    __value_501 = await global::G.CheckAPIKeyResponse11.FromJsonStreamAsync(__contentStream_501, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                else
                {
                    ...
                    __value_503 = await global::G.CheckAPIKeyResponse12.FromJsonStreamAsync(__contentStream_503, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 504)
            {
                ...
                else
                {
                    ...
                    __value_504 = await global::G.CheckAPIKeyResponse13.FromJsonStreamAsync(__contentStream_504, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                var __responseValue = await global::G.CheckAPIKeyResponse.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
