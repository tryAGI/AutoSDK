...
namespace G
{
    ...
    public sealed partial class EmbedByTypeResponse
    {
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.EmbedByTypeResponse?> FromJsonStream(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.EmbedByTypeResponse?>(serializer.Deserialize<global::G.EmbedByTypeResponse>(jsonReader));
        }
