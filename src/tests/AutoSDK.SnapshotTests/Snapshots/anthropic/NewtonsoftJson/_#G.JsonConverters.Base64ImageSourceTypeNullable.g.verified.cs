...
{
    /// <inheritdoc />
    public sealed class Base64ImageSourceTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.Base64ImageSourceType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.Base64ImageSourceTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
