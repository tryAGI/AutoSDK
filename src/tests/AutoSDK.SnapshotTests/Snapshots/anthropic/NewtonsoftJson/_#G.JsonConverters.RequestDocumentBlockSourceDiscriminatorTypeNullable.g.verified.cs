...
{
    /// <inheritdoc />
    public sealed class RequestDocumentBlockSourceDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RequestDocumentBlockSourceDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RequestDocumentBlockSourceDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
