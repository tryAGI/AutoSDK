...
{
    /// <inheritdoc />
    public sealed class BetaPermissionErrorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaPermissionErrorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaPermissionErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
