...
{
    /// <inheritdoc />
    public sealed class BetaRateLimitErrorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaRateLimitErrorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaRateLimitErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
