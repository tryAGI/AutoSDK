...
{
    /// <inheritdoc />
    public sealed class BetaContentBlockDeltaEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaContentBlockDeltaEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaContentBlockDeltaEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
