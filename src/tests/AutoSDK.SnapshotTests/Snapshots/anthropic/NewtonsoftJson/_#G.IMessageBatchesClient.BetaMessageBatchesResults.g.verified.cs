//HintName: G.IMessageBatchesClient.BetaMessageBatchesResults.g.cs
#nullable enable
...
namespace G
{
    public partial interface IMessageBatchesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.BetaMessageBatchIndividualResponse>> BetaMessageBatchesResultsAsResponseAsync(
            string messageBatchId,
            string? anthropicBeta = default,
            string? anthropicVersion = default,
            string? xApiKey = default,
