//HintName: G.IMessageBatchesClient.MessageBatchesList.g.cs
#nullable enable
...
namespace G
{
    public partial interface IMessageBatchesClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.ListResponseMessageBatch> MessageBatchesListAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListResponseMessageBatch>> MessageBatchesListAsResponseAsync(
            string? beforeId = default,
            string? afterId = default,
            int? limit = default,
            string? anthropicVersion = default,
