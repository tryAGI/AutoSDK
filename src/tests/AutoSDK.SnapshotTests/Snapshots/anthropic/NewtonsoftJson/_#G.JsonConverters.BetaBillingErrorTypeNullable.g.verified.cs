...
{
    /// <inheritdoc />
    public sealed class BetaBillingErrorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaBillingErrorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaBillingErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
