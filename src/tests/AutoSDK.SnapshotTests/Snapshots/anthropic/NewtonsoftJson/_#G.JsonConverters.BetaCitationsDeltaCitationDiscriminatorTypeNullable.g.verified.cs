...
{
    /// <inheritdoc />
    public sealed class BetaCitationsDeltaCitationDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaCitationsDeltaCitationDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaCitationsDeltaCitationDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
