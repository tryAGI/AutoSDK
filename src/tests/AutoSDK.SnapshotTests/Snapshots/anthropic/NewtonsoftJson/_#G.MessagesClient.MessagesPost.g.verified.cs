//HintName: G.MessagesClient.MessagesPost.g.cs
...
namespace G
{
    public partial class MessagesClient
    {
        partial void PrepareMessagesPostArguments(
            ...
            global::G.CreateMessageParams request);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Message> MessagesPostAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.Message.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.Message.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
