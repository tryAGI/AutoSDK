...
{
    /// <inheritdoc />
    public sealed class BetaAuthenticationErrorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaAuthenticationErrorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BetaAuthenticationErrorTypeExtensions.ToValueString(value));
        }
    }
}
