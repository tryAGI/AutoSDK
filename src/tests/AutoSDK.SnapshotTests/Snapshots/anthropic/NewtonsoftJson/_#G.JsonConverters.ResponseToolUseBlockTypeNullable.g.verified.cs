...
{
    /// <inheritdoc />
    public sealed class ResponseToolUseBlockTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseToolUseBlockType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseToolUseBlockTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
