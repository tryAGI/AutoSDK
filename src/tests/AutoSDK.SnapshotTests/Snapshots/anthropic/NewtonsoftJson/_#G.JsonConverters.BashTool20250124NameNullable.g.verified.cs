...
{
    /// <inheritdoc />
    public sealed class BashTool20250124NameNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BashTool20250124Name?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BashTool20250124NameExtensions.ToValueString(value.Value));
            }
        }
    }
}
