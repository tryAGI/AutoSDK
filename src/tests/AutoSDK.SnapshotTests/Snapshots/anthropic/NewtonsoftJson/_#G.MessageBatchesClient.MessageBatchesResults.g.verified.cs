//HintName: G.MessageBatchesClient.MessageBatchesResults.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareMessageBatchesResultsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string messageBatchId,
            ref string? anthropicVersion,
            ref string? xApiKey);
        partial void PrepareMessageBatchesResultsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string messageBatchId,
            string? anthropicVersion,
            string? xApiKey);
        partial void ProcessMessageBatchesResultsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessMessageBatchesResultsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.MessageBatchIndividualResponse> MessageBatchesResultsAsync(
            string messageBatchId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessMessageBatchesResultsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessMessageBatchesResultsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.MessageBatchIndividualResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.MessageBatchIndividualResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
