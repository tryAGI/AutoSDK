...
{
    /// <inheritdoc />
    public sealed class BetaTextContentBlockDeltaTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaTextContentBlockDeltaType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BetaTextContentBlockDeltaTypeExtensions.ToValueString(value));
        }
    }
}
