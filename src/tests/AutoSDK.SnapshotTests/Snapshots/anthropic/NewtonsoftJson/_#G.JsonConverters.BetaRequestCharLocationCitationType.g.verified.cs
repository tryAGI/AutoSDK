...
{
    /// <inheritdoc />
    public sealed class BetaRequestCharLocationCitationTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaRequestCharLocationCitationType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BetaRequestCharLocationCitationTypeExtensions.ToValueString(value));
        }
    }
}
