//HintName: G.Api.BetaModelsGet.g.cs
...
namespace G
{
    public partial class Api
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.BetaModelInfo> BetaModelsGetAsync(
            string modelId,
        ...
        {
            var __response = await BetaModelsGetAsResponseAsync(
                modelId: modelId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.BetaModelInfo>> BetaModelsGetAsResponseAsync(
            string modelId,
            string? anthropicVersion = default,
            string? xApiKey = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BetaModelsGet",
                                methodName: "BetaModelsGetAsync",
                                pathTemplate: "$\"/v1/models/{modelId}?beta=true\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode >= 400 && (int)__response.StatusCode <= 499)
                            {
                                ...
                                throw global::G.ApiException<global::G.BetaErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.BetaModelInfo.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.BetaModelInfo>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.BetaModelInfo.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
