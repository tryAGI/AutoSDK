...
{
    /// <inheritdoc />
    public sealed class RequestToolResultBlockTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RequestToolResultBlockType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RequestToolResultBlockTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
