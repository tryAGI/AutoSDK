...
{
    /// <inheritdoc />
    public sealed class ContentBlockStartEventContentBlockDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ContentBlockStartEventContentBlockDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ContentBlockStartEventContentBlockDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
