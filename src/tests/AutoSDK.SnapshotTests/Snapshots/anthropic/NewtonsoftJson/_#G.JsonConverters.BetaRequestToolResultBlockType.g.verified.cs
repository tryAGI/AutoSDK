...
{
    /// <inheritdoc />
    public sealed class BetaRequestToolResultBlockTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaRequestToolResultBlockType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BetaRequestToolResultBlockTypeExtensions.ToValueString(value));
        }
    }
}
