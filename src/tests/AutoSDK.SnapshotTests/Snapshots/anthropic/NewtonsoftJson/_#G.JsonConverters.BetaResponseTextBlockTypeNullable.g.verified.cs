...
{
    /// <inheritdoc />
    public sealed class BetaResponseTextBlockTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaResponseTextBlockType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaResponseTextBlockTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
