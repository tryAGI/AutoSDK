...
{
    /// <inheritdoc />
    public sealed class BetaInvalidRequestErrorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BetaInvalidRequestErrorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BetaInvalidRequestErrorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
