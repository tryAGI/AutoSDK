...
namespace G
{
    ...
    public readonly partial struct Delta2 : global::System.IEquatable<Delta2>
    {
...
#endif
            out global::G.TextContentBlockDelta? value)
        {
            value = TextDelta;
            return IsTextDelta;
        }
        ...
        /// 
        /// </summary>
        public global::G.TextContentBlockDelta PickTextDelta() => IsTextDelta
            ? TextDelta!
        ...
        public bool TryPickInputJsonDelta(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.InputJsonContentBlockDelta? value)
        {
        ...
        /// 
        /// </summary>
        public global::G.InputJsonContentBlockDelta PickInputJsonDelta() => IsInputJsonDelta
            ? InputJsonDelta!
        ...
        public bool TryPickCitationsDelta(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.CitationsDelta? value)
        {
        ...
        /// 
        /// </summary>
        public global::G.CitationsDelta PickCitationsDelta() => IsCitationsDelta
            ? CitationsDelta!
        ...
        public bool TryPickThinkingDelta(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ThinkingContentBlockDelta? value)
        {
            value = ThinkingDelta;
        ...
        /// 
        /// </summary>
        public global::G.ThinkingContentBlockDelta PickThinkingDelta() => IsThinkingDelta
            ? ThinkingDelta!
        ...
        public bool TryPickSignatureDelta(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.SignatureContentBlockDelta? value)
        {
        ...
        /// 
        /// </summary>
        public global::G.SignatureContentBlockDelta PickSignatureDelta() => IsSignatureDelta
            ? SignatureDelta!
