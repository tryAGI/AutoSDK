...
namespace G
{
    public partial class TextCompletionsClient
    {
        ...
        {
            var __response = await CompletePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CompletionResponse>> CompletePostAsResponseAsync(
