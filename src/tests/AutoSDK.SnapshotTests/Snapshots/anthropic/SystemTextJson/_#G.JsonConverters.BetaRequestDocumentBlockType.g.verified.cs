...
{
    /// <inheritdoc />
    public sealed class BetaRequestDocumentBlockTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BetaRequestDocumentBlockType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.BetaRequestDocumentBlockTypeExtensions.ToValueString(value));
        }
    }
}
