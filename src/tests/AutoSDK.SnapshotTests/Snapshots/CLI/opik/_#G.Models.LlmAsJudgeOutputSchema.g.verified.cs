...
namespace G
{
    ...
    public sealed partial class LlmAsJudgeOutputSchema
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.LlmAsJudgeOutputSchemaTypeJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.LlmAsJudgeOutputSchemaType Type { get; set; }
