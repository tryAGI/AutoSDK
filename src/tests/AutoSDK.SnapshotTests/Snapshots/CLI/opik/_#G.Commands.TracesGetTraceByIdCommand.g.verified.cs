//HintName: G.Commands.TracesGetTraceByIdCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TracesGetTraceByIdCommand : global::System.CommandLine.Command
    {
        ...
        public TracesGetTraceByIdCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Traces.GetTraceByIdAsync(
                id: id,
                stripAttachments: stripAttachments,
                cancellationToken: cancellationToken);
