...
{
    /// <inheritdoc />
    public sealed class StartMultipartUploadRequestEntityTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.StartMultipartUploadRequestEntityType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.StartMultipartUploadRequestEntityTypeExtensions.ToValueString(value));
        }
    }
}
