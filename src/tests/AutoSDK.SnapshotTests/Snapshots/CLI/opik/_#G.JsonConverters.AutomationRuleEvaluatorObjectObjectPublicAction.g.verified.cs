...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorObjectObjectPublicActionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AutomationRuleEvaluatorObjectObjectPublicAction>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AutomationRuleEvaluatorObjectObjectPublicActionExtensions.ToValueString(value));
        }
    }
}
