//HintName: G.Commands.TracesGetTraceThreadStatsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TracesGetTraceThreadStatsCommand : global::System.CommandLine.Command
    {
        ...
        public TracesGetTraceThreadStatsCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Traces.GetTraceThreadStatsAsync(
                projectId: projectId,
                projectName: projectName,
                filters: filters,
                search: search,
