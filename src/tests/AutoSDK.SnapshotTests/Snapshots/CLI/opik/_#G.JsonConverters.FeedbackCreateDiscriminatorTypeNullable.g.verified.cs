...
{
    /// <inheritdoc />
    public sealed class FeedbackCreateDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FeedbackCreateDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.FeedbackCreateDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
