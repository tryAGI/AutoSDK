//HintName: G.Commands.WorkspacesGetCostCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class WorkspacesGetCostCommand : global::System.CommandLine.Command
    {
        ...
        public WorkspacesGetCostCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Workspaces.GetCostAsync(
                projectIds: projectIds,
                intervalStart: intervalStart,
                intervalEnd: intervalEnd,
                startBeforeEnd: startBeforeEnd,
