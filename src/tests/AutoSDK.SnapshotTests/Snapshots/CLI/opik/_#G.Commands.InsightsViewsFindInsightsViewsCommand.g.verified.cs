//HintName: G.Commands.InsightsViewsFindInsightsViewsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class InsightsViewsFindInsightsViewsCommand : global::System.CommandLine.Command
    {
        ...
        private new global::System.CommandLine.Option<string?> Name { get; } = new(
            name: "name")
        {
            Description = @"Filter insights views by name (partial match, case insensitive)",
        };
        ...
        public InsightsViewsFindInsightsViewsCommand(
            G.IApi client,
            global::System.IServiceProvider serviceProvider) : base(
            name: "find",
            description: @"Find insights views in a workspace")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.InsightsViews.FindInsightsViewsAsync(
                page: page,
                size: size,
                name: name,
                projectId: projectId,
