...
{
    /// <inheritdoc />
    public sealed class SpanFilterWriteOperatorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SpanFilterWriteOperator>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.SpanFilterWriteOperatorExtensions.ToValueString(value));
        }
    }
}
