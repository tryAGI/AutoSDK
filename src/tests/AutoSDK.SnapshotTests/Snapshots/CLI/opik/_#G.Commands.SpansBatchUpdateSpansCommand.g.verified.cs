//HintName: G.Commands.SpansBatchUpdateSpansCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class SpansBatchUpdateSpansCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.SpanUpdate> Update { get; } = new(
            name: "update")
        {
            Description = @"",
        };
        ...
        public SpansBatchUpdateSpansCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Spans.BatchUpdateSpansAsync(
                ids: ids,
                update: update,
                mergeTags: mergeTags,
                cancellationToken: cancellationToken);
