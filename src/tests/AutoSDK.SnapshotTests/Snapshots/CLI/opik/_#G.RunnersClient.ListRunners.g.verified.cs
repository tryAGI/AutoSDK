//HintName: G.RunnersClient.ListRunners.g.cs
...
namespace G
{
    public partial class RunnersClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ListRunnersServers = new global::G.AutoSDKServer[]
        ...
        partial void ProcessListRunnersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.LocalRunnerPage> ListRunnersAsync(
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
        ...
        {
            var __response = await ListRunnersAsResponseAsync(
                projectId: projectId,
                page: page,
                size: size,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.LocalRunnerPage>> ListRunnersAsResponseAsync(
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListRunnersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.LocalRunnerPage.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.LocalRunnerPage>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.LocalRunnerPage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
