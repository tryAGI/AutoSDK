...
{
    /// <inheritdoc />
    public sealed class ExperimentItemCompareStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ExperimentItemCompareStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ExperimentItemCompareStatusExtensions.ToValueString(value));
        }
    }
}
