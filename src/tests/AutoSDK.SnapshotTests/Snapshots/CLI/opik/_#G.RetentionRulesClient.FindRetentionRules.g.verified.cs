...
namespace G
{
    public partial class RetentionRulesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_FindRetentionRulesServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await FindRetentionRulesAsResponseAsync(
                page: page,
                size: size,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RetentionRulePagePublic>> FindRetentionRulesAsResponseAsync(
            int? page = default,
            int? size = default,
            bool? includeInactive = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "FindRetentionRulesAsync",
                                pathTemplate: "\"/v1/private/retention/rules\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.RetentionRulePagePublic.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.RetentionRulePagePublic>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.RetentionRulePagePublic.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
