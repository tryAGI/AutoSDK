//HintName: G.Commands.DashboardsUpdateDashboardCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class DashboardsUpdateDashboardCommand : global::System.CommandLine.Command
    {
        ...
        public DashboardsUpdateDashboardCommand(
            G.IApi client,
            global::System.IServiceProvider serviceProvider) : base(
            name: "update",
            description: @"Update dashboard by id. Partial updates are supported - only provided fields will be updated.")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Dashboards.UpdateDashboardAsync(
                dashboardId: dashboardId,
                name: name,
                type: type,
                description: description,
