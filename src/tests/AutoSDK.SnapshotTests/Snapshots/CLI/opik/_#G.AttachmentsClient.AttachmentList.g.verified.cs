...
namespace G
{
    public partial class AttachmentsClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_AttachmentListServers = new global::G.AutoSDKServer[]
        ...
        partial void PrepareAttachmentListArguments(
            ...
            ref global::G.AttachmentListEntityType entityType,
            ref global::System.Guid entityId,
            ref string path);
        partial void PrepareAttachmentListRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string path);
        partial void ProcessAttachmentListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAttachmentListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.AttachmentPage> AttachmentListAsync(
            global::System.Guid projectId,
            global::G.AttachmentListEntityType entityType,
            global::System.Guid entityId,
            string path,
        ...
        {
            var __response = await AttachmentListAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AttachmentPage>> AttachmentListAsResponseAsync(
            global::System.Guid projectId,
            global::G.AttachmentListEntityType entityType,
            global::System.Guid entityId,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAttachmentListArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_AttachmentListServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AttachmentListAsync",
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAttachmentListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AttachmentPage.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AttachmentPage>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AttachmentPage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
