//HintName: G.Commands.TracesBatchUpdateThreadsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TracesBatchUpdateThreadsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.TraceThreadUpdate> Update { get; } = new(
            name: "update")
        {
            Description = @"",
        };
        ...
        public TracesBatchUpdateThreadsCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Traces.BatchUpdateThreadsAsync(
                ids: ids,
                update: update,
                mergeTags: mergeTags,
                cancellationToken: cancellationToken);
