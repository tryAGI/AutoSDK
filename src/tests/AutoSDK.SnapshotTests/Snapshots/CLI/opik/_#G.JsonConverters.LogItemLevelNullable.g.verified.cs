...
{
    /// <inheritdoc />
    public sealed class LogItemLevelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LogItemLevel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LogItemLevelExtensions.ToValueString(value.Value));
            }
        }
    }
}
