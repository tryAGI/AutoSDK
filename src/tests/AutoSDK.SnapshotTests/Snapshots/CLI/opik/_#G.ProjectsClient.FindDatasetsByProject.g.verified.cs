//HintName: G.ProjectsClient.FindDatasetsByProject.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareFindDatasetsByProjectArguments(
            ...
            ref string? sorting,
            ref string? filters);
        partial void PrepareFindDatasetsByProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? sorting,
            string? filters);
        partial void ProcessFindDatasetsByProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFindDatasetsByProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.DatasetPagePublic> FindDatasetsByProjectAsync(
            global::System.Guid projectId,
            int? page = default,
            int? size = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareFindDatasetsByProjectArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessFindDatasetsByProjectResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessFindDatasetsByProjectResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
