...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorUpdateActionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AutomationRuleEvaluatorUpdateAction>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AutomationRuleEvaluatorUpdateActionExtensions.ToValueString(value));
        }
    }
}
