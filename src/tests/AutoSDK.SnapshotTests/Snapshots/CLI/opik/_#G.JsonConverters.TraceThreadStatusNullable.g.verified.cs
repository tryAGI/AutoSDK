...
{
    /// <inheritdoc />
    public sealed class TraceThreadStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TraceThreadStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TraceThreadStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
