            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.WorkspaceNameHolder.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.WorkspaceNameHolder.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
