//HintName: G.Commands.TracesSearchTracesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TracesSearchTracesCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<global::G.TraceFilterPublic>?> Filters { get; } = new(
            name: "filters")
        {
            Description = @"",
        };
        ...
        public TracesSearchTracesCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Traces.SearchTracesAsync(
                projectName: projectName,
                projectId: projectId,
                filters: filters,
                lastRetrievedId: lastRetrievedId,
