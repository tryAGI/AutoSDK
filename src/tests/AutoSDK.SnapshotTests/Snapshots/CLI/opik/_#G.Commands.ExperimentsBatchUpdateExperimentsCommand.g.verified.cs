//HintName: G.Commands.ExperimentsBatchUpdateExperimentsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ExperimentsBatchUpdateExperimentsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.ExperimentUpdate> Update { get; } = new(
            name: "update")
        {
            Description = @"",
        };
        ...
        public ExperimentsBatchUpdateExperimentsCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Experiments.BatchUpdateExperimentsAsync(
                ids: ids,
                update: update,
                mergeTags: mergeTags,
                cancellationToken: cancellationToken);
