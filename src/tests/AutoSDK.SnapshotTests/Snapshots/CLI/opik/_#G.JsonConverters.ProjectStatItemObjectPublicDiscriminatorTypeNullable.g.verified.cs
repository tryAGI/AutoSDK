...
{
    /// <inheritdoc />
    public sealed class ProjectStatItemObjectPublicDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ProjectStatItemObjectPublicDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ProjectStatItemObjectPublicDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
