...
{
    /// <inheritdoc />
    public sealed class CreateContainerBodyExpiresAfterAnchorNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateContainerBodyExpiresAfterAnchor?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateContainerBodyExpiresAfterAnchorExtensions.ToValueString(value.Value));
            }
        }
    }
}
