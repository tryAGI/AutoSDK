...
namespace G
{
    public partial class OpenAiClient
    {
        partial void PrepareRetrieveContainerFileArguments(
            ...
            ref string fileId);
        partial void PrepareRetrieveContainerFileRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string containerId,
            string fileId);
        partial void ProcessRetrieveContainerFileResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRetrieveContainerFileResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ContainerFileResource> RetrieveContainerFileAsync(
            string containerId,
            string fileId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRetrieveContainerFileArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessRetrieveContainerFileResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessRetrieveContainerFileResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
