...
{
    /// <inheritdoc />
    public sealed class CreateImageEditRequestBackgroundNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateImageEditRequestBackground?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateImageEditRequestBackgroundExtensions.ToValueString(value.Value));
            }
        }
    }
}
