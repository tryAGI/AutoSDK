...
{
    /// <inheritdoc />
    public sealed class ResponseMCPCallArgumentsDeltaEventTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseMCPCallArgumentsDeltaEventType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ResponseMCPCallArgumentsDeltaEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
