//HintName: G.Commands.CancelVectorStoreFileBatchCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CancelVectorStoreFileBatchCommand : global::System.CommandLine.Command
    {
        ...
        public CancelVectorStoreFileBatchCommand(G.IOpenAiClient client) : base(
            name: "cancel",
            description: @"")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.VectorStores.CancelVectorStoreFileBatchAsync(
                vectorStoreId: vectorStoreId,
                batchId: batchId,
                cancellationToken: cancellationToken);
