//HintName: G.Commands.RetrieveContainerFileCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class RetrieveContainerFileCommand : global::System.CommandLine.Command
    {
        ...
        public RetrieveContainerFileCommand(G.IOpenAiClient client) : base(
            name: "retrieve",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.RetrieveContainerFileAsync(
                containerId: containerId,
                fileId: fileId,
                cancellationToken: cancellationToken);
