//HintName: G.Commands.UsageEmbeddingsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class UsageEmbeddingsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.UsageEmbeddingsBucketWidth?> BucketWidth { get; } = new(
            name: "bucketWidth")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<global::G.UsageEmbeddingsGroupByItem>?> GroupBy { get; } = new(
            name: "groupBy")
        {
            Description = "",
        };
        ...
        public UsageEmbeddingsCommand(G.IOpenAiClient client) : base(
            name: "usage",
            description: @"")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Usage.UsageEmbeddingsAsync(
                startTime: startTime,
                endTime: endTime,
                bucketWidth: bucketWidth,
                projectIds: projectIds,
