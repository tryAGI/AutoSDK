...
{
    /// <inheritdoc />
    public sealed class RealtimeSessionCreateRequestClientSecretExpiresAtAnchorNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RealtimeSessionCreateRequestClientSecretExpiresAtAnchor?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RealtimeSessionCreateRequestClientSecretExpiresAtAnchorExtensions.ToValueString(value.Value));
            }
        }
    }
}
