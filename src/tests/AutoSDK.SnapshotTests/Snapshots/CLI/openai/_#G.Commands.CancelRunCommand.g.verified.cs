//HintName: G.Commands.CancelRunCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CancelRunCommand : global::System.CommandLine.Command
    {
        ...
        public CancelRunCommand(G.IOpenAiClient client) : base(
            name: "cancel",
            description: @"")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Assistants.CancelRunAsync(
                threadId: threadId,
                runId: runId,
                cancellationToken: cancellationToken);
