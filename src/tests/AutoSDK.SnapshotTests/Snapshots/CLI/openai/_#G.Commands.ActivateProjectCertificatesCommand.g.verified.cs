//HintName: G.Commands.ActivateProjectCertificatesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActivateProjectCertificatesCommand : global::System.CommandLine.Command
    {
        ...
        public ActivateProjectCertificatesCommand(G.IOpenAiClient client) : base(
            name: "activate",
            description: @"")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Certificates.ActivateProjectCertificatesAsync(
                projectId: projectId,
                certificateIds: certificateIds,
                cancellationToken: cancellationToken);
