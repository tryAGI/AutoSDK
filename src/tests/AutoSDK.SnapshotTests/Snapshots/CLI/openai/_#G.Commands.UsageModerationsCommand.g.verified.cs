//HintName: G.Commands.UsageModerationsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class UsageModerationsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.UsageModerationsBucketWidth?> BucketWidth { get; } = new(
            name: "bucketWidth")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<global::G.UsageModerationsGroupByItem>?> GroupBy { get; } = new(
            name: "groupBy")
        {
            Description = "",
        };
        ...
        public UsageModerationsCommand(G.IOpenAiClient client) : base(
            name: "usage",
            description: @"")
        {
            _client = client;
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Usage.UsageModerationsAsync(
                startTime: startTime,
                endTime: endTime,
                bucketWidth: bucketWidth,
                projectIds: projectIds,
