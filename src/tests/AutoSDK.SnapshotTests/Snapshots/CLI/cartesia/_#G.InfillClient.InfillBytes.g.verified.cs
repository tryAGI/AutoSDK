...
namespace G
{
    public partial class InfillClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<byte[]>> InfillBytesAsResponseAsync(
            global::G.InfillBytesCartesiaVersion cartesiaVersion,
        ...
        /// The stream to send as the multipart 'left_audio' file part.
        /// </param>
        /// <param name="leftAudioname"></param>
        /// <param name="rightAudio">
        /// The stream to send as the multipart 'right_audio' file part.
        /// </param>
        /// <param name="rightAudioname"></param>
        /// <param name="modelId">
        /// The ID of the model to use for generating audio. Any model other than the first `"sonic"` model is supported.
        ...
        public async global::System.Threading.Tasks.Task<byte[]> InfillBytesAsync(
            global::G.InfillBytesCartesiaVersion cartesiaVersion,
            global::System.IO.Stream? leftAudio = default,
            string? leftAudioname = default,
            global::System.IO.Stream? rightAudio = default,
            string? rightAudioname = default,
            string? modelId = default,
            string? language = default,
            string? transcript = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.InfillBytesRequest
            {
                LeftAudio = global::System.Array.Empty<byte>(),
                LeftAudioname = leftAudioname,
                RightAudio = global::System.Array.Empty<byte>(),
                RightAudioname = rightAudioname,
                ModelId = modelId,
                Language = language,
                Transcript = transcript,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                __httpRequest.Headers.TryAddWithoutValidation("Cartesia-Version", cartesiaVersion.ToValueString());
                            ...
                            if (leftAudio != default)
                            {

                                var __contentLeftAudio = new global::System.Net.Http.StreamContent(leftAudio);
                                __contentLeftAudio.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.LeftAudioname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.LeftAudioname) ?? string.Empty).ToLowerInvariant() switch
                            ...
                            if (rightAudio != default)
                            {

                                var __contentRightAudio = new global::System.Net.Http.StreamContent(rightAudio);
                                __contentRightAudio.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.RightAudioname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.RightAudioname) ?? string.Empty).ToLowerInvariant() switch
