...
{
    /// <inheritdoc />
    public sealed class AuthAccessTokenCartesiaVersionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AuthAccessTokenCartesiaVersion>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AuthAccessTokenCartesiaVersionExtensions.ToValueString(value));
        }
    }
}
