...
{
    /// <inheritdoc />
    public sealed class AgentsGetDeploymentCartesiaVersionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsGetDeploymentCartesiaVersion?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentsGetDeploymentCartesiaVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
