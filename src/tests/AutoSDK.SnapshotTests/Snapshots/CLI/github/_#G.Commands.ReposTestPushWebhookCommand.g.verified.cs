//HintName: G.Commands.ReposTestPushWebhookCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposTestPushWebhookCommand : global::System.CommandLine.Command
    {
        ...
        public ReposTestPushWebhookCommand(G.IApi client) : base(
            name: "repos",
...
> Previously `/repos/:owner/:repo/hooks/:hook_id/test`")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Repos.ReposTestPushWebhookAsync(
                owner: owner,
                repo: repo,
                hookId: hookId,
                cancellationToken: cancellationToken);
