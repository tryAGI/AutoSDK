//HintName: G.Commands.PullsCreateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsCreateCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<string?> HeadRepo { get; } = new(
            name: "headRepo")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<long?> Issue { get; } = new(
            name: "issue")
        {
            Description = "",
        };
        public PullsCreateCommand(G.IApi client) : base(
            name: "pulls",
...
- **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var headRepo = parseResult.GetRequiredValue(HeadRepo);
            ...
            var issue = parseResult.GetRequiredValue(Issue);
            ...
            var response = await _client.Pulls.PullsCreateAsync(
                owner: owner,
                repo: repo,
                title: title,
                head: head,
