//HintName: G.Commands.DependabotSetSelectedReposForOrgSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class DependabotSetSelectedReposForOrgSecretCommand : global::System.CommandLine.Command
    {
        ...
        public DependabotSetSelectedReposForOrgSecretCommand(G.IApi client) : base(
            name: "dependabot",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Dependabot.DependabotSetSelectedReposForOrgSecretAsync(
                org: org,
                secretName: secretName,
                selectedRepositoryIds: selectedRepositoryIds,
                cancellationToken: cancellationToken);
