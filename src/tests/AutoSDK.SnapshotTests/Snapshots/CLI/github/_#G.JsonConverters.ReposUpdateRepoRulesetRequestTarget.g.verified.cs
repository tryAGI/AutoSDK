//HintName: G.JsonConverters.ReposUpdateRepoRulesetRequestTarget.g.cs
#nullable enable
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.ReposUpdateRepoRulesetRequestTargetExtensions.ToEnum(stringValue) ?? default;
                    }
                ...
                {
                    return default(global::G.ReposUpdateRepoRulesetRequestTarget);
                }
                default:
