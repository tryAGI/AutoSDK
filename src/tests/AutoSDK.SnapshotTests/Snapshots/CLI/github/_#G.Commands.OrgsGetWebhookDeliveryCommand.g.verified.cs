//HintName: G.Commands.OrgsGetWebhookDeliveryCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsGetWebhookDeliveryCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsGetWebhookDeliveryCommand(G.IApi client) : base(
            name: "orgs",
...
webhooks that they did not create and users cannot list, view, or edit webhooks that were created by OAuth apps.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Orgs.OrgsGetWebhookDeliveryAsync(
                org: org,
                hookId: hookId,
                deliveryId: deliveryId,
                cancellationToken: cancellationToken);
