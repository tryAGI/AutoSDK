//HintName: G.Commands.CodespacesCreateOrUpdateOrgSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CodespacesCreateOrUpdateOrgSecretCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.CodespacesCreateOrUpdateOrgSecretRequestVisibility> Visibility { get; } = new(
            name: "visibility")
        {
            Description = "",
        };
        ...
        public CodespacesCreateOrUpdateOrgSecretCommand(G.IApi client) : base(
            name: "codespaces",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Codespaces.CodespacesCreateOrUpdateOrgSecretAsync(
                org: org,
                secretName: secretName,
                encryptedValue: encryptedValue,
                keyId: keyId,
