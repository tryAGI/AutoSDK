...
{
    /// <inheritdoc />
    public sealed class WebhooksPullRequest5HeadRepoOwnerTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhooksPullRequest5HeadRepoOwnerType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WebhooksPullRequest5HeadRepoOwnerTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
