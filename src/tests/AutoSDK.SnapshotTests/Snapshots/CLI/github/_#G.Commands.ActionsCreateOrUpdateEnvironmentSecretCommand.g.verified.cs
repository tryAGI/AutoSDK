//HintName: G.Commands.ActionsCreateOrUpdateEnvironmentSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsCreateOrUpdateEnvironmentSecretCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<string> EncryptedValue { get; } = new(
            name: "encryptedValue")
        {
            Description = "",
        };
        ...
        public ActionsCreateOrUpdateEnvironmentSecretCommand(G.IApi client) : base(
            name: "actions",
...
OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsCreateOrUpdateEnvironmentSecretAsync(
                owner: owner,
                repo: repo,
                environmentName: environmentName,
                secretName: secretName,
