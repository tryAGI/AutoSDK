...
{
    /// <inheritdoc />
    public sealed class DependabotListAlertsForRepoScopeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DependabotListAlertsForRepoScope?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.DependabotListAlertsForRepoScopeExtensions.ToValueString(value.Value));
            }
        }
    }
}
