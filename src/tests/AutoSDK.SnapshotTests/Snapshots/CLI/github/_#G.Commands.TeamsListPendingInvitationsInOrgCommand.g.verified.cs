//HintName: G.Commands.TeamsListPendingInvitationsInOrgCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TeamsListPendingInvitationsInOrgCommand : global::System.CommandLine.Command
    {
        ...
        public TeamsListPendingInvitationsInOrgCommand(G.IApi client) : base(
            name: "teams",
...
> You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/{org_id}/team/{team_id}/invitations`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Teams.TeamsListPendingInvitationsInOrgAsync(
                org: org,
                teamSlug: teamSlug,
                perPage: perPage,
                page: page,
