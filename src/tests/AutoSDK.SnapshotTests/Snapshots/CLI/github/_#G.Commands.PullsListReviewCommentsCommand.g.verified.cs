//HintName: G.Commands.PullsListReviewCommentsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsListReviewCommentsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.PullsListReviewCommentsSort?> Sort { get; } = new(
            name: "sort")
        {
            Description = "",
        };

        private global::System.CommandLine.Option<global::G.PullsListReviewCommentsDirection?> Direction { get; } = new(
            name: "direction")
        {
            Description = "",
        };
        ...
        public PullsListReviewCommentsCommand(G.IApi client) : base(
            name: "pulls",
...
- **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Pulls.PullsListReviewCommentsAsync(
                owner: owner,
                repo: repo,
                pullNumber: pullNumber,
                sort: sort,
