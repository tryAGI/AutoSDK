//HintName: G.Commands.CodespacesRemoveSelectedRepoFromOrgSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CodespacesRemoveSelectedRepoFromOrgSecretCommand : global::System.CommandLine.Command
    {
        ...
        public CodespacesRemoveSelectedRepoFromOrgSecretCommand(G.IApi client) : base(
            name: "codespaces",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Codespaces.CodespacesRemoveSelectedRepoFromOrgSecretAsync(
                org: org,
                secretName: secretName,
                repositoryId: repositoryId,
                cancellationToken: cancellationToken);
