//HintName: G.Commands.ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgCommand(G.IApi client) : base(
            name: "actions",
...
OAuth tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Actions.ActionsAddRepoAccessToSelfHostedRunnerGroupInOrgAsync(
                org: org,
                runnerGroupId: runnerGroupId,
                repositoryId: repositoryId,
                cancellationToken: cancellationToken);
