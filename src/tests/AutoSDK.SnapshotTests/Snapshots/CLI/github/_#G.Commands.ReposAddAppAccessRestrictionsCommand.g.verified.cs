//HintName: G.Commands.ReposAddAppAccessRestrictionsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposAddAppAccessRestrictionsCommand : global::System.CommandLine.Command
    {
        ...
        public ReposAddAppAccessRestrictionsCommand(G.IApi client) : base(
            name: "repos",
...
Grants the specified apps push access for this branch. Only GitHub Apps that are installed on the repository and that have been granted write access to the repository contents can be added as authorized actors on a protected branch.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposAddAppAccessRestrictionsAsync(
                owner: owner,
                repo: repo,
                branch: branch,
                apps: apps,
