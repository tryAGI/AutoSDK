//HintName: G.Commands.ChecksGetCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChecksGetCommand : global::System.CommandLine.Command
    {
        ...
        public ChecksGetCommand(G.IApi client) : base(
            name: "checks",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint on a private repository.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Checks.ChecksGetAsync(
                owner: owner,
                repo: repo,
                checkRunId: checkRunId,
                cancellationToken: cancellationToken);
