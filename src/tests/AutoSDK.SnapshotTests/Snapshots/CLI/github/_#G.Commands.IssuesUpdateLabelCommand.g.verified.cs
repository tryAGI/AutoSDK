//HintName: G.Commands.IssuesUpdateLabelCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class IssuesUpdateLabelCommand : global::System.CommandLine.Command
    {
        ...
        public IssuesUpdateLabelCommand(G.IApi client) : base(
            name: "issues",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Issues.IssuesUpdateLabelAsync(
                owner: owner,
                repo: repo,
                name: name,
                newName: newName,
