//HintName: G.JsonConverters.WebhookPullRequestReadyForReviewAction.g.cs
#nullable enable
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.WebhookPullRequestReadyForReviewActionExtensions.ToEnum(stringValue) ?? default;
                    }
