//HintName: G.Commands.OrgsRevokeOrgRoleTeamCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsRevokeOrgRoleTeamCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsRevokeOrgRoleTeamCommand(G.IApi client) : base(
            name: "orgs",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Orgs.OrgsRevokeOrgRoleTeamAsync(
                org: org,
                teamSlug: teamSlug,
                roleId: roleId,
                cancellationToken: cancellationToken);
