//HintName: G.Commands.PullsUpdateReviewCommentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsUpdateReviewCommentCommand : global::System.CommandLine.Command
    {
        ...
        public PullsUpdateReviewCommentCommand(G.IApi client) : base(
            name: "pulls",
...
- **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Pulls.PullsUpdateReviewCommentAsync(
                owner: owner,
                repo: repo,
                commentId: commentId,
                body: body,
