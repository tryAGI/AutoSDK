//HintName: G.Commands.GistsGetRevisionCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class GistsGetRevisionCommand : global::System.CommandLine.Command
    {
        ...
        public GistsGetRevisionCommand(G.IApi client) : base(
            name: "gists",
...
- **`application/vnd.github.base64+json`**: Returns the base64-encoded contents. This can be useful if your gist contains any invalid UTF-8 sequences.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Gists.GistsGetRevisionAsync(
                gistId: gistId,
                sha: sha,
                cancellationToken: cancellationToken);
