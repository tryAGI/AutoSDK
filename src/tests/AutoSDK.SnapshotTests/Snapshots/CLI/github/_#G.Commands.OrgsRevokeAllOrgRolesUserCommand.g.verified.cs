//HintName: G.Commands.OrgsRevokeAllOrgRolesUserCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsRevokeAllOrgRolesUserCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsRevokeAllOrgRolesUserCommand(G.IApi client) : base(
            name: "orgs",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Orgs.OrgsRevokeAllOrgRolesUserAsync(
                org: org,
                username: username,
                cancellationToken: cancellationToken);
