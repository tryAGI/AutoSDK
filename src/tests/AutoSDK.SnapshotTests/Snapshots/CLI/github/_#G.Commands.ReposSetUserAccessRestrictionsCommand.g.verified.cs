//HintName: G.Commands.ReposSetUserAccessRestrictionsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposSetUserAccessRestrictionsCommand : global::System.CommandLine.Command
    {
        ...
        public ReposSetUserAccessRestrictionsCommand(G.IApi client) : base(
            name: "repos",
...
| `array` | Usernames for people who can have push access. **Note**: The list of users, apps, and teams in total is limited to 100 items. |")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposSetUserAccessRestrictionsAsync(
                owner: owner,
                repo: repo,
                branch: branch,
                users: users,
