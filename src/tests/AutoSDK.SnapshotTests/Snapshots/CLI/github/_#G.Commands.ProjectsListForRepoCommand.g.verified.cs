//HintName: G.Commands.ProjectsListForRepoCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ProjectsListForRepoCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.ProjectsListForRepoState?> State { get; } = new(
            name: "state")
        {
            Description = "",
        };
        ...
        public ProjectsListForRepoCommand(G.IApi client) : base(
            name: "projects",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Projects.ProjectsListForRepoAsync(
                owner: owner,
                repo: repo,
                state: state,
                perPage: perPage,
