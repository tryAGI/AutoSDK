//HintName: G.Commands.IssuesRemoveLabelCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class IssuesRemoveLabelCommand : global::System.CommandLine.Command
    {
        ...
        public IssuesRemoveLabelCommand(G.IApi client) : base(
            name: "issues",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Issues.IssuesRemoveLabelAsync(
                owner: owner,
                repo: repo,
                issueNumber: issueNumber,
                name: name,
