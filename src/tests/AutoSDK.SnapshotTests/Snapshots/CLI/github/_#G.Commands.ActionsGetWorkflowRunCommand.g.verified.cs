//HintName: G.Commands.ActionsGetWorkflowRunCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsGetWorkflowRunCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsGetWorkflowRunCommand(G.IApi client) : base(
            name: "actions",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint with a private repository.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsGetWorkflowRunAsync(
                owner: owner,
                repo: repo,
                runId: runId,
                excludePullRequests: excludePullRequests,
