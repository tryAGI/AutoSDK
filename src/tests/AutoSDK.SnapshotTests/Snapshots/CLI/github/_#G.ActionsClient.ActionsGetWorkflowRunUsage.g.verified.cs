            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.WorkflowRunUsage.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.WorkflowRunUsage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
