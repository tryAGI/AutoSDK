//HintName: G.Commands.PackagesGetAllPackageVersionsForPackageOwnedByUserCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PackagesGetAllPackageVersionsForPackageOwnedByUserCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.PackagesGetAllPackageVersionsForPackageOwnedByUserPackageType> PackageType { get; } = new(
            name: "packageType")
        {
            Description = "",
        };
        ...
        public PackagesGetAllPackageVersionsForPackageOwnedByUserCommand(G.IApi client) : base(
            name: "packages",
...
OAuth app tokens and personal access tokens (classic) need the `read:packages` scope to use this endpoint. If the `package_type` belongs to a GitHub Packages registry that only supports repository-scoped permissions, the `repo` scope is also required. For the list of these registries, see ""[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages).""")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Packages.PackagesGetAllPackageVersionsForPackageOwnedByUserAsync(
                packageType: packageType,
                packageName: packageName,
                username: username,
                cancellationToken: cancellationToken);
