//HintName: G.Commands.GistsUpdateCommentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class GistsUpdateCommentCommand : global::System.CommandLine.Command
    {
        ...
        public GistsUpdateCommentCommand(G.IApi client) : base(
            name: "gists",
...
- **`application/vnd.github.base64+json`**: Returns the base64-encoded contents. This can be useful if your gist contains any invalid UTF-8 sequences.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Gists.GistsUpdateCommentAsync(
                gistId: gistId,
                commentId: commentId,
                body: body,
                cancellationToken: cancellationToken);
