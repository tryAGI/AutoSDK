//HintName: G.Commands.OrgsListCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsListCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsListCommand(G.IApi client) : base(
            name: "orgs",
...
> Pagination is powered exclusively by the `since` parameter. Use the [Link header](https://docs.github.com/rest/guides/using-pagination-in-the-rest-api#using-link-headers) to get the URL for the next page of organizations.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Orgs.OrgsListAsync(
                since: since,
                perPage: perPage,
                cancellationToken: cancellationToken);
