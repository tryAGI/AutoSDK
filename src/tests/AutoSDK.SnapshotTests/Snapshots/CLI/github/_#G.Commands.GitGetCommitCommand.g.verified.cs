//HintName: G.Commands.GitGetCommitCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class GitGetCommitCommand : global::System.CommandLine.Command
    {
        ...
        public GitGetCommitCommand(G.IApi client) : base(
            name: "git",
...
| `valid` | None of the above errors applied, so the signature is considered to be verified. |")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Git.GitGetCommitAsync(
                owner: owner,
                repo: repo,
                commitSha: commitSha,
                cancellationToken: cancellationToken);
