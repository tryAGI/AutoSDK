//HintName: G.Commands.ReposGetWebhookDeliveryCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposGetWebhookDeliveryCommand : global::System.CommandLine.Command
    {
        ...
        public ReposGetWebhookDeliveryCommand(G.IApi client) : base(
            name: "repos",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposGetWebhookDeliveryAsync(
                owner: owner,
                repo: repo,
                hookId: hookId,
                deliveryId: deliveryId,
