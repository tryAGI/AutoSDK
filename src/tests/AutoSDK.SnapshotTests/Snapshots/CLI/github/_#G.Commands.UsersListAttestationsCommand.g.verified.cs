//HintName: G.Commands.UsersListAttestationsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class UsersListAttestationsCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            global::System.CommandLine.ParseResult parseResult,
            global::G.UsersListAttestationsResponse response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        public UsersListAttestationsCommand(G.IApi client) : base(
            name: "users",
...
**Please note:** in order to offer meaningful security benefits, an attestation's signature and timestamps **must** be cryptographically verified, and the identity of the attestation signer **must** be validated. Attestations can be verified using the [GitHub CLI `attestation verify` command](https://cli.github.com/manual/gh_attestation_verify). For more information, see [our guide on how to use artifact attestations to establish a build's provenance](https://docs.github.com/actions/security-guides/using-artifact-attestations-to-establish-provenance-for-builds).")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Users.UsersListAttestationsAsync(
                perPage: perPage,
                before: before,
                after: after,
                username: username,
