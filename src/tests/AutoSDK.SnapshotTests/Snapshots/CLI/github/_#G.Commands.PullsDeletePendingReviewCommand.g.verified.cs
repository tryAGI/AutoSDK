//HintName: G.Commands.PullsDeletePendingReviewCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsDeletePendingReviewCommand : global::System.CommandLine.Command
    {
        ...
        public PullsDeletePendingReviewCommand(G.IApi client) : base(
            name: "pulls",
...
- **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Pulls.PullsDeletePendingReviewAsync(
                owner: owner,
                repo: repo,
                pullNumber: pullNumber,
                reviewId: reviewId,
