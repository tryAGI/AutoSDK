//HintName: G.Commands.ActionsCreateOrUpdateOrgSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsCreateOrUpdateOrgSecretCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.ActionsCreateOrUpdateOrgSecretRequestVisibility> Visibility { get; } = new(
            name: "visibility")
        {
            Description = "",
        };
        ...
        public ActionsCreateOrUpdateOrgSecretCommand(G.IApi client) : base(
            name: "actions",
...
OAuth tokens and personal access tokens (classic) need the`admin:org` scope to use this endpoint. If the repository is private, OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsCreateOrUpdateOrgSecretAsync(
                org: org,
                secretName: secretName,
                encryptedValue: encryptedValue,
                keyId: keyId,
