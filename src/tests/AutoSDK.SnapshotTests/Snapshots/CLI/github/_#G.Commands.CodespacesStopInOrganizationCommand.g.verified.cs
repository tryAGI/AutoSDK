//HintName: G.Commands.CodespacesStopInOrganizationCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CodespacesStopInOrganizationCommand : global::System.CommandLine.Command
    {
        ...
        public CodespacesStopInOrganizationCommand(G.IApi client) : base(
            name: "codespaces",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Codespaces.CodespacesStopInOrganizationAsync(
                org: org,
                username: username,
                codespaceName: codespaceName,
                cancellationToken: cancellationToken);
