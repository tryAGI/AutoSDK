//HintName: G.Commands.PackagesRestorePackageVersionForOrgCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PackagesRestorePackageVersionForOrgCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.PackagesRestorePackageVersionForOrgPackageType> PackageType { get; } = new(
            name: "packageType")
        {
            Description = "",
        };
        ...
        public PackagesRestorePackageVersionForOrgCommand(G.IApi client) : base(
            name: "packages",
...
OAuth app tokens and personal access tokens (classic) need the `read:packages` and `write:packages` scopes to use this endpoint. If the `package_type` belongs to a GitHub Packages registry that only supports repository-scoped permissions, the `repo` scope is also required. For the list of these registries, see ""[About permissions for GitHub Packages](https://docs.github.com/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages).""")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Packages.PackagesRestorePackageVersionForOrgAsync(
                packageType: packageType,
                packageName: packageName,
                org: org,
                packageVersionId: packageVersionId,
