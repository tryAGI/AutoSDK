//HintName: G.Commands.ActionsReRunWorkflowFailedJobsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsReRunWorkflowFailedJobsCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsReRunWorkflowFailedJobsCommand(G.IApi client) : base(
            name: "actions",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsReRunWorkflowFailedJobsAsync(
                owner: owner,
                repo: repo,
                runId: runId,
                enableDebugLogging: enableDebugLogging,
