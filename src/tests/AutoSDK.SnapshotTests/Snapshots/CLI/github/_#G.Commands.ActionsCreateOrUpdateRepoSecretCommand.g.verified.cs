//HintName: G.Commands.ActionsCreateOrUpdateRepoSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsCreateOrUpdateRepoSecretCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsCreateOrUpdateRepoSecretCommand(G.IApi client) : base(
            name: "actions",
...
OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsCreateOrUpdateRepoSecretAsync(
                owner: owner,
                repo: repo,
                secretName: secretName,
                encryptedValue: encryptedValue,
