//HintName: G.Commands.TeamsListReposInOrgCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TeamsListReposInOrgCommand : global::System.CommandLine.Command
    {
        ...
        public TeamsListReposInOrgCommand(G.IApi client) : base(
            name: "teams",
...
> You can also specify a team by `org_id` and `team_id` using the route `GET /organizations/{org_id}/team/{team_id}/repos`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Teams.TeamsListReposInOrgAsync(
                org: org,
                teamSlug: teamSlug,
                perPage: perPage,
                page: page,
