//HintName: G.Commands.ActionsCreateEnvironmentVariableCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsCreateEnvironmentVariableCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsCreateEnvironmentVariableCommand(G.IApi client) : base(
            name: "actions",
...
OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsCreateEnvironmentVariableAsync(
                owner: owner,
                repo: repo,
                environmentName: environmentName,
                name: name,
