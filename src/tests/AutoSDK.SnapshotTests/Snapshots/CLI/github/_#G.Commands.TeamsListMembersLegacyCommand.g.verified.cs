//HintName: G.Commands.TeamsListMembersLegacyCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TeamsListMembersLegacyCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.TeamsListMembersLegacyRole?> Role { get; } = new(
            name: "role")
        {
            Description = "",
        };
        ...
        public TeamsListMembersLegacyCommand(G.IApi client) : base(
            name: "teams",
            description: @"> [!WARNING]
...
Team members will include the members of child teams.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Teams.TeamsListMembersLegacyAsync(
                teamId: teamId,
                role: role,
                perPage: perPage,
                page: page,
