//HintName: G.Commands.ReposGetCustomDeploymentProtectionRuleCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposGetCustomDeploymentProtectionRuleCommand : global::System.CommandLine.Command
    {
        ...
        public ReposGetCustomDeploymentProtectionRuleCommand(G.IApi client) : base(
            name: "repos",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint with a private repository.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposGetCustomDeploymentProtectionRuleAsync(
                owner: owner,
                repo: repo,
                environmentName: environmentName,
                protectionRuleId: protectionRuleId,
