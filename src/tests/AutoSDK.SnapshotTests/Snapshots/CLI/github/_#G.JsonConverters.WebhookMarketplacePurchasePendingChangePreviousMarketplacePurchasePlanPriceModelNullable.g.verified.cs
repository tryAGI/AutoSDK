...
{
    /// <inheritdoc />
    public sealed class WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchasePlanPriceModelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchasePlanPriceModel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WebhookMarketplacePurchasePendingChangePreviousMarketplacePurchasePlanPriceModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
