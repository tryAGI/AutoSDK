//HintName: G.Commands.OrgsListPatGrantRequestRepositoriesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsListPatGrantRequestRepositoriesCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsListPatGrantRequestRepositoriesCommand(G.IApi client) : base(
            name: "orgs",
...
Only GitHub Apps can use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Orgs.OrgsListPatGrantRequestRepositoriesAsync(
                org: org,
                patRequestId: patRequestId,
                perPage: perPage,
                page: page,
