//HintName: G.Commands.OrgsAssignUserToOrgRoleCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsAssignUserToOrgRoleCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsAssignUserToOrgRoleCommand(G.IApi client) : base(
            name: "orgs",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Orgs.OrgsAssignUserToOrgRoleAsync(
                org: org,
                username: username,
                roleId: roleId,
                cancellationToken: cancellationToken);
