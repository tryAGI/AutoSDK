//HintName: G.Commands.OrgsRevokeAllOrgRolesTeamCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsRevokeAllOrgRolesTeamCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsRevokeAllOrgRolesTeamCommand(G.IApi client) : base(
            name: "orgs",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Orgs.OrgsRevokeAllOrgRolesTeamAsync(
                org: org,
                teamSlug: teamSlug,
                cancellationToken: cancellationToken);
