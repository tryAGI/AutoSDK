//HintName: G.Commands.IssuesGetCommentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class IssuesGetCommentCommand : global::System.CommandLine.Command
    {
        ...
        public IssuesGetCommentCommand(G.IApi client) : base(
            name: "issues",
...
- **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Issues.IssuesGetCommentAsync(
                owner: owner,
                repo: repo,
                commentId: commentId,
                cancellationToken: cancellationToken);
