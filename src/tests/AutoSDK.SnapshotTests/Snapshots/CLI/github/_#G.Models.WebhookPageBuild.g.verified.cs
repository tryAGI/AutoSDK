//HintName: G.Models.WebhookPageBuild.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class WebhookPageBuild
    {
        /// <summary>
        ...
        public required global::G.WebhookPageBuildBuild Build { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPageBuild" /> class.
        /// </summary>
        /// <param name="build">
        /// The [List GitHub Pages builds](https://docs.github.com/rest/pages/pages#list-github-pages-builds) itself.
        /// </param>
        ...
        public WebhookPageBuild(
            global::G.WebhookPageBuildBuild build,
            int id,
