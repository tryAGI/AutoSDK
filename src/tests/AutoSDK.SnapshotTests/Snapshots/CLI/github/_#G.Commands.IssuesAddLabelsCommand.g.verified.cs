//HintName: G.Commands.IssuesAddLabelsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class IssuesAddLabelsCommand : global::System.CommandLine.Command
    {
        ...
        public IssuesAddLabelsCommand(G.IApi client) : base(
            name: "issues",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Issues.IssuesAddLabelsAsync(
                owner: owner,
                repo: repo,
                issueNumber: issueNumber,
                cancellationToken: cancellationToken);
