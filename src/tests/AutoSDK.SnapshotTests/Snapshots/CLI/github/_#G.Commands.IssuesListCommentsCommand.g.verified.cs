//HintName: G.Commands.IssuesListCommentsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class IssuesListCommentsCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            global::System.CommandLine.ParseResult parseResult,
            global::System.Collections.Generic.IList<global::G.IssueComment> response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        public IssuesListCommentsCommand(G.IApi client) : base(
            name: "issues",
...
- **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Issues.IssuesListCommentsAsync(
                owner: owner,
                repo: repo,
                issueNumber: issueNumber,
                since: since,
