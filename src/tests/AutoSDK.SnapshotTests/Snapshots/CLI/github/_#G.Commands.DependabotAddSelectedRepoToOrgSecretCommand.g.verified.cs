//HintName: G.Commands.DependabotAddSelectedRepoToOrgSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class DependabotAddSelectedRepoToOrgSecretCommand : global::System.CommandLine.Command
    {
        ...
        public DependabotAddSelectedRepoToOrgSecretCommand(G.IApi client) : base(
            name: "dependabot",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Dependabot.DependabotAddSelectedRepoToOrgSecretAsync(
                org: org,
                secretName: secretName,
                repositoryId: repositoryId,
                cancellationToken: cancellationToken);
