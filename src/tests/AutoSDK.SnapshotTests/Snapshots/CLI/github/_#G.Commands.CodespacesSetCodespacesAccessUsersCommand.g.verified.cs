//HintName: G.Commands.CodespacesSetCodespacesAccessUsersCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CodespacesSetCodespacesAccessUsersCommand : global::System.CommandLine.Command
    {
        ...
        public CodespacesSetCodespacesAccessUsersCommand(G.IApi client) : base(
            name: "codespaces",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Codespaces.CodespacesSetCodespacesAccessUsersAsync(
                org: org,
                selectedUsernames: selectedUsernames,
                cancellationToken: cancellationToken);
