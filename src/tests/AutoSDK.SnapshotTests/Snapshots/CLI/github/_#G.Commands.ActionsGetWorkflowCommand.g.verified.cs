//HintName: G.Commands.ActionsGetWorkflowCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsGetWorkflowCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsGetWorkflowCommand(G.IApi client) : base(
            name: "actions",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint with a private repository.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsGetWorkflowAsync(
                owner: owner,
                repo: repo,
                workflowId: workflowId,
                cancellationToken: cancellationToken);
