//HintName: G.JsonConverters.SecretScanningListAlertsForOrgDirection.g.cs
#nullable enable
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.SecretScanningListAlertsForOrgDirectionExtensions.ToEnum(stringValue) ?? default;
                    }
