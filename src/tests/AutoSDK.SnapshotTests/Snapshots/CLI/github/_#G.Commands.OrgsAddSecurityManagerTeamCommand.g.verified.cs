//HintName: G.Commands.OrgsAddSecurityManagerTeamCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsAddSecurityManagerTeamCommand : global::System.CommandLine.Command
    {
        ...
        public OrgsAddSecurityManagerTeamCommand(G.IApi client) : base(
            name: "orgs",
...
OAuth app tokens and personal access tokens (classic) need the `write:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Orgs.OrgsAddSecurityManagerTeamAsync(
                org: org,
                teamSlug: teamSlug,
                cancellationToken: cancellationToken);
