//HintName: G.Commands.ReposRequestPagesBuildCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposRequestPagesBuildCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            global::System.CommandLine.ParseResult parseResult,
            global::G.PageBuildStatus response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        public ReposRequestPagesBuildCommand(G.IApi client) : base(
            name: "repos",
...
Build requests are limited to one concurrent build per repository and one concurrent build per requester. If you request a build while another is still in progress, the second request will be queued until the first completes.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposRequestPagesBuildAsync(
                owner: owner,
                repo: repo,
                cancellationToken: cancellationToken);
