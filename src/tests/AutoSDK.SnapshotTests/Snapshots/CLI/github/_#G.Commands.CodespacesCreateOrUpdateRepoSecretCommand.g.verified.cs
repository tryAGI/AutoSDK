//HintName: G.Commands.CodespacesCreateOrUpdateRepoSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CodespacesCreateOrUpdateRepoSecretCommand : global::System.CommandLine.Command
    {
        ...
        public CodespacesCreateOrUpdateRepoSecretCommand(G.IApi client) : base(
            name: "codespaces",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Codespaces.CodespacesCreateOrUpdateRepoSecretAsync(
                owner: owner,
                repo: repo,
                secretName: secretName,
                encryptedValue: encryptedValue,
