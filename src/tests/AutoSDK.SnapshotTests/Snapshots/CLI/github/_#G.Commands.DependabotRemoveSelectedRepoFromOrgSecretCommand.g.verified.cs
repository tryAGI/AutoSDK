//HintName: G.Commands.DependabotRemoveSelectedRepoFromOrgSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class DependabotRemoveSelectedRepoFromOrgSecretCommand : global::System.CommandLine.Command
    {
        ...
        public DependabotRemoveSelectedRepoFromOrgSecretCommand(G.IApi client) : base(
            name: "dependabot",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Dependabot.DependabotRemoveSelectedRepoFromOrgSecretAsync(
                org: org,
                secretName: secretName,
                repositoryId: repositoryId,
                cancellationToken: cancellationToken);
