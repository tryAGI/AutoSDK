//HintName: G.Commands.AppsListAccountsForPlanCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class AppsListAccountsForPlanCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.AppsListAccountsForPlanSort?> Sort { get; } = new(
            name: "sort")
        {
            Description = "",
        };

        private global::System.CommandLine.Option<global::G.AppsListAccountsForPlanDirection?> Direction { get; } = new(
            name: "direction")
        {
            Description = "",
        };
        ...
        public AppsListAccountsForPlanCommand(G.IApi client) : base(
            name: "apps",
...
GitHub Apps must use a [JWT](https://docs.github.com/apps/building-github-apps/authenticating-with-github-apps/#authenticating-as-a-github-app) to access this endpoint. OAuth apps must use [basic authentication](https://docs.github.com/rest/authentication/authenticating-to-the-rest-api#using-basic-authentication) with their client ID and client secret to access this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Apps.AppsListAccountsForPlanAsync(
                planId: planId,
                sort: sort,
                direction: direction,
                perPage: perPage,
