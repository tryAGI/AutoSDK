//HintName: G.Commands.ReactionsCreateForCommitCommentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReactionsCreateForCommitCommentCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.ReactionsCreateForCommitCommentRequestContent> Content { get; } = new(
            name: "content")
        {
            Description = "",
        };

        public ReactionsCreateForCommitCommentCommand(G.IApi client) : base(
            name: "reactions",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Reactions.ReactionsCreateForCommitCommentAsync(
                owner: owner,
                repo: repo,
                commentId: commentId,
                content: content,
