//HintName: G.Commands.ActionsGetEnvironmentSecretCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ActionsGetEnvironmentSecretCommand : global::System.CommandLine.Command
    {
        ...
        public ActionsGetEnvironmentSecretCommand(G.IApi client) : base(
            name: "actions",
...
OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Actions.ActionsGetEnvironmentSecretAsync(
                owner: owner,
                repo: repo,
                environmentName: environmentName,
                secretName: secretName,
