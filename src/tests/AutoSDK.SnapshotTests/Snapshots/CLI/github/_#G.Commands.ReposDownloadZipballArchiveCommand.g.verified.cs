//HintName: G.Commands.ReposDownloadZipballArchiveCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposDownloadZipballArchiveCommand : global::System.CommandLine.Command
    {
        ...
        public ReposDownloadZipballArchiveCommand(G.IApi client) : base(
            name: "repos",
...
> For private repositories, these links are temporary and expire after five minutes. If the repository is empty, you will receive a 404 when you follow the redirect.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Repos.ReposDownloadZipballArchiveAsync(
                owner: owner,
                repo: repo,
                @ref: @ref,
                cancellationToken: cancellationToken);
