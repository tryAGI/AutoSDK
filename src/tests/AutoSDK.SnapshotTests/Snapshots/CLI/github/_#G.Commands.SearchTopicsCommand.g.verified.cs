//HintName: G.Commands.SearchTopicsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class SearchTopicsCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            global::System.CommandLine.ParseResult parseResult,
            global::G.SearchTopicsResponse response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        public SearchTopicsCommand(G.IApi client) : base(
            name: "search",
...
This query searches for topics with the keyword `ruby` and limits the results to find only topics that are featured. The topics that are the best match for the query appear first in the search results.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Search.SearchTopicsAsync(
                q: q,
                perPage: perPage,
                page: page,
                cancellationToken: cancellationToken);
