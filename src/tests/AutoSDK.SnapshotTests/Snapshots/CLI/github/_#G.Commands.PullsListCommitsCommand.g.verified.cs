//HintName: G.Commands.PullsListCommitsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsListCommitsCommand : global::System.CommandLine.Command
    {
        ...
        public PullsListCommitsCommand(G.IApi client) : base(
            name: "pulls",
...
- **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Pulls.PullsListCommitsAsync(
                owner: owner,
                repo: repo,
                pullNumber: pullNumber,
                perPage: perPage,
