...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestLabeledPullRequestBaseRepoLicense
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookPullRequestLabeledPullRequestBaseRepoLicense" /> class.
        /// </summary>
...
#endif
        public WebhookPullRequestLabeledPullRequestBaseRepoLicense(
            string key,
            string name,
            string nodeId,
            string spdxId,
