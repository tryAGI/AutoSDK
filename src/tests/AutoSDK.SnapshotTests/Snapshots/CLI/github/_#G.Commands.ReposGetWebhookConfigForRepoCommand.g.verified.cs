//HintName: G.Commands.ReposGetWebhookConfigForRepoCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposGetWebhookConfigForRepoCommand : global::System.CommandLine.Command
    {
        ...
        public ReposGetWebhookConfigForRepoCommand(G.IApi client) : base(
            name: "repos",
...
OAuth app tokens and personal access tokens (classic) need the `read:repo_hook` or `repo` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposGetWebhookConfigForRepoAsync(
                owner: owner,
                repo: repo,
                hookId: hookId,
                cancellationToken: cancellationToken);
