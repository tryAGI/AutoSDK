//HintName: G.Commands.PullsRequestReviewersCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsRequestReviewersCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<string>?> Reviewers { get; } = new(
            name: "reviewers")
        {
            Description = "",
        };
        ...
        public PullsRequestReviewersCommand(G.IApi client) : base(
            name: "pulls",
...
This endpoint triggers [notifications](https://docs.github.com/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. For more information, see ""[Rate limits for the API](https://docs.github.com/rest/using-the-rest-api/rate-limits-for-the-rest-api#about-secondary-rate-limits)"" and ""[Best practices for using the REST API](https://docs.github.com/rest/guides/best-practices-for-using-the-rest-api).""")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Pulls.PullsRequestReviewersAsync(
                owner: owner,
                repo: repo,
                pullNumber: pullNumber,
                reviewers: reviewers,
