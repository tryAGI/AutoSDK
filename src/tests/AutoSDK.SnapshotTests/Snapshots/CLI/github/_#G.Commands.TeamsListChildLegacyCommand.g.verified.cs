//HintName: G.Commands.TeamsListChildLegacyCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TeamsListChildLegacyCommand : global::System.CommandLine.Command
    {
        ...
        public TeamsListChildLegacyCommand(G.IApi client) : base(
            name: "teams",
            description: @"> [!WARNING]
> **Deprecation notice:** This endpoint route is deprecated and will be removed from the Teams API. We recommend migrating your existing code to use the new [`List child teams`](https://docs.github.com/rest/teams/teams#list-child-teams) endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Teams.TeamsListChildLegacyAsync(
                teamId: teamId,
                perPage: perPage,
                page: page,
                cancellationToken: cancellationToken);
