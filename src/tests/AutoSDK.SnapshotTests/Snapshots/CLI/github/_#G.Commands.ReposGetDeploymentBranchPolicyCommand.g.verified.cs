//HintName: G.Commands.ReposGetDeploymentBranchPolicyCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposGetDeploymentBranchPolicyCommand : global::System.CommandLine.Command
    {
        ...
        public ReposGetDeploymentBranchPolicyCommand(G.IApi client) : base(
            name: "repos",
...
OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint with a private repository.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposGetDeploymentBranchPolicyAsync(
                owner: owner,
                repo: repo,
                environmentName: environmentName,
                branchPolicyId: branchPolicyId,
