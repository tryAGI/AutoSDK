//HintName: G.Commands.ReactionsDeleteForTeamDiscussionCommentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReactionsDeleteForTeamDiscussionCommentCommand : global::System.CommandLine.Command
    {
        ...
        public ReactionsDeleteForTeamDiscussionCommentCommand(G.IApi client) : base(
            name: "reactions",
            description: @"> [!NOTE]
...
OAuth app tokens and personal access tokens (classic) need the `write:discussion` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Reactions.ReactionsDeleteForTeamDiscussionCommentAsync(
                org: org,
                teamSlug: teamSlug,
                discussionNumber: discussionNumber,
                commentNumber: commentNumber,
