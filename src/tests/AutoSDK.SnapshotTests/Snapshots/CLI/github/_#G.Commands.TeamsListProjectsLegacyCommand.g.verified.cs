//HintName: G.Commands.TeamsListProjectsLegacyCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TeamsListProjectsLegacyCommand : global::System.CommandLine.Command
    {
        ...
        public TeamsListProjectsLegacyCommand(G.IApi client) : base(
            name: "teams",
            description: @"> [!WARNING]
...
Lists the organization projects for a team.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Teams.TeamsListProjectsLegacyAsync(
                teamId: teamId,
                perPage: perPage,
                page: page,
                cancellationToken: cancellationToken);
