//HintName: G.Commands.ReposSetAppAccessRestrictionsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposSetAppAccessRestrictionsCommand : global::System.CommandLine.Command
    {
        ...
        public ReposSetAppAccessRestrictionsCommand(G.IApi client) : base(
            name: "repos",
...
Replaces the list of apps that have push access to this branch. This removes all apps that previously had push access and grants push access to the new list of apps. Only GitHub Apps that are installed on the repository and that have been granted write access to the repository contents can be added as authorized actors on a protected branch.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposSetAppAccessRestrictionsAsync(
                owner: owner,
                repo: repo,
                branch: branch,
                apps: apps,
