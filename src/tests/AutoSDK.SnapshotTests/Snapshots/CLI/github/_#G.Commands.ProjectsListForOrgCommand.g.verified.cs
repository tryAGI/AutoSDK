//HintName: G.Commands.ProjectsListForOrgCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ProjectsListForOrgCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.ProjectsListForOrgState?> State { get; } = new(
            name: "state")
        {
            Description = "",
        };
        ...
        public ProjectsListForOrgCommand(G.IApi client) : base(
            name: "projects",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Projects.ProjectsListForOrgAsync(
                org: org,
                state: state,
                perPage: perPage,
                page: page,
