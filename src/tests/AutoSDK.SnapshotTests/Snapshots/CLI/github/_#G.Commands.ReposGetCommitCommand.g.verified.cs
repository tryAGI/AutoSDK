//HintName: G.Commands.ReposGetCommitCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReposGetCommitCommand : global::System.CommandLine.Command
    {
        ...
        public ReposGetCommitCommand(G.IApi client) : base(
            name: "repos",
...
| `valid` | None of the above errors applied, so the signature is considered to be verified. |")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Repos.ReposGetCommitAsync(
                owner: owner,
                repo: repo,
                page: page,
                perPage: perPage,
