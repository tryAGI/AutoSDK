//HintName: G.Commands.PullsSubmitReviewCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PullsSubmitReviewCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.PullsSubmitReviewRequestEvent> Event { get; } = new(
            name: "@event")
        {
            Description = "",
        };
        ...
        public PullsSubmitReviewCommand(G.IApi client) : base(
            name: "pulls",
...
- **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Pulls.PullsSubmitReviewAsync(
                owner: owner,
                repo: repo,
                pullNumber: pullNumber,
                reviewId: reviewId,
