//HintName: G.Commands.ReactionsCreateForTeamDiscussionLegacyCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ReactionsCreateForTeamDiscussionLegacyCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Argument<global::G.ReactionsCreateForTeamDiscussionLegacyRequestContent> Content { get; } = new(
            name: "content")
        {
            Description = "",
        };

        public ReactionsCreateForTeamDiscussionLegacyCommand(G.IApi client) : base(
            name: "reactions",
            description: @"> [!WARNING]
...
OAuth app tokens and personal access tokens (classic) need the `write:discussion` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Reactions.ReactionsCreateForTeamDiscussionLegacyAsync(
                teamId: teamId,
                discussionNumber: discussionNumber,
                content: content,
                cancellationToken: cancellationToken);
