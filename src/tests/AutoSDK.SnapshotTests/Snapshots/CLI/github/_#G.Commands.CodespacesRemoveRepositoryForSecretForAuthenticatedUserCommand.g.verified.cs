//HintName: G.Commands.CodespacesRemoveRepositoryForSecretForAuthenticatedUserCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CodespacesRemoveRepositoryForSecretForAuthenticatedUserCommand : global::System.CommandLine.Command
    {
        ...
        public CodespacesRemoveRepositoryForSecretForAuthenticatedUserCommand(G.IApi client) : base(
            name: "codespaces",
...
OAuth app tokens and personal access tokens (classic) need the `codespace` or `codespace:secrets` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await _client.Codespaces.CodespacesRemoveRepositoryForSecretForAuthenticatedUserAsync(
                secretName: secretName,
                repositoryId: repositoryId,
                cancellationToken: cancellationToken);
