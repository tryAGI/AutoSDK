//HintName: G.Commands.OrgsListOrgRoleUsersCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class OrgsListOrgRoleUsersCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            global::System.CommandLine.ParseResult parseResult,
            global::System.Collections.Generic.IList<global::G.UserRoleAssignment> response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        public OrgsListOrgRoleUsersCommand(G.IApi client) : base(
            name: "orgs",
...
OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Orgs.OrgsListOrgRoleUsersAsync(
                org: org,
                roleId: roleId,
                perPage: perPage,
                page: page,
