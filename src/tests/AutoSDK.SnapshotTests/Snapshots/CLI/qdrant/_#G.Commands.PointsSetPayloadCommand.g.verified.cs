//HintName: G.Commands.PointsSetPayloadCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PointsSetPayloadCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            ...
            global::G.SetPayloadResponse response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        private global::System.CommandLine.Argument<global::G.Payload> Payload { get; } = new(
            name: "payload")
        {
            Description = @"",
        };
        ...
        public PointsSetPayloadCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Points.SetPayloadAsync(
                collectionName: collectionName,
                wait: wait,
                ordering: ordering,
                timeout: timeout,
