//HintName: G.SearchClient.SearchMatrixPairs.g.cs
...
namespace G
{
    public partial class SearchClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchMatrixPairsSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchMatrixPairsSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchMatrixPairsSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_SearchMatrixPairsSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_SearchMatrixPairsSecurityRequirement0,
                s_SearchMatrixPairsSecurityRequirement1,
                s_SearchMatrixPairsSecurityRequirement2,
            };
        ...
        partial void PrepareSearchMatrixPairsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::G.SearchMatrixRequest request);
        partial void ProcessSearchMatrixPairsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchMatrixPairsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.SearchMatrixPairsResponse2> SearchMatrixPairsAsync(
            string collectionName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSearchMatrixPairsArguments(
            ...
            PrepareSearchMatrixPairsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessSearchMatrixPairsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessSearchMatrixPairsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.SearchMatrixPairsResponse2.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.SearchMatrixPairsResponse2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SearchMatrixPairsAsync(
                collectionName: collectionName,
                consistency: consistency,
                timeout: timeout,
                request: __request,
