//HintName: G.Commands.SnapshotsGetShardSnapshotCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class SnapshotsGetShardSnapshotCommand : global::System.CommandLine.Command
    {
        ...
        public SnapshotsGetShardSnapshotCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Snapshots.GetShardSnapshotAsync(
                collectionName: collectionName,
                shardId: shardId,
                snapshotName: snapshotName,
                cancellationToken: cancellationToken);
