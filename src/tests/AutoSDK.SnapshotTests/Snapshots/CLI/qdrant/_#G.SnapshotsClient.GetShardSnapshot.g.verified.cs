//HintName: G.SnapshotsClient.GetShardSnapshot.g.cs
...
namespace G
{
    public partial class SnapshotsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetShardSnapshotSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetShardSnapshotSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetShardSnapshotSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetShardSnapshotSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetShardSnapshotSecurityRequirement0,
                s_GetShardSnapshotSecurityRequirement1,
                s_GetShardSnapshotSecurityRequirement2,
            };
        ...
        partial void PrepareGetShardSnapshotRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string collectionName,
            int shardId,
            string snapshotName);
        partial void ProcessGetShardSnapshotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetShardSnapshotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> GetShardSnapshotAsync(
            string collectionName,
            int shardId,
            string snapshotName,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetShardSnapshotArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetShardSnapshotResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetShardSnapshotResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
