//HintName: G.JsonConverters.VectorOutput.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class VectorOutputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.VectorOutput>
    {
        /// <inheritdoc />
        public override global::G.VectorOutput Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::System.Collections.Generic.IList<float>? vectorOutputVariant1 = default;
            global::G.SparseVector? sparse = default;
            global::System.Collections.Generic.IList<global::System.Collections.Generic.IList<float>>? vectorOutputVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        vectorOutputVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        vectorOutputVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (vectorOutputVariant1 == null && sparse == null && vectorOutputVariant3 == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<float>), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::System.Collections.Generic.IList<float>> ??
            ...
            var __value = new global::G.VectorOutput(
        ...
        public override void Write(
            ...
            global::G.VectorOutput value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsVectorOutputVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::System.Collections.Generic.IList<float>), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::System.Collections.Generic.IList<float>?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::System.Collections.Generic.IList<float>).Name}");
