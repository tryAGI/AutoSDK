//HintName: G.JsonConverters.StemmingAlgorithm.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class StemmingAlgorithmJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.StemmingAlgorithm>
    {
        /// <inheritdoc />
        public override global::G.StemmingAlgorithm Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.SnowballParams? snowballParams = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.StemmingAlgorithm(
                snowballParams
                );
        ...
        public override void Write(
            ...
            global::G.StemmingAlgorithm value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
