...
{
    /// <inheritdoc />
    public class RangeInterfaceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RangeInterface>
    {
        /// <inheritdoc />
        public override global::G.RangeInterface Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            if (__jsonProps.Contains("gt")) __score0++;
            if (__jsonProps.Contains("gte")) __score0++;
            if (__jsonProps.Contains("lt")) __score0++;
            if (__jsonProps.Contains("lte")) __score0++;
            var __score1 = 0;
            if (__jsonProps.Contains("gt")) __score1++;
            if (__jsonProps.Contains("gte")) __score1++;
            if (__jsonProps.Contains("lt")) __score1++;
            if (__jsonProps.Contains("lte")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
