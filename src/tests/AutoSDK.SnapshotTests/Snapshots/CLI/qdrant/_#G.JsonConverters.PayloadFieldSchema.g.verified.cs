...
{
    /// <inheritdoc />
    public class PayloadFieldSchemaJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PayloadFieldSchema>
    {
        /// <inheritdoc />
        public override global::G.PayloadFieldSchema Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::G.PayloadSchemaType), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::G.PayloadSchemaParams), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::G.PayloadSchemaType? type = default;
            global::G.PayloadSchemaParams? @params = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.PayloadFieldSchema(
                type,
        ...
        public override void Write(
            ...
            global::G.PayloadFieldSchema value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
