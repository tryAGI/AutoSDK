//HintName: G.JsonConverters.OrderByInterface.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class OrderByInterfaceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OrderByInterface>
    {
        /// <inheritdoc />
        public override global::G.OrderByInterface Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("start_from")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            string? orderByInterfaceVariant1 = default;
            ...
            var __value = new global::G.OrderByInterface(
        ...
        public override void Write(
            ...
            global::G.OrderByInterface value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsOrderByInterfaceVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.OrderByInterfaceVariant1!, typeInfo);
            }
