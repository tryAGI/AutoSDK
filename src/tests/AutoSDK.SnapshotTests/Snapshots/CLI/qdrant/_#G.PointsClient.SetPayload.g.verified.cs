//HintName: G.PointsClient.SetPayload.g.cs
...
namespace G
{
    public partial class PointsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SetPayloadSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SetPayloadSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SetPayloadSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_SetPayloadSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_SetPayloadSecurityRequirement0,
                s_SetPayloadSecurityRequirement1,
                s_SetPayloadSecurityRequirement2,
            };
        ...
        partial void PrepareSetPayloadRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::G.SetPayload request);
        partial void ProcessSetPayloadResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSetPayloadResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.SetPayloadResponse> SetPayloadAsync(
            string collectionName,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSetPayloadResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.SetPayloadResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.SetPayloadResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
