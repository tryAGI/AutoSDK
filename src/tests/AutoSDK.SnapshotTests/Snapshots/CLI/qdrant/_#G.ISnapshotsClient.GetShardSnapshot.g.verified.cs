...
namespace G
{
    public partial interface ISnapshotsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::System.IO.Stream> GetShardSnapshotAsStreamAsync(
            string collectionName,
            int shardId,
            string snapshotName,
            global::G.AutoSDKRequestOptions? requestOptions = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<byte[]>> GetShardSnapshotAsResponseAsync(
            string collectionName,
            int shardId,
            string snapshotName,
            global::G.AutoSDKRequestOptions? requestOptions = default,
