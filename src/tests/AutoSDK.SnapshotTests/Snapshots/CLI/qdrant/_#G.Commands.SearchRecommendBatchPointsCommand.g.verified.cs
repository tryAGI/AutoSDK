//HintName: G.Commands.SearchRecommendBatchPointsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class SearchRecommendBatchPointsCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            ...
            global::G.RecommendBatchPointsResponse response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        private global::System.CommandLine.Argument<global::System.Collections.Generic.IList<global::G.RecommendRequest>> Searches { get; } = new(
            name: "searches")
        {
            Description = @"",
        };
        ...
        public SearchRecommendBatchPointsCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Search.RecommendBatchPointsAsync(
                collectionName: collectionName,
                consistency: consistency,
                timeout: timeout,
                searches: searches,
