//HintName: G.Commands.PointsBatchUpdateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PointsBatchUpdateCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            ...
            global::G.BatchUpdateResponse response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        private global::System.CommandLine.Argument<global::System.Collections.Generic.IList<global::G.UpdateOperation>> Operations { get; } = new(
            name: "operations")
        {
            Description = @"",
        };
        ...
        public PointsBatchUpdateCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var operations = parseResult.GetRequiredValue(Operations);
            ...
            var response = await _client.Points.BatchUpdateAsync(
                collectionName: collectionName,
                wait: wait,
                ordering: ordering,
                timeout: timeout,
