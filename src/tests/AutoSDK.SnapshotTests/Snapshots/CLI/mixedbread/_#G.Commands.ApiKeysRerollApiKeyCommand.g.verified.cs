//HintName: G.Commands.ApiKeysRerollApiKeyCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ApiKeysRerollApiKeyCommand : global::System.CommandLine.Command
    {
        ...
        public ApiKeysRerollApiKeyCommand(
            G.IApi client,
...
Returns:
    ApiKeyCreated: The response containing the API key details with the new secret key.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.ApiKeys.RerollApiKeyAsync(
                apiKeyId: apiKeyId,
                cancellationToken: cancellationToken);
