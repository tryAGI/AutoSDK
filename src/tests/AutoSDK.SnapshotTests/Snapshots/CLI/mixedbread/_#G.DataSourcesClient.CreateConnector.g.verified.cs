//HintName: G.DataSourcesClient.CreateConnector.g.cs
...
namespace G
{
    public partial class DataSourcesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_CreateConnectorServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateConnectorSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateConnectorSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.DataSourceConnector> CreateConnectorAsync(
            global::System.Guid dataSourceId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DataSourceConnector>> CreateConnectorAsResponseAsync(
            global::System.Guid dataSourceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_CreateConnectorServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v1/data_sources/{dataSourceId}/connectors\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DataSourceConnector.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DataSourceConnector>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DataSourceConnector.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.DataSourceConnector> CreateConnectorAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.DataSourceConnectorCreateParams
            {
                StoreId = storeId,
                Name = name,
