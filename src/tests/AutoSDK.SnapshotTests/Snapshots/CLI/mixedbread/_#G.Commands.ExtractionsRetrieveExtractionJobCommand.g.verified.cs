//HintName: G.Commands.ExtractionsRetrieveExtractionJobCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ExtractionsRetrieveExtractionJobCommand : global::System.CommandLine.Command
    {
        ...
        public ExtractionsRetrieveExtractionJobCommand(
            G.IApi client,
...
Returns:
    Detailed information about the extraction job.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Extractions.RetrieveExtractionJobAsync(
                jobId: jobId,
                cancellationToken: cancellationToken);
