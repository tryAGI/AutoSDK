//HintName: G.Commands.ParsingRetrieveParsingJobCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ParsingRetrieveParsingJobCommand : global::System.CommandLine.Command
    {
        ...
        public ParsingRetrieveParsingJobCommand(
            G.IApi client,
...
Returns:
    Detailed information about the parse job.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Parsing.RetrieveParsingJobAsync(
                jobId: jobId,
                cancellationToken: cancellationToken);
