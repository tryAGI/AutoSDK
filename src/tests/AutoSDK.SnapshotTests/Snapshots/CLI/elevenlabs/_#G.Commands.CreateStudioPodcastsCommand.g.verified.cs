//HintName: G.Commands.CreateStudioPodcastsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CreateStudioPodcastsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.BodyCreatePodcastV1StudioPodcastsPostQualityPreset?> QualityPreset { get; } = new(
            name: "qualityPreset")
        {
            Description = "",
        };

        private global::System.CommandLine.Option<global::G.BodyCreatePodcastV1StudioPodcastsPostDurationScale?> DurationScale { get; } = new(
            name: "durationScale")
        {
            Description = "",
        };
        ...
        public CreateStudioPodcastsCommand(G.IApi client) : base(
            name: "create",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Studio.CreateStudioPodcastsAsync(
                xiApiKey: xiApiKey,
                modelId: modelId,
                mode: mode,
                source: source,
