//HintName: G.Commands.CreateSpeechToSpeechByVoiceIdStreamCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CreateSpeechToSpeechByVoiceIdStreamCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.SpeechToSpeechStreamingV1SpeechToSpeechVoiceIdStreamPostOutputFormat?> OutputFormat { get; } = new(
            name: "outputFormat")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<global::G.BodySpeechToSpeechStreamingV1SpeechToSpeechVoiceIdStreamPostFileFormat?> FileFormat { get; } = new(
            name: "fileFormat")
        {
            Description = "",
        };
        public CreateSpeechToSpeechByVoiceIdStreamCommand(G.IApi client) : base(
            name: "create",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.SpeechToSpeech.CreateSpeechToSpeechByVoiceIdStreamAsync(
                voiceId: voiceId,
                enableLogging: enableLogging,
                optimizeStreamingLatency: optimizeStreamingLatency,
                outputFormat: outputFormat,
