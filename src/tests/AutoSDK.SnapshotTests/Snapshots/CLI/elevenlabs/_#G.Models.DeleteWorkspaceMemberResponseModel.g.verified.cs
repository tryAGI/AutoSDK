//HintName: G.Models.DeleteWorkspaceMemberResponseModel.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteWorkspaceMemberResponseModel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteWorkspaceMemberResponseModel" /> class.
        /// </summary>
        /// <param name="status">
        /// The status of the workspace member deletion request. If the request was successful, the status will be 'ok'. Otherwise an error message with status 500 will be returned.
        /// </param>
...
#endif
        public DeleteWorkspaceMemberResponseModel(
            string status)
        {
