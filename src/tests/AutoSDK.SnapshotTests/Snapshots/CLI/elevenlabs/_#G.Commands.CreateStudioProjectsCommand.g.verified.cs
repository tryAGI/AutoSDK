//HintName: G.Commands.CreateStudioProjectsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CreateStudioProjectsCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.BodyCreateStudioProjectV1StudioProjectsPostTargetAudience?> TargetAudience { get; } = new(
            name: "targetAudience")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<global::G.BodyCreateStudioProjectV1StudioProjectsPostFiction?> Fiction { get; } = new(
            name: "fiction")
        {
            Description = "",
        };

        private global::System.CommandLine.Option<global::G.BodyCreateStudioProjectV1StudioProjectsPostApplyTextNormalization?> ApplyTextNormalization { get; } = new(
        ...
        private global::System.CommandLine.Option<global::G.BodyCreateStudioProjectV1StudioProjectsPostSourceType?> SourceType { get; } = new(
            name: "sourceType")
        {
            Description = "",
        };
        public CreateStudioProjectsCommand(G.IApi client) : base(
            name: "create",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Studio.CreateStudioProjectsAsync(
                xiApiKey: xiApiKey,
                name: name,
                defaultTitleVoiceId: defaultTitleVoiceId,
                defaultParagraphVoiceId: defaultParagraphVoiceId,
