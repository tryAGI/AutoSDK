//HintName: G.Commands.CreateTextToSpeechByVoiceIdCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CreateTextToSpeechByVoiceIdCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.TextToSpeechV1TextToSpeechVoiceIdPostOutputFormat?> OutputFormat { get; } = new(
            name: "outputFormat")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<global::G.BodyTextToSpeechV1TextToSpeechVoiceIdPostApplyTextNormalization?> ApplyTextNormalization { get; } = new(
        ...
        public CreateTextToSpeechByVoiceIdCommand(G.IApi client) : base(
            name: "create",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.TextToSpeech.CreateTextToSpeechByVoiceIdAsync(
                voiceId: voiceId,
                enableLogging: enableLogging,
                optimizeStreamingLatency: optimizeStreamingLatency,
                outputFormat: outputFormat,
