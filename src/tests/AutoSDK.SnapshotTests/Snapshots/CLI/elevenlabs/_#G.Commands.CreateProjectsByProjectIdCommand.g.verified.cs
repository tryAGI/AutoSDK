//HintName: G.Commands.CreateProjectsByProjectIdCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CreateProjectsByProjectIdCommand : global::System.CommandLine.Command
    {
        ...
        public CreateProjectsByProjectIdCommand(G.IApi client) : base(
            name: "create",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Projects.CreateProjectsByProjectIdAsync(
                projectId: projectId,
                xiApiKey: xiApiKey,
                name: name,
                defaultTitleVoiceId: defaultTitleVoiceId,
