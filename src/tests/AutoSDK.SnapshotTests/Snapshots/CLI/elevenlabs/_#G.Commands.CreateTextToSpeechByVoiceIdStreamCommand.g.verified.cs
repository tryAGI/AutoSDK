//HintName: G.Commands.CreateTextToSpeechByVoiceIdStreamCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CreateTextToSpeechByVoiceIdStreamCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::G.TextToSpeechStreamingV1TextToSpeechVoiceIdStreamPostOutputFormat?> OutputFormat { get; } = new(
            name: "outputFormat")
        {
            Description = "",
        };
        ...
        private global::System.CommandLine.Option<global::G.BodyTextToSpeechStreamingV1TextToSpeechVoiceIdStreamPostApplyTextNormalization?> ApplyTextNormalization { get; } = new(
        ...
        public CreateTextToSpeechByVoiceIdStreamCommand(G.IApi client) : base(
            name: "create",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.TextToSpeech.CreateTextToSpeechByVoiceIdStreamAsync(
                voiceId: voiceId,
                enableLogging: enableLogging,
                optimizeStreamingLatency: optimizeStreamingLatency,
                outputFormat: outputFormat,
