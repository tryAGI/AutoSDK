//HintName: G.Commands.ChatGetEmoteSetsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChatGetEmoteSetsCommand : global::System.CommandLine.Command
    {
...
To get emote set IDs, use the [Get Channel Emotes](https://dev.twitch.tv/docs/api/reference#get-channel-emotes) API.",
        ...
        public ChatGetEmoteSetsCommand(
            G.IApi client,
