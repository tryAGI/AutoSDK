...
namespace G
{
    internal sealed class MainCommand : global::System.CommandLine.RootCommand
    {
        public MainCommand(
            ...
            CCLGroupCommand command3,
            ChannelGroupCommand command4,
            ChannelPointGroupCommand command5,
            CharityGroupCommand command6,
            ChatGroupCommand command7,
            ClipGroupCommand command8,
            ConduitGroupCommand command9,
            EntitlementGroupCommand command10,
            EventSubGroupCommand command11,
            ExtensionGroupCommand command12,
