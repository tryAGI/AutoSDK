//HintName: G.Commands.ChatSendChatAnnouncementCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChatSendChatAnnouncementCommand : global::System.CommandLine.Command
    {
...
If `color` is set to _primary_ or is not set, the channel’s accent color is used to highlight the announcement (see **Profile Accent Color** under [profile settings](https://www.twitch.tv/settings/profile), **Channel and Videos**, and **Brand**).",
        ...
        public ChatSendChatAnnouncementCommand(
            G.IApi client,
