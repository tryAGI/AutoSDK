//HintName: G.Commands.UsersGetUserActiveExtensionsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class UsersGetUserActiveExtensionsCommand : global::System.CommandLine.Command
    {
...
This parameter is required if you specify an app access token and is optional if you specify a user access token. If you specify a user access token and don’t specify this parameter, the API uses the user ID from the access token.",
        ...
        public UsersGetUserActiveExtensionsCommand(
            G.IApi client,
