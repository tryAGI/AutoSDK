//HintName: G.Commands.ScheduleUpdateChannelStreamScheduleSegmentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ScheduleUpdateChannelStreamScheduleSegmentCommand : global::System.CommandLine.Command
    {
...
**NOTE**: For recurring segments, the API cancels the first segment after the current UTC date and time and not the specified segment (unless the specified segment is the next segment after the current UTC date and time).",
        ...
        public ScheduleUpdateChannelStreamScheduleSegmentCommand(
            G.IApi client,
