//HintName: G.Commands.UsersUpdateUserExtensionsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class UsersUpdateUserExtensionsCommand : global::System.CommandLine.Command
    {
...
For component extensions, the key’s value includes the above fields plus the `x` and `y` fields, which identify the coordinate where the extension is placed.",
        ...
        public UsersUpdateUserExtensionsCommand(
            G.IApi client,
