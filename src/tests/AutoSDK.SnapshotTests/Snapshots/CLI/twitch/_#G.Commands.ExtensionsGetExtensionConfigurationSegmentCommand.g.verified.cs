//HintName: G.Commands.ExtensionsGetExtensionConfigurationSegmentCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ExtensionsGetExtensionConfigurationSegmentCommand : global::System.CommandLine.Command
    {
...
You may specify one or more segments. To specify multiple segments, include the `segment` parameter for each segment to get. For example, `segment=broadcaster&segment=developer`. Ignores duplicate segments.",
        ...
        public ExtensionsGetExtensionConfigurationSegmentCommand(
            G.IApi client,
