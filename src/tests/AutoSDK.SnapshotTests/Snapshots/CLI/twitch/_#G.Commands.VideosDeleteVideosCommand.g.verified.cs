//HintName: G.Commands.VideosDeleteVideosCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VideosDeleteVideosCommand : global::System.CommandLine.Command
    {
...
If the user doesn’t have permission to delete one of the videos in the list, none of the videos are deleted.",
        ...
        public VideosDeleteVideosCommand(
            G.IApi client,
