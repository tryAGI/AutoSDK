//HintName: G.Commands.CCLsGetContentClassificationLabelsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CCLsGetContentClassificationLabelsCommand : global::System.CommandLine.Command
    {
...
Supported locales: `""bg-BG"", ""cs-CZ"", ""da-DK"", ""da-DK"", ""de-DE"", ""el-GR"", ""en-GB"", ""en-US"", ""es-ES"", ""es-MX"", ""fi-FI"", ""fr-FR"", ""hu-HU"", ""it-IT"", ""ja-JP"", ""ko-KR"", ""nl-NL"", ""no-NO"", ""pl-PL"", ""pt-BT"", ""pt-PT"", ""ro-RO"", ""ru-RU"", ""sk-SK"", ""sv-SE"", ""th-TH"", ""tr-TR"", ""vi-VN"", ""zh-CN"", ""zh-TW""`",
        ...
        public CCLsGetContentClassificationLabelsCommand(
            G.IApi client,
