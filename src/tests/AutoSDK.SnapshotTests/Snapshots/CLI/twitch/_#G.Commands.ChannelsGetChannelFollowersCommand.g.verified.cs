//HintName: G.Commands.ChannelsGetChannelFollowersCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChannelsGetChannelFollowersCommand : global::System.CommandLine.Command
    {
...
Using this parameter requires both a user access token with the **moderator:read:followers** scope and the user ID in the access token match the broadcaster\_id or be the user ID for a moderator of the specified broadcaster.",
        ...
        public ChannelsGetChannelFollowersCommand(
            G.IApi client,
