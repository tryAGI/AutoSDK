//HintName: G.Commands.ExtensionsSendExtensionPubsubMessageCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ExtensionsSendExtensionPubsubMessageCommand : global::System.CommandLine.Command
    {
...
If `is_global_broadcast` is **true**, you must set this field to global. The broadcast and global values are mutually exclusive; specify only one of them.",
        ...
        public ExtensionsSendExtensionPubsubMessageCommand(
            G.IApi client,
