//HintName: G.Commands.ChannelsModifyChannelInformationCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChannelsModifyChannelInformationCommand : global::System.CommandLine.Command
    {
...
A channel may specify a maximum of 10 tags. Each tag is limited to a maximum of 25 characters and may not be an empty string or contain spaces or special characters. Tags are case insensitive. For readability, consider using camelCasing or PascalCasing.",
        ...
        public ChannelsModifyChannelInformationCommand(
            G.IApi client,
