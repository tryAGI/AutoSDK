//HintName: G.Commands.PredictionsEndPredictionCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PredictionsEndPredictionCommand : global::System.CommandLine.Command
    {
...
The broadcaster has up to 24 hours after the prediction window closes to resolve the prediction. If not, Twitch sets the status to CANCELED and returns the points.",
        ...
        public PredictionsEndPredictionCommand(
            G.IApi client,
