//HintName: G.Commands.ModerationGetModeratorsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ModerationGetModeratorsCommand : global::System.CommandLine.Command
    {
...
The returned list includes only the users from the list who are moderators in the broadcaster’s channel. The list is returned in the same order as you specified the IDs.",
        ...
        public ModerationGetModeratorsCommand(
            G.IApi client,
