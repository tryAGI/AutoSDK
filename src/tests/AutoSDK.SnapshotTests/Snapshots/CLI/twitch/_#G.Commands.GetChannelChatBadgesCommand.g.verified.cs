//HintName: G.Commands.GetChannelChatBadgesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class GetChannelChatBadgesCommand : global::System.CommandLine.Command
    {
        ...
        partial void Complete(
            global::System.CommandLine.ParseResult parseResult,
            global::G.GetChannelChatBadgesResponse response,
            global::System.Threading.CancellationToken cancellationToken);
        ...
        public GetChannelChatBadgesCommand(G.IApi client) : base(
            name: "get",
...
Requires an [app access token](https://dev.twitch.tv/docs/authentication#app-access-tokens) or [user access token](https://dev.twitch.tv/docs/authentication#user-access-tokens).")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Chat.GetChannelChatBadgesAsync(
                broadcasterId: broadcasterId,
                cancellationToken: cancellationToken);
