//HintName: G.Commands.ChannelPointsGetCustomRewardCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChannelPointsGetCustomRewardCommand : global::System.CommandLine.Command
    {
...
Duplicate IDs are ignored. The response contains only the IDs that were found. If none of the IDs were found, the response is 404 Not Found.",
        ...
        public ChannelPointsGetCustomRewardCommand(
            G.IApi client,
