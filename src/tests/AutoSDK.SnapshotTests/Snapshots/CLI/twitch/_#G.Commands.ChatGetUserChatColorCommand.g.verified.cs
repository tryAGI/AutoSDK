//HintName: G.Commands.ChatGetUserChatColorCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChatGetUserChatColorCommand : global::System.CommandLine.Command
    {
...
The API ignores duplicate IDs and IDs that weren’t found.",
        ...
        public ChatGetUserChatColorCommand(
            G.IApi client,
