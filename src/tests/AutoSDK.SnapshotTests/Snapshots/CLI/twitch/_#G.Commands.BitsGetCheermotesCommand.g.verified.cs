//HintName: G.Commands.BitsGetCheermotesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class BitsGetCheermotesCommand : global::System.CommandLine.Command
    {
...
If the broadcaster uploaded Cheermotes, the `type` field in the response is set to **channel\_custom**.",
        ...
        public BitsGetCheermotesCommand(
            G.IApi client,
