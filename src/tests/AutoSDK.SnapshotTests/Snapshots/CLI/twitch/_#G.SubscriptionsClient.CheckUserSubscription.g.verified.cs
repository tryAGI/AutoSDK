...
namespace G
{
    public partial class SubscriptionsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CheckUserSubscriptionSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CheckUserSubscriptionSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CheckUserSubscriptionSecurityRequirement0,
            };
        ...
        {
            var __response = await CheckUserSubscriptionAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CheckUserSubscriptionResponse>> CheckUserSubscriptionAsResponseAsync(
            string broadcasterId,
            string userId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CheckUserSubscriptionSecurityRequirements,
                operationName: "CheckUserSubscriptionAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CheckUserSubscriptionAsync",
                                pathTemplate: "\"/subscriptions/user\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CheckUserSubscriptionResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CheckUserSubscriptionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CheckUserSubscriptionResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
