...
namespace G
{
    public partial interface IExtensionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetExtensionConfigurationSegmentResponse>> GetExtensionConfigurationSegmentAsResponseAsync(
            string extensionId,
            global::G.GetExtensionConfigurationSegmentSegment segment,
            string? broadcasterId = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
