//HintName: G.Commands.ModerationGetBannedUsersCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ModerationGetBannedUsersCommand : global::System.CommandLine.Command
    {
...
The returned list includes only those users that were banned or put in a timeout. The list is returned in the same order that you specified the IDs.",
        ...
        public ModerationGetBannedUsersCommand(
            G.IApi client,
