//HintName: G.Commands.ModerationAddBlockedTermCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ModerationAddBlockedTermCommand : global::System.CommandLine.Command
    {
...
If the blocked term already exists, the response contains the existing blocked term.",
        ...
        public ModerationAddBlockedTermCommand(
            G.IApi client,
