//HintName: G.Commands.ChatUpdateChatSettingsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChatUpdateChatSettingsCommand : global::System.CommandLine.Command
    {
...
Set to **true** if the broadcaster allows only unique messages; otherwise, **false**. The default is **false**.",
        ...
        public ChatUpdateChatSettingsCommand(
            G.IApi client,
