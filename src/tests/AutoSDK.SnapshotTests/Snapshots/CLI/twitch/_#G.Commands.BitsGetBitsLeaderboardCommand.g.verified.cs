//HintName: G.Commands.BitsGetBitsLeaderboardCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class BitsGetBitsLeaderboardCommand : global::System.CommandLine.Command
    {
...
If your start date uses the ‘+’ offset operator (for example, `2022-01-01T00:00:00.0+05:00`), you must URL encode the start date.",
        ...
        public BitsGetBitsLeaderboardCommand(
            G.IApi client,
