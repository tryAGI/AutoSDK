//HintName: G.Commands.StreamsGetStreamsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class StreamsGetStreamsCommand : global::System.CommandLine.Command
    {
...
You may specify a maximum of 100 language codes. To specify multiple languages, include the _language_ parameter for each language. For example, `&language=de&language=fr`.",
        ...
        public StreamsGetStreamsCommand(
            G.IApi client,
