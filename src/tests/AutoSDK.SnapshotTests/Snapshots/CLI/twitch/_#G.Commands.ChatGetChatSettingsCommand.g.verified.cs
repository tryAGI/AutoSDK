//HintName: G.Commands.ChatGetChatSettingsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ChatGetChatSettingsCommand : global::System.CommandLine.Command
    {
...
If you specify this field, this ID must match the user ID in the user access token.",
        ...
        public ChatGetChatSettingsCommand(
            G.IApi client,
