...
{
    /// <inheritdoc />
    public sealed class ModeratedContentDetectorConfigCategorieJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModeratedContentDetectorConfigCategorie>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ModeratedContentDetectorConfigCategorieExtensions.ToValueString(value));
        }
    }
}
