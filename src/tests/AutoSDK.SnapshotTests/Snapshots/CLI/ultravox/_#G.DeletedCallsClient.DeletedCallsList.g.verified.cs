...
namespace G
{
    public partial class DeletedCallsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DeletedCallsListSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_DeletedCallsListSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        {
            var __response = await DeletedCallsListAsResponseAsync(
                cursor: cursor,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedCallTombstoneList>> DeletedCallsListAsResponseAsync(
            string? cursor = default,
            string? durationMax = default,
            string? durationMin = default,
            global::System.DateTime? fromDate = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeletedCallsList",
                                methodName: "DeletedCallsListAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaginatedCallTombstoneList.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaginatedCallTombstoneList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaginatedCallTombstoneList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
