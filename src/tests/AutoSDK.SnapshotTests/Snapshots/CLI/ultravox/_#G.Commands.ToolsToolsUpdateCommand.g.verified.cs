//HintName: G.Commands.ToolsToolsUpdateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ToolsToolsUpdateCommand : global::System.CommandLine.Command
    {
 ...
 implementation (http or client) should be set.",
        ...
        public ToolsToolsUpdateCommand(
            G.IApi client,
