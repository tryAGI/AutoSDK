//HintName: G.ToolsClient.ToolsHistoryList.g.cs
...
namespace G
{
    public partial class ToolsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedToolHistoryList> ToolsHistoryListAsync(
            global::System.Guid toolId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedToolHistoryList>> ToolsHistoryListAsResponseAsync(
            global::System.Guid toolId,
            string? cursor = default,
            int? pageSize = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ToolsHistoryList",
                                methodName: "ToolsHistoryListAsync",
                                pathTemplate: "$\"/api/tools/{toolId}/history\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaginatedToolHistoryList.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaginatedToolHistoryList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaginatedToolHistoryList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
