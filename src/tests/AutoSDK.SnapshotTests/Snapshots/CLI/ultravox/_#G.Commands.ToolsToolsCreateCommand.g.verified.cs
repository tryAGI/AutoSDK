//HintName: G.Commands.ToolsToolsCreateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ToolsToolsCreateCommand : global::System.CommandLine.Command
    {
 ...
 implementation (http or client) should be set.",
        ...
        public ToolsToolsCreateCommand(
            G.IApi client,
