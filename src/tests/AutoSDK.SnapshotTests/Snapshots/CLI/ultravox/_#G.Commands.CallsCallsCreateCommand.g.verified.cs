//HintName: G.Commands.CallsCallsCreateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CallsCallsCreateCommand : global::System.CommandLine.Command
    {
 ...
 Keys may not start with ""ultravox."", which is reserved for system-provided metadata.",
        ...
        public CallsCallsCreateCommand(
            G.IApi client,
