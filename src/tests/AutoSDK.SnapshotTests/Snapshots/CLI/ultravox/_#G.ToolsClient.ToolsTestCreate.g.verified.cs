//HintName: G.ToolsClient.ToolsTestCreate.g.cs
...
namespace G
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ToolsTestCreateSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ToolsTestCreateSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> ToolsTestCreateAsResponseAsync(
            global::System.Guid toolId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_default = global::System.Text.Json.JsonSerializer.Deserialize<string?>(__content_default, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
