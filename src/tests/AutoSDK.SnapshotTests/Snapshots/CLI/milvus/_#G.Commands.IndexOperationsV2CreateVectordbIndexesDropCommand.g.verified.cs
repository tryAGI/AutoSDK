//HintName: G.Commands.IndexOperationsV2CreateVectordbIndexesDropCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class IndexOperationsV2CreateVectordbIndexesDropCommand : global::System.CommandLine.Command
    {
...
Setting this to a non-existing collection results in a **MilvusException**.",
        ...
        private global::System.CommandLine.Argument<string> IndexName1 { get; } = new(
            name: "indexName1")
        {
...
Setting this to a non-existing database results in a **MilvusException**.",
        ...
        public IndexOperationsV2CreateVectordbIndexesDropCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var indexName1 = parseResult.GetRequiredValue(IndexName1);
            ...
            await _client.IndexOperationsV2.CreateVectordbIndexesDropAsync(
                requestTimeout: requestTimeout,
                authorization: authorization,
                dbName: dbName,
                collectionName: collectionName,
