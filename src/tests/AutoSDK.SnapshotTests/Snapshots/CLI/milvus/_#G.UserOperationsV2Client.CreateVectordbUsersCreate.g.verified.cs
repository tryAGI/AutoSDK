//HintName: G.UserOperationsV2Client.CreateVectordbUsersCreate.g.cs
...
namespace G
{
    public partial class UserOperationsV2Client
    {
        ...
        public async global::System.Threading.Tasks.Task CreateVectordbUsersCreateAsync(
        ...
        {
            await CreateVectordbUsersCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> CreateVectordbUsersCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (authorization != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateVectordbUsersCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createVectordbUsersCreate",
                                methodName: "CreateVectordbUsersCreateAsync",
                                pathTemplate: "\"/v2/vectordb/users/create\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateVectordbUsersCreateResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task CreateVectordbUsersCreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.Password
            {
                UserName = userName,
                Password1 = password1,
            };
