//HintName: G.Commands.CollectionOperationsV2CreateVectordbCollectionsRenameCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CollectionOperationsV2CreateVectordbCollectionsRenameCommand : global::System.CommandLine.Command
    {
...
Setting this to a non-existing collection results in a **MilvusException**.",
        ...
        private global::System.CommandLine.Argument<string> NewCollectionName { get; } = new(
...
Setting this to a non-existing database results in a **MilvusException**.",
        ...
        private global::System.CommandLine.Option<string?> NewDbName { get; } = new(
            name: "newDbName")
        {
...
Setting this to a non-existing database results in a **MilvusException**.",
        ...
        public CollectionOperationsV2CreateVectordbCollectionsRenameCommand(
            G.IApi client,
            ...
            description: @"This operation renames an existing collection and optionally moves the collection to a new database.")
        {
            ...
            Arguments.Add(NewCollectionName);
            Options.Add(RequestTimeout);
            Options.Add(Authorization);
            Options.Add(DbName);
            Options.Add(NewDbName);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var newDbName = parseResult.GetRequiredValue(NewDbName);
            var newCollectionName = parseResult.GetRequiredValue(NewCollectionName);
            ...
            await _client.CollectionOperationsV2.CreateVectordbCollectionsRenameAsync(
                requestTimeout: requestTimeout,
                authorization: authorization,
                dbName: dbName,
                collectionName: collectionName,
