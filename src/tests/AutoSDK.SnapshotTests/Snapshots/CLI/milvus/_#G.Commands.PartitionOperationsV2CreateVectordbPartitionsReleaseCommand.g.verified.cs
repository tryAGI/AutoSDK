//HintName: G.Commands.PartitionOperationsV2CreateVectordbPartitionsReleaseCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class PartitionOperationsV2CreateVectordbPartitionsReleaseCommand : global::System.CommandLine.Command
    {
...
Setting this to a non-existing collection results in a **MilvusException**.",
        ...
        private global::System.CommandLine.Argument<global::System.Collections.Generic.IList<string>> PartitionNames1 { get; } = new(
            name: "partitionNames1")
        {
...
Setting this to a non-existing database results in a **MilvusException**.",
        ...
        public PartitionOperationsV2CreateVectordbPartitionsReleaseCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var partitionNames1 = parseResult.GetRequiredValue(PartitionNames1);
            ...
            await _client.PartitionOperationsV2.CreateVectordbPartitionsReleaseAsync(
                requestTimeout: requestTimeout,
                authorization: authorization,
                dbName: dbName,
                collectionName: collectionName,
