...
namespace G
{
    public partial interface IVdpClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListPipelineRunsByRequesterResponse>> PipelinePublicServiceListPipelineRunsByRequesterAsResponseAsync(
            string requesterId,
            int? page = default,
            int? pageSize = default,
            string? filter = default,
