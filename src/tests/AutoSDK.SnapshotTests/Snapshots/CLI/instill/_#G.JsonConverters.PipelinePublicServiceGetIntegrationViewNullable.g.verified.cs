...
{
    /// <inheritdoc />
    public sealed class PipelinePublicServiceGetIntegrationViewNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PipelinePublicServiceGetIntegrationView?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PipelinePublicServiceGetIntegrationViewExtensions.ToValueString(value.Value));
            }
        }
    }
}
