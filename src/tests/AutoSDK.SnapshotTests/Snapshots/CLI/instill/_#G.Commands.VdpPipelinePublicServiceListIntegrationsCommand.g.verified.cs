//HintName: G.Commands.VdpPipelinePublicServiceListIntegrationsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VdpPipelinePublicServiceListIntegrationsCommand : global::System.CommandLine.Command
    {
...
- List integrations where app name or vendor match `googl`: `q=""googl""`.",
        ...
        public VdpPipelinePublicServiceListIntegrationsCommand(
            G.IApi client,
