...
namespace G
{
    public partial class ArtifactClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ListCatalogFilesServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ListCatalogFilesSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ListCatalogFilesSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_ListCatalogFilesSecurityRequirement0,
            };
        ...
        {
            var __response = await ListCatalogFilesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListCatalogFilesResponse>> ListCatalogFilesAsResponseAsync(
            string namespaceId,
            string catalogId,
            int? pageSize = default,
            string? pageToken = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListCatalogFilesSecurityRequirements,
                operationName: "ListCatalogFilesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ListCatalogFilesServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListCatalogFilesAsync",
                                pathTemplate: "$\"/v1alpha/namespaces/{namespaceId}/catalogs/{catalogId}/files\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ListCatalogFilesResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ListCatalogFilesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ListCatalogFilesResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
