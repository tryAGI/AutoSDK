//HintName: G.Commands.NamespaceCreateTokenCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class NamespaceCreateTokenCommand : global::System.CommandLine.Command
    {
...
This field can reflect the client(s) that will use the token.",
        ...
        public NamespaceCreateTokenCommand(
            G.IApi client,
