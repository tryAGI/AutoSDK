//HintName: G.Commands.ModelModelPublicServiceRenameNamespaceModelCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ModelModelPublicServiceRenameNamespaceModelCommand : global::System.CommandLine.Command
    {
...
`namespaces/{namespace.id}/models/{new_model_id}`.",
        ...
        public ModelModelPublicServiceRenameNamespaceModelCommand(
            G.IApi client,
