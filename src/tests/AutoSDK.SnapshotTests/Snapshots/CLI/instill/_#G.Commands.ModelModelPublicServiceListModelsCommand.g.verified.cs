//HintName: G.Commands.ModelModelPublicServiceListModelsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ModelModelPublicServiceListModelsCommand : global::System.CommandLine.Command
    {
...
Format: `order_by=id` or `order_by=create_time desc`, default is `asc`.",
        ...
        public ModelModelPublicServiceListModelsCommand(
            G.IApi client,
