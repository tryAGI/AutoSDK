//HintName: G.Commands.VdpPipelinePublicServiceListNamespaceConnectionsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VdpPipelinePublicServiceListNamespaceConnectionsCommand : global::System.CommandLine.Command
    {
...
- List connections where the component type is `openai` (e.g. to setup a connector within a pipeline): `integrationId=""openai""`.",
        ...
        public VdpPipelinePublicServiceListNamespaceConnectionsCommand(
            G.IApi client,
