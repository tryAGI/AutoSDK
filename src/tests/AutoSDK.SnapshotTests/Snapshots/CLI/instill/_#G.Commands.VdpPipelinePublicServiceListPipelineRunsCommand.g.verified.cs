//HintName: G.Commands.VdpPipelinePublicServiceListPipelineRunsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VdpPipelinePublicServiceListPipelineRunsCommand : global::System.CommandLine.Command
    {
...
Format: `order_by=id` or `order_by=create_time desc`, default is `asc`.",
        ...
        public VdpPipelinePublicServiceListPipelineRunsCommand(
            G.IApi client,
