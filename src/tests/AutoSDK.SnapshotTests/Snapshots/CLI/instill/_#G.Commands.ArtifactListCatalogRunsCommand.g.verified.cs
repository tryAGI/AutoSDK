//HintName: G.Commands.ArtifactListCatalogRunsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ArtifactListCatalogRunsCommand : global::System.CommandLine.Command
    {
...
Format: `order_by=id` or `order_by=create_time desc`, default is `asc`.",
        ...
        public ArtifactListCatalogRunsCommand(
            G.IApi client,
