//HintName: G.Commands.VdpPipelinePublicServiceListPipelinesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VdpPipelinePublicServiceListPipelinesCommand : global::System.CommandLine.Command
    {
...
Format: `order_by=id` or `order_by=create_time desc`, default is `asc`.",
        ...
        public VdpPipelinePublicServiceListPipelinesCommand(
            G.IApi client,
