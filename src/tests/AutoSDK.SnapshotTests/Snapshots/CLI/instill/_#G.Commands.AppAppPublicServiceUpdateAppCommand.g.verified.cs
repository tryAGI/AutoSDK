//HintName: G.Commands.AppAppPublicServiceUpdateAppCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class AppAppPublicServiceUpdateAppCommand : global::System.CommandLine.Command
    {
...
If the last AI assistant app top k is empty, the last AI assistant app top k will be set to empty.",
        ...
        public AppAppPublicServiceUpdateAppCommand(
            G.IApi client,
