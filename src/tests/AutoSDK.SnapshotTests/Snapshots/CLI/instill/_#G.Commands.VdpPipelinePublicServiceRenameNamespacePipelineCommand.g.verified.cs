//HintName: G.Commands.VdpPipelinePublicServiceRenameNamespacePipelineCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VdpPipelinePublicServiceRenameNamespacePipelineCommand : global::System.CommandLine.Command
    {
...
`namespaces/{namespace.id}/pipelines/{new_pipeline_id}`.",
        ...
        public VdpPipelinePublicServiceRenameNamespacePipelineCommand(
            G.IApi client,
