//HintName: G.Commands.VdpPipelinePublicServiceListNamespacePipelinesCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VdpPipelinePublicServiceListNamespacePipelinesCommand : global::System.CommandLine.Command
    {
...
Format: `order_by=id` or `order_by=create_time desc`, default is `asc`.",
        ...
        public VdpPipelinePublicServiceListNamespacePipelinesCommand(
            G.IApi client,
