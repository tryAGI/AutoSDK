...
{
    /// <inheritdoc />
    public sealed class PipelinePublicServiceListPipelinesVisibilityNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PipelinePublicServiceListPipelinesVisibility?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PipelinePublicServiceListPipelinesVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
