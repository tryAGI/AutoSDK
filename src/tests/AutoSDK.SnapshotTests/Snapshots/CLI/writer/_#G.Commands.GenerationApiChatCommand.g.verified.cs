//HintName: G.Commands.GenerationApiChatCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class GenerationApiChatCommand : global::System.CommandLine.Command
    {
...
`text` is the default response format. [JSON Schema](https://json-schema.org/) is supported for structured responses. If you specify `json_schema`, you must also provide a `json_schema` object.",
        ...
        public GenerationApiChatCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.GenerationApi.ChatAsync(
                model: model,
                messages: messages,
                maxTokens: maxTokens,
                temperature: temperature,
