...
namespace G
{
    public partial interface ITemplateClient
    {
        ...
        ///  --header "Authorization: Bearer &lt;token&gt;"
        /// </remarks>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetAsyncApplicationJobsResponse>> GetApplicationsByApplicationIdJobsAsResponseAsync(
            string applicationId,
            global::G.ApiJobStatus? status = default,
            long? offset = default,
            int? limit = default,
