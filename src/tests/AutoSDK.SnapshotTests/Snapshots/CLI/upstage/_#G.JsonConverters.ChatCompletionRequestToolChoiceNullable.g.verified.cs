...
{
    /// <inheritdoc />
    public sealed class ChatCompletionRequestToolChoiceNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionRequestToolChoice?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ChatCompletionRequestToolChoiceExtensions.ToValueString(value.Value));
            }
        }
    }
}
