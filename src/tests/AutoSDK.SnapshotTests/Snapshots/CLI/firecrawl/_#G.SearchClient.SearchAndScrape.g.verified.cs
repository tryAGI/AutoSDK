//HintName: G.SearchClient.SearchAndScrape.g.cs
...
namespace G
{
    public partial class SearchClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchAndScrapeSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_SearchAndScrapeSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_SearchAndScrapeSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::G.SearchAndScrapeResponse> SearchAndScrapeAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.SearchAndScrapeResponse>> SearchAndScrapeAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SearchAndScrapeSecurityRequirements,
                operationName: "SearchAndScrapeAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchAndScrapeAsync",
                                pathTemplate: "\"/search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 408)
                            {
                                ...
                                global::G.SearchAndScrapeResponse2? __value_408 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_408 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_408 = global::G.SearchAndScrapeResponse2.FromJson(__content_408, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_408 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.SearchAndScrapeResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::G.SearchAndScrapeResponse3? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::G.SearchAndScrapeResponse3.FromJson(__content_500, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.SearchAndScrapeResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.SearchAndScrapeResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.SearchAndScrapeResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.SearchAndScrapeResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
