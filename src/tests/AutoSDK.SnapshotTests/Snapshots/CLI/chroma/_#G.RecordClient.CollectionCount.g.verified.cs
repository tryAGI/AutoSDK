//HintName: G.RecordClient.CollectionCount.g.cs
...
namespace G
{
    public partial class RecordClient
    {
        ...
        partial void PrepareCollectionCountArguments(
            ...
            ref global::G.ReadLevel? readLevel);
        partial void PrepareCollectionCountRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessCollectionCountResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCollectionCountResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<int> CollectionCountAsync(
            string tenant,
            string database,
            string collectionId,
        ...
        {
            var __response = await CollectionCountAsResponseAsync(
                tenant: tenant,
                database: database,
        ...
        /// const count = await collection.count();
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<int>> CollectionCountAsResponseAsync(
            string tenant,
            string database,
            string collectionId,
            global::G.ReadLevel? readLevel = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCollectionCountArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                path: $"/api/v2/tenants/{tenant}/databases/{database}/collections/{collectionId}/count",
                                baseUri: HttpClient.BaseAddress);
                            __pathBuilder
                                .AddOptionalParameter("read_level", readLevel?.ToValueString())
                                ;
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CollectionCount",
                                methodName: "CollectionCountAsync",
                                pathTemplate: "$\"/api/v2/tenants/{tenant}/databases/{database}/collections/{collectionId}/count\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCollectionCountResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCollectionCountResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
