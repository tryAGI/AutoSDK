//HintName: G.FunctionClient.GetAttachedFunction.g.cs
...
namespace G
{
    public partial class FunctionClient
    {
        ...
        partial void PrepareGetAttachedFunctionRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string collectionId,
            string functionName);
        partial void ProcessGetAttachedFunctionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAttachedFunctionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetAttachedFunctionResponse> GetAttachedFunctionAsync(
            string tenant,
            string database,
            string collectionId,
            string functionName,
        ...
        {
            var __response = await GetAttachedFunctionAsResponseAsync(
                tenant: tenant,
                database: database,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetAttachedFunctionResponse>> GetAttachedFunctionAsResponseAsync(
            string tenant,
            string database,
            string collectionId,
            string functionName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAttachedFunctionArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAttachedFunction",
                                methodName: "GetAttachedFunctionAsync",
                                pathTemplate: "$\"/api/v2/tenants/{tenant}/databases/{database}/collections/{collectionId}/functions/{functionName}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAttachedFunctionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAttachedFunctionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetAttachedFunctionResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetAttachedFunctionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetAttachedFunctionResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
