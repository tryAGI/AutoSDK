//HintName: G.Commands.RecordCollectionGetCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class RecordCollectionGetCommand : global::System.CommandLine.Command
    {
        ...
        public RecordCollectionGetCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Record.CollectionGetAsync(
                tenant: tenant,
                database: database,
                collectionId: collectionId,
                cancellationToken: cancellationToken);
