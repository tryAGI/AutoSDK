//HintName: G.Commands.CollectionDeleteCollectionCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class CollectionDeleteCollectionCommand : global::System.CommandLine.Command
    {
        ...
        public CollectionDeleteCollectionCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Collection.DeleteCollectionAsync(
                tenant: tenant,
                database: database,
                collectionId: collectionId,
                cancellationToken: cancellationToken);
