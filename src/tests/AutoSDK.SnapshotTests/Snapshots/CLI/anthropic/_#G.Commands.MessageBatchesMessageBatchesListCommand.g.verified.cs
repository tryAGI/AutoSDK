//HintName: G.Commands.MessageBatchesMessageBatchesListCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class MessageBatchesMessageBatchesListCommand : global::System.CommandLine.Command
    {
...
This key is required in the header of all API requests, to authenticate your account and access Anthropic's services. Get your API key through the [Console](https://console.anthropic.com/settings/keys). Each key is scoped to a Workspace.",
        ...
        public MessageBatchesMessageBatchesListCommand(
            G.IApi client,
