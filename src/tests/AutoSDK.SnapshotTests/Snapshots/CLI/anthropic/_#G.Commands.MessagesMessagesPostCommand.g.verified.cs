//HintName: G.Commands.MessagesMessagesPostCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class MessagesMessagesPostCommand : global::System.CommandLine.Command
    {
...
Recommended for advanced use cases only. You usually only need to use `temperature`.",
        ...
        public MessagesMessagesPostCommand(
            G.IApi client,
