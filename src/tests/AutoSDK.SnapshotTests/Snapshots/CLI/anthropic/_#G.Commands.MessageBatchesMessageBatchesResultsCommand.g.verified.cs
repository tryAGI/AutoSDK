//HintName: G.Commands.MessageBatchesMessageBatchesResultsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class MessageBatchesMessageBatchesResultsCommand : global::System.CommandLine.Command
    {
...
This key is required in the header of all API requests, to authenticate your account and access Anthropic's services. Get your API key through the [Console](https://console.anthropic.com/settings/keys). Each key is scoped to a Workspace.",
        ...
        public MessageBatchesMessageBatchesResultsCommand(
            G.IApi client,
