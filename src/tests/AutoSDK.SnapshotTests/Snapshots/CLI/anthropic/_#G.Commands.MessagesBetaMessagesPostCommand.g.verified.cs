//HintName: G.Commands.MessagesBetaMessagesPostCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class MessagesBetaMessagesPostCommand : global::System.CommandLine.Command
    {
...
Recommended for advanced use cases only. You usually only need to use `temperature`.",
        ...
        public MessagesBetaMessagesPostCommand(
            G.IApi client,
