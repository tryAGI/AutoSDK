//HintName: G.Commands.MessageBatchesMessageBatchesRetrieveCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class MessageBatchesMessageBatchesRetrieveCommand : global::System.CommandLine.Command
    {
...
This key is required in the header of all API requests, to authenticate your account and access Anthropic's services. Get your API key through the [Console](https://console.anthropic.com/settings/keys). Each key is scoped to a Workspace.",
        ...
        public MessageBatchesMessageBatchesRetrieveCommand(
            G.IApi client,
