...
namespace G
{
    ...
    public readonly partial struct Result : global::System.IEquatable<Result>
    {
...
#endif
            out global::G.BetaSucceededResult? value)
        {
            value = Succeeded;
            return IsSucceeded;
        }
        ...
        /// 
        /// </summary>
        public global::G.BetaSucceededResult PickSucceeded() => IsSucceeded
            ? Succeeded!
        ...
        public bool TryPickErrored(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.BetaErroredResult? value)
        {
            value = Errored;
            return IsErrored;
        }
        ...
        /// 
        /// </summary>
        public global::G.BetaErroredResult PickErrored() => IsErrored
            ? Errored!
        ...
        public bool TryPickCanceled(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.BetaCanceledResult? value)
        {
            value = Canceled;
            return IsCanceled;
        }
        ...
        /// 
        /// </summary>
        public global::G.BetaCanceledResult PickCanceled() => IsCanceled
            ? Canceled!
        ...
        public bool TryPickExpired(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.BetaExpiredResult? value)
        {
            value = Expired;
            return IsExpired;
        }
        ...
        /// 
        /// </summary>
        public global::G.BetaExpiredResult PickExpired() => IsExpired
            ? Expired!
        ...
        /// 
        /// </summary>
        public static Result FromSucceeded(global::G.BetaSucceededResult? value) => new Result(value);
        ...
        /// 
        /// </summary>
        public static Result FromErrored(global::G.BetaErroredResult? value) => new Result(value);
        ...
        /// 
        /// </summary>
        public static Result FromCanceled(global::G.BetaCanceledResult? value) => new Result(value);
        ...
        /// 
        /// </summary>
        public static Result FromExpired(global::G.BetaExpiredResult? value) => new Result(value);
