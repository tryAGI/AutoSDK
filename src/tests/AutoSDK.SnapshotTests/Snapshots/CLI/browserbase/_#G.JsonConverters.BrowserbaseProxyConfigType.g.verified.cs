...
{
    /// <inheritdoc />
    public sealed class BrowserbaseProxyConfigTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BrowserbaseProxyConfigType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.BrowserbaseProxyConfigTypeExtensions.ToValueString(value));
        }
    }
}
