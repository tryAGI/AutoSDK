...
{
    /// <inheritdoc />
    public sealed class CreateCrawlRequestExtractDepthNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateCrawlRequestExtractDepth?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateCrawlRequestExtractDepthExtensions.ToValueString(value.Value));
            }
        }
    }
}
