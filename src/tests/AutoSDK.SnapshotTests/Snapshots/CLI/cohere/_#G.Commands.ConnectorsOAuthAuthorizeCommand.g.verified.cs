//HintName: G.Commands.ConnectorsOAuthAuthorizeCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ConnectorsOAuthAuthorizeCommand : global::System.CommandLine.Command
    {
        ...
        public ConnectorsOAuthAuthorizeCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Connectors.OAuthAuthorizeAsync(
                id: id,
                afterTokenRedirect: afterTokenRedirect,
                xClientName: xClientName,
                cancellationToken: cancellationToken);
