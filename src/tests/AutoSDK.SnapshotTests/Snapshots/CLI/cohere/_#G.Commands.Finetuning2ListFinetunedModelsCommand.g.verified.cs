//HintName: G.Commands.Finetuning2ListFinetunedModelsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class Finetuning2ListFinetunedModelsCommand : global::System.CommandLine.Command
    {
...
Supported sorting fields:
  - created_at (default)",
        ...
        public Finetuning2ListFinetunedModelsCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Finetuning2.ListFinetunedModelsAsync(
                pageSize: pageSize,
                pageToken: pageToken,
                orderBy: orderBy,
                xClientName: xClientName,
