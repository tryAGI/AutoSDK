...
{
    /// <inheritdoc />
    public sealed class ChatStreamEndEventY8gq2xFinishReasonNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatStreamEndEventY8gq2xFinishReason?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ChatStreamEndEventY8gq2xFinishReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
