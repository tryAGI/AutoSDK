//HintName: G.Commands.Finetuning2ListEventsCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class Finetuning2ListEventsCommand : global::System.CommandLine.Command
    {
...
Supported sorting fields:
  - created_at (default)",
        ...
        public Finetuning2ListEventsCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Finetuning2.ListEventsAsync(
                finetunedModelId: finetunedModelId,
                pageSize: pageSize,
                pageToken: pageToken,
                orderBy: orderBy,
