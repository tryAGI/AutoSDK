//HintName: G.Commands.Finetuning2CreateFinetunedModelCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class Finetuning2CreateFinetunedModelCommand : global::System.CommandLine.Command
    {
        ...
        public Finetuning2CreateFinetunedModelCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Finetuning2.CreateFinetunedModelAsync(
                xClientName: xClientName,
                name: name,
                settings: settings,
                cancellationToken: cancellationToken);
