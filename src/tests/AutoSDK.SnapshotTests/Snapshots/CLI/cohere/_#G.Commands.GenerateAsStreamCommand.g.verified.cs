...
Smaller, ""light"" models are faster, while larger models will perform better. [Custom models](https://docs.cohere.com/docs/training-custom-models) can also be supplied with their full ID.",
        ...
        private global::System.CommandLine.Option<int?> NumGenerations { get; } = new(
            name: "numGenerations")
        {
...
Can only be set to `0` if `return_likelihoods` is set to `ALL` to get the likelihood of the prompt.",
        ...
        private global::System.CommandLine.Option<global::G.GenerateRequestTruncate?> Truncate { get; } = new(
            name: "truncate")
        {
...
Compatible Deployments: Cohere Platform, Azure, AWS Sagemaker/Bedrock, Private Deployments",
        ...
        private global::System.CommandLine.Option<string?> Preset { get; } = new(
            name: "preset")
        {
...
When a preset is specified, the `prompt` parameter becomes optional, and any included parameters will override the preset's parameters.",
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<string>?> EndSequences { get; } = new(
            name: "endSequences")
        {
