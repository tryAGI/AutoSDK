//HintName: G.Commands.Connectors2ListCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class Connectors2ListCommand : global::System.CommandLine.Command
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Connectors2.ListAsync(
                limit: limit,
                offset: offset,
                xClientName: xClientName,
                cancellationToken: cancellationToken);
