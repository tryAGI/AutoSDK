//HintName: G.Commands.Datasets2CreateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class Datasets2CreateCommand : global::System.CommandLine.Command
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Datasets2.CreateAsync(
                name: name,
                type: type,
                keepOriginalFile: keepOriginalFile,
                skipMalformedInput: skipMalformedInput,
