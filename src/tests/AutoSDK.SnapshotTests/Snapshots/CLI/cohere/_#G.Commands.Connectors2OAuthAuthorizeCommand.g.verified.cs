//HintName: G.Commands.Connectors2OAuthAuthorizeCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class Connectors2OAuthAuthorizeCommand : global::System.CommandLine.Command
    {
        ...
        public Connectors2OAuthAuthorizeCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Connectors2.OAuthAuthorizeAsync(
                id: id,
                afterTokenRedirect: afterTokenRedirect,
                xClientName: xClientName,
                cancellationToken: cancellationToken);
