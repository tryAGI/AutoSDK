//HintName: G.Commands.ConnectorsListCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class ConnectorsListCommand : global::System.CommandLine.Command
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Connectors.ListAsync(
                limit: limit,
                offset: offset,
                xClientName: xClientName,
                cancellationToken: cancellationToken);
