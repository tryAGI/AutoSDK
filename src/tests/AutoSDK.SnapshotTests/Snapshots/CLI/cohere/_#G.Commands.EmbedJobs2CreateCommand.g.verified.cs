//HintName: G.Commands.EmbedJobs2CreateCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class EmbedJobs2CreateCommand : global::System.CommandLine.Command
    {
...
Passing `START` will discard the start of the input. `END` will discard the end of the input. In both cases, input is discarded until the remaining input is exactly the maximum input token length for the model.",
        ...
        public EmbedJobs2CreateCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.EmbedJobs2.CreateAsync(
                xClientName: xClientName,
                model: model,
                datasetId: datasetId,
                inputType: inputType,
