...
namespace G
{
    internal sealed partial class ClassifyCommand : global::System.CommandLine.Command
    {
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<string>?> Inputs { get; } = new(
            name: "inputs")
        {
...
Note: by default the `truncate` parameter is set to `END`, so tokens exceeding the limit will be automatically dropped. This behavior can be disabled by setting `truncate` to `NONE`, which will result in validation errors for longer texts.",
        ...
        private global::System.CommandLine.Option<global::System.Collections.Generic.IList<global::G.ClassifyExample>?> Examples { get; } = new(
            name: "examples")
        {
...
Note: [Fine-tuned Models](https://docs.cohere.com/docs/classify-fine-tuning) trained on classification examples don't require the `examples` parameter to be passed in explicitly.",
        ...
        private global::System.CommandLine.Option<global::G.ClassifyRequestTruncate?> Truncate { get; } = new(
            name: "truncate")
        {
