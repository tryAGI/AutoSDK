//HintName: G.Models.CreateTextToImageRequestGemini25FlashReferenceImage.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTextToImageRequestGemini25FlashReferenceImage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTextToImageRequestGemini25FlashReferenceImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
