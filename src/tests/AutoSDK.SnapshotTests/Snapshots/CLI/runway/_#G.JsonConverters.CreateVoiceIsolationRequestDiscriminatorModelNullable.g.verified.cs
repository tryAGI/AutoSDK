...
{
    /// <inheritdoc />
    public sealed class CreateVoiceIsolationRequestDiscriminatorModelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateVoiceIsolationRequestDiscriminatorModel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateVoiceIsolationRequestDiscriminatorModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
