//HintName: G.Models.RequestGen4ImageReferenceImage.g.cs
...
namespace G
{
    ...
    public sealed partial class RequestGen4ImageReferenceImage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestGen4ImageReferenceImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
...
#endif
        public RequestGen4ImageReferenceImage(
            string uri,
            string? tag)
        {
            this.Uri = uri;
