...
namespace G
{
    public partial class StartGeneratingClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.Response3> CreateImageToVideoAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 429)
            {
                ...
                global::G.Response4? __value_429 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_429 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_429 = global::G.Response4.FromJson(__content_429, JsonSerializerOptions);
                    }
                    else
                    {
                        var __contentStream_429 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                        __value_429 = await global::G.Response4.FromJsonStreamAsync(__contentStream_429, JsonSerializerOptions).ConfigureAwait(false);
                    }
                }
                ...
                throw new global::G.ApiException<global::G.Response4>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.Response3.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.Response3.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
