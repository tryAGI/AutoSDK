//HintName: G.Commands.LeMUR2GetResponseCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class LeMUR2GetResponseCommand : global::System.CommandLine.Command
    {
...
This would be found in the response of the original request.",
        ...
        public LeMUR2GetResponseCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.LeMUR2.GetResponseAsync(
                requestId: requestId,
                cancellationToken: cancellationToken);
