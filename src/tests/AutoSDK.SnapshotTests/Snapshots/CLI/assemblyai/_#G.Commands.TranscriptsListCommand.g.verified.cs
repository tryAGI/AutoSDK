//HintName: G.Commands.TranscriptsListCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TranscriptsListCommand : global::System.CommandLine.Command
    {
...
Transcripts are sorted from newest to oldest. The previous URL always points to a page with older transcripts.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Transcripts.ListAsync(
                limit: limit,
                status: status,
                createdOn: createdOn,
                beforeId: beforeId,
