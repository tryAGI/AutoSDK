//HintName: G.Commands.LeMUR2PurgeRequestDataCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class LeMUR2PurgeRequestDataCommand : global::System.CommandLine.Command
    {
        ...
        public LeMUR2PurgeRequestDataCommand(
            G.IApi client,
...
The LLM response data, as well as any context provided in the original request will be removed.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.LeMUR2.PurgeRequestDataAsync(
                requestId: requestId,
                cancellationToken: cancellationToken);
