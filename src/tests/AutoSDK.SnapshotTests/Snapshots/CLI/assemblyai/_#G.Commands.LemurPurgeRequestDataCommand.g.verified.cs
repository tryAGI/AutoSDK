//HintName: G.Commands.LemurPurgeRequestDataCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class LemurPurgeRequestDataCommand : global::System.CommandLine.Command
    {
        ...
        public LemurPurgeRequestDataCommand(
            G.IApi client,
...
The LLM response data, as well as any context provided in the original request will be removed.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Lemur.PurgeRequestDataAsync(
                requestId: requestId,
                cancellationToken: cancellationToken);
