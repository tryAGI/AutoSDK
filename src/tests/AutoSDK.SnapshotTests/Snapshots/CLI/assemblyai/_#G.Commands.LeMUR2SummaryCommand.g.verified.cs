//HintName: G.Commands.LeMUR2SummaryCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class LeMUR2SummaryCommand : global::System.CommandLine.Command
    {
...
You can give the model context to obtain more targeted results while outputting the results in a variety of formats described in human language.")
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.LeMUR2.SummaryAsync(
                cancellationToken: cancellationToken);
