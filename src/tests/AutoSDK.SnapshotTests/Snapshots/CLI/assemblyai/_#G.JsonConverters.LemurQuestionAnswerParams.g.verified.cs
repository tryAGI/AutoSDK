//HintName: G.JsonConverters.LemurQuestionAnswerParams.g.cs
#nullable enable
...
namespace G.JsonConverters
{
    ...
    public class LemurQuestionAnswerParamsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LemurQuestionAnswerParams>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("questions")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::G.LemurQuestionAnswerParamsVariant2? lemurQuestionAnswerParamsVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.LemurQuestionAnswerParams(
                @base,
