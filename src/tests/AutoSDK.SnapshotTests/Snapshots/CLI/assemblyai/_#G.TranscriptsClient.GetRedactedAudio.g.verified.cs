//HintName: G.TranscriptsClient.GetRedactedAudio.g.cs
...
namespace G
{
    public partial class TranscriptsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetRedactedAudioSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetRedactedAudioSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetRedactedAudioSecurityRequirement0,
            };
        ...
        {
            var __response = await GetRedactedAudioAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RedactedAudioResponse>> GetRedactedAudioAsResponseAsync(
            string transcriptId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetRedactedAudioSecurityRequirements,
                operationName: "GetRedactedAudioAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetRedactedAudioAsync",
                                pathTemplate: "$\"/v2/transcript/{transcriptId}/redacted-audio\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.RedactedAudioResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.RedactedAudioResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.RedactedAudioResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
