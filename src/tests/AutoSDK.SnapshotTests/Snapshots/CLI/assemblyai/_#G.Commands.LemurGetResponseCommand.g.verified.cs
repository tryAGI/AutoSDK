//HintName: G.Commands.LemurGetResponseCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class LemurGetResponseCommand : global::System.CommandLine.Command
    {
...
This would be found in the response of the original request.",
        ...
        public LemurGetResponseCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Lemur.GetResponseAsync(
                requestId: requestId,
                cancellationToken: cancellationToken);
