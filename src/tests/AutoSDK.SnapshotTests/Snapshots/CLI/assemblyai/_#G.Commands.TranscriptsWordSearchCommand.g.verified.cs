//HintName: G.Commands.TranscriptsWordSearchCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class TranscriptsWordSearchCommand : global::System.CommandLine.Command
    {
        ...
        public TranscriptsWordSearchCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Transcripts.WordSearchAsync(
                transcriptId: transcriptId,
                words: words,
                cancellationToken: cancellationToken);
