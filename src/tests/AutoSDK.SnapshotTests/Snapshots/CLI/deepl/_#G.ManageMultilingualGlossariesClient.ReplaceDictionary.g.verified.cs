//HintName: G.ManageMultilingualGlossariesClient.ReplaceDictionary.g.cs
...
namespace G
{
    public partial class ManageMultilingualGlossariesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ReplaceDictionaryServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ReplaceDictionarySecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ReplaceDictionarySecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_ReplaceDictionarySecurityRequirement0,
            };
        partial void PrepareReplaceDictionaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string glossaryId,
            global::G.MultilingualGlossaryEntries request);
        partial void PrepareReplaceDictionaryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string glossaryId,
            global::G.MultilingualGlossaryEntries request);
        partial void ProcessReplaceDictionaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReplaceDictionaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.MultilingualGlossaryEntriesInformation> ReplaceDictionaryAsync(
            string glossaryId,
        ...
        {
            var __response = await ReplaceDictionaryAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.MultilingualGlossaryEntriesInformation>> ReplaceDictionaryAsResponseAsync(
            string glossaryId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareReplaceDictionaryArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ReplaceDictionarySecurityRequirements,
                operationName: "ReplaceDictionaryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ReplaceDictionaryServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ReplaceDictionaryAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReplaceDictionaryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.ReplaceDictionaryResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.ReplaceDictionaryResponse.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.ReplaceDictionaryResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReplaceDictionaryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.MultilingualGlossaryEntriesInformation.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.MultilingualGlossaryEntriesInformation>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.MultilingualGlossaryEntriesInformation.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ReplaceDictionaryAsync(
                glossaryId: glossaryId,
                request: __request,
                requestOptions: requestOptions,
