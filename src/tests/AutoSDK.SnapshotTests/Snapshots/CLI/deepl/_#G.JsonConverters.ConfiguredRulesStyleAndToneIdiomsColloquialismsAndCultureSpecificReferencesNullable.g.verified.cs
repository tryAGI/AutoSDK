...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneIdiomsColloquialismsAndCultureSpecificReferencesNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndToneIdiomsColloquialismsAndCultureSpecificReferences?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesStyleAndToneIdiomsColloquialismsAndCultureSpecificReferencesExtensions.ToValueString(value.Value));
            }
        }
    }
}
