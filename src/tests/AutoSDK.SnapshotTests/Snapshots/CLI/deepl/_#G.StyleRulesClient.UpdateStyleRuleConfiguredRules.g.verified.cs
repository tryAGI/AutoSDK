//HintName: G.StyleRulesClient.UpdateStyleRuleConfiguredRules.g.cs
...
namespace G
{
    public partial class StyleRulesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_UpdateStyleRuleConfiguredRulesServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_UpdateStyleRuleConfiguredRulesSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_UpdateStyleRuleConfiguredRulesSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_UpdateStyleRuleConfiguredRulesSecurityRequirement0,
            };
        partial void PrepareUpdateStyleRuleConfiguredRulesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string styleId,
            global::G.ConfiguredRules request);
        partial void PrepareUpdateStyleRuleConfiguredRulesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string styleId,
            global::G.ConfiguredRules request);
        partial void ProcessUpdateStyleRuleConfiguredRulesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateStyleRuleConfiguredRulesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.StyleRuleList> UpdateStyleRuleConfiguredRulesAsync(
            string styleId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateStyleRuleConfiguredRulesArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateStyleRuleConfiguredRulesSecurityRequirements,
                operationName: "UpdateStyleRuleConfiguredRulesAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                path: $"/v3/style_rules/{styleId}/configured_rules",
                                baseUri: ResolveBaseUri(
                                servers: s_UpdateStyleRuleConfiguredRulesServers,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareUpdateStyleRuleConfiguredRulesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateStyleRuleConfiguredRulesAsync",
                                pathTemplate: "$\"/v3/style_rules/{styleId}/configured_rules\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateStyleRuleConfiguredRulesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateStyleRuleConfiguredRulesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdateStyleRuleConfiguredRulesAsync(
                styleId: styleId,
                request: __request,
                requestOptions: requestOptions,
