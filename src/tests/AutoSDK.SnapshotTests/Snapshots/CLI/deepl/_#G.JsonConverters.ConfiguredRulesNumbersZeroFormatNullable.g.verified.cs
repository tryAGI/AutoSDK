...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesNumbersZeroFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesNumbersZeroFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesNumbersZeroFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
