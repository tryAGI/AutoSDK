...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneRedundantPhrasesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndToneRedundantPhrases>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesStyleAndToneRedundantPhrasesExtensions.ToValueString(value));
        }
    }
}
