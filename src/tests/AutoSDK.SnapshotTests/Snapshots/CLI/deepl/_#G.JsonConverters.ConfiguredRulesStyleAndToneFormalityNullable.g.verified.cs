...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneFormalityNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndToneFormality?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesStyleAndToneFormalityExtensions.ToValueString(value.Value));
            }
        }
    }
}
