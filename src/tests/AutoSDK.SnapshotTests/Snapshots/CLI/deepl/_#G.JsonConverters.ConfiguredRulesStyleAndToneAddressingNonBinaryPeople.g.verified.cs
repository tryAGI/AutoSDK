...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesStyleAndToneAddressingNonBinaryPeopleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesStyleAndToneAddressingNonBinaryPeople>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesStyleAndToneAddressingNonBinaryPeopleExtensions.ToValueString(value));
        }
    }
}
