...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesDatesAndTimesCalendarEraJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesDatesAndTimesCalendarEra>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConfiguredRulesDatesAndTimesCalendarEraExtensions.ToValueString(value));
        }
    }
}
