...
{
    /// <inheritdoc />
    public sealed class ConfiguredRulesPunctuationEmphasisNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfiguredRulesPunctuationEmphasis?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfiguredRulesPunctuationEmphasisExtensions.ToValueString(value.Value));
            }
        }
    }
}
