//HintName: G.Commands.RemoveBackgroundCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class RemoveBackgroundCommand : global::System.CommandLine.Command
    {
        ...
        public RemoveBackgroundCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Image.RemoveBackgroundAsync(
                image: image,
                imagename: imagename,
                responseFormat: responseFormat,
                cancellationToken: cancellationToken);
