//HintName: G.Commands.VectorizeImageCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class VectorizeImageCommand : global::System.CommandLine.Command
    {
        ...
        public VectorizeImageCommand(G.IApi client) : base(
            name: "vectorize",
            description: @"")
        {
            _client = client;
