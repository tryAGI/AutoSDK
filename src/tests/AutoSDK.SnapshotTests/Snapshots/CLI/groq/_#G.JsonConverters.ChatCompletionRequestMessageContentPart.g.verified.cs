//HintName: G.JsonConverters.ChatCompletionRequestMessageContentPart.g.cs
#nullable enable
...
namespace G.JsonConverters
{
    ...
    public class ChatCompletionRequestMessageContentPartJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionRequestMessageContentPart>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ChatCompletionRequestMessageContentPartDocument? documentContentPart = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ChatCompletionRequestMessageContentPartDocument), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ChatCompletionRequestMessageContentPartDocument> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ChatCompletionRequestMessageContentPartDocument).Name}");
            ...
            var __value = new global::G.ChatCompletionRequestMessageContentPart(
                textContentPart,
