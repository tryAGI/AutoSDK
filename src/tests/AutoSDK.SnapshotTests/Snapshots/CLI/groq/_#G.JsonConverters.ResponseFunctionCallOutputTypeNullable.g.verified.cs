...
{
    /// <inheritdoc />
    public sealed class ResponseFunctionCallOutputTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseFunctionCallOutputType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ResponseFunctionCallOutputTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
