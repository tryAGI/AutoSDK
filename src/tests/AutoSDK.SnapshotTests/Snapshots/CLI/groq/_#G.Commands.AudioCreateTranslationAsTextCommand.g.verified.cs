//HintName: G.Commands.AudioCreateTranslationAsTextCommand.g.cs

#nullable enable

namespace G
{
    internal sealed partial class AudioCreateTranslationAsTextCommand : global::System.CommandLine.Command
    {
...
When using the Batch API only url is supported.",
        ...
        public AudioCreateTranslationAsTextCommand(
            G.IApi client,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var response = await _client.Audio.CreateTranslationAsTextAsync(
                file: file,
                filename: filename,
                url: url,
                model: model,
