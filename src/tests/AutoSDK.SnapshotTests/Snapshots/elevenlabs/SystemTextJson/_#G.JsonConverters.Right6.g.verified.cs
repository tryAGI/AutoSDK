//HintName: G.JsonConverters.Right6.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Right6JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Right6>
    {
        /// <inheritdoc />
        public override global::G.Right6 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTGreaterThanOrEqualsOperatorNodeOutputRightDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::G.Right6(
                discriminator?.Type,
                stringLiteral,
