...
{
    /// <inheritdoc />
    public sealed class TwilioEdgeLocationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TwilioEdgeLocation>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TwilioEdgeLocationExtensions.ToValueString(value));
        }
    }
}
