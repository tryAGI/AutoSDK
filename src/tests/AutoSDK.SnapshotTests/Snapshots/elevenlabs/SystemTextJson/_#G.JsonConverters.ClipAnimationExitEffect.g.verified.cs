...
{
    /// <inheritdoc />
    public sealed class ClipAnimationExitEffectJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClipAnimationExitEffect>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ClipAnimationExitEffectExtensions.ToValueString(value));
        }
    }
}
