...
{
    /// <inheritdoc />
    public sealed class BodyTextToDialogueStreamWithTimestampsApplyTextNormalizationNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BodyTextToDialogueStreamWithTimestampsApplyTextNormalization?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.BodyTextToDialogueStreamWithTimestampsApplyTextNormalizationExtensions.ToValueString(value.Value));
            }
        }
    }
}
