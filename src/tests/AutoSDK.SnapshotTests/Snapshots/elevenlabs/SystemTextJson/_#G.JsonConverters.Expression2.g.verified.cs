//HintName: G.JsonConverters.Expression2.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Expression2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Expression2>
    {
        /// <inheritdoc />
        public override global::G.Expression2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::G.WorkflowExpressionConditionModelOutputExpressionDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::G.Expression2(
                discriminator?.Type,
                stringLiteral,
