//HintName: G.AgentsPlatformClient.GetConvaiUsers.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetConvaiUsersArguments(
        ...
        partial void ProcessGetConvaiUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetConversationUsersPageResponseModel> GetConvaiUsersAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetConvaiUsersArguments(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetConvaiUsersResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.GetConversationUsersPageResponseModel.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.GetConversationUsersPageResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
