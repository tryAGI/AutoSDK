//HintName: G.JsonConverters.Right12.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Right12JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Right12>
    {
        /// <inheritdoc />
        public override global::G.Right12 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTNotEqualsOperatorNodeOutputRightDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::G.Right12(
                discriminator?.Type,
                stringLiteral,
