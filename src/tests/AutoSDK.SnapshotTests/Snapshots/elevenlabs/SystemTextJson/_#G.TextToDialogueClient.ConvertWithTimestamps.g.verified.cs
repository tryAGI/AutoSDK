//HintName: G.TextToDialogueClient.ConvertWithTimestamps.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareConvertWithTimestampsArguments(
        ...
        partial void PrepareConvertWithTimestampsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.AnyOf<global::G.NonStreamingOutputFormats?, global::G.AllowedOutputFormats?>? outputFormat,
            string? xiApiKey,
            global::G.BodyTextToDialogueFullWithTimestamps request);
        partial void ProcessConvertWithTimestampsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessConvertWithTimestampsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel> ConvertWithTimestampsAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel>> ConvertWithTimestampsAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareConvertWithTimestampsArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ConvertWithTimestamps",
                                methodName: "ConvertWithTimestampsAsync",
                                pathTemplate: "\"/v1/text-to-dialogue/with-timestamps\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessConvertWithTimestampsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessConvertWithTimestampsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ConvertWithTimestampsAsync(
                outputFormat: outputFormat,
                xiApiKey: xiApiKey,
                request: __request,
                requestOptions: requestOptions,
