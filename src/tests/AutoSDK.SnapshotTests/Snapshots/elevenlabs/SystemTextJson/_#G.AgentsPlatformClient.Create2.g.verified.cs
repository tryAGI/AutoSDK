...
namespace G
{
    public partial class AgentsPlatformClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostAgentAvatarResponseModel> Create2Async(
            string agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PostAgentAvatarResponseModel>> Create2AsResponseAsync(
            string agentId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/v1/convai/agents/{agentId}/avatar\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PostAgentAvatarResponseModel.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PostAgentAvatarResponseModel>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PostAgentAvatarResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostAgentAvatarResponseModel> Create2Async(
            string agentId,
            global::System.IO.Stream avatarFile,
            string avatarFilename,
            string? xiApiKey = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            avatarFile = avatarFile ?? throw new global::System.ArgumentNullException(nameof(avatarFile));
            var request = new global::G.BodyPostAgentAvatarV1ConvaiAgentsAgentIdAvatarPost
            {
                AvatarFile = global::System.Array.Empty<byte>(),
                AvatarFilename = avatarFilename,
            };
            PrepareArguments(
                client: HttpClient);
