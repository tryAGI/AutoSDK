...
{
    /// <inheritdoc />
    public sealed class WorkflowToolResponseModelOutputStepDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WorkflowToolResponseModelOutputStepDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WorkflowToolResponseModelOutputStepDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
