...
namespace G
{
    public partial class TextToVoice2Client
    {
        ...
        {
            var __response = await DesignAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.VoicePreviewsResponseModel>> DesignAsResponseAsync(
