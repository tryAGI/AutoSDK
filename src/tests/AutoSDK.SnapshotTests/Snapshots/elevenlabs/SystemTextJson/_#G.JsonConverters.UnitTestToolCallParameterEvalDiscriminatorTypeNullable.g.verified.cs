...
{
    /// <inheritdoc />
    public sealed class UnitTestToolCallParameterEvalDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UnitTestToolCallParameterEvalDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UnitTestToolCallParameterEvalDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
