...
{
    /// <inheritdoc />
    public sealed class BodyTextToSpeechStreamApplyTextNormalizationNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BodyTextToSpeechStreamApplyTextNormalization?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.BodyTextToSpeechStreamApplyTextNormalizationExtensions.ToValueString(value.Value));
            }
        }
    }
}
