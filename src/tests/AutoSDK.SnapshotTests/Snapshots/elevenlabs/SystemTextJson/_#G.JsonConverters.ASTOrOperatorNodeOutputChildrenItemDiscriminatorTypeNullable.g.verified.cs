...
{
    /// <inheritdoc />
    public sealed class ASTOrOperatorNodeOutputChildrenItemDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ASTOrOperatorNodeOutputChildrenItemDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ASTOrOperatorNodeOutputChildrenItemDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
