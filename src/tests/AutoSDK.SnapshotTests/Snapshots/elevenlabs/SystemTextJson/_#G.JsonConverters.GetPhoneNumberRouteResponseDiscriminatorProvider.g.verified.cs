...
{
    /// <inheritdoc />
    public sealed class GetPhoneNumberRouteResponseDiscriminatorProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetPhoneNumberRouteResponseDiscriminatorProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetPhoneNumberRouteResponseDiscriminatorProviderExtensions.ToValueString(value));
        }
    }
}
