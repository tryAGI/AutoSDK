//HintName: G.PvcVoicesClient.CreateVoicesPvc.g.cs
...
namespace G
{
    public partial class PvcVoicesClient
    {
        ...
        partial void ProcessCreateVoicesPvcResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVoicesPvcArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateVoicesPvcResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateVoicesPvcResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateVoicesPvcAsync(
                xiApiKey: xiApiKey,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
