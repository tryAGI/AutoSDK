...
{
    /// <inheritdoc />
    public class InputOverridesVariant13JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InputOverridesVariant13>
    {
        /// <inheritdoc />
        public override global::G.InputOverridesVariant13 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.MCPToolConfigOverrideInputOverridesDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.MCPToolConfigOverrideInputOverridesDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.MCPToolConfigOverrideInputOverridesDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ConstantSchemaOverride? constant = default;
            if (discriminator?.Source == global::G.MCPToolConfigOverrideInputOverridesDiscriminatorSource.Constant)
            {
            ...
            if (discriminator?.Source == global::G.MCPToolConfigOverrideInputOverridesDiscriminatorSource.DynamicVariable)
            {
            ...
            if (discriminator?.Source == global::G.MCPToolConfigOverrideInputOverridesDiscriminatorSource.Llm)
            {
            ...
            var __value = new global::G.InputOverridesVariant13(
        ...
        public override void Write(
            ...
            global::G.InputOverridesVariant13 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
