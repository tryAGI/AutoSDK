...
{
    /// <inheritdoc />
    public sealed class ConversationInitiationSourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConversationInitiationSource>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConversationInitiationSourceExtensions.ToValueString(value));
        }
    }
}
