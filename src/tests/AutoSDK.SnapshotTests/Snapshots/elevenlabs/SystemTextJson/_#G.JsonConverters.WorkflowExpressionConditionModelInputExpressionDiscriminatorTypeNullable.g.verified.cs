...
{
    /// <inheritdoc />
    public sealed class WorkflowExpressionConditionModelInputExpressionDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WorkflowExpressionConditionModelInputExpressionDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WorkflowExpressionConditionModelInputExpressionDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
