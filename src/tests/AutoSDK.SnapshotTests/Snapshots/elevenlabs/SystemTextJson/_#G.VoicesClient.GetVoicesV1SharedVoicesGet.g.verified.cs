//HintName: G.VoicesClient.GetVoicesV1SharedVoicesGet.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetVoicesV1SharedVoicesGetArguments(
            ...
            ref int? page,
            ref string? xiApiKey);
        partial void PrepareGetVoicesV1SharedVoicesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? page,
            string? xiApiKey);
        partial void ProcessGetVoicesV1SharedVoicesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetVoicesV1SharedVoicesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetLibraryVoicesResponseModel> GetVoicesV1SharedVoicesGetAsync(
            int? pageSize = 30,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: _httpClient);
            PrepareGetVoicesV1SharedVoicesGetArguments(
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareGetVoicesV1SharedVoicesGetRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessGetVoicesV1SharedVoicesGetResponse(
                httpClient: _httpClient,
            ...
            ProcessGetVoicesV1SharedVoicesGetResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize<global::G.GetLibraryVoicesResponseModel?>(__content, JsonSerializerOptions) ??
