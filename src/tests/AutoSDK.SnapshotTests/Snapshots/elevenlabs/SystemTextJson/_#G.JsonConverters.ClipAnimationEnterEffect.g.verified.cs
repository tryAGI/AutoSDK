...
{
    /// <inheritdoc />
    public sealed class ClipAnimationEnterEffectJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClipAnimationEnterEffect>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ClipAnimationEnterEffectExtensions.ToValueString(value));
        }
    }
}
