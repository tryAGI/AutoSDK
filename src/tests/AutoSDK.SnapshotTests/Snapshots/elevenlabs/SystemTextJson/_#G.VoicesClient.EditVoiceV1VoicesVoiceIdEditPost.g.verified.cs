//HintName: G.VoicesClient.EditVoiceV1VoicesVoiceIdEditPost.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareEditVoiceV1VoicesVoiceIdEditPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string voiceId,
            ref string? xiApiKey,
            global::G.BodyEditVoiceV1VoicesVoiceIdEditPost request);
        partial void PrepareEditVoiceV1VoicesVoiceIdEditPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string voiceId,
            string? xiApiKey,
            global::G.BodyEditVoiceV1VoicesVoiceIdEditPost request);
        partial void ProcessEditVoiceV1VoicesVoiceIdEditPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEditVoiceV1VoicesVoiceIdEditPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: _httpClient);
            PrepareEditVoiceV1VoicesVoiceIdEditPostArguments(
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareEditVoiceV1VoicesVoiceIdEditPostRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessEditVoiceV1VoicesVoiceIdEditPostResponse(
                httpClient: _httpClient,
            ...
            ProcessEditVoiceV1VoicesVoiceIdEditPostResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize<global::G.EditVoiceV1VoicesVoiceIdEditPostResponse?>(__content, JsonSerializerOptions) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await EditVoiceV1VoicesVoiceIdEditPostAsync(
                voiceId: voiceId,
                xiApiKey: xiApiKey,
                request: request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
