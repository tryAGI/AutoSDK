...
{
    /// <inheritdoc />
    public sealed class PromptAgentAPIModelInputToolDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PromptAgentAPIModelInputToolDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PromptAgentAPIModelInputToolDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
