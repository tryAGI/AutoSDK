...
{
    /// <inheritdoc />
    public sealed class ToolRequestModelToolConfigDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ToolRequestModelToolConfigDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ToolRequestModelToolConfigDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
