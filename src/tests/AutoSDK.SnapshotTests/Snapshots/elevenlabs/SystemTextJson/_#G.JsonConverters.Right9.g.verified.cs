//HintName: G.JsonConverters.Right9.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Right9JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Right9>
    {
        /// <inheritdoc />
        public override global::G.Right9 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ASTStringNodeInput? stringLiteral = default;
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTLessThanOrEqualsOperatorNodeInputRightDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::G.Right9(
                discriminator?.Type,
                stringLiteral,
