...
{
    /// <inheritdoc />
    public sealed class PromptAgentAPIModelOutputToolDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PromptAgentAPIModelOutputToolDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PromptAgentAPIModelOutputToolDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
