...
{
    /// <inheritdoc />
    public sealed class LiteralJsonSchemaPropertyTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LiteralJsonSchemaPropertyType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LiteralJsonSchemaPropertyTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
