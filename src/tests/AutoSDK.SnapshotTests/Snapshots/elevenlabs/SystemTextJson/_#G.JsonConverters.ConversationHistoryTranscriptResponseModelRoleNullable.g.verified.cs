...
{
    /// <inheritdoc />
    public sealed class ConversationHistoryTranscriptResponseModelRoleNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConversationHistoryTranscriptResponseModelRole?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConversationHistoryTranscriptResponseModelRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
