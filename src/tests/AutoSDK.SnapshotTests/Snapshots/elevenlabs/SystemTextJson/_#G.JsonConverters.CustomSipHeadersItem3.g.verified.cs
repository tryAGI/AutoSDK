...
{
    /// <inheritdoc />
    public class CustomSipHeadersItem3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CustomSipHeadersItem3>
    {
        /// <inheritdoc />
        public override global::G.CustomSipHeadersItem3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.WorkflowPhoneNumberNodeModelOutputCustomSipHeaderDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.WorkflowPhoneNumberNodeModelOutputCustomSipHeaderDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.WorkflowPhoneNumberNodeModelOutputCustomSipHeaderDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.CustomSIPHeader? dynamic1 = default;
            if (discriminator?.Type == global::G.WorkflowPhoneNumberNodeModelOutputCustomSipHeaderDiscriminatorType.Dynamic)
            {
            ...
            var __value = new global::G.CustomSipHeadersItem3(
                discriminator?.Type,
                dynamic1,
        ...
        public override void Write(
            ...
            global::G.CustomSipHeadersItem3 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
