...
{
    /// <inheritdoc />
    public sealed class GetAgentResponseTestRouteResponseDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAgentResponseTestRouteResponseDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetAgentResponseTestRouteResponseDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
