//HintName: G.JsonConverters.Left2.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Left2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Left2>
    {
        /// <inheritdoc />
        public override global::G.Left2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ASTEqualsOperatorNodeOutputLeftDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ASTEqualsOperatorNodeOutputLeftDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ASTEqualsOperatorNodeOutputLeftDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ASTStringNodeOutput? stringLiteral = default;
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.StringLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.NumberLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.BooleanLiteral)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.Llm)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.DynamicVariable)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.OrOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.AndOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.EqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.NeqOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.GtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.LtOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.GteOperator)
            {
            ...
            if (discriminator?.Type == global::G.ASTEqualsOperatorNodeOutputLeftDiscriminatorType.LteOperator)
            {
            ...
            var __value = new global::G.Left2(
                discriminator?.Type,
                stringLiteral,
