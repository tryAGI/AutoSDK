//HintName: G.IMusicGenerationClient.Create.g.cs
#nullable enable
...
namespace G
{
    public partial interface IMusicGenerationClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.MusicPrompt>> CreateAsResponseAsync(
