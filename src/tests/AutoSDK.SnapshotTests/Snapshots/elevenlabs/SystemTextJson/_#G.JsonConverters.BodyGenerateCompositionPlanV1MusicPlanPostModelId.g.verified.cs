...
{
    /// <inheritdoc />
    public sealed class BodyGenerateCompositionPlanV1MusicPlanPostModelIdJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BodyGenerateCompositionPlanV1MusicPlanPostModelId>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.BodyGenerateCompositionPlanV1MusicPlanPostModelIdExtensions.ToValueString(value));
        }
    }
}
