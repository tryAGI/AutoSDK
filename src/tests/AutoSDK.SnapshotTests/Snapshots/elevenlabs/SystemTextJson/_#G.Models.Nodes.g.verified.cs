...
namespace G
{
    ...
    public readonly partial struct Nodes : global::System.IEquatable<Nodes>
    {
...
#endif
            out global::G.WorkflowStartNodeModelInput? value)
        {
            value = Start;
            return IsStart;
        }
        ...
        /// 
        /// </summary>
        public global::G.WorkflowStartNodeModelInput PickStart() => IsStart
            ? Start!
        ...
        public bool TryPickEnd(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.WorkflowEndNodeModelInput? value)
        {
            value = End;
            return IsEnd;
        }
        ...
        /// 
        /// </summary>
        public global::G.WorkflowEndNodeModelInput PickEnd() => IsEnd
            ? End!
        ...
        public bool TryPickPhoneNumber(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.WorkflowPhoneNumberNodeModelInput? value)
        {
            value = PhoneNumber;
        ...
        /// 
        /// </summary>
        public global::G.WorkflowPhoneNumberNodeModelInput PickPhoneNumber() => IsPhoneNumber
            ? PhoneNumber!
        ...
        public bool TryPickOverrideAgent(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.WorkflowOverrideAgentNodeModelInput? value)
        {
            value = OverrideAgent;
        ...
        /// 
        /// </summary>
        public global::G.WorkflowOverrideAgentNodeModelInput PickOverrideAgent() => IsOverrideAgent
            ? OverrideAgent!
        ...
        public bool TryPickStandaloneAgent(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.WorkflowStandaloneAgentNodeModelInput? value)
        {
        ...
        /// 
        /// </summary>
        public global::G.WorkflowStandaloneAgentNodeModelInput PickStandaloneAgent() => IsStandaloneAgent
            ? StandaloneAgent!
        ...
        public bool TryPickTool(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.WorkflowToolNodeModelInput? value)
        {
            value = Tool;
            return IsTool;
        }
        ...
        /// 
        /// </summary>
        public global::G.WorkflowToolNodeModelInput PickTool() => IsTool
            ? Tool!
