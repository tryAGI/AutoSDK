...
{
    /// <inheritdoc />
    public sealed class ConversationHistoryTranscriptCommonModelOutputRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConversationHistoryTranscriptCommonModelOutputRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ConversationHistoryTranscriptCommonModelOutputRoleExtensions.ToValueString(value));
        }
    }
}
