...
namespace G
{
    ...
    public sealed partial class ReferenceVideo
    {
        ...
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("content_asset_id")]
        public string? ContentAssetId { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("template_node_id")]
        public string? TemplateNodeId { get; set; }

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("studio_clip")]
