...
{
    /// <inheritdoc />
    public sealed class ToolRequestModelToolConfigDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ToolRequestModelToolConfigDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ToolRequestModelToolConfigDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
