...
{
    /// <inheritdoc />
    public sealed class ASTEqualsOperatorNodeInputRightDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ASTEqualsOperatorNodeInputRightDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ASTEqualsOperatorNodeInputRightDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
