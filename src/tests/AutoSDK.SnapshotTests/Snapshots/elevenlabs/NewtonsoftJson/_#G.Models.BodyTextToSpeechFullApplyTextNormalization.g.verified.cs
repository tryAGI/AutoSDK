//HintName: G.Models.BodyTextToSpeechFullApplyTextNormalization.g.cs
...
namespace G
{
    ...
    public enum BodyTextToSpeechFullApplyTextNormalization
    {
        /// <summary>
    ...
    /// </summary>
    public static class BodyTextToSpeechFullApplyTextNormalizationExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this BodyTextToSpeechFullApplyTextNormalization value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static BodyTextToSpeechFullApplyTextNormalization? ToEnum(string value)
        {
            return value switch
            {
