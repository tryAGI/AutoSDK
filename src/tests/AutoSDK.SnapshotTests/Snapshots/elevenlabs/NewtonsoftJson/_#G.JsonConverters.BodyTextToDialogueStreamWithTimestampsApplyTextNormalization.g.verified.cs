...
{
    /// <inheritdoc />
    public sealed class BodyTextToDialogueStreamWithTimestampsApplyTextNormalizationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BodyTextToDialogueStreamWithTimestampsApplyTextNormalization>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BodyTextToDialogueStreamWithTimestampsApplyTextNormalizationExtensions.ToValueString(value));
        }
    }
}
