...
{
    /// <inheritdoc />
    public sealed class ClipAnimationExitEffectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClipAnimationExitEffect?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ClipAnimationExitEffectExtensions.ToValueString(value.Value));
            }
        }
    }
}
