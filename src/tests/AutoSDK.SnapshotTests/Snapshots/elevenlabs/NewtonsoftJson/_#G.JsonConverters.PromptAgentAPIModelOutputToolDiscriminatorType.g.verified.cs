...
{
    /// <inheritdoc />
    public sealed class PromptAgentAPIModelOutputToolDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PromptAgentAPIModelOutputToolDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PromptAgentAPIModelOutputToolDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
