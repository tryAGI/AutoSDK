//HintName: G.AgentsPlatformClient.Create3.g.cs
...
namespace G
{
    public partial class AgentsPlatformClient
    {
        partial void PrepareCreate3Arguments(
            ...
            global::G.ConversationFeedbackRequestModel request);
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> Create3AsResponseAsync(
            string conversationId,
