//HintName: G.AgentsPlatformClient.Get8.g.cs
...
namespace G
{
    public partial class AgentsPlatformClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetLiveCountResponse> Get8Async(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.GetLiveCountResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.GetLiveCountResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
