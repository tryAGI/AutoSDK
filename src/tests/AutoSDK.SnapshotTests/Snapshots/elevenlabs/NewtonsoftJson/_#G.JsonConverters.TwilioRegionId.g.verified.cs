...
{
    /// <inheritdoc />
    public sealed class TwilioRegionIdJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TwilioRegionId>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TwilioRegionIdExtensions.ToValueString(value));
        }
    }
}
