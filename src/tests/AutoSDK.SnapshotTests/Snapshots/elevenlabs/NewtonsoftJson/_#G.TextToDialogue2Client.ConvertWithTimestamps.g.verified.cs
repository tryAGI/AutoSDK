//HintName: G.TextToDialogue2Client.ConvertWithTimestamps.g.cs

#nullable enable

namespace G
{
    public partial class TextToDialogue2Client
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.AudioWithTimestampsAndVoiceSegmentsResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
