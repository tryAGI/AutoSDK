...
{
    /// <inheritdoc />
    public sealed class MCPServerResponseModelDependentAgentDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MCPServerResponseModelDependentAgentDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MCPServerResponseModelDependentAgentDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
