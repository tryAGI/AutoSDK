...
{
    /// <inheritdoc />
    public sealed class EmbeddingModelEnumNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EmbeddingModelEnum?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EmbeddingModelEnumExtensions.ToValueString(value.Value));
            }
        }
    }
}
