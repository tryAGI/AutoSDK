//HintName: G.Models.SpeechToSpeechFullOutputFormat.g.cs
...
namespace G
{
    ...
    /// </summary>
    public static class SpeechToSpeechFullOutputFormatExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this SpeechToSpeechFullOutputFormat value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static SpeechToSpeechFullOutputFormat? ToEnum(string value)
        {
            return value switch
            {
