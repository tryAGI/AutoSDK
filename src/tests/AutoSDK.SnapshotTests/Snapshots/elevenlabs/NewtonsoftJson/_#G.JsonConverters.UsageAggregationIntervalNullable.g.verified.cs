...
{
    /// <inheritdoc />
    public sealed class UsageAggregationIntervalNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UsageAggregationInterval?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UsageAggregationIntervalExtensions.ToValueString(value.Value));
            }
        }
    }
}
