...
{
    /// <inheritdoc />
    public sealed class LiteralJsonSchemaPropertyTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LiteralJsonSchemaPropertyType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LiteralJsonSchemaPropertyTypeExtensions.ToValueString(value));
        }
    }
}
