...
{
    /// <inheritdoc />
    public sealed class WebhookToolApiSchemaConfigOutputContentTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookToolApiSchemaConfigOutputContentType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookToolApiSchemaConfigOutputContentTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
