//HintName: G.MusicGenerationClient.Create.g.cs
...
namespace G
{
    public partial class MusicGenerationClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.MusicPrompt> CreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.MusicPrompt.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.MusicPrompt.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.BodyGenerateCompositionPlanV1MusicPlanPost
            {
                ...
                SourceCompositionPlan = sourceCompositionPlan,
                ModelId = modelId,
            };
