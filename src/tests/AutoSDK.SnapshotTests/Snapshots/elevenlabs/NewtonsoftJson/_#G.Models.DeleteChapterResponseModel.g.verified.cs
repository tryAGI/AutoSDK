//HintName: G.Models.DeleteChapterResponseModel.g.cs
...
namespace G
{
    ...
    /// Example: {"status":"ok"}
    /// </summary>
    public sealed partial class DeleteChapterResponseModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteChapterResponseModel" /> class.
        /// </summary>
        /// <param name="status">
        /// The status of the studio chapter deletion request. If the request was successful, the status will be 'ok'. Otherwise an error message with status 500 will be returned.
        /// </param>
