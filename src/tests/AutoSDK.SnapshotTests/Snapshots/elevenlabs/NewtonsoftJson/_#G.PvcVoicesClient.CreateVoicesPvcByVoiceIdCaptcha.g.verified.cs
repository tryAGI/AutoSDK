//HintName: G.PvcVoicesClient.CreateVoicesPvcByVoiceIdCaptcha.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCreateVoicesPvcByVoiceIdCaptchaArguments(
        ...
        partial void ProcessCreateVoicesPvcByVoiceIdCaptchaResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateVoicesPvcByVoiceIdCaptchaArguments(
            ...
            PrepareCreateVoicesPvcByVoiceIdCaptchaRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateVoicesPvcByVoiceIdCaptchaResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateVoicesPvcByVoiceIdCaptchaResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.VerifyPVCVoiceCaptchaResponseModel.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.VerifyPVCVoiceCaptchaResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateVoicesPvcByVoiceIdCaptchaAsync(
                voiceId: voiceId,
                xiApiKey: xiApiKey,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
