...
{
    /// <inheritdoc />
    public sealed class CaptionStyleModelTextWeightNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CaptionStyleModelTextWeight?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CaptionStyleModelTextWeightExtensions.ToValueString(value.Value));
            }
        }
    }
}
