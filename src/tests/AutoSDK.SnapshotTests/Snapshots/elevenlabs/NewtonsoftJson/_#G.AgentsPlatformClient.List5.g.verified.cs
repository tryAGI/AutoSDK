//HintName: G.AgentsPlatformClient.List5.g.cs
...
namespace G
{
    public partial class AgentsPlatformClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.LLMListResponseModelInput> List5Async(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.LLMListResponseModelInput>> List5AsResponseAsync(
            string? xiApiKey = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.LLMListResponseModelInput.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.LLMListResponseModelInput>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.LLMListResponseModelInput.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
