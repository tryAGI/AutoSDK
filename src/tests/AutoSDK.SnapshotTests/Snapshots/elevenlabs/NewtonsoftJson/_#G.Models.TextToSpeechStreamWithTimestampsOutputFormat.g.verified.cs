//HintName: G.Models.TextToSpeechStreamWithTimestampsOutputFormat.g.cs
...
namespace G
{
    ...
    public enum TextToSpeechStreamWithTimestampsOutputFormat
    {
        /// <summary>
        /// 
        /// </summary>
    ...
    /// </summary>
    public static class TextToSpeechStreamWithTimestampsOutputFormatExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this TextToSpeechStreamWithTimestampsOutputFormat value)
        {
            return value switch
            {
        ...
        /// </summary>
        public static TextToSpeechStreamWithTimestampsOutputFormat? ToEnum(string value)
        {
            return value switch
            {
