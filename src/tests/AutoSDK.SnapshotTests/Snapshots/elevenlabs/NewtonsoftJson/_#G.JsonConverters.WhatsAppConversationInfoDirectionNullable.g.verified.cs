...
{
    /// <inheritdoc />
    public sealed class WhatsAppConversationInfoDirectionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WhatsAppConversationInfoDirection?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WhatsAppConversationInfoDirectionExtensions.ToValueString(value.Value));
            }
        }
    }
}
