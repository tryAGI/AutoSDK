...
{
    /// <inheritdoc />
    public sealed class ASTLessThanOrEqualsOperatorNodeInputLeftDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ASTLessThanOrEqualsOperatorNodeInputLeftDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ASTLessThanOrEqualsOperatorNodeInputLeftDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
