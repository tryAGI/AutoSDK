...
{
    /// <inheritdoc />
    public sealed class GetDubbingTranscriptsFormatTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetDubbingTranscriptsFormatType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetDubbingTranscriptsFormatTypeExtensions.ToValueString(value));
        }
    }
}
