...
namespace G
{
    ...
    public sealed partial class WorkflowOverrideAgentNodeModelOutput
    {
        ...
        public global::G.ConversationalConfigAPIModelWorkflowOverrideOutput ConversationConfig { get; set; } = default!;
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("additional_prompt", Required = global::Newtonsoft.Json.Required.Always)]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("additional_knowledge_base", Required = global::Newtonsoft.Json.Required.Always)]
        public global::System.Collections.Generic.IList<global::G.KnowledgeBaseLocator> AdditionalKnowledgeBase { get; set; } = default!;

        /// <summary>
        /// IDs of additional tools that the subagent has access to. These will be used in addition to the main agent's tools.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("additional_tool_ids", Required = global::Newtonsoft.Json.Required.Always)]
