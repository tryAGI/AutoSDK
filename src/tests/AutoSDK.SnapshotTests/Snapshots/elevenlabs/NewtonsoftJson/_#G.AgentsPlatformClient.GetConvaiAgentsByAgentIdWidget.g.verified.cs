//HintName: G.AgentsPlatformClient.GetConvaiAgentsByAgentIdWidget.g.cs
...
namespace G
{
    public partial class AgentsPlatformClient
    {
        ...
        partial void ProcessGetConvaiAgentsByAgentIdWidgetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetAgentEmbedResponseModel> GetConvaiAgentsByAgentIdWidgetAsync(
            string agentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareGetConvaiAgentsByAgentIdWidgetRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetConvaiAgentsByAgentIdWidgetResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetConvaiAgentsByAgentIdWidgetResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.GetAgentEmbedResponseModel.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.GetAgentEmbedResponseModel.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
