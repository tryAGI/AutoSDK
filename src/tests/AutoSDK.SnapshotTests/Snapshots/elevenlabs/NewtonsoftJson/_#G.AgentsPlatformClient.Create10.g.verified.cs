//HintName: G.AgentsPlatformClient.Create10.g.cs
...
namespace G
{
    public partial class AgentsPlatformClient
    {
        ...
        partial void ProcessCreate10ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.MCPServerResponseModel> Create10Async(
            string mcpServerId,
        ...
        {
            var __response = await Create10AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.MCPServerResponseModel>> Create10AsResponseAsync(
            string mcpServerId,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreate10ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
