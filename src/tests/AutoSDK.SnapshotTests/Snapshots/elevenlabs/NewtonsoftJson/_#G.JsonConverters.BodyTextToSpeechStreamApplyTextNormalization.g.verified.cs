...
{
    /// <inheritdoc />
    public sealed class BodyTextToSpeechStreamApplyTextNormalizationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BodyTextToSpeechStreamApplyTextNormalization>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BodyTextToSpeechStreamApplyTextNormalizationExtensions.ToValueString(value));
        }
    }
}
