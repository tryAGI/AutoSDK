//HintName: G.Models.PronunciationDictionaryLocatorResponseModel.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class PronunciationDictionaryLocatorResponseModel
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PronunciationDictionaryLocatorResponseModel" /> class.
        /// </summary>
        /// <param name="pronunciationDictionaryId"></param>
        /// <param name="versionId"></param>
        public PronunciationDictionaryLocatorResponseModel(
