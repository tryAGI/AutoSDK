//HintName: G.AgentsPlatformClient.CreateConvaiTwilioOutboundCall.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCreateConvaiTwilioOutboundCallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? xiApiKey,
            global::G.BodyHandleAnOutboundCallViaTwilioV1ConvaiTwilioOutboundCallPost request);
        partial void PrepareCreateConvaiTwilioOutboundCallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? xiApiKey,
            global::G.BodyHandleAnOutboundCallViaTwilioV1ConvaiTwilioOutboundCallPost request);
        partial void ProcessCreateConvaiTwilioOutboundCallResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateConvaiTwilioOutboundCallResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.TwilioOutboundCallResponse> CreateConvaiTwilioOutboundCallAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateConvaiTwilioOutboundCallArguments(
            ...
            PrepareCreateConvaiTwilioOutboundCallRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateConvaiTwilioOutboundCallResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateConvaiTwilioOutboundCallResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.TwilioOutboundCallResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.TwilioOutboundCallResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateConvaiTwilioOutboundCallAsync(
                xiApiKey: xiApiKey,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
