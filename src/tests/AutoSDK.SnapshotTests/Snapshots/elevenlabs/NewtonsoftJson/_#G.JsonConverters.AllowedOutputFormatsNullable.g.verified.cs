...
{
    /// <inheritdoc />
    public sealed class AllowedOutputFormatsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AllowedOutputFormats?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AllowedOutputFormatsExtensions.ToValueString(value.Value));
            }
        }
    }
}
