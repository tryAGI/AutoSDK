...
{
    /// <inheritdoc />
    public sealed class GetToolDependentAgentsResponseModelAgentDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetToolDependentAgentsResponseModelAgentDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetToolDependentAgentsResponseModelAgentDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
