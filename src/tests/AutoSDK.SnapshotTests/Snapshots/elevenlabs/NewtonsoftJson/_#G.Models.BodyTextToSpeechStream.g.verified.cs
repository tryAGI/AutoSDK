//HintName: G.Models.BodyTextToSpeechStream.g.cs
...
namespace G
{
    ...
    public sealed partial class BodyTextToSpeechStream
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BodyTextToSpeechStream" /> class.
        /// </summary>
        /// <param name="text">
        /// The text that will get converted into speech.
        /// </param>
        ...
        public BodyTextToSpeechStream(
            ...
            global::G.BodyTextToSpeechStreamApplyTextNormalization? applyTextNormalization,
