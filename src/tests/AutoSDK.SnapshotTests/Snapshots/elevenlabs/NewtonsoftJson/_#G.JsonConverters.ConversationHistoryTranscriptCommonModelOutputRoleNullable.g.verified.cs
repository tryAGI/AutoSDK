...
{
    /// <inheritdoc />
    public sealed class ConversationHistoryTranscriptCommonModelOutputRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ConversationHistoryTranscriptCommonModelOutputRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ConversationHistoryTranscriptCommonModelOutputRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
