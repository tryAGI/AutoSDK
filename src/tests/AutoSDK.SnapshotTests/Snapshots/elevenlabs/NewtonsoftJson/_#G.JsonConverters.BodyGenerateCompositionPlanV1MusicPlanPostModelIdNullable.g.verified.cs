...
{
    /// <inheritdoc />
    public sealed class BodyGenerateCompositionPlanV1MusicPlanPostModelIdNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BodyGenerateCompositionPlanV1MusicPlanPostModelId?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BodyGenerateCompositionPlanV1MusicPlanPostModelIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
