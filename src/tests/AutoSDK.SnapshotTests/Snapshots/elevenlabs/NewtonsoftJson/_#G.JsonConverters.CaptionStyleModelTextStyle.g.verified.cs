...
{
    /// <inheritdoc />
    public sealed class CaptionStyleModelTextStyleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CaptionStyleModelTextStyle>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CaptionStyleModelTextStyleExtensions.ToValueString(value));
        }
    }
}
