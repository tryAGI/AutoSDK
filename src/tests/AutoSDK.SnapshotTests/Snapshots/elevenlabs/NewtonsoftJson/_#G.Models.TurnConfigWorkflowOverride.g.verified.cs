...
namespace G
{
    ...
    public sealed partial class TurnConfigWorkflowOverride
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("turn_timeout")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("initial_wait_time")]
        public double? InitialWaitTime { get; set; }

        /// <summary>
        /// Maximum wait time since the user last spoke before terminating the call
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("silence_end_call_timeout")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("speculative_turn")]
