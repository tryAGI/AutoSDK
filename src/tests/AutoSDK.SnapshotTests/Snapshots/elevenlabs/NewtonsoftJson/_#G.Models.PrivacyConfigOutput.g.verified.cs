//HintName: G.Models.PrivacyConfigOutput.g.cs
...
namespace G
{
    ...
    public sealed partial class PrivacyConfigOutput
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("conversation_history_redaction")]
        public global::G.ConversationHistoryRedactionConfig? ConversationHistoryRedaction { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PrivacyConfigOutput" /> class.
        /// </summary>
        ...
        /// Default Value: false
        /// </param>
        /// <param name="conversationHistoryRedaction">
        /// Config for PII redaction in the conversation history
        /// </param>
        public PrivacyConfigOutput(
            ...
            global::G.ConversationHistoryRedactionConfig? conversationHistoryRedaction)
        {
            ...
            this.ConversationHistoryRedaction = conversationHistoryRedaction;
        }
