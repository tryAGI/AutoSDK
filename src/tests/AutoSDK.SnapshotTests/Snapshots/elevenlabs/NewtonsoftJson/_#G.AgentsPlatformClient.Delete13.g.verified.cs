...
namespace G
{
    public partial class AgentsPlatformClient
    {
        ...
        partial void ProcessDelete13ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await Delete13AsResponseAsync(
                agentId: agentId,
                branchId: branchId,
                xiApiKey: xiApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> Delete13AsResponseAsync(
            string agentId,
            string branchId,
            string? xiApiKey = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDelete13ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
