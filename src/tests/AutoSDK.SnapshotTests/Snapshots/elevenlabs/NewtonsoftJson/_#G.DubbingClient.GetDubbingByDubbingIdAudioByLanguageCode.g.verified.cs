...
namespace G
{
    public partial class DubbingClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                var __content = await __response.Content.ReadAsByteArrayAsync().ConfigureAwait(false);
            ...
            else
            {
                ...
                var __responseValue = global::Newtonsoft.Json.JsonSerializer.Create(JsonSerializerOptions).Deserialize<byte[]?>(new global::Newtonsoft.Json.JsonTextReader(new global::System.IO.StreamReader(__responseStream)));
