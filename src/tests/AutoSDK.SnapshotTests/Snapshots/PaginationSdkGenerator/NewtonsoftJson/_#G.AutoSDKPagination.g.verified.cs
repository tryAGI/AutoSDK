//HintName: G.AutoSDKPagination.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed class AutoSDKPage<TItem, TResponse> : global::G.AutoSDKHttpResponse<TResponse>
    {
        private readonly global::System.Func<global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::G.AutoSDKPage<TItem, TResponse>?>>? _getNextPageAsync;
        ...
        public AutoSDKPage(
            ...
            int? totalPages = null,
            global::System.Func<global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::G.AutoSDKPage<TItem, TResponse>?>>? getNextPageAsync = null)
        ...
        public global::System.Threading.Tasks.Task<global::G.AutoSDKPage<TItem, TResponse>?> GetNextPageAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            return _getNextPageAsync == null
                ? global::System.Threading.Tasks.Task.FromResult<global::G.AutoSDKPage<TItem, TResponse>?>(null)
        ...
        {
            global::G.AutoSDKPage<TItem, TResponse>? current = this;
            while (current != null)
            {
    ...
    internal static class AutoSDKPaginationSupport
    {
            ...
            bool isTopLevelArray)
        {
            object? value = body;
            if (!isTopLevelArray &&
                !global::G.AutoSDKObjectPathSupport.TryResolveValue(body, path, out value))
            {
        ...
        {
            return global::G.AutoSDKObjectPathSupport.TryResolveValue(body, path, out var value)
                ? global::G.AutoSDKObjectPathSupport.ConvertValueToString(value)
                : null;
        }
        ...
        internal static string? GetHeaderString(global::G.AutoSDKHttpResponse response, string headerName)
        {
        ...
        internal static int? GetHeaderInt(global::G.AutoSDKHttpResponse response, string headerName)
        {
            return ToNullableInt(GetHeaderString(response, headerName));
        }

        internal static global::System.Uri? GetHeaderUri(global::G.AutoSDKHttpResponse response, string headerName)
        {
        ...
        internal static bool TryCoerceValue<TTarget>(object? value, out TTarget result)
        {
            ...
            var stringValue = global::G.AutoSDKObjectPathSupport.ConvertValueToString(value);
