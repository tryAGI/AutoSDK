            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                try
                {
                    if (ReadResponseAsString)
                    {
                        ...
                        __value_422 = global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.CreateTtsResponseItem>?>(__content_422, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_422 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
