...
{
    /// <inheritdoc />
    public sealed class CreateModelResponseTrainModeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateModelResponseTrainMode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateModelResponseTrainModeExtensions.ToValueString(value));
        }
    }
}
