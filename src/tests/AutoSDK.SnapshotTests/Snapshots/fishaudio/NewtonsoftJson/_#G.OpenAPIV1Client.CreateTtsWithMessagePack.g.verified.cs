//HintName: G.OpenAPIV1Client.CreateTtsWithMessagePack.g.cs
...
namespace G
{
    public partial class OpenAPIV1Client
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateTtsWithMessagePackSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateTtsWithMessagePackSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CreateTtsWithMessagePackSecurityRequirement0,
            };
        partial void PrepareCreateTtsWithMessagePackArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::G.CreateTtsModel model,
            global::G.TTSRequest request);
        partial void PrepareCreateTtsWithMessagePackRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.CreateTtsModel model,
            global::G.TTSRequest request);
        partial void ProcessCreateTtsWithMessagePackResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        ///   }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreateTtsWithMessagePackAsync(
        ...
        {
            await CreateTtsWithMessagePackAsResponseAsync(
        ...
        ///   }'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> CreateTtsWithMessagePackAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateTtsWithMessagePackArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateTtsWithMessagePackSecurityRequirements,
                operationName: "CreateTtsWithMessagePackAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createTtsWithMessagePack",
                                methodName: "CreateTtsWithMessagePackAsync",
                                pathTemplate: "\"/v1/tts\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateTtsWithMessagePackResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::G.ApiException<global::G.CreateTtsResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 402)
                            {
                                ...
                                throw global::G.ApiException<global::G.CreateTtsResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                throw global::G.ApiException<global::System.Collections.Generic.IList<global::G.CreateTtsResponseItem>>.Create(
                                    statusCode: __response.StatusCode,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            await CreateTtsWithMessagePackAsync(
                model: model,
                request: __request,
                requestOptions: requestOptions,
