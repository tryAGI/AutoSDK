...
namespace G
{
    public partial class ModelClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ModelPublicServiceTriggerNamespaceLatestModelServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await ModelPublicServiceTriggerNamespaceLatestModelAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.TriggerNamespaceLatestModelResponse>> ModelPublicServiceTriggerNamespaceLatestModelAsResponseAsync(
            string namespaceId,
            string modelId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ModelPublicServiceTriggerNamespaceLatestModelServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelPublicServiceTriggerNamespaceLatestModel",
                                methodName: "ModelPublicServiceTriggerNamespaceLatestModelAsync",
                                pathTemplate: "$\"/v1alpha/namespaces/{namespaceId}/models/{modelId}/trigger\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.TriggerNamespaceLatestModelResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.TriggerNamespaceLatestModelResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.TriggerNamespaceLatestModelResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
