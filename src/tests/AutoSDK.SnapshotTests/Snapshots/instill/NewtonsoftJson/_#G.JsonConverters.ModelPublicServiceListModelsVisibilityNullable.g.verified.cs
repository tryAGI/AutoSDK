...
{
    /// <inheritdoc />
    public sealed class ModelPublicServiceListModelsVisibilityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ModelPublicServiceListModelsVisibility?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ModelPublicServiceListModelsVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
