//HintName: G.x__VDPClient.PipelinePublicServiceTriggerNamespacePipelineRelease.g.cs
...
namespace G
{
    public partial class x__VDPClient
    {
        ...
        partial void ProcessPipelinePublicServiceTriggerNamespacePipelineReleaseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.TriggerNamespacePipelineReleaseResponse> PipelinePublicServiceTriggerNamespacePipelineReleaseAsync(
            string namespaceId,
            string pipelineId,
            string releaseId,
            global::G.TriggerNamespacePipelineReleaseBody request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePipelinePublicServiceTriggerNamespacePipelineReleaseArguments(
            ...
            PreparePipelinePublicServiceTriggerNamespacePipelineReleaseRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPipelinePublicServiceTriggerNamespacePipelineReleaseResponse(
                httpClient: HttpClient,
            ...
            ProcessPipelinePublicServiceTriggerNamespacePipelineReleaseResponseContent(
                httpClient: HttpClient,
                httpResponseMessage: __response,
                content: ref __content);
            ...
            return
                global::G.TriggerNamespacePipelineReleaseResponse.FromJson(__content, JsonSerializerOptions) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.TriggerNamespacePipelineReleaseResponse> PipelinePublicServiceTriggerNamespacePipelineReleaseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.TriggerNamespacePipelineReleaseBody
            {
                Inputs = inputs,
                Data = data,
            };

            return await PipelinePublicServiceTriggerNamespacePipelineReleaseAsync(
                namespaceId: namespaceId,
                pipelineId: pipelineId,
                releaseId: releaseId,
                instillRequesterUid: instillRequesterUid,
