...
{
    /// <inheritdoc />
    public sealed class OrganizationSubscriptionPlanNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrganizationSubscriptionPlan?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OrganizationSubscriptionPlanExtensions.ToValueString(value.Value));
            }
        }
    }
}
