    ...
    public partial class OrganizationClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/v1beta/organizations/{organizationId}?view={(global::System.Uri.EscapeDataString(viewValue?.ToString() ?? string.Empty))}", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.GetOrganizationResponse?>(__content, JsonSerializerOptions) ??
