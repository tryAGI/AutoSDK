...
{
    /// <inheritdoc />
    public sealed class GetUserMembershipViewJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetUserMembershipView>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetUserMembershipViewExtensions.ToValueString(value));
        }
    }
}
