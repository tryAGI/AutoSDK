...
namespace G
{
    public partial class VdpClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_PipelinePublicServiceListPipelineRunsByRequesterServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await PipelinePublicServiceListPipelineRunsByRequesterAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ListPipelineRunsByRequesterResponse>> PipelinePublicServiceListPipelineRunsByRequesterAsResponseAsync(
            string requesterId,
            int? page = default,
            int? pageSize = default,
            string? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_PipelinePublicServiceListPipelineRunsByRequesterServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinePublicServiceListPipelineRunsByRequester",
                                methodName: "PipelinePublicServiceListPipelineRunsByRequesterAsync",
                                pathTemplate: "\"/v1beta/dashboard/pipelines/runs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ListPipelineRunsByRequesterResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ListPipelineRunsByRequesterResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ListPipelineRunsByRequesterResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
