...
{
    /// <inheritdoc />
    public sealed class StripeSubscriptionDetailStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.StripeSubscriptionDetailStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.StripeSubscriptionDetailStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
