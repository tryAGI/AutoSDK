//HintName: G.VdpClient.PipelinePublicServiceTriggerNamespacePipelineRelease.g.cs
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinePublicServiceTriggerNamespacePipelineRelease",
                                methodName: "PipelinePublicServiceTriggerNamespacePipelineReleaseAsync",
                                pathTemplate: "$\"/v1beta/namespaces/{namespaceId}/pipelines/{pipelineId}/releases/{releaseId}/trigger\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.TriggerNamespacePipelineReleaseResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
