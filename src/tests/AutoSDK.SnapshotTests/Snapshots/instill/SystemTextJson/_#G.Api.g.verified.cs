...
namespace G
{
    ...
    public sealed partial class Api : global::G.IApi, global::System.IDisposable
    {
        ...
        /// </summary>
        public AppClient App => new AppClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
        ...
        /// </summary>
        public SubscriptionClient Subscription => new SubscriptionClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerOptions = JsonSerializerOptions,
            AutoSDKServerConfiguration = AutoSDKServerConfiguration,
        ...
        /// </summary>
        public VdpClient Vdp => new VdpClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerOptions = JsonSerializerOptions,
            AutoSDKServerConfiguration = AutoSDKServerConfiguration,
