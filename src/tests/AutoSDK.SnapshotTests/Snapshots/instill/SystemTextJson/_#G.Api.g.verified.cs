...
namespace G
{
    ...
    public sealed partial class Api : global::G.IApi, global::System.IDisposable
    {
        ...
        /// </summary>
        public AppClient App => new AppClient(HttpClient, authorizations: Authorizations, options: Options)
        {
        ...
        /// </summary>
        public SubscriptionClient Subscription => new SubscriptionClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerOptions = JsonSerializerOptions,
        };
        ...
        /// </summary>
        public VdpClient Vdp => new VdpClient(HttpClient, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            JsonSerializerOptions = JsonSerializerOptions,
        };
