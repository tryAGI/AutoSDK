//HintName: G.JsonConverters.Vector2.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class Vector2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Vector2>
    {
        /// <inheritdoc />
        public override global::G.Vector2 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::System.Collections.Generic.IList<double>? vectorVariant1 = default;
            string? vectorVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        vectorVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::G.Vector2(
                vectorVariant1,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsVectorVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.VectorVariant2!, typeInfo);
            }
        }
    }
}