...
namespace G
{
    ...
    public sealed partial class WriteBilling
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("billable_logical_bytes_written", Required = global::Newtonsoft.Json.Required.Always)]
        public long BillableLogicalBytesWritten { get; set; } = default!;
