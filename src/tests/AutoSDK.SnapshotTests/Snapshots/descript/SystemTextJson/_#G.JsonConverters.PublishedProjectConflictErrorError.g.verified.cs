...
{
    /// <inheritdoc />
    public sealed class PublishedProjectConflictErrorErrorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PublishedProjectConflictErrorError>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PublishedProjectConflictErrorErrorExtensions.ToValueString(value));
        }
    }
}
