//HintName: G.Models.ImportJobStatusProgress.g.cs
...
namespace G
{
    ...
    public sealed partial class ImportJobStatusProgress
    {
        ...
        /// </summary>
        /// <example>Importing media...</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportJobStatusProgress" /> class.
        /// </summary>
        /// <param name="label">
        /// Human-readable label describing the current action<br/>
        /// Example: Importing media...
...
#endif
        public ImportJobStatusProgress(
            string label,
            int? percent,
