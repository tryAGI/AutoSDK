...
{
    /// <inheritdoc />
    public sealed class AgentEditJobRequestTeamAccessNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentEditJobRequestTeamAccess?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AgentEditJobRequestTeamAccessExtensions.ToValueString(value.Value));
            }
        }
    }
}
