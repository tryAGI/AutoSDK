...
{
    /// <inheritdoc />
    public sealed class ImportJobStatusJobStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ImportJobStatusJobState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ImportJobStatusJobStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
