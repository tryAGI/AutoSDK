...
{
    /// <inheritdoc />
    public sealed class PublishedProjectForbiddenErrorErrorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PublishedProjectForbiddenErrorError?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PublishedProjectForbiddenErrorErrorExtensions.ToValueString(value.Value));
            }
        }
    }
}
