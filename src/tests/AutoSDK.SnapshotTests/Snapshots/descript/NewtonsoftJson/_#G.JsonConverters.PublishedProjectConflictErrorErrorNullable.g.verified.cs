...
{
    /// <inheritdoc />
    public sealed class PublishedProjectConflictErrorErrorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PublishedProjectConflictErrorError?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PublishedProjectConflictErrorErrorExtensions.ToValueString(value.Value));
            }
        }
    }
}
