...
{
    /// <inheritdoc />
    public sealed class ErrorResponseErrorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ErrorResponseError?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ErrorResponseErrorExtensions.ToValueString(value.Value));
            }
        }
    }
}
