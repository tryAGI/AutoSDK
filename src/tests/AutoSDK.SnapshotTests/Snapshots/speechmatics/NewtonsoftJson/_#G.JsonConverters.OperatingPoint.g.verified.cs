...
{
    /// <inheritdoc />
    public sealed class OperatingPointJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OperatingPoint>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OperatingPointExtensions.ToValueString(value));
        }
    }
}
