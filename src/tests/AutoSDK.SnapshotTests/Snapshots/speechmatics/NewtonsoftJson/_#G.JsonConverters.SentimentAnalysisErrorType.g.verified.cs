...
{
    /// <inheritdoc />
    public sealed class SentimentAnalysisErrorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SentimentAnalysisErrorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SentimentAnalysisErrorTypeExtensions.ToValueString(value));
        }
    }
}
