...
{
    /// <inheritdoc />
    public sealed class ErrorResponseErrorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ErrorResponseError>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ErrorResponseErrorExtensions.ToValueString(value));
        }
    }
}
