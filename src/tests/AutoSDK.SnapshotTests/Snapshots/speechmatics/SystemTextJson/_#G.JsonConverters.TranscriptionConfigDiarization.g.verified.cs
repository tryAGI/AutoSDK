...
{
    /// <inheritdoc />
    public sealed class TranscriptionConfigDiarizationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TranscriptionConfigDiarization>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TranscriptionConfigDiarizationExtensions.ToValueString(value));
        }
    }
}
