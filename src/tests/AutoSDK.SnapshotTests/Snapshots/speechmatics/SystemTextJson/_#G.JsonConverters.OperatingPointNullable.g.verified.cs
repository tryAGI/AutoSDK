...
{
    /// <inheritdoc />
    public sealed class OperatingPointNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OperatingPoint?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.OperatingPointExtensions.ToValueString(value.Value));
            }
        }
    }
}
