//HintName: G.Api.DeleteJobsByJobid.g.cs
...
namespace G
{
    public partial class Api
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DeleteJobsByJobidSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_DeleteJobsByJobidSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareDeleteJobsByJobidArguments(
            ...
            ref string jobid,
            ref bool? force);
        partial void PrepareDeleteJobsByJobidRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string jobid,
            bool? force);
        partial void ProcessDeleteJobsByJobidResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteJobsByJobidResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.DeleteJobResponse> DeleteJobsByJobidAsync(
            string jobid,
            bool? force = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteJobsByJobidArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessDeleteJobsByJobidResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 423)
            {
                ...
                global::G.ErrorResponse? __value_423 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_423 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_423 = global::G.ErrorResponse.FromJson(__content_423, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_423 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessDeleteJobsByJobidResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.DeleteJobResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.DeleteJobResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
