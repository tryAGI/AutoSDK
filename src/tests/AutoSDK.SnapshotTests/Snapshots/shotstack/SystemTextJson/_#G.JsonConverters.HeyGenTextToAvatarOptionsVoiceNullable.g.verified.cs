...
{
    /// <inheritdoc />
    public sealed class HeyGenTextToAvatarOptionsVoiceNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.HeyGenTextToAvatarOptionsVoice?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.HeyGenTextToAvatarOptionsVoiceExtensions.ToValueString(value.Value));
            }
        }
    }
}
