//HintName: G.Models.SvgShadow.g.cs
...
namespace G
{
    ...
    {
        /// <summary>
        /// Horizontal offset of the shadow in pixels.<br/>
        /// Positive values move the shadow to the right, negative to the left.<br/>
        /// Default Value: 0<br/>
        /// Example: 4
        /// </summary>
        /// <example>4</example>
        ...
        /// <summary>
        /// Vertical offset of the shadow in pixels.<br/>
        /// Positive values move the shadow down, negative values move it up.<br/>
        /// Default Value: 0<br/>
        /// Example: 4
        /// </summary>
        /// <example>4</example>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SvgShadow" /> class.
        /// </summary>
        /// <param name="offsetX">
        /// Horizontal offset of the shadow in pixels.<br/>
        /// Positive values move the shadow to the right, negative to the left.<br/>
