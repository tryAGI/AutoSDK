...
{
    /// <inheritdoc />
    public sealed class RichCaptionStyleTextTransformNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RichCaptionStyleTextTransform?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RichCaptionStyleTextTransformExtensions.ToValueString(value.Value));
            }
        }
    }
}
