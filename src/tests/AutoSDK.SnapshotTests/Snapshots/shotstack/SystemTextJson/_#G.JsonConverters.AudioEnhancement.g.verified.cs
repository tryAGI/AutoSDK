...
{
    /// <inheritdoc />
    public class AudioEnhancementJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AudioEnhancement>
    {
        /// <inheritdoc />
        public override global::G.AudioEnhancement Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.DolbyEnhancement? dolby = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.AudioEnhancement(
                dolby
                );
        ...
        public override void Write(
            ...
            global::G.AudioEnhancement value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
