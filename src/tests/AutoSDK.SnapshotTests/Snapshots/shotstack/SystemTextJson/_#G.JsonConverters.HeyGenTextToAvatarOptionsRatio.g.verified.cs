...
{
    /// <inheritdoc />
    public sealed class HeyGenTextToAvatarOptionsRatioJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.HeyGenTextToAvatarOptionsRatio>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.HeyGenTextToAvatarOptionsRatioExtensions.ToValueString(value));
        }
    }
}
