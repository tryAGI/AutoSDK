...
{
    /// <inheritdoc />
    public sealed class AssetResponseAttributesStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AssetResponseAttributesStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AssetResponseAttributesStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
