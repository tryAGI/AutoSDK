...
{
    /// <inheritdoc />
    public sealed class RichCaptionStyleTextTransformJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RichCaptionStyleTextTransform>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RichCaptionStyleTextTransformExtensions.ToValueString(value));
        }
    }
}
