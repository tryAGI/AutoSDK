...
{
    /// <inheritdoc />
    public sealed class HeyGenTextToAvatarOptionsRatioNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.HeyGenTextToAvatarOptionsRatio?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.HeyGenTextToAvatarOptionsRatioExtensions.ToValueString(value.Value));
            }
        }
    }
}
