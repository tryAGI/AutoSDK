...
{
    /// <inheritdoc />
    public sealed class TweenEasingNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TweenEasing?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TweenEasingExtensions.ToValueString(value.Value));
            }
        }
    }
}
