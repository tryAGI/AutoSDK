...
{
    /// <inheritdoc />
    public sealed class RichTextGradientTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RichTextGradientType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RichTextGradientTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
