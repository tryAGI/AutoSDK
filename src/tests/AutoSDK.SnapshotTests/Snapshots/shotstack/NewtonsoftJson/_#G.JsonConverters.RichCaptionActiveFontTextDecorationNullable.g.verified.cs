...
{
    /// <inheritdoc />
    public sealed class RichCaptionActiveFontTextDecorationNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RichCaptionActiveFontTextDecoration?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RichCaptionActiveFontTextDecorationExtensions.ToValueString(value.Value));
            }
        }
    }
}
