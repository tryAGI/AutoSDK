...
{
    /// <inheritdoc />
    public sealed class HeyGenTextToAvatarOptionsVoiceJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.HeyGenTextToAvatarOptionsVoice>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.HeyGenTextToAvatarOptionsVoiceExtensions.ToValueString(value));
        }
    }
}
