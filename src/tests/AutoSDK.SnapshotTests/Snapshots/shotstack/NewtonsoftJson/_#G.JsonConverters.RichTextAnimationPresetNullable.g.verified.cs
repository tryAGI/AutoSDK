...
{
    /// <inheritdoc />
    public sealed class RichTextAnimationPresetNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RichTextAnimationPreset?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RichTextAnimationPresetExtensions.ToValueString(value.Value));
            }
        }
    }
}
