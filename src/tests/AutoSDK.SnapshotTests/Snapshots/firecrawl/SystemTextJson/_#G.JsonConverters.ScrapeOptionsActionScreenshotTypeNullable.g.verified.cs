...
{
    /// <inheritdoc />
    public sealed class ScrapeOptionsActionScreenshotTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ScrapeOptionsActionScreenshotType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ScrapeOptionsActionScreenshotTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
