...
{
    /// <inheritdoc />
    public sealed class ScrapeOptionsActionScrapeTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ScrapeOptionsActionScrapeType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ScrapeOptionsActionScrapeTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
