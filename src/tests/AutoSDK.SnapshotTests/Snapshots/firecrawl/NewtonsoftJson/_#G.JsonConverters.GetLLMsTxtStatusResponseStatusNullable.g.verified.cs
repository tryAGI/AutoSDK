...
{
    /// <inheritdoc />
    public sealed class GetLLMsTxtStatusResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetLLMsTxtStatusResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetLLMsTxtStatusResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
