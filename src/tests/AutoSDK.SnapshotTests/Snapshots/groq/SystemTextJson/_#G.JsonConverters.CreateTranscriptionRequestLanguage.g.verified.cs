...
{
    /// <inheritdoc />
    public sealed class CreateTranscriptionRequestLanguageJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTranscriptionRequestLanguage>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateTranscriptionRequestLanguageExtensions.ToValueString(value));
        }
    }
}
