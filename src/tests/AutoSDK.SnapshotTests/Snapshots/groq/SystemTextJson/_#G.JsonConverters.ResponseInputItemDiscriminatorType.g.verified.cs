...
{
    /// <inheritdoc />
    public sealed class ResponseInputItemDiscriminatorTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseInputItemDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ResponseInputItemDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
