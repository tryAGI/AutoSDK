...
namespace G
{
    ...
    public sealed partial class BatchRequestInput
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.BatchRequestInputMethodJsonConverter))]
        public global::G.BatchRequestInputMethod? Method { get; set; }

        /// <summary>
        /// The OpenAI API relative URL to be used for the request. Currently `/v1/chat/completions` is supported.
        /// </summary>
