...
{
    /// <inheritdoc />
    public sealed class ResponseItemReferenceTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseItemReferenceType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseItemReferenceTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
