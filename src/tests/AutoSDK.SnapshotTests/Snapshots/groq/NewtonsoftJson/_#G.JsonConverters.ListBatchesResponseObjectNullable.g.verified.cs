...
{
    /// <inheritdoc />
    public sealed class ListBatchesResponseObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListBatchesResponseObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListBatchesResponseObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
