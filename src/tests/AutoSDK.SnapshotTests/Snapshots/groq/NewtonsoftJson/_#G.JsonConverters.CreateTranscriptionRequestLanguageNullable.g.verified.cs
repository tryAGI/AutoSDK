...
{
    /// <inheritdoc />
    public sealed class CreateTranscriptionRequestLanguageNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTranscriptionRequestLanguage?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTranscriptionRequestLanguageExtensions.ToValueString(value.Value));
            }
        }
    }
}
