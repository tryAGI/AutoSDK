...
{
    /// <inheritdoc />
    public sealed class ResponseInputItemDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseInputItemDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseInputItemDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
