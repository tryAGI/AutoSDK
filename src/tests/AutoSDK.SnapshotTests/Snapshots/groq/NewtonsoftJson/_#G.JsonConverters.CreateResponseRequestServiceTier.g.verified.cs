...
{
    /// <inheritdoc />
    public sealed class CreateResponseRequestServiceTierJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateResponseRequestServiceTier>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateResponseRequestServiceTierExtensions.ToValueString(value));
        }
    }
}
