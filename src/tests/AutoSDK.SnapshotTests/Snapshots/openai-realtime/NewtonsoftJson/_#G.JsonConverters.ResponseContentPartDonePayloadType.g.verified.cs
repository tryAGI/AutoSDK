...
{
    /// <inheritdoc />
    public sealed class ResponseContentPartDonePayloadTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseContentPartDonePayloadType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ResponseContentPartDonePayloadTypeExtensions.ToValueString(value));
        }
    }
}
