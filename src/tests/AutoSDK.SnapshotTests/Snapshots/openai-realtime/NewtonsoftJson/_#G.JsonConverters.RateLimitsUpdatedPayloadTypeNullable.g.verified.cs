...
{
    /// <inheritdoc />
    public sealed class RateLimitsUpdatedPayloadTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RateLimitsUpdatedPayloadType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RateLimitsUpdatedPayloadTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
