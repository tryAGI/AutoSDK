...
{
    /// <inheritdoc />
    public sealed class InputAudioBufferCommittedPayloadTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InputAudioBufferCommittedPayloadType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.InputAudioBufferCommittedPayloadTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
