...
{
    /// <inheritdoc />
    public sealed class InputAudioBufferCommittedPayloadTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InputAudioBufferCommittedPayloadType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.InputAudioBufferCommittedPayloadTypeExtensions.ToValueString(value));
        }
    }
}
