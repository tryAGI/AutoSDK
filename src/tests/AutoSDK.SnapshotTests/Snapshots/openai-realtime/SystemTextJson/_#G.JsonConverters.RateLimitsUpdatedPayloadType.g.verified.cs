...
{
    /// <inheritdoc />
    public sealed class RateLimitsUpdatedPayloadTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RateLimitsUpdatedPayloadType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.RateLimitsUpdatedPayloadTypeExtensions.ToValueString(value));
        }
    }
}
