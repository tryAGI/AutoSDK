...
{
    /// <inheritdoc />
    public sealed class CreateCrawlRequestExtractDepthJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateCrawlRequestExtractDepth>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateCrawlRequestExtractDepthExtensions.ToValueString(value));
        }
    }
}
