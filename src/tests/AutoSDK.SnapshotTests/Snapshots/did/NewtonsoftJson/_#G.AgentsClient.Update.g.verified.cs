...
namespace G
{
    public partial class AgentsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.AllOf<global::G.UpdateResponseVariant1, global::G.UpdateResponseVariant2>> UpdateAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AllOf<global::G.UpdateResponseVariant1, global::G.UpdateResponseVariant2>>> UpdateAsResponseAsync(
            string id,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::G.UpdateResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::G.UpdateResponse2.FromJson(__content_401, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.UpdateResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AllOf<global::G.UpdateResponseVariant1, global::G.UpdateResponseVariant2>.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AllOf<global::G.UpdateResponseVariant1, global::G.UpdateResponseVariant2>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AllOf<global::G.UpdateResponseVariant1, global::G.UpdateResponseVariant2>.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
