...
{
    /// <inheritdoc />
    public sealed class KnowledgeEmbedderProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.KnowledgeEmbedderProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.KnowledgeEmbedderProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
