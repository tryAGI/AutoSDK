//HintName: G.Models.AgentLlmVariant2PromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class AgentLlmVariant2PromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.AgentLlmVariant2PromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.AgentLlmVariant2PromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentLlmVariant2PromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public AgentLlmVariant2PromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.AgentLlmVariant2PromptCustomizationKnowledgeSource? knowledgeSource,
