...
{
    /// <inheritdoc />
    public sealed class StreamScriptVariant1ProviderElevenLabsTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.StreamScriptVariant1ProviderElevenLabsType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.StreamScriptVariant1ProviderElevenLabsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
