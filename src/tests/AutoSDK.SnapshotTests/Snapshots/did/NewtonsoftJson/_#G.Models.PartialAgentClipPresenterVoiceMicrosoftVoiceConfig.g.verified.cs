//HintName: G.Models.PartialAgentClipPresenterVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialAgentClipPresenterVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialAgentClipPresenterVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public PartialAgentClipPresenterVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
