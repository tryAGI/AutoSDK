//HintName: G.Models.DeleteAnimationResponse4.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteAnimationResponse4
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAnimationResponse4" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public DeleteAnimationResponse4(
            string kind,
            string description,
            object? details,
            string? @internal)
