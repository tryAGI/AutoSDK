//HintName: G.Models.DeleteAnimationResponseConfigLogo.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class DeleteAnimationResponseConfigLogo
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAnimationResponseConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public DeleteAnimationResponseConfigLogo(
            string url,
