//HintName: G.Models.GetPresenterByIdResponsePresenterVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetPresenterByIdResponsePresenterVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPresenterByIdResponsePresenterVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public GetPresenterByIdResponsePresenterVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
