//HintName: G.Models.DeleteResponseVariant1LlmDIdPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteResponseVariant1LlmDIdPromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.DeleteResponseVariant1LlmDIdPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.DeleteResponseVariant1LlmDIdPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteResponseVariant1LlmDIdPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public DeleteResponseVariant1LlmDIdPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.DeleteResponseVariant1LlmDIdPromptCustomizationKnowledgeSource? knowledgeSource,
