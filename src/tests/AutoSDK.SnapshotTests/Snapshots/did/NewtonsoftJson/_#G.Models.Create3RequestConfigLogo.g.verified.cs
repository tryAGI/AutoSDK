//HintName: G.Models.Create3RequestConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class Create3RequestConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Create3RequestConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public Create3RequestConfigLogo(
            string url,
