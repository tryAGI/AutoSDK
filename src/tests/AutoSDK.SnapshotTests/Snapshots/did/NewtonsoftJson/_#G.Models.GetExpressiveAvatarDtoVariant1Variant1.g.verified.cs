//HintName: G.Models.GetExpressiveAvatarDtoVariant1Variant1.g.cs
...
namespace G
{
    ...
    public sealed partial class GetExpressiveAvatarDtoVariant1Variant1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExpressiveAvatarDtoVariant1Variant1" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the avatar
        /// </param>
        ...
        /// The gender of the avatar
        /// </param>
        public GetExpressiveAvatarDtoVariant1Variant1(
            string id,
            string ownerId,
            string name,
            bool isGreenscreen,
