...
{
    /// <inheritdoc />
    public sealed class GetTalksResponseTalkStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetTalksResponseTalkStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetTalksResponseTalkStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
