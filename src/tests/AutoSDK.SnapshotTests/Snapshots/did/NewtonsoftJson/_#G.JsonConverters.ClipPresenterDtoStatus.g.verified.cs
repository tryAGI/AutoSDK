...
{
    /// <inheritdoc />
    public sealed class ClipPresenterDtoStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClipPresenterDtoStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ClipPresenterDtoStatusExtensions.ToValueString(value));
        }
    }
}
