//HintName: G.Models.GetResponseVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetResponseVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResponseVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public GetResponseVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
