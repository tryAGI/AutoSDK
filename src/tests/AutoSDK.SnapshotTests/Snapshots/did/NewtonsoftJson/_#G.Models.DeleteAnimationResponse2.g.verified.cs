//HintName: G.Models.DeleteAnimationResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteAnimationResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteAnimationResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public DeleteAnimationResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
