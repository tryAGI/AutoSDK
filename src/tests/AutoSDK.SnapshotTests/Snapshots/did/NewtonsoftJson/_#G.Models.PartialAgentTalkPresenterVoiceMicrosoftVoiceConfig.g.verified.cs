//HintName: G.Models.PartialAgentTalkPresenterVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialAgentTalkPresenterVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialAgentTalkPresenterVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public PartialAgentTalkPresenterVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
