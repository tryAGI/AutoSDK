//HintName: G.Models.CreateClipStreamResponse2.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateClipStreamResponse2
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipStreamResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public CreateClipStreamResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
