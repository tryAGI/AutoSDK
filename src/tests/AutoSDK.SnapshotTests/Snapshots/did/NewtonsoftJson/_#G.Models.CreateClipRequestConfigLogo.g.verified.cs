//HintName: G.Models.CreateClipRequestConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClipRequestConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public CreateClipRequestConfigLogo(
            string url,
