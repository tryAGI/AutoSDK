...
{
    /// <inheritdoc />
    public sealed class UpdateRequestPresenterPhotoAvatarVoiceElevenLabsAccessNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateRequestPresenterPhotoAvatarVoiceElevenLabsAccess?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateRequestPresenterPhotoAvatarVoiceElevenLabsAccessExtensions.ToValueString(value.Value));
            }
        }
    }
}
