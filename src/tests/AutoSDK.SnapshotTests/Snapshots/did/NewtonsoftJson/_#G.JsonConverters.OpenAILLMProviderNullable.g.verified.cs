...
{
    /// <inheritdoc />
    public sealed class OpenAILLMProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAILLMProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OpenAILLMProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
