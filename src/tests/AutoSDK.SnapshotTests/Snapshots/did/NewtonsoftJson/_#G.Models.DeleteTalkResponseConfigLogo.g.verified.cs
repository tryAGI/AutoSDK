//HintName: G.Models.DeleteTalkResponseConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteTalkResponseConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteTalkResponseConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public DeleteTalkResponseConfigLogo(
            string url,
