//HintName: G.Models.StartConnectionResponse3.g.cs
...
namespace G
{
    ...
    public sealed partial class StartConnectionResponse3
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartConnectionResponse3" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public StartConnectionResponse3(
            string kind,
            string description,
            object? details,
            string? @internal)
