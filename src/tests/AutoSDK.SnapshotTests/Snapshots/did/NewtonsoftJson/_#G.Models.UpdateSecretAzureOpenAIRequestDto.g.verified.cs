//HintName: G.Models.UpdateSecretAzureOpenAIRequestDto.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class UpdateSecretAzureOpenAIRequestDto
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.UpdateSecretAzureOpenAIRequestDtoProviderJsonConverter))]
        public global::G.UpdateSecretAzureOpenAIRequestDtoProvider? Provider { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSecretAzureOpenAIRequestDto" /> class.
        /// </summary>
        /// <param name="apiKey">
        /// The API key for OpenAI/Azure OpenAI authentication.<br/>
        /// Example: sk-1234567890abcdef
        ...
        /// Example: 2023-05-15
        /// </param>
        public UpdateSecretAzureOpenAIRequestDto(
            string? apiKey,
            string? model,
            string? endpoint,
            bool? isStreaming,
            double? maxMessages,
            global::G.UpdateSecretAzureOpenAIRequestDtoProvider? provider,
            string? version)
        {
            this.ApiKey = apiKey;
            this.Model = model;
