//HintName: G.ClientKeysClient.UpdateResourceClientKey.g.cs
...
namespace G
{
    public partial class ClientKeysClient
    {
        ...
        partial void PrepareUpdateResourceClientKeyRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string agentId,
            string clientKey,
            global::G.UpdateResourceClientKeyRequest request);
        partial void ProcessUpdateResourceClientKeyResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task UpdateResourceClientKeyAsync(
            string agentId,
            string clientKey,
        ...
        {
            await UpdateResourceClientKeyAsResponseAsync(
                agentId: agentId,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> UpdateResourceClientKeyAsResponseAsync(
            string agentId,
            string clientKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateResourceClientKeyArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateResourceClientKey",
                                methodName: "UpdateResourceClientKeyAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateResourceClientKeyResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::G.UpdateResourceClientKeyResponse? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::G.UpdateResourceClientKeyResponse.FromJson(__content_404, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.UpdateResourceClientKeyResponse>.Create(
        ...
        public async global::System.Threading.Tasks.Task UpdateResourceClientKeyAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UpdateResourceClientKeyRequest
            {
                AllowedDomains = allowedDomains,
                Name = name,
            };

            await UpdateResourceClientKeyAsync(
                agentId: agentId,
                clientKey: clientKey,
                request: __request,
                requestOptions: requestOptions,
