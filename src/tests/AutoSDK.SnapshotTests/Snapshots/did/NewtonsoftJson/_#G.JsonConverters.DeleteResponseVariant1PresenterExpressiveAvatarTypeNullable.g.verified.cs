...
{
    /// <inheritdoc />
    public sealed class DeleteResponseVariant1PresenterExpressiveAvatarTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeleteResponseVariant1PresenterExpressiveAvatarType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeleteResponseVariant1PresenterExpressiveAvatarTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
