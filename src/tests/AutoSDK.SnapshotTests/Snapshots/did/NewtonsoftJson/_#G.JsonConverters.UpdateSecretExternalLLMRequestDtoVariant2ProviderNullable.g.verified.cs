...
{
    /// <inheritdoc />
    public sealed class UpdateSecretExternalLLMRequestDtoVariant2ProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateSecretExternalLLMRequestDtoVariant2Provider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateSecretExternalLLMRequestDtoVariant2ProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
