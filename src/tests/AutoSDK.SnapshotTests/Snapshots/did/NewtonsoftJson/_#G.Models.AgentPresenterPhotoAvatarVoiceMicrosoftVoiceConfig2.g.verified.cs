//HintName: G.Models.AgentPresenterPhotoAvatarVoiceMicrosoftVoiceConfig2.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentPresenterPhotoAvatarVoiceMicrosoftVoiceConfig2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPresenterPhotoAvatarVoiceMicrosoftVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public AgentPresenterPhotoAvatarVoiceMicrosoftVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
