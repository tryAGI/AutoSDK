...
{
    /// <inheritdoc />
    public sealed class AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceOpenAITypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceOpenAIType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceOpenAITypeExtensions.ToValueString(value));
        }
    }
}
