//HintName: G.Models.CreateAnimationResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateAnimationResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnimationResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public CreateAnimationResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
