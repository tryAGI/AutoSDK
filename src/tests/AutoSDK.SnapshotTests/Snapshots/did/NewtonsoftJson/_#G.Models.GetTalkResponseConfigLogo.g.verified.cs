//HintName: G.Models.GetTalkResponseConfigLogo.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class GetTalkResponseConfigLogo
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTalkResponseConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public GetTalkResponseConfigLogo(
            string url,
