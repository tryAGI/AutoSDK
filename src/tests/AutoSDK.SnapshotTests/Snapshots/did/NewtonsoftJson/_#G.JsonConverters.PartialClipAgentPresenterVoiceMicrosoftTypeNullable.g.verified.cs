...
{
    /// <inheritdoc />
    public sealed class PartialClipAgentPresenterVoiceMicrosoftTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PartialClipAgentPresenterVoiceMicrosoftType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PartialClipAgentPresenterVoiceMicrosoftTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
