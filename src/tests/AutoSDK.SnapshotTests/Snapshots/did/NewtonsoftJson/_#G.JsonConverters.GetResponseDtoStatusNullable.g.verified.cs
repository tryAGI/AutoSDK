...
{
    /// <inheritdoc />
    public sealed class GetResponseDtoStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetResponseDtoStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetResponseDtoStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
