//HintName: G.Models.TextScriptProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class TextScriptProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextScriptProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public TextScriptProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
