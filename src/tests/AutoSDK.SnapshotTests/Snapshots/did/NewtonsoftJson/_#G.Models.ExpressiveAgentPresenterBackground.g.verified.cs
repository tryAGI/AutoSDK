//HintName: G.Models.ExpressiveAgentPresenterBackground.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAgentPresenterBackground
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAgentPresenterBackground" /> class.
        /// </summary>
        /// <param name="color">
        /// Background color of the Avatar.<br/>
        /// Example: #47ffff
        ...
        /// Example: https://path.to.image/
        /// </param>
        public ExpressiveAgentPresenterBackground(
            string? color,
            string? sourceUrl)
        {
            this.Color = color;
