//HintName: G.Models.CreateRequestLlmVariant1PromptCustomization.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateRequestLlmVariant1PromptCustomization
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.CreateRequestLlmVariant1PromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.CreateRequestLlmVariant1PromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRequestLlmVariant1PromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public CreateRequestLlmVariant1PromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.CreateRequestLlmVariant1PromptCustomizationKnowledgeSource? knowledgeSource,
