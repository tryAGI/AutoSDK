...
{
    /// <inheritdoc />
    public sealed class GetScenesResponseSceneStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetScenesResponseSceneStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetScenesResponseSceneStatusExtensions.ToValueString(value));
        }
    }
}
