...
{
    /// <inheritdoc />
    public sealed class CreateSecretRequestDtoApiKeyTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateSecretRequestDtoApiKeyType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateSecretRequestDtoApiKeyTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
