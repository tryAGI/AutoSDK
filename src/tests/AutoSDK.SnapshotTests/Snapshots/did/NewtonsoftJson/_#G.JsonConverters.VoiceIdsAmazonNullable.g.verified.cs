...
{
    /// <inheritdoc />
    public sealed class VoiceIdsAmazonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VoiceIdsAmazon?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VoiceIdsAmazonExtensions.ToValueString(value.Value));
            }
        }
    }
}
