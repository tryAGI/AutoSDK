...
{
    /// <inheritdoc />
    public sealed class LLMConfigDIdModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMConfigDIdModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.LLMConfigDIdModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
