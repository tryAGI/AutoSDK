//HintName: G.Models.CreateStreamRequestFaceDetection.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateStreamRequestFaceDetection
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStreamRequestFaceDetection" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public CreateStreamRequestFaceDetection(
            double top,
            double left,
            double bottom,
            double right)
