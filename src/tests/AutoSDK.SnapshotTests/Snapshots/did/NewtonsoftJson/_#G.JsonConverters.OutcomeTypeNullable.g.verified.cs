...
{
    /// <inheritdoc />
    public sealed class OutcomeTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OutcomeType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OutcomeTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
