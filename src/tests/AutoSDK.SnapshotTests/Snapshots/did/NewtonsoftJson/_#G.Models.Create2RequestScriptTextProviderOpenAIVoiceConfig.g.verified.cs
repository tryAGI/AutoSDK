//HintName: G.Models.Create2RequestScriptTextProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class Create2RequestScriptTextProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Create2RequestScriptTextProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public Create2RequestScriptTextProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
