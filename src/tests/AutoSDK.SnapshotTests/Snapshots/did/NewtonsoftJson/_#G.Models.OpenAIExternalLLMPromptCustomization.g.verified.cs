//HintName: G.Models.OpenAIExternalLLMPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class OpenAIExternalLLMPromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.OpenAIExternalLLMPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.OpenAIExternalLLMPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenAIExternalLLMPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public OpenAIExternalLLMPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.OpenAIExternalLLMPromptCustomizationKnowledgeSource? knowledgeSource,
