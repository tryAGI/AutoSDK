...
{
    /// <inheritdoc />
    public sealed class TextScript3ProviderOpenAITypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TextScript3ProviderOpenAIType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TextScript3ProviderOpenAITypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
