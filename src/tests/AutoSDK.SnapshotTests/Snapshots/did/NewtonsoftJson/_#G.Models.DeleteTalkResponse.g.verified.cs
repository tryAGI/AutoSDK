//HintName: G.Models.DeleteTalkResponse.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteTalkResponse
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.DeleteTalkResponseStatusJsonConverter))]
        public global::G.DeleteTalkResponseStatus Status { get; set; } = default!;
        ...
        public global::G.DeleteTalkResponseConfig? Config { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteTalkResponse" /> class.
        /// </summary>
        /// <param name="id">
        /// Unique identifier for the object
        /// </param>
        ...
        /// The configuration that used to process the talk
        /// </param>
        public DeleteTalkResponse(
            string id,
            string userId,
            string sourceUrl,
            string createdAt,
            string modifiedAt,
            global::G.DeleteTalkResponseStatus status,
            string? driverUrl,
            string? createdBy,
            string? audioUrl,
            string? startedAt,
            ...
            object? metadata,
            string? webhook,
            global::G.DeleteTalkResponseConfig? config)
        {
