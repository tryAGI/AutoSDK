...
{
    /// <inheritdoc />
    public sealed class GetGroupResponseTranslationStatus2JsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetGroupResponseTranslationStatus2>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetGroupResponseTranslationStatus2Extensions.ToValueString(value));
        }
    }
}
