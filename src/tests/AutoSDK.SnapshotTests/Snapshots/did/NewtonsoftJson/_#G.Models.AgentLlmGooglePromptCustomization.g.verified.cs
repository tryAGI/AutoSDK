//HintName: G.Models.AgentLlmGooglePromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class AgentLlmGooglePromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.AgentLlmGooglePromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.AgentLlmGooglePromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentLlmGooglePromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public AgentLlmGooglePromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.AgentLlmGooglePromptCustomizationKnowledgeSource? knowledgeSource,
