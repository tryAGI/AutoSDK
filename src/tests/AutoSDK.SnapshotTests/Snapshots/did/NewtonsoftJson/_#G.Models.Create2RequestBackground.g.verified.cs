//HintName: G.Models.Create2RequestBackground.g.cs
...
namespace G
{
    ...
    public sealed partial class Create2RequestBackground
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Create2RequestBackground" /> class.
        /// </summary>
        /// <param name="color">
        /// Background color of the animated result, or false to use transparent background in-case of webm result format.<br/>
        /// Example: #47ffff
        ...
        /// Example: https://path.to.image/
        /// </param>
        public Create2RequestBackground(
