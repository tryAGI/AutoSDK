//HintName: G.Models.CreateClipRequestPresenterConfigCropVariant2Rectangle2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClipRequestPresenterConfigCropVariant2Rectangle2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestPresenterConfigCropVariant2Rectangle2" /> class.
        /// </summary>
        /// <param name="bottom">
        /// Bottom position.<br/>
        /// Example: 1
        ...
        /// Example: 0
        /// </param>
        public CreateClipRequestPresenterConfigCropVariant2Rectangle2(
            double bottom,
            double right,
            double left,
            double top)
