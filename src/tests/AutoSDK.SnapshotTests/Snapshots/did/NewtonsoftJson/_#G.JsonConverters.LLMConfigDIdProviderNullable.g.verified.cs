...
{
    /// <inheritdoc />
    public sealed class LLMConfigDIdProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMConfigDIdProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.LLMConfigDIdProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
