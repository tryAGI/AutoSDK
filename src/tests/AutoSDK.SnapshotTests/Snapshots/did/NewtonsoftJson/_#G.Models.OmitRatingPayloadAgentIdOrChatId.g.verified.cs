//HintName: G.Models.OmitRatingPayloadAgentIdOrChatId.g.cs
...
namespace G
{
    ...
    public sealed partial class OmitRatingPayloadAgentIdOrChatId
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OmitRatingPayloadAgentIdOrChatId" /> class.
        /// </summary>
        /// <param name="score">
        /// The rating score: positive for favorable, negative for unfavorable<br/>
        /// Example: 1
        ...
        /// The ID of the message to rate
        /// </param>
        public OmitRatingPayloadAgentIdOrChatId(
            double score,
            string knowledgeId,
            string? messageId)
        {
