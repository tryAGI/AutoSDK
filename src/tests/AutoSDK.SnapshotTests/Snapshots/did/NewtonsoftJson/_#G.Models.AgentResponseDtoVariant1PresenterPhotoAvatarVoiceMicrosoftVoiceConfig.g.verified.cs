//HintName: G.Models.AgentResponseDtoVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class AgentResponseDtoVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentResponseDtoVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public AgentResponseDtoVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
