//HintName: G.Models.GetPresenterByIdResponsePresenterVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetPresenterByIdResponsePresenterVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPresenterByIdResponsePresenterVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public GetPresenterByIdResponsePresenterVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
