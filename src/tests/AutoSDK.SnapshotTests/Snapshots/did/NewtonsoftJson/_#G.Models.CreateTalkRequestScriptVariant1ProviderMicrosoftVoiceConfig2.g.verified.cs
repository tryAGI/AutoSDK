//HintName: G.Models.CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
