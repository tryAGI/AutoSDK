//HintName: G.Models.AgentUpdateDtoLlmVariant3PromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class AgentUpdateDtoLlmVariant3PromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.AgentUpdateDtoLlmVariant3PromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.AgentUpdateDtoLlmVariant3PromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUpdateDtoLlmVariant3PromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public AgentUpdateDtoLlmVariant3PromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.AgentUpdateDtoLlmVariant3PromptCustomizationKnowledgeSource? knowledgeSource,
