//HintName: G.Models.CreateStreamScriptTextProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateStreamScriptTextProviderMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStreamScriptTextProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateStreamScriptTextProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
