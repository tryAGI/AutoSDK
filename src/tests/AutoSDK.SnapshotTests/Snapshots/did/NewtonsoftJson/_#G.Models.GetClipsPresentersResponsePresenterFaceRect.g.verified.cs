//HintName: G.Models.GetClipsPresentersResponsePresenterFaceRect.g.cs
...
namespace G
{
    ...
    public sealed partial class GetClipsPresentersResponsePresenterFaceRect
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClipsPresentersResponsePresenterFaceRect" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public GetClipsPresentersResponsePresenterFaceRect(
            double top,
            double left,
            double bottom,
            double right)
