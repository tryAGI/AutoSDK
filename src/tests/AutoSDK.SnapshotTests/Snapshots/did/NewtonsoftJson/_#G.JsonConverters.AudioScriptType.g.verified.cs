...
{
    /// <inheritdoc />
    public sealed class AudioScriptTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AudioScriptType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AudioScriptTypeExtensions.ToValueString(value));
        }
    }
}
