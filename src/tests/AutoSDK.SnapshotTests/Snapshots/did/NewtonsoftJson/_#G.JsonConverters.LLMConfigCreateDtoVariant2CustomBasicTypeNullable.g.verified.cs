...
{
    /// <inheritdoc />
    public sealed class LLMConfigCreateDtoVariant2CustomBasicTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMConfigCreateDtoVariant2CustomBasicType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.LLMConfigCreateDtoVariant2CustomBasicTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
