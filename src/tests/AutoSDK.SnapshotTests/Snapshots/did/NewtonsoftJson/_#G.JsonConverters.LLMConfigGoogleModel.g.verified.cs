...
{
    /// <inheritdoc />
    public sealed class LLMConfigGoogleModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMConfigGoogleModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LLMConfigGoogleModelExtensions.ToValueString(value));
        }
    }
}
