...
{
    /// <inheritdoc />
    public sealed class PartialAgentClipPresenterVoiceElevenLabsTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PartialAgentClipPresenterVoiceElevenLabsType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PartialAgentClipPresenterVoiceElevenLabsTypeExtensions.ToValueString(value));
        }
    }
}
