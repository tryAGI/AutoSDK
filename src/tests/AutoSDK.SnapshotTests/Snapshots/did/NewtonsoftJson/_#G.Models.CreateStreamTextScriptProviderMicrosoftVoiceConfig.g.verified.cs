//HintName: G.Models.CreateStreamTextScriptProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateStreamTextScriptProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStreamTextScriptProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateStreamTextScriptProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
