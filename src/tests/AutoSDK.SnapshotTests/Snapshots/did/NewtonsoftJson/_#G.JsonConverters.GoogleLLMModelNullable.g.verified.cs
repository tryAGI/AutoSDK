...
{
    /// <inheritdoc />
    public sealed class GoogleLLMModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GoogleLLMModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GoogleLLMModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
