//HintName: G.Models.CreateAnimationRequestFace.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateAnimationRequestFace
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.CreateAnimationRequestFaceOverlapJsonConverter))]
        public global::G.CreateAnimationRequestFaceOverlap? Overlap { get; set; }
        ...
        public global::G.CreateAnimationRequestFaceDetection? Detection { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnimationRequestFace" /> class.
        /// </summary>
        /// <param name="size">
        /// Size of the square side
        /// </param>
        ...
        public CreateAnimationRequestFace(
            int size,
            global::System.Collections.Generic.IList<double> topLeft,
            global::G.CreateAnimationRequestFaceOverlap? overlap,
            string? faceId,
            double? detectConfidence,
            double? sharpness,
            bool? faceOccluded,
            double? faceOccludedConfidence,
            global::G.CreateAnimationRequestFaceDetection? detection)
        {
            this.Size = size;
