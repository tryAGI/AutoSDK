...
{
    /// <inheritdoc />
    public sealed class CreateRequestPresenterVideoAvatarTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateRequestPresenterVideoAvatarType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateRequestPresenterVideoAvatarTypeExtensions.ToValueString(value));
        }
    }
}
