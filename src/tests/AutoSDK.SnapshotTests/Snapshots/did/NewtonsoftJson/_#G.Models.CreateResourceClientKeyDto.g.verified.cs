//HintName: G.Models.CreateResourceClientKeyDto.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateResourceClientKeyDto
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResourceClientKeyDto" /> class.
        /// </summary>
        /// <param name="allowedDomains"></param>
        /// <param name="name"></param>
        public CreateResourceClientKeyDto(
