//HintName: G.Models.UpdateSettingsResponseLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateSettingsResponseLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSettingsResponseLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public UpdateSettingsResponseLogo(
            string url,
