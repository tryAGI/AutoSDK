//HintName: G.Models.ScriptVariant1ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class ScriptVariant1ProviderMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScriptVariant1ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public ScriptVariant1ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
