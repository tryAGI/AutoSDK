...
{
    /// <inheritdoc />
    public sealed class CreateStreamTextScriptProviderElevenLabsAccessJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateStreamTextScriptProviderElevenLabsAccess>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateStreamTextScriptProviderElevenLabsAccessExtensions.ToValueString(value));
        }
    }
}
