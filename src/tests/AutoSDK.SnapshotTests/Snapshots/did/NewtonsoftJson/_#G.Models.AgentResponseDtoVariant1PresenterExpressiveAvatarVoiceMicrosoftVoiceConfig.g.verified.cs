//HintName: G.Models.AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public AgentResponseDtoVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
