//HintName: G.Models.GetAvatarResponseDtoError.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAvatarResponseDtoError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvatarResponseDtoError" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public GetAvatarResponseDtoError(
            string kind,
            string description,
            object? details,
            string? @internal)
