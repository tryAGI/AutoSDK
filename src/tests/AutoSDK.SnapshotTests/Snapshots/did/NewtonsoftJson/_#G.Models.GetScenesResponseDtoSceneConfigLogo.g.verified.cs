//HintName: G.Models.GetScenesResponseDtoSceneConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class GetScenesResponseDtoSceneConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetScenesResponseDtoSceneConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public GetScenesResponseDtoSceneConfigLogo(
            string url,
