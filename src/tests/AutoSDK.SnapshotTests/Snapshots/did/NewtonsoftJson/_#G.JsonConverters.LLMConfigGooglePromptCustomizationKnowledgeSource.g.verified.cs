...
{
    /// <inheritdoc />
    public sealed class LLMConfigGooglePromptCustomizationKnowledgeSourceJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMConfigGooglePromptCustomizationKnowledgeSource>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LLMConfigGooglePromptCustomizationKnowledgeSourceExtensions.ToValueString(value));
        }
    }
}
