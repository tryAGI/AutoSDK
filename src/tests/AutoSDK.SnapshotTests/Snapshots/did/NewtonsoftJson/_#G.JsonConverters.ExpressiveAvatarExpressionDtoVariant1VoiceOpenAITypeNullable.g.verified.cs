...
{
    /// <inheritdoc />
    public sealed class ExpressiveAvatarExpressionDtoVariant1VoiceOpenAITypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExpressiveAvatarExpressionDtoVariant1VoiceOpenAIType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExpressiveAvatarExpressionDtoVariant1VoiceOpenAITypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
