//HintName: G.Models.PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
