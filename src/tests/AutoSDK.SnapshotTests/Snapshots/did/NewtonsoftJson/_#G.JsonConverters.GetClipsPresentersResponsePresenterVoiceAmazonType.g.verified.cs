...
{
    /// <inheritdoc />
    public sealed class GetClipsPresentersResponsePresenterVoiceAmazonTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetClipsPresentersResponsePresenterVoiceAmazonType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetClipsPresentersResponsePresenterVoiceAmazonTypeExtensions.ToValueString(value));
        }
    }
}
