//HintName: G.Models.CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig2.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
