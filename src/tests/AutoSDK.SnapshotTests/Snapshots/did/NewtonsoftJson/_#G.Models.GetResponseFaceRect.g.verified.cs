//HintName: G.Models.GetResponseFaceRect.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class GetResponseFaceRect
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResponseFaceRect" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public GetResponseFaceRect(
            double top,
            double left,
            double bottom,
            double right)
