//HintName: G.Models.CreateStreamTextScriptProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateStreamTextScriptProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStreamTextScriptProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateStreamTextScriptProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
