//HintName: G.Models.ExpressiveAgentPresenterVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAgentPresenterVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAgentPresenterVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public ExpressiveAgentPresenterVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
