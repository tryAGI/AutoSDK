//HintName: G.Models.DeletePresenterResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class DeletePresenterResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeletePresenterResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public DeletePresenterResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
