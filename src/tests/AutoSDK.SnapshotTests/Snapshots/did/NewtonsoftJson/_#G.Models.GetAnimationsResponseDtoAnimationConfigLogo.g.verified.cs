//HintName: G.Models.GetAnimationsResponseDtoAnimationConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAnimationsResponseDtoAnimationConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAnimationsResponseDtoAnimationConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public GetAnimationsResponseDtoAnimationConfigLogo(
            string url,
