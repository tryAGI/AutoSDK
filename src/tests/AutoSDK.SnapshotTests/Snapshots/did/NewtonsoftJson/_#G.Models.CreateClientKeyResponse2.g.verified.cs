//HintName: G.Models.CreateClientKeyResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClientKeyResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClientKeyResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public CreateClientKeyResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
