...
{
    /// <inheritdoc />
    public sealed class PartialClipAgentPresenterVoiceElevenLabsAccessJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PartialClipAgentPresenterVoiceElevenLabsAccess>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PartialClipAgentPresenterVoiceElevenLabsAccessExtensions.ToValueString(value));
        }
    }
}
