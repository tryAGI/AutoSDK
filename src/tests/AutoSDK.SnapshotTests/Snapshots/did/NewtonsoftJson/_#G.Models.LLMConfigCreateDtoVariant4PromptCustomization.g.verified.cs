//HintName: G.Models.LLMConfigCreateDtoVariant4PromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class LLMConfigCreateDtoVariant4PromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.LLMConfigCreateDtoVariant4PromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.LLMConfigCreateDtoVariant4PromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LLMConfigCreateDtoVariant4PromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public LLMConfigCreateDtoVariant4PromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.LLMConfigCreateDtoVariant4PromptCustomizationKnowledgeSource? knowledgeSource,
