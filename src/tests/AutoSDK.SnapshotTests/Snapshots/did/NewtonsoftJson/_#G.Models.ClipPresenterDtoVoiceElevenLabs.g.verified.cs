//HintName: G.Models.ClipPresenterDtoVoiceElevenLabs.g.cs
...
namespace G
{
    ...
    public sealed partial class ClipPresenterDtoVoiceElevenLabs
    {
        ...
        public global::G.ClipPresenterDtoVoiceElevenLabsVoiceConfig? VoiceConfig { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClipPresenterDtoVoiceElevenLabs" /> class.
        /// </summary>
        ...
        /// Example: English (United States)
        /// </param>
        public ClipPresenterDtoVoiceElevenLabs(
            global::G.ClipPresenterDtoVoiceElevenLabsType type,
            string? voiceId,
            global::G.ClipPresenterDtoVoiceElevenLabsVoiceConfig? voiceConfig,
            string? modelId,
            string? language)
        {
            this.Type = type;
