//HintName: G.Models.ListResponseConsentError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListResponseConsentError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListResponseConsentError" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public ListResponseConsentError(
            string kind,
            string description,
            object? details,
            string? @internal)
