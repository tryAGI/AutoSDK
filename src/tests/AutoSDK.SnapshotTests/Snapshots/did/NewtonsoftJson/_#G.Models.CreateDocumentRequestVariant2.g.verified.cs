//HintName: G.Models.CreateDocumentRequestVariant2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateDocumentRequestVariant2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDocumentRequestVariant2" /> class.
        /// </summary>
        ...
        /// Callback to call when the document is uploaded
        /// </param>
        public CreateDocumentRequestVariant2(
            string sourceUrl,
            string title,
            string? webhook)
        {
