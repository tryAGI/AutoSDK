...
{
    /// <inheritdoc />
    public sealed class CreateAnimationDtoFaceOverlapNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateAnimationDtoFaceOverlap?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateAnimationDtoFaceOverlapExtensions.ToValueString(value.Value));
            }
        }
    }
}
