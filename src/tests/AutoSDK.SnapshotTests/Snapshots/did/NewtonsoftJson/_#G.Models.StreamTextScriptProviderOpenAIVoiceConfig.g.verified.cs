//HintName: G.Models.StreamTextScriptProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class StreamTextScriptProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamTextScriptProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public StreamTextScriptProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
