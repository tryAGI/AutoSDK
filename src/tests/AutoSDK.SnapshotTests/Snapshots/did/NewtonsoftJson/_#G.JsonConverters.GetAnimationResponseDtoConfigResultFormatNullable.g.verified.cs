...
{
    /// <inheritdoc />
    public sealed class GetAnimationResponseDtoConfigResultFormatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAnimationResponseDtoConfigResultFormat?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetAnimationResponseDtoConfigResultFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
