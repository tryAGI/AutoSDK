...
{
    /// <inheritdoc />
    public sealed class AgentUpdateDtoLlmVariant2TemplateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentUpdateDtoLlmVariant2Template?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AgentUpdateDtoLlmVariant2TemplateExtensions.ToValueString(value.Value));
            }
        }
    }
}
