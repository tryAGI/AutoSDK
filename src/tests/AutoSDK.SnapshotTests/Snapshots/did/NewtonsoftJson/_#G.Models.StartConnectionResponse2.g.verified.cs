//HintName: G.Models.StartConnectionResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class StartConnectionResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StartConnectionResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public StartConnectionResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
