//HintName: G.Models.GetFaceDetectionResponse4.g.cs
...
namespace G
{
    ...
    public sealed partial class GetFaceDetectionResponse4
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFaceDetectionResponse4" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public GetFaceDetectionResponse4(
            string kind,
            string description,
            object? details,
            string? @internal)
