//HintName: G.Models.ExpressiveAvatarExpressionDtoVariant1VoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAvatarExpressionDtoVariant1VoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAvatarExpressionDtoVariant1VoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public ExpressiveAvatarExpressionDtoVariant1VoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
