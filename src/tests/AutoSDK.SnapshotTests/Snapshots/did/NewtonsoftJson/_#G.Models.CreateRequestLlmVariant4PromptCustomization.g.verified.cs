//HintName: G.Models.CreateRequestLlmVariant4PromptCustomization.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateRequestLlmVariant4PromptCustomization
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.CreateRequestLlmVariant4PromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.CreateRequestLlmVariant4PromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRequestLlmVariant4PromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public CreateRequestLlmVariant4PromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.CreateRequestLlmVariant4PromptCustomizationKnowledgeSource? knowledgeSource,
