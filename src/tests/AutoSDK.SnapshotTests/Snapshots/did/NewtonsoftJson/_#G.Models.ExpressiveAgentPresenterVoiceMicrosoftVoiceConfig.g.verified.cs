//HintName: G.Models.ExpressiveAgentPresenterVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAgentPresenterVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAgentPresenterVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public ExpressiveAgentPresenterVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
