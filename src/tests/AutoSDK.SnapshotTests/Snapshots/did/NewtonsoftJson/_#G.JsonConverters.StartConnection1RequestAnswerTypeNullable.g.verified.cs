...
{
    /// <inheritdoc />
    public sealed class StartConnection1RequestAnswerTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.StartConnection1RequestAnswerType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.StartConnection1RequestAnswerTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
