//HintName: G.Models.AgentPresenterExpressiveAvatarVoiceMicrosoftVoiceConfig2.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentPresenterExpressiveAvatarVoiceMicrosoftVoiceConfig2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPresenterExpressiveAvatarVoiceMicrosoftVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public AgentPresenterExpressiveAvatarVoiceMicrosoftVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
