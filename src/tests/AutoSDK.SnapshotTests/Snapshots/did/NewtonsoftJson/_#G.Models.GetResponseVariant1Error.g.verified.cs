//HintName: G.Models.GetResponseVariant1Error.g.cs
...
namespace G
{
    ...
    public sealed partial class GetResponseVariant1Error
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResponseVariant1Error" /> class.
        /// </summary>
        /// <param name="description"></param>
        /// <param name="kind"></param>
        /// <param name="details"></param>
        public GetResponseVariant1Error(
            string description,
            string kind,
            string? details)
        {
