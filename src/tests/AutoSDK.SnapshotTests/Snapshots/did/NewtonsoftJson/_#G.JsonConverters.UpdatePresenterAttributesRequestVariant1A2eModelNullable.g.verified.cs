...
{
    /// <inheritdoc />
    public sealed class UpdatePresenterAttributesRequestVariant1A2eModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdatePresenterAttributesRequestVariant1A2eModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdatePresenterAttributesRequestVariant1A2eModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
