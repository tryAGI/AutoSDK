...
{
    /// <inheritdoc />
    public sealed class TextToSpeechProvidersElevenLabsTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TextToSpeechProvidersElevenLabsType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TextToSpeechProvidersElevenLabsTypeExtensions.ToValueString(value));
        }
    }
}
