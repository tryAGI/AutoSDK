...
{
    /// <inheritdoc />
    public sealed class GetClipResponseConfigResultFormat2NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetClipResponseConfigResultFormat2?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetClipResponseConfigResultFormat2Extensions.ToValueString(value.Value));
            }
        }
    }
}
