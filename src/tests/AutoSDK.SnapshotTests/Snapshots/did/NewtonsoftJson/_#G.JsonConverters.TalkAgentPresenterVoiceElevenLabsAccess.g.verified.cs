...
{
    /// <inheritdoc />
    public sealed class TalkAgentPresenterVoiceElevenLabsAccessJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TalkAgentPresenterVoiceElevenLabsAccess>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TalkAgentPresenterVoiceElevenLabsAccessExtensions.ToValueString(value));
        }
    }
}
