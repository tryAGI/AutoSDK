//HintName: G.Models.GetFaceDetectionResponseFaceCrop.g.cs
...
namespace G
{
    ...
    public sealed partial class GetFaceDetectionResponseFaceCrop
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetFaceDetectionResponseFaceCrop" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public GetFaceDetectionResponseFaceCrop(
            double top,
            double left,
            double bottom,
            double right)
