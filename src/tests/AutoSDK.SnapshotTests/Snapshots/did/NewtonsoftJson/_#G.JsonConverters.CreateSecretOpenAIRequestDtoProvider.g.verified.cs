...
{
    /// <inheritdoc />
    public sealed class CreateSecretOpenAIRequestDtoProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateSecretOpenAIRequestDtoProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateSecretOpenAIRequestDtoProviderExtensions.ToValueString(value));
        }
    }
}
