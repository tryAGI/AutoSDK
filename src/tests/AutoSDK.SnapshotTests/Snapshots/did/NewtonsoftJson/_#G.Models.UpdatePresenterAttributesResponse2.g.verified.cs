//HintName: G.Models.UpdatePresenterAttributesResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdatePresenterAttributesResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePresenterAttributesResponse2" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public UpdatePresenterAttributesResponse2(
            string kind,
            string description,
            object? details,
            string? @internal)
