//HintName: G.Models.PartialAgentTalkPresenterVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class PartialAgentTalkPresenterVoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialAgentTalkPresenterVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public PartialAgentTalkPresenterVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
