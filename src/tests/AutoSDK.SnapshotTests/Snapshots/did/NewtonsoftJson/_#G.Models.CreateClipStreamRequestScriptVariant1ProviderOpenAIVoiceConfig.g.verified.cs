//HintName: G.Models.CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateClipStreamRequestScriptVariant1ProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
