//HintName: G.Models.UploadAnAudioResponse.g.cs
...
namespace G
{
    ...
    public sealed partial class UploadAnAudioResponse
    {
        ...
        public global::G.UploadAnAudioResponseModerationMetadata? ModerationMetadata { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadAnAudioResponse" /> class.
        /// </summary>
        /// <param name="url">
        /// The temporary URL of the audio.<br/>
        /// This URL should be provided when creating an animation via the /animations endpoint.
        ...
        /// The URL of the word level timestamps file.
        /// </param>
        public UploadAnAudioResponse(
            string url,
            string? id,
            double? duration,
            global::G.UploadAnAudioResponseModerationMetadata? moderationMetadata,
