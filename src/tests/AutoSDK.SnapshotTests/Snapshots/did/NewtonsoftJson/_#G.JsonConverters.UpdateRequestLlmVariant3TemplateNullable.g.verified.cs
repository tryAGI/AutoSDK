...
{
    /// <inheritdoc />
    public sealed class UpdateRequestLlmVariant3TemplateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateRequestLlmVariant3Template?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateRequestLlmVariant3TemplateExtensions.ToValueString(value.Value));
            }
        }
    }
}
