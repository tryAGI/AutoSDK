//HintName: G.Models.GoogleLLMPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class GoogleLLMPromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.GoogleLLMPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.GoogleLLMPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleLLMPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public GoogleLLMPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.GoogleLLMPromptCustomizationKnowledgeSource? knowledgeSource,
