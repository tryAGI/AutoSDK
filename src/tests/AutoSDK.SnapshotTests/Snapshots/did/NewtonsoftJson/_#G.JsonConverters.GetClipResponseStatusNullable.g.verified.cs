...
{
    /// <inheritdoc />
    public sealed class GetClipResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetClipResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetClipResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
