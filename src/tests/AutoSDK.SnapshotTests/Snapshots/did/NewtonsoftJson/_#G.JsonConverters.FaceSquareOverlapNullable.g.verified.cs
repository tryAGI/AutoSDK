...
{
    /// <inheritdoc />
    public sealed class FaceSquareOverlapNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FaceSquareOverlap?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FaceSquareOverlapExtensions.ToValueString(value.Value));
            }
        }
    }
}
