//HintName: G.Models.CreateResponseVariant1PresenterVideoAvatarVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateResponseVariant1PresenterVideoAvatarVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResponseVariant1PresenterVideoAvatarVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateResponseVariant1PresenterVideoAvatarVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
