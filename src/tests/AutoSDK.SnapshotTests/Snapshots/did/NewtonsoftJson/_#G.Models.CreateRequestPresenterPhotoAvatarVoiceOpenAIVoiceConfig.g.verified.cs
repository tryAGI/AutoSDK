//HintName: G.Models.CreateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
