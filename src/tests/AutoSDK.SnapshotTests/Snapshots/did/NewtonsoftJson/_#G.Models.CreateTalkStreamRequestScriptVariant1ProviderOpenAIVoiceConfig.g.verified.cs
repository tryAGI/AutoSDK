//HintName: G.Models.CreateTalkStreamRequestScriptVariant1ProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkStreamRequestScriptVariant1ProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkStreamRequestScriptVariant1ProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateTalkStreamRequestScriptVariant1ProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
