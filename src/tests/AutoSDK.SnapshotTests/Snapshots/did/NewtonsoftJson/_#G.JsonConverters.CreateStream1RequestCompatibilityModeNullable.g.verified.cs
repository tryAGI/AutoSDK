...
{
    /// <inheritdoc />
    public sealed class CreateStream1RequestCompatibilityModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateStream1RequestCompatibilityMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateStream1RequestCompatibilityModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
