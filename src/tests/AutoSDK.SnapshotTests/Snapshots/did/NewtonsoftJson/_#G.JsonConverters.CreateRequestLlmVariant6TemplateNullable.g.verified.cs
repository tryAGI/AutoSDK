...
{
    /// <inheritdoc />
    public sealed class CreateRequestLlmVariant6TemplateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateRequestLlmVariant6Template?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateRequestLlmVariant6TemplateExtensions.ToValueString(value.Value));
            }
        }
    }
}
