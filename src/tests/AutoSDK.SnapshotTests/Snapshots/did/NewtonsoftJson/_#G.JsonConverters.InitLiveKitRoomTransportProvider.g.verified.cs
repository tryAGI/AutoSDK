...
{
    /// <inheritdoc />
    public sealed class InitLiveKitRoomTransportProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InitLiveKitRoomTransportProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.InitLiveKitRoomTransportProviderExtensions.ToValueString(value));
        }
    }
}
