//HintName: G.Models.ListResourceClientKeysResponse.g.cs
...
namespace G
{
    ...
    public sealed partial class ListResourceClientKeysResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListResourceClientKeysResponse" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public ListResourceClientKeysResponse(
            string kind,
            string description,
            object? details,
            string? @internal)
