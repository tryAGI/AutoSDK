//HintName: G.Models.ExpressiveAvatarPublicDto.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAvatarPublicDto
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAvatarPublicDto" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the avatar
        /// </param>
        ...
        /// The gender of the avatar
        /// </param>
        public ExpressiveAvatarPublicDto(
            string id,
            string ownerId,
            string name,
            bool isGreenscreen,
