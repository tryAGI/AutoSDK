//HintName: G.Models.PickStreamVideoConfigExcludeKeyofStreamVideoConfigResolutionBackground.g.cs
...
namespace G
{
    ...
    public sealed partial class PickStreamVideoConfigExcludeKeyofStreamVideoConfigResolutionBackground
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PickStreamVideoConfigExcludeKeyofStreamVideoConfigResolutionBackground" /> class.
        /// </summary>
        /// <param name="color">
        /// Background color of the animated result, or false to use transparent background in-case of webm result format.<br/>
        /// Example: #47ffff
        ...
        /// Example: https://path.to.image/
        /// </param>
        public PickStreamVideoConfigExcludeKeyofStreamVideoConfigResolutionBackground(
