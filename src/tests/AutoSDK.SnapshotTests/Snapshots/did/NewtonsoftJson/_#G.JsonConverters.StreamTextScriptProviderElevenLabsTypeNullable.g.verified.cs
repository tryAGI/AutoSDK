...
{
    /// <inheritdoc />
    public sealed class StreamTextScriptProviderElevenLabsTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.StreamTextScriptProviderElevenLabsType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.StreamTextScriptProviderElevenLabsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
