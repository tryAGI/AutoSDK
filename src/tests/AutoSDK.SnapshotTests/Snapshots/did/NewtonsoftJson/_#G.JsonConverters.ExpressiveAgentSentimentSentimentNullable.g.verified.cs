...
{
    /// <inheritdoc />
    public sealed class ExpressiveAgentSentimentSentimentNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExpressiveAgentSentimentSentiment?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExpressiveAgentSentimentSentimentExtensions.ToValueString(value.Value));
            }
        }
    }
}
