...
{
    /// <inheritdoc />
    public sealed class UpdateSecretResponseTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateSecretResponseType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateSecretResponseTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
