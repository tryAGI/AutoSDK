//HintName: G.Models.GetSceneResponseDtoError.g.cs
...
namespace G
{
    ...
    public sealed partial class GetSceneResponseDtoError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSceneResponseDtoError" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public GetSceneResponseDtoError(
            string kind,
            string description,
            object? details,
            string? @internal)
