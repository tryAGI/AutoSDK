...
{
    /// <inheritdoc />
    public sealed class DIdLLMModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DIdLLMModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.DIdLLMModelExtensions.ToValueString(value));
        }
    }
}
