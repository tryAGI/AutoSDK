//HintName: G.Models.GetExpressiveAvatarsDtoAvatarVariant1.g.cs
...
namespace G
{
    ...
    public sealed partial class GetExpressiveAvatarsDtoAvatarVariant1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExpressiveAvatarsDtoAvatarVariant1" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the avatar
        /// </param>
        ...
        /// The gender of the avatar
        /// </param>
        public GetExpressiveAvatarsDtoAvatarVariant1(
            string id,
            string ownerId,
            string name,
            bool isGreenscreen,
