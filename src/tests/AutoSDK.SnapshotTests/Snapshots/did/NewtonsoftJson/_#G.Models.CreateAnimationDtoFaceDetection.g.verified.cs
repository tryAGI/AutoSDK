//HintName: G.Models.CreateAnimationDtoFaceDetection.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateAnimationDtoFaceDetection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnimationDtoFaceDetection" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public CreateAnimationDtoFaceDetection(
            double top,
            double left,
            double bottom,
            double right)
