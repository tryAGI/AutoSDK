//HintName: G.Models.TestWebhookConfigurationRequestAuth.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class TestWebhookConfigurationRequestAuth
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TestWebhookConfigurationRequestAuth" /> class.
        /// </summary>
        /// <param name="secretId"></param>
        public TestWebhookConfigurationRequestAuth(
            string secretId)
        {
