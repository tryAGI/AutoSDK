//HintName: G.Models.ExpressiveAvatarExpressionDtoVariant1VoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAvatarExpressionDtoVariant1VoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAvatarExpressionDtoVariant1VoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public ExpressiveAvatarExpressionDtoVariant1VoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
