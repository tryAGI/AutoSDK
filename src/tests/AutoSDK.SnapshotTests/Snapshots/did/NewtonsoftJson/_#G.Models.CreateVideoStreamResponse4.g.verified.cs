//HintName: G.Models.CreateVideoStreamResponse4.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateVideoStreamResponse4
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVideoStreamResponse4" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public CreateVideoStreamResponse4(
            string kind,
            string description,
            object? details,
            string? @internal)
