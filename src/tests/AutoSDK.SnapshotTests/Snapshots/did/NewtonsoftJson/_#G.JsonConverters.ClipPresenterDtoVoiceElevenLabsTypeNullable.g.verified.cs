...
{
    /// <inheritdoc />
    public sealed class ClipPresenterDtoVoiceElevenLabsTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClipPresenterDtoVoiceElevenLabsType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ClipPresenterDtoVoiceElevenLabsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
