//HintName: G.Models.AssetResponseDtoModerationError.g.cs
...
namespace G
{
    ...
    public sealed partial class AssetResponseDtoModerationError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetResponseDtoModerationError" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public AssetResponseDtoModerationError(
            string kind,
            string description,
            object? details,
            string? @internal)
