...
{
    /// <inheritdoc />
    public sealed class SecretAuthTypeBearerNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SecretAuthTypeBearer?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SecretAuthTypeBearerExtensions.ToValueString(value.Value));
            }
        }
    }
}
