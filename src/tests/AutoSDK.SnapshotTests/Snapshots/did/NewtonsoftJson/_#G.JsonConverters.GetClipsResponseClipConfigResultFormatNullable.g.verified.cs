...
{
    /// <inheritdoc />
    public sealed class GetClipsResponseClipConfigResultFormatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetClipsResponseClipConfigResultFormat?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetClipsResponseClipConfigResultFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
