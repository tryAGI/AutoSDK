...
{
    /// <inheritdoc />
    public sealed class ILogicalChatPlanNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ILogicalChatPlan?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ILogicalChatPlanExtensions.ToValueString(value.Value));
            }
        }
    }
}
