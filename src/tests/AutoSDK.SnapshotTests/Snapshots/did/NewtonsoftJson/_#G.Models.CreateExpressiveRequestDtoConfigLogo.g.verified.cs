//HintName: G.Models.CreateExpressiveRequestDtoConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateExpressiveRequestDtoConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExpressiveRequestDtoConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public CreateExpressiveRequestDtoConfigLogo(
            string url,
