...
{
    /// <inheritdoc />
    public sealed class GetTalkResponseConfigResultFormatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetTalkResponseConfigResultFormat?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetTalkResponseConfigResultFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
