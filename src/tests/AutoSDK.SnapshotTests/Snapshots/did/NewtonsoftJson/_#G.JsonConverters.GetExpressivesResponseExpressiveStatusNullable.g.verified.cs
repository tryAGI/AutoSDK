...
{
    /// <inheritdoc />
    public sealed class GetExpressivesResponseExpressiveStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetExpressivesResponseExpressiveStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetExpressivesResponseExpressiveStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
