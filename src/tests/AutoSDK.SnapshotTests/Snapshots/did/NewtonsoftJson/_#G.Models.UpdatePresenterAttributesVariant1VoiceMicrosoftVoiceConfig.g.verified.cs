//HintName: G.Models.UpdatePresenterAttributesVariant1VoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdatePresenterAttributesVariant1VoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePresenterAttributesVariant1VoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public UpdatePresenterAttributesVariant1VoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
