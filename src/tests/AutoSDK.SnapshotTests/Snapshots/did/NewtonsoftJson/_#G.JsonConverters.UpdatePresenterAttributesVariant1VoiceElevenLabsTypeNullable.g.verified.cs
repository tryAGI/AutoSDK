...
{
    /// <inheritdoc />
    public sealed class UpdatePresenterAttributesVariant1VoiceElevenLabsTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdatePresenterAttributesVariant1VoiceElevenLabsType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdatePresenterAttributesVariant1VoiceElevenLabsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
