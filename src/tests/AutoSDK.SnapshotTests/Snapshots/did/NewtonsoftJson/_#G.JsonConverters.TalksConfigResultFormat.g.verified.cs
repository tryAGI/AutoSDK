...
{
    /// <inheritdoc />
    public sealed class TalksConfigResultFormatJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TalksConfigResultFormat>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TalksConfigResultFormatExtensions.ToValueString(value));
        }
    }
}
