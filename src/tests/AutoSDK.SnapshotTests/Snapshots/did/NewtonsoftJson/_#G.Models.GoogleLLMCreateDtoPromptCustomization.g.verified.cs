//HintName: G.Models.GoogleLLMCreateDtoPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class GoogleLLMCreateDtoPromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.GoogleLLMCreateDtoPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.GoogleLLMCreateDtoPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleLLMCreateDtoPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public GoogleLLMCreateDtoPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.GoogleLLMCreateDtoPromptCustomizationKnowledgeSource? knowledgeSource,
