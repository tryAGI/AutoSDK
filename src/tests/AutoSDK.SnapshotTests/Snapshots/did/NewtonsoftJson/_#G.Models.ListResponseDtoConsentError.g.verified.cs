//HintName: G.Models.ListResponseDtoConsentError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListResponseDtoConsentError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListResponseDtoConsentError" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public ListResponseDtoConsentError(
            string kind,
            string description,
            object? details,
            string? @internal)
