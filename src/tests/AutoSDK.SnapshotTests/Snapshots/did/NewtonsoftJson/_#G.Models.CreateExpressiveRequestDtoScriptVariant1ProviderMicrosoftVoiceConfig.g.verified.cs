//HintName: G.Models.CreateExpressiveRequestDtoScriptVariant1ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateExpressiveRequestDtoScriptVariant1ProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExpressiveRequestDtoScriptVariant1ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public CreateExpressiveRequestDtoScriptVariant1ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
