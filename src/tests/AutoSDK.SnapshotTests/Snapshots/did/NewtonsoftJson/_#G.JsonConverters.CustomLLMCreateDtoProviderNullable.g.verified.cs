...
{
    /// <inheritdoc />
    public sealed class CustomLLMCreateDtoProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CustomLLMCreateDtoProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CustomLLMCreateDtoProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
