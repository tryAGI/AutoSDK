//HintName: G.Models.GetTalksResponseTalkConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class GetTalksResponseTalkConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTalksResponseTalkConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public GetTalksResponseTalkConfigLogo(
            string url,
