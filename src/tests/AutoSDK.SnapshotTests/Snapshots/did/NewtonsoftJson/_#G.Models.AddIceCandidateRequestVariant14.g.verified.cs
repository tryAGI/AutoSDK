//HintName: G.Models.AddIceCandidateRequestVariant14.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class AddIceCandidateRequestVariant14
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddIceCandidateRequestVariant14" /> class.
        /// </summary>
        ...
        /// 4566) in the SDP with which the candidate is associated.
        /// </param>
        public AddIceCandidateRequestVariant14(
            string candidate,
            string sdpMid,
