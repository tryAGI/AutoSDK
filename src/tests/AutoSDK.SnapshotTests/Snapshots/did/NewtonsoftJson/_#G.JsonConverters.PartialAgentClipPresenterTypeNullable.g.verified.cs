...
{
    /// <inheritdoc />
    public sealed class PartialAgentClipPresenterTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PartialAgentClipPresenterType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PartialAgentClipPresenterTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
