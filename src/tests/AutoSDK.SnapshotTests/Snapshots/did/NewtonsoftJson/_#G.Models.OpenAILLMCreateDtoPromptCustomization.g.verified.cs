//HintName: G.Models.OpenAILLMCreateDtoPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class OpenAILLMCreateDtoPromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.OpenAILLMCreateDtoPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.OpenAILLMCreateDtoPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenAILLMCreateDtoPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public OpenAILLMCreateDtoPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.OpenAILLMCreateDtoPromptCustomizationKnowledgeSource? knowledgeSource,
