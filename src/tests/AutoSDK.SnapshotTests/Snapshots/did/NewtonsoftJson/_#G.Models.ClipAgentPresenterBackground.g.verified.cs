//HintName: G.Models.ClipAgentPresenterBackground.g.cs
...
namespace G
{
    ...
    public sealed partial class ClipAgentPresenterBackground
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClipAgentPresenterBackground" /> class.
        /// </summary>
        /// <param name="color">
        /// Background color of the Avatar.<br/>
        /// Example: #47ffff
        ...
        /// Example: https://path.to.image/
        /// </param>
        public ClipAgentPresenterBackground(
            string? color,
            string? sourceUrl)
        {
            this.Color = color;
