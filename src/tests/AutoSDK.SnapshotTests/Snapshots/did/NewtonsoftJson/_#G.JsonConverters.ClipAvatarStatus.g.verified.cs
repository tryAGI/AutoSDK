...
{
    /// <inheritdoc />
    public sealed class ClipAvatarStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClipAvatarStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ClipAvatarStatusExtensions.ToValueString(value));
        }
    }
}
