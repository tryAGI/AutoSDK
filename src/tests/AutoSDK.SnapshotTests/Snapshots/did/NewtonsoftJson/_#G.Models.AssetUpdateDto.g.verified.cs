//HintName: G.Models.AssetUpdateDto.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AssetUpdateDto
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AssetUpdateDto" /> class.
        /// </summary>
        /// <param name="mimeType">
        /// MIME type of the asset
        /// </param>
        ...
        public AssetUpdateDto(
            global::G.AssetUpdateDtoMimeType mimeType,
            string description,
            string id,
            string? name,
