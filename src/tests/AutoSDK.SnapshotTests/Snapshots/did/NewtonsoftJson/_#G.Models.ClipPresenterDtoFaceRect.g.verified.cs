//HintName: G.Models.ClipPresenterDtoFaceRect.g.cs
...
namespace G
{
    ...
    public sealed partial class ClipPresenterDtoFaceRect
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClipPresenterDtoFaceRect" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public ClipPresenterDtoFaceRect(
            double top,
            double left,
            double bottom,
            double right)
