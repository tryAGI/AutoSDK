...
{
    /// <inheritdoc />
    public sealed class AgentLlmGoogleModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentLlmGoogleModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AgentLlmGoogleModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
