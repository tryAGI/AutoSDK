...
{
    /// <inheritdoc />
    public sealed class ProvidersMicrosoftNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProvidersMicrosoft?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProvidersMicrosoftExtensions.ToValueString(value.Value));
            }
        }
    }
}
