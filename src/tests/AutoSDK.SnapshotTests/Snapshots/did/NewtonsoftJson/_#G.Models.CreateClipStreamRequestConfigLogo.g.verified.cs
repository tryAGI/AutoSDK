//HintName: G.Models.CreateClipStreamRequestConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClipStreamRequestConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipStreamRequestConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
        ...
        /// Example: [0, 500]
        /// </param>
        public CreateClipStreamRequestConfigLogo(
            string url,
