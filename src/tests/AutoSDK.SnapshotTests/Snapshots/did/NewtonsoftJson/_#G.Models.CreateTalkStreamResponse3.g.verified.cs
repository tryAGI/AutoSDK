//HintName: G.Models.CreateTalkStreamResponse3.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkStreamResponse3
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkStreamResponse3" /> class.
        /// </summary>
        /// <param name="kind"></param>
        /// <param name="description"></param>
        /// <param name="details"></param>
        /// <param name="internal"></param>
        public CreateTalkStreamResponse3(
            string kind,
            string description,
            object? details,
            string? @internal)
