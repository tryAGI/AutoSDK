//HintName: G.Models.GetResponseVariant1LlmDIdPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class GetResponseVariant1LlmDIdPromptCustomization
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.GetResponseVariant1LlmDIdPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.GetResponseVariant1LlmDIdPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResponseVariant1LlmDIdPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public GetResponseVariant1LlmDIdPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.GetResponseVariant1LlmDIdPromptCustomizationKnowledgeSource? knowledgeSource,
