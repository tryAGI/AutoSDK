//HintName: G.Models.ExpressiveAvatarExpressionPublicDtoVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAvatarExpressionPublicDtoVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAvatarExpressionPublicDtoVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
        ...
        /// Example: +2st
        /// </param>
        public ExpressiveAvatarExpressionPublicDtoVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
