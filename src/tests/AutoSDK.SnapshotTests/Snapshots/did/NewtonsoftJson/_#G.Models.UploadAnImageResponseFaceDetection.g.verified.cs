//HintName: G.Models.UploadAnImageResponseFaceDetection.g.cs
...
namespace G
{
    ...
    public sealed partial class UploadAnImageResponseFaceDetection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadAnImageResponseFaceDetection" /> class.
        /// </summary>
        /// <param name="top"></param>
        /// <param name="left"></param>
        /// <param name="bottom"></param>
        /// <param name="right"></param>
        public UploadAnImageResponseFaceDetection(
            double top,
            double left,
            double bottom,
            double right)
