...
{
    /// <inheritdoc />
    public sealed class ClipPresenterDtoVoiceMicrosoftTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClipPresenterDtoVoiceMicrosoftType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ClipPresenterDtoVoiceMicrosoftTypeExtensions.ToValueString(value));
        }
    }
}
