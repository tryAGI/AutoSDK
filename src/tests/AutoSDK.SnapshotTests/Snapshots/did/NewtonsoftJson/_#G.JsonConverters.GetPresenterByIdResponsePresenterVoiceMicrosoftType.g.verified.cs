...
{
    /// <inheritdoc />
    public sealed class GetPresenterByIdResponsePresenterVoiceMicrosoftTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetPresenterByIdResponsePresenterVoiceMicrosoftType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetPresenterByIdResponsePresenterVoiceMicrosoftTypeExtensions.ToValueString(value));
        }
    }
}
