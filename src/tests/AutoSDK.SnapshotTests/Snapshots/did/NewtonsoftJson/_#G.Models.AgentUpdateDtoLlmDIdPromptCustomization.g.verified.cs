//HintName: G.Models.AgentUpdateDtoLlmDIdPromptCustomization.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentUpdateDtoLlmDIdPromptCustomization
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.AgentUpdateDtoLlmDIdPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.AgentUpdateDtoLlmDIdPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUpdateDtoLlmDIdPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
        ...
        /// Defines the factual knowledge the Agent uses to answer questions.
        /// </param>
        public AgentUpdateDtoLlmDIdPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.AgentUpdateDtoLlmDIdPromptCustomizationKnowledgeSource? knowledgeSource,
