//HintName: G.Models.PickExpressiveAvatarAvatarPublicAllowedAttributes.g.cs
...
namespace G
{
    ...
    public sealed partial class PickExpressiveAvatarAvatarPublicAllowedAttributes
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PickExpressiveAvatarAvatarPublicAllowedAttributes" /> class.
        /// </summary>
        /// <param name="id">
        /// The id of the avatar
        /// </param>
        ...
        /// The gender of the avatar
        /// </param>
        public PickExpressiveAvatarAvatarPublicAllowedAttributes(
            string id,
            string ownerId,
            string name,
            bool isGreenscreen,
