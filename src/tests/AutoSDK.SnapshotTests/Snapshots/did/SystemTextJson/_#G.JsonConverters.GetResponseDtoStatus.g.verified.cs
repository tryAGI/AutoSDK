...
{
    /// <inheritdoc />
    public sealed class GetResponseDtoStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetResponseDtoStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetResponseDtoStatusExtensions.ToValueString(value));
        }
    }
}
