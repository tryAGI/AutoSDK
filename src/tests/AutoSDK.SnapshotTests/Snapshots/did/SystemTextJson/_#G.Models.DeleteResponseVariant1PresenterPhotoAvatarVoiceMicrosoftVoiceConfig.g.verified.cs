//HintName: G.Models.DeleteResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public DeleteResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
