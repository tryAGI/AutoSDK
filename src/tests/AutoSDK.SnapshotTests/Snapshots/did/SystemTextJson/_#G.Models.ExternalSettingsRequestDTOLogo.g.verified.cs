//HintName: G.Models.ExternalSettingsRequestDTOLogo.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class ExternalSettingsRequestDTOLogo
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExternalSettingsRequestDTOLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public ExternalSettingsRequestDTOLogo(
            string url,
