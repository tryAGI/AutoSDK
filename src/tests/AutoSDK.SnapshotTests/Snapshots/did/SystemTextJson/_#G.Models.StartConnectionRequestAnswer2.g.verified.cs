//HintName: G.Models.StartConnectionRequestAnswer2.g.cs
...
namespace G
{
    ...
    public sealed partial class StartConnectionRequestAnswer2
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.StartConnectionRequestAnswerType2JsonConverter))]
        ...
        public StartConnectionRequestAnswer2(
            string sdp,
            global::G.StartConnectionRequestAnswerType2 type)
        {
            this.Type = type;
