//HintName: G.Models.PartialTalkAgentPresenterVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialTalkAgentPresenterVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialTalkAgentPresenterVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public PartialTalkAgentPresenterVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
