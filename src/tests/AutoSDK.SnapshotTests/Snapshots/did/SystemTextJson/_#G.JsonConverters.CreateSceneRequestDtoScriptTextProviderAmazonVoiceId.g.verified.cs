...
{
    /// <inheritdoc />
    public sealed class CreateSceneRequestDtoScriptTextProviderAmazonVoiceIdJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateSceneRequestDtoScriptTextProviderAmazonVoiceId>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateSceneRequestDtoScriptTextProviderAmazonVoiceIdExtensions.ToValueString(value));
        }
    }
}
