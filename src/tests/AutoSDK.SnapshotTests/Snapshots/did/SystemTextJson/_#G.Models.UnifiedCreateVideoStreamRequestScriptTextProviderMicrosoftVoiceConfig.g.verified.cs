//HintName: G.Models.UnifiedCreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class UnifiedCreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnifiedCreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public UnifiedCreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
