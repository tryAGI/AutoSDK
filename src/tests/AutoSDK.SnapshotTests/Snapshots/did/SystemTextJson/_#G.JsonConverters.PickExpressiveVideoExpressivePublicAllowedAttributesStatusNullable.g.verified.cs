...
{
    /// <inheritdoc />
    public sealed class PickExpressiveVideoExpressivePublicAllowedAttributesStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PickExpressiveVideoExpressivePublicAllowedAttributesStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PickExpressiveVideoExpressivePublicAllowedAttributesStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
