//HintName: G.Models.GetResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public GetResponseVariant1PresenterPhotoAvatarVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
