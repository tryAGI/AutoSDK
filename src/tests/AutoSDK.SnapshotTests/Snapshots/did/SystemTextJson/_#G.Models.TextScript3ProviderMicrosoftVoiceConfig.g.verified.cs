//HintName: G.Models.TextScript3ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class TextScript3ProviderMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextScript3ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public TextScript3ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
