...
{
    /// <inheritdoc />
    public sealed class TextScript3ProviderAmazonVoiceIdNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TextScript3ProviderAmazonVoiceId?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TextScript3ProviderAmazonVoiceIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
