//HintName: G.Models.GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
