//HintName: G.Models.GetClipsResponseClipConfigLogo2.g.cs
...
namespace G
{
    ...
    public sealed partial class GetClipsResponseClipConfigLogo2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClipsResponseClipConfigLogo2" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public GetClipsResponseClipConfigLogo2(
            string url,
