...
{
    /// <inheritdoc />
    public sealed class Create2RequestScriptTextProviderAmazonVoiceIdNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Create2RequestScriptTextProviderAmazonVoiceId?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.Create2RequestScriptTextProviderAmazonVoiceIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
