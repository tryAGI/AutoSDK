...
{
    /// <inheritdoc />
    public sealed class CreateRequestPresenterVideoAvatarTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateRequestPresenterVideoAvatarType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateRequestPresenterVideoAvatarTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
