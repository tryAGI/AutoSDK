//HintName: G.Models.DeleteResponseVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteResponseVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteResponseVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public DeleteResponseVariant1PresenterExpressiveAvatarVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
