//HintName: G.Models.CreateClipRequestScriptVariant1ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateClipRequestScriptVariant1ProviderMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestScriptVariant1ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateClipRequestScriptVariant1ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
