//HintName: G.Models.UnifiedCreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class UnifiedCreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnifiedCreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public UnifiedCreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
