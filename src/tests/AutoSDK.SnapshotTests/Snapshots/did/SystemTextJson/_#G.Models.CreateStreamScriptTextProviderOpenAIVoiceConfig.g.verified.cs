//HintName: G.Models.CreateStreamScriptTextProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateStreamScriptTextProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateStreamScriptTextProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateStreamScriptTextProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
