...
{
    /// <inheritdoc />
    public sealed class CreateSecretOpenAIRequestDtoProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateSecretOpenAIRequestDtoProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateSecretOpenAIRequestDtoProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
