//HintName: G.Models.StreamTextScriptProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class StreamTextScriptProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamTextScriptProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public StreamTextScriptProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
