...
{
    /// <inheritdoc />
    public sealed class ClipPresenterDtoStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClipPresenterDtoStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ClipPresenterDtoStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
