...
{
    /// <inheritdoc />
    public sealed class GetAvatarByIdResponseSentimentVariant1VoiceOpenAITypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAvatarByIdResponseSentimentVariant1VoiceOpenAIType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetAvatarByIdResponseSentimentVariant1VoiceOpenAITypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
