...
{
    /// <inheritdoc />
    public sealed class CreateRequestLlmVariant6TemplateJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateRequestLlmVariant6Template>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateRequestLlmVariant6TemplateExtensions.ToValueString(value));
        }
    }
}
