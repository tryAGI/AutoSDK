...
{
    /// <inheritdoc />
    public sealed class ClipPresenterDtoVoiceMicrosoftTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClipPresenterDtoVoiceMicrosoftType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ClipPresenterDtoVoiceMicrosoftTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
