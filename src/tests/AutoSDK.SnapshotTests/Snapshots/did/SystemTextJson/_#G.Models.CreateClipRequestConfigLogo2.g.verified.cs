//HintName: G.Models.CreateClipRequestConfigLogo2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClipRequestConfigLogo2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestConfigLogo2" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public CreateClipRequestConfigLogo2(
            string url,
