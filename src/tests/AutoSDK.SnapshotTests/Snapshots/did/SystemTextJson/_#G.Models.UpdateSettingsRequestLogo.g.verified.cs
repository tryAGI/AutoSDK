//HintName: G.Models.UpdateSettingsRequestLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateSettingsRequestLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSettingsRequestLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public UpdateSettingsRequestLogo(
            string url,
