//HintName: G.Models.GetClipsPresentersResponsePresenterVoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class GetClipsPresentersResponsePresenterVoiceMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetClipsPresentersResponsePresenterVoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public GetClipsPresentersResponsePresenterVoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
