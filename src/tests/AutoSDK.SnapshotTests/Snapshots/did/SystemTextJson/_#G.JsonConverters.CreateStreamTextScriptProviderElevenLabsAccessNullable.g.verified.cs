...
{
    /// <inheritdoc />
    public sealed class CreateStreamTextScriptProviderElevenLabsAccessNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateStreamTextScriptProviderElevenLabsAccess?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateStreamTextScriptProviderElevenLabsAccessExtensions.ToValueString(value.Value));
            }
        }
    }
}
