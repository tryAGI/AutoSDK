//HintName: G.Models.GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceMicrosoftVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public GetExpressiveAvatarsDtoAvatarSentimentVariant1VoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
