...
{
    /// <inheritdoc />
    public sealed class ExpressiveAgentSentimentSentimentJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ExpressiveAgentSentimentSentiment>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ExpressiveAgentSentimentSentimentExtensions.ToValueString(value));
        }
    }
}
