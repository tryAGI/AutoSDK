//HintName: G.Models.ExpressiveAvatarExpressionPublicDtoVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveAvatarExpressionPublicDtoVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveAvatarExpressionPublicDtoVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public ExpressiveAvatarExpressionPublicDtoVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
