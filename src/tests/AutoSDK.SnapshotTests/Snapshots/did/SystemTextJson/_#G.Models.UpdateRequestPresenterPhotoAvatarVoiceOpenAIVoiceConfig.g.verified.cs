//HintName: G.Models.UpdateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public UpdateRequestPresenterPhotoAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
