//HintName: G.Models.CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
