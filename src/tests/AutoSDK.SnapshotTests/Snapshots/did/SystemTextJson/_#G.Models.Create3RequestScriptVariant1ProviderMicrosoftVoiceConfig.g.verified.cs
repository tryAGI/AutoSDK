//HintName: G.Models.Create3RequestScriptVariant1ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class Create3RequestScriptVariant1ProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Create3RequestScriptVariant1ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public Create3RequestScriptVariant1ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
