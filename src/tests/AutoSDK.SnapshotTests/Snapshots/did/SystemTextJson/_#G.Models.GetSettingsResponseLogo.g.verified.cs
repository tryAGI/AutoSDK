//HintName: G.Models.GetSettingsResponseLogo.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class GetSettingsResponseLogo
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSettingsResponseLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public GetSettingsResponseLogo(
            string url,
