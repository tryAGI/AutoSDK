//HintName: G.Models.CreateClipStreamRequestConfigLogo2.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateClipStreamRequestConfigLogo2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipStreamRequestConfigLogo2" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public CreateClipStreamRequestConfigLogo2(
            string url,
