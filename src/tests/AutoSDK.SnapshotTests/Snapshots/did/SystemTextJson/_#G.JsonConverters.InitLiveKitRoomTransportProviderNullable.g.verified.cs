...
{
    /// <inheritdoc />
    public sealed class InitLiveKitRoomTransportProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InitLiveKitRoomTransportProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.InitLiveKitRoomTransportProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
