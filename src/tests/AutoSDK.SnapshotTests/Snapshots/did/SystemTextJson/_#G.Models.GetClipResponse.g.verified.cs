...
namespace G
{
    ...
    public sealed partial class GetClipResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.GetClipResponseStatusJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.GetClipResponseStatus Status { get; set; }
