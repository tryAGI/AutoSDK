    ...
    public class ExpressiveAvatarExpressionDtoJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ExpressiveAvatarExpressionDto>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ExpressiveAvatarExpressionDtoVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ExpressiveAvatarExpressionDtoVariant1> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ExpressiveAvatarExpressionDtoVariant1).Name}");
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsExpressiveAvatarExpressionDtoVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ExpressiveAvatarExpressionDtoVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ExpressiveAvatarExpressionDtoVariant1?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ExpressiveAvatarExpressionDtoVariant1).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ExpressiveAvatarExpressionDtoVariant1!, typeInfo);
            }
            else if (value.IsExpressiveAvatarExpressionDtoVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ExpressiveAvatarExpressionDtoVariant2!, typeInfo);
            }
        }
    }
}