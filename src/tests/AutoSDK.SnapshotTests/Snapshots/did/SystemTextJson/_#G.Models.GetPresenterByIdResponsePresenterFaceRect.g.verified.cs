//HintName: G.Models.GetPresenterByIdResponsePresenterFaceRect.g.cs
...
namespace G
{
    ...
    public sealed partial class GetPresenterByIdResponsePresenterFaceRect
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPresenterByIdResponsePresenterFaceRect" /> class.
        /// </summary>
...
#endif
        public GetPresenterByIdResponsePresenterFaceRect(
            double top,
            double left,
            double bottom,
            double right)
