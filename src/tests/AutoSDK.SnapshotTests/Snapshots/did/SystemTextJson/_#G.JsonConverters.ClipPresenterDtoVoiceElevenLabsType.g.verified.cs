...
{
    /// <inheritdoc />
    public sealed class ClipPresenterDtoVoiceElevenLabsTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClipPresenterDtoVoiceElevenLabsType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ClipPresenterDtoVoiceElevenLabsTypeExtensions.ToValueString(value));
        }
    }
}
