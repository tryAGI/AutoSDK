...
{
    /// <inheritdoc />
    public sealed class InitClipStreamRequestCompatibilityModeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InitClipStreamRequestCompatibilityMode>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.InitClipStreamRequestCompatibilityModeExtensions.ToValueString(value));
        }
    }
}
