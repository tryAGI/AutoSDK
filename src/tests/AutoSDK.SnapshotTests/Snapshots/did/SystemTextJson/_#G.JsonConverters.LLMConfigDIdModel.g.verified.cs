...
{
    /// <inheritdoc />
    public sealed class LLMConfigDIdModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMConfigDIdModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.LLMConfigDIdModelExtensions.ToValueString(value));
        }
    }
}
