...
{
    /// <inheritdoc />
    public sealed class UpdatePresenterAttributesVariant1VoiceElevenLabsTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdatePresenterAttributesVariant1VoiceElevenLabsType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.UpdatePresenterAttributesVariant1VoiceElevenLabsTypeExtensions.ToValueString(value));
        }
    }
}
