...
namespace G
{
    ...
    public sealed partial class DeleteChatLogsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.DeleteChatLogsResponseStatusJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.DeleteChatLogsResponseStatus Status { get; set; }
