//HintName: G.Models.UpdatePresenterAttributesRequestVariant1VoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdatePresenterAttributesRequestVariant1VoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePresenterAttributesRequestVariant1VoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public UpdatePresenterAttributesRequestVariant1VoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
