...
{
    /// <inheritdoc />
    public sealed class CreateTalkStreamRequestConfigVariant1ResultFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTalkStreamRequestConfigVariant1ResultFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateTalkStreamRequestConfigVariant1ResultFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
