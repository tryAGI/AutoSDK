//HintName: G.Models.GetTalksDtoTalkConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class GetTalksDtoTalkConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTalksDtoTalkConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public GetTalksDtoTalkConfigLogo(
            string url,
