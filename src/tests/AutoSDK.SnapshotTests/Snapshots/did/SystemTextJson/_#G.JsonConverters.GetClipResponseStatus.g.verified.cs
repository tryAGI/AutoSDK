...
{
    /// <inheritdoc />
    public sealed class GetClipResponseStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetClipResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetClipResponseStatusExtensions.ToValueString(value));
        }
    }
}
