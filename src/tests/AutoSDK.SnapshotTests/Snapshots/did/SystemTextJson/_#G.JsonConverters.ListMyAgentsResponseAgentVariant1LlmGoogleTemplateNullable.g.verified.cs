...
{
    /// <inheritdoc />
    public sealed class ListMyAgentsResponseAgentVariant1LlmGoogleTemplateNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListMyAgentsResponseAgentVariant1LlmGoogleTemplate?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ListMyAgentsResponseAgentVariant1LlmGoogleTemplateExtensions.ToValueString(value.Value));
            }
        }
    }
}
