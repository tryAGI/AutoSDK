//HintName: G.Models.CreateAnimationRequestFaceDetection.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateAnimationRequestFaceDetection
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnimationRequestFaceDetection" /> class.
        /// </summary>
...
#endif
        public CreateAnimationRequestFaceDetection(
            double top,
            double left,
            double bottom,
            double right)
