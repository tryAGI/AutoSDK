//HintName: G.Models.TextToSpeechProvidersOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class TextToSpeechProvidersOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextToSpeechProvidersOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public TextToSpeechProvidersOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
