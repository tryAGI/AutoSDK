//HintName: G.Models.CreateSceneRequestDtoScriptTextProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateSceneRequestDtoScriptTextProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSceneRequestDtoScriptTextProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateSceneRequestDtoScriptTextProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
