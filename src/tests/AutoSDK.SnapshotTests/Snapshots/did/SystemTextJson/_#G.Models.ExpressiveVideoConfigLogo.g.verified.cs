//HintName: G.Models.ExpressiveVideoConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class ExpressiveVideoConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpressiveVideoConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public ExpressiveVideoConfigLogo(
            string url,
