...
{
    /// <inheritdoc />
    public sealed class GetTranslationResponseTranscriptionVersion2NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetTranslationResponseTranscriptionVersion2?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetTranslationResponseTranscriptionVersion2Extensions.ToValueString(value.Value));
            }
        }
    }
}
