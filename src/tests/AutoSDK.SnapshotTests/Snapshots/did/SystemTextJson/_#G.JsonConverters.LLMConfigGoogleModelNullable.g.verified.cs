...
{
    /// <inheritdoc />
    public sealed class LLMConfigGoogleModelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMConfigGoogleModel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LLMConfigGoogleModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
