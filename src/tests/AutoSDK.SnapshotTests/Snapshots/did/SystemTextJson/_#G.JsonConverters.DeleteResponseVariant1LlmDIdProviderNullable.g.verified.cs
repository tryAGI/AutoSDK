...
{
    /// <inheritdoc />
    public sealed class DeleteResponseVariant1LlmDIdProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DeleteResponseVariant1LlmDIdProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.DeleteResponseVariant1LlmDIdProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
