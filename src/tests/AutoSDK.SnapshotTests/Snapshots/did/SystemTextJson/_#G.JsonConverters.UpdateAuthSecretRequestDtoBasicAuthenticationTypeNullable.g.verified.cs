...
{
    /// <inheritdoc />
    public sealed class UpdateAuthSecretRequestDtoBasicAuthenticationTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateAuthSecretRequestDtoBasicAuthenticationType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateAuthSecretRequestDtoBasicAuthenticationTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
