//HintName: G.Models.CreateSceneRequestDtoConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateSceneRequestDtoConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSceneRequestDtoConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public CreateSceneRequestDtoConfigLogo(
            string url,
