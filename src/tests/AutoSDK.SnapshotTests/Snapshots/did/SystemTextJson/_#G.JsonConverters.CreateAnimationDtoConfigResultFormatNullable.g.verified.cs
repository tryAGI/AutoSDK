...
{
    /// <inheritdoc />
    public sealed class CreateAnimationDtoConfigResultFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateAnimationDtoConfigResultFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateAnimationDtoConfigResultFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
