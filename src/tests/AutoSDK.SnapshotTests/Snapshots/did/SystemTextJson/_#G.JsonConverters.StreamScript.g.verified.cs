...
namespace G.JsonConverters
{
    ...
    public class StreamScriptJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.StreamScript>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        streamScriptVariant1 = global::System.Text.Json.JsonSerializer.Deserialize<global::G.StreamScriptVariant1>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        streamScriptVariant2 = global::System.Text.Json.JsonSerializer.Deserialize<global::G.StreamScriptVariant2>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.StreamScriptVariant1, typeof(global::G.StreamScriptVariant1), options);
            }
            else if (value.IsStreamScriptVariant2)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.StreamScriptVariant2, typeof(global::G.StreamScriptVariant2), options);
            }
        }
    }
}