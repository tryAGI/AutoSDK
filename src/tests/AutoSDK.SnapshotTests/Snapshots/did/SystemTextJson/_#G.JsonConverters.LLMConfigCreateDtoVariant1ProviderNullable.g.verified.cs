...
{
    /// <inheritdoc />
    public sealed class LLMConfigCreateDtoVariant1ProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMConfigCreateDtoVariant1Provider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LLMConfigCreateDtoVariant1ProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
