//HintName: G.Models.Create2RequestConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class Create2RequestConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Create2RequestConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public Create2RequestConfigLogo(
            string url,
