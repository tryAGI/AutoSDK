//HintName: G.Models.DIdLLMPromptCustomization.g.cs
...
namespace G
{
    ...
    public sealed partial class DIdLLMPromptCustomization
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.DIdLLMPromptCustomizationKnowledgeSourceJsonConverter))]
        public global::G.DIdLLMPromptCustomizationKnowledgeSource? KnowledgeSource { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DIdLLMPromptCustomization" /> class.
        /// </summary>
        /// <param name="role">
        /// Role the Agent assumes when responding.<br/>
        /// Example: Salesperson
...
#endif
        public DIdLLMPromptCustomization(
            string? role,
            string? personality,
            global::System.Collections.Generic.IList<string>? topicsToAvoid,
            double? maxResponseLength,
            global::G.DIdLLMPromptCustomizationKnowledgeSource? knowledgeSource,
