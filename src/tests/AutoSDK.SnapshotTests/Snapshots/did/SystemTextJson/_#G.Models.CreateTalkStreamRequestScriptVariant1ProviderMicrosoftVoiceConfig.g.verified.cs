//HintName: G.Models.CreateTalkStreamRequestScriptVariant1ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkStreamRequestScriptVariant1ProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkStreamRequestScriptVariant1ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateTalkStreamRequestScriptVariant1ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
