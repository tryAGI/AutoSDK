//HintName: G.Models.AgentPresenterExpressiveAvatarVoiceOpenAIVoiceConfig2.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentPresenterExpressiveAvatarVoiceOpenAIVoiceConfig2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPresenterExpressiveAvatarVoiceOpenAIVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public AgentPresenterExpressiveAvatarVoiceOpenAIVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
