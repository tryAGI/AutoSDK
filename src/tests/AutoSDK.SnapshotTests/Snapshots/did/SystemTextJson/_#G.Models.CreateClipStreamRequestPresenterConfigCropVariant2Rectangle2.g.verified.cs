//HintName: G.Models.CreateClipStreamRequestPresenterConfigCropVariant2Rectangle2.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateClipStreamRequestPresenterConfigCropVariant2Rectangle2
    {
        /// <summary>
        /// Bottom position.<br/>
        /// Example: 1
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipStreamRequestPresenterConfigCropVariant2Rectangle2" /> class.
        /// </summary>
        /// <param name="bottom">
        /// Bottom position.<br/>
        /// Example: 1
...
#endif
        public CreateClipStreamRequestPresenterConfigCropVariant2Rectangle2(
            double bottom,
            double right,
            double left,
            double top)
