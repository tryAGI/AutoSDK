//HintName: G.Models.PartialTalkAgentPresenterVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialTalkAgentPresenterVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialTalkAgentPresenterVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public PartialTalkAgentPresenterVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
