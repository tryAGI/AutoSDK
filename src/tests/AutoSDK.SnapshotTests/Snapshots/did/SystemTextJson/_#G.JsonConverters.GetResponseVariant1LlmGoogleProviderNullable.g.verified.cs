...
{
    /// <inheritdoc />
    public sealed class GetResponseVariant1LlmGoogleProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetResponseVariant1LlmGoogleProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetResponseVariant1LlmGoogleProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
