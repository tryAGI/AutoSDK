//HintName: G.Models.InitTalkStreamRequestFaceDetection.g.cs
...
namespace G
{
    ...
    public sealed partial class InitTalkStreamRequestFaceDetection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InitTalkStreamRequestFaceDetection" /> class.
        /// </summary>
...
#endif
        public InitTalkStreamRequestFaceDetection(
            double top,
            double left,
            double bottom,
            double right)
