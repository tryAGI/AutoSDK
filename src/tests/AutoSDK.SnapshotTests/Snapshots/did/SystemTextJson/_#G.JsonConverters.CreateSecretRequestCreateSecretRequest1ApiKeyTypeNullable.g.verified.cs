...
{
    /// <inheritdoc />
    public sealed class CreateSecretRequestCreateSecretRequest1ApiKeyTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateSecretRequestCreateSecretRequest1ApiKeyType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateSecretRequestCreateSecretRequest1ApiKeyTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
