//HintName: G.Models.AgentUpdateDtoPresenterVideoAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class AgentUpdateDtoPresenterVideoAvatarVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentUpdateDtoPresenterVideoAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public AgentUpdateDtoPresenterVideoAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
