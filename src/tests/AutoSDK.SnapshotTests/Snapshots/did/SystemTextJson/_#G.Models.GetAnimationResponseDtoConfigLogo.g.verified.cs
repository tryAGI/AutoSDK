//HintName: G.Models.GetAnimationResponseDtoConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAnimationResponseDtoConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAnimationResponseDtoConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public GetAnimationResponseDtoConfigLogo(
            string url,
