//HintName: G.Models.TextScriptProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class TextScriptProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextScriptProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public TextScriptProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
