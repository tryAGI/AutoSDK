//HintName: G.Models.CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
