...
{
    /// <inheritdoc />
    public sealed class ProvidersMicrosoftJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ProvidersMicrosoft>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ProvidersMicrosoftExtensions.ToValueString(value));
        }
    }
}
