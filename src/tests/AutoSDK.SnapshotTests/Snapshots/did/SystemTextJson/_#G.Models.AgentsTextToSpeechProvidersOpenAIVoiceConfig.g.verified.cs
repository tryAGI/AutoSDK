//HintName: G.Models.AgentsTextToSpeechProvidersOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentsTextToSpeechProvidersOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentsTextToSpeechProvidersOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public AgentsTextToSpeechProvidersOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
