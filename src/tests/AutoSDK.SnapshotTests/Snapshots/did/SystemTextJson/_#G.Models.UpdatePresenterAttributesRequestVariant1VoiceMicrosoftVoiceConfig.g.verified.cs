//HintName: G.Models.UpdatePresenterAttributesRequestVariant1VoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdatePresenterAttributesRequestVariant1VoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePresenterAttributesRequestVariant1VoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public UpdatePresenterAttributesRequestVariant1VoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
