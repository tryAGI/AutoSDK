...
{
    /// <inheritdoc />
    public sealed class InternalCallConfigInferenceModeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InternalCallConfigInferenceMode?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.InternalCallConfigInferenceModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
