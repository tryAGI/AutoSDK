//HintName: G.Models.CreateClipRequestPresenterConfigCropVariant2Rectangle.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateClipRequestPresenterConfigCropVariant2Rectangle
    {
        /// <summary>
        /// Bottom position.<br/>
        /// Example: 1
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestPresenterConfigCropVariant2Rectangle" /> class.
        /// </summary>
        /// <param name="bottom">
        /// Bottom position.<br/>
        /// Example: 1
...
#endif
        public CreateClipRequestPresenterConfigCropVariant2Rectangle(
            double bottom,
            double right,
            double left,
            double top)
