...
{
    /// <inheritdoc />
    public sealed class PartialAgentClipPresenterTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PartialAgentClipPresenterType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PartialAgentClipPresenterTypeExtensions.ToValueString(value));
        }
    }
}
