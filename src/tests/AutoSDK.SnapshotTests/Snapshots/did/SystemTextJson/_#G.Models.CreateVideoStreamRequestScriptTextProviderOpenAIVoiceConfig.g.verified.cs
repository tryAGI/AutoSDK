//HintName: G.Models.CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
