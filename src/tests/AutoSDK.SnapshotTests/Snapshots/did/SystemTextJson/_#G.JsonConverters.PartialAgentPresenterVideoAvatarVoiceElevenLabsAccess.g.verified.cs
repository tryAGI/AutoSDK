...
{
    /// <inheritdoc />
    public sealed class PartialAgentPresenterVideoAvatarVoiceElevenLabsAccessJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PartialAgentPresenterVideoAvatarVoiceElevenLabsAccess>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PartialAgentPresenterVideoAvatarVoiceElevenLabsAccessExtensions.ToValueString(value));
        }
    }
}
