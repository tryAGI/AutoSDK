//HintName: G.Models.PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public PickExpressiveAvatarExpressionExpressionPublicAllowedAttributesVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
