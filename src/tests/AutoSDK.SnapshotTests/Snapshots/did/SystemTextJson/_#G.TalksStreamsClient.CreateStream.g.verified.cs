//HintName: G.TalksStreamsClient.CreateStream.g.cs
...
namespace G
{
    public partial class TalksStreamsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateStreamSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateStreamSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateStreamSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CreateStreamSecurityRequirement0,
                s_CreateStreamSecurityRequirement1,
            };
        ...
        partial void ProcessCreateStreamResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CreateStreamResponse3> CreateStreamAsync(
        ...
        {
            var __response = await CreateStreamAsResponseAsync(
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CreateStreamResponse3>> CreateStreamAsResponseAsync(
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::G.CreateStreamResponse4? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::G.CreateStreamResponse4.FromJson(__content_401, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.CreateStreamResponse4>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateStreamResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CreateStreamResponse3.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CreateStreamResponse3>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CreateStreamResponse3.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
