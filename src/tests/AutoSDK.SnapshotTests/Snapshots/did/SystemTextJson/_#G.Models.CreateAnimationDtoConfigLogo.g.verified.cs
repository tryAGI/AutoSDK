//HintName: G.Models.CreateAnimationDtoConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateAnimationDtoConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAnimationDtoConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public CreateAnimationDtoConfigLogo(
            string url,
