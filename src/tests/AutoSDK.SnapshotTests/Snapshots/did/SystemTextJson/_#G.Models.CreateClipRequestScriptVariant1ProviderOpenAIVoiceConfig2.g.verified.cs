//HintName: G.Models.CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateClipRequestScriptVariant1ProviderOpenAIVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
