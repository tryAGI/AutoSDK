...
{
    /// <inheritdoc />
    public sealed class UpdateBasicAuthSecretRequestDtoTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateBasicAuthSecretRequestDtoType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateBasicAuthSecretRequestDtoTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
