//HintName: G.Models.CreateRequestPresenterExpressiveAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateRequestPresenterExpressiveAvatarVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateRequestPresenterExpressiveAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateRequestPresenterExpressiveAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
