...
{
    /// <inheritdoc />
    public sealed class GetPresenterByIdResponsePresenterVoiceMicrosoftTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetPresenterByIdResponsePresenterVoiceMicrosoftType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetPresenterByIdResponsePresenterVoiceMicrosoftTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
