...
namespace G.JsonConverters
{
    ...
    public class AgentsTextToSpeechProvidersJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsTextToSpeechProviders>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("voice_config.pitch")) __score2++;
            if (__jsonProps.Contains("voice_config.rate")) __score2++;
            if (__jsonProps.Contains("voice_config.style")) __score2++;
