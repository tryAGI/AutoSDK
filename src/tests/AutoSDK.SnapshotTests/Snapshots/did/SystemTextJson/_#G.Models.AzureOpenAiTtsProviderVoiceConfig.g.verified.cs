//HintName: G.Models.AzureOpenAiTtsProviderVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class AzureOpenAiTtsProviderVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureOpenAiTtsProviderVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public AzureOpenAiTtsProviderVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
