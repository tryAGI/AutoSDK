//HintName: G.Models.PartialExpressiveAgentPresenterVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialExpressiveAgentPresenterVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialExpressiveAgentPresenterVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public PartialExpressiveAgentPresenterVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
