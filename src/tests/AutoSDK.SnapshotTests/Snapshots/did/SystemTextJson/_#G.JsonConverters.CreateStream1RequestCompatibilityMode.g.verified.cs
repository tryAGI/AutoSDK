...
{
    /// <inheritdoc />
    public sealed class CreateStream1RequestCompatibilityModeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateStream1RequestCompatibilityMode>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateStream1RequestCompatibilityModeExtensions.ToValueString(value));
        }
    }
}
