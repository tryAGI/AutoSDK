...
{
    /// <inheritdoc />
    public sealed class GetGroupResponseTranslationStatus2NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetGroupResponseTranslationStatus2?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetGroupResponseTranslationStatus2Extensions.ToValueString(value.Value));
            }
        }
    }
}
