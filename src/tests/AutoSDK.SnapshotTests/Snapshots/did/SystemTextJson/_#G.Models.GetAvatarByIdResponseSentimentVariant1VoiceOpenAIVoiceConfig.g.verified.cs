//HintName: G.Models.GetAvatarByIdResponseSentimentVariant1VoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAvatarByIdResponseSentimentVariant1VoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvatarByIdResponseSentimentVariant1VoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public GetAvatarByIdResponseSentimentVariant1VoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
