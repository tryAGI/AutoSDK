//HintName: G.Models.ClipPresenterDtoVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class ClipPresenterDtoVoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClipPresenterDtoVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public ClipPresenterDtoVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
