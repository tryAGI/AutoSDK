//HintName: G.Models.AgentPresenterVideoAvatarVoiceMicrosoftVoiceConfig2.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentPresenterVideoAvatarVoiceMicrosoftVoiceConfig2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentPresenterVideoAvatarVoiceMicrosoftVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public AgentPresenterVideoAvatarVoiceMicrosoftVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
