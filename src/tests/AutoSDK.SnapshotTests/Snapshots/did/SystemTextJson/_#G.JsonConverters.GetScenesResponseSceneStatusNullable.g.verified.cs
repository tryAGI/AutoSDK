...
{
    /// <inheritdoc />
    public sealed class GetScenesResponseSceneStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetScenesResponseSceneStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetScenesResponseSceneStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
