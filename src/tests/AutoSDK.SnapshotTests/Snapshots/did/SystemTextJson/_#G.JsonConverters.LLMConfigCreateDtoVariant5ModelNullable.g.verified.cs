...
{
    /// <inheritdoc />
    public sealed class LLMConfigCreateDtoVariant5ModelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMConfigCreateDtoVariant5Model?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LLMConfigCreateDtoVariant5ModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
