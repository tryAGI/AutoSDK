...
{
    /// <inheritdoc />
    public sealed class TextToSpeechProvidersElevenLabsTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TextToSpeechProvidersElevenLabsType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TextToSpeechProvidersElevenLabsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
