//HintName: G.Models.UpdateSecretOpenAIRequestDto.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateSecretOpenAIRequestDto
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.UpdateSecretOpenAIRequestDtoProviderJsonConverter))]
        public global::G.UpdateSecretOpenAIRequestDtoProvider? Provider { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateSecretOpenAIRequestDto" /> class.
        /// </summary>
        /// <param name="apiKey">
        /// The API key for OpenAI/Azure OpenAI authentication.<br/>
        /// Example: sk-1234567890abcdef
...
#endif
        public UpdateSecretOpenAIRequestDto(
            string? apiKey,
            string? model,
            string? endpoint,
            bool? isStreaming,
            double? maxMessages,
            global::G.UpdateSecretOpenAIRequestDtoProvider? provider)
        {
            this.ApiKey = apiKey;
            this.Model = model;
