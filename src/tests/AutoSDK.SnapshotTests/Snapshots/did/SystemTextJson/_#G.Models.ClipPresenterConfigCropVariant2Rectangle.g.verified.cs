//HintName: G.Models.ClipPresenterConfigCropVariant2Rectangle.g.cs
...
namespace G
{
    ...
    public sealed partial class ClipPresenterConfigCropVariant2Rectangle
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClipPresenterConfigCropVariant2Rectangle" /> class.
        /// </summary>
        /// <param name="bottom">
        /// Bottom position.<br/>
        /// Example: 1
...
#endif
        public ClipPresenterConfigCropVariant2Rectangle(
            double bottom,
            double right,
            double left,
            double top)
