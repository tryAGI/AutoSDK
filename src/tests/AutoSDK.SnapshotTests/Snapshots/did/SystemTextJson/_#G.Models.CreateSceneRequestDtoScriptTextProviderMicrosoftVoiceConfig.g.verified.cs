//HintName: G.Models.CreateSceneRequestDtoScriptTextProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateSceneRequestDtoScriptTextProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSceneRequestDtoScriptTextProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateSceneRequestDtoScriptTextProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
