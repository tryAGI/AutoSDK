//HintName: G.Models.CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig2" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateVideoStreamRequestScriptTextProviderOpenAIVoiceConfig2(
            string? style,
            string? rate,
            string? pitch)
        {
