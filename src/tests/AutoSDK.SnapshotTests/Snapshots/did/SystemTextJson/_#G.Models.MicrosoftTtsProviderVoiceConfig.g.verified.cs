//HintName: G.Models.MicrosoftTtsProviderVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class MicrosoftTtsProviderVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MicrosoftTtsProviderVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public MicrosoftTtsProviderVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
