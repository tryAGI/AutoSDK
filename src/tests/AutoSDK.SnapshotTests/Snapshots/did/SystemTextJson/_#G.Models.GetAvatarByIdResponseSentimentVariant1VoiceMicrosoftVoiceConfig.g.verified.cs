//HintName: G.Models.GetAvatarByIdResponseSentimentVariant1VoiceMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAvatarByIdResponseSentimentVariant1VoiceMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvatarByIdResponseSentimentVariant1VoiceMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public GetAvatarByIdResponseSentimentVariant1VoiceMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
