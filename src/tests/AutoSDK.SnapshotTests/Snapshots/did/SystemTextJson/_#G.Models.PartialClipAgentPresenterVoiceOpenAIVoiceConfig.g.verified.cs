//HintName: G.Models.PartialClipAgentPresenterVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialClipAgentPresenterVoiceOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialClipAgentPresenterVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public PartialClipAgentPresenterVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
