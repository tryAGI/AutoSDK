...
{
    /// <inheritdoc />
    public sealed class FaceSquareOverlapJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FaceSquareOverlap>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FaceSquareOverlapExtensions.ToValueString(value));
        }
    }
}
