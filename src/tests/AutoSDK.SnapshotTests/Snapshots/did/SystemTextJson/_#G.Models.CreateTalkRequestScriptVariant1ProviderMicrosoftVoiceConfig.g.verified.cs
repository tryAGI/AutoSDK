//HintName: G.Models.CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateTalkRequestScriptVariant1ProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
