//HintName: G.Models.CreateResponseVariant1PresenterPhotoAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class CreateResponseVariant1PresenterPhotoAvatarVoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResponseVariant1PresenterPhotoAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateResponseVariant1PresenterPhotoAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
