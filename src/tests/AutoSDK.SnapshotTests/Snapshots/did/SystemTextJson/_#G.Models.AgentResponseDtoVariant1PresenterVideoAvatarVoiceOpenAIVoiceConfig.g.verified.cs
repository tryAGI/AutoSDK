//HintName: G.Models.AgentResponseDtoVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class AgentResponseDtoVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AgentResponseDtoVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public AgentResponseDtoVariant1PresenterVideoAvatarVoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
