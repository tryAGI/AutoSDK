...
{
    /// <inheritdoc />
    public sealed class OpenAILLMProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OpenAILLMProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.OpenAILLMProviderExtensions.ToValueString(value));
        }
    }
}
