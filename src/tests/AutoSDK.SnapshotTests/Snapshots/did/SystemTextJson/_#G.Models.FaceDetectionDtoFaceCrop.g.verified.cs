//HintName: G.Models.FaceDetectionDtoFaceCrop.g.cs
...
namespace G
{
    ...
    public sealed partial class FaceDetectionDtoFaceCrop
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FaceDetectionDtoFaceCrop" /> class.
        /// </summary>
...
#endif
        public FaceDetectionDtoFaceCrop(
            double top,
            double left,
            double bottom,
            double right)
