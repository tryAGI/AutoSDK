...
{
    /// <inheritdoc />
    public sealed class PartialAgentClipPresenterVoiceElevenLabsAccessJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PartialAgentClipPresenterVoiceElevenLabsAccess>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PartialAgentClipPresenterVoiceElevenLabsAccessExtensions.ToValueString(value));
        }
    }
}
