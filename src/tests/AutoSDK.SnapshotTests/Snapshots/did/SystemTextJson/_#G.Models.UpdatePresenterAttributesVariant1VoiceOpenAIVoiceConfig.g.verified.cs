//HintName: G.Models.UpdatePresenterAttributesVariant1VoiceOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class UpdatePresenterAttributesVariant1VoiceOpenAIVoiceConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdatePresenterAttributesVariant1VoiceOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public UpdatePresenterAttributesVariant1VoiceOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
