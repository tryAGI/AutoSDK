//HintName: G.Models.GetAvatarResponseDtoFaceRect.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAvatarResponseDtoFaceRect
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAvatarResponseDtoFaceRect" /> class.
        /// </summary>
...
#endif
        public GetAvatarResponseDtoFaceRect(
            double top,
            double left,
            double bottom,
            double right)
