...
{
    /// <inheritdoc />
    public sealed class AgentUpdateDtoLlmGoogleModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentUpdateDtoLlmGoogleModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AgentUpdateDtoLlmGoogleModelExtensions.ToValueString(value));
        }
    }
}
