//HintName: G.Models.CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public CreateVideoStreamRequestScriptTextProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
