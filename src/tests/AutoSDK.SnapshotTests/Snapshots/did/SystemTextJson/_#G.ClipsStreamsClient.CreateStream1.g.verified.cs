...
namespace G
{
    public partial class ClipsStreamsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateStream1SecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateStream1SecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateStream1SecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CreateStream1SecurityRequirement0,
                s_CreateStream1SecurityRequirement1,
            };
        ...
        {
            var __response = await CreateStream1AsResponseAsync(
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CreateStream1Response>> CreateStream1AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateStream1SecurityRequirements,
                operationName: "CreateStream1Async");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateStream1Async",
                                pathTemplate: "\"/clips/streams\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::G.ApiException<global::G.CreateStream1Response2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::G.ApiException<global::G.CreateStream1Response3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CreateStream1Response.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CreateStream1Response>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CreateStream1Response.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
