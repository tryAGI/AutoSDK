...
{
    /// <inheritdoc />
    public sealed class OutcomeTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OutcomeType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.OutcomeTypeExtensions.ToValueString(value));
        }
    }
}
