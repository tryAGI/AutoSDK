//HintName: G.Models.TextToSpeechProvidersMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class TextToSpeechProvidersMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextToSpeechProvidersMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public TextToSpeechProvidersMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
