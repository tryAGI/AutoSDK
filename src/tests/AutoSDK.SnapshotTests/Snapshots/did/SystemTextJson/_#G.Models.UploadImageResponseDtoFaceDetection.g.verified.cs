//HintName: G.Models.UploadImageResponseDtoFaceDetection.g.cs
...
namespace G
{
    ...
    public sealed partial class UploadImageResponseDtoFaceDetection
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadImageResponseDtoFaceDetection" /> class.
        /// </summary>
...
#endif
        public UploadImageResponseDtoFaceDetection(
            double top,
            double left,
            double bottom,
            double right)
