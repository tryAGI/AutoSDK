...
{
    /// <inheritdoc />
    public sealed class SecretAuthTypeBearerJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SecretAuthTypeBearer>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.SecretAuthTypeBearerExtensions.ToValueString(value));
        }
    }
}
