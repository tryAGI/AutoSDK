...
{
    /// <inheritdoc />
    public sealed class GetPresenterByIdResponsePresenterVoiceElevenLabsTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetPresenterByIdResponsePresenterVoiceElevenLabsType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetPresenterByIdResponsePresenterVoiceElevenLabsTypeExtensions.ToValueString(value));
        }
    }
}
