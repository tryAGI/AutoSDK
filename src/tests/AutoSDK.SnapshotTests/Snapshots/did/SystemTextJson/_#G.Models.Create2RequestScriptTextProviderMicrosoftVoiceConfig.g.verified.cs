//HintName: G.Models.Create2RequestScriptTextProviderMicrosoftVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class Create2RequestScriptTextProviderMicrosoftVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Create2RequestScriptTextProviderMicrosoftVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public Create2RequestScriptTextProviderMicrosoftVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
