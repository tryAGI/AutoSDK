//HintName: G.Models.GetChatLogsResponse.g.cs
...
namespace G
{
    ...
    public sealed partial class GetChatLogsResponse
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.GetChatLogsResponseStatusJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.GetChatLogsResponseStatus Status { get; set; }
        ...
        public global::G.GetChatLogsResponseResult? Result { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetChatLogsResponse" /> class.
        /// </summary>
        /// <param name="agentId">
        /// The id of the agent that the export will run for
        /// </param>
...
#endif
        public GetChatLogsResponse(
            string agentId,
            string createdBy,
            string createdAt,
            global::G.GetChatLogsResponseStatus status,
            string exportId,
            string ownerId,
            string modified,
            string? from,
            ...
            string? completedAt,
            global::G.GetChatLogsResponseResult? result,
            string? error,
