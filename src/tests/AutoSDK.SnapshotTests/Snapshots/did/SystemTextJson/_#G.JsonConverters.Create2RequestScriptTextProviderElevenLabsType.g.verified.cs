...
{
    /// <inheritdoc />
    public sealed class Create2RequestScriptTextProviderElevenLabsTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Create2RequestScriptTextProviderElevenLabsType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.Create2RequestScriptTextProviderElevenLabsTypeExtensions.ToValueString(value));
        }
    }
}
