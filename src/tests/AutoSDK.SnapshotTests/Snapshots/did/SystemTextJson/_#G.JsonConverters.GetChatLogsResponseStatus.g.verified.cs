...
{
    /// <inheritdoc />
    public sealed class GetChatLogsResponseStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetChatLogsResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetChatLogsResponseStatusExtensions.ToValueString(value));
        }
    }
}
