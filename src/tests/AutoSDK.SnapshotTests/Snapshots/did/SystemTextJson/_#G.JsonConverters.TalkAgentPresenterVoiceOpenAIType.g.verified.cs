...
{
    /// <inheritdoc />
    public sealed class TalkAgentPresenterVoiceOpenAITypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TalkAgentPresenterVoiceOpenAIType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TalkAgentPresenterVoiceOpenAITypeExtensions.ToValueString(value));
        }
    }
}
