...
{
    /// <inheritdoc />
    public sealed class ClipAvatarStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClipAvatarStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ClipAvatarStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
