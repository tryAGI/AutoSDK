...
{
    /// <inheritdoc />
    public sealed class LLMConfigDIdProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMConfigDIdProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.LLMConfigDIdProviderExtensions.ToValueString(value));
        }
    }
}
