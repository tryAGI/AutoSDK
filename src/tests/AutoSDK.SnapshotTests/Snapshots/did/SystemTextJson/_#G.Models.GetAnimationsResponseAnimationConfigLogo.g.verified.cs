//HintName: G.Models.GetAnimationsResponseAnimationConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAnimationsResponseAnimationConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAnimationsResponseAnimationConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public GetAnimationsResponseAnimationConfigLogo(
            string url,
