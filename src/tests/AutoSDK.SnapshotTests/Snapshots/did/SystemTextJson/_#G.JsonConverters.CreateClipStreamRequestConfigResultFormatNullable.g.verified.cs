...
{
    /// <inheritdoc />
    public sealed class CreateClipStreamRequestConfigResultFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateClipStreamRequestConfigResultFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateClipStreamRequestConfigResultFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
