    ...
    public partial class ClipsStreamsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                throw new global::G.ApiException<global::G.CreateClipStreamResponse2>(
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                throw new global::G.ApiException<global::G.CreateClipStreamResponse3>(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.CreateClipStreamResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.CreateClipStreamResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
