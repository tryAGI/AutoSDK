//HintName: G.Models.CreateTalkRequestConfigLogo.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkRequestConfigLogo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkRequestConfigLogo" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public CreateTalkRequestConfigLogo(
            string url,
