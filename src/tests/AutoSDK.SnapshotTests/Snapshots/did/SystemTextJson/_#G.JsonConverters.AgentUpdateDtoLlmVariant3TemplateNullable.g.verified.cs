...
{
    /// <inheritdoc />
    public sealed class AgentUpdateDtoLlmVariant3TemplateNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentUpdateDtoLlmVariant3Template?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentUpdateDtoLlmVariant3TemplateExtensions.ToValueString(value.Value));
            }
        }
    }
}
