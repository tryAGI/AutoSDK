//HintName: G.Models.StreamScriptVariant1ProviderOpenAIVoiceConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class StreamScriptVariant1ProviderOpenAIVoiceConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StreamScriptVariant1ProviderOpenAIVoiceConfig" /> class.
        /// </summary>
        /// <param name="style">
        /// The style of the voice.<br/>
        /// Available styles change between voices.
...
#endif
        public StreamScriptVariant1ProviderOpenAIVoiceConfig(
            string? style,
            string? rate,
            string? pitch)
        {
