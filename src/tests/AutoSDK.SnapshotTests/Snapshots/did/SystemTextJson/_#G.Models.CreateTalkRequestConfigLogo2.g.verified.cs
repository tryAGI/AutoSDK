//HintName: G.Models.CreateTalkRequestConfigLogo2.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTalkRequestConfigLogo2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTalkRequestConfigLogo2" /> class.
        /// </summary>
        /// <param name="url">
        /// https url to an ARGB jpg/png image, a default logo is used otherwise
        /// </param>
...
#endif
        public CreateTalkRequestConfigLogo2(
            string url,
