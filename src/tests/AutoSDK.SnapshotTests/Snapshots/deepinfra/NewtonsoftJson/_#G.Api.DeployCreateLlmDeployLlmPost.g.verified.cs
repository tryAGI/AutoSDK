            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 402)
            {
                ...
                else
                {
                    ...
                    __value_402 = await global::G.DeepError.FromJsonStreamAsync(__contentStream_402, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                else
                {
                    ...
                    __value_422 = await global::G.DeepError.FromJsonStreamAsync(__contentStream_422, JsonSerializerOptions).ConfigureAwait(false);
                }
