...
namespace G
{
    public partial class Api
    {
        ...
        {
            var __response = await InferenceModelV1InferenceModelNamePostAsResponseAsync(
                modelName: modelName,
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> InferenceModelV1InferenceModelNamePostAsResponseAsync(
            string modelName,
            string? version = default,
            string? xDeepinfraSource = default,
            string? userAgent = default,
