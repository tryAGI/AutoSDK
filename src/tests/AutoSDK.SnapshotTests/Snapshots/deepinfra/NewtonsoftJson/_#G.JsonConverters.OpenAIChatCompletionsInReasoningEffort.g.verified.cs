...
{
    /// <inheritdoc />
    public sealed class OpenAIChatCompletionsInReasoningEffortJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAIChatCompletionsInReasoningEffort>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OpenAIChatCompletionsInReasoningEffortExtensions.ToValueString(value));
        }
    }
}
