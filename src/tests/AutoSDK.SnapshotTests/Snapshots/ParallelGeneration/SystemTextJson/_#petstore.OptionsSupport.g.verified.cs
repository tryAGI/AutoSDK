//HintName: petstore.OptionsSupport.g.cs
...
namespace petstore
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::petstore.AutoSDKRetryOptions Retry { get; set; } = new global::petstore.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::petstore.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::petstore.IAutoSDKHook>();
        ...
        public global::petstore.AutoSDKClientOptions AddHook(
            global::petstore.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::petstore.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::petstore.AutoSDKClientOptions UseAuthorizationProvider(
            global::petstore.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::petstore.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::petstore.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::petstore.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::petstore.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::petstore.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::petstore.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::petstore.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::petstore.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::petstore.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::petstore.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::petstore.AutoSDKRetryOptions? Retry { get; set; }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::petstore.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::petstore.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::petstore.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::petstore.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::petstore.AutoSDKClientOptions clientOptions,
            global::petstore.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::petstore.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::petstore.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::petstore.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::petstore.AutoSDKClientOptions clientOptions,
            global::System.Func<global::petstore.IAutoSDKHook, global::petstore.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::petstore.AutoSDKHookContext context)
        {
