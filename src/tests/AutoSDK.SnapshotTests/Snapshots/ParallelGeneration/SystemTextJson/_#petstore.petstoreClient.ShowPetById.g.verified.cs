//HintName: petstore.petstoreClient.ShowPetById.g.cs
...
namespace petstore
{
    public partial class petstoreClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::petstore.Pet> ShowPetByIdAsync(
            string petId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::petstore.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::petstore.AutoSDKHttpResponse<global::petstore.Pet>> ShowPetByIdAsResponseAsync(
            string petId,
            global::petstore.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                cancellationToken: __effectiveCancellationToken).ConfigureAwait(false);
                    ...
                    {
                        var __retryDelay = global::petstore.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                            response: null,
                            attempt: __attempt);
                ...
                else
                {
                    await global::petstore.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                throw global::G.ApiException<global::petstore.Error>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::petstore.Pet.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::petstore.AutoSDKHttpResponse<global::petstore.Pet>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::petstore.Pet.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
