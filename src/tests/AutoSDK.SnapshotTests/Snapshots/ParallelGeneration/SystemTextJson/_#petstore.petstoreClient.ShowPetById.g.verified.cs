            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (!__response.IsSuccessStatusCode)
            {
                ...
                else
                {
                    ...
                    __value_default = await global::petstore.Error.FromJsonStreamAsync(__contentStream_default, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::petstore.Pet.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::petstore.Pet.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
