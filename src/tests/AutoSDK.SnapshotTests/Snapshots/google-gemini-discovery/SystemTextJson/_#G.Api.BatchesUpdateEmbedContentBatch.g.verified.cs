...
namespace G
{
    public partial class Api
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EmbedContentBatch>> BatchesUpdateEmbedContentBatchAsResponseAsync(
            string batchesId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "BatchesUpdateEmbedContentBatch",
                                methodName: "BatchesUpdateEmbedContentBatchAsync",
                                pathTemplate: "$\"/batches/{batchesId}:updateEmbedContentBatch\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.EmbedContentBatch.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.EmbedContentBatch>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.EmbedContentBatch.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
