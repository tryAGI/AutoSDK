...
{
    /// <inheritdoc />
    public sealed class ModelStatusModelStageNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModelStatusModelStage?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ModelStatusModelStageExtensions.ToValueString(value.Value));
            }
        }
    }
}
