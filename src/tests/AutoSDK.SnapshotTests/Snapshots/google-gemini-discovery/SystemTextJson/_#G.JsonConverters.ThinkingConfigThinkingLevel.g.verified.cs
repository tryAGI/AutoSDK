...
{
    /// <inheritdoc />
    public sealed class ThinkingConfigThinkingLevelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ThinkingConfigThinkingLevel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ThinkingConfigThinkingLevelExtensions.ToValueString(value));
        }
    }
}
