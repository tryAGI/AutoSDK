...
{
    /// <inheritdoc />
    public sealed class ThinkingConfigThinkingLevelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ThinkingConfigThinkingLevel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ThinkingConfigThinkingLevelExtensions.ToValueString(value.Value));
            }
        }
    }
}
