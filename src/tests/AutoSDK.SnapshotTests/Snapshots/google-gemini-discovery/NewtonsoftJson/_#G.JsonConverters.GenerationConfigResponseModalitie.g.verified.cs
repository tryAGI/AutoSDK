...
{
    /// <inheritdoc />
    public sealed class GenerationConfigResponseModalitieJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GenerationConfigResponseModalitie>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GenerationConfigResponseModalitieExtensions.ToValueString(value));
        }
    }
}
