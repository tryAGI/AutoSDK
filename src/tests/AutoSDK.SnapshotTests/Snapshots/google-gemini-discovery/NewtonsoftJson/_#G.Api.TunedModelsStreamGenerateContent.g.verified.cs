//HintName: G.Api.TunedModelsStreamGenerateContent.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareTunedModelsStreamGenerateContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string tunedModelsId,
            global::G.GenerateContentRequest request);
        partial void PrepareTunedModelsStreamGenerateContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string tunedModelsId,
            global::G.GenerateContentRequest request);
        partial void ProcessTunedModelsStreamGenerateContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTunedModelsStreamGenerateContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GenerateContentResponse> TunedModelsStreamGenerateContentAsync(
            string tunedModelsId,
        ...
        {
            var __response = await TunedModelsStreamGenerateContentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GenerateContentResponse>> TunedModelsStreamGenerateContentAsResponseAsync(
            string tunedModelsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTunedModelsStreamGenerateContentArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                path: $"/tunedModels/{tunedModelsId}:streamGenerateContent",
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTunedModelsStreamGenerateContentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TunedModelsStreamGenerateContent",
                                methodName: "TunedModelsStreamGenerateContentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTunedModelsStreamGenerateContentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTunedModelsStreamGenerateContentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GenerateContentResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GenerateContentResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GenerateContentResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
