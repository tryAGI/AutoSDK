...
{
    /// <inheritdoc />
    public sealed class FileUploadTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FileUploadType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FileUploadTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
