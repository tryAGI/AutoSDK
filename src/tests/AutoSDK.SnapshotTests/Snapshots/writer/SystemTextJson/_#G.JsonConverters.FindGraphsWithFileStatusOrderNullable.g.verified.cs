...
{
    /// <inheritdoc />
    public sealed class FindGraphsWithFileStatusOrderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FindGraphsWithFileStatusOrder?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.FindGraphsWithFileStatusOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
