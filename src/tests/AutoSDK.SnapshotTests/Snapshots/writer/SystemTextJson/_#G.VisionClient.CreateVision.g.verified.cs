//HintName: G.VisionClient.CreateVision.g.cs
...
namespace G
{
    public partial class VisionClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateVisionSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateVisionSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareCreateVisionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.VisionRequest request);
        partial void ProcessCreateVisionResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.VisionResponse> CreateVisionAsync(

            global::G.VisionRequest request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateVisionAsResponseAsync(
        ...
        /// --data-raw '{"model":"palmyra-vision","variables":[{"name":"image_1","file_id":"f1234"},{"name":"image_2","file_id":"f9876"}],"prompt":"Describe the difference between the image {{image_1}} and the image {{image_2}}."}'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.VisionResponse>> CreateVisionAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CreateVisionAsync",
                                pathTemplate: "\"/v1/vision\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateVisionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.VisionResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.VisionResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.VisionResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreateVisionAsync(
                request: __request,
                requestOptions: requestOptions,
