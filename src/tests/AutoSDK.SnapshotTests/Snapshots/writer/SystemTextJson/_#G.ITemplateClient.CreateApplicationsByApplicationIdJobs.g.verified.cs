...
namespace G
{
    public partial interface ITemplateClient
    {
        ...
        /// --data-raw '{"inputs":[{"id": "Image ID", "value": ["12345"]}]}'
        /// </remarks>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GenerateApplicationAsyncResponse>> CreateApplicationsByApplicationIdJobsAsResponseAsync(
            string applicationId,
