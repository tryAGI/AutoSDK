...
namespace G
{
    public partial class KgApiClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_UpdateGraphSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_UpdateGraphSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        {
            var __response = await UpdateGraphAsResponseAsync(
                graphId: graphId,
        ...
        /// --data-raw '{"name":"string", "description":"string", "urls":[{"url":"https://example.com/docs", "type":"sub_pages", "exclude_urls":["https://example.com/docs/private"]}]}'
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GraphResponse>> UpdateGraphAsResponseAsync(
            global::System.Guid graphId,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GraphResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GraphResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GraphResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
