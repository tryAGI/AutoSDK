...
{
    /// <inheritdoc />
    public sealed class GraphStageStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GraphStageStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GraphStageStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
