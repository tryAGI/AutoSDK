...
namespace G
{
    ...
    public sealed partial class ElevenLabsRealtimeSpeechToTextRealtimeClient : global::System.IDisposable, global::System.IAsyncDisposable
    {
        ...
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::ExternalTypes.ServerEvent>>? MessageReceived;

        /// <summary>
        /// 
        /// </summary>

        public global::System.Text.Json.Serialization.JsonSerializerContext JsonSerializerContext { get; set; } = global::ExternalTypes.SourceGenerationContext.Default;
