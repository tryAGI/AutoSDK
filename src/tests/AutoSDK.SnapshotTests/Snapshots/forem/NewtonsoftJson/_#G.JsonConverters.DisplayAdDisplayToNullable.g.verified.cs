...
{
    /// <inheritdoc />
    public sealed class DisplayAdDisplayToNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DisplayAdDisplayTo?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DisplayAdDisplayToExtensions.ToValueString(value.Value));
            }
        }
    }
}
