...
{
    /// <inheritdoc />
    public sealed class GetArticlesStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetArticlesState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetArticlesStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
