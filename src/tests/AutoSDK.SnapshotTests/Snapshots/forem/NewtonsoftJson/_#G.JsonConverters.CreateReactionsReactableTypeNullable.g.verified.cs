...
{
    /// <inheritdoc />
    public sealed class CreateReactionsReactableTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateReactionsReactableType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateReactionsReactableTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
