...
namespace G
{
    public partial interface IFollowersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.GetFollowersResponseItem>>> GetFollowersAsResponseAsync(
            int? page = default,
            int? perPage = default,
            string? sort = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
