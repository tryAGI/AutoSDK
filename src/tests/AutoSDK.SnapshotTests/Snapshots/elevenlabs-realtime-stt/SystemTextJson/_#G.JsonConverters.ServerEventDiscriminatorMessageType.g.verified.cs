...
{
    /// <inheritdoc />
    public sealed class ServerEventDiscriminatorMessageTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ServerEventDiscriminatorMessageType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ServerEventDiscriminatorMessageTypeExtensions.ToValueString(value));
        }
    }
}
