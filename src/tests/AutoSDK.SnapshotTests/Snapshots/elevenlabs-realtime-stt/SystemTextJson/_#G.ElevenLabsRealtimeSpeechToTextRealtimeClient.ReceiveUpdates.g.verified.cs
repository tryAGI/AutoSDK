            ...
            string rawText)
        {
            ...
            if (@event.SessionStarted is { } __SessionStartedReceived)
            {
                SessionStartedReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.SessionStartedPayload>(
            ...
            if (@event.PartialTranscript is { } __PartialTranscriptReceived)
            {
                PartialTranscriptReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.PartialTranscriptPayload>(
            ...
            if (@event.CommittedTranscript is { } __CommittedTranscriptReceived)
            {
                CommittedTranscriptReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.CommittedTranscriptPayload>(
            ...
            if (@event.Error is { } __ErrorReceived)
            {
                ErrorReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.ErrorPayload>(
                        __ErrorReceived,
                        rawText,
                        json));
            }
