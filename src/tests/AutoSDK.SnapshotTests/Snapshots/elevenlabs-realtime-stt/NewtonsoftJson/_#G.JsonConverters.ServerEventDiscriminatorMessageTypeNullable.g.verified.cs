...
{
    /// <inheritdoc />
    public sealed class ServerEventDiscriminatorMessageTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ServerEventDiscriminatorMessageType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ServerEventDiscriminatorMessageTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
