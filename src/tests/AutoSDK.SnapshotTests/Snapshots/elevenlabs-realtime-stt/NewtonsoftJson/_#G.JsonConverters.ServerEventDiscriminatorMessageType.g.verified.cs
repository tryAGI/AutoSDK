            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            switch (reader.TokenType)
            {
                case global::Newtonsoft.Json.JsonToken.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.ServerEventDiscriminatorMessageTypeExtensions.ToEnum(stringValue) ?? throw new global::Newtonsoft.Json.JsonSerializationException($"Unknown discriminator value '{stringValue}' for global::G.ServerEventDiscriminatorMessageType.");
                    }
