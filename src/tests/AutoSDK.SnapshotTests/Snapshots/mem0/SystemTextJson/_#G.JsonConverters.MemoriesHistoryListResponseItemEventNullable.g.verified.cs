...
{
    /// <inheritdoc />
    public sealed class MemoriesHistoryListResponseItemEventNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MemoriesHistoryListResponseItemEvent?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.MemoriesHistoryListResponseItemEventExtensions.ToValueString(value.Value));
            }
        }
    }
}
