...
{
    /// <inheritdoc />
    public sealed class MemoriesHistoryListResponseItemEventJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MemoriesHistoryListResponseItemEvent>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.MemoriesHistoryListResponseItemEventExtensions.ToValueString(value));
        }
    }
}
