//HintName: G.Models.ListAgentsResponseAgentTarget.g.cs
...
namespace G
{
    ...
    public sealed partial class ListAgentsResponseAgentTarget
    {
        ...
        /// </summary>
        /// <example>false</example>
        [global::System.Text.Json.Serialization.JsonPropertyName("openAsCursorGithubApp")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAgentsResponseAgentTarget" /> class.
        /// </summary>
        /// <param name="url">
        /// URL to view the agent in Cursor Web<br/>
        /// Example: https://cursor.com/agents?id=bc_abc123
...
#endif
        public ListAgentsResponseAgentTarget(
            string url,
            string? branchName,
            string? prUrl,
            bool? autoCreatePr,
