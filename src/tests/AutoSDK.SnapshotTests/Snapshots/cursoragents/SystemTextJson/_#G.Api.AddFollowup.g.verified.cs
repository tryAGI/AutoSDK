//HintName: G.Api.AddFollowup.g.cs
...
namespace G
{
    public partial class Api
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_AddFollowupSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_AddFollowupSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_AddFollowupSecurityRequirement0,
            };
        partial void PrepareAddFollowupArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::G.AddFollowupRequest request);
        partial void PrepareAddFollowupRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::G.AddFollowupRequest request);
        partial void ProcessAddFollowupResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddFollowupResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.AddFollowupResponse> AddFollowupAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddFollowupSecurityRequirements,
                operationName: "AddFollowupAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "AddFollowupAsync",
                                pathTemplate: "$\"/v0/agents/{id}/followup\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddFollowupResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.AddFollowupResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.AddFollowupResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
