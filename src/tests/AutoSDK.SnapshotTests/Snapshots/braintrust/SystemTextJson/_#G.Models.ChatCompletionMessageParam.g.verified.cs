...
namespace G
{
    ...
    public readonly partial struct ChatCompletionMessageParam : global::System.IEquatable<ChatCompletionMessageParam>
    {
...
#endif
            out global::G.ChatCompletionMessageParamSystem? value)
        {
            value = System;
            return IsSystem;
        }
        ...
        public bool TryPickUser(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ChatCompletionMessageParamUser? value)
        {
            value = User;
            return IsUser;
        }
        ...
        public bool TryPickAssistant(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ChatCompletionMessageParamAssistant? value)
        {
            value = Assistant;
            return IsAssistant;
        }
        ...
        public bool TryPickTool(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ChatCompletionMessageParamTool? value)
        {
            value = Tool;
            return IsTool;
        }
        ...
        public bool TryPickFunction(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ChatCompletionMessageParamFunction? value)
        {
            value = Function;
            return IsFunction;
        }
        ...
        public bool TryPickDeveloper(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ChatCompletionMessageParamDeveloper? value)
        {
            value = Developer;
            return IsDeveloper;
        }
        ...
        public bool TryPickFallback(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.ChatCompletionMessageParamFallback? value)
        {
            value = Fallback;
            return IsFallback;
        }
