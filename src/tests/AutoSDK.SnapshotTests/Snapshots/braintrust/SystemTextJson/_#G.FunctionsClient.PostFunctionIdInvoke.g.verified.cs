...
namespace G
{
    public partial class FunctionsClient
    {
        ...
        {
            var __response = await PostFunctionIdInvokeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> PostFunctionIdInvokeAsResponseAsync(
            global::System.Guid functionId,
