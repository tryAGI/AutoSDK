...
{
    /// <inheritdoc />
    public sealed class PermissionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Permission?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PermissionExtensions.ToValueString(value.Value));
            }
        }
    }
}
