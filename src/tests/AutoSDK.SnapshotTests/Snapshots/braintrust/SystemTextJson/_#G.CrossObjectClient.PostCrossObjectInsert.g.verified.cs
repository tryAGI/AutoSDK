//HintName: G.CrossObjectClient.PostCrossObjectInsert.g.cs

#nullable enable

namespace G
{
    public partial class CrossObjectClient
    {


        private static readonly global::G.EndPointSecurityRequirement s_PostCrossObjectInsertSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PostCrossObjectInsertSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PostCrossObjectInsertSecurityRequirement0,
            };
        partial void PreparePostCrossObjectInsertArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.CrossObjectInsertRequest request);
        partial void PreparePostCrossObjectInsertRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.CrossObjectInsertRequest request);
        partial void ProcessPostCrossObjectInsertResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostCrossObjectInsertResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CrossObjectInsertResponse> PostCrossObjectInsertAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CrossObjectInsertResponse>> PostCrossObjectInsertAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostCrossObjectInsertArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostCrossObjectInsertSecurityRequirements,
                operationName: "PostCrossObjectInsertAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostCrossObjectInsertRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostCrossObjectInsertAsync",
                                pathTemplate: "\"/v1/insert\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostCrossObjectInsertResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostCrossObjectInsertResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CrossObjectInsertResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CrossObjectInsertResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CrossObjectInsertResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostCrossObjectInsertAsync(
                request: __request,
                requestOptions: requestOptions,
