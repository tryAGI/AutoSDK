...
{
    /// <inheritdoc />
    public sealed class InvokeParentSpanParentStructObjectTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InvokeParentSpanParentStructObjectType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.InvokeParentSpanParentStructObjectTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
