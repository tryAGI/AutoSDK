...
{
    /// <inheritdoc />
    public sealed class ChatCompletionContentPartImageWithTitleImageUrlDetailHighNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionContentPartImageWithTitleImageUrlDetailHigh?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ChatCompletionContentPartImageWithTitleImageUrlDetailHighExtensions.ToValueString(value.Value));
            }
        }
    }
}
