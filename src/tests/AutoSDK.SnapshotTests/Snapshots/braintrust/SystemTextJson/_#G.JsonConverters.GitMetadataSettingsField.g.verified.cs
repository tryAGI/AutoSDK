...
{
    /// <inheritdoc />
    public sealed class GitMetadataSettingsFieldJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GitMetadataSettingsField>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GitMetadataSettingsFieldExtensions.ToValueString(value));
        }
    }
}
