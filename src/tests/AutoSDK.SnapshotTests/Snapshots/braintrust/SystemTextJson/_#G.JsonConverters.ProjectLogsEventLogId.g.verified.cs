...
{
    /// <inheritdoc />
    public sealed class ProjectLogsEventLogIdJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ProjectLogsEventLogId>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ProjectLogsEventLogIdExtensions.ToValueString(value));
        }
    }
}
