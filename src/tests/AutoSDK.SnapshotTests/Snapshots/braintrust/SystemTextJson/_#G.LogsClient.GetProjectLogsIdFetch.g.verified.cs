//HintName: G.LogsClient.GetProjectLogsIdFetch.g.cs
...
namespace G
{
    public partial class LogsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetProjectLogsIdFetchSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetProjectLogsIdFetchSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetProjectLogsIdFetchSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetProjectLogsIdFetchSecurityRequirement0,
                s_GetProjectLogsIdFetchSecurityRequirement1,
            };
        partial void PrepareGetProjectLogsIdFetchArguments(
            ...
            ref string? version);
        partial void PrepareGetProjectLogsIdFetchRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? version);
        partial void ProcessGetProjectLogsIdFetchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectLogsIdFetchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Fetch project logs (GET form)<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::G.FetchProjectLogsEventsResponse> GetProjectLogsIdFetchAsync(
            global::System.Guid projectId,
            int? limit = default,
        ...
        {
            var __response = await GetProjectLogsIdFetchAsResponseAsync(
                projectId: projectId,
                limit: limit,
                maxXactId: maxXactId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FetchProjectLogsEventsResponse>> GetProjectLogsIdFetchAsResponseAsync(
            global::System.Guid projectId,
            int? limit = default,
            string? maxXactId = default,
            string? maxRootSpanId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectLogsIdFetchArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetProjectLogsIdFetchSecurityRequirements,
                operationName: "GetProjectLogsIdFetchAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetProjectLogsIdFetchAsync",
                                pathTemplate: "$\"/v1/project_logs/{projectId}/fetch\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectLogsIdFetchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectLogsIdFetchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.FetchProjectLogsEventsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.FetchProjectLogsEventsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.FetchProjectLogsEventsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
