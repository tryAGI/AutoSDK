...
{
    /// <inheritdoc />
    public sealed class FunctionDataNullishParametersTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FunctionDataNullishParametersType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.FunctionDataNullishParametersTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
