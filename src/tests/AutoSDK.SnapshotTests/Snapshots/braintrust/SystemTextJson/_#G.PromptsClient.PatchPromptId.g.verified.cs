//HintName: G.PromptsClient.PatchPromptId.g.cs
...
namespace G
{
    public partial class PromptsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchPromptIdSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchPromptIdSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PatchPromptIdSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PreparePatchPromptIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid promptId,
            global::G.PatchPrompt request);
        partial void ProcessPatchPromptIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::G.Prompt> PatchPromptIdAsync(
            global::System.Guid promptId,
        ...
        {
            var __response = await PatchPromptIdAsResponseAsync(
                promptId: promptId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Prompt>> PatchPromptIdAsResponseAsync(
            global::System.Guid promptId,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchPromptIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Prompt> PatchPromptIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PatchPrompt
            {
                Name = name,
                Slug = slug,
            ...
            return await PatchPromptIdAsync(
                promptId: promptId,
                request: __request,
                requestOptions: requestOptions,
