...
{
    /// <inheritdoc />
    public sealed class FeedbackProjectLogsItemSourceNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FeedbackProjectLogsItemSource?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.FeedbackProjectLogsItemSourceExtensions.ToValueString(value.Value));
            }
        }
    }
}
