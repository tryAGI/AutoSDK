//HintName: G.ExperimentsClient.GetExperimentIdSummarize.g.cs
...
namespace G
{
    public partial class ExperimentsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetExperimentIdSummarizeSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetExperimentIdSummarizeSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareGetExperimentIdSummarizeArguments(
            ...
            ref bool? summarizeScores,
            ref global::System.Guid? comparisonExperimentId);
        partial void PrepareGetExperimentIdSummarizeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid experimentId,
            bool? summarizeScores,
            global::System.Guid? comparisonExperimentId);
        partial void ProcessGetExperimentIdSummarizeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetExperimentIdSummarizeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.SummarizeExperimentResponse> GetExperimentIdSummarizeAsync(
            global::System.Guid experimentId,
        ...
        {
            var __response = await GetExperimentIdSummarizeAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.SummarizeExperimentResponse>> GetExperimentIdSummarizeAsResponseAsync(
            global::System.Guid experimentId,
            bool? summarizeScores = default,
            global::System.Guid? comparisonExperimentId = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetExperimentIdSummarizeArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetExperimentIdSummarizeAsync",
                                pathTemplate: "$\"/v1/experiment/{experimentId}/summarize\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetExperimentIdSummarizeResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetExperimentIdSummarizeResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.SummarizeExperimentResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.SummarizeExperimentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.SummarizeExperimentResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
