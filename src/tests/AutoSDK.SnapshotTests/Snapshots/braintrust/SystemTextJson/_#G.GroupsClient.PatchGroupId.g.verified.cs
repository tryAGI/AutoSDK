//HintName: G.GroupsClient.PatchGroupId.g.cs
...
namespace G
{
    public partial class GroupsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchGroupIdSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchGroupIdSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PatchGroupIdSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PatchGroupIdSecurityRequirement0,
                s_PatchGroupIdSecurityRequirement1,
            };
        partial void PreparePatchGroupIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid groupId,
            global::G.PatchGroup request);
        partial void PreparePatchGroupIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid groupId,
            global::G.PatchGroup request);
        partial void ProcessPatchGroupIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatchGroupIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Group> PatchGroupIdAsync(
            global::System.Guid groupId,
        ...
        {
            var __response = await PatchGroupIdAsResponseAsync(
                groupId: groupId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Group>> PatchGroupIdAsResponseAsync(
            global::System.Guid groupId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PatchGroupIdSecurityRequirements,
                operationName: "PatchGroupIdAsync");
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchGroupIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Group.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.Group>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Group.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PatchGroup
            {
                ...
                Name = name,
                AddMemberUsers = addMemberUsers,
                RemoveMemberUsers = removeMemberUsers,
                AddMemberGroups = addMemberGroups,
                RemoveMemberGroups = removeMemberGroups,
            };

            return await PatchGroupIdAsync(
                groupId: groupId,
                request: __request,
                requestOptions: requestOptions,
