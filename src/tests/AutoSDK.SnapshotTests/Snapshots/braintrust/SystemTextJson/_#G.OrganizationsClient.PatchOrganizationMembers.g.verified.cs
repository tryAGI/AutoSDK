//HintName: G.OrganizationsClient.PatchOrganizationMembers.g.cs
...
namespace G
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchOrganizationMembersSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchOrganizationMembersSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PatchOrganizationMembersSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PatchOrganizationMembersSecurityRequirement0,
                s_PatchOrganizationMembersSecurityRequirement1,
            };
        partial void PreparePatchOrganizationMembersArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.PatchOrganizationMembers request);
        partial void PreparePatchOrganizationMembersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.PatchOrganizationMembers request);
        partial void ProcessPatchOrganizationMembersResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::G.PatchOrganizationMembersOutput> PatchOrganizationMembersAsync(

            global::G.PatchOrganizationMembers request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PatchOrganizationMembersAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PatchOrganizationMembersOutput>> PatchOrganizationMembersAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePatchOrganizationMembersArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PatchOrganizationMembersSecurityRequirements,
                operationName: "PatchOrganizationMembersAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePatchOrganizationMembersRequest(
                    httpClient: HttpClient,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PatchOrganizationMembersAsync",
                                pathTemplate: "\"/v1/organization/members\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchOrganizationMembersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PatchOrganizationMembersOutput.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PatchOrganizationMembersOutput>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PatchOrganizationMembersOutput.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PatchOrganizationMembersAsync(
                request: __request,
                requestOptions: requestOptions,
