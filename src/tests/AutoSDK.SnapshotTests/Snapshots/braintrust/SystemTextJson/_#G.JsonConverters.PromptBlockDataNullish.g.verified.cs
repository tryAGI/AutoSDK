...
namespace G.JsonConverters
{
    ...
    public class PromptBlockDataNullishJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PromptBlockDataNullish>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        chat = global::System.Text.Json.JsonSerializer.Deserialize<global::G.PromptBlockDataNullishChat>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        completion = global::System.Text.Json.JsonSerializer.Deserialize<global::G.PromptBlockDataNullishCompletion>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        promptBlockDataNullishVariant3 = global::System.Text.Json.JsonSerializer.Deserialize<object>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsChat)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Chat, typeof(global::G.PromptBlockDataNullishChat), options);
            }
            else if (value.IsCompletion)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Completion, typeof(global::G.PromptBlockDataNullishCompletion), options);
            }
            else if (value.IsPromptBlockDataNullishVariant3)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PromptBlockDataNullishVariant3, typeof(object), options);
            }
        }
    }
}