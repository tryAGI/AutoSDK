...
{
    /// <inheritdoc />
    public sealed class PutEnvVarRequestObjectTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PutEnvVarRequestObjectType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PutEnvVarRequestObjectTypeExtensions.ToValueString(value));
        }
    }
}
