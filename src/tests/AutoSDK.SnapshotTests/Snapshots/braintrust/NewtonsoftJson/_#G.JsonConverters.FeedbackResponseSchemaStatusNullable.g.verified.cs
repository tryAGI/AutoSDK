...
{
    /// <inheritdoc />
    public sealed class FeedbackResponseSchemaStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FeedbackResponseSchemaStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FeedbackResponseSchemaStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
