...
{
    /// <inheritdoc />
    public sealed class AclListPermissionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AclListPermission?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AclListPermissionExtensions.ToValueString(value.Value));
            }
        }
    }
}
