...
{
    /// <inheritdoc />
    public sealed class EnvVarObjectTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EnvVarObjectType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EnvVarObjectTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
