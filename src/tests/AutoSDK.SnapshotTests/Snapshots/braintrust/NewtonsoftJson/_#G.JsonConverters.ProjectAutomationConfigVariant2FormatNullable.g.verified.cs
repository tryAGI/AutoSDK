...
{
    /// <inheritdoc />
    public sealed class ProjectAutomationConfigVariant2FormatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProjectAutomationConfigVariant2Format?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProjectAutomationConfigVariant2FormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
