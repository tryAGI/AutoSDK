//HintName: G.ExperimentsClient.PostExperimentIdFetch.g.cs
...
namespace G
{
    public partial class ExperimentsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostExperimentIdFetchSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostExperimentIdFetchSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PostExperimentIdFetchSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PostExperimentIdFetchSecurityRequirement0,
                s_PostExperimentIdFetchSecurityRequirement1,
            };
        partial void PreparePostExperimentIdFetchArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.Guid experimentId,
            global::G.FetchEventsRequest request);
        partial void PreparePostExperimentIdFetchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid experimentId,
            global::G.FetchEventsRequest request);
        partial void ProcessPostExperimentIdFetchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostExperimentIdFetchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.FetchExperimentEventsResponse> PostExperimentIdFetchAsync(
            global::System.Guid experimentId,
        ...
        {
            var __response = await PostExperimentIdFetchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FetchExperimentEventsResponse>> PostExperimentIdFetchAsResponseAsync(
            global::System.Guid experimentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostExperimentIdFetchArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostExperimentIdFetchSecurityRequirements,
                operationName: "PostExperimentIdFetchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostExperimentIdFetchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostExperimentIdFetchAsync",
                                pathTemplate: "$\"/v1/experiment/{experimentId}/fetch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostExperimentIdFetchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostExperimentIdFetchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.FetchExperimentEventsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.FetchExperimentEventsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.FetchExperimentEventsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostExperimentIdFetchAsync(
                experimentId: experimentId,
                request: __request,
                requestOptions: requestOptions,
