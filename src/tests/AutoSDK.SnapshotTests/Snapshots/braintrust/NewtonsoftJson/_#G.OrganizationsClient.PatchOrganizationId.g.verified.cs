//HintName: G.OrganizationsClient.PatchOrganizationId.g.cs
...
namespace G
{
    public partial class OrganizationsClient
    {
        ...
        partial void PreparePatchOrganizationIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.Guid organizationId,
            global::G.PatchOrganization request);
        partial void ProcessPatchOrganizationIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatchOrganizationIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Organization> PatchOrganizationIdAsync(
            global::System.Guid organizationId,
        ...
        {
            var __response = await PatchOrganizationIdAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Organization>> PatchOrganizationIdAsResponseAsync(
            global::System.Guid organizationId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePatchOrganizationIdArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PatchOrganizationIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPatchOrganizationIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchOrganizationIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Organization> PatchOrganizationIdAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PatchOrganization
            {
                Name = name,
                ApiUrl = apiUrl,
                IsUniversalApi = isUniversalApi,
                IsDataplanePrivate = isDataplanePrivate,
                ProxyUrl = proxyUrl,
                RealtimeUrl = realtimeUrl,
                ImageRenderingMode = imageRenderingMode,
            };

            return await PatchOrganizationIdAsync(
                organizationId: organizationId,
                request: __request,
                requestOptions: requestOptions,
