...
{
    /// <inheritdoc />
    public sealed class PermissionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.Permission>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PermissionExtensions.ToValueString(value));
        }
    }
}
