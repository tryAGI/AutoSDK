...
{
    /// <inheritdoc />
    public sealed class FeedbackProjectLogsItemSourceJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FeedbackProjectLogsItemSource>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.FeedbackProjectLogsItemSourceExtensions.ToValueString(value));
        }
    }
}
