...
{
    /// <inheritdoc />
    public sealed class GitMetadataSettingsFieldNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GitMetadataSettingsField?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GitMetadataSettingsFieldExtensions.ToValueString(value.Value));
            }
        }
    }
}
