...
{
    /// <inheritdoc />
    public sealed class ProjectLogsEventLogIdNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProjectLogsEventLogId?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProjectLogsEventLogIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
