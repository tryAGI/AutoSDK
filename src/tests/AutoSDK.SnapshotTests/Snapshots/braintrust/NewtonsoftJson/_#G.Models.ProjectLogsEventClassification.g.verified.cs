//HintName: G.Models.ProjectLogsEventClassification.g.cs
...
namespace G
{
    ...
    public sealed partial class ProjectLogsEventClassification
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectLogsEventClassification" /> class.
        /// </summary>
        /// <param name="id">
        /// Stable classification identifier
        /// </param>
        ...
        /// Optional function identifier that produced the classification
        /// </param>
        public ProjectLogsEventClassification(
            string id,
            string? label,
            double? confidence,
