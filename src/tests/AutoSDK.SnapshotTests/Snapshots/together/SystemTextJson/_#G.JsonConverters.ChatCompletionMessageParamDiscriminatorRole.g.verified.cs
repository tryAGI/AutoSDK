...
{
    /// <inheritdoc />
    public sealed class ChatCompletionMessageParamDiscriminatorRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionMessageParamDiscriminatorRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatCompletionMessageParamDiscriminatorRoleExtensions.ToValueString(value));
        }
    }
}
