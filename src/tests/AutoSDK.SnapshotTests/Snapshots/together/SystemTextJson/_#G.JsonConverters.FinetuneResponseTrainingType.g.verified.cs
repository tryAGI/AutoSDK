...
namespace G.JsonConverters
{
    ...
    public class FinetuneResponseTrainingTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FinetuneResponseTrainingType>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("lora_r")) __score1++;
            if (__jsonProps.Contains("lora_alpha")) __score1++;
            if (__jsonProps.Contains("lora_dropout")) __score1++;
            if (__jsonProps.Contains("lora_trainable_modules")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        full = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        lora = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::G.FinetuneResponseTrainingType(
                full,
