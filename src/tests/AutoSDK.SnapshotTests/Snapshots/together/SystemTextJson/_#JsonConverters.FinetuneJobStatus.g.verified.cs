...
namespace G.JsonConverters
{
    ...
    public sealed class FinetuneJobStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FinetuneJobStatus>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.FinetuneJobStatusExtensions.ToEnum(stringValue) ?? default;
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FinetuneJobStatusExtensions.ToValueString(value));
        }
    }
}
