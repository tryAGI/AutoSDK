...
namespace G
{
    public partial class FineTuningClient
    {
        ...
        {
            var __response = await GetFinetuneDownloadAsResponseAsync(
                ftId: ftId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FinetuneDownloadResult>> GetFinetuneDownloadAsResponseAsync(
            string ftId,
            int? checkpointStep = default,
            string? output = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getFinetuneDownload",
                                methodName: "GetFinetuneDownloadAsync",
                                pathTemplate: "\"/finetune/download\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.FinetuneDownloadResult.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.FinetuneDownloadResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.FinetuneDownloadResult.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
