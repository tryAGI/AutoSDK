...
{
    /// <inheritdoc />
    public sealed class ChatCompletionRequestMessageRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionRequestMessageRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatCompletionRequestMessageRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
