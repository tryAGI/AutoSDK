...
{
    /// <inheritdoc />
    public sealed class ChatCompletionFunctionMessageParamRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionFunctionMessageParamRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatCompletionFunctionMessageParamRoleExtensions.ToValueString(value));
        }
    }
}
