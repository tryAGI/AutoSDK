...
namespace G
{
    ...
    public readonly partial struct CompletionStream : global::System.IEquatable<CompletionStream>
    {
...
#endif
            out global::G.CompletionEvent? value)
        {
            value = Event;
            return IsEvent;
        }
        ...
        /// 
        /// </summary>
        public global::G.CompletionEvent PickEvent() => IsEvent
            ? Event!
        ...
        public bool TryPickSentinel(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.StreamSentinel? value)
        {
            value = Sentinel;
            return IsSentinel;
        }
        ...
        /// 
        /// </summary>
        public static CompletionStream FromEvent(global::G.CompletionEvent? value) => new CompletionStream(value);
        ...
        /// 
        /// </summary>
        public static CompletionStream FromSentinel(global::G.StreamSentinel? value) => new CompletionStream(value);
