//HintName: G.Api.InferClassificationInferClassificationPost.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareInferClassificationInferClassificationPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            bool? countinference,
            ref string? serviceSecret,
            global::G.ClassificationInferenceRequest request);
        partial void PrepareInferClassificationInferClassificationPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            bool? countinference,
            string? serviceSecret,
            global::G.ClassificationInferenceRequest request);
        partial void ProcessInferClassificationInferClassificationPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInferClassificationInferClassificationPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Classification infer<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::G.AnyOf<global::G.ClassificationInferenceResponse, global::G.MultiLabelClassificationInferenceResponse, global::G.StubResponse>> InferClassificationInferClassificationPostAsync(
        ...
        {
            var __response = await InferClassificationInferClassificationPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AnyOf<global::G.ClassificationInferenceResponse, global::G.MultiLabelClassificationInferenceResponse, global::G.StubResponse>>> InferClassificationInferClassificationPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInferClassificationInferClassificationPostArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInferClassificationInferClassificationPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InferClassificationInferClassificationPost",
                                methodName: "InferClassificationInferClassificationPostAsync",
                                pathTemplate: "\"/infer/classification\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInferClassificationInferClassificationPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInferClassificationInferClassificationPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AnyOf<global::G.ClassificationInferenceResponse, global::G.MultiLabelClassificationInferenceResponse, global::G.StubResponse>.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AnyOf<global::G.ClassificationInferenceResponse, global::G.MultiLabelClassificationInferenceResponse, global::G.StubResponse>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AnyOf<global::G.ClassificationInferenceResponse, global::G.MultiLabelClassificationInferenceResponse, global::G.StubResponse>.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.AnyOf<global::G.ClassificationInferenceResponse, global::G.MultiLabelClassificationInferenceResponse, global::G.StubResponse>> InferClassificationInferClassificationPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.ClassificationInferenceRequest
            {
                Id = id,
                ApiKey = apiKey,
            ...
            return await InferClassificationInferClassificationPostAsync(
                countinference: countinference,
                serviceSecret: serviceSecret,
                request: __request,
                requestOptions: requestOptions,
