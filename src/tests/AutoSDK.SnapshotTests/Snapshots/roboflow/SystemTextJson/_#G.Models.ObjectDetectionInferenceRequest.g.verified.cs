//HintName: G.Models.ObjectDetectionInferenceRequest.g.cs
...
{
    /// <summary>
    /// Object Detection inference request.<br/>
    /// Attributes:<br/>
    ///     class_agnostic_nms (Optional[bool]): If true, NMS is applied to all detections at once, if false, NMS is applied per class.<br/>
    ///     class_filter (Optional[List[str]]): If provided, only predictions for the listed classes will be returned.<br/>
    ///     confidence (Optional[float]): The confidence threshold used to filter out predictions.<br/>
    ///     fix_batch_size (Optional[bool]): If true, the batch size will be fixed to the maximum batch size configured for this server.<br/>
    ///     iou_threshold (Optional[float]): The IoU threshold that must be met for a box pair to be considered duplicate during NMS.<br/>
    ///     max_detections (Optional[int]): The maximum number of detections that will be returned.<br/>
    ///     max_candidates (Optional[int]): The maximum number of candidate detections passed to NMS.<br/>
    ///     visualization_labels (Optional[bool]): If true, labels will be rendered on prediction visualizations.<br/>
    ...
    /// </summary>
    public sealed partial class ObjectDetectionInferenceRequest
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectDetectionInferenceRequest" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public ObjectDetectionInferenceRequest(
            string id,
