...
namespace G
{
    public partial class Api
    {
        ...
        {
            var __response = await InferFromPredefinedWorkflowInferWorkflowsWorkspaceNameWorkflowIdPostAsResponseAsync(
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.WorkflowInferenceResponse>> InferFromPredefinedWorkflowInferWorkflowsWorkspaceNameWorkflowIdPostAsResponseAsync(
            string workspaceName,
            string workflowId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InferFromPredefinedWorkflowInferWorkflowsWorkspaceNameWorkflowIdPost",
                                methodName: "InferFromPredefinedWorkflowInferWorkflowsWorkspaceNameWorkflowIdPostAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.WorkflowInferenceResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.WorkflowInferenceResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.WorkflowInferenceResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
