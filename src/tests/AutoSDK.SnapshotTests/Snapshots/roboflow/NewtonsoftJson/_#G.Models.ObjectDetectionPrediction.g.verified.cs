//HintName: G.Models.ObjectDetectionPrediction.g.cs
...
{
    /// <summary>
    /// Object Detection prediction.<br/>
    /// Attributes:<br/>
    ///     x (float): The center x-axis pixel coordinate of the prediction.<br/>
    ///     y (float): The center y-axis pixel coordinate of the prediction.<br/>
    ///     width (float): The width of the prediction bounding box in number of pixels.<br/>
    ///     height (float): The height of the prediction bounding box in number of pixels.<br/>
    ///     confidence (float): The detection confidence as a fraction between 0 and 1.<br/>
    ///     class_name (str): The predicted class label.<br/>
    ///     class_confidence (Union[float, None]): The class label confidence as a fraction between 0 and 1.<br/>
    ...
    public sealed partial class ObjectDetectionPrediction
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectDetectionPrediction" /> class.
        /// </summary>
        /// <param name="x">
        /// The center x-axis pixel coordinate of the prediction
        /// </param>
