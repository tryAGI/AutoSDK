...
namespace G
{
    public partial class Api
    {
        ...
        {
            var __response = await LegacyInferFromRequestDatasetIdVersionIdGetAsResponseAsync(
                datasetId: datasetId,
                versionId: versionId,
                apiKey: apiKey,
