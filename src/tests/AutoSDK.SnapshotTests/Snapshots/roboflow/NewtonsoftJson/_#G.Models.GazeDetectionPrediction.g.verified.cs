...
namespace G
{
    ...
    public sealed partial class GazeDetectionPrediction
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("face", Required = global::Newtonsoft.Json.Required.Always)]
        public global::G.FaceDetectionPrediction Face { get; set; } = default!;

        /// <summary>
        /// Yaw (radian) of the detected face
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("yaw")]
