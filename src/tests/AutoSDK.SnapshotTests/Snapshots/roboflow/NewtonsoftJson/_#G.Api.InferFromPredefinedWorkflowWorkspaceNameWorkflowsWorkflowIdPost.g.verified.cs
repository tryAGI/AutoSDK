...
namespace G
{
    ...
    {
        partial void PrepareInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string workspaceName,
            ref string workflowId,
            global::G.PredefinedWorkflowInferenceRequest request);
        partial void PrepareInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string workspaceName,
            string workflowId,
            global::G.PredefinedWorkflowInferenceRequest request);
        partial void ProcessInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.WorkflowInferenceResponse> InferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostAsync(
            string workspaceName,
            string workflowId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostArguments(
            ...
            var __pathBuilder = new global::G.PathBuilder(
                path: $"/{workspaceName}/workflows/{workflowId}",
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessInferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await InferFromPredefinedWorkflowWorkspaceNameWorkflowsWorkflowIdPostAsync(
                workspaceName: workspaceName,
                workflowId: workflowId,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
