//HintName: G.Models.ClipTextEmbeddingRequest.g.cs
...
{
    /// <summary>
    /// Request for CLIP text embedding.<br/>
    /// Attributes:<br/>
    ///     text (Union[List[str], str]): A string or list of strings.
    /// </summary>
    public sealed partial class ClipTextEmbeddingRequest
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public global::G.AnyOf<global::System.Collections.Generic.IList<string>, string> Text { get; set; } = default!;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ClipTextEmbeddingRequest" /> class.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="text">
        /// A string or list of strings
