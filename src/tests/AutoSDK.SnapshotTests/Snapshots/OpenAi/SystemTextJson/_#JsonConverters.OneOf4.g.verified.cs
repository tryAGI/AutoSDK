...
{
    /// <inheritdoc />
    public class OneOfJsonConverter<T1, T2, T3, T4> : global::System.Text.Json.Serialization.JsonConverter<global::G.OneOf<T1, T2, T3, T4>>
    {
        /// <inheritdoc />
        public override global::G.OneOf<T1, T2, T3, T4> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var result = new global::G.OneOf<T1, T2, T3, T4>(
                value1,
                value2,
                value3,
                value4
        ...
        public override void Write(
            ...
            global::G.OneOf<T1, T2, T3, T4> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options)); 
