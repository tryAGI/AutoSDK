...
namespace G
{
    public partial class Api
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CheckAPIKeySecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CheckAPIKeySecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CheckAPIKeySecurityRequirement0,
            };
        ...
        {
            var __response = await CheckAPIKeyAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CheckApiKeyResponse>> CheckAPIKeyAsResponseAsync(
            string? xClientName = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CheckAPIKeySecurityRequirements,
                operationName: "CheckAPIKeyAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CheckAPIKeyAsync",
                                pathTemplate: "\"/v1/check-api-key\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::G.ApiException<global::G.NotFoundErrorBody29>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::G.ApiException<global::G.UnauthorizedErrorBody57>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::G.ApiException<global::G.BadRequestErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::G.ApiException<global::G.UnauthorizedErrorBody58>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                throw global::G.ApiException<global::G.UnprocessableEntityErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::G.ApiException<global::G.GatewayTimeoutErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 498)
                            {
                                ...
                                throw global::G.ApiException<global::G.ForbiddenErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 499)
                            {
                                ...
                                throw global::G.ApiException<global::G.InternalServerErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::G.ApiException<global::G.ServiceUnavailableErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                throw global::G.ApiException<global::G.NotImplementedErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.TooManyRequestsErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 504)
                            {
                                ...
                                throw global::G.ApiException<global::G.InvalidTokenErrorBody29>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CheckApiKeyResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CheckApiKeyResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CheckApiKeyResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
