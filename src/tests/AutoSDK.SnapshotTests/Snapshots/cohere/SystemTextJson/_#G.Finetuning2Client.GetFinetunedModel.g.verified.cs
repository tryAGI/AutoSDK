//HintName: G.Finetuning2Client.GetFinetunedModel.g.cs

#nullable enable

namespace G
{
    public partial class Finetuning2Client
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.GetFinetunedModelResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
