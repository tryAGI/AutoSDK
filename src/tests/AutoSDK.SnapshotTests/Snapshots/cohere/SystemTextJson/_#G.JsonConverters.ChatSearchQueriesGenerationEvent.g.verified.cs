...
namespace G.JsonConverters
{
    ...
    public class ChatSearchQueriesGenerationEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatSearchQueriesGenerationEvent>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("search_queries")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::G.ChatSearchQueriesGenerationEvent6evypd? event6evypd = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.ChatSearchQueriesGenerationEvent(
                stream,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsEvent6evypd)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ChatSearchQueriesGenerationEvent6evypd), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ChatSearchQueriesGenerationEvent6evypd?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ChatSearchQueriesGenerationEvent6evypd).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Event6evypd!, typeInfo);
            }
        }
    }
}