//HintName: G.Models.ChatMessageEndEventDelta.g.cs
...
namespace G
{
    ...
    public sealed partial class ChatMessageEndEventDelta
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatMessageEndEventDelta" /> class.
        /// </summary>
        /// <param name="error">
        /// An error message if an error occurred during the generation.
        /// </param>
...
#endif
        public ChatMessageEndEventDelta(
            string? error,
