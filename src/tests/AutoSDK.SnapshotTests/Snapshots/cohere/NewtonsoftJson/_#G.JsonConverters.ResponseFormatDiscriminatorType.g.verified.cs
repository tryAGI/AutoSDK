...
{
    /// <inheritdoc />
    public sealed class ResponseFormatDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseFormatDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ResponseFormatDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
