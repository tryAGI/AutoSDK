...
{
    /// <inheritdoc />
    public sealed class ChatStreamEndEventY8gq2xFinishReasonJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatStreamEndEventY8gq2xFinishReason>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatStreamEndEventY8gq2xFinishReasonExtensions.ToValueString(value));
        }
    }
}
