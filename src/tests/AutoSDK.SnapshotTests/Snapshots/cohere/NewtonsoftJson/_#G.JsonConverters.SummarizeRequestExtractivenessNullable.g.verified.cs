...
{
    /// <inheritdoc />
    public sealed class SummarizeRequestExtractivenessNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SummarizeRequestExtractiveness?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SummarizeRequestExtractivenessExtensions.ToValueString(value.Value));
            }
        }
    }
}
