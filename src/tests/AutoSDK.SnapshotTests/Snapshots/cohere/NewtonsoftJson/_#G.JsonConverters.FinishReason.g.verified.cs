...
{
    /// <inheritdoc />
    public sealed class FinishReasonJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FinishReason>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.FinishReasonExtensions.ToValueString(value));
        }
    }
}
