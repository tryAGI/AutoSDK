...
namespace G
{
    public partial class DatasetsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DatasetsCreateResponse>> CreateAsResponseAsync(
            string name,
            global::G.DatasetType type,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DatasetsCreateResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DatasetsCreateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DatasetsCreateResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.DatasetsCreateResponse> CreateAsync(
            ...
            string? csvDelimiter = default,
            string? xClientName = default,
            global::System.IO.Stream? evalData = default,
            string? evalDataname = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.DatasetDytngn
            {
                Data = global::System.Array.Empty<byte>(),
                Dataname = dataname,
                EvalData = global::System.Array.Empty<byte>(),
                EvalDataname = evalDataname,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            if (xClientName != default)
            {
                __httpRequest.Headers.TryAddWithoutValidation("X-Client-Name", xClientName.ToString());
                            ...
                            if (evalData != default)
                            {
                                ...
                                var __contentEvalData = new global::System.Net.Http.StreamContent(evalData);
                                __contentEvalData.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.EvalDataname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.EvalDataname) ?? string.Empty).ToLowerInvariant() switch
