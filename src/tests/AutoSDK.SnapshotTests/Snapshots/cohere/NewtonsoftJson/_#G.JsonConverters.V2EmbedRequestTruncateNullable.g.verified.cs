...
{
    /// <inheritdoc />
    public sealed class V2EmbedRequestTruncateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.V2EmbedRequestTruncate?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.V2EmbedRequestTruncateExtensions.ToValueString(value.Value));
            }
        }
    }
}
