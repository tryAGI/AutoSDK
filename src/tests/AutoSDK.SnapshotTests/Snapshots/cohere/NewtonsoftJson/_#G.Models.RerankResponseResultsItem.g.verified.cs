//HintName: G.Models.RerankResponseResultsItem.g.cs
...
namespace G
{
    ...
    public sealed partial class RerankResponseResultsItem
    {
        ...
        public global::G.RerankResponseResultsItemDocument? Document { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RerankResponseResultsItem" /> class.
        /// </summary>
        /// <param name="index">
        /// Corresponds to the index in the original list of documents to which the ranked document belongs. (i.e. if the first value in the `results` object has an `index` value of 3, it means in the list of documents passed in, the document at `index=3` had the highest relevance)
        /// </param>
        ...
        /// Included only in responses
        /// </param>
        public RerankResponseResultsItem(
            int index,
            global::G.RerankResponseResultsItemDocument? document,
        ...
        /// <summary>
        /// Creates a new <see cref="RerankResponseResultsItem"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static RerankResponseResultsItem FromIndex(int index)
        {
            return new RerankResponseResultsItem
            {
                Index = index,
            };
        }
