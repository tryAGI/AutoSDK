...
{
    /// <inheritdoc />
    public sealed class ChatCitationTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCitationType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatCitationTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
