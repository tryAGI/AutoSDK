//HintName: G.DeepgramConstDiscriminatorSpeakV1RealtimeClient.ReceiveUpdates.g.cs
...
namespace G
{
    public sealed partial class DeepgramConstDiscriminatorSpeakV1RealtimeClient
    {
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::G.SpeakV1ServerEvent> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::G.SpeakV1ServerEvent @event;
                    try
                    {
                        @event = (global::G.SpeakV1ServerEvent)global::System.Text.Json.JsonSerializer.Deserialize(json, typeof(global::G.SpeakV1ServerEvent), JsonSerializerContext)!;
                    }
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::G.SpeakV1ServerEvent>(
                    @event,
                    rawText,
                    json));

            if (@event.AudioResponse is { } __AudioResponseReceived)
            {
                AudioResponseReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.AudioResponsePayload>(
                        __AudioResponseReceived,
                        rawText,
                        json));
            }
            if (@event.SpeakMetadata is { } __SpeakMetadataReceived)
            {
                SpeakMetadataReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.SpeakMetadataPayload>(
                        __SpeakMetadataReceived,
                        rawText,
                        json));
            }
        }
