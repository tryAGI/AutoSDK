//HintName: G.Models.GetAuthConfigsResponseItemToolkit.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class GetAuthConfigsResponseItemToolkit
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAuthConfigsResponseItemToolkit" /> class.
        /// </summary>
        /// <param name="slug">
        /// The unique identifier of the integration app
        /// </param>
...
#endif
        public GetAuthConfigsResponseItemToolkit(
            string slug,
            string logo,
            string? authGuideUrl,
            string? authHintUrl)
