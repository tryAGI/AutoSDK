...
{
    /// <inheritdoc />
    public sealed class GetMcpAppByAppKeyOrderByJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetMcpAppByAppKeyOrderBy>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetMcpAppByAppKeyOrderByExtensions.ToValueString(value));
        }
    }
}
