...
{
    /// <inheritdoc />
    public sealed class PostToolRouterSessionRequestTagNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PostToolRouterSessionRequestTag?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PostToolRouterSessionRequestTagExtensions.ToValueString(value.Value));
            }
        }
    }
}
