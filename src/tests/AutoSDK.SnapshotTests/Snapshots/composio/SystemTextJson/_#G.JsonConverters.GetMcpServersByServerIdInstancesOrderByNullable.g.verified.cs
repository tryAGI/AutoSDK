...
{
    /// <inheritdoc />
    public sealed class GetMcpServersByServerIdInstancesOrderByNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetMcpServersByServerIdInstancesOrderBy?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetMcpServersByServerIdInstancesOrderByExtensions.ToValueString(value.Value));
            }
        }
    }
}
