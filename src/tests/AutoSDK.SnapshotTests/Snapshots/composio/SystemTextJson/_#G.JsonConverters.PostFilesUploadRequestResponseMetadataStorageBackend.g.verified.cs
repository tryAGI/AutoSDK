...
{
    /// <inheritdoc />
    public sealed class PostFilesUploadRequestResponseMetadataStorageBackendJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PostFilesUploadRequestResponseMetadataStorageBackend>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PostFilesUploadRequestResponseMetadataStorageBackendExtensions.ToValueString(value));
        }
    }
}
