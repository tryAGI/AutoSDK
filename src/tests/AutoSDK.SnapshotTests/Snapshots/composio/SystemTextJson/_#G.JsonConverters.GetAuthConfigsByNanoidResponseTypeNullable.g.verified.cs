...
{
    /// <inheritdoc />
    public sealed class GetAuthConfigsByNanoidResponseTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAuthConfigsByNanoidResponseType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetAuthConfigsByNanoidResponseTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
