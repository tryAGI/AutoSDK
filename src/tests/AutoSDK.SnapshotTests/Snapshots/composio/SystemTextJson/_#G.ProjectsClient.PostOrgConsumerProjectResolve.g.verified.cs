//HintName: G.ProjectsClient.PostOrgConsumerProjectResolve.g.cs
...
namespace G
{
    public partial class ProjectsClient
    {
        ...
        partial void PreparePostOrgConsumerProjectResolveArguments(
            ...
            ref string xOrgId);
        partial void PreparePostOrgConsumerProjectResolveRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xUserApiKey,
            string xOrgId);
        partial void ProcessPostOrgConsumerProjectResolveResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostOrgConsumerProjectResolveResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostOrgConsumerProjectResolveResponse> PostOrgConsumerProjectResolveAsync(
            string xUserApiKey,
            string xOrgId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PreparePostOrgConsumerProjectResolveArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                __httpRequest.Headers.TryAddWithoutValidation("x-org-id", xOrgId.ToString());
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostOrgConsumerProjectResolveAsync",
                                pathTemplate: "\"/api/v3/org/consumer/project/resolve\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostOrgConsumerProjectResolveResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad request. x-org-id is required for user API key authentication.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostOrgConsumerProjectResolveResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.PostOrgConsumerProjectResolveResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.PostOrgConsumerProjectResolveResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
