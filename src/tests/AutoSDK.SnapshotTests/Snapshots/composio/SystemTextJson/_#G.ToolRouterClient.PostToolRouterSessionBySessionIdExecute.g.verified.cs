//HintName: G.ToolRouterClient.PostToolRouterSessionBySessionIdExecute.g.cs
...
namespace G
{
    public partial class ToolRouterClient
    {
        ...
        partial void PreparePostToolRouterSessionBySessionIdExecuteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? sessionId,
            global::G.PostToolRouterSessionBySessionIdExecuteRequest request);
        partial void ProcessPostToolRouterSessionBySessionIdExecuteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostToolRouterSessionBySessionIdExecuteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostToolRouterSessionBySessionIdExecuteResponse> PostToolRouterSessionBySessionIdExecuteAsync(
            string? sessionId,
        ...
        {
            var __response = await PostToolRouterSessionBySessionIdExecuteAsResponseAsync(
                sessionId: sessionId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PostToolRouterSessionBySessionIdExecuteResponse>> PostToolRouterSessionBySessionIdExecuteAsResponseAsync(
            string? sessionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostToolRouterSessionBySessionIdExecuteArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostToolRouterSessionBySessionIdExecuteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostToolRouterSessionBySessionIdExecuteAsync",
                                pathTemplate: "$\"/api/v3/tool_router/session/{sessionId}/execute\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostToolRouterSessionBySessionIdExecuteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostToolRouterSessionBySessionIdExecuteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PostToolRouterSessionBySessionIdExecuteResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PostToolRouterSessionBySessionIdExecuteResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PostToolRouterSessionBySessionIdExecuteResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
