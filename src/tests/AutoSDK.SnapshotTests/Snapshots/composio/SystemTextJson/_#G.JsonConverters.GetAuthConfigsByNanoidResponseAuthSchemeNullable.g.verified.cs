...
{
    /// <inheritdoc />
    public sealed class GetAuthConfigsByNanoidResponseAuthSchemeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetAuthConfigsByNanoidResponseAuthScheme?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetAuthConfigsByNanoidResponseAuthSchemeExtensions.ToValueString(value.Value));
            }
        }
    }
}
