...
{
    /// <inheritdoc />
    public sealed class GetTriggersTypesResponseItemTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetTriggersTypesResponseItemType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetTriggersTypesResponseItemTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
