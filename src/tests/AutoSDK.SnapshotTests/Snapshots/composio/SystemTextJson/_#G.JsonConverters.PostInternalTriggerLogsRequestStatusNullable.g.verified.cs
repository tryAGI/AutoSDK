...
{
    /// <inheritdoc />
    public sealed class PostInternalTriggerLogsRequestStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PostInternalTriggerLogsRequestStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PostInternalTriggerLogsRequestStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
