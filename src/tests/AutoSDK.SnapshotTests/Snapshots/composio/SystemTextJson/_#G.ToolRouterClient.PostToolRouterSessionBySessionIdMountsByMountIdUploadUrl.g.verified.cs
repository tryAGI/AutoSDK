//HintName: G.ToolRouterClient.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrl.g.cs
...
namespace G
{
    public partial class ToolRouterClient
    {
        ...
        partial void PreparePostToolRouterSessionBySessionIdMountsByMountIdUploadUrlRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string sessionId,
            string mountId,
            global::G.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlRequest request);
        partial void ProcessPostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse> PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlAsync(
            string sessionId,
            string mountId,
        ...
        {
            var __response = await PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlAsResponseAsync(
                sessionId: sessionId,
                mountId: mountId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse>> PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlAsResponseAsync(
            string sessionId,
            string mountId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostToolRouterSessionBySessionIdMountsByMountIdUploadUrlArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostToolRouterSessionBySessionIdMountsByMountIdUploadUrlRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlAsync",
                                pathTemplate: "$\"/api/v3/tool_router/session/{sessionId}/mounts/{mountId}/upload_url\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostToolRouterSessionBySessionIdMountsByMountIdUploadUrlAsync(
                sessionId: sessionId,
                mountId: mountId,
                request: __request,
                requestOptions: requestOptions,
