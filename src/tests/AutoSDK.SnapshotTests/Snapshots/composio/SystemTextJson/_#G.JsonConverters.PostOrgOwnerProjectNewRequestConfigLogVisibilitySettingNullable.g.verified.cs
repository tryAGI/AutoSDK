...
{
    /// <inheritdoc />
    public sealed class PostOrgOwnerProjectNewRequestConfigLogVisibilitySettingNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PostOrgOwnerProjectNewRequestConfigLogVisibilitySetting?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PostOrgOwnerProjectNewRequestConfigLogVisibilitySettingExtensions.ToValueString(value.Value));
            }
        }
    }
}
