//HintName: G.ProjectsClient.PatchOrgProjectConfig.g.cs
...
namespace G
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchOrgProjectConfigSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchOrgProjectConfigSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PatchOrgProjectConfigSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PatchOrgProjectConfigSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PatchOrgProjectConfigSecurityRequirement0,
                s_PatchOrgProjectConfigSecurityRequirement1,
                s_PatchOrgProjectConfigSecurityRequirement2,
            };
        partial void PreparePatchOrgProjectConfigArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.PatchOrgProjectConfigRequest request);
        partial void PreparePatchOrgProjectConfigRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.PatchOrgProjectConfigRequest request);
        partial void ProcessPatchOrgProjectConfigResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPatchOrgProjectConfigResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PatchOrgProjectConfigResponse> PatchOrgProjectConfigAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePatchOrgProjectConfigArguments(
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePatchOrgProjectConfigRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PatchOrgProjectConfigAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPatchOrgProjectConfigResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad request. The configuration data may be invalid or missing.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPatchOrgProjectConfigResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.PatchOrgProjectConfigResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.PatchOrgProjectConfigResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PatchOrgProjectConfigRequest
            {
                ...
                MaskSecretKeysInConnectedAccount = maskSecretKeysInConnectedAccount,
                LogVisibilitySetting = logVisibilitySetting,
                RequireMcpApiKey = requireMcpApiKey,
                IsComposioLinkEnabledForManagedAuth = isComposioLinkEnabledForManagedAuth,
                SignedUrlFileExpiryInSeconds = signedUrlFileExpiryInSeconds,
            };

            return await PatchOrgProjectConfigAsync(
                request: __request,
                requestOptions: requestOptions,
