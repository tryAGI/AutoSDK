//HintName: G.Models.GetToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class GetToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool" /> class.
        /// </summary>
        /// <param name="slug">
        /// Prefixed tool slug (e.g. LOCAL_CRM_FIND_CUSTOMER)
        /// </param>
...
#endif
        public GetToolRouterSessionBySessionIdResponseExperimentalCustomToolkitTool(
            string slug,
            string name,
            string description,
