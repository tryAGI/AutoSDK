...
namespace G
{
    public partial interface IMcpClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetMcpServersByServerIdInstancesResponse>> GetMcpServersByServerIdInstancesAsResponseAsync(
            string serverId,
            double? pageNo = default,
            double? limit = default,
            string? search = default,
