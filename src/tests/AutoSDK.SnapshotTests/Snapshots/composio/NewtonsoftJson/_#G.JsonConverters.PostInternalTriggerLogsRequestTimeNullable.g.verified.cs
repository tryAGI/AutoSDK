...
{
    /// <inheritdoc />
    public sealed class PostInternalTriggerLogsRequestTimeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PostInternalTriggerLogsRequestTime?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PostInternalTriggerLogsRequestTimeExtensions.ToValueString(value.Value));
            }
        }
    }
}
