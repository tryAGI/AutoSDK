//HintName: G.Models.GetTriggersTypesResponseItemToolkit.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class GetTriggersTypesResponseItemToolkit
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetTriggersTypesResponseItemToolkit" /> class.
        /// </summary>
        /// <param name="slug">
        /// Unique identifier for the parent toolkit<br/>
        /// Example: slack
        ...
        /// Example: https://example.com/logo.png
        /// </param>
        public GetTriggersTypesResponseItemToolkit(
            string slug,
            string name,
            string logo)
        {
