...
{
    /// <inheritdoc />
    public sealed class GetMcpAppByAppKeyOrderDirectionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetMcpAppByAppKeyOrderDirection?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetMcpAppByAppKeyOrderDirectionExtensions.ToValueString(value.Value));
            }
        }
    }
}
