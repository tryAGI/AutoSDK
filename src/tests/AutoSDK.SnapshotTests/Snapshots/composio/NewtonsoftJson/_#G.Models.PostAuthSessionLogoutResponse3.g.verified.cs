//HintName: G.Models.PostAuthSessionLogoutResponse3.g.cs
...
namespace G
{
    ...
    public sealed partial class PostAuthSessionLogoutResponse3
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostAuthSessionLogoutResponse3" /> class.
        /// </summary>
        /// <param name="message">
        /// Human-readable description of the error that occurred<br/>
        /// Example: Authentication required
        ...
        /// Example: AUTH_REQUIRED
        /// </param>
        public PostAuthSessionLogoutResponse3(
            string message,
            string? code)
        {
