...
{
    /// <inheritdoc />
    public sealed class GetMcpAppByAppKeyOrderByNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetMcpAppByAppKeyOrderBy?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetMcpAppByAppKeyOrderByExtensions.ToValueString(value.Value));
            }
        }
    }
}
