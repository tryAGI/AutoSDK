...
{
    /// <inheritdoc />
    public sealed class PostWebhookSubscriptionsResponseVersionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PostWebhookSubscriptionsResponseVersion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PostWebhookSubscriptionsResponseVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
