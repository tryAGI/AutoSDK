...
namespace G
{
    public partial interface IOrganizationManagementClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GetOrgConsumerConnectedToolkitsResponse>> GetOrgConsumerConnectedToolkitsAsResponseAsync(
            string userId,
            string xUserApiKey,
            string xOrgId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
