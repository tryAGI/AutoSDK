//HintName: G.TriggersClient.GetTriggersTypesBySlug.g.cs
...
namespace G
{
    public partial class TriggersClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetTriggersTypesBySlugSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetTriggersTypesBySlugSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetTriggersTypesBySlugSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetTriggersTypesBySlugSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_GetTriggersTypesBySlugSecurityRequirement0,
                s_GetTriggersTypesBySlugSecurityRequirement1,
                s_GetTriggersTypesBySlugSecurityRequirement2,
            };
        ...
        partial void ProcessGetTriggersTypesBySlugResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await GetTriggersTypesBySlugAsResponseAsync(
                slug: slug,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTriggersTypesBySlugArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetTriggersTypesBySlugSecurityRequirements,
                operationName: "GetTriggersTypesBySlugAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetTriggersTypesBySlugAsync",
                                pathTemplate: "$\"/api/v3/triggers_types/{slug}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTriggersTypesBySlugResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTriggersTypesBySlugResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GetTriggersTypesBySlugResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GetTriggersTypesBySlugResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GetTriggersTypesBySlugResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
