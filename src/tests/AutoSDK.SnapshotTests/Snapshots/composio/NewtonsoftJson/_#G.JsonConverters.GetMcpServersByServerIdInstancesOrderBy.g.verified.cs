...
{
    /// <inheritdoc />
    public sealed class GetMcpServersByServerIdInstancesOrderByJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetMcpServersByServerIdInstancesOrderBy>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetMcpServersByServerIdInstancesOrderByExtensions.ToValueString(value));
        }
    }
}
