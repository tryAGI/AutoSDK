//HintName: G.Models.PatchAuthConfigsByNanoidRequestVariant2ToolAccessConfig.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class PatchAuthConfigsByNanoidRequestVariant2ToolAccessConfig
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchAuthConfigsByNanoidRequestVariant2ToolAccessConfig" /> class.
        /// </summary>
        ...
        /// The actions that the user can perform on the auth config. If passed, this will update the actions that the user can perform on the auth config.
        /// </param>
        public PatchAuthConfigsByNanoidRequestVariant2ToolAccessConfig(
