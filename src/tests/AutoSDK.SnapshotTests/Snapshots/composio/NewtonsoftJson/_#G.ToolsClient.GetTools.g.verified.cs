...
namespace G
{
    public partial class ToolsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ToolsPaginated>> GetToolsAsResponseAsync(
            string? toolkitSlug = default,
            string? toolSlugs = default,
            global::G.OneOf<string, global::System.Collections.Generic.IList<string>>? authConfigIds = default,
            global::G.GetToolsImportant? important = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ToolsPaginated.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ToolsPaginated>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ToolsPaginated.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
