...
{
    /// <inheritdoc />
    public sealed class GetAuthConfigsByNanoidResponseAuthSchemeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAuthConfigsByNanoidResponseAuthScheme>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetAuthConfigsByNanoidResponseAuthSchemeExtensions.ToValueString(value));
        }
    }
}
