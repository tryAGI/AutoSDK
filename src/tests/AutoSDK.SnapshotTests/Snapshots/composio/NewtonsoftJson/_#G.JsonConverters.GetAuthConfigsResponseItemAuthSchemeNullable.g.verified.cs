...
{
    /// <inheritdoc />
    public sealed class GetAuthConfigsResponseItemAuthSchemeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAuthConfigsResponseItemAuthScheme?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetAuthConfigsResponseItemAuthSchemeExtensions.ToValueString(value.Value));
            }
        }
    }
}
