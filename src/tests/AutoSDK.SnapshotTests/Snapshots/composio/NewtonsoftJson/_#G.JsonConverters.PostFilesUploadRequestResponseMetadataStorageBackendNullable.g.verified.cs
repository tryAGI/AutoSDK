...
{
    /// <inheritdoc />
    public sealed class PostFilesUploadRequestResponseMetadataStorageBackendNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PostFilesUploadRequestResponseMetadataStorageBackend?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PostFilesUploadRequestResponseMetadataStorageBackendExtensions.ToValueString(value.Value));
            }
        }
    }
}
