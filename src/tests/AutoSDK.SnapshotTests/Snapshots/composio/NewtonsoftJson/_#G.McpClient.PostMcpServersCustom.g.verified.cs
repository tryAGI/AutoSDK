//HintName: G.McpClient.PostMcpServersCustom.g.cs
...
namespace G
{
    public partial class McpClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostMcpServersCustomSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostMcpServersCustomSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostMcpServersCustomSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PostMcpServersCustomSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PostMcpServersCustomSecurityRequirement0,
                s_PostMcpServersCustomSecurityRequirement1,
                s_PostMcpServersCustomSecurityRequirement2,
            };
        partial void PreparePostMcpServersCustomArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.PostMcpServersCustomRequest request);
        partial void PreparePostMcpServersCustomRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.PostMcpServersCustomRequest request);
        partial void ProcessPostMcpServersCustomResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostMcpServersCustomResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostMcpServersCustomResponse> PostMcpServersCustomAsync(

            global::G.PostMcpServersCustomRequest request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostMcpServersCustomAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PostMcpServersCustomResponse>> PostMcpServersCustomAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostMcpServersCustomArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostMcpServersCustomSecurityRequirements,
                operationName: "PostMcpServersCustomAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostMcpServersCustomRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostMcpServersCustomAsync",
                                pathTemplate: "\"/api/v3/mcp/servers/custom\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostMcpServersCustomResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad request. The request body may be invalid, missing required parameters, or contain invalid toolkit identifiers.
                            ...
                            // Forbidden. The authenticated user does not have permission to create MCP servers for this project.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostMcpServersCustomResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PostMcpServersCustomResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PostMcpServersCustomResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PostMcpServersCustomResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostMcpServersCustomAsync(
                request: __request,
                requestOptions: requestOptions,
