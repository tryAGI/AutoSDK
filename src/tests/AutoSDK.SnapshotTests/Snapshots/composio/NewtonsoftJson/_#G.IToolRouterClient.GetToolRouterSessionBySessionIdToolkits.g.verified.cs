...
namespace G
{
    public partial interface IToolRouterClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ToolRouterToolkitsListResponse>> GetToolRouterSessionBySessionIdToolkitsAsResponseAsync(
            string sessionId,
            double? limit = default,
            string? cursor = default,
            global::System.Collections.Generic.IList<string>? toolkits = default,
