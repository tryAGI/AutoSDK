//HintName: G.FilesClient.PostFilesUploadRequest.g.cs
...
namespace G
{
    public partial class FilesClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostFilesUploadRequestSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostFilesUploadRequestSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PostFilesUploadRequestSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PostFilesUploadRequestSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PostFilesUploadRequestSecurityRequirement0,
                s_PostFilesUploadRequestSecurityRequirement1,
                s_PostFilesUploadRequestSecurityRequirement2,
            };
        partial void PreparePostFilesUploadRequestArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.PostFilesUploadRequestRequest request);
        partial void PreparePostFilesUploadRequestRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.PostFilesUploadRequestRequest request);
        partial void ProcessPostFilesUploadRequestResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostFilesUploadRequestResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostFilesUploadRequestResponse> PostFilesUploadRequestAsync(

            global::G.PostFilesUploadRequestRequest request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PostFilesUploadRequestAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PostFilesUploadRequestResponse>> PostFilesUploadRequestAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostFilesUploadRequestArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PostFilesUploadRequestSecurityRequirements,
                operationName: "PostFilesUploadRequestAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PreparePostFilesUploadRequestRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostFilesUploadRequestAsync",
                                pathTemplate: "\"/api/v3/files/upload/request\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostFilesUploadRequestResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostFilesUploadRequestResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PostFilesUploadRequestResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PostFilesUploadRequestResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PostFilesUploadRequestResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostFilesUploadRequestAsync(
                request: __request,
                requestOptions: requestOptions,
