...
namespace G
{
    public partial class ConnectedAccountsClient
    {
        ...
        partial void PreparePostConnectedAccountsByNanoidRefreshRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string nanoid,
            string? redirectUrl,
            global::G.PostConnectedAccountsByNanoidRefreshRequest request);
        partial void ProcessPostConnectedAccountsByNanoidRefreshResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPostConnectedAccountsByNanoidRefreshResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PostConnectedAccountsByNanoidRefreshResponse> PostConnectedAccountsByNanoidRefreshAsync(
            string nanoid,
        ...
        {
            var __response = await PostConnectedAccountsByNanoidRefreshAsResponseAsync(
                nanoid: nanoid,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PostConnectedAccountsByNanoidRefreshResponse>> PostConnectedAccountsByNanoidRefreshAsResponseAsync(
            string nanoid,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePostConnectedAccountsByNanoidRefreshArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PostConnectedAccountsByNanoidRefreshAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessPostConnectedAccountsByNanoidRefreshResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad request - Invalid nanoid format or the account cannot be refreshed in its current state
                            ...
                            // Not implemented - This operation is not supported for the requested connected account or authentication scheme
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPostConnectedAccountsByNanoidRefreshResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PostConnectedAccountsByNanoidRefreshResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PostConnectedAccountsByNanoidRefreshResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PostConnectedAccountsByNanoidRefreshResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PostConnectedAccountsByNanoidRefreshAsync(
                nanoid: nanoid,
                redirectUrl: redirectUrl,
                request: __request,
                requestOptions: requestOptions,
