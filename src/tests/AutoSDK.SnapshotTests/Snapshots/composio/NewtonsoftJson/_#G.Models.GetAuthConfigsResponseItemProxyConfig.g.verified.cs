//HintName: G.Models.GetAuthConfigsResponseItemProxyConfig.g.cs
...
namespace G
{
    ...
    public sealed partial class GetAuthConfigsResponseItemProxyConfig
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetAuthConfigsResponseItemProxyConfig" /> class.
        /// </summary>
        /// <param name="proxyUrl">
        /// The url of the auth proxy
        /// </param>
        ...
        /// The auth key for the auth proxy
        /// </param>
        public GetAuthConfigsResponseItemProxyConfig(
            string proxyUrl,
            string? proxyAuthKey)
        {
