//HintName: G.CommissionPoolClient.GetCommissionPoolById.g.cs

#nullable enable

namespace G
{
    public partial class CommissionPoolClient
    {
        partial void PrepareGetCommissionPoolByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? id,
            ref string? currentCulture);
        partial void PrepareGetCommissionPoolByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? id,
            string? currentCulture);
        partial void ProcessGetCommissionPoolByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCommissionPoolByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CommissionPoolForDetailResponseDto> GetCommissionPoolByIdAsync(
            long? id = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCommissionPoolByIdArguments(
                httpClient: HttpClient,
                id: ref id,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/CommissionPool/id",
            ...
            PrepareGetCommissionPoolByIdRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetCommissionPoolByIdResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetCommissionPoolByIdResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.CommissionPoolForDetailResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.CommissionPoolForDetailResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
