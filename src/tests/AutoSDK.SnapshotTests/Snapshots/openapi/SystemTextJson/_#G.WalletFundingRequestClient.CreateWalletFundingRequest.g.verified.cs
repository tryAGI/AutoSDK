//HintName: G.WalletFundingRequestClient.CreateWalletFundingRequest.g.cs

#nullable enable

namespace G
{
    public partial class WalletFundingRequestClient
    {
        partial void PrepareCreateWalletFundingRequestArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.WalletFundingRequestForCreateRequestDto request);
        partial void PrepareCreateWalletFundingRequestRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.WalletFundingRequestForCreateRequestDto request);
        partial void ProcessCreateWalletFundingRequestResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWalletFundingRequestResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.WalletFundingRequestForCreateResponseDto2> CreateWalletFundingRequestAsync(
            global::G.WalletFundingRequestForCreateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWalletFundingRequestArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/WalletFundingRequest/create",
            ...
            PrepareCreateWalletFundingRequestRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateWalletFundingRequestResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateWalletFundingRequestResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.WalletFundingRequestForCreateResponseDto2.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.WalletFundingRequestForCreateResponseDto2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.WalletFundingRequestForCreateResponseDto2> CreateWalletFundingRequestAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.WalletFundingRequestForCreateRequestDto
            {
                UserId = userId,
                AmountInFiatCurrency = amountInFiatCurrency,
                FiatCurrencyCode = fiatCurrencyCode,
                CryptoCurrencyOptionEnumId = cryptoCurrencyOptionEnumId,
                OrderId = orderId,
                TransactionGroupId = transactionGroupId,
                IsXTera = isXTera,
            };

            return await CreateWalletFundingRequestAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
