//HintName: G.UserClient.ProfileUpdateRequired.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareProfileUpdateRequiredArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref string? currentCulture);
        partial void PrepareProfileUpdateRequiredRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            string? currentCulture);
        partial void ProcessProfileUpdateRequiredResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessProfileUpdateRequiredResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.UserForProfileUpdateRequiredResponseDto> ProfileUpdateRequiredAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareProfileUpdateRequiredArguments(
                httpClient: HttpClient,
                userId: ref userId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/User/profileupdaterequired",
            ...
            PrepareProfileUpdateRequiredRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessProfileUpdateRequiredResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessProfileUpdateRequiredResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.UserForProfileUpdateRequiredResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.UserForProfileUpdateRequiredResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
