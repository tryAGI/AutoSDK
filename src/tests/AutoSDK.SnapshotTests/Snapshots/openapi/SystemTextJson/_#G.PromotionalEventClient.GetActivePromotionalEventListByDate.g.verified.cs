//HintName: G.PromotionalEventClient.GetActivePromotionalEventListByDate.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetActivePromotionalEventListByDateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::System.DateTime? aDate,
            ref string? currentCulture);
        partial void PrepareGetActivePromotionalEventListByDateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::System.DateTime? aDate,
            string? currentCulture);
        partial void ProcessGetActivePromotionalEventListByDateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetActivePromotionalEventListByDateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.PromotionalEventForListActiveByDateResponseDto>> GetActivePromotionalEventListByDateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetActivePromotionalEventListByDateArguments(
                httpClient: HttpClient,
                aDate: ref aDate,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/PromotionalEvent/getactivebydate",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("aDate", aDate?.ToString("yyyy-MM-ddTHH:mm:ssZ")) 
                ; 
            ...
            PrepareGetActivePromotionalEventListByDateRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetActivePromotionalEventListByDateResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetActivePromotionalEventListByDateResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.PromotionalEventForListActiveByDateResponseDto>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.PromotionalEventForListActiveByDateResponseDto>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
