//HintName: G.RanksClient.GetRankSummaryByUserId.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetRankSummaryByUserIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref long? rankPeriodId,
            ref string? currentCulture);
        partial void PrepareGetRankSummaryByUserIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            long? rankPeriodId,
            string? currentCulture);
        partial void ProcessGetRankSummaryByUserIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRankSummaryByUserIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.RankSummaryResponseDto> GetRankSummaryByUserIdAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRankSummaryByUserIdArguments(
                httpClient: HttpClient,
                userId: ref userId,
                rankPeriodId: ref rankPeriodId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Ranks/by-userid",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("UserId", userId?.ToString()) 
                .AddOptionalParameter("RankPeriodId", rankPeriodId?.ToString()) 
                ; 
            ...
            PrepareGetRankSummaryByUserIdRequest(
                httpClient: HttpClient,
                httpRequestMessage: __httpRequest,
                userId: userId,
                rankPeriodId: rankPeriodId,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetRankSummaryByUserIdResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetRankSummaryByUserIdResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.RankSummaryResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.RankSummaryResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
