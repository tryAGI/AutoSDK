//HintName: G.FundTransferRequestClient.GetFundTransferChargeExemptUsers.g.cs

#nullable enable

namespace G
{
    public partial class FundTransferRequestClient
    {
        partial void PrepareGetFundTransferChargeExemptUsersArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref string? currentCulture);
        partial void PrepareGetFundTransferChargeExemptUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            string? currentCulture);
        partial void ProcessGetFundTransferChargeExemptUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFundTransferChargeExemptUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.FundTransferChargeExemptUserResponseDto> GetFundTransferChargeExemptUsersAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFundTransferChargeExemptUsersArguments(
                httpClient: HttpClient,
                userId: ref userId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/FundTransferRequest/exempt-user",
            ...
            PrepareGetFundTransferChargeExemptUsersRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetFundTransferChargeExemptUsersResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetFundTransferChargeExemptUsersResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.FundTransferChargeExemptUserResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.FundTransferChargeExemptUserResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
