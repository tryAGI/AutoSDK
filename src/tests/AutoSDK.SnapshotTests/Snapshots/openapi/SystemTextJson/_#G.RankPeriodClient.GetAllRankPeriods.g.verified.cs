//HintName: G.RankPeriodClient.GetAllRankPeriods.g.cs

#nullable enable

namespace G
{
    public partial class RankPeriodClient
    {
        partial void PrepareGetAllRankPeriodsArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? rankAchievementForListRequestDto,
            ref string? currentCulture);
        partial void PrepareGetAllRankPeriodsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? rankAchievementForListRequestDto,
            string? currentCulture);
        partial void ProcessGetAllRankPeriodsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAllRankPeriodsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.RankPeriodsForListResponseDto>> GetAllRankPeriodsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAllRankPeriodsArguments(
                httpClient: HttpClient,
                rankAchievementForListRequestDto: rankAchievementForListRequestDto,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/RankPeriod/all",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("rankAchievementForListRequestDto", rankAchievementForListRequestDto?.ToString()) 
                ; 
            ...
            PrepareGetAllRankPeriodsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetAllRankPeriodsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetAllRankPeriodsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.RankPeriodsForListResponseDto>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.RankPeriodsForListResponseDto>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
