//HintName: G.Models.ProductForListResponseDto.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class ProductForListResponseDto
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductForListResponseDto" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public ProductForListResponseDto(
            long? id,
            string? name,
            double? price,
