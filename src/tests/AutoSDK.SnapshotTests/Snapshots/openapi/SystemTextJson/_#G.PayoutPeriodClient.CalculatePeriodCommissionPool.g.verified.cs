//HintName: G.PayoutPeriodClient.CalculatePeriodCommissionPool.g.cs

#nullable enable

namespace G
{
    public partial class PayoutPeriodClient
    {
        partial void PrepareCalculatePeriodCommissionPoolArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.PayoutPeriodForCalculateCommissionsRequestDto request);
        partial void PrepareCalculatePeriodCommissionPoolRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.PayoutPeriodForCalculateCommissionsRequestDto request);
        partial void ProcessCalculatePeriodCommissionPoolResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCalculatePeriodCommissionPoolResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CalculatePeriodCommissionPoolAsync(
            global::G.PayoutPeriodForCalculateCommissionsRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCalculatePeriodCommissionPoolArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/PayoutPeriod/calculate",
            ...
            PrepareCalculatePeriodCommissionPoolRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCalculatePeriodCommissionPoolResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCalculatePeriodCommissionPoolResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> CalculatePeriodCommissionPoolAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PayoutPeriodForCalculateCommissionsRequestDto
            {
                PayoutPeriodId = payoutPeriodId,
                FastWeeklyVolumes = fastWeeklyVolumes,
            };

            return await CalculatePeriodCommissionPoolAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
