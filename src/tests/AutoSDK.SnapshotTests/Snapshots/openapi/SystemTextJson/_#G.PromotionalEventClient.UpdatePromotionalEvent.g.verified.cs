//HintName: G.PromotionalEventClient.UpdatePromotionalEvent.g.cs

#nullable enable

namespace G
{
    public partial class PromotionalEventClient
    {
        partial void PrepareUpdatePromotionalEventArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.PromotionalEventForUpdateRequestDto request);
        partial void PrepareUpdatePromotionalEventRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.PromotionalEventForUpdateRequestDto request);
        partial void ProcessUpdatePromotionalEventResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdatePromotionalEventResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdatePromotionalEventAsync(
            global::G.PromotionalEventForUpdateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdatePromotionalEventArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/PromotionalEvent/update",
            ...
            PrepareUpdatePromotionalEventRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdatePromotionalEventResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdatePromotionalEventResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdatePromotionalEventAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PromotionalEventForUpdateRequestDto
            {
                PromotionalEventImages = promotionalEventImages,
                Id = id,
                Name = name,
                StartDate = startDate,
                EndDate = endDate,
                PromotionTypeEnumId = promotionTypeEnumId,
            ...
            return await UpdatePromotionalEventAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
