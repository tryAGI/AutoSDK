//HintName: G.OrdersClient.CheckUpgradeToMembership365.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCheckUpgradeToMembership365Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref double? customPrice,
            ref string? currentCulture);
        partial void PrepareCheckUpgradeToMembership365Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            double? customPrice,
            string? currentCulture);
        partial void ProcessCheckUpgradeToMembership365Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckUpgradeToMembership365ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CheckUpgradeToMembership365ResponseDto> CheckUpgradeToMembership365Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCheckUpgradeToMembership365Arguments(
                httpClient: HttpClient,
                customPrice: ref customPrice,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/orders/check-upgrade-to-membership-365",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("CustomPrice", customPrice?.ToString()) 
                ; 
            ...
            PrepareCheckUpgradeToMembership365Request(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCheckUpgradeToMembership365Response(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCheckUpgradeToMembership365ResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.CheckUpgradeToMembership365ResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.CheckUpgradeToMembership365ResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
