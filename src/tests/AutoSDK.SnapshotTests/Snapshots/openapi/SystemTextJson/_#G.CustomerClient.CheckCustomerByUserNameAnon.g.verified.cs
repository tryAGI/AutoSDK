//HintName: G.CustomerClient.CheckCustomerByUserNameAnon.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCheckCustomerByUserNameAnonArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? userName,
            ref global::G.UserNameSearchModeEnum? searchMode,
            ref long? id,
            ref string? currentCulture);
        partial void PrepareCheckCustomerByUserNameAnonRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? userName,
            global::G.UserNameSearchModeEnum? searchMode,
            long? id,
            string? currentCulture);
        partial void ProcessCheckCustomerByUserNameAnonResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCheckCustomerByUserNameAnonResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CustomerForDetailResponseDto> CheckCustomerByUserNameAnonAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCheckCustomerByUserNameAnonArguments(
            ...
            var __pathBuilder = new PathBuilder(
                path: "/api/Customer/user-name-anon",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("UserName", userName) 
                .AddOptionalParameter("SearchMode", searchMode?.ToValueString()) 
            ...
            PrepareCheckCustomerByUserNameAnonRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCheckCustomerByUserNameAnonResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCheckCustomerByUserNameAnonResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.CustomerForDetailResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.CustomerForDetailResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
