//HintName: G.FundWithdrawalRequestClient.BulkApproveFundWithdrawalRequests.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareBulkApproveFundWithdrawalRequestsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.FundWithdrawalRequestBulkApproveRequestDto request);
        partial void PrepareBulkApproveFundWithdrawalRequestsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.FundWithdrawalRequestBulkApproveRequestDto request);
        partial void ProcessBulkApproveFundWithdrawalRequestsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBulkApproveFundWithdrawalRequestsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.FundWithdrawalRequestBulkApproveResponseDto> BulkApproveFundWithdrawalRequestsAsync(
            global::G.FundWithdrawalRequestBulkApproveRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareBulkApproveFundWithdrawalRequestsArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/FundWithdrawalRequest/bulk-approve",
            ...
            PrepareBulkApproveFundWithdrawalRequestsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessBulkApproveFundWithdrawalRequestsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessBulkApproveFundWithdrawalRequestsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.FundWithdrawalRequestBulkApproveResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.FundWithdrawalRequestBulkApproveResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.FundWithdrawalRequestBulkApproveResponseDto> BulkApproveFundWithdrawalRequestsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.FundWithdrawalRequestBulkApproveRequestDto
            {
                Ids = ids,
            };

            return await BulkApproveFundWithdrawalRequestsAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
