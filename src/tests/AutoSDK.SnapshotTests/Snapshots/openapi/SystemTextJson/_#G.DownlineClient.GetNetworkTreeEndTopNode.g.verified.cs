//HintName: G.DownlineClient.GetNetworkTreeEndTopNode.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetNetworkTreeEndTopNodeArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::G.NetworkTreeSide2 side,
            ref int levelsToDisplay,
            ref string? currentCulture);
        partial void PrepareGetNetworkTreeEndTopNodeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.NetworkTreeSide2 side,
            int levelsToDisplay,
            string? currentCulture);
        partial void ProcessGetNetworkTreeEndTopNodeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetNetworkTreeEndTopNodeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.NetworkTreeEndTopNodeResponseDto> GetNetworkTreeEndTopNodeAsync(
            global::G.NetworkTreeSide2 side,
            int levelsToDisplay,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetNetworkTreeEndTopNodeArguments(
                httpClient: HttpClient,
                side: ref side,
                levelsToDisplay: ref levelsToDisplay,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/downline/for-tree-end-topnode",
            ...
            PrepareGetNetworkTreeEndTopNodeRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetNetworkTreeEndTopNodeResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetNetworkTreeEndTopNodeResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.NetworkTreeEndTopNodeResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.NetworkTreeEndTopNodeResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
