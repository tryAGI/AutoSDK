//HintName: G.PayoutDetailsItemClient.GetAllPaginated.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetAllPaginatedArguments(
        ...
        partial void PrepareGetAllPaginatedRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetAllPaginatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAllPaginatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedResponseDtoOfPayoutDetailsItemForListResponseDto> GetAllPaginatedAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAllPaginatedArguments(
            ...
            var __pathBuilder = new PathBuilder(
                path: "/api/PayoutDetailsItem/paginated",
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetAllPaginatedResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetAllPaginatedResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.PaginatedResponseDtoOfPayoutDetailsItemForListResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.PaginatedResponseDtoOfPayoutDetailsItemForListResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
