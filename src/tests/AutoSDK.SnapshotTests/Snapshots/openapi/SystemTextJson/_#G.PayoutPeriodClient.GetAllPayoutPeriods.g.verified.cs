//HintName: G.PayoutPeriodClient.GetAllPayoutPeriods.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetAllPayoutPeriodsArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? payoutPeriodForListRequestDto,
            ref string? currentCulture);
        partial void PrepareGetAllPayoutPeriodsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? payoutPeriodForListRequestDto,
            string? currentCulture);
        partial void ProcessGetAllPayoutPeriodsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAllPayoutPeriodsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.PayoutPeriodForListResponseDto>> GetAllPayoutPeriodsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAllPayoutPeriodsArguments(
                httpClient: HttpClient,
                payoutPeriodForListRequestDto: payoutPeriodForListRequestDto,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/PayoutPeriod/all",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("PayoutPeriodForListRequestDto", payoutPeriodForListRequestDto?.ToString()) 
                ; 
            ...
            PrepareGetAllPayoutPeriodsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetAllPayoutPeriodsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetAllPayoutPeriodsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.PayoutPeriodForListResponseDto>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.PayoutPeriodForListResponseDto>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
