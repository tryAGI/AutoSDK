//HintName: G.ProductSubscriptionClient.GetProductSubscription.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetProductSubscriptionArguments(
        ...
        partial void PrepareGetProductSubscriptionRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetProductSubscriptionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProductSubscriptionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedResponseDtoOfProductSubscriptionForListResponseDto> GetProductSubscriptionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProductSubscriptionArguments(
            ...
            var __pathBuilder = new PathBuilder(
                path: "/api/ProductSubscription/all",
            ...
            __pathBuilder 
                ...
                .AddOptionalParameter("ProductTypeId", productTypeId?.ToString()) 
            ...
            PrepareGetProductSubscriptionRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetProductSubscriptionResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetProductSubscriptionResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.PaginatedResponseDtoOfProductSubscriptionForListResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.PaginatedResponseDtoOfProductSubscriptionForListResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
