//HintName: G.UserClient.ResetSecurityWords.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareResetSecurityWordsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref string? currentCulture);
        partial void PrepareResetSecurityWordsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            string? currentCulture);
        partial void ProcessResetSecurityWordsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResetSecurityWordsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.SecurityWordsForDetailResponseDto> ResetSecurityWordsAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareResetSecurityWordsArguments(
                httpClient: HttpClient,
                userId: ref userId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/User/resetSecurityWords",
            ...
            PrepareResetSecurityWordsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessResetSecurityWordsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessResetSecurityWordsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.SecurityWordsForDetailResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.SecurityWordsForDetailResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
