//HintName: G.FundWithdrawalRequestClient.UpdateFundWithdrawalRequest.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateFundWithdrawalRequestArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.FundWithdrawalRequestForUpdateRequestDto request);
        partial void PrepareUpdateFundWithdrawalRequestRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.FundWithdrawalRequestForUpdateRequestDto request);
        partial void ProcessUpdateFundWithdrawalRequestResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateFundWithdrawalRequestResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateFundWithdrawalRequestAsync(
            global::G.FundWithdrawalRequestForUpdateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateFundWithdrawalRequestArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/FundWithdrawalRequest/update",
            ...
            PrepareUpdateFundWithdrawalRequestRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateFundWithdrawalRequestResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateFundWithdrawalRequestResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateFundWithdrawalRequestAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.FundWithdrawalRequestForUpdateRequestDto
            {
                Id = id,
                UserId = userId,
                ...
                UsdtWithdrawalAddress = usdtWithdrawalAddress,
                TusdtWithdrawalAddress = tusdtWithdrawalAddress,
                CebotWithdrawalAddress = cebotWithdrawalAddress,
                WithdrawalAddressIdEnum = withdrawalAddressIdEnum,
                DonationAmount = donationAmount,
            };

            return await UpdateFundWithdrawalRequestAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
