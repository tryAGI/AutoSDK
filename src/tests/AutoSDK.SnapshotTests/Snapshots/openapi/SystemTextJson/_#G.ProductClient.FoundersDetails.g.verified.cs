//HintName: G.ProductClient.FoundersDetails.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareFoundersDetailsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.ProductFoundersForListRequestDto request);
        partial void PrepareFoundersDetailsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.ProductFoundersForListRequestDto request);
        partial void ProcessFoundersDetailsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFoundersDetailsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ProductFoundersForListResponseDto> FoundersDetailsAsync(
            global::G.ProductFoundersForListRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareFoundersDetailsArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/Product/founders-details",
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessFoundersDetailsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessFoundersDetailsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.ProductFoundersForListResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.ProductFoundersForListResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.ProductFoundersForListResponseDto> FoundersDetailsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.ProductFoundersForListRequestDto
            {
                UserId = userId,
            };

            return await FoundersDetailsAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
