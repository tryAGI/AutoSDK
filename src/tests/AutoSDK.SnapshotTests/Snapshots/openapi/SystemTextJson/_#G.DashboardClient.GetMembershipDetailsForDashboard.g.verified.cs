//HintName: G.DashboardClient.GetMembershipDetailsForDashboard.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetMembershipDetailsForDashboardArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? request,
            ref string? currentCulture);
        partial void PrepareGetMembershipDetailsForDashboardRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? request,
            string? currentCulture);
        partial void ProcessGetMembershipDetailsForDashboardResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMembershipDetailsForDashboardResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.MembershipDetailsForDashboardResponseDto> GetMembershipDetailsForDashboardAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMembershipDetailsForDashboardArguments(
                httpClient: HttpClient,
                request: request,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Dashboard/membershipDetailsForDashboard",
            ...
            PrepareGetMembershipDetailsForDashboardRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetMembershipDetailsForDashboardResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetMembershipDetailsForDashboardResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.MembershipDetailsForDashboardResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.MembershipDetailsForDashboardResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
