//HintName: G.PayoutDetailsItemVolumeBoostClient.CreatePayoutDetailsItemVolumeBoost.g.cs

#nullable enable

namespace G
{
    public partial class PayoutDetailsItemVolumeBoostClient
    {
        partial void PrepareCreatePayoutDetailsItemVolumeBoostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.PayoutDetailsItemVolumeBoostForCreateRequestDto request);
        partial void PrepareCreatePayoutDetailsItemVolumeBoostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.PayoutDetailsItemVolumeBoostForCreateRequestDto request);
        partial void ProcessCreatePayoutDetailsItemVolumeBoostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePayoutDetailsItemVolumeBoostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PayoutDetailsItemVolumeBoostForCreateResponseDto> CreatePayoutDetailsItemVolumeBoostAsync(
            global::G.PayoutDetailsItemVolumeBoostForCreateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePayoutDetailsItemVolumeBoostArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/PayoutDetailsItemVolumeBoost/create",
            ...
            PrepareCreatePayoutDetailsItemVolumeBoostRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreatePayoutDetailsItemVolumeBoostResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreatePayoutDetailsItemVolumeBoostResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.PayoutDetailsItemVolumeBoostForCreateResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.PayoutDetailsItemVolumeBoostForCreateResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.PayoutDetailsItemVolumeBoostForCreateResponseDto> CreatePayoutDetailsItemVolumeBoostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PayoutDetailsItemVolumeBoostForCreateRequestDto
            {
                UserId = userId,
                PayoutPeriodId = payoutPeriodId,
                Leg1Volume = leg1Volume,
                Leg2Volume = leg2Volume,
                ApplyUpLine = applyUpLine,
            };

            return await CreatePayoutDetailsItemVolumeBoostAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
