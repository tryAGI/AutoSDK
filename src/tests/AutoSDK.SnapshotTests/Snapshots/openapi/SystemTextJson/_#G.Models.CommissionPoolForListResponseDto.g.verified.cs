//HintName: G.Models.CommissionPoolForListResponseDto.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CommissionPoolForListResponseDto
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommissionPoolForListResponseDto" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CommissionPoolForListResponseDto(
            long? id,
            string? poolName,
            int? volumeRequired,
