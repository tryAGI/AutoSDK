//HintName: G.DashboardClient.ReferralRankAchievementPromoSummary.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareReferralRankAchievementPromoSummaryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref int? requiredRankId,
            ref global::System.DateTime? startDate,
            ref global::System.DateTime? endDate,
            ref string? currentCulture);
        partial void PrepareReferralRankAchievementPromoSummaryRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessReferralRankAchievementPromoSummaryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReferralRankAchievementPromoSummaryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ReferralRankAchievementPromoSummaryResponseDto> ReferralRankAchievementPromoSummaryAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReferralRankAchievementPromoSummaryArguments(
                httpClient: HttpClient,
                userId: ref userId,
                requiredRankId: ref requiredRankId,
                startDate: ref startDate,
                endDate: ref endDate,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Dashboard/referralRankAchievementPromoSummary",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("UserId", userId?.ToString()) 
                .AddOptionalParameter("RequiredRankId", requiredRankId?.ToString()) 
            ...
            PrepareReferralRankAchievementPromoSummaryRequest(
                httpClient: HttpClient,
                httpRequestMessage: __httpRequest,
                userId: userId,
                requiredRankId: requiredRankId,
                startDate: startDate,
                endDate: endDate,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessReferralRankAchievementPromoSummaryResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessReferralRankAchievementPromoSummaryResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.ReferralRankAchievementPromoSummaryResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.ReferralRankAchievementPromoSummaryResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
