//HintName: G.WalletTransactionClient.PayoutWeeklyCommissions.g.cs
...
namespace G
{
    ...
    {
        partial void PreparePayoutWeeklyCommissionsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.WalletTransactionForPayoutCommissionsRequestDto request);
        partial void PreparePayoutWeeklyCommissionsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.WalletTransactionForPayoutCommissionsRequestDto request);
        partial void ProcessPayoutWeeklyCommissionsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPayoutWeeklyCommissionsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> PayoutWeeklyCommissionsAsync(
            global::G.WalletTransactionForPayoutCommissionsRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePayoutWeeklyCommissionsArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/WalletTransaction/payout",
            ...
            PreparePayoutWeeklyCommissionsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPayoutWeeklyCommissionsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessPayoutWeeklyCommissionsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> PayoutWeeklyCommissionsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.WalletTransactionForPayoutCommissionsRequestDto
            {
                PayoutPeriodId = payoutPeriodId,
            };

            return await PayoutWeeklyCommissionsAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
