//HintName: G.DashboardClient.GetTotalNetworkVolumeForDashboard.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetTotalNetworkVolumeForDashboardArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref string? currentCulture);
        partial void PrepareGetTotalNetworkVolumeForDashboardRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            string? currentCulture);
        partial void ProcessGetTotalNetworkVolumeForDashboardResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetTotalNetworkVolumeForDashboardResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetTotalNetworkVolumeResponseDto> GetTotalNetworkVolumeForDashboardAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTotalNetworkVolumeForDashboardArguments(
                httpClient: HttpClient,
                userId: ref userId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Dashboard/totalNetworkVolumeForDashboard",
            ...
            PrepareGetTotalNetworkVolumeForDashboardRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetTotalNetworkVolumeForDashboardResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetTotalNetworkVolumeForDashboardResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.GetTotalNetworkVolumeResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.GetTotalNetworkVolumeResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
