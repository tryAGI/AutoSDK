//HintName: G.WalletTransactionClient.BTCCurrentRate.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareBTCCurrentRateArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? request,
            ref string? currentCulture);
        partial void PrepareBTCCurrentRateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? request,
            string? currentCulture);
        partial void ProcessBTCCurrentRateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBTCCurrentRateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.BTCForCurrentRateResponseDto> BTCCurrentRateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareBTCCurrentRateArguments(
                httpClient: HttpClient,
                request: request,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/WalletTransaction/btc-rate",
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessBTCCurrentRateResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.BTCForCurrentRateResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.BTCForCurrentRateResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
