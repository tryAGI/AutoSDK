//HintName: G.DashboardClient.TurboBoosterDisplay.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareTurboBoosterDisplayArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref string? currentCulture);
        partial void PrepareTurboBoosterDisplayRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            string? currentCulture);
        partial void ProcessTurboBoosterDisplayResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTurboBoosterDisplayResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.NetworkTreeForTurboBoosterListResponseDto> TurboBoosterDisplayAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTurboBoosterDisplayArguments(
                httpClient: HttpClient,
                userId: ref userId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Dashboard/turbo-booster-display",
            ...
            PrepareTurboBoosterDisplayRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessTurboBoosterDisplayResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessTurboBoosterDisplayResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.NetworkTreeForTurboBoosterListResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.NetworkTreeForTurboBoosterListResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
