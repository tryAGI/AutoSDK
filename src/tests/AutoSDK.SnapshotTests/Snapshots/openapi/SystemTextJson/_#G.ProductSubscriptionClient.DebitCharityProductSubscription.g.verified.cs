//HintName: G.ProductSubscriptionClient.DebitCharityProductSubscription.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareDebitCharityProductSubscriptionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.ProductSubscriptionForDebitCharityRequestDto request);
        partial void PrepareDebitCharityProductSubscriptionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.ProductSubscriptionForDebitCharityRequestDto request);
        partial void ProcessDebitCharityProductSubscriptionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDebitCharityProductSubscriptionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DebitCharityProductSubscriptionAsync(
            global::G.ProductSubscriptionForDebitCharityRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDebitCharityProductSubscriptionArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/ProductSubscription/debit-charity",
            ...
            PrepareDebitCharityProductSubscriptionRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessDebitCharityProductSubscriptionResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessDebitCharityProductSubscriptionResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> DebitCharityProductSubscriptionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.ProductSubscriptionForDebitCharityRequestDto
            {
                AdminId = adminId,
                DebitAmount = debitAmount,
            };

            return await DebitCharityProductSubscriptionAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
