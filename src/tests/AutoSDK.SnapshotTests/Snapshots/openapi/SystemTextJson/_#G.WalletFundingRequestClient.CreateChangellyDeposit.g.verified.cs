//HintName: G.WalletFundingRequestClient.CreateChangellyDeposit.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCreateChangellyDepositArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.CreateChagellyDepositRequestDto request);
        partial void PrepareCreateChangellyDepositRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.CreateChagellyDepositRequestDto request);
        partial void ProcessCreateChangellyDepositResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateChangellyDepositResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CreateChagellyDepositResponseDto> CreateChangellyDepositAsync(
            global::G.CreateChagellyDepositRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateChangellyDepositArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/WalletFundingRequest/createChangellyDeposit",
            ...
            PrepareCreateChangellyDepositRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreateChangellyDepositResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateChangellyDepositResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.CreateChagellyDepositResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.CreateChagellyDepositResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.CreateChagellyDepositResponseDto> CreateChangellyDepositAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.CreateChagellyDepositRequestDto
            {
                UserId = userId,
                Amount = amount,
            ...
            return await CreateChangellyDepositAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
