//HintName: G.WalletFundingRequestClient.GetByWalletTypePaginated.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetByWalletTypePaginatedArguments(
            ...
            ref long? userId,
            ref string? username,
            ref string? bTCAddress,
            ref int? walletTypeIdEnum,
            ref int? walletTypeIdEnum2,
            ref int? walletTypeIdEnum3,
            ref int? pageNumber,
            ref int? pageSize,
        ...
        partial void PrepareGetByWalletTypePaginatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? walletTypeIdEnum2,
            int? walletTypeIdEnum3,
            int? pageNumber,
            int? pageSize,
        ...
        partial void ProcessGetByWalletTypePaginatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetByWalletTypePaginatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedResponseDtoOfWalletFundingRequestForPaginatedListResponseDto> GetByWalletTypePaginatedAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetByWalletTypePaginatedArguments(
                httpClient: HttpClient,
                fromDate: ref fromDate,
                toDate: ref toDate,
                isReceived: ref isReceived,
                userId: ref userId,
                username: ref username,
                bTCAddress: ref bTCAddress,
                walletTypeIdEnum: ref walletTypeIdEnum,
                walletTypeIdEnum2: ref walletTypeIdEnum2,
                walletTypeIdEnum3: ref walletTypeIdEnum3,
            ...
            var __pathBuilder = new PathBuilder(
                path: "/api/WalletFundingRequest/deposits-paginated",
            ...
            __pathBuilder 
                ...
                .AddOptionalParameter("IsReceived", isReceived?.ToString()) 
                .AddOptionalParameter("UserId", userId?.ToString()) 
                .AddOptionalParameter("Username", username) 
                .AddOptionalParameter("BTCAddress", bTCAddress) 
                .AddOptionalParameter("WalletTypeIdEnum", walletTypeIdEnum?.ToString()) 
                .AddOptionalParameter("WalletTypeIdEnum2", walletTypeIdEnum2?.ToString()) 
                .AddOptionalParameter("WalletTypeIdEnum3", walletTypeIdEnum3?.ToString()) 
            ...
            PrepareGetByWalletTypePaginatedRequest(
                httpClient: HttpClient,
                ...
                walletTypeIdEnum2: walletTypeIdEnum2,
                walletTypeIdEnum3: walletTypeIdEnum3,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetByWalletTypePaginatedResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetByWalletTypePaginatedResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.PaginatedResponseDtoOfWalletFundingRequestForPaginatedListResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.PaginatedResponseDtoOfWalletFundingRequestForPaginatedListResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
