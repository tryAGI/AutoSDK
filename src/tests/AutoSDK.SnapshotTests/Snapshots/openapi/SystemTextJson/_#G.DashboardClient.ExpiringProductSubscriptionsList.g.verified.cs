//HintName: G.DashboardClient.ExpiringProductSubscriptionsList.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareExpiringProductSubscriptionsListArguments(
            global::System.Net.Http.HttpClient httpClient,
            object? request,
            ref string? currentCulture);
        partial void PrepareExpiringProductSubscriptionsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object? request,
            string? currentCulture);
        partial void ProcessExpiringProductSubscriptionsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessExpiringProductSubscriptionsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<global::G.ExpiringProductSubscriptionsListResponseDto>> ExpiringProductSubscriptionsListAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareExpiringProductSubscriptionsListArguments(
                httpClient: HttpClient,
                request: request,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Dashboard/expiring-product-subscriptions",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("request", request?.ToString()) 
                ; 
            ...
            PrepareExpiringProductSubscriptionsListRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessExpiringProductSubscriptionsListResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessExpiringProductSubscriptionsListResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::System.Text.Json.JsonSerializer.Deserialize<global::System.Collections.Generic.IList<global::G.ExpiringProductSubscriptionsListResponseDto>?>(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Collections.Generic.IList<global::G.ExpiringProductSubscriptionsListResponseDto>?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
