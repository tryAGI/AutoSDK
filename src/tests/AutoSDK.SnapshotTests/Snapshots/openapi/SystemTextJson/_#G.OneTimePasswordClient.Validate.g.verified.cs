//HintName: G.OneTimePasswordClient.Validate.g.cs

#nullable enable

namespace G
{
    public partial class OneTimePasswordClient
    {
        partial void PrepareValidateArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref int? validationCode,
        ...
        public async global::System.Threading.Tasks.Task<global::G.OneTimePasswordForValidateResponseDto> ValidateAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareValidateArguments(
                ...
                userId: ref userId,
                validationCode: ref validationCode,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/OneTimePassword/validate",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("UserId", userId?.ToString()) 
                .AddOptionalParameter("ValidationCode", validationCode?.ToString()) 
                ; 
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::G.OneTimePasswordForValidateResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.OneTimePasswordForValidateResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
