//HintName: G.ProductSubscriptionClient.ChangeAutoRenew.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareChangeAutoRenewArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.ProductSubscriptionForChangeAutoRenewOptionRequestDto request);
        partial void PrepareChangeAutoRenewRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.ProductSubscriptionForChangeAutoRenewOptionRequestDto request);
        partial void ProcessChangeAutoRenewResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChangeAutoRenewResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ChangeAutoRenewAsync(
            global::G.ProductSubscriptionForChangeAutoRenewOptionRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChangeAutoRenewArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/ProductSubscription/auto-renew",
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessChangeAutoRenewResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessChangeAutoRenewResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> ChangeAutoRenewAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.ProductSubscriptionForChangeAutoRenewOptionRequestDto
            {
                UserId = userId,
            ...
            return await ChangeAutoRenewAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
