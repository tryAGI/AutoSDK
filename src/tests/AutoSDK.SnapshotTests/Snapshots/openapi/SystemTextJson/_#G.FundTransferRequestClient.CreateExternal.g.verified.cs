//HintName: G.FundTransferRequestClient.CreateExternal.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCreateExternalArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.FundTransferExternalRequestForCreateRequestDto request);
        partial void PrepareCreateExternalRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.FundTransferExternalRequestForCreateRequestDto request);
        partial void ProcessCreateExternalResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateExternalResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateExternalAsync(
            global::G.FundTransferExternalRequestForCreateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateExternalArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/FundTransferRequest/create-external",
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreateExternalResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> CreateExternalAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.FundTransferExternalRequestForCreateRequestDto
            {
                UserId = userId,
                OriginWalletTypeEnumId = originWalletTypeEnumId,
                WalletTypeEnumId = walletTypeEnumId,
                DestinationWalletUserId = destinationWalletUserId,
                Amount = amount,
                TransferChargePercent = transferChargePercent,
            };

            return await CreateExternalAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
