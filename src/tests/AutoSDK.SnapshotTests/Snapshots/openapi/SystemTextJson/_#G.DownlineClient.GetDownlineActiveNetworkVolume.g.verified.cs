//HintName: G.DownlineClient.GetDownlineActiveNetworkVolume.g.cs

#nullable enable

namespace G
{
    public partial class DownlineClient
    {
        partial void PrepareGetDownlineActiveNetworkVolumeArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? rankId,
            ref global::G.NetworkTreeSide? side,
            ref int? pageNumber,
            ref int? pageSize,
        ...
        partial void PrepareGetDownlineActiveNetworkVolumeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? rankId,
            global::G.NetworkTreeSide? side,
            int? pageNumber,
            int? pageSize,
        ...
        partial void ProcessGetDownlineActiveNetworkVolumeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetDownlineActiveNetworkVolumeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ActiveNetworkVolumePaginatedResponseDto> GetDownlineActiveNetworkVolumeAsync(
            long? rankId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetDownlineActiveNetworkVolumeArguments(
            ...
            var __pathBuilder = new PathBuilder(
                path: "/api/downline/active-network-volume",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("RankId", rankId?.ToString()) 
                .AddOptionalParameter("Side", side?.ToValueString()) 
            ...
            PrepareGetDownlineActiveNetworkVolumeRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetDownlineActiveNetworkVolumeResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetDownlineActiveNetworkVolumeResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.ActiveNetworkVolumePaginatedResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.ActiveNetworkVolumePaginatedResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
