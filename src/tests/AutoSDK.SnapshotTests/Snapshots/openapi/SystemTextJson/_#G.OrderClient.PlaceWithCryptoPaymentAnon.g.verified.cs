//HintName: G.OrderClient.PlaceWithCryptoPaymentAnon.g.cs
...
namespace G
{
    ...
    {
        partial void PreparePlaceWithCryptoPaymentAnonArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.OrderForPlaceWithCryptoPaymentRequestDto request);
        partial void PreparePlaceWithCryptoPaymentAnonRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.OrderForPlaceWithCryptoPaymentRequestDto request);
        partial void ProcessPlaceWithCryptoPaymentAnonResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPlaceWithCryptoPaymentAnonResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.OrderForPlaceWithCryptoPaymentResponseDto> PlaceWithCryptoPaymentAnonAsync(
            global::G.OrderForPlaceWithCryptoPaymentRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePlaceWithCryptoPaymentAnonArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/Order/place-with-crypto-payment-anon",
            ...
            PreparePlaceWithCryptoPaymentAnonRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPlaceWithCryptoPaymentAnonResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessPlaceWithCryptoPaymentAnonResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.OrderForPlaceWithCryptoPaymentResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.OrderForPlaceWithCryptoPaymentResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.OrderForPlaceWithCryptoPaymentResponseDto> PlaceWithCryptoPaymentAnonAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.OrderForPlaceWithCryptoPaymentRequestDto
            {
                CryptoOptionEnumId = cryptoOptionEnumId,
                ShopModeIsInfin8Direct = shopModeIsInfin8Direct,
                ShopModeIsBlackCard = shopModeIsBlackCard,
            ...
            return await PlaceWithCryptoPaymentAnonAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
