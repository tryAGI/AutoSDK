//HintName: G.WalletTransactionClient.GetWalletBalance.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetWalletBalanceArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref int? walletTypeIdEnum,
            ref long? productSubscriptionId,
            ref string? currentCulture);
        partial void PrepareGetWalletBalanceRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetWalletBalanceResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetWalletBalanceResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.WalletTransactionForBalanceResponseDto> GetWalletBalanceAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetWalletBalanceArguments(
                httpClient: HttpClient,
                userId: ref userId,
                walletTypeIdEnum: ref walletTypeIdEnum,
                productSubscriptionId: ref productSubscriptionId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/WalletTransaction/wallet-balance",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("UserId", userId?.ToString()) 
                .AddOptionalParameter("WalletTypeIdEnum", walletTypeIdEnum?.ToString()) 
                .AddOptionalParameter("ProductSubscriptionId", productSubscriptionId?.ToString()) 
                ; 
            ...
            PrepareGetWalletBalanceRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetWalletBalanceResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetWalletBalanceResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.WalletTransactionForBalanceResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.WalletTransactionForBalanceResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
