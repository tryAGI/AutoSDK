//HintName: G.ProductSubscriptionClient.GetProductsSubscriptionSales.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetProductsSubscriptionSalesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? productId,
            ref int? productTypeEnumId,
            ref string? currentCulture);
        partial void PrepareGetProductsSubscriptionSalesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? productId,
            int? productTypeEnumId,
            string? currentCulture);
        partial void ProcessGetProductsSubscriptionSalesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProductsSubscriptionSalesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ProductSubscriptionForSalesResponseDto> GetProductsSubscriptionSalesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetProductsSubscriptionSalesArguments(
                httpClient: HttpClient,
                productId: ref productId,
                productTypeEnumId: ref productTypeEnumId,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/ProductSubscription/sales",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("ProductId", productId?.ToString()) 
                .AddOptionalParameter("ProductTypeEnumId", productTypeEnumId?.ToString()) 
                ; 
            ...
            PrepareGetProductsSubscriptionSalesRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetProductsSubscriptionSalesResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetProductsSubscriptionSalesResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.ProductSubscriptionForSalesResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.ProductSubscriptionForSalesResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
