//HintName: G.DownlineClient.GetMostRightOrLeftNode.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetMostRightOrLeftNodeArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::G.NetworkTreeSide2 side,
            ref string? currentCulture);
        partial void PrepareGetMostRightOrLeftNodeRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.NetworkTreeSide2 side,
            string? currentCulture);
        partial void ProcessGetMostRightOrLeftNodeResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMostRightOrLeftNodeResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.MostRightOrLeftResponseDto> GetMostRightOrLeftNodeAsync(
            global::G.NetworkTreeSide2 side,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMostRightOrLeftNodeArguments(
                httpClient: HttpClient,
                side: ref side,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/downline/most-right-left",
            ...
            PrepareGetMostRightOrLeftNodeRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetMostRightOrLeftNodeResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetMostRightOrLeftNodeResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.MostRightOrLeftResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.MostRightOrLeftResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
