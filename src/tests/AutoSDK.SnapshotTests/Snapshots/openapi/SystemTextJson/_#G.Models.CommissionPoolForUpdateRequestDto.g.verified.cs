//HintName: G.Models.CommissionPoolForUpdateRequestDto.g.cs
...
namespace G
{
    ...
    public sealed partial class CommissionPoolForUpdateRequestDto
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommissionPoolForUpdateRequestDto" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public CommissionPoolForUpdateRequestDto(
            long? id,
            string? poolName,
            int? volumeRequired,
