//HintName: G.PromotionalEventClient.GetPromotionalEventById.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetPromotionalEventByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? id,
            ref string? currentCulture);
        partial void PrepareGetPromotionalEventByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? id,
            string? currentCulture);
        partial void ProcessGetPromotionalEventByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetPromotionalEventByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PromotionalEventForDetailResponseDto> GetPromotionalEventByIdAsync(
            long? id = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetPromotionalEventByIdArguments(
                httpClient: HttpClient,
                id: ref id,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/PromotionalEvent/by-id",
            ...
            PrepareGetPromotionalEventByIdRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetPromotionalEventByIdResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetPromotionalEventByIdResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.PromotionalEventForDetailResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.PromotionalEventForDetailResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
