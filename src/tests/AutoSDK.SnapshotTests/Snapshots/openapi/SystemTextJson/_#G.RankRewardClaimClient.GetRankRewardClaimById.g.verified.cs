//HintName: G.RankRewardClaimClient.GetRankRewardClaimById.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetRankRewardClaimByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? id,
            ref string? currentCulture);
        partial void PrepareGetRankRewardClaimByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? id,
            string? currentCulture);
        partial void ProcessGetRankRewardClaimByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetRankRewardClaimByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.RankRewardClaimForDetailResponseDto> GetRankRewardClaimByIdAsync(
            long? id = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetRankRewardClaimByIdArguments(
                httpClient: HttpClient,
                id: ref id,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/RankRewardClaim/id",
            ...
            PrepareGetRankRewardClaimByIdRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetRankRewardClaimByIdResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetRankRewardClaimByIdResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.RankRewardClaimForDetailResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.RankRewardClaimForDetailResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
