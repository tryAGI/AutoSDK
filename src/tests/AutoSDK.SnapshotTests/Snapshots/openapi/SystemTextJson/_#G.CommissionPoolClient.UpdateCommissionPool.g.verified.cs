//HintName: G.CommissionPoolClient.UpdateCommissionPool.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateCommissionPoolArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.CommissionPoolForUpdateRequestDto request);
        partial void PrepareUpdateCommissionPoolRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.CommissionPoolForUpdateRequestDto request);
        partial void ProcessUpdateCommissionPoolResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateCommissionPoolResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCommissionPoolAsync(
            global::G.CommissionPoolForUpdateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateCommissionPoolArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/CommissionPool/update",
            ...
            PrepareUpdateCommissionPoolRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateCommissionPoolResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateCommissionPoolResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCommissionPoolAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.CommissionPoolForUpdateRequestDto
            {
                Id = id,
                PoolName = poolName,
                VolumeRequired = volumeRequired,
                ActivePackageValueRequired = activePackageValueRequired,
                PercentageRevenueShare = percentageRevenueShare,
                CurrentAchievers = currentAchievers,
                CurrentEstimatedRevenue = currentEstimatedRevenue,
            };

            return await UpdateCommissionPoolAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
