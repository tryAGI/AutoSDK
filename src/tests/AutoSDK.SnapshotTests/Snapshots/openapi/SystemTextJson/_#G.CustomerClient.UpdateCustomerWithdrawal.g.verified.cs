//HintName: G.CustomerClient.UpdateCustomerWithdrawal.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateCustomerWithdrawalArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.CustomerForUpdateWithdrawalRequestDto request);
        partial void PrepareUpdateCustomerWithdrawalRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.CustomerForUpdateWithdrawalRequestDto request);
        partial void ProcessUpdateCustomerWithdrawalResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateCustomerWithdrawalResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCustomerWithdrawalAsync(
            global::G.CustomerForUpdateWithdrawalRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateCustomerWithdrawalArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/Customer/update-withdrawal",
            ...
            PrepareUpdateCustomerWithdrawalRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateCustomerWithdrawalResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateCustomerWithdrawalResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateCustomerWithdrawalAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.CustomerForUpdateWithdrawalRequestDto
            {
                Id = id,
                BtcAddress = btcAddress,
                UsdtAddress = usdtAddress,
                TusdtAddress = tusdtAddress,
                Xtera = xtera,
            };

            return await UpdateCustomerWithdrawalAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
