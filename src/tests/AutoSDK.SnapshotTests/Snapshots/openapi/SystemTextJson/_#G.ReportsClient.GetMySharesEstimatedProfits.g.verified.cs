//HintName: G.ReportsClient.GetMySharesEstimatedProfits.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetMySharesEstimatedProfitsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref double? initialAmount,
            ref global::System.DateTime? startDate,
            ref int? numberOfMonths,
            ref string? currentCulture);
        partial void PrepareGetMySharesEstimatedProfitsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetMySharesEstimatedProfitsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMySharesEstimatedProfitsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetMySharesEstimatedProfitsResponseDto> GetMySharesEstimatedProfitsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMySharesEstimatedProfitsArguments(
                httpClient: HttpClient,
                initialAmount: ref initialAmount,
                startDate: ref startDate,
                numberOfMonths: ref numberOfMonths,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/reports/my-shares/estimated-profits",
                baseUri: HttpClient.BaseAddress); 
            __pathBuilder 
                .AddOptionalParameter("InitialAmount", initialAmount?.ToString()) 
                .AddOptionalParameter("StartDate", startDate?.ToString("yyyy-MM-ddTHH:mm:ssZ")) 
                .AddOptionalParameter("NumberOfMonths", numberOfMonths?.ToString()) 
                ; 
            ...
            PrepareGetMySharesEstimatedProfitsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetMySharesEstimatedProfitsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetMySharesEstimatedProfitsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.GetMySharesEstimatedProfitsResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.GetMySharesEstimatedProfitsResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
