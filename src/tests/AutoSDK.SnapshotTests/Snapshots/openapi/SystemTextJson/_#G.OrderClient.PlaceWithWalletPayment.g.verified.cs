//HintName: G.OrderClient.PlaceWithWalletPayment.g.cs
...
namespace G
{
    ...
    {
        partial void PreparePlaceWithWalletPaymentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.OrderForPlaceWithWalletPaymentRequestDto request);
        partial void PreparePlaceWithWalletPaymentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.OrderForPlaceWithWalletPaymentRequestDto request);
        partial void ProcessPlaceWithWalletPaymentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPlaceWithWalletPaymentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.OrderForPlaceWithWalletPaymentResponseDto> PlaceWithWalletPaymentAsync(
            global::G.OrderForPlaceWithWalletPaymentRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePlaceWithWalletPaymentArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/Order/place-with-wallet-payment",
            ...
            PreparePlaceWithWalletPaymentRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPlaceWithWalletPaymentResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessPlaceWithWalletPaymentResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.OrderForPlaceWithWalletPaymentResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.OrderForPlaceWithWalletPaymentResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.OrderForPlaceWithWalletPaymentResponseDto> PlaceWithWalletPaymentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.OrderForPlaceWithWalletPaymentRequestDto
            {
                WalletTypeEnumId = walletTypeEnumId,
                ShopModeIsInfin8Direct = shopModeIsInfin8Direct,
                SecondWalletTypeEnumId = secondWalletTypeEnumId,
                UserId = userId,
                LineItems = lineItems,
                AppPurchase = appPurchase,
            };

            return await PlaceWithWalletPaymentAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
