//HintName: G.WalletFundingRequestClient.GetChangellyOffersAnon.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetChangellyOffersAnonArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? userId,
            ref double? amount,
            ref string? currentCulture);
        partial void PrepareGetChangellyOffersAnonRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? userId,
            double? amount,
            string? currentCulture);
        partial void ProcessGetChangellyOffersAnonResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetChangellyOffersAnonResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetChangellyOffersResponseDto> GetChangellyOffersAnonAsync(
            long? userId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetChangellyOffersAnonArguments(
            ...
            var __pathBuilder = new PathBuilder(
                path: "/api/WalletFundingRequest/getChangellyOffers-anon",
            ...
            PrepareGetChangellyOffersAnonRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetChangellyOffersAnonResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetChangellyOffersAnonResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.GetChangellyOffersResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.GetChangellyOffersResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
