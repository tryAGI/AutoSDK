//HintName: G.Models.PayoutPeriodForListResponseDto.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class PayoutPeriodForListResponseDto
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayoutPeriodForListResponseDto" /> class.
        /// </summary>
        /// <param name="id"></param>
...
#endif
        public PayoutPeriodForListResponseDto(
            long? id,
