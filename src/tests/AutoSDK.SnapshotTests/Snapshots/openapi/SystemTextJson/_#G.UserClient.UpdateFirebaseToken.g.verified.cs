//HintName: G.UserClient.UpdateFirebaseToken.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateFirebaseTokenArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.UserForUpdateFirebaseTokenRequestDto request);
        partial void PrepareUpdateFirebaseTokenRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.UserForUpdateFirebaseTokenRequestDto request);
        partial void ProcessUpdateFirebaseTokenResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateFirebaseTokenResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateFirebaseTokenAsync(
            global::G.UserForUpdateFirebaseTokenRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateFirebaseTokenArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/User/updateFirebaseToken",
            ...
            PrepareUpdateFirebaseTokenRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateFirebaseTokenResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateFirebaseTokenResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateFirebaseTokenAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UserForUpdateFirebaseTokenRequestDto
            {
                Id = id,
                FirebaseNotificationToken = firebaseNotificationToken,
            };

            return await UpdateFirebaseTokenAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
