//HintName: G.UserClient.UpdateUserLanguage.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareUpdateUserLanguageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.UserForUpdateLanguageRequestDto request);
        partial void PrepareUpdateUserLanguageRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.UserForUpdateLanguageRequestDto request);
        partial void ProcessUpdateUserLanguageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateUserLanguageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateUserLanguageAsync(
            global::G.UserForUpdateLanguageRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateUserLanguageArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/User/updateUserLanguage",
            ...
            PrepareUpdateUserLanguageRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessUpdateUserLanguageResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessUpdateUserLanguageResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> UpdateUserLanguageAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UserForUpdateLanguageRequestDto
            {
                Id = id,
                Language = language,
            };

            return await UpdateUserLanguageAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
