//HintName: G.PromotionalEventClient.CreatePromotionalEvent.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareCreatePromotionalEventArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.PromotionalEventForCreateRequestDto request);
        partial void PrepareCreatePromotionalEventRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.PromotionalEventForCreateRequestDto request);
        partial void ProcessCreatePromotionalEventResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePromotionalEventResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PromotionalEventForCreateResponseDto> CreatePromotionalEventAsync(
            global::G.PromotionalEventForCreateRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePromotionalEventArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/PromotionalEvent/create",
            ...
            PrepareCreatePromotionalEventRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessCreatePromotionalEventResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessCreatePromotionalEventResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.PromotionalEventForCreateResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.PromotionalEventForCreateResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.PromotionalEventForCreateResponseDto> CreatePromotionalEventAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PromotionalEventForCreateRequestDto
            {
                Images = images,
                Id = id,
                Name = name,
            ...
            return await CreatePromotionalEventAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
