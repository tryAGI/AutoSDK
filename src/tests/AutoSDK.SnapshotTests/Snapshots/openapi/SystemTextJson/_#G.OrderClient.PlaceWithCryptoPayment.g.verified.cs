//HintName: G.OrderClient.PlaceWithCryptoPayment.g.cs
...
namespace G
{
    ...
    {
        partial void PreparePlaceWithCryptoPaymentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? currentCulture,
            global::G.OrderForPlaceWithCryptoPaymentRequestDto request);
        partial void PreparePlaceWithCryptoPaymentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? currentCulture,
            global::G.OrderForPlaceWithCryptoPaymentRequestDto request);
        partial void ProcessPlaceWithCryptoPaymentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPlaceWithCryptoPaymentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.OrderForPlaceWithCryptoPaymentResponseDto> PlaceWithCryptoPaymentAsync(
            global::G.OrderForPlaceWithCryptoPaymentRequestDto request,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePlaceWithCryptoPaymentArguments(
                httpClient: HttpClient,
                currentCulture: ref currentCulture,
                request: request);

            var __pathBuilder = new PathBuilder(
                path: "/api/Order/place-with-crypto-payment",
            ...
            PreparePlaceWithCryptoPaymentRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessPlaceWithCryptoPaymentResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessPlaceWithCryptoPaymentResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PlaceWithCryptoPaymentAsync(
                currentCulture: currentCulture,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
