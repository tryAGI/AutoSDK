//HintName: G.CustomerClient.GetCustomerRankById.g.cs
...
namespace G
{
    ...
    {
        partial void PrepareGetCustomerRankByIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref long? id,
            ref string? currentCulture);
        partial void PrepareGetCustomerRankByIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            long? id,
            string? currentCulture);
        partial void ProcessGetCustomerRankByIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetCustomerRankByIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CustomerForRankResponseDto> GetCustomerRankByIdAsync(
            long? id = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetCustomerRankByIdArguments(
                httpClient: HttpClient,
                id: ref id,
                currentCulture: ref currentCulture);

            var __pathBuilder = new PathBuilder(
                path: "/api/Customer/id-rank",
            ...
            PrepareGetCustomerRankByIdRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessGetCustomerRankByIdResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessGetCustomerRankByIdResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                return
                    global::G.CustomerForRankResponseDto.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                return
                    await global::G.CustomerForRankResponseDto.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
