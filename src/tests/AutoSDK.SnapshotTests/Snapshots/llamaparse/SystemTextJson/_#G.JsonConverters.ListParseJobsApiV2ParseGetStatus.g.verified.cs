...
{
    /// <inheritdoc />
    public sealed class ListParseJobsApiV2ParseGetStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListParseJobsApiV2ParseGetStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ListParseJobsApiV2ParseGetStatusExtensions.ToValueString(value));
        }
    }
}
