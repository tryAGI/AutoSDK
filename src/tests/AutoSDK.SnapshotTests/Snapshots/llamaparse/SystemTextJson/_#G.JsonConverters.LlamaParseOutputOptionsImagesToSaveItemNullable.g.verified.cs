...
{
    /// <inheritdoc />
    public sealed class LlamaParseOutputOptionsImagesToSaveItemNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LlamaParseOutputOptionsImagesToSaveItem?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LlamaParseOutputOptionsImagesToSaveItemExtensions.ToValueString(value.Value));
            }
        }
    }
}
