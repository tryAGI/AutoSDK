...
{
    /// <inheritdoc />
    public sealed class SpreadsheetParsingConfigTableMergeSensitivityNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SpreadsheetParsingConfigTableMergeSensitivity?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.SpreadsheetParsingConfigTableMergeSensitivityExtensions.ToValueString(value.Value));
            }
        }
    }
}
