...
namespace G
{
    public partial class FilesClient
    {
        ...
        {
            var __response = await GeneratePresignedUrlApiV1FilesPutAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FileIdPresignedUrl>> GeneratePresignedUrlApiV1FilesPutAsResponseAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.FileIdPresignedUrl.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.FileIdPresignedUrl>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.FileIdPresignedUrl.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
