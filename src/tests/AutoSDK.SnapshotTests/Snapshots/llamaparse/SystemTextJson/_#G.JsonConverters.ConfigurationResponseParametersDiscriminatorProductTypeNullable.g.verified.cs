...
{
    /// <inheritdoc />
    public sealed class ConfigurationResponseParametersDiscriminatorProductTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConfigurationResponseParametersDiscriminatorProductType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ConfigurationResponseParametersDiscriminatorProductTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
