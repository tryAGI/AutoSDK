...
{
    /// <inheritdoc />
    public sealed class RetrievalModeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RetrievalMode>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.RetrievalModeExtensions.ToValueString(value));
        }
    }
}
