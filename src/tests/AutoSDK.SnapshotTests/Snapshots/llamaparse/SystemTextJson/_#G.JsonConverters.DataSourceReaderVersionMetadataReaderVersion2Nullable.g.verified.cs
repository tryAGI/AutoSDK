...
{
    /// <inheritdoc />
    public sealed class DataSourceReaderVersionMetadataReaderVersion2NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DataSourceReaderVersionMetadataReaderVersion2?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.DataSourceReaderVersionMetadataReaderVersion2Extensions.ToValueString(value.Value));
            }
        }
    }
}
