...
{
    /// <inheritdoc />
    public sealed class DataSourceReaderVersionMetadataReaderVersionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DataSourceReaderVersionMetadataReaderVersion>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.DataSourceReaderVersionMetadataReaderVersionExtensions.ToValueString(value));
        }
    }
}
