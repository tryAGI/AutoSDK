...
namespace G
{
    public partial class BetaClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ListSplitJobsApiV1BetaSplitJobsGetSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ListSplitJobsApiV1BetaSplitJobsGetSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_ListSplitJobsApiV1BetaSplitJobsGetSecurityRequirement0,
            };
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListSplitJobsApiV1BetaSplitJobsGet",
                                methodName: "ListSplitJobsApiV1BetaSplitJobsGetAsync",
                                pathTemplate: "\"/api/v1/beta/split/jobs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.SplitJobQueryResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.SplitJobQueryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.SplitJobQueryResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
