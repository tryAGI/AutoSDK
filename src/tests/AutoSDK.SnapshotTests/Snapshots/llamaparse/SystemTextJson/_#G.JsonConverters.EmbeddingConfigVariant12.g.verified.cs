//HintName: G.JsonConverters.EmbeddingConfigVariant12.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class EmbeddingConfigVariant12JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EmbeddingConfigVariant12>
    {
        /// <inheritdoc />
        public override global::G.EmbeddingConfigVariant12 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.PipelineCreateEmbeddingConfigVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.PipelineCreateEmbeddingConfigVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.PipelineCreateEmbeddingConfigVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.AzureOpenAIEmbeddingConfig? azureEmbedding1 = default;
            if (discriminator?.Type == global::G.PipelineCreateEmbeddingConfigVariant1DiscriminatorType.AzureEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.PipelineCreateEmbeddingConfigVariant1DiscriminatorType.CohereEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.PipelineCreateEmbeddingConfigVariant1DiscriminatorType.GeminiEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.PipelineCreateEmbeddingConfigVariant1DiscriminatorType.HuggingfaceApiEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.PipelineCreateEmbeddingConfigVariant1DiscriminatorType.VertexaiEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.PipelineCreateEmbeddingConfigVariant1DiscriminatorType.BedrockEmbedding)
            {
            ...
            var __value = new global::G.EmbeddingConfigVariant12(
                discriminator?.Type,
                azureEmbedding1,
        ...
        public override void Write(
            ...
            global::G.EmbeddingConfigVariant12 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
