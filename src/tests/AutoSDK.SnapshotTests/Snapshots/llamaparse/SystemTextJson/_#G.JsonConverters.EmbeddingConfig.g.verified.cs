//HintName: G.JsonConverters.EmbeddingConfig.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class EmbeddingConfigJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EmbeddingConfig>
    {
        /// <inheritdoc />
        public override global::G.EmbeddingConfig Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.EmbeddingModelConfigEmbeddingConfigDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.EmbeddingModelConfigEmbeddingConfigDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.EmbeddingModelConfigEmbeddingConfigDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.AzureOpenAIEmbeddingConfig? azureEmbedding1 = default;
            if (discriminator?.Type == global::G.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.AzureEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.CohereEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.GeminiEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.HuggingfaceApiEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.VertexaiEmbedding)
            {
            ...
            if (discriminator?.Type == global::G.EmbeddingModelConfigEmbeddingConfigDiscriminatorType.BedrockEmbedding)
            {
            ...
            var __value = new global::G.EmbeddingConfig(
                discriminator?.Type,
                azureEmbedding1,
        ...
        public override void Write(
            ...
            global::G.EmbeddingConfig value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
