...
{
    /// <inheritdoc />
    public sealed class DataSourceReaderVersionMetadataReaderVersion2JsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DataSourceReaderVersionMetadataReaderVersion2>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.DataSourceReaderVersionMetadataReaderVersion2Extensions.ToValueString(value));
        }
    }
}
