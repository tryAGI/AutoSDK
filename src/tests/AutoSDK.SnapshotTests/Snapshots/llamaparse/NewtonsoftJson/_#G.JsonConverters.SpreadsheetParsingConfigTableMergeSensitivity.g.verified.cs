...
{
    /// <inheritdoc />
    public sealed class SpreadsheetParsingConfigTableMergeSensitivityJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SpreadsheetParsingConfigTableMergeSensitivity>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SpreadsheetParsingConfigTableMergeSensitivityExtensions.ToValueString(value));
        }
    }
}
