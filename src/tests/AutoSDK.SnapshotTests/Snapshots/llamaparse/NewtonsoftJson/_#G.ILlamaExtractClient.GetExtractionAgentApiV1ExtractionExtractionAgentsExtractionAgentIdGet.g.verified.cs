...
namespace G
{
    public partial interface ILlamaExtractClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ExtractAgent>> GetExtractionAgentApiV1ExtractionExtractionAgentsExtractionAgentIdGetAsResponseAsync(
            global::System.Guid extractionAgentId,
            string? session = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
