...
{
    /// <inheritdoc />
    public sealed class ExtractConfigurationExtractionTargetNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExtractConfigurationExtractionTarget?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExtractConfigurationExtractionTargetExtensions.ToValueString(value.Value));
            }
        }
    }
}
