...
namespace G
{
    public partial interface ILlamaExtractClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedExtractRunsResponse>> ListExtractRunsApiV1ExtractionRunsGetAsResponseAsync(
            global::System.Guid extractionAgentId,
            int? skip = default,
            int? limit = default,
            string? session = default,
