...
{
    /// <inheritdoc />
    public sealed class RetrievalModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RetrievalMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RetrievalModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
