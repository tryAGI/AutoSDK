...
{
    /// <inheritdoc />
    public sealed class ListExtractJobsApiV2ExtractGetStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListExtractJobsApiV2ExtractGetStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListExtractJobsApiV2ExtractGetStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
