...
{
    /// <inheritdoc />
    public sealed class ParseV2ParametersVersionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ParseV2ParametersVersion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ParseV2ParametersVersionExtensions.ToValueString(value.Value));
            }
        }
    }
}
