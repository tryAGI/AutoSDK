...
namespace G
{
    public partial class LlamaExtractClient
    {
        ...
        {
            var __response = await RunJobOnFileApiV1ExtractionJobsFilePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ExtractJob>> RunJobOnFileApiV1ExtractionJobsFilePostAsResponseAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ExtractJob.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ExtractJob>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ExtractJob.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.BodyRunJobOnFileApiV1ExtractionJobsFilePost
            {
                ExtractionAgentId = extractionAgentId,
