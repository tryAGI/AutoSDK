...
namespace G
{
    public partial interface IPipelineFilesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FileCountByStatusResponse>> GetPipelineFileStatusCountsApiV1PipelinesPipelineIdFilesStatusCountsGetAsResponseAsync(
            global::System.Guid pipelineId,
            global::System.Guid? dataSourceId = default,
            bool? onlyManuallyUploaded = default,
            string? session = default,
