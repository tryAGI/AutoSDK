...
namespace G
{
    public partial interface IClassifierClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ClassifyJobResults>> GetClassificationJobResultsApiV1ClassifierJobsClassifyJobIdResultsGetAsResponseAsync(
            global::System.Guid classifyJobId,
            global::System.Guid? projectId = default,
            global::System.Guid? organizationId = default,
            string? session = default,
