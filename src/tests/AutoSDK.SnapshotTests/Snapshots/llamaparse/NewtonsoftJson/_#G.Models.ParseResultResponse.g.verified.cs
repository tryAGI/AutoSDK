...
namespace G
{
    ...
    public sealed partial class ParseResultResponse
    {
        ...
        public global::G.ParseJobResponse Job { get; set; } = default!;

        /// <summary>
        /// Metadata including size, existence, and presigned URLs for result files
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("result_content_metadata")]
