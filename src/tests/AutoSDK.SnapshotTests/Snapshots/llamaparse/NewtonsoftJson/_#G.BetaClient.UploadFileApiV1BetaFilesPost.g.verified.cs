//HintName: G.BetaClient.UploadFileApiV1BetaFilesPost.g.cs
...
namespace G
{
    public partial class BetaClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_UploadFileApiV1BetaFilesPostSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_UploadFileApiV1BetaFilesPostSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.FileV2> UploadFileApiV1BetaFilesPostAsync(
        ...
        {
            var __response = await UploadFileApiV1BetaFilesPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FileV2>> UploadFileApiV1BetaFilesPostAsResponseAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.FileV2.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.FileV2>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.FileV2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.FileV2> UploadFileApiV1BetaFilesPostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.BodyUploadFileApiV1BetaFilesPost
            {
                Purpose = purpose,
                File = file,
                Filename = filename,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.BodyUploadFileApiV1BetaFilesPost
            {
                Purpose = purpose,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.FileV2.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                }
                                catch (global::System.Exception __ex)
                                {
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.FileV2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
                                        throw new global::System.InvalidOperationException("Response deserialization failed.");
                                }
                                catch (global::System.Exception __ex)
                                {
