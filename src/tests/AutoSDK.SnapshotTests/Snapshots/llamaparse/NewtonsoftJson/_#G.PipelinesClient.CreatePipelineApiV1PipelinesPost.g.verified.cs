//HintName: G.PipelinesClient.CreatePipelineApiV1PipelinesPost.g.cs
...
namespace G
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreatePipelineApiV1PipelinesPostSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreatePipelineApiV1PipelinesPostSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CreatePipelineApiV1PipelinesPostSecurityRequirement0,
            };
        partial void PrepareCreatePipelineApiV1PipelinesPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Guid? projectId,
            global::System.Guid? organizationId,
            ref string? session,
            global::G.PipelineCreate request);
        partial void PrepareCreatePipelineApiV1PipelinesPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? session,
            global::G.PipelineCreate request);
        partial void ProcessCreatePipelineApiV1PipelinesPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreatePipelineApiV1PipelinesPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Pipeline> CreatePipelineApiV1PipelinesPostAsync(
        ...
        {
            var __response = await CreatePipelineApiV1PipelinesPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Pipeline>> CreatePipelineApiV1PipelinesPostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePipelineApiV1PipelinesPostArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePipelineApiV1PipelinesPostSecurityRequirements,
                operationName: "CreatePipelineApiV1PipelinesPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePipelineApiV1PipelinesPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreatePipelineApiV1PipelinesPost",
                                methodName: "CreatePipelineApiV1PipelinesPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePipelineApiV1PipelinesPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreatePipelineApiV1PipelinesPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await CreatePipelineApiV1PipelinesPostAsync(
                projectId: projectId,
                organizationId: organizationId,
                session: session,
                request: __request,
