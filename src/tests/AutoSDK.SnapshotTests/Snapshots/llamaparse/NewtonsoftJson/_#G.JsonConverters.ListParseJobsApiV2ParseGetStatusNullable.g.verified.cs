...
{
    /// <inheritdoc />
    public sealed class ListParseJobsApiV2ParseGetStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListParseJobsApiV2ParseGetStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListParseJobsApiV2ParseGetStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
