...
namespace G
{
    ...
    public sealed partial class CloudSlackDataSource
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("slack_token")]
        public string? SlackToken { get; set; }

        /// <summary>
        /// Slack Channel.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("channel_ids")]
        public string? ChannelIds { get; set; }

        /// <summary>
        /// Latest date.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("latest_date")]
        public string? LatestDate { get; set; }

        /// <summary>
        /// Earliest date.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("earliest_date")]
        public string? EarliestDate { get; set; }

        /// <summary>
        /// Earliest date timestamp.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("earliest_date_timestamp")]
        public double? EarliestDateTimestamp { get; set; }

        /// <summary>
        /// Latest date timestamp.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("latest_date_timestamp")]
        public double? LatestDateTimestamp { get; set; }

        /// <summary>
        /// Slack Channel name pattern.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("channel_patterns")]
