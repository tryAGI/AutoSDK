...
{
    /// <inheritdoc />
    public sealed class LlamaParseOutputOptionsImagesToSaveItemJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LlamaParseOutputOptionsImagesToSaveItem>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LlamaParseOutputOptionsImagesToSaveItemExtensions.ToValueString(value));
        }
    }
}
