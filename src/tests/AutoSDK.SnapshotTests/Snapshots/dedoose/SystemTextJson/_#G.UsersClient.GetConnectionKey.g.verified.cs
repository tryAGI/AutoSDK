                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::System.Text.Json.JsonSerializer.Deserialize<global::System.Guid?>(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::System.Text.Json.JsonSerializer.DeserializeAsync<global::System.Guid?>(__content, JsonSerializerOptions).ConfigureAwait(false) ??
