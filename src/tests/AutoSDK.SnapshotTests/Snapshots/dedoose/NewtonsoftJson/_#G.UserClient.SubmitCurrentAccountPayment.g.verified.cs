...
namespace G
{
    public partial class UserClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SubmitCurrentAccountPaymentSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_SubmitCurrentAccountPaymentSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_SubmitCurrentAccountPaymentSecurityRequirement0,
            };
        ...
        {
            var __response = await SubmitCurrentAccountPaymentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaymentResponse>> SubmitCurrentAccountPaymentAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubmitCurrentAccountPaymentSecurityRequirements,
                operationName: "SubmitCurrentAccountPaymentAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SubmitCurrentAccountPayment",
                                methodName: "SubmitCurrentAccountPaymentAsync",
                                pathTemplate: "\"/api/v1/user/submitcurrentaccountpayment\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaymentResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaymentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaymentResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
