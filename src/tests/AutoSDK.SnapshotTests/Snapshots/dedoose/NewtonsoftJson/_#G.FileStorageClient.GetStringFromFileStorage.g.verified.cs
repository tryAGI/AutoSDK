...
namespace G
{
    public partial class FileStorageClient
    {
        ...
        {
            var __response = await GetStringFromFileStorageAsResponseAsync(
                dataPath: dataPath,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> GetStringFromFileStorageAsResponseAsync(
            string dataPath,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
