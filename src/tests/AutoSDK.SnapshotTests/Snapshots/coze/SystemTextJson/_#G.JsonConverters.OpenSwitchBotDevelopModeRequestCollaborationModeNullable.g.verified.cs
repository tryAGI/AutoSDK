...
{
    /// <inheritdoc />
    public sealed class OpenSwitchBotDevelopModeRequestCollaborationModeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OpenSwitchBotDevelopModeRequestCollaborationMode?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.OpenSwitchBotDevelopModeRequestCollaborationModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
