...
{
    /// <inheritdoc />
    public sealed class EnterMessage1ContentTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EnterMessage1ContentType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.EnterMessage1ContentTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
