...
{
    /// <inheritdoc />
    public sealed class VariableChannelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.VariableChannel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.VariableChannelExtensions.ToValueString(value));
        }
    }
}
