...
{
    /// <inheritdoc />
    public sealed class ModifyMessageApiRequestContentTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModifyMessageApiRequestContentType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ModifyMessageApiRequestContentTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
