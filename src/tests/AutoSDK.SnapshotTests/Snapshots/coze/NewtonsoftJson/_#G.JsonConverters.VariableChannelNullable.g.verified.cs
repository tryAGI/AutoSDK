...
{
    /// <inheritdoc />
    public sealed class VariableChannelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VariableChannel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VariableChannelExtensions.ToValueString(value.Value));
            }
        }
    }
}
