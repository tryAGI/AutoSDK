...
{
    /// <inheritdoc />
    public sealed class EnterMessage1ContentTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EnterMessage1ContentType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.EnterMessage1ContentTypeExtensions.ToValueString(value));
        }
    }
}
