...
{
    /// <inheritdoc />
    public sealed class OpenSwitchBotDevelopModeRequestCollaborationModeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenSwitchBotDevelopModeRequestCollaborationMode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OpenSwitchBotDevelopModeRequestCollaborationModeExtensions.ToValueString(value));
        }
    }
}
