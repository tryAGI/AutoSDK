...
{
    /// <inheritdoc />
    public sealed class ModifyMessageApiRequestContentTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ModifyMessageApiRequestContentType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ModifyMessageApiRequestContentTypeExtensions.ToValueString(value));
        }
    }
}
