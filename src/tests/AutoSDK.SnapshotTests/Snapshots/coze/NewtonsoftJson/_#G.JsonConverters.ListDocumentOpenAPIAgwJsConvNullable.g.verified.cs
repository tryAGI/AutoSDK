...
{
    /// <inheritdoc />
    public sealed class ListDocumentOpenAPIAgwJsConvNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListDocumentOpenAPIAgwJsConv?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListDocumentOpenAPIAgwJsConvExtensions.ToValueString(value.Value));
            }
        }
    }
}
