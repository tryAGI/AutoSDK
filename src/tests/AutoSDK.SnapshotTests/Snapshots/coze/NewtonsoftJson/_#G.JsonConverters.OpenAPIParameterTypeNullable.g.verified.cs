...
{
    /// <inheritdoc />
    public sealed class OpenAPIParameterTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAPIParameterType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OpenAPIParameterTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
