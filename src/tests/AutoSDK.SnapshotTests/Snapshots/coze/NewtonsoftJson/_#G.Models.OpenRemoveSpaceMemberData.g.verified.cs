...
namespace G
{
    ...
    public sealed partial class OpenRemoveSpaceMemberData
    {
        ...
        /// 不在空间的用户不进行处理
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("not_in_workspace_user_ids")]
        public global::System.Collections.Generic.IList<string>? NotInWorkspaceUserIds { get; set; }

        /// <summary>
        /// 空间所有者不进行处理
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("owner_not_support_remove_user_ids")]
        public global::System.Collections.Generic.IList<string>? OwnerNotSupportRemoveUserIds { get; set; }

        /// <summary>
        /// 成功移除的成员列表
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("removed_success_user_ids")]
