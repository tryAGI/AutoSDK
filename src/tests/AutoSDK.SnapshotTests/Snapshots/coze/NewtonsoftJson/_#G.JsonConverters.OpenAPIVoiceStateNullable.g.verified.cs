...
{
    /// <inheritdoc />
    public sealed class OpenAPIVoiceStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAPIVoiceState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OpenAPIVoiceStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
