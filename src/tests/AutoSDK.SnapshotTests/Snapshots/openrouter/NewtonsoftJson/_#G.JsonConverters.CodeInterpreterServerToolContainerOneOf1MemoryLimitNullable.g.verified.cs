...
{
    /// <inheritdoc />
    public sealed class CodeInterpreterServerToolContainerOneOf1MemoryLimitNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CodeInterpreterServerToolContainerOneOf1MemoryLimit?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CodeInterpreterServerToolContainerOneOf1MemoryLimitExtensions.ToValueString(value.Value));
            }
        }
    }
}
