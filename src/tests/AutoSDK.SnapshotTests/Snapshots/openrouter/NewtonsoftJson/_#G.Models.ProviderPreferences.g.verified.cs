//HintName: G.Models.ProviderPreferences.g.cs
...
namespace G
{
    ...
    public sealed partial class ProviderPreferences
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("allow_fallbacks")]
        public bool? AllowFallbacks { get; set; }

        /// <summary>
        /// Whether to filter providers to only those that support the parameters you've provided. If this setting is omitted or set to false, then providers will receive only the parameters they support, and ignore the rest.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("require_parameters")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("zdr")]
        public bool? Zdr { get; set; }

        /// <summary>
        /// Whether to restrict routing to only models that allow text distillation. When true, only models where the author has allowed distillation will be used.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("enforce_distillable_text")]
        ...
        public global::System.Collections.Generic.IList<global::G.ProviderPreferencesOrderItems>? Order { get; set; }

        /// <summary>
        /// List of provider slugs to allow. If provided, this list is merged with your account-wide allowed provider settings for this request.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("only")]
        public global::System.Collections.Generic.IList<global::G.ProviderPreferencesOnlyItems>? Only { get; set; }

        /// <summary>
        /// List of provider slugs to ignore. If provided, this list is merged with your account-wide ignored provider settings for this request.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("ignore")]
        public global::System.Collections.Generic.IList<global::G.ProviderPreferencesIgnoreItems>? Ignore { get; set; }

        /// <summary>
        /// A list of quantization levels to filter the provider by.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("quantizations")]
        ...
        public global::G.ProviderPreferencesSort? Sort { get; set; }

        /// <summary>
        /// The object specifying the maximum price you want to pay for this request. USD price per million tokens, for prompt and completion.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("max_price")]
        public global::G.ProviderPreferencesMaxPrice? MaxPrice { get; set; }

        /// <summary>
        /// Preferred minimum throughput (in tokens per second). Can be a number (applies to p50) or an object with percentile-specific cutoffs. Endpoints below the threshold(s) may still be used, but are deprioritized in routing. When using fallback models, this may cause a fallback model to be used instead of the primary model if it meets the threshold.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("preferred_min_throughput")]
        public global::G.PreferredMinThroughput? PreferredMinThroughput { get; set; }

        /// <summary>
        /// Preferred maximum latency (in seconds). Can be a number (applies to p50) or an object with percentile-specific cutoffs. Endpoints above the threshold(s) may still be used, but are deprioritized in routing. When using fallback models, this may cause a fallback model to be used instead of the primary model if it meets the threshold.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("preferred_max_latency")]
        ...
        public ProviderPreferences(
            ...
            global::System.Collections.Generic.IList<global::G.ProviderPreferencesOrderItems>? order,
            global::System.Collections.Generic.IList<global::G.ProviderPreferencesOnlyItems>? only,
            global::System.Collections.Generic.IList<global::G.ProviderPreferencesIgnoreItems>? ignore,
            global::System.Collections.Generic.IList<global::G.Quantization>? quantizations,
            global::G.ProviderPreferencesSort? sort,
            global::G.ProviderPreferencesMaxPrice? maxPrice,
