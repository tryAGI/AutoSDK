...
{
    /// <inheritdoc />
    public sealed class ChatWebSearchServerToolParametersSearchContextSizeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatWebSearchServerToolParametersSearchContextSize?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatWebSearchServerToolParametersSearchContextSizeExtensions.ToValueString(value.Value));
            }
        }
    }
}
