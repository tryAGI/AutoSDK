...
{
    /// <inheritdoc />
    public sealed class InstructTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InstructType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.InstructTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
