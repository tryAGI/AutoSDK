...
{
    /// <inheritdoc />
    public sealed class MessagesRequestContextManagementEditsItemsOneOf2TriggerTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MessagesRequestContextManagementEditsItemsOneOf2TriggerType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MessagesRequestContextManagementEditsItemsOneOf2TriggerTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
