...
{
    /// <inheritdoc />
    public sealed class ImageGenerationServerToolSizeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ImageGenerationServerToolSize?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ImageGenerationServerToolSizeExtensions.ToValueString(value.Value));
            }
        }
    }
}
