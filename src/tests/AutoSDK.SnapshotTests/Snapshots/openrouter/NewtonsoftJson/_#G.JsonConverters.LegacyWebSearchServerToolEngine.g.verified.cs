...
{
    /// <inheritdoc />
    public sealed class LegacyWebSearchServerToolEngineJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LegacyWebSearchServerToolEngine>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LegacyWebSearchServerToolEngineExtensions.ToValueString(value));
        }
    }
}
