...
{
    /// <inheritdoc />
    public sealed class InputModalityJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InputModality>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.InputModalityExtensions.ToValueString(value));
        }
    }
}
