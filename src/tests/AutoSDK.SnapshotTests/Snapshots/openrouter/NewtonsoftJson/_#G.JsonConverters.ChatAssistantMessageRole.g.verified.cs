...
{
    /// <inheritdoc />
    public sealed class ChatAssistantMessageRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatAssistantMessageRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatAssistantMessageRoleExtensions.ToValueString(value));
        }
    }
}
