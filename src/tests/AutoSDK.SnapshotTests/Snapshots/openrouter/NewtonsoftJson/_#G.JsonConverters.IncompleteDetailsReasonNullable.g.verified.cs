...
{
    /// <inheritdoc />
    public sealed class IncompleteDetailsReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IncompleteDetailsReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.IncompleteDetailsReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
