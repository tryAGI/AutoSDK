...
{
    /// <inheritdoc />
    public sealed class EasyInputMessageRole1NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EasyInputMessageRole1?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EasyInputMessageRole1Extensions.ToValueString(value.Value));
            }
        }
    }
}
