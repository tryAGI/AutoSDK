...
{
    /// <inheritdoc />
    public sealed class BaseMessagesResultRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BaseMessagesResultRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BaseMessagesResultRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
