...
{
    /// <inheritdoc />
    public sealed class MessagesRequestContextManagementEditsItemsOneOf0ClearAtLeastTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MessagesRequestContextManagementEditsItemsOneOf0ClearAtLeastType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.MessagesRequestContextManagementEditsItemsOneOf0ClearAtLeastTypeExtensions.ToValueString(value));
        }
    }
}
