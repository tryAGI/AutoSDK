...
{
    /// <inheritdoc />
    public sealed class ModelArchitectureInstructTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ModelArchitectureInstructType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ModelArchitectureInstructTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
