...
{
    /// <inheritdoc />
    public sealed class OutputServerToolItemStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OutputServerToolItemStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OutputServerToolItemStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
