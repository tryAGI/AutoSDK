...
{
    /// <inheritdoc />
    public sealed class CreateChargeRequestChainIdJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateChargeRequestChainId>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateChargeRequestChainIdExtensions.ToValueString(value));
        }
    }
}
