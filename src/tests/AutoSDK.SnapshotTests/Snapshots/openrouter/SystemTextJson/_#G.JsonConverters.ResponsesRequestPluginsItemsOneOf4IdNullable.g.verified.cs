...
{
    /// <inheritdoc />
    public sealed class ResponsesRequestPluginsItemsOneOf4IdNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponsesRequestPluginsItemsOneOf4Id?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ResponsesRequestPluginsItemsOneOf4IdExtensions.ToValueString(value.Value));
            }
        }
    }
}
