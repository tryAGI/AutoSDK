...
{
    /// <inheritdoc />
    public sealed class MessagesRequestPluginsItemsOneOf0IdNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MessagesRequestPluginsItemsOneOf0Id?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.MessagesRequestPluginsItemsOneOf0IdExtensions.ToValueString(value.Value));
            }
        }
    }
}
