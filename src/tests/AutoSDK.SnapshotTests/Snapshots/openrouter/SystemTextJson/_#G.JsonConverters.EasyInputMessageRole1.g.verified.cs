...
{
    /// <inheritdoc />
    public sealed class EasyInputMessageRole1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EasyInputMessageRole1>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.EasyInputMessageRole1Extensions.ToValueString(value));
        }
    }
}
