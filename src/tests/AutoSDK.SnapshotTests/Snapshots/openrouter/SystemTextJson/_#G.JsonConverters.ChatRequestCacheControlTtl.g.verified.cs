...
{
    /// <inheritdoc />
    public sealed class ChatRequestCacheControlTtlJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatRequestCacheControlTtl>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatRequestCacheControlTtlExtensions.ToValueString(value));
        }
    }
}
