...
{
    /// <inheritdoc />
    public sealed class LegacyWebSearchServerToolEngineNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LegacyWebSearchServerToolEngine?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LegacyWebSearchServerToolEngineExtensions.ToValueString(value.Value));
            }
        }
    }
}
