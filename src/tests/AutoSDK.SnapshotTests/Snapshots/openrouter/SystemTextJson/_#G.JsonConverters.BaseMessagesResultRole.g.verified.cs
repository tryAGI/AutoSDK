...
{
    /// <inheritdoc />
    public sealed class BaseMessagesResultRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BaseMessagesResultRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.BaseMessagesResultRoleExtensions.ToValueString(value));
        }
    }
}
