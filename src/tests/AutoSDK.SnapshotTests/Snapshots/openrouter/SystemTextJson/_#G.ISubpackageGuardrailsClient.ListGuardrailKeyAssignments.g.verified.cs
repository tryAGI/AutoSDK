...
namespace G
{
    public partial interface ISubpackageGuardrailsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GuardrailsListGuardrailKeyAssignmentsResponse200>> ListGuardrailKeyAssignmentsAsResponseAsync(
            global::System.Guid id,
            string? offset = default,
            string? limit = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
