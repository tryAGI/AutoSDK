            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.GuardrailsCreateGuardrailResponse201.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.GuardrailsCreateGuardrailResponse201.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
