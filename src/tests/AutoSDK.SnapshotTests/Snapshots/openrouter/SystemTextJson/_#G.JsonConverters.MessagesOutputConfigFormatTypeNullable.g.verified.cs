...
{
    /// <inheritdoc />
    public sealed class MessagesOutputConfigFormatTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MessagesOutputConfigFormatType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.MessagesOutputConfigFormatTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
