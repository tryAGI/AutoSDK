...
{
    /// <inheritdoc />
    public sealed class BaseMessagesResultContentItemsOneOf9TypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BaseMessagesResultContentItemsOneOf9Type?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.BaseMessagesResultContentItemsOneOf9TypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
