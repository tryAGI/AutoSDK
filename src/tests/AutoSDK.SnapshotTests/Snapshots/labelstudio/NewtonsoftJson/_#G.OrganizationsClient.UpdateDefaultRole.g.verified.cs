...
namespace G
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_UpdateDefaultRoleSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_UpdateDefaultRoleSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_UpdateDefaultRoleSecurityRequirement0,
            };
        ...
        {
            var __response = await UpdateDefaultRoleAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DefaultRole>> UpdateDefaultRoleAsResponseAsync(
            int id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateDefaultRoleSecurityRequirements,
                operationName: "UpdateDefaultRoleAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UpdateDefaultRole",
                                methodName: "UpdateDefaultRoleAsync",
                                pathTemplate: "$\"/api/organizations/{id}/set-default-role\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DefaultRole.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DefaultRole>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DefaultRole.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
