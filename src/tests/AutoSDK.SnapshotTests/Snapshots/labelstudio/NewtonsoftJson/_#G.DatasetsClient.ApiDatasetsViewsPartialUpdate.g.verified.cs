...
namespace G
{
    public partial class DatasetsClient
    {
        ...
        {
            var __response = await ApiDatasetsViewsPartialUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DatasetView>> ApiDatasetsViewsPartialUpdateAsResponseAsync(
            string id,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiDatasetsViewsPartialUpdate",
                                methodName: "ApiDatasetsViewsPartialUpdateAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DatasetView.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DatasetView>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DatasetView.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
