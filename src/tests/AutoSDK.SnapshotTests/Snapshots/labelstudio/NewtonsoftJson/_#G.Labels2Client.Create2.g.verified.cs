//HintName: G.Labels2Client.Create2.g.cs
...
namespace G
{
    public partial class Labels2Client
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedLabelCreateList> Create2Async(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedLabelCreateList>> Create2AsResponseAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaginatedLabelCreateList.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaginatedLabelCreateList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaginatedLabelCreateList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
