...
namespace G
{
    public partial class StatsClient
    {
        ...
        {
            var __response = await UserReviewScoreAsResponseAsync(
                id: id,
                userPk: userPk,
                perLabel: perLabel,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ApiProjectsUserStatsReviewScoreRetrieve2Response>> UserReviewScoreAsResponseAsync(
            int id,
            int userPk,
            bool? perLabel = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "UserReviewScore",
                                methodName: "UserReviewScoreAsync",
                                pathTemplate: "$\"/api/projects/{id}/user-stats/{userPk}/review_score\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ApiProjectsUserStatsReviewScoreRetrieve2Response.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ApiProjectsUserStatsReviewScoreRetrieve2Response>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ApiProjectsUserStatsReviewScoreRetrieve2Response.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
