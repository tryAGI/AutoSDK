//HintName: G.ProjectsClient.Create2.g.cs
...
namespace G
{
    public partial class ProjectsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.LseProjectParams> Create2Async(
            int id,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/api/projects/{id}/project-extra-params/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.LseProjectParams.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.LseProjectParams.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
