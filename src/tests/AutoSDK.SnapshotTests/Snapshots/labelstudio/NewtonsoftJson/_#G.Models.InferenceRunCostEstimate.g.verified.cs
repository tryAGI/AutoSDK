...
namespace G
{
    ...
    public sealed partial class InferenceRunCostEstimate
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("completion_cost_usd")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("prompt_cost_usd")]
        public string? PromptCostUsd { get; set; }

        /// <summary>
        /// Total cost of the inference (in USD)
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("total_cost_usd")]
