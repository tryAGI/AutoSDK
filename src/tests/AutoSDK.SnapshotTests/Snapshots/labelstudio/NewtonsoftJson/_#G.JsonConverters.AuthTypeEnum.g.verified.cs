...
{
    /// <inheritdoc />
    public sealed class AuthTypeEnumJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AuthTypeEnum>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AuthTypeEnumExtensions.ToValueString(value));
        }
    }
}
