//HintName: G.LabelsClient.List.g.cs
...
namespace G
{
    public partial class LabelsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedLabelLinkList> ListAsync(
            int? page = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.PaginatedLabelLinkList.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.PaginatedLabelLinkList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
