...
{
    /// <inheritdoc />
    public sealed class Options165EnumNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.Options165Enum?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.Options165EnumExtensions.ToValueString(value.Value));
            }
        }
    }
}
