...
{
    /// <inheritdoc />
    public sealed class OrganizationMemberTagImportStatusStatusEnumNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrganizationMemberTagImportStatusStatusEnum?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OrganizationMemberTagImportStatusStatusEnumExtensions.ToValueString(value.Value));
            }
        }
    }
}
