...
namespace G
{
    public partial class DimensionsClient
    {
        ...
        {
            var __response = await ApiProjectsDimensionsUpdateAsResponseAsync(
                id: id,
                projectPk: projectPk,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Dimension>> ApiProjectsDimensionsUpdateAsResponseAsync(
            int id,
            int projectPk,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiProjectsDimensionsUpdate",
                                methodName: "ApiProjectsDimensionsUpdateAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Dimension.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.Dimension>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Dimension.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
