...
{
    /// <inheritdoc />
    public sealed class ScopeEnumNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ScopeEnum?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ScopeEnumExtensions.ToValueString(value.Value));
            }
        }
    }
}
