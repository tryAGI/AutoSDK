...
{
    /// <inheritdoc />
    public sealed class ApiProjectsTasksAssigneesDestroyTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ApiProjectsTasksAssigneesDestroyType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ApiProjectsTasksAssigneesDestroyTypeExtensions.ToValueString(value));
        }
    }
}
