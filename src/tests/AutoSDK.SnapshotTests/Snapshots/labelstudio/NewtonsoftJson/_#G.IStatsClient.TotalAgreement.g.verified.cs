...
namespace G
{
    public partial interface IStatsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OneOf<global::G.ApiProjectsStatsTotalAgreementRetrieveResponseVariant1, global::G.ApiProjectsStatsTotalAgreementRetrieveResponseVariant2>>> TotalAgreementAsResponseAsync(
            int id,
            bool? perLabel = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
