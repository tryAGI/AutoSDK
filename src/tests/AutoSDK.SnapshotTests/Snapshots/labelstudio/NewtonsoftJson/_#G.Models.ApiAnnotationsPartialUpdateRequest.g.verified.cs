//HintName: G.Models.ApiAnnotationsPartialUpdateRequest.g.cs
...
namespace G
{
    ...
    public sealed partial class ApiAnnotationsPartialUpdateRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiAnnotationsPartialUpdateRequest" /> class.
        /// </summary>
        ...
        /// User skipped the task
        /// </param>
        public ApiAnnotationsPartialUpdateRequest(
            int? completedBy,
            bool? groundTruth,
            double? leadTime,
            int? project,
