...
namespace G
{
    public partial class DataExplorerClient
    {
        ...
        {
            var __response = await ApiDatasetsTasksRetrieveAsResponseAsync(
                dataset: dataset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DatasetView>> ApiDatasetsTasksRetrieveAsResponseAsync(
            int? dataset = default,
            double? maxThreshold = default,
            double? minThreshold = default,
            int? page = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiDatasetsTasksRetrieve",
                                methodName: "ApiDatasetsTasksRetrieveAsync",
                                pathTemplate: "\"/api/datasets/tasks\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
