//HintName: G.IPausesClient.Create.g.cs
#nullable enable
...
namespace G
{
    public partial interface IPausesClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.Pause> CreateAsync(
            int projectPk,
            int userPk,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Pause>> CreateAsResponseAsync(
            int projectPk,
            int userPk,
