...
namespace G
{
    public partial interface IStatsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ApiProjectsUsersStatsAgreementGroundtruthRetrieveResponse>> UserGroundTruthAgreementAsResponseAsync(
            int id,
            int userPk,
            bool? perLabel = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
