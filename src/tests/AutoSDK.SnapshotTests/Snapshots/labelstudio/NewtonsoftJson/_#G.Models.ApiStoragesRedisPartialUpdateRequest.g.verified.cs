//HintName: G.Models.ApiStoragesRedisPartialUpdateRequest.g.cs
...
namespace G
{
    ...
    public sealed partial class ApiStoragesRedisPartialUpdateRequest
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiStoragesRedisPartialUpdateRequest" /> class.
        /// </summary>
        ...
        /// Default Value: false
        /// </param>
        public ApiStoragesRedisPartialUpdateRequest(
            string? description,
            string? host,
            string? password,
            string? path,
