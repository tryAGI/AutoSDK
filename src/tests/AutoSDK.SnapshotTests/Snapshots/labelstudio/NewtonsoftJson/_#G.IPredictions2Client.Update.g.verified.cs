//HintName: G.IPredictions2Client.Update.g.cs
#nullable enable
...
namespace G
{
    public partial interface IPredictions2Client
    {
        ...
        global::System.Threading.Tasks.Task<global::G.Prediction> UpdateAsync(
            int id,

            global::G.ApiPredictionsPartialUpdateRequest request,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Prediction>> UpdateAsResponseAsync(
            int id,
