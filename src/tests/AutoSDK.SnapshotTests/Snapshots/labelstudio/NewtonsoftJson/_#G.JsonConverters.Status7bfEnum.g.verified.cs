...
{
    /// <inheritdoc />
    public sealed class Status7bfEnumJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.Status7bfEnum>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.Status7bfEnumExtensions.ToValueString(value));
        }
    }
}
