...
namespace G
{
    public partial class ProjectsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedPaginatedProjectMemberList>> List2AsResponseAsync(
            int id,
            string? ids = default,
            bool? @implicit = default,
            global::System.DateTime? lastActivityGte = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaginatedPaginatedProjectMemberList.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaginatedPaginatedProjectMemberList>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaginatedPaginatedProjectMemberList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
