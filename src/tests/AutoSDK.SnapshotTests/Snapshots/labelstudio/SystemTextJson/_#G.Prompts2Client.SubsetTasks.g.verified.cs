...
namespace G
{
    public partial class Prompts2Client
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedProjectSubsetTasksResponseList>> SubsetTasksAsResponseAsync(
            int projectPk,
            bool? includeTotal = default,
            int? modelRun = default,
            string? ordering = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaginatedProjectSubsetTasksResponseList.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaginatedProjectSubsetTasksResponseList>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaginatedProjectSubsetTasksResponseList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
