//HintName: G.IDimensionsClient.Get2.g.cs
#nullable enable
...
namespace G
{
    public partial interface IDimensionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.TaskAgreementMatrixResponse>> Get2AsResponseAsync(
            int projectPk,
            global::G.AgreementSelectionRequest selection,
            int taskPk,
            int? dimension = default,
