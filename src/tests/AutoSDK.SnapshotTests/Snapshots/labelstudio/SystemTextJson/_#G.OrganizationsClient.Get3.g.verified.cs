//HintName: G.OrganizationsClient.Get3.g.cs
...
namespace G
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_Get3SecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_Get3SecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.OrganizationMember> Get3Async(
            int id,
            int userPk,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OrganizationMember>> Get3AsResponseAsync(
            int id,
            int userPk,
            bool? contributedToProjects = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/api/organizations/{id}/memberships/{userPk}/\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.OrganizationMember.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.OrganizationMember>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.OrganizationMember.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
