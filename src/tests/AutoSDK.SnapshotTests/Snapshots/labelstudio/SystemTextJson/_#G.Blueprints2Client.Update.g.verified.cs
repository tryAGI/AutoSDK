//HintName: G.Blueprints2Client.Update.g.cs
...
namespace G
{
    public partial class Blueprints2Client
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.Blueprint> UpdateAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.Blueprint.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.Blueprint.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.Blueprint> UpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.PatchedBlueprintUpdateRequest
            {
