                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ApiDatasetStoragesAzureCheckForRecordsCreate",
                                methodName: "ApiDatasetStoragesAzureCheckForRecordsCreateAsync",
                                pathTemplate: "\"/api/dataset-storages/azure/check-for-records/\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
