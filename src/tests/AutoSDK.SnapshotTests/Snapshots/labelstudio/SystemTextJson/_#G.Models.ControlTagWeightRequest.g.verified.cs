//HintName: G.Models.ControlTagWeightRequest.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class ControlTagWeightRequest
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ControlTagWeightRequest" /> class.
        /// </summary>
        /// <param name="overall">
        /// Overall weight for this control tag (0.0 to 1.0). Zero excludes the tag from agreement.
        /// </param>
...
#endif
        public ControlTagWeightRequest(
            double overall,
            string type,
