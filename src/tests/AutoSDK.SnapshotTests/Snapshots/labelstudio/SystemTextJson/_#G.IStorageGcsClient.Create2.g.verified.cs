//HintName: G.IStorageGcsClient.Create2.g.cs
#nullable enable
...
namespace G
{
    public partial interface IStorageGcsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.GCSImportStorage> Create2Async(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GCSImportStorage>> Create2AsResponseAsync(
