...
{
    /// <inheritdoc />
    public sealed class ApiProjectsTasksAssigneesDestroyTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ApiProjectsTasksAssigneesDestroyType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ApiProjectsTasksAssigneesDestroyTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
