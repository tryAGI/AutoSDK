//HintName: G.IStorageS3Client.Update2.g.cs
#nullable enable
...
namespace G
{
    public partial interface IStorageS3Client
    {
        ...
        global::System.Threading.Tasks.Task<global::G.S3ImportStorage> Update2Async(
            int id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.S3ImportStorage>> Update2AsResponseAsync(
            int id,
