//HintName: G.AnnotationHistoryClient.Retrieve.g.cs
...
namespace G
{
    public partial class AnnotationHistoryClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.AnnotationHistory> RetrieveAsync(
            int id,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.AnnotationHistory.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.AnnotationHistory.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
