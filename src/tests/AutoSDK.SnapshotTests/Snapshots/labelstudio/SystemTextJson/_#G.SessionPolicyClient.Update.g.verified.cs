            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.SessionTimeoutPolicy.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.SessionTimeoutPolicy.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
