...
namespace G
{
    public partial interface IActivityLogsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.ActivityLogResponse>>> ListAsResponseAsync(
            string? endDate = default,
            global::G.ApiActivityLogsListMethod? method = default,
            string? ordering = default,
            int? page = default,
