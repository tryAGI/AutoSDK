//HintName: G.Comments2Client.Get.g.cs
...
namespace G
{
    public partial class Comments2Client
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.MaybeExpandedComment> GetAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.MaybeExpandedComment.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.MaybeExpandedComment.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
