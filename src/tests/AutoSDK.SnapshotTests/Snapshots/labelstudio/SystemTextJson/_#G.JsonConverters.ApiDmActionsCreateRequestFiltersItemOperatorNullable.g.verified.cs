...
{
    /// <inheritdoc />
    public sealed class ApiDmActionsCreateRequestFiltersItemOperatorNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ApiDmActionsCreateRequestFiltersItemOperator?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ApiDmActionsCreateRequestFiltersItemOperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
