...
{
    /// <inheritdoc />
    public sealed class OAIModelsResponseObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OAIModelsResponseObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OAIModelsResponseObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
