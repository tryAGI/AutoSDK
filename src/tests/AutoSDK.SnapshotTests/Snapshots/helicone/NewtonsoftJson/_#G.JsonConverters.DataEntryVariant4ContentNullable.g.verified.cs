...
{
    /// <inheritdoc />
    public sealed class DataEntryVariant4ContentNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DataEntryVariant4Content?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DataEntryVariant4ContentExtensions.ToValueString(value.Value));
            }
        }
    }
}
