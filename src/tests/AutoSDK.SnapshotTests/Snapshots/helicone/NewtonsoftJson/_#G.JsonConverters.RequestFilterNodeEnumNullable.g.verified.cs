...
{
    /// <inheritdoc />
    public sealed class RequestFilterNodeEnumNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RequestFilterNodeEnum?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RequestFilterNodeEnumExtensions.ToValueString(value.Value));
            }
        }
    }
}
