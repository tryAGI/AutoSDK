...
{
    /// <inheritdoc />
    public sealed class OpenAIChatRequestMessageToolCallTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAIChatRequestMessageToolCallType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OpenAIChatRequestMessageToolCallTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
