...
{
    /// <inheritdoc />
    public sealed class GetSpendBreakdownTimeRangeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetSpendBreakdownTimeRange>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetSpendBreakdownTimeRangeExtensions.ToValueString(value));
        }
    }
}
