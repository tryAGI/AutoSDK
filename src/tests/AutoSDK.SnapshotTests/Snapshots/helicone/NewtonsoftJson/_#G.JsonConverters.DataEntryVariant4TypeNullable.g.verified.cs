...
{
    /// <inheritdoc />
    public sealed class DataEntryVariant4TypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DataEntryVariant4Type?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DataEntryVariant4TypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
