...
{
    /// <inheritdoc />
    public sealed class EvaluatorStatsRecentTrendNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EvaluatorStatsRecentTrend?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EvaluatorStatsRecentTrendExtensions.ToValueString(value.Value));
            }
        }
    }
}
