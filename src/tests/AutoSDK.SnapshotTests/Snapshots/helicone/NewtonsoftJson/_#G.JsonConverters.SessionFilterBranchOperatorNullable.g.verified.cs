...
{
    /// <inheritdoc />
    public sealed class SessionFilterBranchOperatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SessionFilterBranchOperator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SessionFilterBranchOperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
