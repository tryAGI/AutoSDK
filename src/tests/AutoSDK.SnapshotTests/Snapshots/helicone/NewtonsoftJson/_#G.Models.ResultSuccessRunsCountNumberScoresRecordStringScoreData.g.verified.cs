//HintName: G.Models.ResultSuccessRunsCountNumberScoresRecordStringScoreData.g.cs
...
namespace G
{
    ...
    public sealed partial class ResultSuccessRunsCountNumberScoresRecordStringScoreData
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ResultSuccessRunsCountNumberScoresRecordStringScoreData" /> class.
        /// </summary>
        /// <param name="scores">
        /// Construct a type with a set of properties K of type T
        /// </param>
        /// <param name="runsCount"></param>
        public ResultSuccessRunsCountNumberScoresRecordStringScoreData(
