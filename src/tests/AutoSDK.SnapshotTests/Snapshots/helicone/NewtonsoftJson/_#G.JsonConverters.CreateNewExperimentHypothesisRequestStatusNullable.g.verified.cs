...
{
    /// <inheritdoc />
    public sealed class CreateNewExperimentHypothesisRequestStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateNewExperimentHypothesisRequestStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateNewExperimentHypothesisRequestStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
