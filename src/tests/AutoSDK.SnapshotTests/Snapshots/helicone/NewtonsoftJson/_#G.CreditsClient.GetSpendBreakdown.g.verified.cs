...
namespace G
{
    public partial class CreditsClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_GetSpendBreakdownServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await GetSpendBreakdownAsResponseAsync(
                timeRange: timeRange,
                startDate: startDate,
                endDate: endDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ResultSpendBreakdownResponseString>> GetSpendBreakdownAsResponseAsync(
            global::G.GetSpendBreakdownTimeRange? timeRange = default,
            string? startDate = default,
            string? endDate = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSpendBreakdownAsync",
                                pathTemplate: "\"/v1/credits/spend/breakdown\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ResultSpendBreakdownResponseString.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ResultSpendBreakdownResponseString>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ResultSpendBreakdownResponseString.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
