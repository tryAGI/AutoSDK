...
{
    /// <inheritdoc />
    public sealed class CreateAPIKeyRequestKeyPermissionsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateAPIKeyRequestKeyPermissions?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateAPIKeyRequestKeyPermissionsExtensions.ToValueString(value.Value));
            }
        }
    }
}
