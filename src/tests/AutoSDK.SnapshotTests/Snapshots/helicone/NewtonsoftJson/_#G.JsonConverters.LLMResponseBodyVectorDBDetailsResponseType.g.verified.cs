...
{
    /// <inheritdoc />
    public sealed class LLMResponseBodyVectorDBDetailsResponseTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LLMResponseBodyVectorDBDetailsResponseType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LLMResponseBodyVectorDBDetailsResponseTypeExtensions.ToValueString(value));
        }
    }
}
