...
namespace G.JsonConverters
{
    ...
    public class ResultHeliconeRequestStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResultHeliconeRequestString>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        success = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ResultSuccessHeliconeRequest>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsSuccess)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Success, typeof(global::G.ResultSuccessHeliconeRequest), options);
            }
