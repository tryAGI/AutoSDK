...
{
    /// <inheritdoc />
    public sealed class GetSpendBreakdownTimeRangeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetSpendBreakdownTimeRange?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetSpendBreakdownTimeRangeExtensions.ToValueString(value.Value));
            }
        }
    }
}
