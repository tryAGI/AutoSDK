...
{
    /// <inheritdoc />
    public sealed class Prompt2025VersionPromptBodyMessageToolCallTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Prompt2025VersionPromptBodyMessageToolCallType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.Prompt2025VersionPromptBodyMessageToolCallTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
