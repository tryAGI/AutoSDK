...
{
    /// <inheritdoc />
    public sealed class EvaluatorStatsRecentTrendJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EvaluatorStatsRecentTrend>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.EvaluatorStatsRecentTrendExtensions.ToValueString(value));
        }
    }
}
