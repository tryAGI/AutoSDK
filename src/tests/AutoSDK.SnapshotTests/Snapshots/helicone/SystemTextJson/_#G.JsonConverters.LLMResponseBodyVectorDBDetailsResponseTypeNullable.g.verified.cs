...
{
    /// <inheritdoc />
    public sealed class LLMResponseBodyVectorDBDetailsResponseTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMResponseBodyVectorDBDetailsResponseType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LLMResponseBodyVectorDBDetailsResponseTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
