//HintName: G.Models.ModelGeographicLatencyItem.g.cs
...
namespace G
{
    ...
    public sealed partial class ModelGeographicLatencyItem
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelGeographicLatencyItem" /> class.
        /// </summary>
...
#endif
        public ModelGeographicLatencyItem(
            double median,
            string countryCode)
        {
            this.Median = median;
