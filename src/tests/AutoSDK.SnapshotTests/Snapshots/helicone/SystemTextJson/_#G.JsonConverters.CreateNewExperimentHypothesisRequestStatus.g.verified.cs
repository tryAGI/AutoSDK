...
{
    /// <inheritdoc />
    public sealed class CreateNewExperimentHypothesisRequestStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateNewExperimentHypothesisRequestStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateNewExperimentHypothesisRequestStatusExtensions.ToValueString(value));
        }
    }
}
