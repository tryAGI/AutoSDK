//HintName: G.JsonConverters.ResultNullString.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResultNullStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResultNullString>
    {
        /// <inheritdoc />
        public override global::G.ResultNullString Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ResultSuccessNull? success = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ResultSuccessNull), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ResultSuccessNull> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ResultSuccessNull).Name}");
            ...
            var __value = new global::G.ResultNullString(
                success,
        ...
        public override void Write(
            ...
            global::G.ResultNullString value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
