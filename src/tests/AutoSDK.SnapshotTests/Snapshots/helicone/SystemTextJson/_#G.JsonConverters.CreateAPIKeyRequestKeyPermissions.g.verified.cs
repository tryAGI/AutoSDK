...
{
    /// <inheritdoc />
    public sealed class CreateAPIKeyRequestKeyPermissionsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateAPIKeyRequestKeyPermissions>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateAPIKeyRequestKeyPermissionsExtensions.ToValueString(value));
        }
    }
}
