...
{
    /// <inheritdoc />
    public sealed class LLMResponseBodyDataDetailsResponseTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LLMResponseBodyDataDetailsResponseType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LLMResponseBodyDataDetailsResponseTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
