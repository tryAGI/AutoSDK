...
{
    /// <inheritdoc />
    public sealed class ChatCompletionMessageFunctionToolCallTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionMessageFunctionToolCallType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ChatCompletionMessageFunctionToolCallTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
