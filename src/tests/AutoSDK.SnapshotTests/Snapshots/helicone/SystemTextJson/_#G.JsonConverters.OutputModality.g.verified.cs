...
{
    /// <inheritdoc />
    public sealed class OutputModalityJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OutputModality>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.OutputModalityExtensions.ToValueString(value));
        }
    }
}
