...
namespace G.JsonConverters
{
    ...
    public class ResultPrompt2025ArrayStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResultPrompt2025ArrayString>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        success = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ResultSuccessPrompt2025Array>(__rawJson, options);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsSuccess)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Success, typeof(global::G.ResultSuccessPrompt2025Array), options);
            }
