//HintName: G.JsonConverters.ResultArrayString.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResultArrayStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResultArrayString>
    {
        /// <inheritdoc />
        public override global::G.ResultArrayString Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ResultSuccessArray? success = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ResultSuccessArray), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ResultSuccessArray> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ResultSuccessArray).Name}");
            ...
            var __value = new global::G.ResultArrayString(
                success,
        ...
        public override void Write(
            ...
            global::G.ResultArrayString value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
