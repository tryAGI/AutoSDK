...
namespace G.JsonConverters
{
    ...
    public class SessionFilterNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SessionFilterNode>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        pickLeafRequestResponseRmtOrSessions = global::System.Text.Json.JsonSerializer.Deserialize<global::G.PickFilterLeafRequestResponseRmtOrSessionsRequestResponseRmt>(__rawJson, options);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        branch = global::System.Text.Json.JsonSerializer.Deserialize<global::G.SessionFilterBranch>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        @enum = global::System.Text.Json.JsonSerializer.Deserialize<global::G.SessionFilterNodeEnum>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PickLeafRequestResponseRmtOrSessions, typeof(global::G.PickFilterLeafRequestResponseRmtOrSessionsRequestResponseRmt), options);
            }
            else if (value.IsBranch)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Branch, typeof(global::G.SessionFilterBranch), options);
            }
            else if (value.IsEnum)
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Enum, typeof(global::G.SessionFilterNodeEnum), options);
            }
        }
    }
}