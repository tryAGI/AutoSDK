//HintName: G.JsonConverters.ResultVoidString.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResultVoidStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResultVoidString>
    {
        /// <inheritdoc />
        public override global::G.ResultVoidString Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ResultSuccessVoid? success = default;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ResultSuccessVoid), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ResultSuccessVoid> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ResultSuccessVoid).Name}");
            ...
            var __value = new global::G.ResultVoidString(
                success,
        ...
        public override void Write(
            ...
            global::G.ResultVoidString value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
