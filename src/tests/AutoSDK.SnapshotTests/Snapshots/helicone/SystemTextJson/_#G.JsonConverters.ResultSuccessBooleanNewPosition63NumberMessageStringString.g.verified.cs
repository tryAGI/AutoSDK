...
namespace G.JsonConverters
{
    ...
    public class ResultSuccessBooleanNewPosition63NumberMessageStringStringJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResultSuccessBooleanNewPosition63NumberMessageStringString>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("data.newPosition")) __score0++;
            ...
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        resultSuccessSuccessBooleanNewPosition63NumberMessageString = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
