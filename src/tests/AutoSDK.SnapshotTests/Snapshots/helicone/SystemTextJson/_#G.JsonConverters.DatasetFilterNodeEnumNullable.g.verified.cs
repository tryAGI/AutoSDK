...
{
    /// <inheritdoc />
    public sealed class DatasetFilterNodeEnumNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DatasetFilterNodeEnum?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.DatasetFilterNodeEnumExtensions.ToValueString(value.Value));
            }
        }
    }
}
