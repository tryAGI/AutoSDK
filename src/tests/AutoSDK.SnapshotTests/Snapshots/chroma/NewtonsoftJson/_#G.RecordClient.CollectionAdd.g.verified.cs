//HintName: G.RecordClient.CollectionAdd.g.cs
...
namespace G
{
    public partial class RecordClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CollectionAddSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CollectionAddSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AddCollectionRecordsResponse> CollectionAddAsync(
            string tenant,
            string database,
            string collectionId,
        ...
        /// await collection.add({ ids: ['id1', 'id2'], embeddings: [[0.1, 0.2], [0.3, 0.4]], documents: ['doc1', 'doc2'] });
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AddCollectionRecordsResponse>> CollectionAddAsResponseAsync(
            string tenant,
            string database,
            string collectionId,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AddCollectionRecordsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AddCollectionRecordsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AddCollectionRecordsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.AddCollectionRecordsResponse> CollectionAddAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.AddCollectionRecordsPayload
            {
                Documents = documents,
