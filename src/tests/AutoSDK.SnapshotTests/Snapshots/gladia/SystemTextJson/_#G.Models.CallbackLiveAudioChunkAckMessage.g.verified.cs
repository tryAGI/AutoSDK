...
namespace G
{
    ...
    public sealed partial class CallbackLiveAudioChunkAckMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CallbackLiveAudioChunkAckMessageEventJsonConverter))]
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.AudioChunkAckMessage Payload { get; set; }
