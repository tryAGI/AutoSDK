...
namespace G
{
    ...
    public sealed partial class CallbackLiveStartRecordingMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CallbackLiveStartRecordingMessageEventJsonConverter))]
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.StartRecordingMessage Payload { get; set; }
