...
namespace G
{
    ...
    public sealed partial class CallbackLiveTranscriptMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CallbackLiveTranscriptMessageEventJsonConverter))]
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::G.TranscriptMessage Payload { get; set; }
