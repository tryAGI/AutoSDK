...
{
    /// <inheritdoc />
    public sealed class CallbackLiveSentimentAnalysisMessageEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CallbackLiveSentimentAnalysisMessageEvent>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CallbackLiveSentimentAnalysisMessageEventExtensions.ToValueString(value));
        }
    }
}
