...
{
    /// <inheritdoc />
    public sealed class VideoToTextControllerVideoTranscriptionRequestLanguageBehaviourNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.VideoToTextControllerVideoTranscriptionRequestLanguageBehaviour?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.VideoToTextControllerVideoTranscriptionRequestLanguageBehaviourExtensions.ToValueString(value.Value));
            }
        }
    }
}
