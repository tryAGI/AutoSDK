...
{
    /// <inheritdoc />
    public sealed class CallbackLiveSpeechEndMessageEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CallbackLiveSpeechEndMessageEvent>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CallbackLiveSpeechEndMessageEventExtensions.ToValueString(value));
        }
    }
}
