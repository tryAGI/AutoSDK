...
{
    /// <inheritdoc />
    public sealed class WebhookTranscriptionCreatedPayloadEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhookTranscriptionCreatedPayloadEvent>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.WebhookTranscriptionCreatedPayloadEventExtensions.ToValueString(value));
        }
    }
}
