//HintName: G.Models.AudioToLlmListDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class AudioToLlmListDTO
    {
        /// <summary>
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::G.AudioToLlmDTO> Results { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AudioToLlmListDTO" /> class.
        /// </summary>
        /// <param name="success">
        /// The audio intelligence model succeeded to get a valid output
        /// </param>
...
#endif
        public AudioToLlmListDTO(
            bool success,
            bool isEmpty,
            double execTime,
            global::System.Collections.Generic.IList<global::G.AudioToLlmDTO> results,
