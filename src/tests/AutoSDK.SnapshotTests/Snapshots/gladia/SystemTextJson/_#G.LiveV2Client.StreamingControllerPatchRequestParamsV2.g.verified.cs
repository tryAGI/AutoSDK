...
namespace G
{
    public partial class LiveV2Client
    {
        ...
        {
            await StreamingControllerPatchRequestParamsV2AsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> StreamingControllerPatchRequestParamsV2AsResponseAsync(
            string id,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamingControllerPatchRequestParamsV2",
                                methodName: "StreamingControllerPatchRequestParamsV2Async",
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 413)
                            {
                                ...
                                throw global::G.ApiException<global::G.PayloadTooLargeErrorResponse>.Create(
                                    statusCode: __response.StatusCode,
