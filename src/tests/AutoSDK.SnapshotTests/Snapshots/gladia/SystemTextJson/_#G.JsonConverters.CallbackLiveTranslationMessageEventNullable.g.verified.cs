...
{
    /// <inheritdoc />
    public sealed class CallbackLiveTranslationMessageEventNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CallbackLiveTranslationMessageEvent?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CallbackLiveTranslationMessageEventExtensions.ToValueString(value.Value));
            }
        }
    }
}
