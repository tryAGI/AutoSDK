...
{
    /// <inheritdoc />
    public sealed class WebhookLiveEndRecordingPayloadEventNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhookLiveEndRecordingPayloadEvent?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WebhookLiveEndRecordingPayloadEventExtensions.ToValueString(value.Value));
            }
        }
    }
}
