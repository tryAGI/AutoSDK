...
{
    /// <inheritdoc />
    public sealed class CallbackLiveTranslationMessageEventJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CallbackLiveTranslationMessageEvent>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CallbackLiveTranslationMessageEventExtensions.ToValueString(value));
        }
    }
}
