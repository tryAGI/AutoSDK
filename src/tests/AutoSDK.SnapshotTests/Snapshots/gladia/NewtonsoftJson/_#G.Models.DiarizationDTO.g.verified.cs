//HintName: G.Models.DiarizationDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class DiarizationDTO
    {
        /// <summary>
        ...
        public global::System.Collections.Generic.IList<global::G.UtteranceDTO> Results { get; set; } = default!;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DiarizationDTO" /> class.
        /// </summary>
        /// <param name="success">
        /// The audio intelligence model succeeded to get a valid output
        /// </param>
        ...
        /// `null` if `success` is `true`. Contains the error details of the failed model
        /// </param>
        public DiarizationDTO(
            bool success,
            bool isEmpty,
            double execTime,
            global::System.Collections.Generic.IList<global::G.UtteranceDTO> results,
