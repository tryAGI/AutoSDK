...
{
    /// <inheritdoc />
    public sealed class WebhookLiveEndRecordingPayloadEventJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookLiveEndRecordingPayloadEvent>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookLiveEndRecordingPayloadEventExtensions.ToValueString(value));
        }
    }
}
