//HintName: G.TranscriptionV2Client.TranscriptionControllerDeleteTranscriptV2.g.cs
...
namespace G
{
    public partial class TranscriptionV2Client
    {
        ...
        partial void PrepareTranscriptionControllerDeleteTranscriptV2Arguments(
            ...
            ref string id);
        partial void PrepareTranscriptionControllerDeleteTranscriptV2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessTranscriptionControllerDeleteTranscriptV2Response(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TranscriptionControllerDeleteTranscriptV2Async(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTranscriptionControllerDeleteTranscriptV2Arguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TranscriptionControllerDeleteTranscriptV2",
                                methodName: "TranscriptionControllerDeleteTranscriptV2Async",
                                pathTemplate: "$\"/v2/transcription/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTranscriptionControllerDeleteTranscriptV2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // You don't have the permissions to delete this transcription job
                            ...
                            // The transcription job is not in a deletable state
                            if ((int)__response.StatusCode == 403)
                            {
                                string? __content_403 = null;
                                global::System.Exception? __exception_403 = null;
                                global::G.ForbiddenErrorResponse? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::G.ForbiddenErrorResponse.FromJson(__content_403, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.ForbiddenErrorResponse>(
                            ...
                            // The transcription job doesn't exist or has been deleted
