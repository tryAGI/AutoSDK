...
namespace G
{
    ...
    public sealed partial class WebhookTranscriptionCreatedPayload
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.WebhookTranscriptionCreatedPayloadEventJsonConverter))]
        ...
        /// <summary>
        /// Creates a new <see cref="WebhookTranscriptionCreatedPayload"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static WebhookTranscriptionCreatedPayload FromPayload(global::G.PreRecordedEventPayload payload)
        {
            return new WebhookTranscriptionCreatedPayload
            {
                Payload = payload,
            };
        }
