...
{
    /// <inheritdoc />
    public sealed class CallbackLiveSentimentAnalysisMessageEventNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CallbackLiveSentimentAnalysisMessageEvent?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CallbackLiveSentimentAnalysisMessageEventExtensions.ToValueString(value.Value));
            }
        }
    }
}
