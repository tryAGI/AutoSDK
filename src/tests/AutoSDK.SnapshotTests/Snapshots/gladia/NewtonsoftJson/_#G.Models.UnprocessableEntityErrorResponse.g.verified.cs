//HintName: G.Models.UnprocessableEntityErrorResponse.g.cs
...
namespace G
{
    ...
    public sealed partial class UnprocessableEntityErrorResponse
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnprocessableEntityErrorResponse" /> class.
        /// </summary>
        ...
        /// Example: Invalid parameter
        /// </param>
        public UnprocessableEntityErrorResponse(
            string timestamp,
            string path,
            string requestId,
            double statusCode,
