...
{
    /// <inheritdoc />
    public sealed class StopRecordingActionTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.StopRecordingActionType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.StopRecordingActionTypeExtensions.ToValueString(value));
        }
    }
}
