//HintName: G.Models.ListStreamingResponse.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class ListStreamingResponse
    {
        /// <summary>
        ...
        public global::System.Collections.Generic.IList<global::G.StreamingResponse> Items { get; set; } = default!;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListStreamingResponse" /> class.
        /// </summary>
        /// <param name="first">
        /// URL to fetch the first page<br/>
        /// Example: https://api.gladia.io/v2/transcription?status=done&amp;offset=0&amp;limit=20
        ...
        /// Example: https://api.gladia.io/v2/transcription?status=done&amp;offset=20&amp;limit=20
        /// </param>
        public ListStreamingResponse(
            string first,
            string current,
            global::System.Collections.Generic.IList<global::G.StreamingResponse> items,
            string? next)
        {
