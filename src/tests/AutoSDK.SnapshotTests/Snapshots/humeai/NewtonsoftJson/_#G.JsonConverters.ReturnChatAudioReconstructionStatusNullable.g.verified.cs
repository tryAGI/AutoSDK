...
{
    /// <inheritdoc />
    public sealed class ReturnChatAudioReconstructionStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReturnChatAudioReconstructionStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReturnChatAudioReconstructionStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
