...
{
    /// <inheritdoc />
    public sealed class PostedLanguageModelModelProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PostedLanguageModelModelProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PostedLanguageModelModelProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
