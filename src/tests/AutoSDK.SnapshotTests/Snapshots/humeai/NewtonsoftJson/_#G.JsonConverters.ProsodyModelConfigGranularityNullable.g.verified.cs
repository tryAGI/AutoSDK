...
{
    /// <inheritdoc />
    public sealed class ProsodyModelConfigGranularityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProsodyModelConfigGranularity?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProsodyModelConfigGranularityExtensions.ToValueString(value.Value));
            }
        }
    }
}
