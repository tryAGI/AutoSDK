...
{
    /// <inheritdoc />
    public sealed class ReturnChatPagedEventsPaginationDirectionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReturnChatPagedEventsPaginationDirection?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReturnChatPagedEventsPaginationDirectionExtensions.ToValueString(value.Value));
            }
        }
    }
}
