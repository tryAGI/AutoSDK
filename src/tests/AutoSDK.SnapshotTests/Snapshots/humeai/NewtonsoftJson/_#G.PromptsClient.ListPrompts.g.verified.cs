...
namespace G
{
    public partial class PromptsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.ReturnPagedPrompts> ListPromptsAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ReturnPagedPrompts>> ListPromptsAsResponseAsync(
            int? pageNumber = default,
            int? pageSize = default,
            bool? restrictToMostRecent = default,
            string? name = default,
