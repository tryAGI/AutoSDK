...
{
    /// <inheritdoc />
    public sealed class ListBatchJobsStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListBatchJobsStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListBatchJobsStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
