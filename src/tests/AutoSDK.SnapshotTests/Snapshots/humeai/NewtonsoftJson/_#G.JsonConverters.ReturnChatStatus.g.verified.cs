...
{
    /// <inheritdoc />
    public sealed class ReturnChatStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReturnChatStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ReturnChatStatusExtensions.ToValueString(value));
        }
    }
}
