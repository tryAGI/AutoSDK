            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.ReturnPagedPrompts.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.ReturnPagedPrompts.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
