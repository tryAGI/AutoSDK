...
{
    /// <inheritdoc />
    public sealed class ReturnChatPagedEventsPaginationDirectionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ReturnChatPagedEventsPaginationDirection>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ReturnChatPagedEventsPaginationDirectionExtensions.ToValueString(value));
        }
    }
}
