...
{
    /// <inheritdoc />
    public sealed class PostedLanguageModelModelProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PostedLanguageModelModelProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PostedLanguageModelModelProviderExtensions.ToValueString(value));
        }
    }
}
