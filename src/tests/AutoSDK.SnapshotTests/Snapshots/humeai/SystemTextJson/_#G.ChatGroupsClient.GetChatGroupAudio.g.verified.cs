...
namespace G
{
    public partial class ChatGroupsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ReturnChatGroupPagedAudioReconstructions>> GetChatGroupAudioAsResponseAsync(
            string id,
            int? pageNumber = default,
            int? pageSize = default,
            bool? ascendingOrder = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetChatGroupAudio",
                                methodName: "GetChatGroupAudioAsync",
                                pathTemplate: "$\"/v0/evi/chat_groups/{id}/audio\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ReturnChatGroupPagedAudioReconstructions.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ReturnChatGroupPagedAudioReconstructions>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ReturnChatGroupPagedAudioReconstructions.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
