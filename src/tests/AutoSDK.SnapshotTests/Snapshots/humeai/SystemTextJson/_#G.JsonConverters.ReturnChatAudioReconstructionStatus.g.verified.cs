...
{
    /// <inheritdoc />
    public sealed class ReturnChatAudioReconstructionStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ReturnChatAudioReconstructionStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ReturnChatAudioReconstructionStatusExtensions.ToValueString(value));
        }
    }
}
