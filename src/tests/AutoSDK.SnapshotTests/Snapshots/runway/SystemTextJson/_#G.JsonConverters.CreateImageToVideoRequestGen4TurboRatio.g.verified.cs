...
{
    /// <inheritdoc />
    public sealed class CreateImageToVideoRequestGen4TurboRatioJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateImageToVideoRequestGen4TurboRatio>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateImageToVideoRequestGen4TurboRatioExtensions.ToValueString(value));
        }
    }
}
