...
{
    /// <inheritdoc />
    public sealed class CreateVoiceDubbingRequestDiscriminatorModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateVoiceDubbingRequestDiscriminatorModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateVoiceDubbingRequestDiscriminatorModelExtensions.ToValueString(value));
        }
    }
}
