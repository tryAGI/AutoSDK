//HintName: G.Models.RequestGemini25FlashReferenceImage.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class RequestGemini25FlashReferenceImage
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestGemini25FlashReferenceImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
...
#endif
        public RequestGemini25FlashReferenceImage(
            string uri,
            string? tag)
        {
            this.Uri = uri;
