...
{
    /// <inheritdoc />
    public sealed class CreateTextToImageRequestGen4ImageTurboContentModerationPublicFigureThresholdNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTextToImageRequestGen4ImageTurboContentModerationPublicFigureThreshold?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTextToImageRequestGen4ImageTurboContentModerationPublicFigureThresholdExtensions.ToValueString(value.Value));
            }
        }
    }
}
