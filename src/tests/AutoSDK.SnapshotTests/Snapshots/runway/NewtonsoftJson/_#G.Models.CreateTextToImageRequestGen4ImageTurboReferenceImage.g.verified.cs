//HintName: G.Models.CreateTextToImageRequestGen4ImageTurboReferenceImage.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateTextToImageRequestGen4ImageTurboReferenceImage
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateTextToImageRequestGen4ImageTurboReferenceImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
        ...
        /// A tag to identify the reference image. This is used to reference the image in prompt text.
        /// </param>
        public CreateTextToImageRequestGen4ImageTurboReferenceImage(
            string uri,
            string? tag)
        {
            this.Uri = uri;
