...
{
    /// <inheritdoc />
    public sealed class CreateImageToVideoRequestGen4TurboRatioNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateImageToVideoRequestGen4TurboRatio?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateImageToVideoRequestGen4TurboRatioExtensions.ToValueString(value.Value));
            }
        }
    }
}
