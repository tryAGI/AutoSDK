//HintName: G.Models.RequestVeo3PromptImagePromptImage.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class RequestVeo3PromptImagePromptImage
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestVeo3PromptImagePromptImage" /> class.
        /// </summary>
        /// <param name="uri">
        /// A HTTPS URL, Runway or data URI containing an encoded image. See [our docs](/assets/inputs#images) on image inputs for more information.<br/>
        /// Example: https://example.com/image.jpg
