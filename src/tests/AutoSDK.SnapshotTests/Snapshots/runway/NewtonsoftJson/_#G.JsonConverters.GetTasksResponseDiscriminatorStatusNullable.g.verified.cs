...
{
    /// <inheritdoc />
    public sealed class GetTasksResponseDiscriminatorStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetTasksResponseDiscriminatorStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetTasksResponseDiscriminatorStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
