...
{
    /// <inheritdoc />
    public sealed class CreateVoiceIsolationRequestDiscriminatorModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateVoiceIsolationRequestDiscriminatorModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateVoiceIsolationRequestDiscriminatorModelExtensions.ToValueString(value));
        }
    }
}
