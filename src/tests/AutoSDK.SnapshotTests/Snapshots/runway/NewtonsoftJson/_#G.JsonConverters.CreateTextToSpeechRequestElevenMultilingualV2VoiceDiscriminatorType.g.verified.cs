...
{
    /// <inheritdoc />
    public sealed class CreateTextToSpeechRequestElevenMultilingualV2VoiceDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTextToSpeechRequestElevenMultilingualV2VoiceDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateTextToSpeechRequestElevenMultilingualV2VoiceDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
