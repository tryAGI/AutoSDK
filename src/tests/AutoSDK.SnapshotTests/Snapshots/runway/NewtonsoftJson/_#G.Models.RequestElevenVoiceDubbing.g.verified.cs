//HintName: G.Models.RequestElevenVoiceDubbing.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class RequestElevenVoiceDubbing
    {
        /// <summary>
        ...
        public global::G.RequestElevenVoiceDubbingTargetLang TargetLang { get; set; } = default!;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RequestElevenVoiceDubbing" /> class.
        /// </summary>
        /// <param name="audioUri">
        /// A HTTPS URL, Runway or data URI containing an encoded audio. See [our docs](/assets/inputs#audio) on audio inputs for more information.<br/>
        /// Example: https://example.com/audio.mp3
        ...
        public RequestElevenVoiceDubbing(
            string audioUri,
            global::G.RequestElevenVoiceDubbingTargetLang targetLang,
