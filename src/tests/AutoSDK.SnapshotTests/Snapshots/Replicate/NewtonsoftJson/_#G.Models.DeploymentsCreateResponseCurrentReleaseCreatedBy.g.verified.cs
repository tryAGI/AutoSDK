...
namespace G
{
    ...
    public sealed partial class DeploymentsCreateResponseCurrentReleaseCreatedBy
    {
        ...
        public DeploymentsCreateResponseCurrentReleaseCreatedBy(
            string? githubUrl,
            string? name,
            global::G.DeploymentsCreateResponseCurrentReleaseCreatedByType? type,
            string? username)
        {
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::G.DeploymentsCreateResponseCurrentReleaseCreatedBy? FromJson(
            string json,
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            return global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.DeploymentsCreateResponseCurrentReleaseCreatedBy>(
                json,
                jsonSerializerOptions);
        }
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.DeploymentsCreateResponseCurrentReleaseCreatedBy?> FromJsonStreamAsync(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.DeploymentsCreateResponseCurrentReleaseCreatedBy?>(serializer.Deserialize<global::G.DeploymentsCreateResponseCurrentReleaseCreatedBy>(jsonReader));
        }
