...
{
    /// <inheritdoc />
    public sealed class VideoSearchSafesearchNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VideoSearchSafesearch?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VideoSearchSafesearchExtensions.ToValueString(value.Value));
            }
        }
    }
}
