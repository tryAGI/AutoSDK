...
{
    /// <inheritdoc />
    public sealed class VideoSearchSafesearchJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.VideoSearchSafesearch>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.VideoSearchSafesearchExtensions.ToValueString(value));
        }
    }
}
