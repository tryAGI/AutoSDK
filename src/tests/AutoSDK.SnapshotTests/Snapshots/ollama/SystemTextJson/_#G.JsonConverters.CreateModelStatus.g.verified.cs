//HintName: G.JsonConverters.CreateModelStatus.g.cs
#nullable enable
...
namespace G.JsonConverters
{
    ...
    public class CreateModelStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateModelStatus>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::G.CreateModelStatusEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            string? createModelStatusVariant1 = default;
            global::G.CreateModelStatusEnum? @enum = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        createModelStatusVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (createModelStatusVariant1 == null && @enum == null)
            {
                try
                {
            ...
            var __value = new global::G.CreateModelStatus(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsCreateModelStatusVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.CreateModelStatusVariant1!, typeInfo);
            }
