...
namespace G.JsonConverters
{
    ...
    public class PullModelStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PullModelStatus>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::G.PullModelStatusEnum), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            string? pullModelStatusVariant1 = default;
            global::G.PullModelStatusEnum? @enum = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        pullModelStatusVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
            ...
            if (pullModelStatusVariant1 == null && @enum == null)
            {
                try
                {
            ...
            var __value = new global::G.PullModelStatus(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsPullModelStatusVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(string), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<string?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(string).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.PullModelStatusVariant1!, typeInfo);
            }
