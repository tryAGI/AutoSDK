//HintName: G.Models.RetextureTask.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class RetextureTask
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetextureTask" /> class.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="type"></param>
        /// <param name="modelUrls"></param>
        /// <param name="thumbnailUrl"></param>
        /// <param name="textStylePrompt"></param>
        /// <param name="imageStyleUrl"></param>
