...
{
    /// <inheritdoc />
    public sealed class TargetFormat3DJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TargetFormat3D>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TargetFormat3DExtensions.ToValueString(value));
        }
    }
}
