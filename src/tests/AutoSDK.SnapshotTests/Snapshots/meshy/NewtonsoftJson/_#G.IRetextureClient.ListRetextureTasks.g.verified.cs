...
namespace G
{
    public partial interface IRetextureClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.RetextureTask>>> ListRetextureTasksAsResponseAsync(
            int? pageNum = default,
            int? pageSize = default,
            global::G.ListRetextureTasksSortBy? sortBy = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
