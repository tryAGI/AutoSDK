...
{
    /// <inheritdoc />
    public sealed class SymmetryModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SymmetryMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SymmetryModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
