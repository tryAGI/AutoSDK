...
{
    /// <inheritdoc />
    public sealed class TargetFormat3DNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TargetFormat3D?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TargetFormat3DExtensions.ToValueString(value.Value));
            }
        }
    }
}
