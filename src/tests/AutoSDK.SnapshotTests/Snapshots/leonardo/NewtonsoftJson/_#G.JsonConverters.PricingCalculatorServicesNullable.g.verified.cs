...
{
    /// <inheritdoc />
    public sealed class PricingCalculatorServicesNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PricingCalculatorServices?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PricingCalculatorServicesExtensions.ToValueString(value.Value));
            }
        }
    }
}
