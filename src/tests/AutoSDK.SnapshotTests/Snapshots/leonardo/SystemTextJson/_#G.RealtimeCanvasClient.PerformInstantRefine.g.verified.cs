...
namespace G
{
    public partial class RealtimeCanvasClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PerformInstantRefineSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PerformInstantRefineSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PerformInstantRefineSecurityRequirement0,
            };
        ...
        {
            var __response = await PerformInstantRefineAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PerformInstantRefineResponse>> PerformInstantRefineAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PerformInstantRefineSecurityRequirements,
                operationName: "PerformInstantRefineAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PerformInstantRefineAsync",
                                pathTemplate: "\"/lcm-instant-refine\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PerformInstantRefineResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PerformInstantRefineResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PerformInstantRefineResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
