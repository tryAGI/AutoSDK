...
namespace G
{
    public partial class RealtimeCanvasClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_PerformAlchemyUpscaleLCMSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_PerformAlchemyUpscaleLCMSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_PerformAlchemyUpscaleLCMSecurityRequirement0,
            };
        ...
        {
            var __response = await PerformAlchemyUpscaleLCMAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PerformAlchemyUpscaleLCMResponse>> PerformAlchemyUpscaleLCMAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PerformAlchemyUpscaleLCMSecurityRequirements,
                operationName: "PerformAlchemyUpscaleLCMAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PerformAlchemyUpscaleLCMAsync",
                                pathTemplate: "\"/lcm-upscale\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PerformAlchemyUpscaleLCMResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PerformAlchemyUpscaleLCMResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PerformAlchemyUpscaleLCMResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
