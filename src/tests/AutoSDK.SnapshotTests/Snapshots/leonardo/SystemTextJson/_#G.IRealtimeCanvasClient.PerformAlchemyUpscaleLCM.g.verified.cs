//HintName: G.IRealtimeCanvasClient.PerformAlchemyUpscaleLCM.g.cs
#nullable enable
...
namespace G
{
    public partial interface IRealtimeCanvasClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.PerformAlchemyUpscaleLCMResponse> PerformAlchemyUpscaleLCMAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PerformAlchemyUpscaleLCMResponse>> PerformAlchemyUpscaleLCMAsResponseAsync(
