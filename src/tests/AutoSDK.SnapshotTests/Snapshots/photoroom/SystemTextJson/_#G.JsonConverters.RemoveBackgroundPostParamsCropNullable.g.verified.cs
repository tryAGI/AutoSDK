...
{
    /// <inheritdoc />
    public sealed class RemoveBackgroundPostParamsCropNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RemoveBackgroundPostParamsCrop?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RemoveBackgroundPostParamsCropExtensions.ToValueString(value.Value));
            }
        }
    }
}
