...
{
    /// <inheritdoc />
    public sealed class EditImageGetVirtualModelPoseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EditImageGetVirtualModelPose>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.EditImageGetVirtualModelPoseExtensions.ToValueString(value));
        }
    }
}
