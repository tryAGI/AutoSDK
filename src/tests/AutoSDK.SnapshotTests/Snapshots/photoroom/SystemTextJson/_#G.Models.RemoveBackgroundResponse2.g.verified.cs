//HintName: G.Models.RemoveBackgroundResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class RemoveBackgroundResponse2
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveBackgroundResponse2" /> class.
        /// </summary>
        /// <param name="detail">
        /// The details of the error<br/>
        /// Example: Please provide an image.
...
#endif
        public RemoveBackgroundResponse2(
            string detail,
            double statusCode,
            string type)
        {
