...
{
    /// <inheritdoc />
    public sealed class EditImageGetGhostMannequinSizeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EditImageGetGhostMannequinSize?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.EditImageGetGhostMannequinSizeExtensions.ToValueString(value.Value));
            }
        }
    }
}
