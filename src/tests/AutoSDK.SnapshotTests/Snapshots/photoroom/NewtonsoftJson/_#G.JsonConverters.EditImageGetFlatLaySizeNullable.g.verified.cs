...
{
    /// <inheritdoc />
    public sealed class EditImageGetFlatLaySizeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EditImageGetFlatLaySize?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EditImageGetFlatLaySizeExtensions.ToValueString(value.Value));
            }
        }
    }
}
