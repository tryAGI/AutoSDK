//HintName: G.Models.EditImageGetResponseError2.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class EditImageGetResponseError2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EditImageGetResponseError2" /> class.
        /// </summary>
        /// <param name="detail">
        /// The details of the error<br/>
        /// Example: API credits exhausted. Visit https://app.photoroom.com/api-dashboard to purchase more API credits
        /// </param>
        public EditImageGetResponseError2(
            string detail)
        {
