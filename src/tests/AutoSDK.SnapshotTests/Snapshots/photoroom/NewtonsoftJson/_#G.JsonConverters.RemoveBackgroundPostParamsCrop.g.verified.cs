...
{
    /// <inheritdoc />
    public sealed class RemoveBackgroundPostParamsCropJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RemoveBackgroundPostParamsCrop>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RemoveBackgroundPostParamsCropExtensions.ToValueString(value));
        }
    }
}
