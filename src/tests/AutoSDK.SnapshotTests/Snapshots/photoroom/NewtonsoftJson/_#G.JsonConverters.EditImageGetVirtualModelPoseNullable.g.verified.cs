...
{
    /// <inheritdoc />
    public sealed class EditImageGetVirtualModelPoseNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EditImageGetVirtualModelPose?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EditImageGetVirtualModelPoseExtensions.ToValueString(value.Value));
            }
        }
    }
}
