...
{
    /// <inheritdoc />
    public sealed class BrowserbaseProxyConfigTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BrowserbaseProxyConfigType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BrowserbaseProxyConfigTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
