...
{
    /// <inheritdoc />
    public sealed class NoneProxyConfigTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.NoneProxyConfigType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.NoneProxyConfigTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
