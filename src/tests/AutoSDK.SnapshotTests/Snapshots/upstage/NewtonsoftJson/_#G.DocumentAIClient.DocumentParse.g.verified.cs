//HintName: G.DocumentAIClient.DocumentParse.g.cs
...
namespace G
{
    public partial class DocumentAIClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DocumentParseSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_DocumentParseSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_DocumentParseSecurityRequirement0,
            };
        partial void PrepareDocumentParseArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.DocumentParseRequest request);
        partial void PrepareDocumentParseRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.DocumentParseRequest request);
        partial void ProcessDocumentParseResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDocumentParseResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.DocumentParseResponse> DocumentParseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DocumentParseSecurityRequirements,
                operationName: "DocumentParseAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::G.PathBuilder(
                                path: "/document-ai/document-parse",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DocumentParse",
                                methodName: "DocumentParseAsync",
                                pathTemplate: "\"/document-ai/document-parse\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDocumentParseResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.DocumentParseResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.DocumentParseResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await DocumentParseAsync(
                request: __request,
                requestOptions: requestOptions,
