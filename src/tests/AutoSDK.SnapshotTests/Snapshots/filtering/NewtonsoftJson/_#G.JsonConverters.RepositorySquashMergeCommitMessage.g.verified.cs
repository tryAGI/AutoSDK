...
{
    /// <inheritdoc />
    public sealed class RepositorySquashMergeCommitMessageJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RepositorySquashMergeCommitMessage>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RepositorySquashMergeCommitMessageExtensions.ToValueString(value));
        }
    }
}
