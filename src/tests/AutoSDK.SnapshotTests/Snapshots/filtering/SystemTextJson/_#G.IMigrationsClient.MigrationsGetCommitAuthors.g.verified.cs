...
namespace G
{
    public partial interface IMigrationsClient
    {
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.PorterAuthor>>> MigrationsGetCommitAuthorsAsResponseAsync(
            string owner,
            string repo,
            int? since = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
