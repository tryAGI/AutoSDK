...
{
    /// <inheritdoc />
    public sealed class ListInternalRunsDurationOperatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListInternalRunsDurationOperator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListInternalRunsDurationOperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
