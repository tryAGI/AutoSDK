...
{
    /// <inheritdoc />
    public sealed class ModifyMessageResponseDiscriminatorMessageTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ModifyMessageResponseDiscriminatorMessageType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ModifyMessageResponseDiscriminatorMessageTypeExtensions.ToValueString(value));
        }
    }
}
