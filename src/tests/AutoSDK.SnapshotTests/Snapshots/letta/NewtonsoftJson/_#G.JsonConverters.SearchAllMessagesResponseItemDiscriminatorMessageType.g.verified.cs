...
{
    /// <inheritdoc />
    public sealed class SearchAllMessagesResponseItemDiscriminatorMessageTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SearchAllMessagesResponseItemDiscriminatorMessageType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SearchAllMessagesResponseItemDiscriminatorMessageTypeExtensions.ToValueString(value));
        }
    }
}
