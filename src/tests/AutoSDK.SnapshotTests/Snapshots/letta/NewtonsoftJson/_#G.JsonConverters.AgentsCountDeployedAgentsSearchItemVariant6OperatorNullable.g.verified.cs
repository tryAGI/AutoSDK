...
{
    /// <inheritdoc />
    public sealed class AgentsCountDeployedAgentsSearchItemVariant6OperatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentsCountDeployedAgentsSearchItemVariant6Operator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AgentsCountDeployedAgentsSearchItemVariant6OperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
