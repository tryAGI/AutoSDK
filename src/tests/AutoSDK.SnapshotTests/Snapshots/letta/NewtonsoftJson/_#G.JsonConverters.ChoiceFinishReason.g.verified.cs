...
{
    /// <inheritdoc />
    public sealed class ChoiceFinishReasonJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChoiceFinishReason>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChoiceFinishReasonExtensions.ToValueString(value));
        }
    }
}
