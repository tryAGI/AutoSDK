...
{
    /// <inheritdoc />
    public sealed class PassageSearchRequestTagMatchModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PassageSearchRequestTagMatchMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PassageSearchRequestTagMatchModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
