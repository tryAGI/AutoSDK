//HintName: G.Models.PipelinesUpdatePipelineProducerConfigResponsePipelineConfigVariant1DataChannel.g.cs
...
namespace G
{
    ...
    public sealed partial class PipelinesUpdatePipelineProducerConfigResponsePipelineConfigVariant1DataChannel
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PipelinesUpdatePipelineProducerConfigResponsePipelineConfigVariant1DataChannel" /> class.
        /// </summary>
        /// <param name="channelId"></param>
        /// <param name="channelName"></param>
        /// <param name="lastMessageTs"></param>
        public PipelinesUpdatePipelineProducerConfigResponsePipelineConfigVariant1DataChannel(
            string channelId,
            string? channelName,
