...
{
    /// <inheritdoc />
    public sealed class PipelinesUpdatePipelineResponseErrorCodeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PipelinesUpdatePipelineResponseErrorCode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PipelinesUpdatePipelineResponseErrorCodeExtensions.ToValueString(value.Value));
            }
        }
    }
}
