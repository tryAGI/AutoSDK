...
{
    /// <inheritdoc />
    public sealed class TemplatesCreateTemplateNoProjectRequestDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TemplatesCreateTemplateNoProjectRequestDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TemplatesCreateTemplateNoProjectRequestDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
