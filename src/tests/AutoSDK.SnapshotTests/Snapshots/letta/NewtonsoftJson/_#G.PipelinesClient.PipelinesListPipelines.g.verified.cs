...
namespace G
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_PipelinesListPipelinesServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await PipelinesListPipelinesAsResponseAsync(
                search: search,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PipelinesListPipelinesResponse>> PipelinesListPipelinesAsResponseAsync(
            string? search = default,
            string? integrationType = default,
            string? integrationId = default,
            global::G.OneOf<string, double?>? offset = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PipelinesListPipelines",
                                methodName: "PipelinesListPipelinesAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PipelinesListPipelinesResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PipelinesListPipelinesResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PipelinesListPipelinesResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
