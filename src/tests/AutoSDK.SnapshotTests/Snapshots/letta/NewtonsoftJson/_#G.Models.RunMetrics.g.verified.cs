...
namespace G
{
    ...
    public sealed partial class RunMetrics
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("run_start_ns")]
        public long? RunStartNs { get; set; }

        /// <summary>
        /// Total time for the run in nanoseconds.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("run_ns")]
        public long? RunNs { get; set; }

        /// <summary>
        /// The number of steps in the run.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("num_steps")]
        public int? NumSteps { get; set; }

        /// <summary>
        /// List of tool IDs that were used in this run.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("tools_used")]
