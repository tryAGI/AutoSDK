...
{
    /// <inheritdoc />
    public sealed class GroupSchemaManagerConfigDiscriminatorManagerTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GroupSchemaManagerConfigDiscriminatorManagerType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GroupSchemaManagerConfigDiscriminatorManagerTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
