...
{
    /// <inheritdoc />
    public sealed class PipelinesListPipelineSyncHistoryResponseRunStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PipelinesListPipelineSyncHistoryResponseRunStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PipelinesListPipelineSyncHistoryResponseRunStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
