...
{
    /// <inheritdoc />
    public sealed class PipelinesCreatePipelineRequestIntegrationTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PipelinesCreatePipelineRequestIntegrationType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PipelinesCreatePipelineRequestIntegrationTypeExtensions.ToValueString(value));
        }
    }
}
