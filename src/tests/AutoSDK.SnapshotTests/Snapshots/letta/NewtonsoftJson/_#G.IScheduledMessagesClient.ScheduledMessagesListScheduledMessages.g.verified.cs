...
namespace G
{
    public partial interface IScheduledMessagesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ScheduledMessagesListScheduledMessagesResponse>> ScheduledMessagesListScheduledMessagesAsResponseAsync(
            string agentId,
            string? limit = default,
            string? after = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
