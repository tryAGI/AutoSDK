...
{
    /// <inheritdoc />
    public sealed class MetadataSendTelemetryRequestServiceJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MetadataSendTelemetryRequestService>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.MetadataSendTelemetryRequestServiceExtensions.ToValueString(value));
        }
    }
}
