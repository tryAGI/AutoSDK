...
namespace G
{
    ...
    public readonly partial struct ManagerConfig2 : global::System.IEquatable<ManagerConfig2>
    {
        ...
        /// 
        /// </summary>
        public global::G.RoundRobinManager PickRoundRobin() => IsRoundRobin
            ? RoundRobin!
        ...
        public bool TryPickSupervisor(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.SupervisorManagerSchema? value)
        {
            value = Supervisor;
            return IsSupervisor;
        }
        ...
        /// 
        /// </summary>
        public global::G.SupervisorManagerSchema PickSupervisor() => IsSupervisor
            ? Supervisor!
        ...
        public bool TryPickDynamic(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.DynamicManagerSchema? value)
        {
            value = Dynamic;
            return IsDynamic;
        }
        ...
        /// 
        /// </summary>
        public global::G.DynamicManagerSchema PickDynamic() => IsDynamic
            ? Dynamic!
        ...
        public bool TryPickSleeptime(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.SleeptimeManagerSchema? value)
        {
            value = Sleeptime;
            return IsSleeptime;
        }
        ...
        /// 
        /// </summary>
        public global::G.SleeptimeManagerSchema PickSleeptime() => IsSleeptime
            ? Sleeptime!
        ...
        public bool TryPickVoiceSleeptime(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.VoiceSleeptimeManagerSchema? value)
        {
        ...
        /// 
        /// </summary>
        public global::G.VoiceSleeptimeManagerSchema PickVoiceSleeptime() => IsVoiceSleeptime
            ? VoiceSleeptime!
