...
{
    /// <inheritdoc />
    public sealed class FeedsListSubscriptionHistoryResponseErrorCodeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FeedsListSubscriptionHistoryResponseErrorCode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FeedsListSubscriptionHistoryResponseErrorCodeExtensions.ToValueString(value.Value));
            }
        }
    }
}
