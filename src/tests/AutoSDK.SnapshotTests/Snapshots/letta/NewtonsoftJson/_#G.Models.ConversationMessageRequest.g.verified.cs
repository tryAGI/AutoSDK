//HintName: G.Models.ConversationMessageRequest.g.cs
...
namespace G
{
    ...
    /// </summary>
    public sealed partial class ConversationMessageRequest
    {
        /// <summary>
        ...
        /// Default Value: false
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("stream_tokens")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConversationMessageRequest" /> class.
        /// </summary>
        /// <param name="messages">
        /// The messages to be sent to the agent.
        /// </param>
