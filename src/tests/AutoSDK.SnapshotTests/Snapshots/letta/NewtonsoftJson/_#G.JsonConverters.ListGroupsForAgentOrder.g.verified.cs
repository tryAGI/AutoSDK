...
{
    /// <inheritdoc />
    public sealed class ListGroupsForAgentOrderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListGroupsForAgentOrder>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ListGroupsForAgentOrderExtensions.ToValueString(value));
        }
    }
}
