...
{
    /// <inheritdoc />
    public sealed class EnvironmentsSendModeChangeRequestModeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EnvironmentsSendModeChangeRequestMode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.EnvironmentsSendModeChangeRequestModeExtensions.ToValueString(value));
        }
    }
}
