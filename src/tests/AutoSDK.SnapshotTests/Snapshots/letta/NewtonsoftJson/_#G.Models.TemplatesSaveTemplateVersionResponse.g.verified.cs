//HintName: G.Models.TemplatesSaveTemplateVersionResponse.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class TemplatesSaveTemplateVersionResponse
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplatesSaveTemplateVersionResponse" /> class.
        /// </summary>
        /// <param name="name">
        /// The exact name of the template
        /// </param>
        ...
        public TemplatesSaveTemplateVersionResponse(
            string name,
            string id,
            string projectId,
            string projectSlug,
