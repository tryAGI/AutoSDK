...
{
    /// <inheritdoc />
    public sealed class ListAgentsIncludeItemNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListAgentsIncludeItem?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListAgentsIncludeItemExtensions.ToValueString(value.Value));
            }
        }
    }
}
