...
{
    /// <inheritdoc />
    public sealed class ListMessagesForRunOrderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListMessagesForRunOrder?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ListMessagesForRunOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
