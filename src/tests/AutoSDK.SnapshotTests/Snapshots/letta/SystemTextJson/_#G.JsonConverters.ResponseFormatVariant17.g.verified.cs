//HintName: G.JsonConverters.ResponseFormatVariant17.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResponseFormatVariant17JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseFormatVariant17>
    {
        /// <inheritdoc />
        public override global::G.ResponseFormatVariant17 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GroqModelSettingsResponseFormatVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GroqModelSettingsResponseFormatVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.GroqModelSettingsResponseFormatVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextResponseFormat? text = default;
            if (discriminator?.Type == global::G.GroqModelSettingsResponseFormatVariant1DiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.GroqModelSettingsResponseFormatVariant1DiscriminatorType.JsonSchema)
            {
            ...
            if (discriminator?.Type == global::G.GroqModelSettingsResponseFormatVariant1DiscriminatorType.JsonObject)
            {
            ...
            var __value = new global::G.ResponseFormatVariant17(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::G.ResponseFormatVariant17 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
