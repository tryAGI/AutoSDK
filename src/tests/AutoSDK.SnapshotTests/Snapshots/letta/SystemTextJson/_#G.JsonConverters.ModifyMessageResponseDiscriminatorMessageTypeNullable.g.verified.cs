...
{
    /// <inheritdoc />
    public sealed class ModifyMessageResponseDiscriminatorMessageTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModifyMessageResponseDiscriminatorMessageType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ModifyMessageResponseDiscriminatorMessageTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
