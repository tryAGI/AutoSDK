...
namespace G
{
    public partial interface IStepsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.ListMessagesForStepResponseItem>>> ListMessagesForStepAsResponseAsync(
            string stepId,
            string? before = default,
            string? after = default,
            int? limit = default,
