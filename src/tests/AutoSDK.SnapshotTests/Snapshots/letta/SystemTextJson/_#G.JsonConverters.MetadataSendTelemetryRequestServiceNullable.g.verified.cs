...
{
    /// <inheritdoc />
    public sealed class MetadataSendTelemetryRequestServiceNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MetadataSendTelemetryRequestService?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.MetadataSendTelemetryRequestServiceExtensions.ToValueString(value.Value));
            }
        }
    }
}
