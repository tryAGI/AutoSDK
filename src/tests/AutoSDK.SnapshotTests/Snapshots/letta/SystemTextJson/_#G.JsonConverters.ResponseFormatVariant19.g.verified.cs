...
{
    /// <inheritdoc />
    public class ResponseFormatVariant19JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseFormatVariant19>
    {
        /// <inheritdoc />
        public override global::G.ResponseFormatVariant19 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.LLMConfigResponseFormatVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.LLMConfigResponseFormatVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.LLMConfigResponseFormatVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextResponseFormat? text = default;
            if (discriminator?.Type == global::G.LLMConfigResponseFormatVariant1DiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.LLMConfigResponseFormatVariant1DiscriminatorType.JsonSchema)
            {
            ...
            if (discriminator?.Type == global::G.LLMConfigResponseFormatVariant1DiscriminatorType.JsonObject)
            {
            ...
            var __value = new global::G.ResponseFormatVariant19(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::G.ResponseFormatVariant19 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
