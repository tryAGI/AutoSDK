...
namespace G
{
    public partial class MemoryFilesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_MemoryFilesListDirectoryServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await MemoryFilesListDirectoryAsResponseAsync(
                agentId: agentId,
                path: path,
                depth: depth,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.MemoryFilesListDirectoryResponse>> MemoryFilesListDirectoryAsResponseAsync(
            string agentId,
            string? path = default,
            double? depth = default,
            string? @ref = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "MemoryFilesListDirectory",
                                methodName: "MemoryFilesListDirectoryAsync",
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::G.ApiException<global::G.MemoryFilesListDirectoryResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                throw global::G.ApiException<global::G.MemoryFilesListDirectoryResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.MemoryFilesListDirectoryResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.MemoryFilesListDirectoryResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.MemoryFilesListDirectoryResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
