//HintName: G.JsonConverters.ResponseFormatVariant111.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResponseFormatVariant111JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseFormatVariant111>
    {
        /// <inheritdoc />
        public override global::G.ResponseFormatVariant111 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.OpenAIModelSettingsResponseFormatVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.OpenAIModelSettingsResponseFormatVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.OpenAIModelSettingsResponseFormatVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextResponseFormat? text = default;
            if (discriminator?.Type == global::G.OpenAIModelSettingsResponseFormatVariant1DiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.OpenAIModelSettingsResponseFormatVariant1DiscriminatorType.JsonSchema)
            {
            ...
            if (discriminator?.Type == global::G.OpenAIModelSettingsResponseFormatVariant1DiscriminatorType.JsonObject)
            {
            ...
            var __value = new global::G.ResponseFormatVariant111(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::G.ResponseFormatVariant111 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
