...
{
    /// <inheritdoc />
    public sealed class FeedsListSubscriptionHistoryResponseErrorCodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FeedsListSubscriptionHistoryResponseErrorCode>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FeedsListSubscriptionHistoryResponseErrorCodeExtensions.ToValueString(value));
        }
    }
}
