...
{
    /// <inheritdoc />
    public sealed class ImageContentSourceDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ImageContentSourceDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ImageContentSourceDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
