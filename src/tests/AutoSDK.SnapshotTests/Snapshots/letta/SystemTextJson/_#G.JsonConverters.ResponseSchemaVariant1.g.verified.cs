//HintName: G.JsonConverters.ResponseSchemaVariant1.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResponseSchemaVariant1JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseSchemaVariant1>
    {
        /// <inheritdoc />
        public override global::G.ResponseSchemaVariant1 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GoogleAIModelSettingsResponseSchemaVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GoogleAIModelSettingsResponseSchemaVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.GoogleAIModelSettingsResponseSchemaVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextResponseFormat? text = default;
            if (discriminator?.Type == global::G.GoogleAIModelSettingsResponseSchemaVariant1DiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.GoogleAIModelSettingsResponseSchemaVariant1DiscriminatorType.JsonSchema)
            {
            ...
            if (discriminator?.Type == global::G.GoogleAIModelSettingsResponseSchemaVariant1DiscriminatorType.JsonObject)
            {
            ...
            var __value = new global::G.ResponseSchemaVariant1(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::G.ResponseSchemaVariant1 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
