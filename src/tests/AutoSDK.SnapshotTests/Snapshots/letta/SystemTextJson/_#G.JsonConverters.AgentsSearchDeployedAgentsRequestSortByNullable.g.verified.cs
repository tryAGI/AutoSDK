...
{
    /// <inheritdoc />
    public sealed class AgentsSearchDeployedAgentsRequestSortByNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsSearchDeployedAgentsRequestSortBy?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentsSearchDeployedAgentsRequestSortByExtensions.ToValueString(value.Value));
            }
        }
    }
}
