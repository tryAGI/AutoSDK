...
namespace G
{
    public partial interface IArchivesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.AgentState>>> ListAgentsForArchiveAsResponseAsync(
            string archiveId,
            string? before = default,
            string? after = default,
            int? limit = default,
