...
{
    /// <inheritdoc />
    public sealed class PipelinesCreatePipelineRequestIntegrationTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PipelinesCreatePipelineRequestIntegrationType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PipelinesCreatePipelineRequestIntegrationTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
