...
{
    /// <inheritdoc />
    public sealed class FeedsSubscribeAgentResponseMergeStrategyJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FeedsSubscribeAgentResponseMergeStrategy>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FeedsSubscribeAgentResponseMergeStrategyExtensions.ToValueString(value));
        }
    }
}
