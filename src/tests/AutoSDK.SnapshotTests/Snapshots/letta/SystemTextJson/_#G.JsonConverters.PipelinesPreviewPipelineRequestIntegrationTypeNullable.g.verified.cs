...
{
    /// <inheritdoc />
    public sealed class PipelinesPreviewPipelineRequestIntegrationTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PipelinesPreviewPipelineRequestIntegrationType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PipelinesPreviewPipelineRequestIntegrationTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
