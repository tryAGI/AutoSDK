//HintName: G.JsonConverters.ToolRulesVariant1Item5.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ToolRulesVariant1Item5JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ToolRulesVariant1Item5>
    {
        /// <inheritdoc />
        public override global::G.ToolRulesVariant1Item5 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ChildToolRule? constrainChildTools = default;
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.ConstrainChildTools)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.RunFirst)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.ExitLoop)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.Conditional)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.ContinueLoop)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.RequiredBeforeExit)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.MaxCountPerStep)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.ParentLastTool)
            {
            ...
            if (discriminator?.Type == global::G.LettaSchemasAgentFileAgentSchemaToolRulesVariant1ItemDiscriminatorType.RequiresApproval)
            {
            ...
            var __value = new global::G.ToolRulesVariant1Item5(
                discriminator?.Type,
                constrainChildTools,
        ...
        public override void Write(
            ...
            global::G.ToolRulesVariant1Item5 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
