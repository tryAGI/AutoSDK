...
namespace G
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_SearchArchivalMemoryServers = new global::G.AutoSDKServer[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ArchivalMemorySearchResponse>> SearchArchivalMemoryAsResponseAsync(
            string agentId,
            string query,
            global::System.Collections.Generic.IList<string>? tags = default,
            global::G.SearchArchivalMemoryTagMatchMode? tagMatchMode = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ArchivalMemorySearchResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ArchivalMemorySearchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ArchivalMemorySearchResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
