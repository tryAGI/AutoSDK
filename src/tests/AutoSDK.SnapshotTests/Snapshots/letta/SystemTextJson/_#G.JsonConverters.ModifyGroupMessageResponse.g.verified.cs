//HintName: G.JsonConverters.ModifyGroupMessageResponse.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ModifyGroupMessageResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModifyGroupMessageResponse>
    {
        /// <inheritdoc />
        public override global::G.ModifyGroupMessageResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ModifyGroupMessageResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ModifyGroupMessageResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ModifyGroupMessageResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.SystemMessage? systemMessage = default;
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.SystemMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.UserMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.ReasoningMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.HiddenReasoningMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.ToolCallMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.ToolReturnMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.AssistantMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.ApprovalRequestMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.ApprovalResponseMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.SummaryMessage)
            {
            ...
            if (discriminator?.MessageType == global::G.ModifyGroupMessageResponseDiscriminatorMessageType.EventMessage)
            {
            ...
            var __value = new global::G.ModifyGroupMessageResponse(
        ...
        public override void Write(
            ...
            global::G.ModifyGroupMessageResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
