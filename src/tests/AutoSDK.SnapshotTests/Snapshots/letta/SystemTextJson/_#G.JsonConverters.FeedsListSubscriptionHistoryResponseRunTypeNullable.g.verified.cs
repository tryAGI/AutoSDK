...
{
    /// <inheritdoc />
    public sealed class FeedsListSubscriptionHistoryResponseRunTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FeedsListSubscriptionHistoryResponseRunType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.FeedsListSubscriptionHistoryResponseRunTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
