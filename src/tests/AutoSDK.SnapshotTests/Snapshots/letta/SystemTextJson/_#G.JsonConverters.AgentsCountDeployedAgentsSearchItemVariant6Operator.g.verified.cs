...
{
    /// <inheritdoc />
    public sealed class AgentsCountDeployedAgentsSearchItemVariant6OperatorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentsCountDeployedAgentsSearchItemVariant6Operator>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AgentsCountDeployedAgentsSearchItemVariant6OperatorExtensions.ToValueString(value));
        }
    }
}
