...
{
    /// <inheritdoc />
    public sealed class LettaToolReturnContentUnionDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LettaToolReturnContentUnionDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LettaToolReturnContentUnionDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
