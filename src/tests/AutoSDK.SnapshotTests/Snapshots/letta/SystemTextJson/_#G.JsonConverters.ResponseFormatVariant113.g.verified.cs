//HintName: G.JsonConverters.ResponseFormatVariant113.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ResponseFormatVariant113JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseFormatVariant113>
    {
        /// <inheritdoc />
        public override global::G.ResponseFormatVariant113 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.TogetherModelSettingsResponseFormatVariant1Discriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.TogetherModelSettingsResponseFormatVariant1Discriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.TogetherModelSettingsResponseFormatVariant1Discriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextResponseFormat? text = default;
            if (discriminator?.Type == global::G.TogetherModelSettingsResponseFormatVariant1DiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.TogetherModelSettingsResponseFormatVariant1DiscriminatorType.JsonSchema)
            {
            ...
            if (discriminator?.Type == global::G.TogetherModelSettingsResponseFormatVariant1DiscriminatorType.JsonObject)
            {
            ...
            var __value = new global::G.ResponseFormatVariant113(
                discriminator?.Type,
                text,
        ...
        public override void Write(
            ...
            global::G.ResponseFormatVariant113 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
