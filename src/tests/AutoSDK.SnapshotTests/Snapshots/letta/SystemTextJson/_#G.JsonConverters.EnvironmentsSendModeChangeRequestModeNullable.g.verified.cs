...
{
    /// <inheritdoc />
    public sealed class EnvironmentsSendModeChangeRequestModeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EnvironmentsSendModeChangeRequestMode?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.EnvironmentsSendModeChangeRequestModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
