...
namespace G
{
    public partial class MemoryFilesClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_MemoryFilesReadFileContentServers = new global::G.AutoSDKServer[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.MemoryFilesReadFileContentResponse>> MemoryFilesReadFileContentAsResponseAsync(
            string agentId,
            string filePath,
            string? @ref = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                throw global::G.ApiException<global::G.MemoryFilesReadFileContentResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 501)
                            {
                                ...
                                throw global::G.ApiException<global::G.MemoryFilesReadFileContentResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.MemoryFilesReadFileContentResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.MemoryFilesReadFileContentResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.MemoryFilesReadFileContentResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
