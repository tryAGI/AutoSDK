...
{
    /// <inheritdoc />
    public sealed class GetTeamsMetricsMaxMetricJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetTeamsMetricsMaxMetric>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetTeamsMetricsMaxMetricExtensions.ToValueString(value));
        }
    }
}
