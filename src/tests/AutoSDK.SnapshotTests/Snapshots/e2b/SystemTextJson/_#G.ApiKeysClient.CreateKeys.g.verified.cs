            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.CreatedTeamAPIKey.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.CreatedTeamAPIKey.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
