...
{
    /// <inheritdoc />
    public sealed class GetTeamsMetricsMaxMetricNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetTeamsMetricsMaxMetric?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetTeamsMetricsMaxMetricExtensions.ToValueString(value.Value));
            }
        }
    }
}
