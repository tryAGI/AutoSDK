//HintName: G.SandboxesClient.CreateSandboxesBySandboxIDPause.g.cs
...
namespace G
{
    public partial class SandboxesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> CreateSandboxesBySandboxIDPauseAsResponseAsync(
            string sandboxID,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createSandboxesBySandboxIDPause",
                                methodName: "CreateSandboxesBySandboxIDPauseAsync",
                                pathTemplate: "$\"/sandboxes/{sandboxID}/pause\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateSandboxesBySandboxIDPauseResponse(
                    httpClient: HttpClient,
