...
namespace G
{
    public partial interface ISnapshotsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.SnapshotInfo>>> GetSnapshotsAsResponseAsync(
            string? sandboxID = default,
            int? limit = default,
            string? nextToken = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
