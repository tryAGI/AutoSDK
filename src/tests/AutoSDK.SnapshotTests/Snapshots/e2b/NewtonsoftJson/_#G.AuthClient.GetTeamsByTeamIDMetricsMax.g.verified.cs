...
namespace G
{
    public partial class AuthClient
    {
        ...
        partial void PrepareGetTeamsByTeamIDMetricsMaxArguments(
            ...
            ref global::G.GetTeamsMetricsMaxMetric metric);
        ...
        partial void ProcessGetTeamsByTeamIDMetricsMaxResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.MaxTeamMetric> GetTeamsByTeamIDMetricsMaxAsync(
            string teamID,
            global::G.GetTeamsMetricsMaxMetric metric,
            long? start = default,
        ...
        {
            var __response = await GetTeamsByTeamIDMetricsMaxAsResponseAsync(
                teamID: teamID,
                metric: metric,
                start: start,
                end: end,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.MaxTeamMetric>> GetTeamsByTeamIDMetricsMaxAsResponseAsync(
            string teamID,
            global::G.GetTeamsMetricsMaxMetric metric,
            long? start = default,
            global::System.DateTimeOffset? end = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetTeamsByTeamIDMetricsMaxArguments(
            ...
            var metricValue = metric switch
            {
                ...
                global::G.GetTeamsMetricsMaxMetric.SandboxStartRate => "sandbox_start_rate",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getTeamsByTeamIDMetricsMax",
                                methodName: "GetTeamsByTeamIDMetricsMaxAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetTeamsByTeamIDMetricsMaxResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetTeamsByTeamIDMetricsMaxResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.MaxTeamMetric.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.MaxTeamMetric>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.MaxTeamMetric.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
