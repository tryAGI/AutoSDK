...
{
    /// <inheritdoc />
    public sealed class TransliterateRequestSpokenFormNumeralsLanguageNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TransliterateRequestSpokenFormNumeralsLanguage?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TransliterateRequestSpokenFormNumeralsLanguageExtensions.ToValueString(value.Value));
            }
        }
    }
}
