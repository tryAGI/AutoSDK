...
{
    /// <inheritdoc />
    public sealed class TranslateRequestSpeakerGenderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TranslateRequestSpeakerGender?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TranslateRequestSpeakerGenderExtensions.ToValueString(value.Value));
            }
        }
    }
}
