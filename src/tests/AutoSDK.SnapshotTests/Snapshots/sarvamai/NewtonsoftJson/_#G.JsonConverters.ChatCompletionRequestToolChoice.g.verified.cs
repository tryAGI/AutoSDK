...
{
    /// <inheritdoc />
    public sealed class ChatCompletionRequestToolChoiceJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionRequestToolChoice>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatCompletionRequestToolChoiceExtensions.ToValueString(value));
        }
    }
}
