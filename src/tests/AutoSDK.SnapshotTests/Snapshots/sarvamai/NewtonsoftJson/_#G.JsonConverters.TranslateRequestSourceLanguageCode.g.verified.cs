...
{
    /// <inheritdoc />
    public sealed class TranslateRequestSourceLanguageCodeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TranslateRequestSourceLanguageCode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TranslateRequestSourceLanguageCodeExtensions.ToValueString(value));
        }
    }
}
