...
{
    /// <inheritdoc />
    public sealed class TransliterateRequestTargetLanguageCodeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TransliterateRequestTargetLanguageCode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TransliterateRequestTargetLanguageCodeExtensions.ToValueString(value.Value));
            }
        }
    }
}
