...
{
    /// <inheritdoc />
    public sealed class TextToSpeechRequestTargetLanguageCodeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TextToSpeechRequestTargetLanguageCode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TextToSpeechRequestTargetLanguageCodeExtensions.ToValueString(value));
        }
    }
}
