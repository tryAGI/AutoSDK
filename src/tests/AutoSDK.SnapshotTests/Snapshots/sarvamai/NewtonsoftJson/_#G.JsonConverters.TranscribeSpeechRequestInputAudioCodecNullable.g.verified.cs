...
{
    /// <inheritdoc />
    public sealed class TranscribeSpeechRequestInputAudioCodecNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TranscribeSpeechRequestInputAudioCodec?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TranscribeSpeechRequestInputAudioCodecExtensions.ToValueString(value.Value));
            }
        }
    }
}
