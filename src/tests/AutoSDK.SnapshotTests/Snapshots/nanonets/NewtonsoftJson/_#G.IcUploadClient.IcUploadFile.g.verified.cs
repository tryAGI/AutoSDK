...
namespace G
{
    public partial class IcUploadClient
    {
        ...
        {
            var __response = await IcUploadFileAsResponseAsync(
        ...
        /// IRestResponse response = client.Execute(request);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> IcUploadFileAsResponseAsync(
            ...
            foreach (var __authorization in __authorizations)
            {
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            __httpRequestContent.Add(
                                content: new global::System.Net.Http.StringContent(request.Category ?? string.Empty),
                                name: "\"category\"");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "IcUploadFile",
                                methodName: "IcUploadFileAsync",
                                pathTemplate: "\"/ImageCategorization/UploadFile\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.IcUploadFileRequest
            {
                ModelId = modelId,
                Category = category,
