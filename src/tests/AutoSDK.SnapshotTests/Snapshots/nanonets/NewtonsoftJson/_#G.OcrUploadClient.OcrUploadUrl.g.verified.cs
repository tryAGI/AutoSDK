//HintName: G.OcrUploadClient.OcrUploadUrl.g.cs
...
namespace G
{
    public partial class OcrUploadClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_OcrUploadUrlSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_OcrUploadUrlSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_OcrUploadUrlSecurityRequirement0,
            };
        partial void PrepareOcrUploadUrlArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string contentType,
            ref string modelId,
            global::G.OcrUploadUrlRequest request);
        partial void PrepareOcrUploadUrlRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string contentType,
            string modelId,
            global::G.OcrUploadUrlRequest request);
        partial void ProcessOcrUploadUrlResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrUploadUrlResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<string> OcrUploadUrlAsync(
            string contentType,
            string modelId,
        ...
        /// IRestResponse response = client.Execute(request);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> OcrUploadUrlAsResponseAsync(
            string contentType,
            string modelId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_OcrUploadUrlSecurityRequirements,
                operationName: "OcrUploadUrlAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrUploadUrl",
                                methodName: "OcrUploadUrlAsync",
                                pathTemplate: "$\"/OCR/Model/{modelId}/UploadUrls\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrUploadUrlResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> OcrUploadUrlAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.OcrUploadUrlRequest
            {
                Urls = urls,
            };

            return await OcrUploadUrlAsync(
                contentType: contentType,
                modelId: modelId,
                request: __request,
                requestOptions: requestOptions,
