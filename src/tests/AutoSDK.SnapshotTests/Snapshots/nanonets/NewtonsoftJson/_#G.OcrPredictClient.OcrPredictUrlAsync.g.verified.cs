...
namespace G
{
    public partial class OcrPredictClient
    {
        ...
        {
            var __response = await OcrPredictUrlAsyncAsResponseAsync(
                modelId: modelId,
                async: async,
        ...
        /// IRestResponse response = client.Execute(request);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> OcrPredictUrlAsyncAsResponseAsync(
            string modelId,
            bool async,
