//HintName: G.OcrPredictClient.OcrPredictGetFile.g.cs
...
namespace G
{
    public partial class OcrPredictClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_OcrPredictGetFileSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_OcrPredictGetFileSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareOcrPredictGetFileArguments(
            ...
            ref string modelId,
            ref int startDayInterval,
            ref int currentBatchDay);
        partial void PrepareOcrPredictGetFileRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string modelId,
            int startDayInterval,
            int currentBatchDay);
        partial void ProcessOcrPredictGetFileResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessOcrPredictGetFileResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// </remarks>
        public async global::System.Threading.Tasks.Task<string> OcrPredictGetFileAsync(
            string modelId,
            int startDayInterval,
            int currentBatchDay,
        ...
        {
            var __response = await OcrPredictGetFileAsResponseAsync(
                modelId: modelId,
        ...
        /// IRestResponse response = client.Execute(request);
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> OcrPredictGetFileAsResponseAsync(
            string modelId,
            int startDayInterval,
            int currentBatchDay,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareOcrPredictGetFileArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrPredictGetFile",
                                methodName: "OcrPredictGetFileAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessOcrPredictGetFileResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessOcrPredictGetFileResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
