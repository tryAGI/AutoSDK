...
namespace G
{
    public partial class OcrUploadClient
    {
        ...
        {
            var __response = await OcrUploadFileAsResponseAsync(
                modelId: modelId,
        ...
        /// IRestResponse response = client.Execute(request);"
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> OcrUploadFileAsResponseAsync(
            string modelId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OcrUploadFile",
                                methodName: "OcrUploadFileAsync",
                                pathTemplate: "$\"/OCR/Model/{modelId}/UploadFile\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.OcrUploadFileRequest
            {
                Data = data,
