...
namespace G
{
    public partial class SubpackageEntityCollectionsSubpackageEntityCollectionsEntitiesClient
    {
        partial void PrepareListArguments(
            ...
            ref int? pageLimit,
            ref string? name,
            ref global::G.EntityCollectionsEntityCollectionIdEntitiesGetParametersStatus? status,
            ref global::G.EntityCollectionsEntityCollectionIdEntitiesGetParametersSortBy? sortBy,
        ...
        partial void PrepareListRequest(
            ...
            int? pageLimit,
            string? name,
            global::G.EntityCollectionsEntityCollectionIdEntitiesGetParametersStatus? status,
            global::G.EntityCollectionsEntityCollectionIdEntitiesGetParametersSortBy? sortBy,
            string? sortOption,
            string xApiKey);
        ...
        public async global::System.Threading.Tasks.Task<global::G.EntityCollectionsEntitiesListResponse200> ListAsync(
            string entityCollectionId,
            string xApiKey,
            int? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EntityCollectionsEntitiesListResponse200>> ListAsResponseAsync(
            string entityCollectionId,
            string xApiKey,
            int? page = default,
            int? pageLimit = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.ListEntitiesInCollectionRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.ListEntitiesInCollectionRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.ListEntitiesInCollectionRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.EntityCollectionsEntitiesListResponse200.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.EntityCollectionsEntitiesListResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.EntityCollectionsEntitiesListResponse200.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
