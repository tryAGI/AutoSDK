//HintName: G.Models.GetUploadStatusRequestInternalServerError.g.cs
...
namespace G
{
    ...
    public sealed partial class GetUploadStatusRequestInternalServerError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetUploadStatusRequestInternalServerError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
