//HintName: G.Models.ListAsyncEmbeddingTasksRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListAsyncEmbeddingTasksRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListAsyncEmbeddingTasksRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public ListAsyncEmbeddingTasksRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
