...
{
    /// <inheritdoc />
    public sealed class EmbeddingImageMetadataInputTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EmbeddingImageMetadataInputType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.EmbeddingImageMetadataInputTypeExtensions.ToValueString(value));
        }
    }
}
