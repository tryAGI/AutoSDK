//HintName: G.Models.ListIncompleteUploadsRequestForbiddenError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListIncompleteUploadsRequestForbiddenError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListIncompleteUploadsRequestForbiddenError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public ListIncompleteUploadsRequestForbiddenError(
            string? code,
            string? message,
            string? docsUrl)
        {
