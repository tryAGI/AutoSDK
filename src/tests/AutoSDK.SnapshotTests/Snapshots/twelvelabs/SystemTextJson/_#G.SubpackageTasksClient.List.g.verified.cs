...
namespace G
{
    public partial class SubpackageTasksClient
    {
        partial void PrepareListArguments(
            ...
            ref string? indexId,
            global::System.Collections.Generic.IList<global::G.TasksGetParametersStatusSchemaItems>? status,
            ref string? filename,
            ref double? duration,
            ref int? width,
            ref int? height,
        ...
        public async global::System.Threading.Tasks.Task<global::G.TasksListResponse200> ListAsync(
            string xApiKey,
            int? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.TasksListResponse200>> ListAsResponseAsync(
            string xApiKey,
            int? page = default,
            int? pageLimit = default,
            string? sortBy = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.ListVideoIndexingTasksRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.ListVideoIndexingTasksRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.ListVideoIndexingTasksRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.TasksListResponse200.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.TasksListResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.TasksListResponse200.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
