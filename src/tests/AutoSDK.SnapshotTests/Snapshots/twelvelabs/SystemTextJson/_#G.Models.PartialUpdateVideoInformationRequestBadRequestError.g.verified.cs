//HintName: G.Models.PartialUpdateVideoInformationRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class PartialUpdateVideoInformationRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartialUpdateVideoInformationRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public PartialUpdateVideoInformationRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
