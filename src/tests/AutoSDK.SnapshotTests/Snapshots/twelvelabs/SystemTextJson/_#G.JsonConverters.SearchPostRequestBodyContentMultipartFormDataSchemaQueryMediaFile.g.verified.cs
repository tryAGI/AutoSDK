...
{
    /// <inheritdoc />
    public class SearchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFileJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SearchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFile>
    {
        /// <inheritdoc />
        public override global::G.SearchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFile Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            byte[]? searchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFileVariant1 = default;
            global::System.Collections.Generic.IList<byte[]>? searchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFileVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        searchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFileVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        searchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFileVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            var __value = new global::G.SearchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFile(
        ...
        public override void Write(
            ...
            global::G.SearchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFile value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsSearchPostRequestBodyContentMultipartFormDataSchemaQueryMediaFileVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(byte[]), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<byte[]?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(byte[]).Name}");
