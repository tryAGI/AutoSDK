//HintName: G.Models.RemoveEntityAssetsRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class RemoveEntityAssetsRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveEntityAssetsRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public RemoveEntityAssetsRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
