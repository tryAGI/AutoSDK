//HintName: G.Models.CreateEntityCollectionRequestBadRequestError.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateEntityCollectionRequestBadRequestError
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEntityCollectionRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public CreateEntityCollectionRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
