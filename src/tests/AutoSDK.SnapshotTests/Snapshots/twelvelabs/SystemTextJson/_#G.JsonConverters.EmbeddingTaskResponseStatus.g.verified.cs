...
{
    /// <inheritdoc />
    public sealed class EmbeddingTaskResponseStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.EmbeddingTaskResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.EmbeddingTaskResponseStatusExtensions.ToValueString(value));
        }
    }
}
