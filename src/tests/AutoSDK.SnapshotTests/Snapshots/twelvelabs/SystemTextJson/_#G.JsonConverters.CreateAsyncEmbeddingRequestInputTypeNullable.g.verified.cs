...
{
    /// <inheritdoc />
    public sealed class CreateAsyncEmbeddingRequestInputTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateAsyncEmbeddingRequestInputType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateAsyncEmbeddingRequestInputTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
