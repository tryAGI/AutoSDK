//HintName: G.Models.RetrieveAssetRequestBadRequestError.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class RetrieveAssetRequestBadRequestError
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveAssetRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public RetrieveAssetRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
