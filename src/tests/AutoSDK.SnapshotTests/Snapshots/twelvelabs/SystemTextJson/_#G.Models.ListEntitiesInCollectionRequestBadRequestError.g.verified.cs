//HintName: G.Models.ListEntitiesInCollectionRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListEntitiesInCollectionRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListEntitiesInCollectionRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public ListEntitiesInCollectionRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
