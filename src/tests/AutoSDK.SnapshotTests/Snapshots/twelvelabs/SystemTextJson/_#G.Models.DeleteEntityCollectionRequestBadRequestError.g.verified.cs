//HintName: G.Models.DeleteEntityCollectionRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteEntityCollectionRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteEntityCollectionRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public DeleteEntityCollectionRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
