//HintName: G.Models.RetrieveVideoInformationRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class RetrieveVideoInformationRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveVideoInformationRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public RetrieveVideoInformationRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
