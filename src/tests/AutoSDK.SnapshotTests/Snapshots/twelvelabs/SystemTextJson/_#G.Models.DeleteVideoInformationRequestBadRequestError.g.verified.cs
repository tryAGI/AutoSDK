//HintName: G.Models.DeleteVideoInformationRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class DeleteVideoInformationRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteVideoInformationRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
...
#endif
        public DeleteVideoInformationRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
