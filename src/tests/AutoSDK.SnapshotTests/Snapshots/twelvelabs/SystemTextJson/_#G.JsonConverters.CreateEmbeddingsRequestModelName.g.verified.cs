...
{
    /// <inheritdoc />
    public sealed class CreateEmbeddingsRequestModelNameJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateEmbeddingsRequestModelName>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateEmbeddingsRequestModelNameExtensions.ToValueString(value));
        }
    }
}
