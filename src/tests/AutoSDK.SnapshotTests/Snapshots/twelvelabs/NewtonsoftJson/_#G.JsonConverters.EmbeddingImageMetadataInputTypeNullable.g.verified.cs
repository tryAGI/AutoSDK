...
{
    /// <inheritdoc />
    public sealed class EmbeddingImageMetadataInputTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EmbeddingImageMetadataInputType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EmbeddingImageMetadataInputTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
