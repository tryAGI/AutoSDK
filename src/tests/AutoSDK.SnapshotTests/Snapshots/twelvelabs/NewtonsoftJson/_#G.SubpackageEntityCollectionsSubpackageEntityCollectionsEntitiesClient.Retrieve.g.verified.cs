//HintName: G.SubpackageEntityCollectionsSubpackageEntityCollectionsEntitiesClient.Retrieve.g.cs
...
namespace G
{
    public partial class SubpackageEntityCollectionsSubpackageEntityCollectionsEntitiesClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.Entity> RetrieveAsync(
            string entityCollectionId,
            string entityId,
            string xApiKey,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.RetrieveEntityRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.RetrieveEntityRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.RetrieveEntityRequestBadRequestError>(
