...
{
    /// <inheritdoc />
    public sealed class EmbeddingTaskResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EmbeddingTaskResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EmbeddingTaskResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
