//HintName: G.Models.RetrieveVideoIndexingTaskRequestBadRequestError.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class RetrieveVideoIndexingTaskRequestBadRequestError
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveVideoIndexingTaskRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
        ...
        /// The URL of the relevant documentation page.
        /// </param>
        public RetrieveVideoIndexingTaskRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
