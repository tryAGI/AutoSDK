//HintName: G.Models.UpdateEntityCollectionRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateEntityCollectionRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEntityCollectionRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
        ...
        /// The URL of the relevant documentation page.
        /// </param>
        public UpdateEntityCollectionRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
