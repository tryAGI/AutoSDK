//HintName: G.Models.ListIncompleteUploadsRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListIncompleteUploadsRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListIncompleteUploadsRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
        ...
        /// The URL of the relevant documentation page.
        /// </param>
        public ListIncompleteUploadsRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
