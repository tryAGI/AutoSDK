//HintName: G.SubpackageIndexesSubpackageIndexesIndexedAssetsClient.Update.g.cs
...
namespace G
{
    public partial class SubpackageIndexesSubpackageIndexesIndexedAssetsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.IndexesIndexedAssetsUpdateResponse204> UpdateAsync(
            string indexId,
            string indexedAssetId,
            string xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.IndexesIndexedAssetsUpdateResponse204>> UpdateAsResponseAsync(
            string indexId,
            string indexedAssetId,
            string xApiKey,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.PartialUpdateIndexedAssetInformationRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.PartialUpdateIndexedAssetInformationRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.PartialUpdateIndexedAssetInformationRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.IndexesIndexedAssetsUpdateResponse204.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.IndexesIndexedAssetsUpdateResponse204>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.IndexesIndexedAssetsUpdateResponse204.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.IndexesIndexedAssetsUpdateResponse204> UpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UpdateRequest2
            {
