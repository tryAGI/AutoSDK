//HintName: G.Models.CreateMultipartUploadRequestForbiddenError.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateMultipartUploadRequestForbiddenError
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateMultipartUploadRequestForbiddenError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
        ...
        /// The URL of the relevant documentation page.
        /// </param>
        public CreateMultipartUploadRequestForbiddenError(
            string? code,
            string? message,
            string? docsUrl)
        {
