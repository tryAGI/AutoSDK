...
{
    /// <inheritdoc />
    public sealed class ThresholdSearchJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ThresholdSearch>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ThresholdSearchExtensions.ToValueString(value));
        }
    }
}
