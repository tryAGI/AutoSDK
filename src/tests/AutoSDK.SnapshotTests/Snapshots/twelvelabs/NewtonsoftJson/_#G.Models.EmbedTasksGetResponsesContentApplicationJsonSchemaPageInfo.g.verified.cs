//HintName: G.Models.EmbedTasksGetResponsesContentApplicationJsonSchemaPageInfo.g.cs
...
namespace G
{
    ...
    public sealed partial class EmbedTasksGetResponsesContentApplicationJsonSchemaPageInfo
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbedTasksGetResponsesContentApplicationJsonSchemaPageInfo" /> class.
        /// </summary>
        ...
        /// The total number of results.
        /// </param>
        public EmbedTasksGetResponsesContentApplicationJsonSchemaPageInfo(
            int? limitPerPage,
            int? page,
            int? totalPage,
            int? totalResults)
