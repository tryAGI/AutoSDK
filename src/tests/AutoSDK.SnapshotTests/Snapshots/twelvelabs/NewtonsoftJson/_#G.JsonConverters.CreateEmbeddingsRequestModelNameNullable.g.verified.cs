...
{
    /// <inheritdoc />
    public sealed class CreateEmbeddingsRequestModelNameNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateEmbeddingsRequestModelName?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateEmbeddingsRequestModelNameExtensions.ToValueString(value.Value));
            }
        }
    }
}
