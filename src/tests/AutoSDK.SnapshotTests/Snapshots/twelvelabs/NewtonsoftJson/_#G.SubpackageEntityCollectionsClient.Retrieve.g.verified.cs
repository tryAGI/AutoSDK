//HintName: G.SubpackageEntityCollectionsClient.Retrieve.g.cs
...
namespace G
{
    public partial class SubpackageEntityCollectionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.EntityCollection> RetrieveAsync(
            string entityCollectionId,
            string xApiKey,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.RetrieveEntityCollectionRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.RetrieveEntityCollectionRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.RetrieveEntityCollectionRequestBadRequestError>(
