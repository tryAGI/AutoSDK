...
namespace G
{
    public partial class SubpackageEmbedClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EmbeddingResponse>> CreateAsResponseAsync(
            string xApiKey,
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                __httpRequest.Headers.TryAddWithoutValidation("x-api-key", xApiKey.ToString());
                            ...
                            if (request.TextTruncate != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.TextTruncate ?? string.Empty),
                                    name: "\"text_truncate\"");
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::G.ApiException<global::G.CreateTextImageAudioEmbeddingRequestBadRequestError>.Create(
