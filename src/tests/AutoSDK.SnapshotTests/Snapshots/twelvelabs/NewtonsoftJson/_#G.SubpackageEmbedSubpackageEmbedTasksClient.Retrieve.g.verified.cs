//HintName: G.SubpackageEmbedSubpackageEmbedTasksClient.Retrieve.g.cs
...
namespace G
{
    public partial class SubpackageEmbedSubpackageEmbedTasksClient
    {
        partial void PrepareRetrieveArguments(
            ...
            ref string taskId,
            global::System.Collections.Generic.IList<global::G.EmbedTasksTaskIdGetParametersEmbeddingOptionSchemaItems>? embeddingOption,
            ref string xApiKey);
        ...
        public async global::System.Threading.Tasks.Task<global::G.EmbedTasksRetrieveResponse200> RetrieveAsync(
            string taskId,
            string xApiKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EmbedTasksRetrieveResponse200>> RetrieveAsResponseAsync(
            string taskId,
            string xApiKey,
            global::System.Collections.Generic.IList<global::G.EmbedTasksTaskIdGetParametersEmbeddingOptionSchemaItems>? embeddingOption = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/embed/tasks/{taskId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.RetrieveVideoEmbeddingRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.RetrieveVideoEmbeddingRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.RetrieveVideoEmbeddingRequestBadRequestError>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.EmbedTasksRetrieveResponse200.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.EmbedTasksRetrieveResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.EmbedTasksRetrieveResponse200.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
