...
{
    /// <inheritdoc />
    public sealed class HlsObjectStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.HlsObjectStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.HlsObjectStatusExtensions.ToValueString(value));
        }
    }
}
