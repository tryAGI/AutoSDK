//HintName: G.Models.ListIncompleteUploadsRequestInternalServerError.g.cs
...
namespace G
{
    ...
    public sealed partial class ListIncompleteUploadsRequestInternalServerError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListIncompleteUploadsRequestInternalServerError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
        ...
        /// The URL of the relevant documentation page.
        /// </param>
        public ListIncompleteUploadsRequestInternalServerError(
            string? code,
            string? message,
            string? docsUrl)
        {
