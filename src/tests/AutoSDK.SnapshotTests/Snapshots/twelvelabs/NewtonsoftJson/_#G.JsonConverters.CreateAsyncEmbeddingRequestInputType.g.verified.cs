...
{
    /// <inheritdoc />
    public sealed class CreateAsyncEmbeddingRequestInputTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateAsyncEmbeddingRequestInputType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateAsyncEmbeddingRequestInputTypeExtensions.ToValueString(value));
        }
    }
}
