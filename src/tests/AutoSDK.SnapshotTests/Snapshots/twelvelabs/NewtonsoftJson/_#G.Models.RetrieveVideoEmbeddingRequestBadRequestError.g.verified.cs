//HintName: G.Models.RetrieveVideoEmbeddingRequestBadRequestError.g.cs
...
namespace G
{
    ...
    public sealed partial class RetrieveVideoEmbeddingRequestBadRequestError
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RetrieveVideoEmbeddingRequestBadRequestError" /> class.
        /// </summary>
        /// <param name="code">
        /// A string representing the code associated with the error. See the [Error codes](/v1.3/api-reference/error-codes) page for details.
        /// </param>
        ...
        /// The URL of the relevant documentation page.
        /// </param>
        public RetrieveVideoEmbeddingRequestBadRequestError(
            string? code,
            string? message,
            string? docsUrl)
        {
