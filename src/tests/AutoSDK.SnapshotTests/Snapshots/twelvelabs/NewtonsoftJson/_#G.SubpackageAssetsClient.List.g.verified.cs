//HintName: G.SubpackageAssetsClient.List.g.cs
...
namespace G
{
    public partial class SubpackageAssetsClient
    {
        partial void PrepareListArguments(
            ...
            global::System.Collections.Generic.IList<global::G.AssetsGetParametersAssetTypesSchemaItems>? assetTypes,
            ref string xApiKey);
        ...
        public async global::System.Threading.Tasks.Task<global::G.AssetsListResponse200> ListAsync(
            string xApiKey,
            int? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AssetsListResponse200>> ListAsResponseAsync(
            string xApiKey,
            int? page = default,
            int? pageLimit = default,
            global::System.Collections.Generic.IList<string>? assetIds = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::G.ListAssetsRequestBadRequestError? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::G.ListAssetsRequestBadRequestError.FromJson(__content_400, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::G.ApiException<global::G.ListAssetsRequestBadRequestError>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AssetsListResponse200.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AssetsListResponse200>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AssetsListResponse200.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
