            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.IndexesVideosUpdateResponse204.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.IndexesVideosUpdateResponse204.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
