            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                else
                {
                    ...
                    __value_400 = await global::G.PostApiSubscriptionError.FromJsonStreamAsync(__contentStream_400, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                var __responseValue = await global::G.PostApiSubscriptionResponse.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
