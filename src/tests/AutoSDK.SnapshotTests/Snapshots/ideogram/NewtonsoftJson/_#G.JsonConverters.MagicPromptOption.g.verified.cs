...
{
    /// <inheritdoc />
    public sealed class MagicPromptOptionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MagicPromptOption>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.MagicPromptOptionExtensions.ToValueString(value));
        }
    }
}
