...
namespace G
{
    ...
    public readonly partial struct OneOf<T1, T2, T3, T4> : global::System.IEquatable<OneOf<T1, T2, T3, T4>>
    {
        ...
        public static global::G.OneOf<T1, T2, T3, T4>? FromJson(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            return global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.OneOf<T1, T2, T3, T4>>(
                json,
                jsonSerializerOptions);
        }
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.OneOf<T1, T2, T3, T4>?>(serializer.Deserialize<global::G.OneOf<T1, T2, T3, T4>>(jsonReader));
        }
