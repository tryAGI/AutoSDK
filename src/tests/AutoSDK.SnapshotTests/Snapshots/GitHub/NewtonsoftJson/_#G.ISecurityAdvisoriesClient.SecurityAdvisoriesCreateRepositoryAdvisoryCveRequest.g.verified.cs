...
namespace G
{
    public partial interface ISecurityAdvisoriesClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.SecurityAdvisoriesCreateRepositoryAdvisoryCveRequestResponse> SecurityAdvisoriesCreateRepositoryAdvisoryCveRequestAsync(
            string owner,
            string repo,
            string ghsaId,
