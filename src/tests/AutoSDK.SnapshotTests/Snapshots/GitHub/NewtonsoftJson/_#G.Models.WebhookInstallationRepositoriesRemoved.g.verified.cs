...
namespace G
{
    ...
    public sealed partial class WebhookInstallationRepositoriesRemoved
    {
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.WebhookInstallationRepositoriesRemoved?>(serializer.Deserialize<global::G.WebhookInstallationRepositoriesRemoved>(jsonReader));
        }
