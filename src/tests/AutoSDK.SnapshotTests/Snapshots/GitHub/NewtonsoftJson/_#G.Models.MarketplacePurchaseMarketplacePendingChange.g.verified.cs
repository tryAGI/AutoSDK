...
namespace G
{
    ...
    public sealed partial class MarketplacePurchaseMarketplacePendingChange
    {
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.MarketplacePurchaseMarketplacePendingChange?> FromJsonStream(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.MarketplacePurchaseMarketplacePendingChange?>(serializer.Deserialize<global::G.MarketplacePurchaseMarketplacePendingChange>(jsonReader));
        }
