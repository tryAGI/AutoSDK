...
namespace G
{
    ...
    public sealed partial class ActionsCacheUsageByRepository
    {
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.ActionsCacheUsageByRepository?>(serializer.Deserialize<global::G.ActionsCacheUsageByRepository>(jsonReader));
        }
