    ...
    public partial class ReposClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::G.BranchProtection.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                var __responseValue = await global::G.BranchProtection.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
