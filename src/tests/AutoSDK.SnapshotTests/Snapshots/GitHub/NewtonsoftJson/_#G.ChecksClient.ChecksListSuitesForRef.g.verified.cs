    ...
    public partial class ChecksClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::G.ChecksListSuitesForRefResponse.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                var __responseValue = await global::G.ChecksListSuitesForRefResponse.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
