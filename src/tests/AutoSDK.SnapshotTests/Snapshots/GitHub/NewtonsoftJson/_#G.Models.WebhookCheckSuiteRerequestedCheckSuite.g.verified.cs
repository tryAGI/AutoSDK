...
namespace G
{
    ...
    public sealed partial class WebhookCheckSuiteRerequestedCheckSuite
    {
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.WebhookCheckSuiteRerequestedCheckSuite?>(serializer.Deserialize<global::G.WebhookCheckSuiteRerequestedCheckSuite>(jsonReader));
        }
