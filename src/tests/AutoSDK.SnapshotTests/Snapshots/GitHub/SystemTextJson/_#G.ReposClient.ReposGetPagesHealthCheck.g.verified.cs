    ...
    public partial class ReposClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                return
                    global::G.PagesHealthCheck.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                ...
                var __responseValue = await global::G.PagesHealthCheck.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
