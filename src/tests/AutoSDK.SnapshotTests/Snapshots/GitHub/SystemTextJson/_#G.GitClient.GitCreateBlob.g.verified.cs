            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                else
                {
                    ...
                    __value_422 = await global::G.OneOf<global::G.ValidationError, global::G.RepositoryRuleViolationError>.FromJsonStreamAsync(__contentStream_422, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                var __responseValue = await global::G.ShortBlob.FromJsonStreamAsync(__responseStream, JsonSerializerOptions).ConfigureAwait(false);
