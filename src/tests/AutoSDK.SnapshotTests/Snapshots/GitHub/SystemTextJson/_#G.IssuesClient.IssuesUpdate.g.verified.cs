            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                else
                {
                    ...
                    __value_503 = await global::G.IssuesUpdateResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerOptions).ConfigureAwait(false);
                }

                throw new global::G.ApiException<global::G.IssuesUpdateResponse>(
                    message: __response.ReasonPhrase ?? string.Empty,
                    statusCode: __response.StatusCode)
                {
            ...
            else
            {
                ...
                return
                    await global::G.Issue.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
