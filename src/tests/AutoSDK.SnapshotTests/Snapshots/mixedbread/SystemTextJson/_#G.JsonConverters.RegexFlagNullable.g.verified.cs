...
{
    /// <inheritdoc />
    public sealed class RegexFlagNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RegexFlag?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RegexFlagExtensions.ToValueString(value.Value));
            }
        }
    }
}
