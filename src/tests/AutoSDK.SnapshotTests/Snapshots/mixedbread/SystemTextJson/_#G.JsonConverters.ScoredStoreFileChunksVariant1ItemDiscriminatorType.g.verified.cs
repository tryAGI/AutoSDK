...
{
    /// <inheritdoc />
    public sealed class ScoredStoreFileChunksVariant1ItemDiscriminatorTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ScoredStoreFileChunksVariant1ItemDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ScoredStoreFileChunksVariant1ItemDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
