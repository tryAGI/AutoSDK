...
{
    /// <inheritdoc />
    public sealed class RegexFlagJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RegexFlag>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RegexFlagExtensions.ToValueString(value));
        }
    }
}
