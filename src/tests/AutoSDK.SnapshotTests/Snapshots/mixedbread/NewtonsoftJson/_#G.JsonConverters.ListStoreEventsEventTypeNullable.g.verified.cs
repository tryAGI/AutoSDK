...
{
    /// <inheritdoc />
    public sealed class ListStoreEventsEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListStoreEventsEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListStoreEventsEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
