//HintName: G.StoresClient.GetStoreEventHistogram.g.cs
...
namespace G
{
    public partial class StoresClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_GetStoreEventHistogramServers = new global::G.AutoSDKServer[]
        ...
        private static readonly global::G.EndPointSecurityRequirement s_GetStoreEventHistogramSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_GetStoreEventHistogramSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareGetStoreEventHistogramRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.AnyOf<string, global::System.Guid?> storeIdentifier,
            global::G.StoreEventHistogramParams request);
        partial void ProcessGetStoreEventHistogramResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetStoreEventHistogramResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.StoreEventHistogramResponse> GetStoreEventHistogramAsync(
            global::G.AnyOf<string, global::System.Guid?> storeIdentifier,
        ...
        {
            var __response = await GetStoreEventHistogramAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.StoreEventHistogramResponse>> GetStoreEventHistogramAsResponseAsync(
            global::G.AnyOf<string, global::System.Guid?> storeIdentifier,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetStoreEventHistogramArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_GetStoreEventHistogramServers,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetStoreEventHistogram",
                                methodName: "GetStoreEventHistogramAsync",
                                pathTemplate: "$\"/v1/stores/{storeIdentifier}/events/histogram\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetStoreEventHistogramResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetStoreEventHistogramResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.StoreEventHistogramResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.StoreEventHistogramResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.StoreEventHistogramResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
