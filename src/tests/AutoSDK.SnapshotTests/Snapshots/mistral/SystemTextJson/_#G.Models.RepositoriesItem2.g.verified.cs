...
namespace G
{
    ...
    public readonly partial struct RepositoriesItem2 : global::System.IEquatable<RepositoriesItem2>
    {
...
#endif
            out global::G.GithubRepositoryOut? value)
        {
            value = Github;
            return IsGithub;
        }
        ...
        /// 
        /// </summary>
        public global::G.GithubRepositoryOut PickGithub() => IsGithub
            ? Github!
            : throw new global::System.InvalidOperationException($"Expected union variant 'Github' but the value was {ToString()}.");
        /// <summary>
        /// 
        /// </summary>
        public static implicit operator RepositoriesItem2(global::G.GithubRepositoryOut value) => new RepositoriesItem2((global::G.GithubRepositoryOut?)value);

        /// <summary>
        /// 
        /// </summary>
        public static implicit operator global::G.GithubRepositoryOut?(RepositoriesItem2 @this) => @this.Github;

        /// <summary>
        /// 
        /// </summary>
        public RepositoriesItem2(global::G.GithubRepositoryOut? value)
        {
            Github = value;
        }
        ...
        /// 
        /// </summary>
        public static RepositoriesItem2 FromGithub(global::G.GithubRepositoryOut? value) => new RepositoriesItem2(value);
