...
{
    /// <inheritdoc />
    public sealed class CompletionResponseStreamChoiceFinishReasonJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CompletionResponseStreamChoiceFinishReason>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CompletionResponseStreamChoiceFinishReasonExtensions.ToValueString(value));
        }
    }
}
