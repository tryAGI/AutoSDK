//HintName: G.JsonConverters.JobsApiRoutesFineTuningCancelFineTuningJobResponse.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class JobsApiRoutesFineTuningCancelFineTuningJobResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponse>
    {
        /// <inheritdoc />
        public override global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.CompletionDetailedJobOut? completion = default;
            if (discriminator?.JobType == global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponseDiscriminatorJobType.Completion)
            {
            ...
            if (discriminator?.JobType == global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponseDiscriminatorJobType.Classifier)
            {
            ...
            var __value = new global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponse(
        ...
        public override void Write(
            ...
            global::G.JobsApiRoutesFineTuningCancelFineTuningJobResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
