...
{
    /// <inheritdoc />
    public sealed class ImageURLChunkTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ImageURLChunkType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ImageURLChunkTypeExtensions.ToValueString(value));
        }
    }
}
