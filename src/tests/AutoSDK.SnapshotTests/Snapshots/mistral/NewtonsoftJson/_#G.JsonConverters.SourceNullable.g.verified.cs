...
{
    /// <inheritdoc />
    public sealed class SourceNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.Source?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SourceExtensions.ToValueString(value.Value));
            }
        }
    }
}
