...
{
    /// <inheritdoc />
    public sealed class JobsOutDataItemDiscriminatorJobTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.JobsOutDataItemDiscriminatorJobType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.JobsOutDataItemDiscriminatorJobTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
