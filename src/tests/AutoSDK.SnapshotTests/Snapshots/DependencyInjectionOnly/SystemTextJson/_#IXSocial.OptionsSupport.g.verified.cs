...
namespace IXSocial
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::IXSocial.AutoSDKRetryOptions Retry { get; set; } = new global::IXSocial.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::IXSocial.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::IXSocial.IAutoSDKHook>();
        ...
        public global::IXSocial.AutoSDKClientOptions AddHook(
            global::IXSocial.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::IXSocial.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::IXSocial.AutoSDKClientOptions UseAuthorizationProvider(
            global::IXSocial.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::IXSocial.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::IXSocial.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::IXSocial.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::IXSocial.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::IXSocial.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::IXSocial.AutoSDKHook
    {
        /// <inheritdoc />
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::IXSocial.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::IXSocial.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::IXSocial.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::IXSocial.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::IXSocial.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::IXSocial.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::IXSocial.AutoSDKClientOptions clientOptions,
            global::IXSocial.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::IXSocial.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::IXSocial.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::IXSocial.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::IXSocial.AutoSDKClientOptions clientOptions,
            global::System.Func<global::IXSocial.IAutoSDKHook, global::IXSocial.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::IXSocial.AutoSDKHookContext context)
        {
