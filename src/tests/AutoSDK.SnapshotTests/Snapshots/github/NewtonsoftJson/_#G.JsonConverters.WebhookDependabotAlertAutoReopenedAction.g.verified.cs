...
{
    /// <inheritdoc />
    public sealed class WebhookDependabotAlertAutoReopenedActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDependabotAlertAutoReopenedAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookDependabotAlertAutoReopenedActionExtensions.ToValueString(value));
        }
    }
}
