...
namespace G
{
    public partial interface IPullsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.PullRequestReviewComment>>> PullsListReviewCommentsForRepoAsResponseAsync(
            string owner,
            string repo,
            global::G.PullsListReviewCommentsForRepoSort? sort = default,
            global::G.PullsListReviewCommentsForRepoDirection? direction = default,
