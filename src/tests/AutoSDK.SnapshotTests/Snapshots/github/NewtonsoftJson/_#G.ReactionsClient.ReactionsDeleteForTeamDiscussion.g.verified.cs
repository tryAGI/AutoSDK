...
namespace G
{
    public partial class ReactionsClient
    {
        ...
        {
            await ReactionsDeleteForTeamDiscussionAsResponseAsync(
                org: org,
                teamSlug: teamSlug,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> ReactionsDeleteForTeamDiscussionAsResponseAsync(
            string org,
            string teamSlug,
            int discussionNumber,
            int reactionId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/teams/{teamSlug}/discussions/{discussionNumber}/reactions/{reactionId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
