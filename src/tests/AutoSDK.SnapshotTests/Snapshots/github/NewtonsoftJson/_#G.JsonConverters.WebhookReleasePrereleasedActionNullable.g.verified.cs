...
{
    /// <inheritdoc />
    public sealed class WebhookReleasePrereleasedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookReleasePrereleasedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookReleasePrereleasedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
