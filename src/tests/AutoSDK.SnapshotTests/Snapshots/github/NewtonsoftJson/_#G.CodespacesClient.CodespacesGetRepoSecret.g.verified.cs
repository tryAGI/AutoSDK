...
namespace G
{
    public partial class CodespacesClient
    {
        ...
        {
            var __response = await CodespacesGetRepoSecretAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RepoCodespacesSecret>> CodespacesGetRepoSecretAsResponseAsync(
            string owner,
            string repo,
            string secretName,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.RepoCodespacesSecret.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.RepoCodespacesSecret>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.RepoCodespacesSecret.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
