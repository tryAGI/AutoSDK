...
{
    /// <inheritdoc />
    public sealed class WebhookTeamDeletedRepositoryVisibilityJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookTeamDeletedRepositoryVisibility>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookTeamDeletedRepositoryVisibilityExtensions.ToValueString(value));
        }
    }
}
