...
{
    /// <inheritdoc />
    public sealed class WebhookProjectCardEditedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookProjectCardEditedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookProjectCardEditedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
