...
{
    /// <inheritdoc />
    public sealed class CodespacesCreateForAuthenticatedUserRequestVariant2GeoNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CodespacesCreateForAuthenticatedUserRequestVariant2Geo?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CodespacesCreateForAuthenticatedUserRequestVariant2GeoExtensions.ToValueString(value.Value));
            }
        }
    }
}
