...
{
    /// <inheritdoc />
    public sealed class MigrationsSetLfsPreferenceRequestUseLfsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MigrationsSetLfsPreferenceRequestUseLfs?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MigrationsSetLfsPreferenceRequestUseLfsExtensions.ToValueString(value.Value));
            }
        }
    }
}
