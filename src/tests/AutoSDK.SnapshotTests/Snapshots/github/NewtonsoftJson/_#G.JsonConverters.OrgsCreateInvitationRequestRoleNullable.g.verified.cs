...
{
    /// <inheritdoc />
    public sealed class OrgsCreateInvitationRequestRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrgsCreateInvitationRequestRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OrgsCreateInvitationRequestRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
