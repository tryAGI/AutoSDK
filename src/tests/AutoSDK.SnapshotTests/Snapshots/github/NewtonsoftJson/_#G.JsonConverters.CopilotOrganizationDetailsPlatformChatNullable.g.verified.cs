...
{
    /// <inheritdoc />
    public sealed class CopilotOrganizationDetailsPlatformChatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CopilotOrganizationDetailsPlatformChat?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CopilotOrganizationDetailsPlatformChatExtensions.ToValueString(value.Value));
            }
        }
    }
}
