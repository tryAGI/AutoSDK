...
namespace G
{
    public partial class SecurityAdvisoriesClient
    {
        ...
        {
            var __response = await SecurityAdvisoriesUpdateRepositoryAdvisoryAsResponseAsync(
                owner: owner,
                repo: repo,
                ghsaId: ghsaId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RepositoryAdvisory>> SecurityAdvisoriesUpdateRepositoryAdvisoryAsResponseAsync(
            string owner,
            string repo,
            string ghsaId,
