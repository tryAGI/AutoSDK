...
{
    /// <inheritdoc />
    public sealed class WebhookDiscussionCommentDeletedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDiscussionCommentDeletedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookDiscussionCommentDeletedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
