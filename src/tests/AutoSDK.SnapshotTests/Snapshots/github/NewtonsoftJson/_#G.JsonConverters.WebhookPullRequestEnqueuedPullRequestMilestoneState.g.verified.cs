...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestEnqueuedPullRequestMilestoneStateJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestEnqueuedPullRequestMilestoneState>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookPullRequestEnqueuedPullRequestMilestoneStateExtensions.ToValueString(value));
        }
    }
}
