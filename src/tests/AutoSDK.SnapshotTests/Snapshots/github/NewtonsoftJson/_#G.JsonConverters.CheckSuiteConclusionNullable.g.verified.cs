...
{
    /// <inheritdoc />
    public sealed class CheckSuiteConclusionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CheckSuiteConclusion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CheckSuiteConclusionExtensions.ToValueString(value.Value));
            }
        }
    }
}
