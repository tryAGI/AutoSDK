...
{
    /// <inheritdoc />
    public sealed class DependencyRelationshipNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DependencyRelationship?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DependencyRelationshipExtensions.ToValueString(value.Value));
            }
        }
    }
}
