...
{
    /// <inheritdoc />
    public sealed class RepositoryRulesetSourceTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RepositoryRulesetSourceType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RepositoryRulesetSourceTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
