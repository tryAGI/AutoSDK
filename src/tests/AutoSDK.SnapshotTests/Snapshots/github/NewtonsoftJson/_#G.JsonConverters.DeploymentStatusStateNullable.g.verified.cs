...
{
    /// <inheritdoc />
    public sealed class DeploymentStatusStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeploymentStatusState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeploymentStatusStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
