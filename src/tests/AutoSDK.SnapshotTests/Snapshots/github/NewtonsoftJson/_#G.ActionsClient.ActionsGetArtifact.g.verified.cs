...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsGetArtifactAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Artifact>> ActionsGetArtifactAsResponseAsync(
            string owner,
            string repo,
            int artifactId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Artifact.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.Artifact>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Artifact.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
