...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            await ActionsDeleteEnvironmentVariableAsResponseAsync(
                owner: owner,
                repo: repo,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> ActionsDeleteEnvironmentVariableAsResponseAsync(
            string owner,
            string repo,
            string name,
            string environmentName,
