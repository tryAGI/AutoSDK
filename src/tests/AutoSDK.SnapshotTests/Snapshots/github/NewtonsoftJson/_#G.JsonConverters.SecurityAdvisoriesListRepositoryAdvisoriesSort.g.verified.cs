...
{
    /// <inheritdoc />
    public sealed class SecurityAdvisoriesListRepositoryAdvisoriesSortJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SecurityAdvisoriesListRepositoryAdvisoriesSort>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SecurityAdvisoriesListRepositoryAdvisoriesSortExtensions.ToValueString(value));
        }
    }
}
