...
namespace G
{
    public partial class ChecksClient
    {
        ...
        {
            var __response = await ChecksUpdateAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CheckRun>> ChecksUpdateAsResponseAsync(
            string owner,
            string repo,
            int checkRunId,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CheckRun.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CheckRun>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CheckRun.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
