...
{
    /// <inheritdoc />
    public sealed class WebhookDeploymentStatusCreatedCheckRunConclusionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDeploymentStatusCreatedCheckRunConclusion>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookDeploymentStatusCreatedCheckRunConclusionExtensions.ToValueString(value));
        }
    }
}
