...
namespace G
{
    public partial class PullsClient
    {
        ...
        {
            var __response = await PullsGetReviewCommentAsResponseAsync(
                owner: owner,
                repo: repo,
                commentId: commentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PullRequestReviewComment>> PullsGetReviewCommentAsResponseAsync(
            string owner,
            string repo,
            long commentId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/pulls/comments/{commentId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
