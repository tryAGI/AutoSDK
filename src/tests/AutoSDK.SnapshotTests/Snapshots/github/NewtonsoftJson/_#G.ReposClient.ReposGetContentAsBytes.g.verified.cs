//HintName: G.ReposClient.ReposGetContentAsBytes.g.cs
...
namespace G
{
    public partial class ReposClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ReposGetContentAsBytesServers = new global::G.AutoSDKServer[]
        ...
        partial void PrepareReposGetContentAsBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string owner,
            ref string repo,
            ref string path,
            ref string? @ref);
        partial void PrepareReposGetContentAsBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string path,
            string? @ref);
        partial void ProcessReposGetContentAsBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessReposGetContentAsBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> ReposGetContentAsBytesAsync(
            string owner,
            string repo,
            string path,
            string? @ref = default,
        ...
        {
            var __response = await ReposGetContentAsBytesAsResponseAsync(
                owner: owner,
                repo: repo,
                path: path,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::System.IO.Stream> ReposGetContentAsBytesAsStreamAsync(
            string owner,
            string repo,
            string path,
            string? @ref = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareReposGetContentAsBytesArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ReposGetContentAsBytesServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareReposGetContentAsBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ReposGetContentAsBytes",
                                methodName: "ReposGetContentAsBytesAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessReposGetContentAsBytesResponse(
                    httpClient: HttpClient,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<byte[]>> ReposGetContentAsBytesAsResponseAsync(
            string owner,
            string repo,
            string path,
            string? @ref = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessReposGetContentAsBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
