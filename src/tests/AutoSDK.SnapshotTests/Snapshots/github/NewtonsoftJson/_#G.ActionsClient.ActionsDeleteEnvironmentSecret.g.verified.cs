...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            await ActionsDeleteEnvironmentSecretAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> ActionsDeleteEnvironmentSecretAsResponseAsync(
            string owner,
            string repo,
            string environmentName,
            string secretName,
