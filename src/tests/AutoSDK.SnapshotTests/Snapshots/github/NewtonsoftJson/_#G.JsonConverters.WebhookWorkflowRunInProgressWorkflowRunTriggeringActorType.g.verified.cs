...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowRunInProgressWorkflowRunTriggeringActorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowRunInProgressWorkflowRunTriggeringActorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookWorkflowRunInProgressWorkflowRunTriggeringActorTypeExtensions.ToValueString(value));
        }
    }
}
