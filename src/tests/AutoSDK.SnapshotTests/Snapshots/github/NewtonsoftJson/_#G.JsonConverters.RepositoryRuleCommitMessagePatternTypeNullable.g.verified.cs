...
{
    /// <inheritdoc />
    public sealed class RepositoryRuleCommitMessagePatternTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RepositoryRuleCommitMessagePatternType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RepositoryRuleCommitMessagePatternTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
