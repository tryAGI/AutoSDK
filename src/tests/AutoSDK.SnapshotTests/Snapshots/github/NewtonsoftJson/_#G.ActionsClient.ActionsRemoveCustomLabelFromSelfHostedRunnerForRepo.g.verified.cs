...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsRemoveCustomLabelFromSelfHostedRunnerForRepoAsResponseAsync(
                owner: owner,
                repo: repo,
                runnerId: runnerId,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForRepoResponse>> ActionsRemoveCustomLabelFromSelfHostedRunnerForRepoAsResponseAsync(
            string owner,
            string repo,
            int runnerId,
            string name,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/actions/runners/{runnerId}/labels/{name}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForRepoResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForRepoResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForRepoResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
