...
{
    /// <inheritdoc />
    public sealed class WebhookDiscussionReopenedActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDiscussionReopenedAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookDiscussionReopenedActionExtensions.ToValueString(value));
        }
    }
}
