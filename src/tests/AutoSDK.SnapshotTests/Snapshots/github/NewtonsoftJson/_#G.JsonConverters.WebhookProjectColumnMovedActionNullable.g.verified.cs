...
{
    /// <inheritdoc />
    public sealed class WebhookProjectColumnMovedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookProjectColumnMovedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookProjectColumnMovedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
