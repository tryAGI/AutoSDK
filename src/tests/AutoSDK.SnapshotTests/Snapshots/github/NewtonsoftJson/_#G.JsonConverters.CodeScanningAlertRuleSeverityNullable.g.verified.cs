...
{
    /// <inheritdoc />
    public sealed class CodeScanningAlertRuleSeverityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CodeScanningAlertRuleSeverity?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CodeScanningAlertRuleSeverityExtensions.ToValueString(value.Value));
            }
        }
    }
}
