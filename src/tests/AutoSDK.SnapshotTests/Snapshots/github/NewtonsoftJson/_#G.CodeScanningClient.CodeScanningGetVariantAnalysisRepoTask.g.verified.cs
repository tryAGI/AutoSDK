...
namespace G
{
    public partial class CodeScanningClient
    {
        ...
        {
            var __response = await CodeScanningGetVariantAnalysisRepoTaskAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CodeScanningVariantAnalysisRepoTask>> CodeScanningGetVariantAnalysisRepoTaskAsResponseAsync(
            string owner,
            string repo,
            int codeqlVariantAnalysisId,
            string repoOwner,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.CodeScanningGetVariantAnalysisRepoTaskResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CodeScanningVariantAnalysisRepoTask.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CodeScanningVariantAnalysisRepoTask>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CodeScanningVariantAnalysisRepoTask.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
