...
{
    /// <inheritdoc />
    public sealed class WebhookProjectCardMovedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookProjectCardMovedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookProjectCardMovedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
