...
{
    /// <inheritdoc />
    public sealed class ReposCreateForAuthenticatedUserRequestSquashMergeCommitMessageNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReposCreateForAuthenticatedUserRequestSquashMergeCommitMessage?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReposCreateForAuthenticatedUserRequestSquashMergeCommitMessageExtensions.ToValueString(value.Value));
            }
        }
    }
}
