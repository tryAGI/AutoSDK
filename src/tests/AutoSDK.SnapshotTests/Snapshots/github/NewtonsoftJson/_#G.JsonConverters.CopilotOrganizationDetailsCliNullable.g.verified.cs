...
{
    /// <inheritdoc />
    public sealed class CopilotOrganizationDetailsCliNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CopilotOrganizationDetailsCli?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CopilotOrganizationDetailsCliExtensions.ToValueString(value.Value));
            }
        }
    }
}
