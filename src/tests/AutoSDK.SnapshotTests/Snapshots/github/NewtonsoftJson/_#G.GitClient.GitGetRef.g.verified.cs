...
namespace G
{
    public partial class GitClient
    {
        ...
        {
            var __response = await GitGetRefAsResponseAsync(
                owner: owner,
                repo: repo,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GitRef>> GitGetRefAsResponseAsync(
            string owner,
            string repo,
            string @ref,
            global::G.AutoSDKRequestOptions? requestOptions = default,
