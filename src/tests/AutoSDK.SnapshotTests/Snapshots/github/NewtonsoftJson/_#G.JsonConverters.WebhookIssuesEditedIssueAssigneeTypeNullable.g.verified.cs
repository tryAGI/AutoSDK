...
{
    /// <inheritdoc />
    public sealed class WebhookIssuesEditedIssueAssigneeTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookIssuesEditedIssueAssigneeType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookIssuesEditedIssueAssigneeTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
