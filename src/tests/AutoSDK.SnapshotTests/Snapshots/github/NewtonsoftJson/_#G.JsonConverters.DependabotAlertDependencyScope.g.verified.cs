...
{
    /// <inheritdoc />
    public sealed class DependabotAlertDependencyScopeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DependabotAlertDependencyScope>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.DependabotAlertDependencyScopeExtensions.ToValueString(value));
        }
    }
}
