...
{
    /// <inheritdoc />
    public sealed class OrganizationActionsVariableVisibilityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrganizationActionsVariableVisibility?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OrganizationActionsVariableVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
