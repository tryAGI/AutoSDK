...
namespace G
{
    public partial class OrgsClient
    {
        ...
        {
            await OrgsAssignTeamToOrgRoleAsResponseAsync(
                org: org,
                teamSlug: teamSlug,
                roleId: roleId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> OrgsAssignTeamToOrgRoleAsResponseAsync(
            string org,
            string teamSlug,
            int roleId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/organization-roles/teams/{teamSlug}/{roleId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
