...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowRunRequestedWorkflowRunActorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowRunRequestedWorkflowRunActorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookWorkflowRunRequestedWorkflowRunActorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
