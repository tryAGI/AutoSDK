...
{
    /// <inheritdoc />
    public sealed class SecretScanningPushProtectionBypassReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SecretScanningPushProtectionBypassReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SecretScanningPushProtectionBypassReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
