...
{
    /// <inheritdoc />
    public sealed class PullsSubmitReviewRequestEventJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PullsSubmitReviewRequestEvent>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PullsSubmitReviewRequestEventExtensions.ToValueString(value));
        }
    }
}
