...
{
    /// <inheritdoc />
    public sealed class WebhooksMilestone3StateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhooksMilestone3State?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhooksMilestone3StateExtensions.ToValueString(value.Value));
            }
        }
    }
}
