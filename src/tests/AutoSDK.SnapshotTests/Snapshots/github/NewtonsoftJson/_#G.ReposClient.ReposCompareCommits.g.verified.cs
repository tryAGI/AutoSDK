...
namespace G
{
    public partial class ReposClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ReposCompareCommitsServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await ReposCompareCommitsAsResponseAsync(
                owner: owner,
                repo: repo,
                basehead: basehead,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CommitComparison>> ReposCompareCommitsAsResponseAsync(
            string owner,
            string repo,
            string basehead,
            int? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ReposCompareCommitsServers,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.ReposCompareCommitsResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CommitComparison.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CommitComparison>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CommitComparison.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
