...
{
    /// <inheritdoc />
    public sealed class IssuesListForAuthenticatedUserStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IssuesListForAuthenticatedUserState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.IssuesListForAuthenticatedUserStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
