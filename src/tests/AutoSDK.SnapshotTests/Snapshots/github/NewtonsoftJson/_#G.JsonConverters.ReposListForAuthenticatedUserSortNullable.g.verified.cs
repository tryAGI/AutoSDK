...
{
    /// <inheritdoc />
    public sealed class ReposListForAuthenticatedUserSortNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReposListForAuthenticatedUserSort?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReposListForAuthenticatedUserSortExtensions.ToValueString(value.Value));
            }
        }
    }
}
