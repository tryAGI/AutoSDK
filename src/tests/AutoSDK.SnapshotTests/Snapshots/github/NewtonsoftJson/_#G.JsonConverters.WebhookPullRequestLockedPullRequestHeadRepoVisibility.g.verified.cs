...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestLockedPullRequestHeadRepoVisibilityJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestLockedPullRequestHeadRepoVisibility>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookPullRequestLockedPullRequestHeadRepoVisibilityExtensions.ToValueString(value));
        }
    }
}
