...
{
    /// <inheritdoc />
    public sealed class IssuesListForOrgFilterNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IssuesListForOrgFilter?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.IssuesListForOrgFilterExtensions.ToValueString(value.Value));
            }
        }
    }
}
