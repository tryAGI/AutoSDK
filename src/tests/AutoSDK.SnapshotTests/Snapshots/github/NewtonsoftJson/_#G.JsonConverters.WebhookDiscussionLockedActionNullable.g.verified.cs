...
{
    /// <inheritdoc />
    public sealed class WebhookDiscussionLockedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDiscussionLockedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookDiscussionLockedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
