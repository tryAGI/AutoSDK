...
{
    /// <inheritdoc />
    public sealed class WebhookStarDeletedActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookStarDeletedAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookStarDeletedActionExtensions.ToValueString(value));
        }
    }
}
