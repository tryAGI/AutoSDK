...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowJobCompletedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowJobCompletedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookWorkflowJobCompletedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
