...
{
    /// <inheritdoc />
    public sealed class WebhookOrganizationMemberInvitedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookOrganizationMemberInvitedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookOrganizationMemberInvitedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
