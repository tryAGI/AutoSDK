...
{
    /// <inheritdoc />
    public sealed class WebhooksPullRequest5BaseRepoOwnerTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhooksPullRequest5BaseRepoOwnerType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhooksPullRequest5BaseRepoOwnerTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
