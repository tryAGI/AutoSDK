...
{
    /// <inheritdoc />
    public sealed class WebhooksRulePullRequestReviewsEnforcementLevelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhooksRulePullRequestReviewsEnforcementLevel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhooksRulePullRequestReviewsEnforcementLevelExtensions.ToValueString(value.Value));
            }
        }
    }
}
