...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestUnlabeledPullRequestStateJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestUnlabeledPullRequestState>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookPullRequestUnlabeledPullRequestStateExtensions.ToValueString(value));
        }
    }
}
