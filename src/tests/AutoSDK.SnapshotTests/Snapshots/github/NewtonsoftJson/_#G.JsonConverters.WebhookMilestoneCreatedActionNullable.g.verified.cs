...
{
    /// <inheritdoc />
    public sealed class WebhookMilestoneCreatedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookMilestoneCreatedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookMilestoneCreatedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
