...
namespace G
{
    public sealed partial class SecretScanningLocationPullRequestReview
    {
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.SecretScanningLocationPullRequestReview?>(serializer.Deserialize<global::G.SecretScanningLocationPullRequestReview>(jsonReader));
        }
    }
}
