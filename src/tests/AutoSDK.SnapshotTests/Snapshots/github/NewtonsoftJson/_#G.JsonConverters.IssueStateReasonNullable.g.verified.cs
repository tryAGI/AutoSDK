...
{
    /// <inheritdoc />
    public sealed class IssueStateReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IssueStateReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.IssueStateReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
