...
{
    /// <inheritdoc />
    public sealed class WebhookDeploymentReviewApprovedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDeploymentReviewApprovedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookDeploymentReviewApprovedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
