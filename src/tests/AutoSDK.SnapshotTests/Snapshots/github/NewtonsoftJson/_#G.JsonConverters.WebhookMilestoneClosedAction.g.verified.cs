...
{
    /// <inheritdoc />
    public sealed class WebhookMilestoneClosedActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookMilestoneClosedAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookMilestoneClosedActionExtensions.ToValueString(value));
        }
    }
}
