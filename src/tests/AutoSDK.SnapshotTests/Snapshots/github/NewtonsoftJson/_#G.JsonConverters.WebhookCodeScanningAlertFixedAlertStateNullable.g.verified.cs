...
{
    /// <inheritdoc />
    public sealed class WebhookCodeScanningAlertFixedAlertStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookCodeScanningAlertFixedAlertState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookCodeScanningAlertFixedAlertStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
