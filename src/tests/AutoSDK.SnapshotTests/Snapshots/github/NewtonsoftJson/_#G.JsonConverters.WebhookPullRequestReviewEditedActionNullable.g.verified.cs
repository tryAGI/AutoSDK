...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestReviewEditedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestReviewEditedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPullRequestReviewEditedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
