...
{
    /// <inheritdoc />
    public sealed class WebhookWatchStartedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWatchStartedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookWatchStartedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
