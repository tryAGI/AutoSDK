...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowRunRequestedWorkflowRunStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowRunRequestedWorkflowRunStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookWorkflowRunRequestedWorkflowRunStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
