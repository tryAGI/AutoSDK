...
{
    /// <inheritdoc />
    public sealed class SimpleCheckSuiteConclusionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SimpleCheckSuiteConclusion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SimpleCheckSuiteConclusionExtensions.ToValueString(value.Value));
            }
        }
    }
}
