...
{
    /// <inheritdoc />
    public sealed class WebhookCommitCommentCreatedCommentAuthorAssociationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookCommitCommentCreatedCommentAuthorAssociation>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookCommitCommentCreatedCommentAuthorAssociationExtensions.ToValueString(value));
        }
    }
}
