...
{
    /// <inheritdoc />
    public sealed class WebhooksCommentAuthorAssociationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhooksCommentAuthorAssociation>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhooksCommentAuthorAssociationExtensions.ToValueString(value));
        }
    }
}
