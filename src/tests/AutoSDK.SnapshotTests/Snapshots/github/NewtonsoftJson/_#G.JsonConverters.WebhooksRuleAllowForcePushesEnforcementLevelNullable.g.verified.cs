...
{
    /// <inheritdoc />
    public sealed class WebhooksRuleAllowForcePushesEnforcementLevelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhooksRuleAllowForcePushesEnforcementLevel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhooksRuleAllowForcePushesEnforcementLevelExtensions.ToValueString(value.Value));
            }
        }
    }
}
