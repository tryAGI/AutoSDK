...
namespace G
{
    public partial class OrgsClient
    {
        ...
        {
            var __response = await OrgsListPatGrantRepositoriesAsResponseAsync(
                org: org,
                patId: patId,
                perPage: perPage,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.MinimalRepository>>> OrgsListPatGrantRepositoriesAsResponseAsync(
            string org,
            int patId,
            int? perPage = default,
            int? page = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/personal-access-tokens/{patId}/repositories\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
