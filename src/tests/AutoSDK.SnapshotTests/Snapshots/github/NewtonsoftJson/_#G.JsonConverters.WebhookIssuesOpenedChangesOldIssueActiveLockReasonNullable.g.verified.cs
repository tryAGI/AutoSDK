...
{
    /// <inheritdoc />
    public sealed class WebhookIssuesOpenedChangesOldIssueActiveLockReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookIssuesOpenedChangesOldIssueActiveLockReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookIssuesOpenedChangesOldIssueActiveLockReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
