...
{
    /// <inheritdoc />
    public sealed class ClassroomAssignmentTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClassroomAssignmentType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ClassroomAssignmentTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
