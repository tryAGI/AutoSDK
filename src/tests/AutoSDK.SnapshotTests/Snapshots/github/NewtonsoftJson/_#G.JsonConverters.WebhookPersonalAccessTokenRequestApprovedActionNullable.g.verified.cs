...
{
    /// <inheritdoc />
    public sealed class WebhookPersonalAccessTokenRequestApprovedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPersonalAccessTokenRequestApprovedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPersonalAccessTokenRequestApprovedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
