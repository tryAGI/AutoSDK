...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsListJobsForWorkflowRunAsResponseAsync(
                owner: owner,
                repo: repo,
                runId: runId,
                filter: filter,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsListJobsForWorkflowRunResponse>> ActionsListJobsForWorkflowRunAsResponseAsync(
            string owner,
            string repo,
            int runId,
            global::G.ActionsListJobsForWorkflowRunFilter? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::G.ActionsListJobsForWorkflowRunResponse.FromJson(__content, JsonSerializerOptions) ??
                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                    return new global::G.AutoSDKHttpResponse<global::G.ActionsListJobsForWorkflowRunResponse>(
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::G.ActionsListJobsForWorkflowRunResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
