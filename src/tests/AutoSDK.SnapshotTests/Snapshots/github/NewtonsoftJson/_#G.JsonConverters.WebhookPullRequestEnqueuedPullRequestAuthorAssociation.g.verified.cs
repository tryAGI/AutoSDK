...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestEnqueuedPullRequestAuthorAssociationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestEnqueuedPullRequestAuthorAssociation>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookPullRequestEnqueuedPullRequestAuthorAssociationExtensions.ToValueString(value));
        }
    }
}
