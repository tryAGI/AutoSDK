...
namespace G
{
    public partial interface ISecretScanningClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.SecretScanningAlert>>> SecretScanningListAlertsForRepoAsResponseAsync(
            string owner,
            string repo,
            global::G.SecretScanningListAlertsForRepoState? state = default,
            string? secretType = default,
