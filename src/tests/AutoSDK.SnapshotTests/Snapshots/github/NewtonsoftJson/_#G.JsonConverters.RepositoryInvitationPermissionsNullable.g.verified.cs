...
{
    /// <inheritdoc />
    public sealed class RepositoryInvitationPermissionsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RepositoryInvitationPermissions?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RepositoryInvitationPermissionsExtensions.ToValueString(value.Value));
            }
        }
    }
}
