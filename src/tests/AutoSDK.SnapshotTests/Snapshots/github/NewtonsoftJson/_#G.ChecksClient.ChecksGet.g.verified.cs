...
namespace G
{
    public partial class ChecksClient
    {
        ...
        {
            var __response = await ChecksGetAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CheckRun>> ChecksGetAsResponseAsync(
            string owner,
            string repo,
            int checkRunId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
