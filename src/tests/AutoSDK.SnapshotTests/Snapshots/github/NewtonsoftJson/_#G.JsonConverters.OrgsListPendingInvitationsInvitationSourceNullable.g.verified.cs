...
{
    /// <inheritdoc />
    public sealed class OrgsListPendingInvitationsInvitationSourceNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrgsListPendingInvitationsInvitationSource?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OrgsListPendingInvitationsInvitationSourceExtensions.ToValueString(value.Value));
            }
        }
    }
}
