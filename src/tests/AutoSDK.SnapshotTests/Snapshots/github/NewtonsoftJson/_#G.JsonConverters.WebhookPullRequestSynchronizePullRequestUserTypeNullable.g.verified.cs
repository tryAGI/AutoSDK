...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestSynchronizePullRequestUserTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestSynchronizePullRequestUserType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPullRequestSynchronizePullRequestUserTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
