            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                else
                {
                    ...
                    __value_503 = await global::G.CodeScanningGetSarifResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                return
                    await global::G.CodeScanningSarifsStatus.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
