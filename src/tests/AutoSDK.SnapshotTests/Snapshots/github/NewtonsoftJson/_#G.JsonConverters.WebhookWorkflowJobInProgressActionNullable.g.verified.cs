...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowJobInProgressActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowJobInProgressAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookWorkflowJobInProgressActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
