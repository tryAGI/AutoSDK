...
namespace G
{
    public partial class PullsClient
    {
        ...
        {
            var __response = await PullsMergeAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PullRequestMergeResult>> PullsMergeAsResponseAsync(
            string owner,
            string repo,
            int pullNumber,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 405)
                            {
                                ...
                                throw global::G.ApiException<global::G.PullsMergeResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                throw global::G.ApiException<global::G.PullsMergeResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PullRequestMergeResult.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PullRequestMergeResult>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PullRequestMergeResult.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
