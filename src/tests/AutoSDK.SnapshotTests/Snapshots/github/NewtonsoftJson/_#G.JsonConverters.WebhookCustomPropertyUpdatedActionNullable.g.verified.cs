...
{
    /// <inheritdoc />
    public sealed class WebhookCustomPropertyUpdatedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookCustomPropertyUpdatedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookCustomPropertyUpdatedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
