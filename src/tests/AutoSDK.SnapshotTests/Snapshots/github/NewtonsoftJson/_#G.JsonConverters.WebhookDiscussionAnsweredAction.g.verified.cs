...
{
    /// <inheritdoc />
    public sealed class WebhookDiscussionAnsweredActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDiscussionAnsweredAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookDiscussionAnsweredActionExtensions.ToValueString(value));
        }
    }
}
