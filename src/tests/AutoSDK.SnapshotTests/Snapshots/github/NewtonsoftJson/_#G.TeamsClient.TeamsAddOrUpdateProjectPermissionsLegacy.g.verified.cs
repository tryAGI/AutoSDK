...
namespace G
{
    public partial class TeamsClient
    {
        ...
        {
            await TeamsAddOrUpdateProjectPermissionsLegacyAsResponseAsync(
                teamId: teamId,
                projectId: projectId,
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> TeamsAddOrUpdateProjectPermissionsLegacyAsResponseAsync(
            int teamId,
            int projectId,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::G.TeamsAddOrUpdateProjectPermissionsLegacyResponse? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::G.TeamsAddOrUpdateProjectPermissionsLegacyResponse.FromJson(__content_403, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::G.ApiException<global::G.TeamsAddOrUpdateProjectPermissionsLegacyResponse>.Create(
