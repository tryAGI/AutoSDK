...
{
    /// <inheritdoc />
    public sealed class WebhookProjectsV2ItemReorderedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookProjectsV2ItemReorderedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookProjectsV2ItemReorderedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
