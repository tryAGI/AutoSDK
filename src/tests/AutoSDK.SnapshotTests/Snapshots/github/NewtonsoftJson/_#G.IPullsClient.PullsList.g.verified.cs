...
namespace G
{
    public partial interface IPullsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.PullRequestSimple>>> PullsListAsResponseAsync(
            string owner,
            string repo,
            global::G.PullsListState? state = default,
            string? head = default,
