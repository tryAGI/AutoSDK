...
{
    /// <inheritdoc />
    public sealed class WebhookPingHookNameNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPingHookName?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPingHookNameExtensions.ToValueString(value.Value));
            }
        }
    }
}
