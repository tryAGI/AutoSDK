...
{
    /// <inheritdoc />
    public sealed class WebhookCommitCommentCreatedCommentUserTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookCommitCommentCreatedCommentUserType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookCommitCommentCreatedCommentUserTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
