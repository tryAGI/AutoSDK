...
namespace G
{
    public partial interface IChecksClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.CheckAnnotation>>> ChecksListAnnotationsAsResponseAsync(
            string owner,
            string repo,
            int checkRunId,
            int? perPage = default,
