...
{
    /// <inheritdoc />
    public sealed class WebhookDependabotAlertFixedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDependabotAlertFixedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookDependabotAlertFixedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
