...
namespace G
{
    public partial class CopilotClient
    {
        ...
        {
            var __response = await CopilotUsageMetricsForTeamAsResponseAsync(
                org: org,
                teamSlug: teamSlug,
                since: since,
                until: until,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.CopilotUsageMetrics>>> CopilotUsageMetricsForTeamAsResponseAsync(
            string org,
            string teamSlug,
            string? since = default,
            string? until = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CopilotUsageMetricsForTeamAsync",
                                pathTemplate: "$\"/orgs/{org}/team/{teamSlug}/copilot/usage\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
