...
{
    /// <inheritdoc />
    public sealed class CodespaceLocationJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CodespaceLocation>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CodespaceLocationExtensions.ToValueString(value));
        }
    }
}
