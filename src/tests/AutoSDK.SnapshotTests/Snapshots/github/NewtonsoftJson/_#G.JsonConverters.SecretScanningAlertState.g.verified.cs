...
{
    /// <inheritdoc />
    public sealed class SecretScanningAlertStateJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SecretScanningAlertState>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SecretScanningAlertStateExtensions.ToValueString(value));
        }
    }
}
