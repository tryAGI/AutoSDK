...
{
    /// <inheritdoc />
    public sealed class RepositoryRuleCommitAuthorEmailPatternTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RepositoryRuleCommitAuthorEmailPatternType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RepositoryRuleCommitAuthorEmailPatternTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
