...
{
    /// <inheritdoc />
    public sealed class AppPermissionsGpgKeysNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AppPermissionsGpgKeys?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AppPermissionsGpgKeysExtensions.ToValueString(value.Value));
            }
        }
    }
}
