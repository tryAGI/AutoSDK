...
{
    /// <inheritdoc />
    public sealed class AppsListAccountsForPlanStubbedSortNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AppsListAccountsForPlanStubbedSort?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AppsListAccountsForPlanStubbedSortExtensions.ToValueString(value.Value));
            }
        }
    }
}
