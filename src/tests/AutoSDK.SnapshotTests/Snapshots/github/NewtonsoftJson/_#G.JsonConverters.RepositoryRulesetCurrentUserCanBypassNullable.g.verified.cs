...
{
    /// <inheritdoc />
    public sealed class RepositoryRulesetCurrentUserCanBypassNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RepositoryRulesetCurrentUserCanBypass?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RepositoryRulesetCurrentUserCanBypassExtensions.ToValueString(value.Value));
            }
        }
    }
}
