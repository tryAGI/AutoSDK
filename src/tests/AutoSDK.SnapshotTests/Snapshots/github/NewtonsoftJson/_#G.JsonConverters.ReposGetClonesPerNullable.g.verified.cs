...
{
    /// <inheritdoc />
    public sealed class ReposGetClonesPerNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReposGetClonesPer?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReposGetClonesPerExtensions.ToValueString(value.Value));
            }
        }
    }
}
