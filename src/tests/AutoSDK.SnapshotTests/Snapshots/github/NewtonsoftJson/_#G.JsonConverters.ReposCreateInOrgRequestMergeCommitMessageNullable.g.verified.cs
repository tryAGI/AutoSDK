...
{
    /// <inheritdoc />
    public sealed class ReposCreateInOrgRequestMergeCommitMessageNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReposCreateInOrgRequestMergeCommitMessage?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReposCreateInOrgRequestMergeCommitMessageExtensions.ToValueString(value.Value));
            }
        }
    }
}
