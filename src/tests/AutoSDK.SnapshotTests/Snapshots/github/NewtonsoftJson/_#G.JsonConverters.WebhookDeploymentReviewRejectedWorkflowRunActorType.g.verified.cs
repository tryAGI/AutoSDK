...
{
    /// <inheritdoc />
    public sealed class WebhookDeploymentReviewRejectedWorkflowRunActorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDeploymentReviewRejectedWorkflowRunActorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookDeploymentReviewRejectedWorkflowRunActorTypeExtensions.ToValueString(value));
        }
    }
}
