...
namespace G
{
    public partial class SearchClient
    {
        ...
        {
            var __response = await SearchIssuesAndPullRequestsAsResponseAsync(
                q: q,
                sort: sort,
                order: order,
                perPage: perPage,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.SearchIssuesAndPullRequestsResponse>> SearchIssuesAndPullRequestsAsResponseAsync(
            string q,
            global::G.SearchIssuesAndPullRequestsSort? sort = default,
            global::G.SearchIssuesAndPullRequestsOrder? order = default,
            int? perPage = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.SearchIssuesAndPullRequestsResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.SearchIssuesAndPullRequestsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.SearchIssuesAndPullRequestsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.SearchIssuesAndPullRequestsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
