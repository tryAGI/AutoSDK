...
{
    /// <inheritdoc />
    public sealed class OrgsEnableOrDisableSecurityProductOnAllOrgReposEnablementJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrgsEnableOrDisableSecurityProductOnAllOrgReposEnablement>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OrgsEnableOrDisableSecurityProductOnAllOrgReposEnablementExtensions.ToValueString(value));
        }
    }
}
