...
{
    /// <inheritdoc />
    public sealed class AppPermissionsMetadataNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AppPermissionsMetadata?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AppPermissionsMetadataExtensions.ToValueString(value.Value));
            }
        }
    }
}
