...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestEnqueuedPullRequestActiveLockReasonJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestEnqueuedPullRequestActiveLockReason>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookPullRequestEnqueuedPullRequestActiveLockReasonExtensions.ToValueString(value));
        }
    }
}
