...
namespace G
{
    public partial class TeamsClient
    {
        ...
        {
            await TeamsAddOrUpdateProjectPermissionsInOrgAsResponseAsync(
                org: org,
                teamSlug: teamSlug,
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> TeamsAddOrUpdateProjectPermissionsInOrgAsResponseAsync(
            string org,
            string teamSlug,
            int projectId,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                throw global::G.ApiException<global::G.TeamsAddOrUpdateProjectPermissionsInOrgResponse>.Create(
