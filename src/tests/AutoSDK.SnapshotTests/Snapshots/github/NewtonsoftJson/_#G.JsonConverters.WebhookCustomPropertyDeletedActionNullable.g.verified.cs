...
{
    /// <inheritdoc />
    public sealed class WebhookCustomPropertyDeletedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookCustomPropertyDeletedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookCustomPropertyDeletedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
