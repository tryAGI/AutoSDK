...
{
    /// <inheritdoc />
    public sealed class GlobalAdvisorySeverityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GlobalAdvisorySeverity?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GlobalAdvisorySeverityExtensions.ToValueString(value.Value));
            }
        }
    }
}
