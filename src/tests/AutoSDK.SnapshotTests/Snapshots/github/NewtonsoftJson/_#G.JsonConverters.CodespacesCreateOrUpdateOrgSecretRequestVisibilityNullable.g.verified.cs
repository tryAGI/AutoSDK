...
{
    /// <inheritdoc />
    public sealed class CodespacesCreateOrUpdateOrgSecretRequestVisibilityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CodespacesCreateOrUpdateOrgSecretRequestVisibility?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CodespacesCreateOrUpdateOrgSecretRequestVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
