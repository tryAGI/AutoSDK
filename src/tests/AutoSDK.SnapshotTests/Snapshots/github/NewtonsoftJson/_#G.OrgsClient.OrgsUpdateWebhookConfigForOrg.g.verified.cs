...
namespace G
{
    public partial class OrgsClient
    {
        ...
        {
            var __response = await OrgsUpdateWebhookConfigForOrgAsResponseAsync(
                org: org,
                hookId: hookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.WebhookConfig>> OrgsUpdateWebhookConfigForOrgAsResponseAsync(
            string org,
            int hookId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/hooks/{hookId}/config\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
