...
{
    /// <inheritdoc />
    public sealed class ReviewCustomGatesStateRequiredStateJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReviewCustomGatesStateRequiredState>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ReviewCustomGatesStateRequiredStateExtensions.ToValueString(value));
        }
    }
}
