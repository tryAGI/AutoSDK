...
{
    /// <inheritdoc />
    public sealed class ReposGetViewsPerNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReposGetViewsPer?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReposGetViewsPerExtensions.ToValueString(value.Value));
            }
        }
    }
}
