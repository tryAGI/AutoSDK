...
{
    /// <inheritdoc />
    public sealed class WebhookIssuesEditedIssueStateJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookIssuesEditedIssueState>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookIssuesEditedIssueStateExtensions.ToValueString(value));
        }
    }
}
