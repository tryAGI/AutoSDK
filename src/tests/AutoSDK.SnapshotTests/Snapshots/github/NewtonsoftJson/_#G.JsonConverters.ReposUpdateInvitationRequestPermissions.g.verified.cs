...
{
    /// <inheritdoc />
    public sealed class ReposUpdateInvitationRequestPermissionsJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReposUpdateInvitationRequestPermissions>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ReposUpdateInvitationRequestPermissionsExtensions.ToValueString(value));
        }
    }
}
