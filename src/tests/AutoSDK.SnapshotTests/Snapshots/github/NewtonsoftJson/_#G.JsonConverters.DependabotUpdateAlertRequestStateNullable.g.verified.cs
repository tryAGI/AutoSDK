...
{
    /// <inheritdoc />
    public sealed class DependabotUpdateAlertRequestStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DependabotUpdateAlertRequestState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DependabotUpdateAlertRequestStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
