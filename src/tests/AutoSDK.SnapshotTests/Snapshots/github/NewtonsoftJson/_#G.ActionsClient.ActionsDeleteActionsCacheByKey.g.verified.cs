...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsDeleteActionsCacheByKeyAsResponseAsync(
                owner: owner,
                repo: repo,
                key: key,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsCacheList>> ActionsDeleteActionsCacheByKeyAsResponseAsync(
            string owner,
            string repo,
            string key,
            string? @ref = default,
