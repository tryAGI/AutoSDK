...
{
    /// <inheritdoc />
    public sealed class WebhookIssuesOpenedIssueMilestoneCreatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookIssuesOpenedIssueMilestoneCreatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookIssuesOpenedIssueMilestoneCreatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
