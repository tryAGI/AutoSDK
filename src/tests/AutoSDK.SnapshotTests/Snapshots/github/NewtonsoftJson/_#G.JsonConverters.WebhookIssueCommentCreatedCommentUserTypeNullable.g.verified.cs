...
{
    /// <inheritdoc />
    public sealed class WebhookIssueCommentCreatedCommentUserTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookIssueCommentCreatedCommentUserType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookIssueCommentCreatedCommentUserTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
