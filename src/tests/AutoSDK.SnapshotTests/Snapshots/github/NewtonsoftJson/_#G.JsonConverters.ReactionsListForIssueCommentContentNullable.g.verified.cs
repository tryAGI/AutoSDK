...
{
    /// <inheritdoc />
    public sealed class ReactionsListForIssueCommentContentNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReactionsListForIssueCommentContent?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReactionsListForIssueCommentContentExtensions.ToValueString(value.Value));
            }
        }
    }
}
