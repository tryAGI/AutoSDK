...
{
    /// <inheritdoc />
    public sealed class TeamsUpdateInOrgRequestPermissionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TeamsUpdateInOrgRequestPermission>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TeamsUpdateInOrgRequestPermissionExtensions.ToValueString(value));
        }
    }
}
