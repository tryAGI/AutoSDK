            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                else
                {
                    ...
                    __value_503 = await global::G.CodeScanningUpdateAlertResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            else
            {
                ...
                return
                    await global::G.CodeScanningAlert.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
