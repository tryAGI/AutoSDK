...
namespace G
{
    public partial class CodeSecurityClient
    {
        ...
        {
            var __response = await CodeSecuritySetConfigurationAsDefaultAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CodeSecuritySetConfigurationAsDefaultResponse>> CodeSecuritySetConfigurationAsDefaultAsResponseAsync(
            string org,
            int configurationId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CodeSecuritySetConfigurationAsDefaultAsync",
                                pathTemplate: "$\"/orgs/{org}/code-security/configurations/{configurationId}/defaults\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CodeSecuritySetConfigurationAsDefaultResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CodeSecuritySetConfigurationAsDefaultResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CodeSecuritySetConfigurationAsDefaultResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
