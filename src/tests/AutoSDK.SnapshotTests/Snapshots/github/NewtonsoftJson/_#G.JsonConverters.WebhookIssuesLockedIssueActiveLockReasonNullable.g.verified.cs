...
{
    /// <inheritdoc />
    public sealed class WebhookIssuesLockedIssueActiveLockReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookIssuesLockedIssueActiveLockReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookIssuesLockedIssueActiveLockReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
