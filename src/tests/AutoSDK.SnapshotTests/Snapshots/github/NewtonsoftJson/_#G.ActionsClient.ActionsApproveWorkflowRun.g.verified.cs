...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsApproveWorkflowRunAsResponseAsync(
                owner: owner,
                repo: repo,
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EmptyObject>> ActionsApproveWorkflowRunAsResponseAsync(
            string owner,
            string repo,
            int runId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/actions/runs/{runId}/approve\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
