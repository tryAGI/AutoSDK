...
{
    /// <inheritdoc />
    public sealed class TeamsUpdateLegacyRequestPermissionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TeamsUpdateLegacyRequestPermission?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TeamsUpdateLegacyRequestPermissionExtensions.ToValueString(value.Value));
            }
        }
    }
}
