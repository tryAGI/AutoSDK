...
{
    /// <inheritdoc />
    public sealed class WebhookMarketplacePurchasePurchasedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookMarketplacePurchasePurchasedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookMarketplacePurchasePurchasedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
