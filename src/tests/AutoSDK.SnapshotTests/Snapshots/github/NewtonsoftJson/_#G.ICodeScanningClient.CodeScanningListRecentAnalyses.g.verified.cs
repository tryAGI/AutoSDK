...
namespace G
{
    public partial interface ICodeScanningClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.CodeScanningAnalysis>>> CodeScanningListRecentAnalysesAsResponseAsync(
            string owner,
            string repo,
            string? toolName = default,
            string? toolGuid = default,
