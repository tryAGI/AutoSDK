...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestDequeuedPullRequestAssigneeTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestDequeuedPullRequestAssigneeType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPullRequestDequeuedPullRequestAssigneeTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
