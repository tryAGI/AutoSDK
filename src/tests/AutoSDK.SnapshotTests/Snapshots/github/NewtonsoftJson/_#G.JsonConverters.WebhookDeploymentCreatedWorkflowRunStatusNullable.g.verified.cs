...
{
    /// <inheritdoc />
    public sealed class WebhookDeploymentCreatedWorkflowRunStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDeploymentCreatedWorkflowRunStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookDeploymentCreatedWorkflowRunStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
