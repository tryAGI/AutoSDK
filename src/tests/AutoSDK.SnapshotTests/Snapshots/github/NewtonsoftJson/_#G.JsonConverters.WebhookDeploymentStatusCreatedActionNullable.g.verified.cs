...
{
    /// <inheritdoc />
    public sealed class WebhookDeploymentStatusCreatedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookDeploymentStatusCreatedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookDeploymentStatusCreatedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
