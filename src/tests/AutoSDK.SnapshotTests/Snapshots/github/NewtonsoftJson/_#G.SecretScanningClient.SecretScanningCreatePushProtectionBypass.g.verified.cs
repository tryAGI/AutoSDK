            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                else
                {
                    ...
                    __value_503 = await global::G.SecretScanningCreatePushProtectionBypassResponse.FromJsonStreamAsync(__contentStream_503, JsonSerializerOptions).ConfigureAwait(false);
                }
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.SecretScanningPushProtectionBypass.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
