...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowRunCompletedWorkflowRunConclusionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowRunCompletedWorkflowRunConclusion>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookWorkflowRunCompletedWorkflowRunConclusionExtensions.ToValueString(value));
        }
    }
}
