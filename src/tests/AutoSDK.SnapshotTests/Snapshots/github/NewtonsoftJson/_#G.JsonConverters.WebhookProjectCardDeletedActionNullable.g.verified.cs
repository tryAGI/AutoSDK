...
{
    /// <inheritdoc />
    public sealed class WebhookProjectCardDeletedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookProjectCardDeletedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookProjectCardDeletedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
