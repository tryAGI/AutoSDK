...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsCreateRemoveTokenForRepoAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AuthenticationToken>> ActionsCreateRemoveTokenForRepoAsResponseAsync(
            string owner,
            string repo,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AuthenticationToken.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AuthenticationToken>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AuthenticationToken.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
