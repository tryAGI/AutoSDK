...
{
    /// <inheritdoc />
    public sealed class DependabotListAlertsForOrgDirectionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DependabotListAlertsForOrgDirection?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DependabotListAlertsForOrgDirectionExtensions.ToValueString(value.Value));
            }
        }
    }
}
