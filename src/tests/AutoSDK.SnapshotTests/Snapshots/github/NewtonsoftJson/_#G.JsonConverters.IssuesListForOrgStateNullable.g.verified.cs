...
{
    /// <inheritdoc />
    public sealed class IssuesListForOrgStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IssuesListForOrgState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.IssuesListForOrgStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
