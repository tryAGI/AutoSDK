...
namespace G
{
    public partial class ReposClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ReposGetWebhookDeliveryServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await ReposGetWebhookDeliveryAsResponseAsync(
                owner: owner,
                repo: repo,
                hookId: hookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.HookDelivery>> ReposGetWebhookDeliveryAsResponseAsync(
            string owner,
            string repo,
            int hookId,
            int deliveryId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ReposGetWebhookDeliveryServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/hooks/{hookId}/deliveries/{deliveryId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.HookDelivery.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.HookDelivery>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.HookDelivery.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
