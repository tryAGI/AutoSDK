...
{
    /// <inheritdoc />
    public sealed class WebhookMemberAddedChangesPermissionToNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookMemberAddedChangesPermissionTo?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookMemberAddedChangesPermissionToExtensions.ToValueString(value.Value));
            }
        }
    }
}
