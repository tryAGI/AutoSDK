...
{
    /// <inheritdoc />
    public sealed class WebhookMembershipRemovedActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookMembershipRemovedAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookMembershipRemovedActionExtensions.ToValueString(value));
        }
    }
}
