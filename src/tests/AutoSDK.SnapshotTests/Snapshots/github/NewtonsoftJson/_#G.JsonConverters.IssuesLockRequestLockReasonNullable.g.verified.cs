...
{
    /// <inheritdoc />
    public sealed class IssuesLockRequestLockReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.IssuesLockRequestLockReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.IssuesLockRequestLockReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
