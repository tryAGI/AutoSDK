...
{
    /// <inheritdoc />
    public sealed class PullRequestReviewCommentSubjectTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PullRequestReviewCommentSubjectType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PullRequestReviewCommentSubjectTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
