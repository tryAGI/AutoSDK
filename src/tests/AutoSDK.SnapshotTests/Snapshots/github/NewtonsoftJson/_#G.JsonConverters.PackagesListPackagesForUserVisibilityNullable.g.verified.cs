...
{
    /// <inheritdoc />
    public sealed class PackagesListPackagesForUserVisibilityNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PackagesListPackagesForUserVisibility?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PackagesListPackagesForUserVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
