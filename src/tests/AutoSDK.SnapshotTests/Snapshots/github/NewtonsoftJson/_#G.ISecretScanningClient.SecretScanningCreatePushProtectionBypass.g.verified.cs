...
namespace G
{
    public partial interface ISecretScanningClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.SecretScanningPushProtectionBypass>> SecretScanningCreatePushProtectionBypassAsResponseAsync(
            string owner,
            string repo,
