...
{
    /// <inheritdoc />
    public sealed class WebhookInstallationSuspendActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookInstallationSuspendAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookInstallationSuspendActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
