...
{
    /// <inheritdoc />
    public sealed class WebhookBranchProtectionRuleEditedChangesLinearHistoryRequirementEnforcementLevelFromNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookBranchProtectionRuleEditedChangesLinearHistoryRequirementEnforcementLevelFrom?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookBranchProtectionRuleEditedChangesLinearHistoryRequirementEnforcementLevelFromExtensions.ToValueString(value.Value));
            }
        }
    }
}
