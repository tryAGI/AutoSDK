...
{
    /// <inheritdoc />
    public sealed class PackagesListPackagesForAuthenticatedUserPackageTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PackagesListPackagesForAuthenticatedUserPackageType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PackagesListPackagesForAuthenticatedUserPackageTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
