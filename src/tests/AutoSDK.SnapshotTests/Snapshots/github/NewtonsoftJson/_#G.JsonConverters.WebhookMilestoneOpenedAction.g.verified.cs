...
{
    /// <inheritdoc />
    public sealed class WebhookMilestoneOpenedActionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookMilestoneOpenedAction>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhookMilestoneOpenedActionExtensions.ToValueString(value));
        }
    }
}
