...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsUpdateSelfHostedRunnerGroupForOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RunnerGroupsOrg>> ActionsUpdateSelfHostedRunnerGroupForOrgAsResponseAsync(
            string org,
            int runnerGroupId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ActionsUpdateSelfHostedRunnerGroupForOrgAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.RunnerGroupsOrg.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.RunnerGroupsOrg>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.RunnerGroupsOrg.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
