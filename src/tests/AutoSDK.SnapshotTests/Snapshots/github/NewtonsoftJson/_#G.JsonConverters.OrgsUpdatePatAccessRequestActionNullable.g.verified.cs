...
{
    /// <inheritdoc />
    public sealed class OrgsUpdatePatAccessRequestActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OrgsUpdatePatAccessRequestAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OrgsUpdatePatAccessRequestActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
