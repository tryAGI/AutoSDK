...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsGetActionsCacheUsageForOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsCacheUsageOrgEnterprise>> ActionsGetActionsCacheUsageForOrgAsResponseAsync(
            string org,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::G.ActionsCacheUsageOrgEnterprise.FromJson(__content, JsonSerializerOptions) ??
                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                    return new global::G.AutoSDKHttpResponse<global::G.ActionsCacheUsageOrgEnterprise>(
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::G.ActionsCacheUsageOrgEnterprise.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
