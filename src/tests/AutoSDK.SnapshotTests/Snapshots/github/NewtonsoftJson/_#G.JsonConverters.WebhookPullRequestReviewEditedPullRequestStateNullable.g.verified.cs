...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestReviewEditedPullRequestStateNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestReviewEditedPullRequestState?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPullRequestReviewEditedPullRequestStateExtensions.ToValueString(value.Value));
            }
        }
    }
}
