...
{
    /// <inheritdoc />
    public sealed class WebhooksCommentUserTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhooksCommentUserType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WebhooksCommentUserTypeExtensions.ToValueString(value));
        }
    }
}
