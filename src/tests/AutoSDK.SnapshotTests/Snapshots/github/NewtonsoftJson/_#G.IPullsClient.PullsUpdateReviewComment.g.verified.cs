//HintName: G.IPullsClient.PullsUpdateReviewComment.g.cs
#nullable enable
...
namespace G
{
    public partial interface IPullsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PullRequestReviewComment>> PullsUpdateReviewCommentAsResponseAsync(
            string owner,
            string repo,
            long commentId,
