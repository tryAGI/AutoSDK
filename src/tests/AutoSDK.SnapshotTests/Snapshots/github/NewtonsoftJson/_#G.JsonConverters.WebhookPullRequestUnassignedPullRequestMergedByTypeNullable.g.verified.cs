...
{
    /// <inheritdoc />
    public sealed class WebhookPullRequestUnassignedPullRequestMergedByTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookPullRequestUnassignedPullRequestMergedByType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookPullRequestUnassignedPullRequestMergedByTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
