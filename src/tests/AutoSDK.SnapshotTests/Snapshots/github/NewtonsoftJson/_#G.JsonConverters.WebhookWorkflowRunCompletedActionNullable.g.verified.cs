...
{
    /// <inheritdoc />
    public sealed class WebhookWorkflowRunCompletedActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WebhookWorkflowRunCompletedAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WebhookWorkflowRunCompletedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
