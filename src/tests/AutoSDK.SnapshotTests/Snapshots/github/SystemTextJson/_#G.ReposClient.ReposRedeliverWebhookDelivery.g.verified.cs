...
namespace G
{
    public partial class ReposClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ReposRedeliverWebhookDeliveryServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await ReposRedeliverWebhookDeliveryAsResponseAsync(
                owner: owner,
                repo: repo,
                hookId: hookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> ReposRedeliverWebhookDeliveryAsResponseAsync(
            string owner,
            string repo,
            int hookId,
            int deliveryId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ReposRedeliverWebhookDeliveryServers,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/hooks/{hookId}/deliveries/{deliveryId}/attempts\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
