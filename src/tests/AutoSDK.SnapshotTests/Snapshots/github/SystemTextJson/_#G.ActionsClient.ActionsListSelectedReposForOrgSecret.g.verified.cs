...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsListSelectedReposForOrgSecretAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsListSelectedReposForOrgSecretResponse>> ActionsListSelectedReposForOrgSecretAsResponseAsync(
            string org,
            string secretName,
            int? page = default,
            int? perPage = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/actions/secrets/{secretName}/repositories\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ActionsListSelectedReposForOrgSecretResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ActionsListSelectedReposForOrgSecretResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ActionsListSelectedReposForOrgSecretResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
