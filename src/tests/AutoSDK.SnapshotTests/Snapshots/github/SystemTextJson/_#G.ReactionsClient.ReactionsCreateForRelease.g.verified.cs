...
namespace G
{
    public partial class ReactionsClient
    {
        ...
        {
            var __response = await ReactionsCreateForReleaseAsResponseAsync(
                owner: owner,
                repo: repo,
                releaseId: releaseId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Reaction>> ReactionsCreateForReleaseAsResponseAsync(
            string owner,
            string repo,
            int releaseId,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Reaction.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.Reaction>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Reaction.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
