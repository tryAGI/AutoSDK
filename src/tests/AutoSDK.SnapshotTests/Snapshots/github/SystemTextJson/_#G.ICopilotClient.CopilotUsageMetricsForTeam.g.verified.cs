...
namespace G
{
    public partial interface ICopilotClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.CopilotUsageMetrics>>> CopilotUsageMetricsForTeamAsResponseAsync(
            string org,
            string teamSlug,
            string? since = default,
            string? until = default,
