...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsRemoveCustomLabelFromSelfHostedRunnerForOrgAsResponseAsync(
                org: org,
                runnerId: runnerId,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForOrgResponse>> ActionsRemoveCustomLabelFromSelfHostedRunnerForOrgAsResponseAsync(
            string org,
            int runnerId,
            string name,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/actions/runners/{runnerId}/labels/{name}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForOrgResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForOrgResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ActionsRemoveCustomLabelFromSelfHostedRunnerForOrgResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
