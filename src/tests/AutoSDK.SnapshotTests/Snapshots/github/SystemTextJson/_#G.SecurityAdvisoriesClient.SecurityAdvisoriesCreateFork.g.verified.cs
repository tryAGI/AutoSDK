...
namespace G
{
    public partial class SecurityAdvisoriesClient
    {
        ...
        {
            var __response = await SecurityAdvisoriesCreateForkAsResponseAsync(
                owner: owner,
                repo: repo,
                ghsaId: ghsaId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FullRepository>> SecurityAdvisoriesCreateForkAsResponseAsync(
            string owner,
            string repo,
            string ghsaId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/security-advisories/{ghsaId}/forks\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
