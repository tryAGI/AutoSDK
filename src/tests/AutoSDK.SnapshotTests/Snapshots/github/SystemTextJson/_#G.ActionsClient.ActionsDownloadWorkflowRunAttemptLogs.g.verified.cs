...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            await ActionsDownloadWorkflowRunAttemptLogsAsResponseAsync(
                owner: owner,
                repo: repo,
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> ActionsDownloadWorkflowRunAttemptLogsAsResponseAsync(
            string owner,
            string repo,
            int runId,
            int attemptNumber,
