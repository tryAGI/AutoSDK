...
namespace G
{
    public partial interface IDependabotClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.DependabotAlertWithRepository>>> DependabotListAlertsForEnterpriseAsResponseAsync(
            string enterprise,
            string? state = default,
            string? severity = default,
            string? ecosystem = default,
