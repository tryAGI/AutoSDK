...
namespace G
{
    public partial class GistsClient
    {
        ...
        {
            var __response = await GistsUpdateCommentAsResponseAsync(
                gistId: gistId,
                commentId: commentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GistComment>> GistsUpdateCommentAsResponseAsync(
            string gistId,
            long commentId,
