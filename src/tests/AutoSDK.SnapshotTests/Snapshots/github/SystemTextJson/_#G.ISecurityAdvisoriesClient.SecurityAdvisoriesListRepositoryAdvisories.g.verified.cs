...
namespace G
{
    public partial interface ISecurityAdvisoriesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.RepositoryAdvisory>>> SecurityAdvisoriesListRepositoryAdvisoriesAsResponseAsync(
            string owner,
            string repo,
            global::G.SecurityAdvisoriesListRepositoryAdvisoriesDirection? direction = default,
            global::G.SecurityAdvisoriesListRepositoryAdvisoriesSort? sort = default,
