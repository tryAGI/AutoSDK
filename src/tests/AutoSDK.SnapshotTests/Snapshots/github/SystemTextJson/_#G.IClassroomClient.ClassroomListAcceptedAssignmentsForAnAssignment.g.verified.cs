...
namespace G
{
    public partial interface IClassroomClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.ClassroomAcceptedAssignment>>> ClassroomListAcceptedAssignmentsForAnAssignmentAsResponseAsync(
            int assignmentId,
            int? page = default,
            int? perPage = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
