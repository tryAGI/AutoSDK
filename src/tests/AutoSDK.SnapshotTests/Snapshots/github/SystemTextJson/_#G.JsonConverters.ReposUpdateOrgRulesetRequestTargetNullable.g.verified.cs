...
{
    /// <inheritdoc />
    public sealed class ReposUpdateOrgRulesetRequestTargetNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ReposUpdateOrgRulesetRequestTarget?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ReposUpdateOrgRulesetRequestTargetExtensions.ToValueString(value.Value));
            }
        }
    }
}
