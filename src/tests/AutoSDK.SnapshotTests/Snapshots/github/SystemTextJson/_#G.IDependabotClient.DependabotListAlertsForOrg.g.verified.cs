...
namespace G
{
    public partial interface IDependabotClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.DependabotAlertWithRepository>>> DependabotListAlertsForOrgAsResponseAsync(
            string org,
            string? state = default,
            string? severity = default,
            string? ecosystem = default,
