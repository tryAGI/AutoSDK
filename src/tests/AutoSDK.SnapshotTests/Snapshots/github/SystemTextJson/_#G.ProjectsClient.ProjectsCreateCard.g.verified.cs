    ...
    public partial class ProjectsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 503)
            {
                ...
                global::G.ProjectsCreateCardResponse2? __value_503 = null;
                if (ReadResponseAsString)
                {
                    __content_503 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = global::G.ProjectsCreateCardResponse2.FromJson(__content_503, JsonSerializerOptions);
                }
                else
                {
                    var __contentStream_503 = await __response.Content.ReadAsStreamAsync(cancellationToken).ConfigureAwait(false);
                    __value_503 = await global::G.ProjectsCreateCardResponse2.FromJsonStreamAsync(__contentStream_503, JsonSerializerOptions).ConfigureAwait(false);
                }

                throw new global::G.ApiException<global::G.ProjectsCreateCardResponse2>(
            ...
            else
            {
                ...
                return
                    await global::G.ProjectCard.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
