...
namespace G
{
    public partial class ActionsClient
    {
        ...
        {
            var __response = await ActionsGetWorkflowUsageAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.WorkflowUsage>> ActionsGetWorkflowUsageAsResponseAsync(
            string owner,
            string repo,
            global::G.OneOf<int?, string> workflowId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/actions/workflows/{workflowId}/timing\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.WorkflowUsage.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.WorkflowUsage>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.WorkflowUsage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
