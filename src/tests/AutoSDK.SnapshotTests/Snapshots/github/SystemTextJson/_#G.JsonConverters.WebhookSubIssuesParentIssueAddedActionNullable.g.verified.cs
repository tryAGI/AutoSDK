...
{
    /// <inheritdoc />
    public sealed class WebhookSubIssuesParentIssueAddedActionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhookSubIssuesParentIssueAddedAction?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WebhookSubIssuesParentIssueAddedActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
