            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.WebhookDeploymentStatusCreatedWorkflowRunConclusionExtensions.ToEnum(stringValue) ?? default;
                    }
                ...
                {
                    return default(global::G.WebhookDeploymentStatusCreatedWorkflowRunConclusion);
                }
                default:
