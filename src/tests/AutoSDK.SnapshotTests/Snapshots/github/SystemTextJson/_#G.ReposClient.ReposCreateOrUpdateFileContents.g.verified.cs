...
namespace G
{
    public partial class ReposClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_ReposCreateOrUpdateFileContentsServers = new global::G.AutoSDKServer[]
        ...
        {
            var __response = await ReposCreateOrUpdateFileContentsAsResponseAsync(
                owner: owner,
                repo: repo,
                path: path,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FileCommit>> ReposCreateOrUpdateFileContentsAsResponseAsync(
            string owner,
            string repo,
            string path,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_ReposCreateOrUpdateFileContentsServers,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 409)
                            {
                                ...
                                throw global::G.ApiException<global::G.OneOf<global::G.BasicError, global::G.RepositoryRuleViolationError>?>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.FileCommit.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.FileCommit>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.FileCommit.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
