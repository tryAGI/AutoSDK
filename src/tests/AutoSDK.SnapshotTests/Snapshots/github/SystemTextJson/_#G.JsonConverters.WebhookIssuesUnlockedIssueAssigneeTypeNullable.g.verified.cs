...
{
    /// <inheritdoc />
    public sealed class WebhookIssuesUnlockedIssueAssigneeTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhookIssuesUnlockedIssueAssigneeType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WebhookIssuesUnlockedIssueAssigneeTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
