...
namespace G
{
    public partial class CodeSecurityClient
    {
        ...
        {
            var __response = await CodeSecurityUpdateConfigurationAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CodeSecurityConfiguration>> CodeSecurityUpdateConfigurationAsResponseAsync(
            string org,
            int configurationId,
