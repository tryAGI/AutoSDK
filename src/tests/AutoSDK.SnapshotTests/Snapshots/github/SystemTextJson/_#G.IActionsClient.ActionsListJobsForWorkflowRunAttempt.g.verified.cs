...
namespace G
{
    public partial interface IActionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ActionsListJobsForWorkflowRunAttemptResponse>> ActionsListJobsForWorkflowRunAttemptAsResponseAsync(
            string owner,
            string repo,
            int runId,
            int attemptNumber,
