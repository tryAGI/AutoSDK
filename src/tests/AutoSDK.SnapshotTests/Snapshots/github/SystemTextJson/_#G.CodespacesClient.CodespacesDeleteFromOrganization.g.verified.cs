...
namespace G
{
    public partial class CodespacesClient
    {
        ...
        {
            var __response = await CodespacesDeleteFromOrganizationAsResponseAsync(
                org: org,
                username: username,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> CodespacesDeleteFromOrganizationAsResponseAsync(
            string org,
            string username,
            string codespaceName,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/members/{username}/codespaces/{codespaceName}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
