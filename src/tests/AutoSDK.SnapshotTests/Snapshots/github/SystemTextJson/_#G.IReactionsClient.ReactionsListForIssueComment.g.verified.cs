...
namespace G
{
    public partial interface IReactionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.Reaction>>> ReactionsListForIssueCommentAsResponseAsync(
            string owner,
            string repo,
            long commentId,
            global::G.ReactionsListForIssueCommentContent? content = default,
