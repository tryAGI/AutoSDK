...
namespace G
{
    public partial class CodespacesClient
    {
        ...
        {
            var __response = await CodespacesCheckPermissionsForDevcontainerAsResponseAsync(
                owner: owner,
                repo: repo,
                @ref: @ref,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CodespacesPermissionsCheckForDevcontainer>> CodespacesCheckPermissionsForDevcontainerAsResponseAsync(
            string owner,
            string repo,
            string @ref,
            string devcontainerPath,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.CodespacesCheckPermissionsForDevcontainerResponse>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CodespacesPermissionsCheckForDevcontainer.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CodespacesPermissionsCheckForDevcontainer>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CodespacesPermissionsCheckForDevcontainer.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
