...
namespace G
{
    public partial class ReactionsClient
    {
        ...
        {
            await ReactionsDeleteForIssueCommentAsResponseAsync(
                owner: owner,
                repo: repo,
                commentId: commentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> ReactionsDeleteForIssueCommentAsResponseAsync(
            string owner,
            string repo,
            long commentId,
            int reactionId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/issues/comments/{commentId}/reactions/{reactionId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
