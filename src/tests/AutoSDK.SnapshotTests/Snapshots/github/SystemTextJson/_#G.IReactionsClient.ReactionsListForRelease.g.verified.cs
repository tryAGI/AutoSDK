...
namespace G
{
    public partial interface IReactionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.Reaction>>> ReactionsListForReleaseAsResponseAsync(
            string owner,
            string repo,
            int releaseId,
            global::G.ReactionsListForReleaseContent? content = default,
