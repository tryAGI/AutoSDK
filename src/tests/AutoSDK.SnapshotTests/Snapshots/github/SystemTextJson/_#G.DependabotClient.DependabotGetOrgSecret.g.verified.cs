...
namespace G
{
    public partial class DependabotClient
    {
        ...
        {
            var __response = await DependabotGetOrgSecretAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OrganizationDependabotSecret>> DependabotGetOrgSecretAsResponseAsync(
            string org,
            string secretName,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.OrganizationDependabotSecret.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.OrganizationDependabotSecret>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.OrganizationDependabotSecret.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
