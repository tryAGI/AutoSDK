...
namespace G
{
    public partial interface ICodeSecurityClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.CodeSecurityConfiguration>>> CodeSecurityGetConfigurationsForOrgAsResponseAsync(
            string org,
            global::G.CodeSecurityGetConfigurationsForOrgTargetType? targetType = default,
            int? perPage = default,
            string? before = default,
