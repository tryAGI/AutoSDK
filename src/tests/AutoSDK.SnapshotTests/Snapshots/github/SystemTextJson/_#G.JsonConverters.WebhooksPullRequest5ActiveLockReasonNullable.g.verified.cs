...
{
    /// <inheritdoc />
    public sealed class WebhooksPullRequest5ActiveLockReasonNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WebhooksPullRequest5ActiveLockReason?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WebhooksPullRequest5ActiveLockReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
