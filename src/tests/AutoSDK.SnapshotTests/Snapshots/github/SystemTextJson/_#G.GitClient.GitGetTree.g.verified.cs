...
namespace G
{
    public partial class GitClient
    {
        ...
        {
            var __response = await GitGetTreeAsResponseAsync(
                owner: owner,
                repo: repo,
                treeSha: treeSha,
                recursive: recursive,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.GitTree>> GitGetTreeAsResponseAsync(
            string owner,
            string repo,
            string treeSha,
            string? recursive = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.GitTree.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.GitTree>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.GitTree.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
