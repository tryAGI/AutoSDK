            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.WebhookCheckSuiteRequestedCheckSuiteAppPermissionsMetadataExtensions.ToEnum(stringValue) ?? default;
                    }
                ...
                {
                    return default(global::G.WebhookCheckSuiteRequestedCheckSuiteAppPermissionsMetadata);
                }
                default:
