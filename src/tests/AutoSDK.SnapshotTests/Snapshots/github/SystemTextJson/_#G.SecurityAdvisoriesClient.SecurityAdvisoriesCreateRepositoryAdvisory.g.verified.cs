...
namespace G
{
    public partial class SecurityAdvisoriesClient
    {
        ...
        {
            var __response = await SecurityAdvisoriesCreateRepositoryAdvisoryAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RepositoryAdvisory>> SecurityAdvisoriesCreateRepositoryAdvisoryAsResponseAsync(
            string owner,
            string repo,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.RepositoryAdvisory.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.RepositoryAdvisory>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.RepositoryAdvisory.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
