...
namespace G
{
    public partial interface IDependabotClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DependabotListSelectedReposForOrgSecretResponse>> DependabotListSelectedReposForOrgSecretAsResponseAsync(
            string org,
            string secretName,
            int? page = default,
            int? perPage = default,
