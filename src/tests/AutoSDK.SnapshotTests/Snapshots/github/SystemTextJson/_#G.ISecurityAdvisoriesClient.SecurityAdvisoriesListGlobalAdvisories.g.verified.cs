...
namespace G
{
    public partial interface ISecurityAdvisoriesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.GlobalAdvisory>>> SecurityAdvisoriesListGlobalAdvisoriesAsResponseAsync(
            string? ghsaId = default,
            global::G.SecurityAdvisoriesListGlobalAdvisoriesType? type = default,
            string? cveId = default,
            global::G.SecurityAdvisoryEcosystems? ecosystem = default,
