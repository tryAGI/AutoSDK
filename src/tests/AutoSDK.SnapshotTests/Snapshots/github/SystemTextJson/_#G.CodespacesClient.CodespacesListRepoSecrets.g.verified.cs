...
namespace G
{
    public partial class CodespacesClient
    {
        ...
        {
            var __response = await CodespacesListRepoSecretsAsResponseAsync(
                owner: owner,
                repo: repo,
                perPage: perPage,
                page: page,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CodespacesListRepoSecretsResponse>> CodespacesListRepoSecretsAsResponseAsync(
            string owner,
            string repo,
            int? perPage = default,
            int? page = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::G.CodespacesListRepoSecretsResponse.FromJson(__content, JsonSerializerOptions) ??
                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                    return new global::G.AutoSDKHttpResponse<global::G.CodespacesListRepoSecretsResponse>(
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::G.CodespacesListRepoSecretsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
