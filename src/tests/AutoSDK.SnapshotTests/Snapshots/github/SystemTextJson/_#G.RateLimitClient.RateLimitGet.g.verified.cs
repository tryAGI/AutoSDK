...
namespace G
{
    public partial class RateLimitClient
    {
        ...
        {
            var __response = await RateLimitGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RateLimitOverview>> RateLimitGetAsResponseAsync(
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    var __value = global::G.RateLimitOverview.FromJson(__content, JsonSerializerOptions) ??
                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                    return new global::G.AutoSDKHttpResponse<global::G.RateLimitOverview>(
                        statusCode: __response.StatusCode,
            ...
            else
            {
                try
                {
                    ...
                    var __value = await global::G.RateLimitOverview.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
