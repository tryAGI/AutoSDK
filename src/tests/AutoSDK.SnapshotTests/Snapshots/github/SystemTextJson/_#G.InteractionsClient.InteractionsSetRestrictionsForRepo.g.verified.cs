...
namespace G
{
    public partial class InteractionsClient
    {
        ...
        {
            var __response = await InteractionsSetRestrictionsForRepoAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.InteractionLimitResponse>> InteractionsSetRestrictionsForRepoAsResponseAsync(
            string owner,
            string repo,
