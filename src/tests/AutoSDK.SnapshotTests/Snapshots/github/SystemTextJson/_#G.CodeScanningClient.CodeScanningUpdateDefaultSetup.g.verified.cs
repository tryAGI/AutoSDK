...
namespace G
{
    public partial class CodeScanningClient
    {
        ...
        {
            var __response = await CodeScanningUpdateDefaultSetupAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EmptyObject>> CodeScanningUpdateDefaultSetupAsResponseAsync(
            string owner,
            string repo,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.CodeScanningUpdateDefaultSetupResponse>.Create(
                                    statusCode: __response.StatusCode,
