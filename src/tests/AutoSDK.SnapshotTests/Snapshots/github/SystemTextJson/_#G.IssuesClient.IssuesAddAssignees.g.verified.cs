...
namespace G
{
    public partial class IssuesClient
    {
        ...
        {
            var __response = await IssuesAddAssigneesAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Issue>> IssuesAddAssigneesAsResponseAsync(
            string owner,
            string repo,
            int issueNumber,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/repos/{owner}/{repo}/issues/{issueNumber}/assignees\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
        ...
        public async global::System.Threading.Tasks.Task<global::G.Issue> IssuesAddAssigneesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.IssuesAddAssigneesRequest
            {
                Assignees = assignees,
            };
