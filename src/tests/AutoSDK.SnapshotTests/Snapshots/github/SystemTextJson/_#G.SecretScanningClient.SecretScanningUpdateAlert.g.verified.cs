...
namespace G
{
    public partial class SecretScanningClient
    {
        ...
        {
            var __response = await SecretScanningUpdateAlertAsResponseAsync(
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.SecretScanningAlert>> SecretScanningUpdateAlertAsResponseAsync(
            string owner,
            string repo,
            int alertNumber,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 503)
                            {
                                ...
                                throw global::G.ApiException<global::G.SecretScanningUpdateAlertResponse>.Create(
                                    statusCode: __response.StatusCode,
