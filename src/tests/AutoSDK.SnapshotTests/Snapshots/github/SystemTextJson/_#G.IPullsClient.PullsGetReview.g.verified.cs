//HintName: G.IPullsClient.PullsGetReview.g.cs
#nullable enable
...
namespace G
{
    public partial interface IPullsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.PullRequestReview> PullsGetReviewAsync(
            string owner,
            string repo,
            int pullNumber,
            int reviewId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PullRequestReview>> PullsGetReviewAsResponseAsync(
            string owner,
            string repo,
            int pullNumber,
            int reviewId,
