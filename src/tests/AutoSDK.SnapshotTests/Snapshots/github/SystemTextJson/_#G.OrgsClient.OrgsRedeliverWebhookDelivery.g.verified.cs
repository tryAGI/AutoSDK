...
namespace G
{
    public partial class OrgsClient
    {
        ...
        {
            var __response = await OrgsRedeliverWebhookDeliveryAsResponseAsync(
                org: org,
                hookId: hookId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> OrgsRedeliverWebhookDeliveryAsResponseAsync(
            string org,
            int hookId,
            int deliveryId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/orgs/{org}/hooks/{hookId}/deliveries/{deliveryId}/attempts\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
