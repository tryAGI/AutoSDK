...
namespace G
{
    public partial class BillingClient
    {
        ...
        {
            var __response = await BillingGetSharedStorageBillingOrgAsResponseAsync(
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CombinedBillingUsage>> BillingGetSharedStorageBillingOrgAsResponseAsync(
            string org,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
