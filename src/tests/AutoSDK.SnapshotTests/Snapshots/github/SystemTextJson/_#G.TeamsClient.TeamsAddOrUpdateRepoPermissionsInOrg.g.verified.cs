...
namespace G
{
    public partial class TeamsClient
    {
        ...
        {
            await TeamsAddOrUpdateRepoPermissionsInOrgAsResponseAsync(
                org: org,
                teamSlug: teamSlug,
                owner: owner,
                repo: repo,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> TeamsAddOrUpdateRepoPermissionsInOrgAsResponseAsync(
            string org,
            string teamSlug,
            string owner,
            string repo,
