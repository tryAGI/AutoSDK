...
namespace G
{
    ...
    public sealed partial class AppSchemasPipelineGetDetailed
    {
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::G.AppSchemasPipelineGetDetailed?> FromJsonStreamAsync(
            ...
            global::Newtonsoft.Json.JsonSerializerSettings? jsonSerializerOptions = null)
        {
            ...
            return new global::System.Threading.Tasks.ValueTask<global::G.AppSchemasPipelineGetDetailed?>(serializer.Deserialize<global::G.AppSchemasPipelineGetDetailed>(jsonReader));
        }
