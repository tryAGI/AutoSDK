//HintName: G.NullableAnyOfAsyncAPIRealtimeClient.g.cs
...
{
    /// <summary>
    /// The AsyncAPI counterpart of nullable-any-of.yaml. AsyncAPI schemas run through the same CSharpTypeMapper as OpenAPI ones, so `anyOf: [null, X]` array items must resolve to a nullable item type here too, identically to the `oneOf` form.
    /// </summary>
    public sealed partial class NullableAnyOfAsyncAPIRealtimeClient : global::System.IDisposable, global::System.IAsyncDisposable
    {
        /// <summary>
        /// Default WebSocket base URL.
        /// </summary>
        public const string DefaultBaseUrl = "wss://example.com/ws";
        ...
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::G.Event>>? MessageReceived;
        /// <summary>
        /// Raised after a Event message is deserialized.
        /// </summary>
        public event global::System.EventHandler<AutoSDKWebSocketMessageEventArgs<global::G.Event>>? EventReceived;
        ...
        /// <summary>
        /// Creates a new instance of the NullableAnyOfAsyncAPIRealtimeClient.
        ...
        public NullableAnyOfAsyncAPIRealtimeClient(
