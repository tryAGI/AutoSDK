//HintName: G.NullableAnyOfAsyncAPIRealtimeClient.ReceiveUpdates.g.cs

#nullable enable

namespace G
{
    public sealed partial class NullableAnyOfAsyncAPIRealtimeClient
    {
        /// <summary>
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::G.Event> ReceiveUpdatesAsync(
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            while (_clientWebSocket.State == global::System.Net.WebSockets.WebSocketState.Open)
            {
                ...
                string json = global::System.Text.Encoding.UTF8.GetString(__messageBuffer.ToArray());
                    global::G.Event @event;
                    try
                    {
                        @event = global::System.Text.Json.JsonSerializer.Deserialize<global::G.Event>(json, JsonSerializerOptions) ??
            ...
            string rawText)
        {
            ...
            MessageReceived?.Invoke(
                this,
                new AutoSDKWebSocketMessageEventArgs<global::G.Event>(
                    @event,
                    rawText,
                    json));
