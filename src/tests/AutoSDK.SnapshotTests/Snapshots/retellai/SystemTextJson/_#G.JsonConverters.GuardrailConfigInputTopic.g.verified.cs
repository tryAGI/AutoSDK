...
{
    /// <inheritdoc />
    public sealed class GuardrailConfigInputTopicJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GuardrailConfigInputTopic>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GuardrailConfigInputTopicExtensions.ToValueString(value));
        }
    }
}
