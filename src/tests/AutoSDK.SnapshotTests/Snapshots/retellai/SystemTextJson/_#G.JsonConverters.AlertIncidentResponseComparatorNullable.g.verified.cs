...
{
    /// <inheritdoc />
    public sealed class AlertIncidentResponseComparatorNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AlertIncidentResponseComparator?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AlertIncidentResponseComparatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
