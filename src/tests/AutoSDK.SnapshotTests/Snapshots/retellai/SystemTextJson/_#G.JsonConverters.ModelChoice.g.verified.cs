...
{
    /// <inheritdoc />
    public class ModelChoiceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModelChoice>
    {
        /// <inheritdoc />
        public override global::G.ModelChoice Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ModelChoiceCascading? cascading = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.ModelChoice(
                cascading
                );
