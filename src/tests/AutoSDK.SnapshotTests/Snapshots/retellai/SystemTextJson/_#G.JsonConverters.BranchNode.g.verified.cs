//HintName: G.JsonConverters.BranchNode.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class BranchNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BranchNode>
    {
        /// <inheritdoc />
        public override global::G.BranchNode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.BranchNodeVariant2? branchNodeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.BranchNodeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.BranchNodeVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.BranchNodeVariant2).Name}");
            ...
            var __value = new global::G.BranchNode(
                @base,
