...
{
    /// <inheritdoc />
    public sealed class CreateBatchCallResponseStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateBatchCallResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateBatchCallResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
