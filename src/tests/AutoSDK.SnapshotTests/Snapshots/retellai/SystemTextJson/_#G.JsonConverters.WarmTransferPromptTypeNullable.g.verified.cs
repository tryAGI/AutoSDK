...
{
    /// <inheritdoc />
    public sealed class WarmTransferPromptTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WarmTransferPromptType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.WarmTransferPromptTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
