...
{
    /// <inheritdoc />
    public sealed class UpdateConversationFlowComponentResponseStatus2NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateConversationFlowComponentResponseStatus2?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateConversationFlowComponentResponseStatus2Extensions.ToValueString(value.Value));
            }
        }
    }
}
