...
{
    /// <inheritdoc />
    public sealed class AlertFilterStatusCodeValueItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AlertFilterStatusCodeValueItem>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AlertFilterStatusCodeValueItemExtensions.ToValueString(value));
        }
    }
}
