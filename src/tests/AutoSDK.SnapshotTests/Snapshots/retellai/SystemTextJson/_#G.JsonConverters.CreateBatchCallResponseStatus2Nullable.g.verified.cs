...
{
    /// <inheritdoc />
    public sealed class CreateBatchCallResponseStatus2NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateBatchCallResponseStatus2?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateBatchCallResponseStatus2Extensions.ToValueString(value.Value));
            }
        }
    }
}
