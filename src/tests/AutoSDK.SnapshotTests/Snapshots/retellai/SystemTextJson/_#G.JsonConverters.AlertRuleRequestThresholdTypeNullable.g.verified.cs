...
{
    /// <inheritdoc />
    public sealed class AlertRuleRequestThresholdTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AlertRuleRequestThresholdType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AlertRuleRequestThresholdTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
