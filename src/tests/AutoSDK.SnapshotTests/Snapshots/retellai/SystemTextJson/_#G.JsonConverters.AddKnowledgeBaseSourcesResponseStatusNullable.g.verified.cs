...
{
    /// <inheritdoc />
    public sealed class AddKnowledgeBaseSourcesResponseStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AddKnowledgeBaseSourcesResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AddKnowledgeBaseSourcesResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
