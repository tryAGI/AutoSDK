//HintName: G.JsonConverters.ConversationFlowResponse.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ConversationFlowResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ConversationFlowResponse>
    {
        /// <inheritdoc />
        public override global::G.ConversationFlowResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ConversationFlowResponseVariant2? conversationFlowResponseVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ConversationFlowResponseVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ConversationFlowResponseVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ConversationFlowResponseVariant2).Name}");
            ...
            var __value = new global::G.ConversationFlowResponse(
                conversationFlow,
        ...
        public override void Write(
            ...
            global::G.ConversationFlowResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
