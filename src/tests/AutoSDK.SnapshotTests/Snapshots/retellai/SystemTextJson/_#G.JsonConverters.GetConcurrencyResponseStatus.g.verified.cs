...
{
    /// <inheritdoc />
    public sealed class GetConcurrencyResponseStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetConcurrencyResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetConcurrencyResponseStatusExtensions.ToValueString(value));
        }
    }
}
