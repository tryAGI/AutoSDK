...
{
    /// <inheritdoc />
    public sealed class WarmTransferStaticMessageTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WarmTransferStaticMessageType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.WarmTransferStaticMessageTypeExtensions.ToValueString(value));
        }
    }
}
