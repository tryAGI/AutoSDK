//HintName: G.JsonConverters.AgentSwapNode.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class AgentSwapNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentSwapNode>
    {
        /// <inheritdoc />
        public override global::G.AgentSwapNode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.AgentSwapNodeVariant2? agentSwapNodeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.AgentSwapNodeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.AgentSwapNodeVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.AgentSwapNodeVariant2).Name}");
            ...
            var __value = new global::G.AgentSwapNode(
                @base,
