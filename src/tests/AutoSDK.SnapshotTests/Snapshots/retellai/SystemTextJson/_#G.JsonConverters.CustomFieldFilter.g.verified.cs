//HintName: G.JsonConverters.CustomFieldFilter.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class CustomFieldFilterJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CustomFieldFilter>
    {
        /// <inheritdoc />
        public override global::G.CustomFieldFilter Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ValueFilter? value = default;
            global::G.CustomFieldFilterVariant2? customFieldFilterVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.CustomFieldFilter(
                value,
        ...
        public override void Write(
            ...
            global::G.CustomFieldFilter value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsValue)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ValueFilter), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ValueFilter> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ValueFilter).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.Value!.Value, typeInfo);
            }
            else if (value.IsCustomFieldFilterVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.CustomFieldFilterVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.CustomFieldFilterVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.CustomFieldFilterVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.CustomFieldFilterVariant2!, typeInfo);
            }
        }
    }
}