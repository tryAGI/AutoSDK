...
{
    /// <inheritdoc />
    public sealed class CloneVoiceRequestVoiceProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CloneVoiceRequestVoiceProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CloneVoiceRequestVoiceProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
