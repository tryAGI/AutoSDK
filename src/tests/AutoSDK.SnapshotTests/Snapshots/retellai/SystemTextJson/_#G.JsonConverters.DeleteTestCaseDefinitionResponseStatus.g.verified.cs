...
{
    /// <inheritdoc />
    public sealed class DeleteTestCaseDefinitionResponseStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DeleteTestCaseDefinitionResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.DeleteTestCaseDefinitionResponseStatusExtensions.ToValueString(value));
        }
    }
}
