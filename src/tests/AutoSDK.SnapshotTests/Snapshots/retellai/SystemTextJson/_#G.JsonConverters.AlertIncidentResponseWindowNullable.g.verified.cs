...
{
    /// <inheritdoc />
    public sealed class AlertIncidentResponseWindowNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AlertIncidentResponseWindow?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AlertIncidentResponseWindowExtensions.ToValueString(value.Value));
            }
        }
    }
}
