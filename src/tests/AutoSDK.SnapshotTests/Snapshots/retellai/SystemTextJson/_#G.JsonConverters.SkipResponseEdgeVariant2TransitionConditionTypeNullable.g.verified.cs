...
{
    /// <inheritdoc />
    public sealed class SkipResponseEdgeVariant2TransitionConditionTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SkipResponseEdgeVariant2TransitionConditionType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.SkipResponseEdgeVariant2TransitionConditionTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
