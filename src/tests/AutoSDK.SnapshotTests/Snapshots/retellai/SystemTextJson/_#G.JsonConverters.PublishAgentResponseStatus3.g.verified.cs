...
{
    /// <inheritdoc />
    public sealed class PublishAgentResponseStatus3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PublishAgentResponseStatus3>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PublishAgentResponseStatus3Extensions.ToValueString(value));
        }
    }
}
