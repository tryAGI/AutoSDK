...
{
    /// <inheritdoc />
    public sealed class ListTestRunsV2ResponseStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListTestRunsV2ResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ListTestRunsV2ResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
