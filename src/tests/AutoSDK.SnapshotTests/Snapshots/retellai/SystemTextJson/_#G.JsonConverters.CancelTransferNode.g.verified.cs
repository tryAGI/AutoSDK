//HintName: G.JsonConverters.CancelTransferNode.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class CancelTransferNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CancelTransferNode>
    {
        /// <inheritdoc />
        public override global::G.CancelTransferNode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.CancelTransferNodeVariant2? cancelTransferNodeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.CancelTransferNodeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.CancelTransferNodeVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.CancelTransferNodeVariant2).Name}");
            ...
            var __value = new global::G.CancelTransferNode(
                @base,
        ...
        public override void Write(
            ...
            global::G.CancelTransferNode value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
