...
{
    /// <inheritdoc />
    public sealed class ChatAgentRequestDataStorageSettingJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatAgentRequestDataStorageSetting>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatAgentRequestDataStorageSettingExtensions.ToValueString(value));
        }
    }
}
