...
{
    /// <inheritdoc />
    public sealed class UpdateConversationFlowResponseStatus5NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateConversationFlowResponseStatus5?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateConversationFlowResponseStatus5Extensions.ToValueString(value.Value));
            }
        }
    }
}
