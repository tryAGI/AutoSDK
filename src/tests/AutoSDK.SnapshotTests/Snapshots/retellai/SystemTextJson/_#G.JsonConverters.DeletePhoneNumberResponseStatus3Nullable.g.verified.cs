...
{
    /// <inheritdoc />
    public sealed class DeletePhoneNumberResponseStatus3NullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DeletePhoneNumberResponseStatus3?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.DeletePhoneNumberResponseStatus3Extensions.ToValueString(value.Value));
            }
        }
    }
}
