...
{
    /// <inheritdoc />
    public sealed class FinetuneExampleUtteranceVariant3RoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FinetuneExampleUtteranceVariant3Role>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FinetuneExampleUtteranceVariant3RoleExtensions.ToValueString(value));
        }
    }
}
