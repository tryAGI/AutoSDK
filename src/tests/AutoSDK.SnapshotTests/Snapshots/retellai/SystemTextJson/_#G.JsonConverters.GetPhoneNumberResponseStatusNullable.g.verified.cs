...
{
    /// <inheritdoc />
    public sealed class GetPhoneNumberResponseStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetPhoneNumberResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetPhoneNumberResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
