...
{
    /// <inheritdoc />
    public sealed class CreatePhoneCallResponseStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreatePhoneCallResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreatePhoneCallResponseStatusExtensions.ToValueString(value));
        }
    }
}
