//HintName: G.Models.CancelTransferTool.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CancelTransferTool
    {
        /// <summary>
        /// 
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("type")]
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CancelTransferToolTypeJsonConverter))]
        public global::G.CancelTransferToolType Type { get; set; }
        ...
        /// <summary>
        /// Describes what the tool does. This tool is only available to transfer agents (agents with isTransferAgent set to true) in agentic warm transfer mode. When invoked, it cancels the transfer, returns the original caller to the main agent, and ends the transfer agent call.
        /// </summary>
        ...
        /// <summary>
        /// Describes what to say to user when cancelling the transfer. Only applicable when speak_during_execution is true.
        /// </summary>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CancelTransferToolExecutionMessageTypeJsonConverter))]
        public global::G.CancelTransferToolExecutionMessageType? ExecutionMessageType { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CancelTransferTool" /> class.
        /// </summary>
        /// <param name="name">
        /// Name of the tool. Must be unique within all tools available to LLM at any given time (general tools + state tools + state transitions). Must be consisted of a-z, A-Z, 0-9, or contain underscores and dashes, with a maximum length of 64 (no space allowed).
        /// </param>
...
#endif
        public CancelTransferTool(
            string name,
            global::G.CancelTransferToolType type,
            string? description,
            bool? speakDuringExecution,
            string? executionMessageDescription,
            global::G.CancelTransferToolExecutionMessageType? executionMessageType)
        {
            this.Type = type;
