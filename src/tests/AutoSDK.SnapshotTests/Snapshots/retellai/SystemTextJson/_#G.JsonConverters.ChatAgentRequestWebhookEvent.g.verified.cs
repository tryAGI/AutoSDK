...
{
    /// <inheritdoc />
    public sealed class ChatAgentRequestWebhookEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatAgentRequestWebhookEvent>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatAgentRequestWebhookEventExtensions.ToValueString(value));
        }
    }
}
