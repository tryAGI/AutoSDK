//HintName: G.JsonConverters.BridgeTransferNode.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class BridgeTransferNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.BridgeTransferNode>
    {
        /// <inheritdoc />
        public override global::G.BridgeTransferNode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.BridgeTransferNodeVariant2? bridgeTransferNodeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.BridgeTransferNodeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.BridgeTransferNodeVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.BridgeTransferNodeVariant2).Name}");
            ...
            var __value = new global::G.BridgeTransferNode(
                @base,
        ...
        public override void Write(
            ...
            global::G.BridgeTransferNode value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
