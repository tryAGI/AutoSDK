...
{
    /// <inheritdoc />
    public sealed class ListExportRequestsV2ResponseItemChannelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ListExportRequestsV2ResponseItemChannel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ListExportRequestsV2ResponseItemChannelExtensions.ToValueString(value));
        }
    }
}
