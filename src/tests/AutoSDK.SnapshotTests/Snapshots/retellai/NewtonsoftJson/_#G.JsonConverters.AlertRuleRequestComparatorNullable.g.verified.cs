...
{
    /// <inheritdoc />
    public sealed class AlertRuleRequestComparatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertRuleRequestComparator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AlertRuleRequestComparatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
