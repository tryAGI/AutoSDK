...
{
    /// <inheritdoc />
    public sealed class PIIConfigModeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PIIConfigMode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PIIConfigModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
