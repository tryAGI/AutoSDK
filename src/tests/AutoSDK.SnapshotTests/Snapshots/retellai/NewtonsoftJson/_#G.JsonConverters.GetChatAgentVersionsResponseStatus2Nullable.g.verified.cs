...
{
    /// <inheritdoc />
    public sealed class GetChatAgentVersionsResponseStatus2NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetChatAgentVersionsResponseStatus2?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetChatAgentVersionsResponseStatus2Extensions.ToValueString(value.Value));
            }
        }
    }
}
