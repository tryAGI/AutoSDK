...
{
    /// <inheritdoc />
    public sealed class GuardrailConfigInputTopicNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GuardrailConfigInputTopic?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GuardrailConfigInputTopicExtensions.ToValueString(value.Value));
            }
        }
    }
}
