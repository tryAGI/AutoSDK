...
{
    /// <inheritdoc />
    public sealed class ListExportRequestsV2ResponseItemChannelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListExportRequestsV2ResponseItemChannel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListExportRequestsV2ResponseItemChannelExtensions.ToValueString(value.Value));
            }
        }
    }
}
