...
{
    /// <inheritdoc />
    public sealed class GetBatchTestResponseStatus3JsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetBatchTestResponseStatus3>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetBatchTestResponseStatus3Extensions.ToValueString(value));
        }
    }
}
