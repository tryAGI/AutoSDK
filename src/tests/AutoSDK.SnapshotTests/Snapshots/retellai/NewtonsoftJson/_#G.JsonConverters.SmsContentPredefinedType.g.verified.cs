...
{
    /// <inheritdoc />
    public sealed class SmsContentPredefinedTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SmsContentPredefinedType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SmsContentPredefinedTypeExtensions.ToValueString(value));
        }
    }
}
