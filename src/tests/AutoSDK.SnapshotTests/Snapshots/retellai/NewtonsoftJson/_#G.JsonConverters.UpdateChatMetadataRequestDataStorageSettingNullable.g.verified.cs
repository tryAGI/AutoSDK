...
{
    /// <inheritdoc />
    public sealed class UpdateChatMetadataRequestDataStorageSettingNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateChatMetadataRequestDataStorageSetting?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateChatMetadataRequestDataStorageSettingExtensions.ToValueString(value.Value));
            }
        }
    }
}
