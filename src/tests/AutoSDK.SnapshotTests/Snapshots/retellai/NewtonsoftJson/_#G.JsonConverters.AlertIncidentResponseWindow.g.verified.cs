...
{
    /// <inheritdoc />
    public sealed class AlertIncidentResponseWindowJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertIncidentResponseWindow>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AlertIncidentResponseWindowExtensions.ToValueString(value));
        }
    }
}
