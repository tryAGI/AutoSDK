...
{
    /// <inheritdoc />
    public sealed class GetMCPToolsResponseStatus2NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetMCPToolsResponseStatus2?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetMCPToolsResponseStatus2Extensions.ToValueString(value.Value));
            }
        }
    }
}
