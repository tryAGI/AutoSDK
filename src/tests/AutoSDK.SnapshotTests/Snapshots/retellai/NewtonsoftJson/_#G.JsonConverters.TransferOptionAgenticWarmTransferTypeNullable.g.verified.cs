...
{
    /// <inheritdoc />
    public sealed class TransferOptionAgenticWarmTransferTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TransferOptionAgenticWarmTransferType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TransferOptionAgenticWarmTransferTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
