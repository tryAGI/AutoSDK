...
{
    /// <inheritdoc />
    public sealed class WarmTransferPromptTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WarmTransferPromptType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.WarmTransferPromptTypeExtensions.ToValueString(value));
        }
    }
}
