//HintName: G.Api.UpdateChatMetadata.g.cs
...
namespace G
{
    public partial class Api
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_UpdateChatMetadataSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_UpdateChatMetadataSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.ChatResponse> UpdateChatMetadataAsync(
            string chatId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                global::G.UpdateChatMetadataResponse? __value_400 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = global::G.UpdateChatMetadataResponse.FromJson(__content_400, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::G.ApiException<global::G.UpdateChatMetadataResponse>(
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                global::G.UpdateChatMetadataResponse2? __value_401 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_401 = global::G.UpdateChatMetadataResponse2.FromJson(__content_401, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::G.ApiException<global::G.UpdateChatMetadataResponse2>(
            ...
            if ((int)__response.StatusCode == 422)
            {
                ...
                global::G.UpdateChatMetadataResponse3? __value_422 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_422 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_422 = global::G.UpdateChatMetadataResponse3.FromJson(__content_422, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_422 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::G.ApiException<global::G.UpdateChatMetadataResponse3>(
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                global::G.UpdateChatMetadataResponse4? __value_500 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_500 = global::G.UpdateChatMetadataResponse4.FromJson(__content_500, JsonSerializerOptions);
                    }
                    else
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::G.ApiException<global::G.UpdateChatMetadataResponse4>(
