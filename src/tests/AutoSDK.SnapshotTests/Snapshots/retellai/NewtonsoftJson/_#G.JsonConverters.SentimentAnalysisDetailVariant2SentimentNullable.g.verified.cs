...
{
    /// <inheritdoc />
    public sealed class SentimentAnalysisDetailVariant2SentimentNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SentimentAnalysisDetailVariant2Sentiment?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SentimentAnalysisDetailVariant2SentimentExtensions.ToValueString(value.Value));
            }
        }
    }
}
