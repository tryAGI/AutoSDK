...
{
    /// <inheritdoc />
    public sealed class GetAgentResponseStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetAgentResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetAgentResponseStatusExtensions.ToValueString(value));
        }
    }
}
