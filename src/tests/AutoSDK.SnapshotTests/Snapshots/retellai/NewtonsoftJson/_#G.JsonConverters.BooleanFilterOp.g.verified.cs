...
{
    /// <inheritdoc />
    public sealed class BooleanFilterOpJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BooleanFilterOp>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BooleanFilterOpExtensions.ToValueString(value));
        }
    }
}
