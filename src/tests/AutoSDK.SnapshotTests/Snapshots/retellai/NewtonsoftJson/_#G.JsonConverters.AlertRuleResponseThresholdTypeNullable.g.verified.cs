...
{
    /// <inheritdoc />
    public sealed class AlertRuleResponseThresholdTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertRuleResponseThresholdType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AlertRuleResponseThresholdTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
