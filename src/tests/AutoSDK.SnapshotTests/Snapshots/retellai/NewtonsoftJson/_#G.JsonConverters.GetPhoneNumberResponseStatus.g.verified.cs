...
{
    /// <inheritdoc />
    public sealed class GetPhoneNumberResponseStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetPhoneNumberResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetPhoneNumberResponseStatusExtensions.ToValueString(value));
        }
    }
}
