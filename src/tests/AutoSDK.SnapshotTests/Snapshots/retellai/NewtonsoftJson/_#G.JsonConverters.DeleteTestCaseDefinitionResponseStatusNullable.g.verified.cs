...
{
    /// <inheritdoc />
    public sealed class DeleteTestCaseDefinitionResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeleteTestCaseDefinitionResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeleteTestCaseDefinitionResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
