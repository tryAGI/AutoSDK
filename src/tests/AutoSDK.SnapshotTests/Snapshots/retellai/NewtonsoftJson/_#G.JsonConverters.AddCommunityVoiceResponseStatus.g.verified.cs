...
{
    /// <inheritdoc />
    public sealed class AddCommunityVoiceResponseStatusJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AddCommunityVoiceResponseStatus>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AddCommunityVoiceResponseStatusExtensions.ToValueString(value));
        }
    }
}
