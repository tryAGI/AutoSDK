...
{
    /// <inheritdoc />
    public sealed class PublishAgentResponseStatus3NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PublishAgentResponseStatus3?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PublishAgentResponseStatus3Extensions.ToValueString(value.Value));
            }
        }
    }
}
