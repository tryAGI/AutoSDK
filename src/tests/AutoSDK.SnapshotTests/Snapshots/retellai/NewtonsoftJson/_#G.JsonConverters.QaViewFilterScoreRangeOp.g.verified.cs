...
{
    /// <inheritdoc />
    public sealed class QaViewFilterScoreRangeOpJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.QaViewFilterScoreRangeOp>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.QaViewFilterScoreRangeOpExtensions.ToValueString(value));
        }
    }
}
