...
{
    /// <inheritdoc />
    public sealed class ToolCallInvocationUtteranceRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ToolCallInvocationUtteranceRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ToolCallInvocationUtteranceRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
