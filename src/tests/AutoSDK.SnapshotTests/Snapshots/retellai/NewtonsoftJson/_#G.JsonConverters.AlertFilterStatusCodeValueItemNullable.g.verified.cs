...
{
    /// <inheritdoc />
    public sealed class AlertFilterStatusCodeValueItemNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertFilterStatusCodeValueItem?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AlertFilterStatusCodeValueItemExtensions.ToValueString(value.Value));
            }
        }
    }
}
