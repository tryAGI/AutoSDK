...
namespace G
{
    ...
    public sealed partial class ListAgentsResponse
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.ListAgentsResponseStatusJsonConverter))]
        public global::G.ListAgentsResponseStatus? Status { get; set; }
        ...
        public ListAgentsResponse(
            global::G.ListAgentsResponseStatus? status,
            string? message)
        {
            this.Status = status;
