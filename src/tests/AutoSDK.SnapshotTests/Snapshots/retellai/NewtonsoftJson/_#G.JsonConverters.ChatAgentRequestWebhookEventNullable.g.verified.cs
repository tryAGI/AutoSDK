...
{
    /// <inheritdoc />
    public sealed class ChatAgentRequestWebhookEventNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatAgentRequestWebhookEvent?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatAgentRequestWebhookEventExtensions.ToValueString(value.Value));
            }
        }
    }
}
