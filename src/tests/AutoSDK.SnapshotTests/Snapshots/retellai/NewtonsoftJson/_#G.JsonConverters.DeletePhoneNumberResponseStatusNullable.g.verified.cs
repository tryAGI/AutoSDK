...
{
    /// <inheritdoc />
    public sealed class DeletePhoneNumberResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeletePhoneNumberResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeletePhoneNumberResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
