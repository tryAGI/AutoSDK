...
{
    /// <inheritdoc />
    public sealed class GetChatResponseStatus2NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetChatResponseStatus2?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetChatResponseStatus2Extensions.ToValueString(value.Value));
            }
        }
    }
}
