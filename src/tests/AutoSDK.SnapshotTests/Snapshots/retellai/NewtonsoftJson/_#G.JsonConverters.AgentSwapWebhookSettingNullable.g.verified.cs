...
{
    /// <inheritdoc />
    public sealed class AgentSwapWebhookSettingNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AgentSwapWebhookSetting?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AgentSwapWebhookSettingExtensions.ToValueString(value.Value));
            }
        }
    }
}
