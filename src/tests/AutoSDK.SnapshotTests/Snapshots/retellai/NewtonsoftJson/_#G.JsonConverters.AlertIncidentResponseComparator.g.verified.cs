...
{
    /// <inheritdoc />
    public sealed class AlertIncidentResponseComparatorJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertIncidentResponseComparator>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AlertIncidentResponseComparatorExtensions.ToValueString(value));
        }
    }
}
