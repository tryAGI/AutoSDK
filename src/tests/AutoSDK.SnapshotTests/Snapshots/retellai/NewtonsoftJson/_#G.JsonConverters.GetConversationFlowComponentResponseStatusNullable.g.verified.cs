...
{
    /// <inheritdoc />
    public sealed class GetConversationFlowComponentResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetConversationFlowComponentResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetConversationFlowComponentResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
