//HintName: G.Models.GetKnowledgeBaseResponse2.g.cs
...
namespace G
{
    ...
    public sealed partial class GetKnowledgeBaseResponse2
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.GetKnowledgeBaseResponseStatus2JsonConverter))]
        public global::G.GetKnowledgeBaseResponseStatus2? Status { get; set; }
        ...
        public GetKnowledgeBaseResponse2(
            global::G.GetKnowledgeBaseResponseStatus2? status,
            string? message)
        {
            this.Status = status;
