...
{
    /// <inheritdoc />
    public sealed class WarmTransferStaticMessageTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.WarmTransferStaticMessageType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.WarmTransferStaticMessageTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
