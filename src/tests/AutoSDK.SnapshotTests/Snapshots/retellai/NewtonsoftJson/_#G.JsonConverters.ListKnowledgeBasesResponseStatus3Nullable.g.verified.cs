...
{
    /// <inheritdoc />
    public sealed class ListKnowledgeBasesResponseStatus3NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListKnowledgeBasesResponseStatus3?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListKnowledgeBasesResponseStatus3Extensions.ToValueString(value.Value));
            }
        }
    }
}
