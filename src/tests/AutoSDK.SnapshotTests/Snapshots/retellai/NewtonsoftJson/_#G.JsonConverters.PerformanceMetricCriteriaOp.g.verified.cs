...
{
    /// <inheritdoc />
    public sealed class PerformanceMetricCriteriaOpJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PerformanceMetricCriteriaOp>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PerformanceMetricCriteriaOpExtensions.ToValueString(value));
        }
    }
}
