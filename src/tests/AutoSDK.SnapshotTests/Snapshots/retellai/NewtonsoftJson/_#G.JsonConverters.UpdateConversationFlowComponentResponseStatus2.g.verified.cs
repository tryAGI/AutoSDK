...
{
    /// <inheritdoc />
    public sealed class UpdateConversationFlowComponentResponseStatus2JsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateConversationFlowComponentResponseStatus2>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.UpdateConversationFlowComponentResponseStatus2Extensions.ToValueString(value));
        }
    }
}
