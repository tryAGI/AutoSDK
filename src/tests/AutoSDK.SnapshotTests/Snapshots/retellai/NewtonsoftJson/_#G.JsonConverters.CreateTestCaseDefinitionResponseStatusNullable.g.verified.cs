...
{
    /// <inheritdoc />
    public sealed class CreateTestCaseDefinitionResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTestCaseDefinitionResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTestCaseDefinitionResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
