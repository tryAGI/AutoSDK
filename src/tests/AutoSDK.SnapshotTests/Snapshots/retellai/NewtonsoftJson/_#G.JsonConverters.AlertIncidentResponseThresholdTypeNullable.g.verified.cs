...
{
    /// <inheritdoc />
    public sealed class AlertIncidentResponseThresholdTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertIncidentResponseThresholdType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AlertIncidentResponseThresholdTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
