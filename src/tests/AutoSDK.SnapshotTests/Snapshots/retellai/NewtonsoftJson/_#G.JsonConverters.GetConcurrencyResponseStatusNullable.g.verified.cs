...
{
    /// <inheritdoc />
    public sealed class GetConcurrencyResponseStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetConcurrencyResponseStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetConcurrencyResponseStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
