...
{
    /// <inheritdoc />
    public sealed class RetellLlmOverrideStartSpeakerNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RetellLlmOverrideStartSpeaker?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RetellLlmOverrideStartSpeakerExtensions.ToValueString(value.Value));
            }
        }
    }
}
