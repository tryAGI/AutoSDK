...
{
    /// <inheritdoc />
    public sealed class AddCommunityVoiceResponseStatus4NullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AddCommunityVoiceResponseStatus4?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AddCommunityVoiceResponseStatus4Extensions.ToValueString(value.Value));
            }
        }
    }
}
