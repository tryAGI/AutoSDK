...
{
    /// <inheritdoc />
    public sealed class GetScoresResponseDataVariant2DataTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetScoresResponseDataVariant2DataType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetScoresResponseDataVariant2DataTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
