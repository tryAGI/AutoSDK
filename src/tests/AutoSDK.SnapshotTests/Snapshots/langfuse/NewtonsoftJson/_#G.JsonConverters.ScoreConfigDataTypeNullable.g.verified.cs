...
{
    /// <inheritdoc />
    public sealed class ScoreConfigDataTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ScoreConfigDataType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ScoreConfigDataTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
