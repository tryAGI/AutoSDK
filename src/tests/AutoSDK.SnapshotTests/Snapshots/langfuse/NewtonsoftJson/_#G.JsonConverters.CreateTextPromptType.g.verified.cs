...
{
    /// <inheritdoc />
    public sealed class CreateTextPromptTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTextPromptType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateTextPromptTypeExtensions.ToValueString(value));
        }
    }
}
