...
namespace G
{
    public partial class DatasetRunItemsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DatasetRunItemsListSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_DatasetRunItemsListSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareDatasetRunItemsListArguments(
            ...
            ref int? page,
            ref int? limit);
        partial void PrepareDatasetRunItemsListRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? page,
            int? limit);
        partial void ProcessDatasetRunItemsListResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDatasetRunItemsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.PaginatedDatasetRunItems> DatasetRunItemsListAsync(
            string datasetId,
            string runName,
            int? page = default,
            int? limit = default,
        ...
        {
            var __response = await DatasetRunItemsListAsResponseAsync(
                datasetId: datasetId,
                runName: runName,
                page: page,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PaginatedDatasetRunItems>> DatasetRunItemsListAsResponseAsync(
            string datasetId,
            string runName,
            int? page = default,
            int? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDatasetRunItemsListArguments(
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            __pathBuilder
                                .AddRequiredParameter("datasetId", datasetId)
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DatasetRunItemsList",
                                methodName: "DatasetRunItemsListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDatasetRunItemsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDatasetRunItemsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PaginatedDatasetRunItems.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PaginatedDatasetRunItems>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PaginatedDatasetRunItems.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
