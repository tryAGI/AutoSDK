//HintName: G.DatasetRunItemsClient.DatasetRunItemsCreate.g.cs
...
namespace G
{
    public partial class DatasetRunItemsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DatasetRunItemsCreateSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_DatasetRunItemsCreateSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_DatasetRunItemsCreateSecurityRequirement0,
            };
        partial void PrepareDatasetRunItemsCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.CreateDatasetRunItemRequest request);
        partial void PrepareDatasetRunItemsCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.CreateDatasetRunItemRequest request);
        partial void ProcessDatasetRunItemsCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDatasetRunItemsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.DatasetRunItem> DatasetRunItemsCreateAsync(

            global::G.CreateDatasetRunItemRequest request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await DatasetRunItemsCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DatasetRunItem>> DatasetRunItemsCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDatasetRunItemsCreateArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DatasetRunItemsCreateSecurityRequirements,
                operationName: "DatasetRunItemsCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDatasetRunItemsCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DatasetRunItemsCreate",
                                methodName: "DatasetRunItemsCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDatasetRunItemsCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDatasetRunItemsCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DatasetRunItem.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DatasetRunItem>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DatasetRunItem.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await DatasetRunItemsCreateAsync(
                request: __request,
                requestOptions: requestOptions,
