...
namespace G
{
    ...
    public sealed partial class CreateDatasetRunItemRequest
    {
        ...
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("runName", Required = global::Newtonsoft.Json.Required.Always)]
        public string RunName { get; set; } = default!;

        /// <summary>
        /// Description of the run. If run exists, description will be updated.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("runDescription")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("datasetVersion")]
