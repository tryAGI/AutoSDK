...
namespace G
{
    public partial class LegacyObservationsV1Client
    {
        ...
        {
            var __response = await LegacyObservationsV1GetManyAsResponseAsync(
                page: page,
                limit: limit,
                name: name,
                userId: userId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.LegacyObservationsViews>> LegacyObservationsV1GetManyAsResponseAsync(
            int? page = default,
            int? limit = default,
            string? name = default,
            string? userId = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.LegacyObservationsViews.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.LegacyObservationsViews>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.LegacyObservationsViews.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
