...
{
    /// <inheritdoc />
    public sealed class CreateTextPromptTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTextPromptType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateTextPromptTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
