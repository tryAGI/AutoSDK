//HintName: G.ScimClient.ScimListUsers.g.cs
...
namespace G
{
    public partial class ScimClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ScimListUsersSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ScimListUsersSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareScimListUsersArguments(
            ...
            ref int? startIndex,
            ref int? count);
        partial void PrepareScimListUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? filter,
            int? startIndex,
            int? count);
        partial void ProcessScimListUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessScimListUsersResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ScimUsersListResponse> ScimListUsersAsync(
        ...
        {
            var __response = await ScimListUsersAsResponseAsync(
                filter: filter,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ScimUsersListResponse>> ScimListUsersAsResponseAsync(
            string? filter = default,
            int? startIndex = default,
            int? count = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessScimListUsersResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ScimUsersListResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ScimUsersListResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ScimUsersListResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
