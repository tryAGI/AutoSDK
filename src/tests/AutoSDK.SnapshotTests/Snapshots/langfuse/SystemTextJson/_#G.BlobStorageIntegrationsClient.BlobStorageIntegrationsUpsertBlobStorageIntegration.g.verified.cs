//HintName: G.BlobStorageIntegrationsClient.BlobStorageIntegrationsUpsertBlobStorageIntegration.g.cs
...
namespace G
{
    public partial class BlobStorageIntegrationsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_BlobStorageIntegrationsUpsertBlobStorageIntegrationSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_BlobStorageIntegrationsUpsertBlobStorageIntegrationSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.BlobStorageIntegrationResponse> BlobStorageIntegrationsUpsertBlobStorageIntegrationAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.BlobStorageIntegrationResponse>> BlobStorageIntegrationsUpsertBlobStorageIntegrationAsResponseAsync(
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.BlobStorageIntegrationResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.BlobStorageIntegrationResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.BlobStorageIntegrationResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.BlobStorageIntegrationResponse> BlobStorageIntegrationsUpsertBlobStorageIntegrationAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.CreateBlobStorageIntegrationRequest
            {
                ProjectId = projectId,
                Type = type,
