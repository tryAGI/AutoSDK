//HintName: G.JsonConverters.ChatMessageWithPlaceholders.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ChatMessageWithPlaceholdersJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatMessageWithPlaceholders>
    {
        /// <inheritdoc />
        public override global::G.ChatMessageWithPlaceholders Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::G.ChatMessage? chatMessage = default;
            global::G.PlaceholderMessage? placeholderMessage = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.ChatMessageWithPlaceholders(
                chatMessage,
        ...
        public override void Write(
            ...
            global::G.ChatMessageWithPlaceholders value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsChatMessage)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ChatMessage), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ChatMessage?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.ChatMessage).Name}");
