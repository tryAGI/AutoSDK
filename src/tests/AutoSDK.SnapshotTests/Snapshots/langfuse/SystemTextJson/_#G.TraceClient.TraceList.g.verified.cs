...
namespace G
{
    public partial class TraceClient
    {
        ...
        {
            var __response = await TraceListAsResponseAsync(
                page: page,
                limit: limit,
                userId: userId,
                name: name,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Traces>> TraceListAsResponseAsync(
            int? page = default,
            int? limit = default,
            string? userId = default,
            string? name = default,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Traces.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.Traces>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Traces.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
