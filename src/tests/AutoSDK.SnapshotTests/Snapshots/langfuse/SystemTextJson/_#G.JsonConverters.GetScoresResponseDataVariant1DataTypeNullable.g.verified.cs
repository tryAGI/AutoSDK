...
{
    /// <inheritdoc />
    public sealed class GetScoresResponseDataVariant1DataTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetScoresResponseDataVariant1DataType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetScoresResponseDataVariant1DataTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
