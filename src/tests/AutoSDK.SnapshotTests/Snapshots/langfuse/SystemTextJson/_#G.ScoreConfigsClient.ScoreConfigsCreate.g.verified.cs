//HintName: G.ScoreConfigsClient.ScoreConfigsCreate.g.cs
...
namespace G
{
    public partial class ScoreConfigsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ScoreConfigsCreateSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ScoreConfigsCreateSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_ScoreConfigsCreateSecurityRequirement0,
            };
        partial void PrepareScoreConfigsCreateArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.CreateScoreConfigRequest request);
        partial void PrepareScoreConfigsCreateRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.CreateScoreConfigRequest request);
        partial void ProcessScoreConfigsCreateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessScoreConfigsCreateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ScoreConfig> ScoreConfigsCreateAsync(

            global::G.CreateScoreConfigRequest request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ScoreConfigsCreateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ScoreConfig>> ScoreConfigsCreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareScoreConfigsCreateArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ScoreConfigsCreateSecurityRequirements,
                operationName: "ScoreConfigsCreateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareScoreConfigsCreateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ScoreConfigsCreate",
                                methodName: "ScoreConfigsCreateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessScoreConfigsCreateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessScoreConfigsCreateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ScoreConfigsCreateAsync(
                request: __request,
                requestOptions: requestOptions,
