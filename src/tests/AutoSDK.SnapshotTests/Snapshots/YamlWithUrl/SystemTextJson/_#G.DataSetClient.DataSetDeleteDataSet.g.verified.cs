...
namespace G
{
    public partial class DataSetClient
    {
        ...
        public async global::System.Threading.Tasks.Task<DataSetVO> DataSetDeleteDataSetAsync(
            string token,
            string id,
            string projectId,
            string projectIdKey,
