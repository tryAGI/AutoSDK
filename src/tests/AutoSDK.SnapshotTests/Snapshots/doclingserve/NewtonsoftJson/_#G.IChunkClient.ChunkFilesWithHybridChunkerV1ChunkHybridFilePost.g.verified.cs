//HintName: G.IChunkClient.ChunkFilesWithHybridChunkerV1ChunkHybridFilePost.g.cs
#nullable enable
...
namespace G
{
    public partial interface IChunkClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ChunkDocumentResponse>> ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsResponseAsync(
