...
namespace G
{
    public partial class ConvertClient
    {
        ...
        {
            var __response = await ProcessFileV1ConvertFilePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AnyOf<global::G.ConvertDocumentResponse, global::G.PresignedUrlConvertDocumentResponse>>> ProcessFileV1ConvertFilePostAsResponseAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ProcessFileV1ConvertFilePost",
                                methodName: "ProcessFileV1ConvertFilePostAsync",
                                pathTemplate: "\"/v1/convert/file\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AnyOf<global::G.ConvertDocumentResponse, global::G.PresignedUrlConvertDocumentResponse>.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AnyOf<global::G.ConvertDocumentResponse, global::G.PresignedUrlConvertDocumentResponse>>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AnyOf<global::G.ConvertDocumentResponse, global::G.PresignedUrlConvertDocumentResponse>.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.BodyProcessFileV1ConvertFilePost
            {
