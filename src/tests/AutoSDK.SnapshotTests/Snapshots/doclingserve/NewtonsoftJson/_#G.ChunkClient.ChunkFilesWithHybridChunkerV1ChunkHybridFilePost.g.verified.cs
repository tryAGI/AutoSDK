//HintName: G.ChunkClient.ChunkFilesWithHybridChunkerV1ChunkHybridFilePost.g.cs
...
namespace G
{
    public partial class ChunkClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ChunkFilesWithHybridChunkerV1ChunkHybridFilePostSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ChunkFilesWithHybridChunkerV1ChunkHybridFilePostSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_ChunkFilesWithHybridChunkerV1ChunkHybridFilePostSecurityRequirement0,
            };
        partial void PrepareChunkFilesWithHybridChunkerV1ChunkHybridFilePostArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.BodyChunkFilesWithHybridChunkerV1ChunkHybridFilePost request);
        partial void PrepareChunkFilesWithHybridChunkerV1ChunkHybridFilePostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.BodyChunkFilesWithHybridChunkerV1ChunkHybridFilePost request);
        partial void ProcessChunkFilesWithHybridChunkerV1ChunkHybridFilePostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChunkFilesWithHybridChunkerV1ChunkHybridFilePostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ChunkDocumentResponse> ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsync(

            global::G.BodyChunkFilesWithHybridChunkerV1ChunkHybridFilePost request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ChunkDocumentResponse>> ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChunkFilesWithHybridChunkerV1ChunkHybridFilePostArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChunkFilesWithHybridChunkerV1ChunkHybridFilePostSecurityRequirements,
                operationName: "ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChunkFilesWithHybridChunkerV1ChunkHybridFilePostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChunkFilesWithHybridChunkerV1ChunkHybridFilePost",
                                methodName: "ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsync",
                                pathTemplate: "\"/v1/chunk/hybrid/file\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChunkFilesWithHybridChunkerV1ChunkHybridFilePostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChunkFilesWithHybridChunkerV1ChunkHybridFilePostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ChunkDocumentResponse> ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.BodyChunkFilesWithHybridChunkerV1ChunkHybridFilePost
            {
                Files = files,
            ...
            return await ChunkFilesWithHybridChunkerV1ChunkHybridFilePostAsync(
                request: __request,
                requestOptions: requestOptions,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::G.BodyChunkFilesWithHybridChunkerV1ChunkHybridFilePost
            {
