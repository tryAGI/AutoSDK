//HintName: G.JsonConverters.Target.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class TargetJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Target>
    {
        /// <inheritdoc />
        public override global::G.Target Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ConvertDocumentsRequestTargetDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ConvertDocumentsRequestTargetDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ConvertDocumentsRequestTargetDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.InBodyTarget? inbody = default;
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestTargetDiscriminatorKind.Inbody)
            {
            ...
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestTargetDiscriminatorKind.Zip)
            {
            ...
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestTargetDiscriminatorKind.S3)
            {
            ...
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestTargetDiscriminatorKind.Put)
            {
            ...
            var __value = new global::G.Target(
                discriminator?.Kind,
                inbody,
