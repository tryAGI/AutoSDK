...
namespace G.JsonConverters
{
    ...
    public class SourcesItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SourcesItem>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ConvertDocumentsRequestSourceDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ConvertDocumentsRequestSourceDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ConvertDocumentsRequestSourceDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.FileSourceRequest? file = default;
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestSourceDiscriminatorKind.File)
            {
            ...
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestSourceDiscriminatorKind.Http)
            {
            ...
            if (discriminator?.Kind == global::G.ConvertDocumentsRequestSourceDiscriminatorKind.S3)
            {
