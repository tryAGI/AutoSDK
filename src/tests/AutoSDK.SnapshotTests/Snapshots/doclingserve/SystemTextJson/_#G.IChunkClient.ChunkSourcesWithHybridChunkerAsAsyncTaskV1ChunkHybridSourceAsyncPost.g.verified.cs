//HintName: G.IChunkClient.ChunkSourcesWithHybridChunkerAsAsyncTaskV1ChunkHybridSourceAsyncPost.g.cs
#nullable enable
...
namespace G
{
    public partial interface IChunkClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.TaskStatusResponse>> ChunkSourcesWithHybridChunkerAsAsyncTaskV1ChunkHybridSourceAsyncPostAsResponseAsync(
