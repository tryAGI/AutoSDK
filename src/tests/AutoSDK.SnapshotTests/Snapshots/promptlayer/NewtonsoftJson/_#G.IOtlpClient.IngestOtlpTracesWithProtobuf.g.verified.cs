//HintName: G.IOtlpClient.IngestOtlpTracesWithProtobuf.g.cs
#nullable enable
...
namespace G
{
    public partial interface IOtlpClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.OtlpExportTraceServiceResponse> IngestOtlpTracesWithProtobufAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OtlpExportTraceServiceResponse>> IngestOtlpTracesWithProtobufAsResponseAsync(
            global::G.IngestOtlpTracesContentType contentType,
