//HintName: G.Models.GetWorkflowVersionExecutionResultsResponseVariant12.g.cs
...
namespace G
{
    ...
    public sealed partial class GetWorkflowVersionExecutionResultsResponseVariant12
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWorkflowVersionExecutionResultsResponseVariant12" /> class.
        /// </summary>
        /// <param name="status">
        /// The status of the node execution.
        /// </param>
        ...
        /// Whether this node is an output node.
        /// </param>
        public GetWorkflowVersionExecutionResultsResponseVariant12(
            string? status,
            object? value,
            string? errorMessage,
