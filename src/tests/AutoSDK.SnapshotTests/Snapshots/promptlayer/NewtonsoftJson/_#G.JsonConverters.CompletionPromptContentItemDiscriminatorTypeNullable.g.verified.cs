...
{
    /// <inheritdoc />
    public sealed class CompletionPromptContentItemDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CompletionPromptContentItemDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CompletionPromptContentItemDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
