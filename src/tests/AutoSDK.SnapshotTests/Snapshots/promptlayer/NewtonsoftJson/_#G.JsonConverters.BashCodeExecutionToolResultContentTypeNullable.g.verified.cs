...
{
    /// <inheritdoc />
    public sealed class BashCodeExecutionToolResultContentTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BashCodeExecutionToolResultContentType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.BashCodeExecutionToolResultContentTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
