...
{
    /// <inheritdoc />
    public sealed class ListDatasetsStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListDatasetsStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListDatasetsStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
