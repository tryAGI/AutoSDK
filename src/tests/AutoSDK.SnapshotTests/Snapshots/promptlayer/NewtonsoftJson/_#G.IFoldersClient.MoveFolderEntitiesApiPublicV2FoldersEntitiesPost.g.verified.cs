...
namespace G
{
    public partial interface IFoldersClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.FolderEntitiesCountResponse>> MoveFolderEntitiesApiPublicV2FoldersEntitiesPostAsResponseAsync(
