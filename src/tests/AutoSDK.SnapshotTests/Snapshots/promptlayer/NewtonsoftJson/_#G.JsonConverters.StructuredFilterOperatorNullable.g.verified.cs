...
{
    /// <inheritdoc />
    public sealed class StructuredFilterOperatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.StructuredFilterOperator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.StructuredFilterOperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
