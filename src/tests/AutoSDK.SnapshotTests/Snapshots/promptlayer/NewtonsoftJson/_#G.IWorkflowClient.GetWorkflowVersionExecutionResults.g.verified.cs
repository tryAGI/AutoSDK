...
namespace G
{
    public partial interface IWorkflowClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OneOf<global::System.Collections.Generic.Dictionary<string, global::G.GetWorkflowVersionExecutionResultsResponseVariant12>, object>>> GetWorkflowVersionExecutionResultsAsResponseAsync(
            long workflowVersionExecutionId,
            bool? returnAllOutputs = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
