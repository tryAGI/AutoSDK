//HintName: G.JsonConverters.ContentItem5.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ContentItem5JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ContentItem5>
    {
        /// <inheritdoc />
        public override global::G.ContentItem5 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.ToolMessageContentItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.ToolMessageContentItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.ToolMessageContentItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextContent? text = default;
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.Thinking)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.Code)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.ImageUrl)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.Media)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.MediaVariable)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.OutputMedia)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.ServerToolUse)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.WebSearchToolResult)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.CodeExecutionResult)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.McpListTools)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.McpCall)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.McpApprovalRequest)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.McpApprovalResponse)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.BashCodeExecutionToolResult)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.TextEditorCodeExecutionToolResult)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.ShellCall)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.ShellCallOutput)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.ApplyPatchCall)
            {
            ...
            if (discriminator?.Type == global::G.ToolMessageContentItemDiscriminatorType.ApplyPatchCallOutput)
            {
            ...
            var __value = new global::G.ContentItem5(
                discriminator?.Type,
                text,
