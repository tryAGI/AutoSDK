...
{
    /// <inheritdoc />
    public sealed class McpApprovalResponseContentTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.McpApprovalResponseContentType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.McpApprovalResponseContentTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
