//HintName: G.JsonConverters.ContentItem3.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class ContentItem3JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ContentItem3>
    {
        /// <inheritdoc />
        public override global::G.ContentItem3 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.UserMessageContentItemDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.UserMessageContentItemDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.UserMessageContentItemDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.TextContent? text = default;
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.Text)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.Thinking)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.Code)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.ImageUrl)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.Media)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.MediaVariable)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.OutputMedia)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.ServerToolUse)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.WebSearchToolResult)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.CodeExecutionResult)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.McpListTools)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.McpCall)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.McpApprovalRequest)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.McpApprovalResponse)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.BashCodeExecutionToolResult)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.TextEditorCodeExecutionToolResult)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.ShellCall)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.ShellCallOutput)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.ApplyPatchCall)
            {
            ...
            if (discriminator?.Type == global::G.UserMessageContentItemDiscriminatorType.ApplyPatchCallOutput)
            {
            ...
            var __value = new global::G.ContentItem3(
                discriminator?.Type,
                text,
