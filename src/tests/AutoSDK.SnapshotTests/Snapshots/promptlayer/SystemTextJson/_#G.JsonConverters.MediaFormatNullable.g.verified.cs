...
{
    /// <inheritdoc />
    public sealed class MediaFormatNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.MediaFormat?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.MediaFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
