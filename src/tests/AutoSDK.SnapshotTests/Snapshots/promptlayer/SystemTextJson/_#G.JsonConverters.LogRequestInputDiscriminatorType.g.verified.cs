...
{
    /// <inheritdoc />
    public sealed class LogRequestInputDiscriminatorTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LogRequestInputDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.LogRequestInputDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
