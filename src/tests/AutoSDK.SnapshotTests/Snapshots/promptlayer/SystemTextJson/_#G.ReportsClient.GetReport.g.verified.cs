//HintName: G.ReportsClient.GetReport.g.cs
...
namespace G
{
    public partial class ReportsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::G.GetReportResponse> GetReportAsync(
            int reportId,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.GetReportResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.GetReportResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
