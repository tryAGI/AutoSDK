...
{
    /// <inheritdoc />
    public sealed class ProjectMetricRequestPublicIntervalJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ProjectMetricRequestPublicInterval>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ProjectMetricRequestPublicIntervalExtensions.ToValueString(value));
        }
    }
}
