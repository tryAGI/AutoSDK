...
{
    /// <inheritdoc />
    public sealed class DatasetPublicStatusJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DatasetPublicStatus>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.DatasetPublicStatusExtensions.ToValueString(value));
        }
    }
}
