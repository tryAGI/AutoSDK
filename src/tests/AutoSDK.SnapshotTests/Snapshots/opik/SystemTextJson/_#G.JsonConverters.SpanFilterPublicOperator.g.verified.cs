...
{
    /// <inheritdoc />
    public sealed class SpanFilterPublicOperatorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SpanFilterPublicOperator>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.SpanFilterPublicOperatorExtensions.ToValueString(value));
        }
    }
}
