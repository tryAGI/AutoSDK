...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorObjectObjectPublicDiscriminatorTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AutomationRuleEvaluatorObjectObjectPublicDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AutomationRuleEvaluatorObjectObjectPublicDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
