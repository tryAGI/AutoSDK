...
{
    /// <inheritdoc />
    public sealed class PromptVersionTemplateStructureJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PromptVersionTemplateStructure>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.PromptVersionTemplateStructureExtensions.ToValueString(value));
        }
    }
}
