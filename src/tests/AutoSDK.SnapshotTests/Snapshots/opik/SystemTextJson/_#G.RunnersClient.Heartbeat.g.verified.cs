//HintName: G.RunnersClient.Heartbeat.g.cs
...
namespace G
{
    public partial class RunnersClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_HeartbeatServers = new global::G.AutoSDKServer[]
        ...
        public async global::System.Threading.Tasks.Task<global::G.LocalRunnerHeartbeatResponse> HeartbeatAsync(
            global::System.Guid runnerId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await HeartbeatAsResponseAsync(
                runnerId: runnerId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.LocalRunnerHeartbeatResponse>> HeartbeatAsResponseAsync(
            global::System.Guid runnerId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "HeartbeatAsync",
                                pathTemplate: "$\"/v1/private/local-runners/{runnerId}/heartbeats\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 410)
                            {
                                ...
                                global::G.ErrorMessage? __value_410 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_410 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_410 = global::G.ErrorMessage.FromJson(__content_410, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_410 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.LocalRunnerHeartbeatResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.LocalRunnerHeartbeatResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.LocalRunnerHeartbeatResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
