...
{
    /// <inheritdoc />
    public sealed class ExperimentRunSummaryPublicStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ExperimentRunSummaryPublicStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ExperimentRunSummaryPublicStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
