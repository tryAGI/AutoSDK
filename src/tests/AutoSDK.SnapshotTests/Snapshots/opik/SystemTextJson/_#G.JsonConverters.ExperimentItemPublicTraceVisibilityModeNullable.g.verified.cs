...
{
    /// <inheritdoc />
    public sealed class ExperimentItemPublicTraceVisibilityModeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ExperimentItemPublicTraceVisibilityMode?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ExperimentItemPublicTraceVisibilityModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
