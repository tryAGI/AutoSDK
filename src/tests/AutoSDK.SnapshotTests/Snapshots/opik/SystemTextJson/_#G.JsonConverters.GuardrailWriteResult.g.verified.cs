...
{
    /// <inheritdoc />
    public sealed class GuardrailWriteResultJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GuardrailWriteResult>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GuardrailWriteResultExtensions.ToValueString(value));
        }
    }
}
