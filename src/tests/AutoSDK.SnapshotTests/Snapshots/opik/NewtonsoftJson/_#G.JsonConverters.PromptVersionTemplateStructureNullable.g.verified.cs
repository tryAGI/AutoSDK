...
{
    /// <inheritdoc />
    public sealed class PromptVersionTemplateStructureNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PromptVersionTemplateStructure?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PromptVersionTemplateStructureExtensions.ToValueString(value.Value));
            }
        }
    }
}
