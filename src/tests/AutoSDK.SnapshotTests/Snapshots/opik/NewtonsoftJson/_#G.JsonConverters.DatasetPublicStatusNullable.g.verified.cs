...
{
    /// <inheritdoc />
    public sealed class DatasetPublicStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DatasetPublicStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DatasetPublicStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
