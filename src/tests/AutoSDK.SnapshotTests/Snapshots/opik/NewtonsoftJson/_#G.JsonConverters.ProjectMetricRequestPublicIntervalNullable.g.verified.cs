...
{
    /// <inheritdoc />
    public sealed class ProjectMetricRequestPublicIntervalNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProjectMetricRequestPublicInterval?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProjectMetricRequestPublicIntervalExtensions.ToValueString(value.Value));
            }
        }
    }
}
