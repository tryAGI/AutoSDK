...
{
    /// <inheritdoc />
    public sealed class ExperimentItemCompareStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExperimentItemCompareStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExperimentItemCompareStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
