...
{
    /// <inheritdoc />
    public sealed class FeedbackPublicDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FeedbackPublicDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.FeedbackPublicDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
