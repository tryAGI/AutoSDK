...
{
    /// <inheritdoc />
    public sealed class FeedbackCreateDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FeedbackCreateDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.FeedbackCreateDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
