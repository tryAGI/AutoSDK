...
{
    /// <inheritdoc />
    public sealed class DatasetItemPublicSourceNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DatasetItemPublicSource?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DatasetItemPublicSourceExtensions.ToValueString(value.Value));
            }
        }
    }
}
