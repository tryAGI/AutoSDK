...
{
    /// <inheritdoc />
    public sealed class GuardrailWriteResultNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GuardrailWriteResult?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GuardrailWriteResultExtensions.ToValueString(value.Value));
            }
        }
    }
}
