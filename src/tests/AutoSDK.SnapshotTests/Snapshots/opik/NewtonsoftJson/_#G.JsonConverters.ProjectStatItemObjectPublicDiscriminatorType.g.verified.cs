...
{
    /// <inheritdoc />
    public sealed class ProjectStatItemObjectPublicDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProjectStatItemObjectPublicDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ProjectStatItemObjectPublicDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
