...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AutomationRuleEvaluatorDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AutomationRuleEvaluatorDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
