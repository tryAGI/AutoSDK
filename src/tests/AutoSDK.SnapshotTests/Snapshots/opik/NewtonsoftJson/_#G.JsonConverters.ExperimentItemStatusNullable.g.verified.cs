...
{
    /// <inheritdoc />
    public sealed class ExperimentItemStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExperimentItemStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExperimentItemStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
