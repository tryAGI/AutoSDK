...
{
    /// <inheritdoc />
    public sealed class TraceFilterOperatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TraceFilterOperator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TraceFilterOperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
