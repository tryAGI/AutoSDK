...
{
    /// <inheritdoc />
    public sealed class AlertTriggerConfigPublicTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AlertTriggerConfigPublicType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AlertTriggerConfigPublicTypeExtensions.ToValueString(value));
        }
    }
}
