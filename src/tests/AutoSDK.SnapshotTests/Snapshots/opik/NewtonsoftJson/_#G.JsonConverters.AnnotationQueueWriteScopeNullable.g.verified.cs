...
{
    /// <inheritdoc />
    public sealed class AnnotationQueueWriteScopeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AnnotationQueueWriteScope?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AnnotationQueueWriteScopeExtensions.ToValueString(value.Value));
            }
        }
    }
}
