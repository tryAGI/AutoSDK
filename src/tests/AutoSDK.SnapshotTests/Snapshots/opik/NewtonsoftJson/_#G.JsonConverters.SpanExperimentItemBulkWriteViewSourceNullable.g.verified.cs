...
{
    /// <inheritdoc />
    public sealed class SpanExperimentItemBulkWriteViewSourceNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SpanExperimentItemBulkWriteViewSource?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SpanExperimentItemBulkWriteViewSourceExtensions.ToValueString(value.Value));
            }
        }
    }
}
