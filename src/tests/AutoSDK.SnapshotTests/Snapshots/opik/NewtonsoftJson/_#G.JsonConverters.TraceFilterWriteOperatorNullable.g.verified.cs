...
{
    /// <inheritdoc />
    public sealed class TraceFilterWriteOperatorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TraceFilterWriteOperator?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TraceFilterWriteOperatorExtensions.ToValueString(value.Value));
            }
        }
    }
}
