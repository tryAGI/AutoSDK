...
namespace G
{
    public partial class AttachmentsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            {
                global::G.DownloadAttachmentEntityType.Trace => "trace",
                global::G.DownloadAttachmentEntityType.Span => "span",
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_403 = global::Newtonsoft.Json.JsonConvert.DeserializeObject<byte[]?>(__content_403, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
