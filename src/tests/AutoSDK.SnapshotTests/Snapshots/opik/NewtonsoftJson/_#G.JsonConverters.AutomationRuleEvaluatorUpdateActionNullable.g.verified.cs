...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorUpdateActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AutomationRuleEvaluatorUpdateAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AutomationRuleEvaluatorUpdateActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
