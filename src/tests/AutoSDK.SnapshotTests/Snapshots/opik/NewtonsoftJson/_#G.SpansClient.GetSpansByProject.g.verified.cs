//HintName: G.SpansClient.GetSpansByProject.g.cs
...
namespace G
{
    public partial class SpansClient
    {
        ...
        private static readonly global::G.AutoSDKServer[] s_GetSpansByProjectServers = new global::G.AutoSDKServer[]
        ...
        partial void PrepareGetSpansByProjectArguments(
            ...
            ref global::G.GetSpansByProjectType? type,
            ref string? filters,
            ref bool? truncate,
        ...
        partial void PrepareGetSpansByProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessGetSpansByProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetSpansByProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.SpanPagePublic> GetSpansByProjectAsync(
            int? page = default,
            int? size = default,
        ...
        {
            var __response = await GetSpansByProjectAsResponseAsync(
                page: page,
                size: size,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.SpanPagePublic>> GetSpansByProjectAsResponseAsync(
            int? page = default,
            int? size = default,
            string? projectName = default,
            global::System.Guid? projectId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetSpansByProjectArguments(
            ...
            {
                global::G.GetSpansByProjectType.General => "general",
                global::G.GetSpansByProjectType.Tool => "tool",
                global::G.GetSpansByProjectType.Llm => "llm",
                global::G.GetSpansByProjectType.Guardrail => "guardrail",
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                ...
                                servers: s_GetSpansByProjectServers,
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetSpansByProjectRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetSpansByProjectAsync",
                                pathTemplate: "\"/v1/private/spans\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetSpansByProjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetSpansByProjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.SpanPagePublic.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.SpanPagePublic>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.SpanPagePublic.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
