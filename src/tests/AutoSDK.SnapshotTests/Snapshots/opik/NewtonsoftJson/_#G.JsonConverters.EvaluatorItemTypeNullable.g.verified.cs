...
{
    /// <inheritdoc />
    public sealed class EvaluatorItemTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EvaluatorItemType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EvaluatorItemTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
