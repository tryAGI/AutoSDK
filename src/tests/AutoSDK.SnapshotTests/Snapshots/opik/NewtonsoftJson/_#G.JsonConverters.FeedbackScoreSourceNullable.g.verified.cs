...
{
    /// <inheritdoc />
    public sealed class FeedbackScoreSourceNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FeedbackScoreSource?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FeedbackScoreSourceExtensions.ToValueString(value.Value));
            }
        }
    }
}
