...
{
    /// <inheritdoc />
    public sealed class ProviderApiKeyWriteProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProviderApiKeyWriteProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProviderApiKeyWriteProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
