...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorObjectObjectPublicActionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AutomationRuleEvaluatorObjectObjectPublicAction?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AutomationRuleEvaluatorObjectObjectPublicActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
