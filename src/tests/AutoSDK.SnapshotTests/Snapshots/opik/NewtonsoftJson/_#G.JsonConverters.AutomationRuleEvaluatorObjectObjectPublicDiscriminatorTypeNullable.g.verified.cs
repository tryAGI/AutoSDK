...
{
    /// <inheritdoc />
    public sealed class AutomationRuleEvaluatorObjectObjectPublicDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AutomationRuleEvaluatorObjectObjectPublicDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AutomationRuleEvaluatorObjectObjectPublicDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
