//HintName: G.IFeedbackDefinitionsClient.DeleteFeedbackDefinitionById.g.cs
#nullable enable
...
namespace G
{
    public partial interface IFeedbackDefinitionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse> DeleteFeedbackDefinitionByIdAsResponseAsync(
            global::System.Guid id,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
