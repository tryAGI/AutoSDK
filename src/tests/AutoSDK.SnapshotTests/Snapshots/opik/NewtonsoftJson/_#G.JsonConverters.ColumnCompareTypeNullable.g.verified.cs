...
{
    /// <inheritdoc />
    public sealed class ColumnCompareTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ColumnCompareType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ColumnCompareTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
