...
{
    /// <inheritdoc />
    public sealed class EvaluatorItemPublicTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.EvaluatorItemPublicType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.EvaluatorItemPublicTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
