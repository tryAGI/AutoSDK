//HintName: G.DeepgramInlinePayloadsListenV1RealtimeClient.ReceiveUpdates.g.cs

#nullable enable

namespace G
{
    public sealed partial class DeepgramInlinePayloadsListenV1RealtimeClient
    {
        /// <summary>
            ...
            string rawText)
        {
            ...
            if (@event.Results is { } __ResultsReceived)
            {
                ResultsReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.ListenV1Results>(
                        __ResultsReceived,
                        rawText,
                        json));
            }
            if (@event.Metadata is { } __MetadataReceived)
            {
                MetadataReceived?.Invoke(
                    this,
                    new AutoSDKWebSocketMessageEventArgs<global::G.ListenV1Metadata>(
                        __MetadataReceived,
                        rawText,
                        json));
            }
