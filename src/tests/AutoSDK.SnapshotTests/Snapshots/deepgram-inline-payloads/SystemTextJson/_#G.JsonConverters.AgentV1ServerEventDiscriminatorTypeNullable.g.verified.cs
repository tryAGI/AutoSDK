...
{
    /// <inheritdoc />
    public sealed class AgentV1ServerEventDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AgentV1ServerEventDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AgentV1ServerEventDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
