...
{
    /// <inheritdoc />
    public sealed class PredictionHistoryItemRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PredictionHistoryItemRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PredictionHistoryItemRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
