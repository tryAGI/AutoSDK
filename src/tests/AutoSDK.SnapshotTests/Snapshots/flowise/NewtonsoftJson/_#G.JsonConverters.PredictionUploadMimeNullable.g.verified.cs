...
{
    /// <inheritdoc />
    public sealed class PredictionUploadMimeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PredictionUploadMime?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PredictionUploadMimeExtensions.ToValueString(value.Value));
            }
        }
    }
}
