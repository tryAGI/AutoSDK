...
{
    /// <inheritdoc />
    public sealed class DocumentStoreLoaderFileStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DocumentStoreLoaderFileStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DocumentStoreLoaderFileStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
