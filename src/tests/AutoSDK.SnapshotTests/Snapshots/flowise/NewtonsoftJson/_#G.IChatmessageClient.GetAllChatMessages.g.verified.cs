...
namespace G
{
    public partial interface IChatmessageClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.ChatMessage>>> GetAllChatMessagesAsResponseAsync(
            string id,
            global::G.GetAllChatMessagesChatType? chatType = default,
            global::G.GetAllChatMessagesOrder? order = default,
            string? chatId = default,
