...
namespace G
{
    public partial interface IUpsertHistoryClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::G.UpsertHistoryResponse>>> GetAllUpsertHistoryAsResponseAsync(
            string id,
            global::G.GetAllUpsertHistoryOrder? order = default,
            global::System.DateTime? startDate = default,
            global::System.DateTime? endDate = default,
