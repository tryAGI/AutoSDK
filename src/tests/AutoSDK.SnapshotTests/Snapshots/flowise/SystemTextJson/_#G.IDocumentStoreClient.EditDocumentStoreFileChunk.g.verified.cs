...
namespace G
{
    public partial interface IDocumentStoreClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DocumentStoreFileChunkPagedResponse>> EditDocumentStoreFileChunkAsResponseAsync(
            string storeId,
            string loaderId,
            string chunkId,
