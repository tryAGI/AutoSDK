...
{
    /// <inheritdoc />
    public sealed class SingleSeriesForecastFinetuneLossNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SingleSeriesForecastFinetuneLoss?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.SingleSeriesForecastFinetuneLossExtensions.ToValueString(value.Value));
            }
        }
    }
}
