//HintName: G.ExcludedClient.TimegptMultiSeries.g.cs
...
namespace G
{
    public partial class ExcludedClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TimegptMultiSeriesSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_TimegptMultiSeriesSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_TimegptMultiSeriesSecurityRequirement0,
            };
        partial void PrepareTimegptMultiSeriesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.MultiSeriesForecast request);
        partial void PrepareTimegptMultiSeriesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.MultiSeriesForecast request);
        partial void ProcessTimegptMultiSeriesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTimegptMultiSeriesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Foundational Time Series Model Multi Series (Beta)<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> TimegptMultiSeriesAsync(

            global::G.MultiSeriesForecast request,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await TimegptMultiSeriesAsResponseAsync(
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> TimegptMultiSeriesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTimegptMultiSeriesArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TimegptMultiSeriesSecurityRequirements,
                operationName: "TimegptMultiSeriesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTimegptMultiSeriesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TimegptMultiSeries",
                                methodName: "TimegptMultiSeriesAsync",
                                pathTemplate: "\"/timegpt_multi_series\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTimegptMultiSeriesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTimegptMultiSeriesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await TimegptMultiSeriesAsync(
                request: __request,
                requestOptions: requestOptions,
