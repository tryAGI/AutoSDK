//HintName: G.ExcludedClient.TimegptMultiSeriesAnomalies.g.cs
...
namespace G
{
    public partial class ExcludedClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TimegptMultiSeriesAnomaliesSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_TimegptMultiSeriesAnomaliesSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_TimegptMultiSeriesAnomaliesSecurityRequirement0,
            };
        partial void PrepareTimegptMultiSeriesAnomaliesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::G.MultiSeriesAnomaly request);
        partial void PrepareTimegptMultiSeriesAnomaliesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::G.MultiSeriesAnomaly request);
        partial void ProcessTimegptMultiSeriesAnomaliesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTimegptMultiSeriesAnomaliesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Foundational Time Series Model Multi Series Anomaly Detector (Beta)<br/>
        ...
        public async global::System.Threading.Tasks.Task<string> TimegptMultiSeriesAnomaliesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTimegptMultiSeriesAnomaliesArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TimegptMultiSeriesAnomaliesSecurityRequirements,
                operationName: "TimegptMultiSeriesAnomaliesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTimegptMultiSeriesAnomaliesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TimegptMultiSeriesAnomalies",
                                methodName: "TimegptMultiSeriesAnomaliesAsync",
                                pathTemplate: "\"/timegpt_multi_series_anomalies\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTimegptMultiSeriesAnomaliesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTimegptMultiSeriesAnomaliesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> TimegptMultiSeriesAnomaliesAsync(
            ...
            string? freq = default,
            global::System.Collections.Generic.IList<object>? level = default,
            object? y = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.MultiSeriesAnomaly
            {
                Model = model,
                Freq = freq,
                Level = level,
            ...
            return await TimegptMultiSeriesAnomaliesAsync(
                request: __request,
                requestOptions: requestOptions,
