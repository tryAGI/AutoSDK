//HintName: G.Models.MultiSeriesCrossValidation.g.cs
...
namespace G
{
    ...
    public sealed partial class MultiSeriesCrossValidation
    {
        ...
        [global::System.Obsolete("This property marked as deprecated.")]
        public global::G.MultiSeriesCrossValidationFewshotLoss2? FewshotLoss { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.MultiSeriesCrossValidationFinetuneLossJsonConverter))]
        public global::G.MultiSeriesCrossValidationFinetuneLoss? FinetuneLoss { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiSeriesCrossValidation" /> class.
        /// </summary>
        /// <param name="model">
        /// Model to use as a string. Common options are (but not restricted to) `timegpt-1` and `timegpt-1-long-horizon.` Full options vary by different users. Contact support@nixtla.io for more information. We recommend using `timegpt-1-long-horizon` for forecasting if you want to predict more than one seasonal period given the frequency of your data.<br/>
        /// Default Value: timegpt-1
...
#endif
        public MultiSeriesCrossValidation(
            object? model,
            string? freq,
            ...
            bool? cleanExFirst,
            int? finetuneSteps,
            global::G.MultiSeriesCrossValidationFinetuneLoss? finetuneLoss)
        {
            this.Model = model;
            this.Freq = freq;
            this.Level = level;
