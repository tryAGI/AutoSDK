...
namespace G
{
    public partial class ExcludedClient
    {
        ...
        {
            var __response = await TimegptMultiSeriesCrossValidationAsResponseAsync(
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> TimegptMultiSeriesCrossValidationAsResponseAsync(
