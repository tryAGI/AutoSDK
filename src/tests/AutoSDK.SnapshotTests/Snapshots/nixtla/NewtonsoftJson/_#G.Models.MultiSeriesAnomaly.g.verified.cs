//HintName: G.Models.MultiSeriesAnomaly.g.cs
...
namespace G
{
    ...
    public sealed partial class MultiSeriesAnomaly
    {
        ...
        public global::System.Collections.Generic.IList<object>? Level { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MultiSeriesAnomaly" /> class.
        /// </summary>
        /// <param name="model">
        /// Model to use as a string. Common options are (but not restricted to) `timegpt-1` and `timegpt-1-long-horizon.` Full options vary by different users. Contact support@nixtla.io for more information. We recommend using `timegpt-1-long-horizon` for forecasting if you want to predict more than one seasonal period given the frequency of your data.<br/>
        /// Default Value: timegpt-1
        ...
        public MultiSeriesAnomaly(
            object? model,
            string? freq,
            global::System.Collections.Generic.IList<object>? level,
            object? y,
