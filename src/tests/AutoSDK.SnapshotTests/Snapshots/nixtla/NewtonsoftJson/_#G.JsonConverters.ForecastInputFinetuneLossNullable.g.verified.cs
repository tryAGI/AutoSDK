...
{
    /// <inheritdoc />
    public sealed class ForecastInputFinetuneLossNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ForecastInputFinetuneLoss?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ForecastInputFinetuneLossExtensions.ToValueString(value.Value));
            }
        }
    }
}
