...
{
    /// <inheritdoc />
    public sealed class SingleSeriesForecastFinetuneLossJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SingleSeriesForecastFinetuneLoss>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SingleSeriesForecastFinetuneLossExtensions.ToValueString(value));
        }
    }
}
