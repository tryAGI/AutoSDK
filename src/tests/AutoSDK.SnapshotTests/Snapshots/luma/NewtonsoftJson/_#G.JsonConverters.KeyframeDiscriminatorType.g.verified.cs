...
{
    /// <inheritdoc />
    public sealed class KeyframeDiscriminatorTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.KeyframeDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.KeyframeDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
