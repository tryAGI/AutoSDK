...
{
    /// <inheritdoc />
    public sealed class InputAudioBufferCommittedEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InputAudioBufferCommittedEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.InputAudioBufferCommittedEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
