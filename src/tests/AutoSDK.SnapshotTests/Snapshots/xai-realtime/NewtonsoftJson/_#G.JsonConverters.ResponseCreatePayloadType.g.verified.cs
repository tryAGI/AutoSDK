...
{
    /// <inheritdoc />
    public sealed class ResponseCreatePayloadTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseCreatePayloadType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ResponseCreatePayloadTypeExtensions.ToValueString(value));
        }
    }
}
