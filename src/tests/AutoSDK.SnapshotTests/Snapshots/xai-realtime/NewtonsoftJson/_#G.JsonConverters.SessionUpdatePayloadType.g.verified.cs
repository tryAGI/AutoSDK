...
{
    /// <inheritdoc />
    public sealed class SessionUpdatePayloadTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SessionUpdatePayloadType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SessionUpdatePayloadTypeExtensions.ToValueString(value));
        }
    }
}
