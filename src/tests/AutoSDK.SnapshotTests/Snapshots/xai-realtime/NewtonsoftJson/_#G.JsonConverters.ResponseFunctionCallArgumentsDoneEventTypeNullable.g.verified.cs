...
{
    /// <inheritdoc />
    public sealed class ResponseFunctionCallArgumentsDoneEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseFunctionCallArgumentsDoneEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseFunctionCallArgumentsDoneEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
