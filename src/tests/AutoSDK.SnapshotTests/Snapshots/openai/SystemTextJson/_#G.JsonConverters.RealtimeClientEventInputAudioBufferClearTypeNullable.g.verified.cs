...
{
    /// <inheritdoc />
    public sealed class RealtimeClientEventInputAudioBufferClearTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RealtimeClientEventInputAudioBufferClearType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RealtimeClientEventInputAudioBufferClearTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
