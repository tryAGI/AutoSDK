...
namespace G.JsonConverters
{
    ...
    public class ResponseStreamEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseStreamEvent>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (discriminator?.Type == "response.code_interpreter_call_code.delta")
            {
            ...
            if (discriminator?.Type == "response.code_interpreter_call_code.done")
            {
            ...
            if (discriminator?.Type == "response.reasoning_summary_part.added")
            {
            ...
            if (discriminator?.Type == "response.reasoning_summary_part.done")
            {
            ...
            if (discriminator?.Type == "response.reasoning_summary_text.delta")
            {
            ...
            if (discriminator?.Type == "response.reasoning_summary_text.done")
            {
            ...
            if (discriminator?.Type == "response.image_generation_call.completed")
            {
            ...
            if (discriminator?.Type == "response.image_generation_call.generating")
            {
            ...
            if (discriminator?.Type == "response.image_generation_call.in_progress")
            {
            ...
            if (discriminator?.Type == "response.image_generation_call.partial_image")
            {
            ...
            if (discriminator?.Type == "response.mcp_call.arguments_delta")
            {
            ...
            if (discriminator?.Type == "response.mcp_call.arguments_done")
            {
            ...
            if (discriminator?.Type == "response.mcp_call.completed")
            {
            ...
            if (discriminator?.Type == "response.mcp_call.failed")
            {
            ...
            if (discriminator?.Type == "response.mcp_call.in_progress")
            {
            ...
            if (discriminator?.Type == "response.mcp_list_tools.completed")
            {
            ...
            if (discriminator?.Type == "response.mcp_list_tools.failed")
            {
            ...
            if (discriminator?.Type == "response.mcp_list_tools.in_progress")
            {
            ...
            if (discriminator?.Type == "response.output_text_annotation.added")
            {
            ...
            if (discriminator?.Type == "response.queued")
            {
            ...
            if (discriminator?.Type == "response.reasoning.delta")
            {
            ...
            if (discriminator?.Type == "response.reasoning.done")
            {
            ...
            if (discriminator?.Type == "response.reasoning_summary.delta")
            {
            ...
            if (discriminator?.Type == "response.reasoning_summary.done")
            {
