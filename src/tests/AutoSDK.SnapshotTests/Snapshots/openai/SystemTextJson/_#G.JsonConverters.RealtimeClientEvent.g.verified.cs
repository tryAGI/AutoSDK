...
namespace G.JsonConverters
{
    ...
    public class RealtimeClientEventJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RealtimeClientEvent>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.RealtimeClientEventDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.RealtimeClientEventDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.RealtimeClientEventDiscriminator)}");
            ...
            if (discriminator?.Type == "transcription_session.update")
            {
                ...
                transcriptionSessionUpdate = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }
