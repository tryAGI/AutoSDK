...
{
    /// <inheritdoc />
    public sealed class RealtimeServerEventResponseContentPartDonePartTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RealtimeServerEventResponseContentPartDonePartType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RealtimeServerEventResponseContentPartDonePartTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
