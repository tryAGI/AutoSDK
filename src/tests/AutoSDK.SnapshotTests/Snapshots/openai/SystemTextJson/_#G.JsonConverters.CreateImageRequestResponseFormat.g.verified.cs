//HintName: G.JsonConverters.CreateImageRequestResponseFormat.g.cs
#nullable enable
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.CreateImageRequestResponseFormatExtensions.ToEnum(stringValue) ?? default;
                    }
                ...
                {
                    return default(global::G.CreateImageRequestResponseFormat);
                }
                default:
