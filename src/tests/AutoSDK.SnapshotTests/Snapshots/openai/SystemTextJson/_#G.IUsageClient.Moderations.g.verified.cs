//HintName: G.IUsageClient.Moderations.g.cs
#nullable enable
...
namespace G
{
    public partial interface IUsageClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.UsageResponse> ModerationsAsync(
            int startTime,
            int? endTime = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.UsageResponse>> ModerationsAsResponseAsync(
            int startTime,
            int? endTime = default,
            global::G.UsageModerationsBucketWidth? bucketWidth = default,
            global::System.Collections.Generic.IList<string>? projectIds = default,
