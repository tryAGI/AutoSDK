...
{
    /// <inheritdoc />
    public sealed class UrlCitationBodyTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UrlCitationBodyType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.UrlCitationBodyTypeExtensions.ToValueString(value));
        }
    }
}
