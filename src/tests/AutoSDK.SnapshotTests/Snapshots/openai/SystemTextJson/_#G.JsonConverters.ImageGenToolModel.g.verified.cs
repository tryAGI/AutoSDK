...
{
    /// <inheritdoc />
    public sealed class ImageGenToolModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ImageGenToolModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ImageGenToolModelExtensions.ToValueString(value));
        }
    }
}
