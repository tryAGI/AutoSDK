...
namespace G
{
    public partial class UploadsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CancelUploadSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CancelUploadSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Upload>> CancelUploadAsResponseAsync(
            string uploadId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Upload.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Upload.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
