...
{
    /// <inheritdoc />
    public sealed class ContainerResourceExpiresAfterAnchorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ContainerResourceExpiresAfterAnchor>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ContainerResourceExpiresAfterAnchorExtensions.ToValueString(value));
        }
    }
}
