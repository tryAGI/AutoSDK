...
namespace G
{
    public partial class VectorStoresClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchVectorStoreSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_SearchVectorStoreSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        {
            var __response = await SearchVectorStoreAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.VectorStoreSearchResultsPage>> SearchVectorStoreAsResponseAsync(
            string vectorStoreId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SearchVectorStoreAsync",
                                pathTemplate: "$\"/vector_stores/{vectorStoreId}/search\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.VectorStoreSearchResultsPage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.VectorStoreSearchResultsPage>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.VectorStoreSearchResultsPage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
