...
namespace G.JsonConverters
{
    ...
    public class ChatCompletionRequestAssistantMessageContentPartJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatCompletionRequestAssistantMessageContentPart>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        refusalContentPart = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ChatCompletionRequestMessageContentPartRefusal>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (textContentPart == null && refusalContentPart == null)
            {
                try
                {
                    textContentPart = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ChatCompletionRequestMessageContentPartText>(__rawJson, options);
            ...
            var __value = new global::G.ChatCompletionRequestAssistantMessageContentPart(
                textContentPart,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.RefusalContentPart, typeof(global::G.ChatCompletionRequestMessageContentPartRefusal), options);
            }
        }
    }
}