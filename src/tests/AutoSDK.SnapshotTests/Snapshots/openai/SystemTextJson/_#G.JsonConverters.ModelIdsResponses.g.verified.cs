...
namespace G.JsonConverters
{
    ...
    public class ModelIdsResponsesJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ModelIdsResponses>
    {
            ...
            if (__bestIndex >= 0)
            {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        responsesOnlyModel = global::System.Text.Json.JsonSerializer.Deserialize<global::G.ModelIdsResponsesEnum>(__rawJson, options);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ResponsesOnlyModel, typeof(global::G.ModelIdsResponsesEnum), options);
            }
        }
    }
}