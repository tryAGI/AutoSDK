...
{
    /// <inheritdoc />
    public sealed class RealtimeClientEventDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.RealtimeClientEventDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.RealtimeClientEventDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
