...
{
    /// <inheritdoc />
    public sealed class ResponseAudioDoneEventTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ResponseAudioDoneEventType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ResponseAudioDoneEventTypeExtensions.ToValueString(value));
        }
    }
}
