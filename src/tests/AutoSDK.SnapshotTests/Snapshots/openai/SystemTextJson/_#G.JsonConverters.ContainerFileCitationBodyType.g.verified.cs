...
{
    /// <inheritdoc />
    public sealed class ContainerFileCitationBodyTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ContainerFileCitationBodyType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ContainerFileCitationBodyTypeExtensions.ToValueString(value));
        }
    }
}
