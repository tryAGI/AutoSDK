...
{
    /// <inheritdoc />
    public sealed class CodeInterpreterToolTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CodeInterpreterToolType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CodeInterpreterToolTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
