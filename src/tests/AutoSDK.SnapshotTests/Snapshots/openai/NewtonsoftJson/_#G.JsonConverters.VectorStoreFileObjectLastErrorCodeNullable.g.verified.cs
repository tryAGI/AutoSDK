...
{
    /// <inheritdoc />
    public sealed class VectorStoreFileObjectLastErrorCodeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VectorStoreFileObjectLastErrorCode?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VectorStoreFileObjectLastErrorCodeExtensions.ToValueString(value.Value));
            }
        }
    }
}
