...
{
    /// <inheritdoc />
    public sealed class RealtimeSessionTurnDetectionTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeSessionTurnDetectionType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RealtimeSessionTurnDetectionTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
