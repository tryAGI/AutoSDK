...
{
    /// <inheritdoc />
    public sealed class ChatCompletionRequestSystemMessageRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionRequestSystemMessageRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ChatCompletionRequestSystemMessageRoleExtensions.ToValueString(value));
        }
    }
}
