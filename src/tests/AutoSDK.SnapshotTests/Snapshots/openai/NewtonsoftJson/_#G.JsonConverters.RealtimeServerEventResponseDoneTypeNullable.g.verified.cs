...
{
    /// <inheritdoc />
    public sealed class RealtimeServerEventResponseDoneTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeServerEventResponseDoneType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RealtimeServerEventResponseDoneTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
