//HintName: G.IRealtimeClient.CreateSession.g.cs
#nullable enable
...
namespace G
{
    public partial interface IRealtimeClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.RealtimeSessionCreateResponse> CreateSessionAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RealtimeSessionCreateResponse>> CreateSessionAsResponseAsync(
