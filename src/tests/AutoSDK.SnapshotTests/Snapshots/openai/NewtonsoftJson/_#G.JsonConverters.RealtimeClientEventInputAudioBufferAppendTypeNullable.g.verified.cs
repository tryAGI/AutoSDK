...
{
    /// <inheritdoc />
    public sealed class RealtimeClientEventInputAudioBufferAppendTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeClientEventInputAudioBufferAppendType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RealtimeClientEventInputAudioBufferAppendTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
