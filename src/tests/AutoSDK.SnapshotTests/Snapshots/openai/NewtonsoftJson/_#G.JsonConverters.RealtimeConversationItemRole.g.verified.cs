...
{
    /// <inheritdoc />
    public sealed class RealtimeConversationItemRoleJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeConversationItemRole>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RealtimeConversationItemRoleExtensions.ToValueString(value));
        }
    }
}
