...
{
    /// <inheritdoc />
    public sealed class CreateImageVariationRequestModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateImageVariationRequestModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateImageVariationRequestModelExtensions.ToValueString(value));
        }
    }
}
