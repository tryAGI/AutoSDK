...
{
    /// <inheritdoc />
    public sealed class RealtimeResponseStatusDetailsReasonJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeResponseStatusDetailsReason>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RealtimeResponseStatusDetailsReasonExtensions.ToValueString(value));
        }
    }
}
