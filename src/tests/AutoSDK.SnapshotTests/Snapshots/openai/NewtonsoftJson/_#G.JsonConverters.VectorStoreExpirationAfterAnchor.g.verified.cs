...
{
    /// <inheritdoc />
    public sealed class VectorStoreExpirationAfterAnchorJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VectorStoreExpirationAfterAnchor>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.VectorStoreExpirationAfterAnchorExtensions.ToValueString(value));
        }
    }
}
