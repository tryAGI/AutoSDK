...
{
    /// <inheritdoc />
    public sealed class RunStepDetailsToolCallsFileSearchResultObjectContentItemTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RunStepDetailsToolCallsFileSearchResultObjectContentItemType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RunStepDetailsToolCallsFileSearchResultObjectContentItemTypeExtensions.ToValueString(value));
        }
    }
}
