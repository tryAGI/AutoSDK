...
{
    /// <inheritdoc />
    public sealed class RunObjectIncompleteDetailsReasonNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RunObjectIncompleteDetailsReason?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RunObjectIncompleteDetailsReasonExtensions.ToValueString(value.Value));
            }
        }
    }
}
