...
{
    /// <inheritdoc />
    public sealed class ResponsePropertiesTruncationNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponsePropertiesTruncation?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponsePropertiesTruncationExtensions.ToValueString(value.Value));
            }
        }
    }
}
