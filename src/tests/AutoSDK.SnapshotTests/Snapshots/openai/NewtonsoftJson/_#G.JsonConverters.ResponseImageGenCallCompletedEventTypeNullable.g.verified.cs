...
{
    /// <inheritdoc />
    public sealed class ResponseImageGenCallCompletedEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseImageGenCallCompletedEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseImageGenCallCompletedEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
