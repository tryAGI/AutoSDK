...
namespace G
{
    ...
    public readonly partial struct OutputContent : global::System.IEquatable<OutputContent>
    {
...
#endif
            out global::G.OutputTextContent? value)
        {
            value = OutputText;
            return IsOutputText;
        }
        ...
        /// 
        /// </summary>
        public global::G.OutputTextContent PickOutputText() => IsOutputText
            ? OutputText!
        ...
        public bool TryPickRefusal(
            ...
            [global::System.Diagnostics.CodeAnalysis.NotNullWhen(true)]
#endif
            out global::G.RefusalContent? value)
        {
            value = Refusal;
            return IsRefusal;
        }
        ...
        /// 
        /// </summary>
        public global::G.RefusalContent PickRefusal() => IsRefusal
            ? Refusal!
