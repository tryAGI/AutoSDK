...
{
    /// <inheritdoc />
    public sealed class CreateEvalCompletionsRunDataSourceTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateEvalCompletionsRunDataSourceType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateEvalCompletionsRunDataSourceTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
