...
{
    /// <inheritdoc />
    public sealed class FineTuneDPOHyperparametersBetaNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FineTuneDPOHyperparametersBeta?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FineTuneDPOHyperparametersBetaExtensions.ToValueString(value.Value));
            }
        }
    }
}
