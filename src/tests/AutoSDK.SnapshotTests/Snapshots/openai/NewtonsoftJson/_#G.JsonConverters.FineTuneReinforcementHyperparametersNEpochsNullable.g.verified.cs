...
{
    /// <inheritdoc />
    public sealed class FineTuneReinforcementHyperparametersNEpochsNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FineTuneReinforcementHyperparametersNEpochs?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FineTuneReinforcementHyperparametersNEpochsExtensions.ToValueString(value.Value));
            }
        }
    }
}
