...
{
    /// <inheritdoc />
    public sealed class MessageContentImageUrlObjectTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MessageContentImageUrlObjectType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.MessageContentImageUrlObjectTypeExtensions.ToValueString(value));
        }
    }
}
