...
{
    /// <inheritdoc />
    public sealed class CreateImageEditRequestBackgroundJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateImageEditRequestBackground>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateImageEditRequestBackgroundExtensions.ToValueString(value));
        }
    }
}
