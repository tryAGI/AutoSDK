...
{
    /// <inheritdoc />
    public sealed class RealtimeSessionModalitieNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeSessionModalitie?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RealtimeSessionModalitieExtensions.ToValueString(value.Value));
            }
        }
    }
}
