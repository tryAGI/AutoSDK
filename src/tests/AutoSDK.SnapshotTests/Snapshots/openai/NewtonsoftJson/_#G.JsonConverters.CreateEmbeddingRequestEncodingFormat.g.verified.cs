...
{
    /// <inheritdoc />
    public sealed class CreateEmbeddingRequestEncodingFormatJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateEmbeddingRequestEncodingFormat>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateEmbeddingRequestEncodingFormatExtensions.ToValueString(value));
        }
    }
}
