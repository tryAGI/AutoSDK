...
{
    /// <inheritdoc />
    public sealed class CreateContainerBodyExpiresAfterAnchorJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateContainerBodyExpiresAfterAnchor>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateContainerBodyExpiresAfterAnchorExtensions.ToValueString(value));
        }
    }
}
