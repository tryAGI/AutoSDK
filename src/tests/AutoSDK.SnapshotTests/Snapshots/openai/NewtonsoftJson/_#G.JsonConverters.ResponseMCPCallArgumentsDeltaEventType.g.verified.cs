...
{
    /// <inheritdoc />
    public sealed class ResponseMCPCallArgumentsDeltaEventTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseMCPCallArgumentsDeltaEventType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ResponseMCPCallArgumentsDeltaEventTypeExtensions.ToValueString(value));
        }
    }
}
