...
{
    /// <inheritdoc />
    public sealed class CreateTranslationRequestResponseFormatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTranslationRequestResponseFormat?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTranslationRequestResponseFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
