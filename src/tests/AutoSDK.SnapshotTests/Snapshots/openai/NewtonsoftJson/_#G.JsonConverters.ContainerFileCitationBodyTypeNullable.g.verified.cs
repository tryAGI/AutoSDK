...
{
    /// <inheritdoc />
    public sealed class ContainerFileCitationBodyTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ContainerFileCitationBodyType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ContainerFileCitationBodyTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
