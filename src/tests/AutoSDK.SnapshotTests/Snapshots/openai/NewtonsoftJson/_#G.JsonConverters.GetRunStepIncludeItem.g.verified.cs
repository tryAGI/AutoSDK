...
{
    /// <inheritdoc />
    public sealed class GetRunStepIncludeItemJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetRunStepIncludeItem>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GetRunStepIncludeItemExtensions.ToValueString(value));
        }
    }
}
