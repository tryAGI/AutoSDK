...
{
    /// <inheritdoc />
    public sealed class ResponseWebSearchCallSearchingEventTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ResponseWebSearchCallSearchingEventType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ResponseWebSearchCallSearchingEventTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
