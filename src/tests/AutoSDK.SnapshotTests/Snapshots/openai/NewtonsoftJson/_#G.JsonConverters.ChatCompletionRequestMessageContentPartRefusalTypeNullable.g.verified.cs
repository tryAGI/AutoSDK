...
{
    /// <inheritdoc />
    public sealed class ChatCompletionRequestMessageContentPartRefusalTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionRequestMessageContentPartRefusalType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatCompletionRequestMessageContentPartRefusalTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
