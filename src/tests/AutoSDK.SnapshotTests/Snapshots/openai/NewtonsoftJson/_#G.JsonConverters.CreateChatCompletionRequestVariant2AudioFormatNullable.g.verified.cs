...
{
    /// <inheritdoc />
    public sealed class CreateChatCompletionRequestVariant2AudioFormatNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateChatCompletionRequestVariant2AudioFormat?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateChatCompletionRequestVariant2AudioFormatExtensions.ToValueString(value.Value));
            }
        }
    }
}
