...
namespace G
{
    public partial class UploadsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CompleteUploadSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CompleteUploadSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        {
            var __response = await CompleteUploadAsResponseAsync(
                uploadId: uploadId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Upload>> CompleteUploadAsResponseAsync(
            string uploadId,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CompleteUploadAsync",
                                pathTemplate: "$\"/uploads/{uploadId}/complete\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.Upload.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.Upload>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.Upload.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
