...
{
    /// <inheritdoc />
    public sealed class RealtimeClientEventInputAudioBufferClearTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeClientEventInputAudioBufferClearType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RealtimeClientEventInputAudioBufferClearTypeExtensions.ToValueString(value));
        }
    }
}
