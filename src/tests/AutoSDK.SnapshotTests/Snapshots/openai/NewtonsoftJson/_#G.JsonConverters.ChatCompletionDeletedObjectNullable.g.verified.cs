...
{
    /// <inheritdoc />
    public sealed class ChatCompletionDeletedObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatCompletionDeletedObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatCompletionDeletedObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
