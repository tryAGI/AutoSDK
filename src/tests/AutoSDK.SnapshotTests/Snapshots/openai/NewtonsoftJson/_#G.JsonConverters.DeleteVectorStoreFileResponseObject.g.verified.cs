...
{
    /// <inheritdoc />
    public sealed class DeleteVectorStoreFileResponseObjectJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeleteVectorStoreFileResponseObject>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.DeleteVectorStoreFileResponseObjectExtensions.ToValueString(value));
        }
    }
}
