//HintName: G.ProjectsClient.ModifyProjectRateLimit.g.cs
...
namespace G
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_ModifyProjectRateLimitSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_ModifyProjectRateLimitSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
        ...
        partial void PrepareModifyProjectRateLimitRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string rateLimitId,
            global::G.ProjectRateLimitUpdateRequest request);
        partial void ProcessModifyProjectRateLimitResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::G.ProjectRateLimit> ModifyProjectRateLimitAsync(
            string projectId,
            string rateLimitId,
        ...
        {
            var __response = await ModifyProjectRateLimitAsResponseAsync(
                projectId: projectId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.ProjectRateLimit>> ModifyProjectRateLimitAsResponseAsync(
            string projectId,
            string rateLimitId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareModifyProjectRateLimitArguments(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModifyProjectRateLimit",
                                methodName: "ModifyProjectRateLimitAsync",
                                pathTemplate: "$\"/organization/projects/{projectId}/rate_limits/{rateLimitId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModifyProjectRateLimitResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModifyProjectRateLimitResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.ProjectRateLimit.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.ProjectRateLimit>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.ProjectRateLimit.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ModifyProjectRateLimitAsync(
                projectId: projectId,
                rateLimitId: rateLimitId,
                request: __request,
                requestOptions: requestOptions,
