...
{
    /// <inheritdoc />
    public sealed class UsageCompletionsGroupByItemJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UsageCompletionsGroupByItem>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.UsageCompletionsGroupByItemExtensions.ToValueString(value));
        }
    }
}
