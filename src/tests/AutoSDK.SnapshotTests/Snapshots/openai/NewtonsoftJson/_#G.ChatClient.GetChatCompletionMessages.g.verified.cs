            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.ChatCompletionMessageList.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.ChatCompletionMessageList.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
