...
{
    /// <inheritdoc />
    public sealed class ContainerResourceExpiresAfterAnchorNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ContainerResourceExpiresAfterAnchor?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ContainerResourceExpiresAfterAnchorExtensions.ToValueString(value.Value));
            }
        }
    }
}
