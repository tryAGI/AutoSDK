...
{
    /// <inheritdoc />
    public sealed class ListFilesInVectorStoreBatchFilterNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ListFilesInVectorStoreBatchFilter?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ListFilesInVectorStoreBatchFilterExtensions.ToValueString(value.Value));
            }
        }
    }
}
