...
{
    /// <inheritdoc />
    public sealed class RealtimeServerEventInputAudioBufferSpeechStartedTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeServerEventInputAudioBufferSpeechStartedType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.RealtimeServerEventInputAudioBufferSpeechStartedTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
