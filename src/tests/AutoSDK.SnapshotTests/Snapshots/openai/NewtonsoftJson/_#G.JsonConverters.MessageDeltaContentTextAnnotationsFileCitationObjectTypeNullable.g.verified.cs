...
{
    /// <inheritdoc />
    public sealed class MessageDeltaContentTextAnnotationsFileCitationObjectTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.MessageDeltaContentTextAnnotationsFileCitationObjectType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.MessageDeltaContentTextAnnotationsFileCitationObjectTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
