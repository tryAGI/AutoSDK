...
{
    /// <inheritdoc />
    public sealed class RealtimeSessionCreateRequestClientSecretExpiresAtAnchorJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RealtimeSessionCreateRequestClientSecretExpiresAtAnchor>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RealtimeSessionCreateRequestClientSecretExpiresAtAnchorExtensions.ToValueString(value));
        }
    }
}
