...
{
    /// <inheritdoc />
    public sealed class ImageGenToolBackgroundJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ImageGenToolBackground>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ImageGenToolBackgroundExtensions.ToValueString(value));
        }
    }
}
