...
{
    /// <inheritdoc />
    public sealed class ProjectServiceAccountCreateResponseObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProjectServiceAccountCreateResponseObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProjectServiceAccountCreateResponseObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
