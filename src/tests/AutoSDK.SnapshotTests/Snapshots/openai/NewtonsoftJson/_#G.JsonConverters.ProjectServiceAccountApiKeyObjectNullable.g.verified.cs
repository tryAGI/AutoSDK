...
{
    /// <inheritdoc />
    public sealed class ProjectServiceAccountApiKeyObjectNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ProjectServiceAccountApiKeyObject?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ProjectServiceAccountApiKeyObjectExtensions.ToValueString(value.Value));
            }
        }
    }
}
