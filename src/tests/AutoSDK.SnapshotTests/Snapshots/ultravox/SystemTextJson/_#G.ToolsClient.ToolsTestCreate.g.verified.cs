            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (!__response.IsSuccessStatusCode)
            {
                ...
                else
                {
                    ...
                    __value_default = await global::System.Text.Json.JsonSerializer.DeserializeAsync<string?>(__contentStream_default, JsonSerializerOptions).ConfigureAwait(false);
                }
