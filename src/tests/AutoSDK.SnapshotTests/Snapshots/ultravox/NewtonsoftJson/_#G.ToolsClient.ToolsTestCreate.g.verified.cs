...
namespace G
{
    public partial class ToolsClient
    {
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        ...
                                        __value_default = global::Newtonsoft.Json.JsonConvert.DeserializeObject<byte[]?>(__content_default, JsonSerializerOptions);
                                    }
                                    else
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<byte[]>> ToolsTestCreateAsResponseAsync(
            global::System.Guid toolId,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
