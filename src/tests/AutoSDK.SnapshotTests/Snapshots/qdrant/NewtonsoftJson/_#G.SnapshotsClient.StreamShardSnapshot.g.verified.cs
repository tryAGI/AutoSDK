//HintName: G.SnapshotsClient.StreamShardSnapshot.g.cs
...
namespace G
{
    public partial class SnapshotsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_StreamShardSnapshotSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_StreamShardSnapshotSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_StreamShardSnapshotSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_StreamShardSnapshotSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_StreamShardSnapshotSecurityRequirement0,
                s_StreamShardSnapshotSecurityRequirement1,
                s_StreamShardSnapshotSecurityRequirement2,
            };
        partial void PrepareStreamShardSnapshotArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string collectionName,
            ref int shardId);
        partial void PrepareStreamShardSnapshotRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string collectionName,
            int shardId);
        partial void ProcessStreamShardSnapshotResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessStreamShardSnapshotResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref byte[] content);
        ...
        public async global::System.Threading.Tasks.Task<byte[]> StreamShardSnapshotAsync(
            string collectionName,
            int shardId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStreamShardSnapshotArguments(
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessStreamShardSnapshotResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessStreamShardSnapshotResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
