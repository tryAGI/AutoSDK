...
{
    /// <inheritdoc />
    public sealed class BinaryQuantizationEncodingJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.BinaryQuantizationEncoding>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.BinaryQuantizationEncodingExtensions.ToValueString(value));
        }
    }
}
