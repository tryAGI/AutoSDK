...
namespace G
{
    public partial class SnapshotsClient
    {
        ...
        {
            var __response = await RecoverFromUploadedSnapshotAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.RecoverFromUploadedSnapshotResponse>> RecoverFromUploadedSnapshotAsResponseAsync(
            string collectionName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RecoverFromUploadedSnapshot",
                                methodName: "RecoverFromUploadedSnapshotAsync",
                                pathTemplate: "$\"/collections/{collectionName}/snapshots/upload\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.RecoverFromUploadedSnapshotResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.RecoverFromUploadedSnapshotResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.RecoverFromUploadedSnapshotResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        /// <param name="checksum"></param>
        /// <param name="snapshot">
        /// The stream to send as the multipart 'snapshot' file part.
        /// </param>
        /// <param name="snapshotname"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        ...
        public async global::System.Threading.Tasks.Task<global::G.RecoverFromUploadedSnapshotResponse> RecoverFromUploadedSnapshotAsync(
            ...
            global::G.SnapshotPriority? priority = default,
            string? checksum = default,
            global::System.IO.Stream? snapshot = default,
            string? snapshotname = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {

            var request = new global::G.RecoverFromUploadedSnapshotRequest
            {
                Snapshot = global::System.Array.Empty<byte>(),
                Snapshotname = snapshotname,
            };
            PrepareArguments(
                client: HttpClient);
                         ...
                         __authorization.Location == "Header")
                {
                    __httpRequest.Headers.Add(__authorization.Name, __authorization.Value);
                            ...
                            if (snapshot != default)
                            {
                                ...
                                var __contentSnapshot = new global::System.Net.Http.StreamContent(snapshot);
                                __contentSnapshot.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                    request.Snapshotname is null
                                        ? "application/octet-stream"
                                        : (global::System.IO.Path.GetExtension(request.Snapshotname) ?? string.Empty).ToLowerInvariant() switch
