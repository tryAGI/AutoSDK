...
{
    /// <inheritdoc />
    public sealed class ReshardingDirectionJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReshardingDirection>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.ReshardingDirectionExtensions.ToValueString(value));
        }
    }
}
