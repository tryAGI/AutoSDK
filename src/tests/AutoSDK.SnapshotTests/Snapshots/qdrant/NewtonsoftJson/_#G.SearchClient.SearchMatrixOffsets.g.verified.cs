//HintName: G.SearchClient.SearchMatrixOffsets.g.cs
...
namespace G
{
    public partial class SearchClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchMatrixOffsetsSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchMatrixOffsetsSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_SearchMatrixOffsetsSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_SearchMatrixOffsetsSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_SearchMatrixOffsetsSecurityRequirement0,
                s_SearchMatrixOffsetsSecurityRequirement1,
                s_SearchMatrixOffsetsSecurityRequirement2,
            };
        ...
        partial void PrepareSearchMatrixOffsetsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::G.SearchMatrixRequest request);
        partial void ProcessSearchMatrixOffsetsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSearchMatrixOffsetsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.SearchMatrixOffsetsResponse2> SearchMatrixOffsetsAsync(
            string collectionName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareSearchMatrixOffsetsArguments(
            ...
            PrepareSearchMatrixOffsetsRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessSearchMatrixOffsetsResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessSearchMatrixOffsetsResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.SearchMatrixOffsetsResponse2.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.SearchMatrixOffsetsResponse2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::G.SearchMatrixOffsetsResponse2> SearchMatrixOffsetsAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.SearchMatrixRequest
            {
                ShardKey = shardKey,
                Filter = filter,
                Sample = sample,
            ...
            return await SearchMatrixOffsetsAsync(
                collectionName: collectionName,
                consistency: consistency,
                timeout: timeout,
                request: __request,
