...
namespace G
{
    public partial class SearchClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DiscoverPointsSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DiscoverPointsSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_DiscoverPointsSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_DiscoverPointsSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_DiscoverPointsSecurityRequirement0,
                s_DiscoverPointsSecurityRequirement1,
                s_DiscoverPointsSecurityRequirement2,
            };
        partial void PrepareDiscoverPointsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string collectionName,
            ref global::G.ReadConsistency? consistency,
            ref int? timeout,
            global::G.DiscoverRequest request);
        partial void PrepareDiscoverPointsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::G.DiscoverRequest request);
        partial void ProcessDiscoverPointsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDiscoverPointsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.DiscoverPointsResponse> DiscoverPointsAsync(
            string collectionName,
        ...
        {
            var __response = await DiscoverPointsAsResponseAsync(
        ...
        /// <exception cref="global::G.ApiException"></exception>
        [global::System.Obsolete("This method marked as deprecated.")]
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.DiscoverPointsResponse>> DiscoverPointsAsResponseAsync(
            string collectionName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDiscoverPointsArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DiscoverPointsSecurityRequirements,
                operationName: "DiscoverPointsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::G.PathBuilder(
                                path: $"/collections/{collectionName}/points/discover",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DiscoverPoints",
                                methodName: "DiscoverPointsAsync",
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDiscoverPointsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.DiscoverPointsResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.DiscoverPointsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.DiscoverPointsResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await DiscoverPointsAsync(
                collectionName: collectionName,
                consistency: consistency,
                timeout: timeout,
                request: __request,
