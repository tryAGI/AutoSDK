...
{
    /// <inheritdoc />
    public sealed class ReadConsistencyTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ReadConsistencyType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ReadConsistencyTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
