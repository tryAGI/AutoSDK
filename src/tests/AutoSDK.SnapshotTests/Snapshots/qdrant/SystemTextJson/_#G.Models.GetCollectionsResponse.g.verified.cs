...
namespace G
{
    ...
    public sealed partial class GetCollectionsResponse
    {
        ...
        /// </summary>
        /// <example>{"collections":[{"name":"arxiv-title"},{"name":"arxiv-abstract"},{"name":"medium-title"},{"name":"medium-text"}]}</example>
        [global::System.Text.Json.Serialization.JsonPropertyName("result")]
        public global::G.CollectionsResponse? Result { get; set; }
        ...
        public GetCollectionsResponse(
            ...
            float? time,
            string? status,
            global::G.CollectionsResponse? result)
        {
            this.Usage = usage;
            this.Time = time;
            this.Status = status;
