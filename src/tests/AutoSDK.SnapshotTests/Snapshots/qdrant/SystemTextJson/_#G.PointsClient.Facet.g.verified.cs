//HintName: G.PointsClient.Facet.g.cs
...
namespace G
{
    public partial class PointsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_FacetSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_FacetSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_FacetSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_FacetSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_FacetSecurityRequirement0,
                s_FacetSecurityRequirement1,
                s_FacetSecurityRequirement2,
            };
        ...
        partial void PrepareFacetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::G.FacetRequest request);
        partial void ProcessFacetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessFacetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.FacetResponse2> FacetAsync(
            string collectionName,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Facet",
                                methodName: "FacetAsync",
                                pathTemplate: "$\"/collections/{collectionName}/facet\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.FacetResponse2.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.FacetResponse2.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
