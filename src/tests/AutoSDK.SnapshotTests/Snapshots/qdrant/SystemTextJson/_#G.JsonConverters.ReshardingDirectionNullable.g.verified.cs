...
{
    /// <inheritdoc />
    public sealed class ReshardingDirectionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ReshardingDirection?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ReshardingDirectionExtensions.ToValueString(value.Value));
            }
        }
    }
}
