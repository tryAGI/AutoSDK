//HintName: G.ServiceClient.Telemetry.g.cs
...
namespace G
{
    public partial class ServiceClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TelemetrySecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TelemetrySecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_TelemetrySecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_TelemetrySecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_TelemetrySecurityRequirement0,
                s_TelemetrySecurityRequirement1,
                s_TelemetrySecurityRequirement2,
            };
        partial void PrepareTelemetryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref bool? anonymize,
            ref int? detailsLevel,
            ref bool? perCollection,
            ref int? timeout);
        partial void PrepareTelemetryRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? perCollection,
            int? timeout);
        partial void ProcessTelemetryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTelemetryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.TelemetryResponse> TelemetryAsync(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "TelemetryAsync",
                                pathTemplate: "\"/telemetry\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTelemetryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::G.TelemetryResponse.FromJson(__content, JsonSerializerOptions) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::G.TelemetryResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
