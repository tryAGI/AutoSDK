...
{
    /// <inheritdoc />
    public class PayloadSelectorJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PayloadSelector>
    {
        /// <inheritdoc />
        public override global::G.PayloadSelector Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("exclude")) __score1++;
            var __bestScore = 0;
            var __bestIndex = -1;
            if (__score0 > __bestScore) { __bestScore = __score0; __bestIndex = 0; }
            if (__score1 > __bestScore) { __bestScore = __score1; __bestIndex = 1; }

            global::G.PayloadSelectorInclude? include = default;
            global::G.PayloadSelectorExclude? exclude = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::G.PayloadSelector(
                include,
        ...
        public override void Write(
            ...
            global::G.PayloadSelector value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
