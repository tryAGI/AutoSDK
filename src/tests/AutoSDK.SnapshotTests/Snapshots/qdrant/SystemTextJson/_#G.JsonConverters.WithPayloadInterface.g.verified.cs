//HintName: G.JsonConverters.WithPayloadInterface.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class WithPayloadInterfaceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.WithPayloadInterface>
    {
        /// <inheritdoc />
        public override global::G.WithPayloadInterface Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score2 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::G.PayloadSelector), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::G.PayloadSelector? selector = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.PayloadSelector), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.PayloadSelector> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.PayloadSelector).Name}");
            ...
            var __value = new global::G.WithPayloadInterface(
        ...
        public override void Write(
            ...
            global::G.WithPayloadInterface value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
