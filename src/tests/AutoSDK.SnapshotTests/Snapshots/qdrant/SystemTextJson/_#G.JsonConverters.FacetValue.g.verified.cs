...
{
    /// <inheritdoc />
    public class FacetValueJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FacetValue>
    {
        /// <inheritdoc />
        public override global::G.FacetValue Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(long), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            string? facetValueVariant1 = default;
            long? facetValueVariant2 = default;
            bool? facetValueVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        facetValueVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        facetValueVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        facetValueVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (facetValueVariant1 == null && facetValueVariant2 == null && facetValueVariant3 == null)
            {
                try
                {
            ...
            var __value = new global::G.FacetValue(
                facetValueVariant1,
