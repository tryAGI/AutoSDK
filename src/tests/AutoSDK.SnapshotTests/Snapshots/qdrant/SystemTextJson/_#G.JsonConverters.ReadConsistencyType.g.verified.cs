...
{
    /// <inheritdoc />
    public sealed class ReadConsistencyTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ReadConsistencyType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ReadConsistencyTypeExtensions.ToValueString(value));
        }
    }
}
