...
namespace G
{
    public partial class PointsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_BatchUpdateSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_BatchUpdateSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement s_BatchUpdateSecurityRequirement2 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                { 
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_BatchUpdateSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_BatchUpdateSecurityRequirement0,
                s_BatchUpdateSecurityRequirement1,
                s_BatchUpdateSecurityRequirement2,
            };
        partial void PrepareBatchUpdateArguments(
            ...
            ref int? timeout,
            global::G.UpdateOperations request);
        partial void PrepareBatchUpdateRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? timeout,
            global::G.UpdateOperations request);
        partial void ProcessBatchUpdateResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessBatchUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.BatchUpdateResponse> BatchUpdateAsync(
            string collectionName,
        ...
        {
            var __response = await BatchUpdateAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.BatchUpdateResponse>> BatchUpdateAsResponseAsync(
            string collectionName,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessBatchUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.BatchUpdateResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.BatchUpdateResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.BatchUpdateResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
