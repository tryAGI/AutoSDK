...
namespace G
{
    public partial class LogsClient
    {
        ...
        {
            var __response = await GetPipelineStartupLogsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> GetPipelineStartupLogsAsResponseAsync(
            string pipelineIdOrPointer,
            string? pipelineId = default,
            string? pointer = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
