...
namespace G
{
    public partial class CloudClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateGcpServiceAccountSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CreateGcpServiceAccountSecurityRequirement1 =
            new global::G.EndPointSecurityRequirement
            {
                Authorizations = new global::G.EndPointAuthorizationRequirement[]
                {                    new global::G.EndPointAuthorizationRequirement
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CreateGcpServiceAccountSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CreateGcpServiceAccountSecurityRequirement0,
                s_CreateGcpServiceAccountSecurityRequirement1,
            };
        ...
        {
            var __response = await CreateGcpServiceAccountAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> CreateGcpServiceAccountAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateGcpServiceAccountSecurityRequirements,
                operationName: "CreateGcpServiceAccountAsync");
                ...
                if (__cookies.Count > 0)
                            ...
                            if (request.CredentialId != default)
                            {
                                ...
                                __httpRequestContent.Add(
                                    content: new global::System.Net.Http.StringContent(request.CredentialId ?? string.Empty),
                                    name: "\"credential_id\"");
                            ...
                            __contentServiceAccountFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.ServiceAccountFilename is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.ServiceAccountFilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateGcpServiceAccount",
                                methodName: "CreateGcpServiceAccountAsync",
                                pathTemplate: "\"/v4/cloud/provider/gcp/service-accounts\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
        ...
        /// </summary>
        /// <param name="credentialId"></param>
        /// <param name="serviceAccountFile">
        /// The stream to send as the multipart 'service_account_file' file part.
        /// </param>
        /// <param name="serviceAccountFilename"></param>
        /// <param name="requestOptions">Per-request overrides such as headers, query parameters, timeout, retries, and response buffering.</param>
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<string> CreateGcpServiceAccountAsync(
            global::System.IO.Stream serviceAccountFile,
            string serviceAccountFilename,
            string? credentialId = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            serviceAccountFile = serviceAccountFile ?? throw new global::System.ArgumentNullException(nameof(serviceAccountFile));
            var request = new global::G.BodyCreateGcpServiceAccountV4CloudProviderGcpServiceAccountsPost
            {
                CredentialId = credentialId,
                ServiceAccountFile = global::System.Array.Empty<byte>(),
                ServiceAccountFilename = serviceAccountFilename,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                if (__cookies.Count > 0)
                            ...
                            var __contentServiceAccountFile = new global::System.Net.Http.StreamContent(serviceAccountFile);
                            __contentServiceAccountFile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.ServiceAccountFilename is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.ServiceAccountFilename) ?? string.Empty).ToLowerInvariant() switch
