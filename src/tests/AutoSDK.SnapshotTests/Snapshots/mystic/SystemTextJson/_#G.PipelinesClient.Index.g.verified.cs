            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::G.PaginatedPipelineGet.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.PaginatedPipelineGet.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
