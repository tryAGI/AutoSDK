...
namespace G
{
    public partial class PipelinesClient
    {
        ...
        {
            var __response = await RetrieveByPointerAsResponseAsync(
                pointer: pointer,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.AppSchemasPipelineGetDetailed>> RetrieveByPointerAsResponseAsync(
            string pointer,
            bool? includePointers = default,
            bool? includeExtras = default,
            string? pipelineId = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RetrieveByPointer",
                                methodName: "RetrieveByPointerAsync",
                                pathTemplate: "$\"/v4/pipelines/by-pointer/{pointer}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.AppSchemasPipelineGetDetailed.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.AppSchemasPipelineGetDetailed>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.AppSchemasPipelineGetDetailed.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
