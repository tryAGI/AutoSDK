...
namespace G
{
    public partial class FilesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<string>> CreateAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                if (__cookies.Count > 0)
                            ...
                            __contentPfile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.Pfilename is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.Pfilename) ?? string.Empty).ToLowerInvariant() switch
                                    {
                                        ".aac" => "audio/aac",
                                        ".flac" => "audio/flac",
                                        ".gif" => "image/gif",
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            pfile = pfile ?? throw new global::System.ArgumentNullException(nameof(pfile));
            var request = new global::G.BodyCreateV4FilesPost
            {
                Pfile = global::System.Array.Empty<byte>(),
                Pfilename = pfilename,
            };
            PrepareArguments(
                client: HttpClient);
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                if (__cookies.Count > 0)
                            ...
                            var __httpRequestContent = new global::System.Net.Http.MultipartFormDataContent();
                            var __contentPfile = new global::System.Net.Http.StreamContent(pfile);
                            __contentPfile.Headers.ContentType = new global::System.Net.Http.Headers.MediaTypeHeaderValue(
                                request.Pfilename is null
                                    ? "application/octet-stream"
                                    : (global::System.IO.Path.GetExtension(request.Pfilename) ?? string.Empty).ToLowerInvariant() switch
