...
namespace G
{
    public partial class MetricsClient
    {
        ...
        {
            var __response = await OverallUsageSummaryAsResponseAsync(
                start: start,
                end: end,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.OverallUsageSummary>> OverallUsageSummaryAsResponseAsync(
            global::System.DateTime start,
            global::System.DateTime end,
            string? pipelineId = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "OverallUsageSummary",
                                methodName: "OverallUsageSummaryAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.OverallUsageSummary.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.OverallUsageSummary>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.OverallUsageSummary.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
