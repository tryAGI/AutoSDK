...
{
    /// <inheritdoc />
    public sealed class CreatePersonaRequestPipelineModeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreatePersonaRequestPipelineMode?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreatePersonaRequestPipelineModeExtensions.ToValueString(value.Value));
            }
        }
    }
}
