...
{
    /// <inheritdoc />
    public sealed class JsonPatchOperationOpJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.JsonPatchOperationOp>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.JsonPatchOperationOpExtensions.ToValueString(value));
        }
    }
}
