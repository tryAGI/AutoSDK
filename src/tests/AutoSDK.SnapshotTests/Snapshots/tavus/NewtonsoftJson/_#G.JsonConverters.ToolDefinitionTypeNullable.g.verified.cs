...
{
    /// <inheritdoc />
    public sealed class ToolDefinitionTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ToolDefinitionType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ToolDefinitionTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
