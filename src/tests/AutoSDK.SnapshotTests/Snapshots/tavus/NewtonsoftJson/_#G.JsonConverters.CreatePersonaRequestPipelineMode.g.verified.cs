...
{
    /// <inheritdoc />
    public sealed class CreatePersonaRequestPipelineModeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreatePersonaRequestPipelineMode>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreatePersonaRequestPipelineModeExtensions.ToValueString(value));
        }
    }
}
