//HintName: G.Api.ResearchControllerGetResearch.g.cs
...
namespace G
{
    public partial class Api
    {
        ...
        partial void PrepareResearchControllerGetResearchArguments(
            ...
            ref string stream,
            ref string events);
        partial void PrepareResearchControllerGetResearchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string researchId,
            string stream,
            string events);
        partial void ProcessResearchControllerGetResearchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessResearchControllerGetResearchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.ResearchDtoClass> ResearchControllerGetResearchAsync(
            string researchId,
            string stream,
            string events,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareResearchControllerGetResearchArguments(
            ...
            PrepareResearchControllerGetResearchRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessResearchControllerGetResearchResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessResearchControllerGetResearchResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::G.ResearchDtoClass.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::G.ResearchDtoClass.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
