...
namespace G.JsonConverters
{
    ...
    public class InputJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.Input>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GenerationInputDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GenerationInputDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.GenerationInputDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.GenerateVideoRequestOutput? video = default;
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.Video)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GenerateVideoRequestOutput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GenerateVideoRequestOutput> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.GenerateVideoRequestOutput)}");
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.TextToSpeech)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.TextToSound)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.Image)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.ImageUpscale)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.VideoUpscale)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.AudioIsolation)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.SpeechToSpeech)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.VoiceClone)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.AudioFromVideo)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.VideoWithAudio)
            {
            ...
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.VideoToVideo)
            {
            ...
            global::G.GenerateMotionControlRequestOutput? motionControl = default;
            if (discriminator?.Type == global::G.GenerationInputDiscriminatorType.MotionControl)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GenerateMotionControlRequestOutput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GenerateMotionControlRequestOutput> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.GenerateMotionControlRequestOutput)}");
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GenerateVideoRequestOutput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GenerateVideoRequestOutput?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.GenerateVideoRequestOutput).Name}");
            ...
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.GenerateMotionControlRequestOutput), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.GenerateMotionControlRequestOutput?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::G.GenerateMotionControlRequestOutput).Name}");
