...
{
    /// <inheritdoc />
    public sealed class GenerateAssetPublicGenerationsPostResponseDiscriminatorTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GenerateAssetPublicGenerationsPostResponseDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GenerateAssetPublicGenerationsPostResponseDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
