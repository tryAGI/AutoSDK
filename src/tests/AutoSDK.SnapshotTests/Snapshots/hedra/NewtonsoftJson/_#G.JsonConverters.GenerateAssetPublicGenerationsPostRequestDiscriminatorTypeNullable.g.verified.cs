...
{
    /// <inheritdoc />
    public sealed class GenerateAssetPublicGenerationsPostRequestDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GenerateAssetPublicGenerationsPostRequestDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GenerateAssetPublicGenerationsPostRequestDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
