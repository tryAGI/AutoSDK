...
{
    /// <inheritdoc />
    public sealed class S3CredentialProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.S3CredentialProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.S3CredentialProviderExtensions.ToValueString(value));
        }
    }
}
