...
{
    /// <inheritdoc />
    public sealed class TransferDestinationAssistantTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TransferDestinationAssistantType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TransferDestinationAssistantTypeExtensions.ToValueString(value));
        }
    }
}
