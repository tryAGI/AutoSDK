...
{
    /// <inheritdoc />
    public sealed class CartesiaVoiceModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CartesiaVoiceModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CartesiaVoiceModelExtensions.ToValueString(value));
        }
    }
}
