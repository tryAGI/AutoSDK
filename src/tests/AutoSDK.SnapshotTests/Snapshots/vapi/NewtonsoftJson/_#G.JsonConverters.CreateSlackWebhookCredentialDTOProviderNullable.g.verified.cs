...
{
    /// <inheritdoc />
    public sealed class CreateSlackWebhookCredentialDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateSlackWebhookCredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateSlackWebhookCredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
