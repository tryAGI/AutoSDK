//HintName: G.Models.UpdateHandoffToolDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateHandoffToolDTO
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("defaultResult")]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateHandoffToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
