//HintName: G.CampaignsClient.CampaignControllerFindAll.g.cs
...
namespace G
{
    public partial class CampaignsClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_CampaignControllerFindAllSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_CampaignControllerFindAllSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_CampaignControllerFindAllSecurityRequirement0,
            };
        partial void PrepareCampaignControllerFindAllArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? id,
            ref global::G.CampaignControllerFindAllStatus? status,
            ref double? page,
            ref global::G.CampaignControllerFindAllSortOrder? sortOrder,
            ref double? limit,
        ...
        partial void PrepareCampaignControllerFindAllRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? id,
            global::G.CampaignControllerFindAllStatus? status,
            double? page,
            global::G.CampaignControllerFindAllSortOrder? sortOrder,
            double? limit,
        ...
        partial void ProcessCampaignControllerFindAllResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCampaignControllerFindAllResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.CampaignPaginatedResponse> CampaignControllerFindAllAsync(
            string? id = default,
            global::G.CampaignControllerFindAllStatus? status = default,
            double? page = default,
            global::G.CampaignControllerFindAllSortOrder? sortOrder = default,
        ...
        {
            var __response = await CampaignControllerFindAllAsResponseAsync(
                id: id,
                status: status,
                page: page,
                sortOrder: sortOrder,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.CampaignPaginatedResponse>> CampaignControllerFindAllAsResponseAsync(
            string? id = default,
            global::G.CampaignControllerFindAllStatus? status = default,
            double? page = default,
            global::G.CampaignControllerFindAllSortOrder? sortOrder = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCampaignControllerFindAllArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CampaignControllerFindAllSecurityRequirements,
                operationName: "CampaignControllerFindAllAsync");

            var statusValue = status switch
            {
                global::G.CampaignControllerFindAllStatus.Ended => "ended",
                global::G.CampaignControllerFindAllStatus.InProgress => "in-progress",
                global::G.CampaignControllerFindAllStatus.Scheduled => "scheduled",
                _ => throw new global::System.NotImplementedException("Enum value not implemented."),
            };
            var sortOrderValue = sortOrder switch
            {
                global::G.CampaignControllerFindAllSortOrder.Asc => "ASC",
                global::G.CampaignControllerFindAllSortOrder.Desc => "DESC",
                _ => throw new global::System.NotImplementedException("Enum value not implemented."),
            };
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCampaignControllerFindAllRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "CampaignControllerFindAllAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCampaignControllerFindAllResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCampaignControllerFindAllResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.CampaignPaginatedResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.CampaignPaginatedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.CampaignPaginatedResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
