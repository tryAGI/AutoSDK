...
{
    /// <inheritdoc />
    public sealed class FallbackTavusVoiceProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackTavusVoiceProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.FallbackTavusVoiceProviderExtensions.ToValueString(value));
        }
    }
}
