...
{
    /// <inheritdoc />
    public sealed class ClientMessageTransferUpdateTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClientMessageTransferUpdateType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ClientMessageTransferUpdateTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
