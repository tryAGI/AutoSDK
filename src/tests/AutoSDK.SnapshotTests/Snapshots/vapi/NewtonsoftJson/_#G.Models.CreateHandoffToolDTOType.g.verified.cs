//HintName: G.Models.CreateHandoffToolDTOType.g.cs
...
namespace G
{
    ...
    public enum CreateHandoffToolDTOType
    {
        /// <summary>
    ...
    /// </summary>
    public static class CreateHandoffToolDTOTypeExtensions
    {
        /// <summary>
        /// Converts an enum to a string.
        /// </summary>
        public static string ToValueString(this CreateHandoffToolDTOType value)
        {
            return value switch
            {
                CreateHandoffToolDTOType.Handoff => "handoff",
        ...
        /// </summary>
        public static CreateHandoffToolDTOType? ToEnum(string value)
        {
            return value switch
            {
                "handoff" => CreateHandoffToolDTOType.Handoff,
                _ => null,
            };
        }
    }
