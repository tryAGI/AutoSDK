...
{
    /// <inheritdoc />
    public sealed class FallbackAzureVoiceVoiceIdNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackAzureVoiceVoiceId?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackAzureVoiceVoiceIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
