...
{
    /// <inheritdoc />
    public sealed class RecordingConsentPlanStayOnLineTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.RecordingConsentPlanStayOnLineType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.RecordingConsentPlanStayOnLineTypeExtensions.ToValueString(value));
        }
    }
}
