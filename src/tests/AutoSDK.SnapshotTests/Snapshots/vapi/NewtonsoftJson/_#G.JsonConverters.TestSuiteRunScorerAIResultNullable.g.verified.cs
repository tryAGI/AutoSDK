...
{
    /// <inheritdoc />
    public sealed class TestSuiteRunScorerAIResultNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TestSuiteRunScorerAIResult?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TestSuiteRunScorerAIResultExtensions.ToValueString(value.Value));
            }
        }
    }
}
