...
{
    /// <inheritdoc />
    public sealed class DeepSeekCredentialProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeepSeekCredentialProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeepSeekCredentialProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
