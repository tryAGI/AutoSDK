...
{
    /// <inheritdoc />
    public sealed class CreatePieInsightFromCallTableDTOGroupByNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreatePieInsightFromCallTableDTOGroupBy?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreatePieInsightFromCallTableDTOGroupByExtensions.ToValueString(value.Value));
            }
        }
    }
}
