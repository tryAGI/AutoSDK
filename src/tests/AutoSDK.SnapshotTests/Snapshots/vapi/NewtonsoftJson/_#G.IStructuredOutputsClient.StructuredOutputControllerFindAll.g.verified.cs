...
namespace G
{
    public partial interface IStructuredOutputsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.StructuredOutputPaginatedResponse>> StructuredOutputControllerFindAllAsResponseAsync(
            string? id = default,
            string? name = default,
            double? page = default,
            global::G.StructuredOutputControllerFindAllSortOrder? sortOrder = default,
