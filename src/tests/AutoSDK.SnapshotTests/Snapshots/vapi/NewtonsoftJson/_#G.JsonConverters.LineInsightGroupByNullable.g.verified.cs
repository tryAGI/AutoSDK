...
{
    /// <inheritdoc />
    public sealed class LineInsightGroupByNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LineInsightGroupBy?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.LineInsightGroupByExtensions.ToValueString(value.Value));
            }
        }
    }
}
