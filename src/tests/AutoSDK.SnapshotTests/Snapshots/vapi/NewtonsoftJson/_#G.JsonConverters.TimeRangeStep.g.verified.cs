...
{
    /// <inheritdoc />
    public sealed class TimeRangeStepJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TimeRangeStep>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TimeRangeStepExtensions.ToValueString(value));
        }
    }
}
