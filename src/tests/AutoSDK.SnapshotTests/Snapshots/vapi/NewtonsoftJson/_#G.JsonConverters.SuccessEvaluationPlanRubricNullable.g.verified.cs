...
{
    /// <inheritdoc />
    public sealed class SuccessEvaluationPlanRubricNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SuccessEvaluationPlanRubric?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SuccessEvaluationPlanRubricExtensions.ToValueString(value.Value));
            }
        }
    }
}
