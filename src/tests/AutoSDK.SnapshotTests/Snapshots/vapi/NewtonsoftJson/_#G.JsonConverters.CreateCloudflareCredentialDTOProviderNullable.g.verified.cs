...
{
    /// <inheritdoc />
    public sealed class CreateCloudflareCredentialDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateCloudflareCredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateCloudflareCredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
