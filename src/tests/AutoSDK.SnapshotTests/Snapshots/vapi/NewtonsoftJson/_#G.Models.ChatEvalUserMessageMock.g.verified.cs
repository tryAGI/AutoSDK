...
namespace G
{
    ...
    public sealed partial class ChatEvalUserMessageMock
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.ChatEvalUserMessageMockRoleJsonConverter))]
        ...
        /// <summary>
        /// Creates a new <see cref="ChatEvalUserMessageMock"/> from its single non-const required field,
        /// hardcoding any const discriminator fields.
        /// </summary>
        public static ChatEvalUserMessageMock FromContent(string content)
        {
            return new ChatEvalUserMessageMock
            {
                Content = content,
            };
        }
