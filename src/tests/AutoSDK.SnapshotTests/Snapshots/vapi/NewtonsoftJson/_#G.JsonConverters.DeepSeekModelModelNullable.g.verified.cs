...
{
    /// <inheritdoc />
    public sealed class DeepSeekModelModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeepSeekModelModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeepSeekModelModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
