...
{
    /// <inheritdoc />
    public sealed class CreateCustomCredentialDTOEncryptionPlanDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateCustomCredentialDTOEncryptionPlanDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateCustomCredentialDTOEncryptionPlanDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
