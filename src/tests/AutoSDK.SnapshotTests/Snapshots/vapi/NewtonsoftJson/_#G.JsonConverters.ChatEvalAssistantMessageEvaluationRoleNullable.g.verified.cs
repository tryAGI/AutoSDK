...
{
    /// <inheritdoc />
    public sealed class ChatEvalAssistantMessageEvaluationRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatEvalAssistantMessageEvaluationRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatEvalAssistantMessageEvaluationRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
