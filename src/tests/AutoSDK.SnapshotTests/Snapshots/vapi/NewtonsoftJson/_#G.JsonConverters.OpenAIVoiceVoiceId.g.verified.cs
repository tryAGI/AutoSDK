...
{
    /// <inheritdoc />
    public sealed class OpenAIVoiceVoiceIdJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAIVoiceVoiceId>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OpenAIVoiceVoiceIdExtensions.ToValueString(value));
        }
    }
}
