...
{
    /// <inheritdoc />
    public sealed class ExportChatDTOSortOrderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ExportChatDTOSortOrder?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ExportChatDTOSortOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
