...
{
    /// <inheritdoc />
    public sealed class TranscriberCostTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TranscriberCostType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TranscriberCostTypeExtensions.ToValueString(value));
        }
    }
}
