...
namespace G
{
    public partial class EvalClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_EvalControllerGetPaginatedSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_EvalControllerGetPaginatedSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_EvalControllerGetPaginatedSecurityRequirement0,
            };
        partial void PrepareEvalControllerGetPaginatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? id,
            ref double? page,
            ref global::G.EvalControllerGetPaginatedSortOrder? sortOrder,
            ref double? limit,
        ...
        partial void PrepareEvalControllerGetPaginatedRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? id,
            double? page,
            global::G.EvalControllerGetPaginatedSortOrder? sortOrder,
            double? limit,
        ...
        partial void ProcessEvalControllerGetPaginatedResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEvalControllerGetPaginatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.EvalPaginatedResponse> EvalControllerGetPaginatedAsync(
            string? id = default,
            double? page = default,
            global::G.EvalControllerGetPaginatedSortOrder? sortOrder = default,
        ...
        {
            var __response = await EvalControllerGetPaginatedAsResponseAsync(
                id: id,
                page: page,
                sortOrder: sortOrder,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvalPaginatedResponse>> EvalControllerGetPaginatedAsResponseAsync(
            string? id = default,
            double? page = default,
            global::G.EvalControllerGetPaginatedSortOrder? sortOrder = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEvalControllerGetPaginatedArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvalControllerGetPaginatedSecurityRequirements,
                operationName: "EvalControllerGetPaginatedAsync");

            var sortOrderValue = sortOrder switch
            {
                global::G.EvalControllerGetPaginatedSortOrder.Asc => "ASC",
                global::G.EvalControllerGetPaginatedSortOrder.Desc => "DESC",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEvalControllerGetPaginatedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvalControllerGetPaginated",
                                methodName: "EvalControllerGetPaginatedAsync",
                                pathTemplate: "\"/eval\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvalControllerGetPaginatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvalControllerGetPaginatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.EvalPaginatedResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.EvalPaginatedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.EvalPaginatedResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
