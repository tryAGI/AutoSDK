...
{
    /// <inheritdoc />
    public sealed class UpdateAzureCredentialDTOServiceNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateAzureCredentialDTOService?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateAzureCredentialDTOServiceExtensions.ToValueString(value.Value));
            }
        }
    }
}
