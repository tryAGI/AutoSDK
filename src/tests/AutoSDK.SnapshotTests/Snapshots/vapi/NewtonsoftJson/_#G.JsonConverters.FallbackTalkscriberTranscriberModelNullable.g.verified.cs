...
{
    /// <inheritdoc />
    public sealed class FallbackTalkscriberTranscriberModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackTalkscriberTranscriberModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackTalkscriberTranscriberModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
