...
{
    /// <inheritdoc />
    public sealed class UpdateSipRequestToolDTOVerbNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.UpdateSipRequestToolDTOVerb?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.UpdateSipRequestToolDTOVerbExtensions.ToValueString(value.Value));
            }
        }
    }
}
