...
{
    /// <inheritdoc />
    public sealed class AzureCredentialProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AzureCredentialProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AzureCredentialProviderExtensions.ToValueString(value));
        }
    }
}
