...
{
    /// <inheritdoc />
    public sealed class CreateEndCallToolDTOTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateEndCallToolDTOType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateEndCallToolDTOTypeExtensions.ToValueString(value));
        }
    }
}
