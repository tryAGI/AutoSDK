...
{
    /// <inheritdoc />
    public sealed class SpeechmaticsTranscriberOperatingPointNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SpeechmaticsTranscriberOperatingPoint?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SpeechmaticsTranscriberOperatingPointExtensions.ToValueString(value.Value));
            }
        }
    }
}
