...
{
    /// <inheritdoc />
    public sealed class CreateSlackSendMessageToolDTOTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateSlackSendMessageToolDTOType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateSlackSendMessageToolDTOTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
