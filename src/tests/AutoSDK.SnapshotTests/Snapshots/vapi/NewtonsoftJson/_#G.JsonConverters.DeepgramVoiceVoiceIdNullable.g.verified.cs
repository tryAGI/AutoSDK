...
{
    /// <inheritdoc />
    public sealed class DeepgramVoiceVoiceIdNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeepgramVoiceVoiceId?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeepgramVoiceVoiceIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
