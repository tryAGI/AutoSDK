...
{
    /// <inheritdoc />
    public sealed class CreateRimeAICredentialDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateRimeAICredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateRimeAICredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
