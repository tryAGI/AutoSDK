...
{
    /// <inheritdoc />
    public sealed class CreateTavusCredentialDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTavusCredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTavusCredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
