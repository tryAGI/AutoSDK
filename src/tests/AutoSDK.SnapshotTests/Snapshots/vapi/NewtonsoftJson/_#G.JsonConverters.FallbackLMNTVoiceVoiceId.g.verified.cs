...
{
    /// <inheritdoc />
    public sealed class FallbackLMNTVoiceVoiceIdJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackLMNTVoiceVoiceId>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.FallbackLMNTVoiceVoiceIdExtensions.ToValueString(value));
        }
    }
}
