...
{
    /// <inheritdoc />
    public sealed class CreateCustomKnowledgeBaseDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateCustomKnowledgeBaseDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateCustomKnowledgeBaseDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
