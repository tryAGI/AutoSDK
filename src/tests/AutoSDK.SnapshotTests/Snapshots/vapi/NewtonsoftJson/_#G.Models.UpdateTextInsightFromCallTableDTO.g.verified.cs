//HintName: G.Models.UpdateTextInsightFromCallTableDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class UpdateTextInsightFromCallTableDTO
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.UpdateTextInsightFromCallTableDTOTypeJsonConverter))]
        public global::G.UpdateTextInsightFromCallTableDTOType? Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTextInsightFromCallTableDTO" /> class.
        /// </summary>
        /// <param name="name">
        /// This is the name of the Insight.
        /// </param>
        ...
        /// For Text Insights, we only allow a single query, or require a formula if multiple queries are provided
        /// </param>
        public UpdateTextInsightFromCallTableDTO(
            string? name,
            global::G.UpdateTextInsightFromCallTableDTOType? type,
            object? formula,
