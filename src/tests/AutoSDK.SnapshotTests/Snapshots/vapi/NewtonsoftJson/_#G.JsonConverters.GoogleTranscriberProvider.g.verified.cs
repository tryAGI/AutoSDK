...
{
    /// <inheritdoc />
    public sealed class GoogleTranscriberProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GoogleTranscriberProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.GoogleTranscriberProviderExtensions.ToValueString(value));
        }
    }
}
