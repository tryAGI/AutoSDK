...
{
    /// <inheritdoc />
    public sealed class ToolControllerFindOneResponseDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ToolControllerFindOneResponseDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ToolControllerFindOneResponseDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
