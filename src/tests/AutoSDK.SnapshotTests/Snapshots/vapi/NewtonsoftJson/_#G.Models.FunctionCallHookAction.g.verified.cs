//HintName: G.Models.FunctionCallHookAction.g.cs
...
namespace G
{
    ...
    public sealed partial class FunctionCallHookAction
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.FunctionCallHookActionTypeJsonConverter))]
        public global::G.FunctionCallHookActionType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FunctionCallHookAction" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        ...
        public FunctionCallHookAction(
            ...
            global::G.FunctionCallHookActionType type,
            bool? async,
