...
{
    /// <inheritdoc />
    public sealed class PhoneNumberCallEndingHookFilterOneOfItemJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PhoneNumberCallEndingHookFilterOneOfItem>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PhoneNumberCallEndingHookFilterOneOfItemExtensions.ToValueString(value));
        }
    }
}
