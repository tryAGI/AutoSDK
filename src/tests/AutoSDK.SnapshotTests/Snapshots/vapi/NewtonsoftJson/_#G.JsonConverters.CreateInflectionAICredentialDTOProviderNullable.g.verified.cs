...
{
    /// <inheritdoc />
    public sealed class CreateInflectionAICredentialDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateInflectionAICredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateInflectionAICredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
