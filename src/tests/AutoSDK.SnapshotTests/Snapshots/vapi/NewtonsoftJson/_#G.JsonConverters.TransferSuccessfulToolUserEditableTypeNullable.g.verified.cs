...
{
    /// <inheritdoc />
    public sealed class TransferSuccessfulToolUserEditableTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TransferSuccessfulToolUserEditableType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TransferSuccessfulToolUserEditableTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
