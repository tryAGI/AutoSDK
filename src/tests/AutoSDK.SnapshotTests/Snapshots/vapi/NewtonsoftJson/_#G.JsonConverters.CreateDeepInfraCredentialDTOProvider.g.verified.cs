...
{
    /// <inheritdoc />
    public sealed class CreateDeepInfraCredentialDTOProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateDeepInfraCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateDeepInfraCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
