...
{
    /// <inheritdoc />
    public sealed class ElevenLabsTranscriberModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ElevenLabsTranscriberModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ElevenLabsTranscriberModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
