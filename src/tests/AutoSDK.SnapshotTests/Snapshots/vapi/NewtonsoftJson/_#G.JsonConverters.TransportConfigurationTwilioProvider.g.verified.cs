...
{
    /// <inheritdoc />
    public sealed class TransportConfigurationTwilioProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TransportConfigurationTwilioProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TransportConfigurationTwilioProviderExtensions.ToValueString(value));
        }
    }
}
