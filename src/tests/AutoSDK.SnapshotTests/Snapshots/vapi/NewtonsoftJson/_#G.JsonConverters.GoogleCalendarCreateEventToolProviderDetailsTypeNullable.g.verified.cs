...
{
    /// <inheritdoc />
    public sealed class GoogleCalendarCreateEventToolProviderDetailsTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GoogleCalendarCreateEventToolProviderDetailsType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GoogleCalendarCreateEventToolProviderDetailsTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
