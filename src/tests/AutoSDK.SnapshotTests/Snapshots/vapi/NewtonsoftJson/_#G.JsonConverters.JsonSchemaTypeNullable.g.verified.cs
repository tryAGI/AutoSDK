...
{
    /// <inheritdoc />
    public sealed class JsonSchemaTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.JsonSchemaType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.JsonSchemaTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
