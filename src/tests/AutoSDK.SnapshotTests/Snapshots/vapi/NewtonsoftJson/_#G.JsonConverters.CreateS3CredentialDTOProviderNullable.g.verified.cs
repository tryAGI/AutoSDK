...
{
    /// <inheritdoc />
    public sealed class CreateS3CredentialDTOProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateS3CredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateS3CredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
