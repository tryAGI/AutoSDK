...
{
    /// <inheritdoc />
    public sealed class StartSpeakingPlanSmartEndpointingEnabledNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.StartSpeakingPlanSmartEndpointingEnabled?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.StartSpeakingPlanSmartEndpointingEnabledExtensions.ToValueString(value.Value));
            }
        }
    }
}
