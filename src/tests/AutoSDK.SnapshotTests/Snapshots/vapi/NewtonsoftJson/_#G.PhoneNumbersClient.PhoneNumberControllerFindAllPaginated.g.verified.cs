...
namespace G
{
    public partial class PhoneNumbersClient
    {
        ...
        {
            var __response = await PhoneNumberControllerFindAllPaginatedAsResponseAsync(
                search: search,
                page: page,
                sortOrder: sortOrder,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.PhoneNumberPaginatedResponse>> PhoneNumberControllerFindAllPaginatedAsResponseAsync(
            string? search = default,
            double? page = default,
            global::G.PhoneNumberControllerFindAllPaginatedSortOrder? sortOrder = default,
            double? limit = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "PhoneNumberControllerFindAllPaginated",
                                methodName: "PhoneNumberControllerFindAllPaginatedAsync",
                                pathTemplate: "\"/v2/phone-number\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.PhoneNumberPaginatedResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.PhoneNumberPaginatedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.PhoneNumberPaginatedResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
