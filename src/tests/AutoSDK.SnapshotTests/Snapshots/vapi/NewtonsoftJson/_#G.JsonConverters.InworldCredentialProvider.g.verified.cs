...
{
    /// <inheritdoc />
    public sealed class InworldCredentialProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InworldCredentialProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.InworldCredentialProviderExtensions.ToValueString(value));
        }
    }
}
