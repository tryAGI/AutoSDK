...
{
    /// <inheritdoc />
    public sealed class CreateTestSuiteTestChatDtoTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTestSuiteTestChatDtoType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.CreateTestSuiteTestChatDtoTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
