...
{
    /// <inheritdoc />
    public sealed class CreateDeepgramCredentialDTOProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateDeepgramCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateDeepgramCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
