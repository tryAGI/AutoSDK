...
{
    /// <inheritdoc />
    public sealed class PhoneNumberCallRingingHookFilterTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PhoneNumberCallRingingHookFilterType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.PhoneNumberCallRingingHookFilterTypeExtensions.ToValueString(value));
        }
    }
}
