//HintName: G.Models.CreateGoogleSheetsRowAppendToolDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateGoogleSheetsRowAppendToolDTO
    {
        /// <summary>
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.CreateGoogleSheetsRowAppendToolDTOTypeJsonConverter))]
        public global::G.CreateGoogleSheetsRowAppendToolDTOType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGoogleSheetsRowAppendToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        ...
        /// ```
        /// </param>
        public CreateGoogleSheetsRowAppendToolDTO(
            ...
            global::G.CreateGoogleSheetsRowAppendToolDTOType type,
