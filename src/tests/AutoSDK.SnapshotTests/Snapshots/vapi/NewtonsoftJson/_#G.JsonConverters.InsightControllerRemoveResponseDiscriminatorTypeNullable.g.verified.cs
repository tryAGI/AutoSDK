...
{
    /// <inheritdoc />
    public sealed class InsightControllerRemoveResponseDiscriminatorTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.InsightControllerRemoveResponseDiscriminatorType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.InsightControllerRemoveResponseDiscriminatorTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
