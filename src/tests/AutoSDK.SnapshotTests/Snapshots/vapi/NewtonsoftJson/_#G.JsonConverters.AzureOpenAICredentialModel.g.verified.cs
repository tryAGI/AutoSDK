...
{
    /// <inheritdoc />
    public sealed class AzureOpenAICredentialModelJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AzureOpenAICredentialModel>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.AzureOpenAICredentialModelExtensions.ToValueString(value));
        }
    }
}
