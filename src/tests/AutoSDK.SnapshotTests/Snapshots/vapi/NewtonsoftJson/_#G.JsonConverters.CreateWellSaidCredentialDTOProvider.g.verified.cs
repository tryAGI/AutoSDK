...
{
    /// <inheritdoc />
    public sealed class CreateWellSaidCredentialDTOProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateWellSaidCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateWellSaidCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
