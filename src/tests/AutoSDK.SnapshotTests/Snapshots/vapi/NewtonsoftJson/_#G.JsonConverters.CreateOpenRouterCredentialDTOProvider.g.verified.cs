...
{
    /// <inheritdoc />
    public sealed class CreateOpenRouterCredentialDTOProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateOpenRouterCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateOpenRouterCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
