...
{
    /// <inheritdoc />
    public sealed class OpenAIVoiceProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenAIVoiceProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.OpenAIVoiceProviderExtensions.ToValueString(value));
        }
    }
}
