...
{
    /// <inheritdoc />
    public sealed class CreateVonagePhoneNumberDTOProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateVonagePhoneNumberDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateVonagePhoneNumberDTOProviderExtensions.ToValueString(value));
        }
    }
}
