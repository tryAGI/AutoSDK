...
{
    /// <inheritdoc />
    public sealed class LMNTVoiceLanguageJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.LMNTVoiceLanguage>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.LMNTVoiceLanguageExtensions.ToValueString(value));
        }
    }
}
