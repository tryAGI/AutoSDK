...
{
    /// <inheritdoc />
    public sealed class FallbackGoogleTranscriberModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackGoogleTranscriberModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackGoogleTranscriberModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
