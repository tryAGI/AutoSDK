...
{
    /// <inheritdoc />
    public sealed class ChatEvalSystemMessageMockRoleNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ChatEvalSystemMessageMockRole?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ChatEvalSystemMessageMockRoleExtensions.ToValueString(value.Value));
            }
        }
    }
}
