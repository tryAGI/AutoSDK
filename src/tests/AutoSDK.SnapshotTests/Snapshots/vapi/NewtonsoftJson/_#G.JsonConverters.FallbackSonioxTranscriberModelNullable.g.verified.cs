...
{
    /// <inheritdoc />
    public sealed class FallbackSonioxTranscriberModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackSonioxTranscriberModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackSonioxTranscriberModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
