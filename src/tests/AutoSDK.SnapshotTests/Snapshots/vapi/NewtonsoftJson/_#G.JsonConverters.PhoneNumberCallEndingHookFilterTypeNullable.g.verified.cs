...
{
    /// <inheritdoc />
    public sealed class PhoneNumberCallEndingHookFilterTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.PhoneNumberCallEndingHookFilterType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.PhoneNumberCallEndingHookFilterTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
