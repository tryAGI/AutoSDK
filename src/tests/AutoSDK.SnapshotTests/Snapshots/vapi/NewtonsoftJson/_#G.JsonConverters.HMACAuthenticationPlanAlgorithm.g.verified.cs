...
{
    /// <inheritdoc />
    public sealed class HMACAuthenticationPlanAlgorithmJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.HMACAuthenticationPlanAlgorithm>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.HMACAuthenticationPlanAlgorithmExtensions.ToValueString(value));
        }
    }
}
