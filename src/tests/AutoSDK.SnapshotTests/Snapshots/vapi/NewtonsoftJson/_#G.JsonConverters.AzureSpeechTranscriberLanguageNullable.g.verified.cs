...
{
    /// <inheritdoc />
    public sealed class AzureSpeechTranscriberLanguageNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.AzureSpeechTranscriberLanguage?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.AzureSpeechTranscriberLanguageExtensions.ToValueString(value.Value));
            }
        }
    }
}
