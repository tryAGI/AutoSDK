...
{
    /// <inheritdoc />
    public sealed class ClientMessageSpeechUpdateStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClientMessageSpeechUpdateStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ClientMessageSpeechUpdateStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
