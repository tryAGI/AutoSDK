...
{
    /// <inheritdoc />
    public sealed class SimulationRunTargetSquadTypeJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SimulationRunTargetSquadType>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.SimulationRunTargetSquadTypeExtensions.ToValueString(value));
        }
    }
}
