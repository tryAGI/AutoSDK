...
{
    /// <inheritdoc />
    public sealed class TransferAssistantModelProviderJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TransferAssistantModelProvider>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.TransferAssistantModelProviderExtensions.ToValueString(value));
        }
    }
}
