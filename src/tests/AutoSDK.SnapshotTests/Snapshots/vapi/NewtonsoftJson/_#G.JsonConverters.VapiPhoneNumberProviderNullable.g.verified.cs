...
{
    /// <inheritdoc />
    public sealed class VapiPhoneNumberProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VapiPhoneNumberProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VapiPhoneNumberProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
