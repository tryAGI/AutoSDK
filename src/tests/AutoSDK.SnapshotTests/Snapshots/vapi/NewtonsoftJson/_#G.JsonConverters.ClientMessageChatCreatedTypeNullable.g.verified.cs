...
{
    /// <inheritdoc />
    public sealed class ClientMessageChatCreatedTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ClientMessageChatCreatedType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ClientMessageChatCreatedTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
