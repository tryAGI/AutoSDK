...
{
    /// <inheritdoc />
    public sealed class OpenRouterModelProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.OpenRouterModelProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.OpenRouterModelProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
