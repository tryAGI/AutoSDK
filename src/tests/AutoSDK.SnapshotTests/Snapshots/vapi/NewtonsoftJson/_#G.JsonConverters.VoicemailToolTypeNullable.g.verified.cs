...
{
    /// <inheritdoc />
    public sealed class VoicemailToolTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VoicemailToolType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VoicemailToolTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
