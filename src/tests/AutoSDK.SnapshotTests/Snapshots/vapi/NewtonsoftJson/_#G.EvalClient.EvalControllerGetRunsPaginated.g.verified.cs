//HintName: G.EvalClient.EvalControllerGetRunsPaginated.g.cs
...
namespace G
{
    public partial class EvalClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_EvalControllerGetRunsPaginatedSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_EvalControllerGetRunsPaginatedSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_EvalControllerGetRunsPaginatedSecurityRequirement0,
            };
        partial void PrepareEvalControllerGetRunsPaginatedArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? id,
            ref double? page,
            ref global::G.EvalControllerGetRunsPaginatedSortOrder? sortOrder,
            ref double? limit,
        ...
        partial void PrepareEvalControllerGetRunsPaginatedRequest(
            ...
            string? id,
            double? page,
            global::G.EvalControllerGetRunsPaginatedSortOrder? sortOrder,
            double? limit,
        ...
        partial void ProcessEvalControllerGetRunsPaginatedResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.EvalRunPaginatedResponse> EvalControllerGetRunsPaginatedAsync(
            string? id = default,
            double? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvalRunPaginatedResponse>> EvalControllerGetRunsPaginatedAsResponseAsync(
            string? id = default,
            double? page = default,
            global::G.EvalControllerGetRunsPaginatedSortOrder? sortOrder = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvalControllerGetRunsPaginatedSecurityRequirements,
                operationName: "EvalControllerGetRunsPaginatedAsync");

            var sortOrderValue = sortOrder switch
            {
                global::G.EvalControllerGetRunsPaginatedSortOrder.Asc => "ASC",
                global::G.EvalControllerGetRunsPaginatedSortOrder.Desc => "DESC",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvalControllerGetRunsPaginated",
                                methodName: "EvalControllerGetRunsPaginatedAsync",
                                pathTemplate: "\"/eval/run\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvalControllerGetRunsPaginatedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvalControllerGetRunsPaginatedResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.EvalRunPaginatedResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.EvalRunPaginatedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.EvalRunPaginatedResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
