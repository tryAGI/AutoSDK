...
{
    /// <inheritdoc />
    public sealed class TextEditorToolNameNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TextEditorToolName?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TextEditorToolNameExtensions.ToValueString(value.Value));
            }
        }
    }
}
