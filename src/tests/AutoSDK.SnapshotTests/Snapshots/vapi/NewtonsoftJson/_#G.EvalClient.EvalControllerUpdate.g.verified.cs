//HintName: G.EvalClient.EvalControllerUpdate.g.cs
...
namespace G
{
    public partial class EvalClient
    {
        ...
        private static readonly global::G.EndPointSecurityRequirement s_EvalControllerUpdateSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_EvalControllerUpdateSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_EvalControllerUpdateSecurityRequirement0,
            };
        ...
        partial void ProcessEvalControllerUpdateResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Eval> EvalControllerUpdateAsync(
            string id,
        ...
        {
            var __response = await EvalControllerUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.Eval>> EvalControllerUpdateAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareEvalControllerUpdateArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EvalControllerUpdateSecurityRequirements,
                operationName: "EvalControllerUpdateAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEvalControllerUpdateRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "EvalControllerUpdate",
                                methodName: "EvalControllerUpdateAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEvalControllerUpdateResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEvalControllerUpdateResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.Eval> EvalControllerUpdateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::G.UpdateEvalDTO
            {
                Messages = messages,
                Name = name,
            ...
            return await EvalControllerUpdateAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
