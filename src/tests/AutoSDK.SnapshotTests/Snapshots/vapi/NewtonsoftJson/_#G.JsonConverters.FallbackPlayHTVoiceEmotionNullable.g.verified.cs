...
{
    /// <inheritdoc />
    public sealed class FallbackPlayHTVoiceEmotionNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackPlayHTVoiceEmotion?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackPlayHTVoiceEmotionExtensions.ToValueString(value.Value));
            }
        }
    }
}
