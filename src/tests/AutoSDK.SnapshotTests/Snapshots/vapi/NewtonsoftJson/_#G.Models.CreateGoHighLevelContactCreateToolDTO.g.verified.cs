//HintName: G.Models.CreateGoHighLevelContactCreateToolDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateGoHighLevelContactCreateToolDTO
    {
        ...
        [global::Newtonsoft.Json.JsonConverter(typeof(global::G.JsonConverters.CreateGoHighLevelContactCreateToolDTOTypeJsonConverter))]
        public global::G.CreateGoHighLevelContactCreateToolDTOType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGoHighLevelContactCreateToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
        ...
        /// ```
        /// </param>
        public CreateGoHighLevelContactCreateToolDTO(
            ...
            global::G.CreateGoHighLevelContactCreateToolDTOType type,
