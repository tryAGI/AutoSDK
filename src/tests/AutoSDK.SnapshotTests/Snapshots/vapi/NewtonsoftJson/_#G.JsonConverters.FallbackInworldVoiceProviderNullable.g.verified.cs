...
{
    /// <inheritdoc />
    public sealed class FallbackInworldVoiceProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackInworldVoiceProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackInworldVoiceProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
