...
{
    /// <inheritdoc />
    public sealed class DeepInfraCredentialProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.DeepInfraCredentialProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.DeepInfraCredentialProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
