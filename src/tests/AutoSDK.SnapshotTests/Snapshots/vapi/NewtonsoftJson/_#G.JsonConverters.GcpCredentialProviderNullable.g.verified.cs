...
{
    /// <inheritdoc />
    public sealed class GcpCredentialProviderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GcpCredentialProvider?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GcpCredentialProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
