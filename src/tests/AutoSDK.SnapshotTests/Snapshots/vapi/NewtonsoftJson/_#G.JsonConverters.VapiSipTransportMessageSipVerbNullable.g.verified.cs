...
{
    /// <inheritdoc />
    public sealed class VapiSipTransportMessageSipVerbNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.VapiSipTransportMessageSipVerb?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.VapiSipTransportMessageSipVerbExtensions.ToValueString(value.Value));
            }
        }
    }
}
