...
{
    /// <inheritdoc />
    public sealed class SipRequestToolVerbNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SipRequestToolVerb?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SipRequestToolVerbExtensions.ToValueString(value.Value));
            }
        }
    }
}
