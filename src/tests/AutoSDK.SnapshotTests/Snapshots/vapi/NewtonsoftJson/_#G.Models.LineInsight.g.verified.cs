//HintName: G.Models.LineInsight.g.cs
...
namespace G
{
    ...
    public sealed partial class LineInsight
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LineInsight" /> class.
        /// </summary>
        /// <param name="queries">
        /// These are the queries to run to generate the insight.
        /// </param>
        ...
        public LineInsight(
            ...
            global::G.LineInsightGroupBy? groupBy)
        {
            this.Name = name;
            this.Type = type;
