...
{
    /// <inheritdoc />
    public sealed class GetEvalPaginatedDTOSortOrderNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.GetEvalPaginatedDTOSortOrder?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.GetEvalPaginatedDTOSortOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
