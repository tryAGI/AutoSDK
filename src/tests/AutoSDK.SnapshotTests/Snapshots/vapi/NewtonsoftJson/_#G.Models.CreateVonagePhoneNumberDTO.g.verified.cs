//HintName: G.Models.CreateVonagePhoneNumberDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateVonagePhoneNumberDTO
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateVonagePhoneNumberDTO" /> class.
        /// </summary>
        /// <param name="number">
        /// These are the digits of the phone number you own on your Vonage.
        /// </param>
        ...
        /// 3. org.server
        /// </param>
        public CreateVonagePhoneNumberDTO(
            string number,
            string credentialId,
            ...
            global::G.CreateVonagePhoneNumberDTOProvider provider,
            string? name,
            string? assistantId,
            string? workflowId,
            string? squadId,
