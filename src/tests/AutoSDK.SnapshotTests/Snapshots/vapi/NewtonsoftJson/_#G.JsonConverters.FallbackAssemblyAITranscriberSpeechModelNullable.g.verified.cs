...
{
    /// <inheritdoc />
    public sealed class FallbackAssemblyAITranscriberSpeechModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackAssemblyAITranscriberSpeechModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackAssemblyAITranscriberSpeechModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
