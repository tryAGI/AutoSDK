...
{
    /// <inheritdoc />
    public sealed class FallbackRimeAIVoiceModelNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.FallbackRimeAIVoiceModel?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.FallbackRimeAIVoiceModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
