...
{
    /// <inheritdoc />
    public sealed class ContextEngineeringPlanNoneTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.ContextEngineeringPlanNoneType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.ContextEngineeringPlanNoneTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
