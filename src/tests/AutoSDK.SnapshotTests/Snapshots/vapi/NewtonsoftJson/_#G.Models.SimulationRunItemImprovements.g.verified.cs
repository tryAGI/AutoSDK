...
namespace G
{
    ...
    public sealed partial class SimulationRunItemImprovements
    {
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("systemPromptSuggestions", Required = global::Newtonsoft.Json.Required.Always)]
        public global::System.Collections.Generic.IList<global::G.SimulationRunItemImprovementSuggestion> SystemPromptSuggestions { get; set; } = default!;

        /// <summary>
        /// This is the list of suggestions for improving tools.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("toolSuggestions", Required = global::Newtonsoft.Json.Required.Always)]
        public global::System.Collections.Generic.IList<global::G.SimulationRunItemImprovementSuggestion> ToolSuggestions { get; set; } = default!;

        /// <summary>
        /// This is the list of suggestions for improving the scenario/evaluation plan.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("scenarioSuggestions", Required = global::Newtonsoft.Json.Required.Always)]
        public global::System.Collections.Generic.IList<global::G.SimulationRunItemImprovementSuggestion> ScenarioSuggestions { get; set; } = default!;

        /// <summary>
        /// This is a complete revised system prompt if major changes are needed.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("suggestedSystemPrompt")]
