...
{
    /// <inheritdoc />
    public sealed class SimulationRunSuiteEntryTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SimulationRunSuiteEntryType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SimulationRunSuiteEntryTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
