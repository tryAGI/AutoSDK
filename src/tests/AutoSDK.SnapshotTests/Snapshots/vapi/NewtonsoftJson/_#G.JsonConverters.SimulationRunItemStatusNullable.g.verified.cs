...
{
    /// <inheritdoc />
    public sealed class SimulationRunItemStatusNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.SimulationRunItemStatus?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.SimulationRunItemStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
