...
{
    /// <inheritdoc />
    public sealed class CreateTokenDTOTagJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.CreateTokenDTOTag>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            writer.WriteValue(global::G.CreateTokenDTOTagExtensions.ToValueString(value));
        }
    }
}
