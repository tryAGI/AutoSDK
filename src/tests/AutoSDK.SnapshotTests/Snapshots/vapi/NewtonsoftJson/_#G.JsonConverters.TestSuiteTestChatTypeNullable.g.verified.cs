...
{
    /// <inheritdoc />
    public sealed class TestSuiteTestChatTypeNullableJsonConverter : global::Newtonsoft.Json.JsonConverter<global::G.TestSuiteTestChatType?>
    {
        /// <inheritdoc />
            ...
            global::Newtonsoft.Json.JsonSerializer serializer)
        {
            ...
            {
                writer.WriteValue(global::G.TestSuiteTestChatTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
