...
{
    /// <inheritdoc />
    public sealed class ChatEvalAssistantMessageEvaluationRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatEvalAssistantMessageEvaluationRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatEvalAssistantMessageEvaluationRoleExtensions.ToValueString(value));
        }
    }
}
