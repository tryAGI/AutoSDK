...
{
    /// <inheritdoc />
    public sealed class CreateWellSaidCredentialDTOProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateWellSaidCredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateWellSaidCredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
