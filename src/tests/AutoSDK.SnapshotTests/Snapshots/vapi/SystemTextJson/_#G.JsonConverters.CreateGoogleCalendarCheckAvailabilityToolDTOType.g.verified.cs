...
{
    /// <inheritdoc />
    public sealed class CreateGoogleCalendarCheckAvailabilityToolDTOTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateGoogleCalendarCheckAvailabilityToolDTOType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateGoogleCalendarCheckAvailabilityToolDTOTypeExtensions.ToValueString(value));
        }
    }
}
