//HintName: G.Models.UpdateEvalDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateEvalDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.UpdateEvalDTOTypeJsonConverter))]
        public global::G.UpdateEvalDTOType? Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateEvalDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// This is the mock conversation that will be used to evaluate the flow of the conversation.<br/>
        /// Mock Messages are used to simulate the flow of the conversation<br/>
        ...
        public UpdateEvalDTO(
            ...
            string? name,
            string? description,
            global::G.UpdateEvalDTOType? type)
        {
