//HintName: G.Models.CreateGoHighLevelContactGetToolDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateGoHighLevelContactGetToolDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CreateGoHighLevelContactGetToolDTOTypeJsonConverter))]
        public global::G.CreateGoHighLevelContactGetToolDTOType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGoHighLevelContactGetToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
...
#endif
        public CreateGoHighLevelContactGetToolDTO(
            ...
            global::G.CreateGoHighLevelContactGetToolDTOType type,
