...
{
    /// <inheritdoc />
    public sealed class OpenAIVoiceVoiceIdNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OpenAIVoiceVoiceId?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.OpenAIVoiceVoiceIdExtensions.ToValueString(value.Value));
            }
        }
    }
}
