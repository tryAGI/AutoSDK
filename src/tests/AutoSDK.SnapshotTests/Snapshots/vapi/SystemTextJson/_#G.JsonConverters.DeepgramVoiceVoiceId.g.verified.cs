...
{
    /// <inheritdoc />
    public sealed class DeepgramVoiceVoiceIdJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DeepgramVoiceVoiceId>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.DeepgramVoiceVoiceIdExtensions.ToValueString(value));
        }
    }
}
