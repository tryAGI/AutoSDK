...
{
    /// <inheritdoc />
    public sealed class JsonSchemaFormatJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.JsonSchemaFormat>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.JsonSchemaFormatExtensions.ToValueString(value));
        }
    }
}
