...
{
    /// <inheritdoc />
    public sealed class ElevenLabsTranscriberModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ElevenLabsTranscriberModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ElevenLabsTranscriberModelExtensions.ToValueString(value));
        }
    }
}
