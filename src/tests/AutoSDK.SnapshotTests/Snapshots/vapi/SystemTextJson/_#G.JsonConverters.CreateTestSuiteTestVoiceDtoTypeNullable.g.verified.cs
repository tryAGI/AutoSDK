...
{
    /// <inheritdoc />
    public sealed class CreateTestSuiteTestVoiceDtoTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTestSuiteTestVoiceDtoType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateTestSuiteTestVoiceDtoTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
