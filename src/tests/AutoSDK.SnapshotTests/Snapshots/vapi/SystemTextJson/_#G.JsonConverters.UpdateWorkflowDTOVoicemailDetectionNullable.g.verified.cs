...
{
    /// <inheritdoc />
    public sealed class UpdateWorkflowDTOVoicemailDetectionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateWorkflowDTOVoicemailDetection?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateWorkflowDTOVoicemailDetectionExtensions.ToValueString(value.Value));
            }
        }
    }
}
