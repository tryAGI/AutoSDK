//HintName: G.InsightClient.InsightControllerFindAll.g.cs

#nullable enable

namespace G
{
    public partial class InsightClient
    {


        private static readonly global::G.EndPointSecurityRequirement s_InsightControllerFindAllSecurityRequirement0 =
        ...
        private static readonly global::G.EndPointSecurityRequirement[] s_InsightControllerFindAllSecurityRequirements =
            new global::G.EndPointSecurityRequirement[]
            {                s_InsightControllerFindAllSecurityRequirement0,
            };
        partial void PrepareInsightControllerFindAllArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? id,
            ref double? page,
            ref global::G.InsightControllerFindAllSortOrder? sortOrder,
            ref double? limit,
        ...
        partial void PrepareInsightControllerFindAllRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? id,
            double? page,
            global::G.InsightControllerFindAllSortOrder? sortOrder,
            double? limit,
        ...
        partial void ProcessInsightControllerFindAllResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessInsightControllerFindAllResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::G.InsightPaginatedResponse> InsightControllerFindAllAsync(
            string? id = default,
            double? page = default,
            global::G.InsightControllerFindAllSortOrder? sortOrder = default,
        ...
        {
            var __response = await InsightControllerFindAllAsResponseAsync(
                id: id,
                page: page,
                sortOrder: sortOrder,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.InsightPaginatedResponse>> InsightControllerFindAllAsResponseAsync(
            string? id = default,
            double? page = default,
            global::G.InsightControllerFindAllSortOrder? sortOrder = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareInsightControllerFindAllArguments(
            ...
            var __authorizations = global::G.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_InsightControllerFindAllSecurityRequirements,
                operationName: "InsightControllerFindAllAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareInsightControllerFindAllRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "InsightControllerFindAll",
                                methodName: "InsightControllerFindAllAsync",
                                pathTemplate: "\"/reporting/insight\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessInsightControllerFindAllResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessInsightControllerFindAllResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.InsightPaginatedResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.InsightPaginatedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.InsightPaginatedResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
