//HintName: G.JsonConverters.InsightControllerFindOneResponse.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class InsightControllerFindOneResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InsightControllerFindOneResponse>
    {
        /// <inheritdoc />
        public override global::G.InsightControllerFindOneResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.InsightControllerFindOneResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.InsightControllerFindOneResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.InsightControllerFindOneResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.BarInsight? bar = default;
            if (discriminator?.Type == global::G.InsightControllerFindOneResponseDiscriminatorType.Bar)
            {
            ...
            if (discriminator?.Type == global::G.InsightControllerFindOneResponseDiscriminatorType.Pie)
            {
            ...
            if (discriminator?.Type == global::G.InsightControllerFindOneResponseDiscriminatorType.Line)
            {
            ...
            if (discriminator?.Type == global::G.InsightControllerFindOneResponseDiscriminatorType.Text)
            {
            ...
            var __value = new global::G.InsightControllerFindOneResponse(
                discriminator?.Type,
                bar,
        ...
        public override void Write(
            ...
            global::G.InsightControllerFindOneResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
