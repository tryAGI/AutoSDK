...
{
    /// <inheritdoc />
    public sealed class AzureOpenAICredentialModelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AzureOpenAICredentialModel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AzureOpenAICredentialModelExtensions.ToValueString(value.Value));
            }
        }
    }
}
