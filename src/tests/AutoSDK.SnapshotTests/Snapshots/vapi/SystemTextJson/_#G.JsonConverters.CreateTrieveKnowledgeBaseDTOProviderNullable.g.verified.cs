...
{
    /// <inheritdoc />
    public sealed class CreateTrieveKnowledgeBaseDTOProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTrieveKnowledgeBaseDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateTrieveKnowledgeBaseDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
