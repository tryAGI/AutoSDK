...
{
    /// <inheritdoc />
    public sealed class InsightControllerRemoveResponseDiscriminatorTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InsightControllerRemoveResponseDiscriminatorType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.InsightControllerRemoveResponseDiscriminatorTypeExtensions.ToValueString(value));
        }
    }
}
