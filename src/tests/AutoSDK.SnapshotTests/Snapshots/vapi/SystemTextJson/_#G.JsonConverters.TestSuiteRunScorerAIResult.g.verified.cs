...
{
    /// <inheritdoc />
    public sealed class TestSuiteRunScorerAIResultJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TestSuiteRunScorerAIResult>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TestSuiteRunScorerAIResultExtensions.ToValueString(value));
        }
    }
}
