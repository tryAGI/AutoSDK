...
{
    /// <inheritdoc />
    public sealed class AzureVoiceVoiceIdJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AzureVoiceVoiceId>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AzureVoiceVoiceIdExtensions.ToValueString(value));
        }
    }
}
