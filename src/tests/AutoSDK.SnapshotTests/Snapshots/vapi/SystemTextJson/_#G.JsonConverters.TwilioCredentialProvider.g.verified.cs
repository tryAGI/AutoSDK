...
{
    /// <inheritdoc />
    public sealed class TwilioCredentialProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TwilioCredentialProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TwilioCredentialProviderExtensions.ToValueString(value));
        }
    }
}
