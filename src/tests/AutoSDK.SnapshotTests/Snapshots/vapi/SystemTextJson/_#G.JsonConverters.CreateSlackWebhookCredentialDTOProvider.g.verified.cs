...
{
    /// <inheritdoc />
    public sealed class CreateSlackWebhookCredentialDTOProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateSlackWebhookCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateSlackWebhookCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
