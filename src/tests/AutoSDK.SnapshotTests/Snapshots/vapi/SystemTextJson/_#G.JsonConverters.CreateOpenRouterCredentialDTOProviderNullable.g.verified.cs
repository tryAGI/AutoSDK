...
{
    /// <inheritdoc />
    public sealed class CreateOpenRouterCredentialDTOProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateOpenRouterCredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateOpenRouterCredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
