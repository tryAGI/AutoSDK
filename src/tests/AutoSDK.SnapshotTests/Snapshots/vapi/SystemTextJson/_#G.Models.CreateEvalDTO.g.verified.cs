//HintName: G.Models.CreateEvalDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateEvalDTO
    {
        /// <summary>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CreateEvalDTOTypeJsonConverter))]
        public global::G.CreateEvalDTOType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEvalDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// This is the mock conversation that will be used to evaluate the flow of the conversation.<br/>
        /// Mock Messages are used to simulate the flow of the conversation<br/>
        ...
        public CreateEvalDTO(
            ...
            string? name,
            string? description,
            global::G.CreateEvalDTOType type)
        {
