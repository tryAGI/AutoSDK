...
{
    /// <inheritdoc />
    public sealed class CreateToolTemplateDTOVisibilityNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateToolTemplateDTOVisibility?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateToolTemplateDTOVisibilityExtensions.ToValueString(value.Value));
            }
        }
    }
}
