...
{
    /// <inheritdoc />
    public sealed class PieInsightFromCallTableGroupByNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PieInsightFromCallTableGroupBy?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PieInsightFromCallTableGroupByExtensions.ToValueString(value.Value));
            }
        }
    }
}
