...
{
    /// <inheritdoc />
    public sealed class CreateBarInsightFromCallTableDTOGroupByNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateBarInsightFromCallTableDTOGroupBy?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateBarInsightFromCallTableDTOGroupByExtensions.ToValueString(value.Value));
            }
        }
    }
}
