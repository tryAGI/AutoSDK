...
{
    /// <inheritdoc />
    public sealed class ClientMessageChatCreatedTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ClientMessageChatCreatedType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ClientMessageChatCreatedTypeExtensions.ToValueString(value));
        }
    }
}
