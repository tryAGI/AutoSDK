...
{
    /// <inheritdoc />
    public sealed class TalkscriberTranscriberLanguageNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TalkscriberTranscriberLanguage?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TalkscriberTranscriberLanguageExtensions.ToValueString(value.Value));
            }
        }
    }
}
