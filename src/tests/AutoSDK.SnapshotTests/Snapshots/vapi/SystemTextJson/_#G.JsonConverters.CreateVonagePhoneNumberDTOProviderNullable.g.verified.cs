...
{
    /// <inheritdoc />
    public sealed class CreateVonagePhoneNumberDTOProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateVonagePhoneNumberDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateVonagePhoneNumberDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
