...
{
    /// <inheritdoc />
    public sealed class FallbackSonioxTranscriberModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FallbackSonioxTranscriberModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FallbackSonioxTranscriberModelExtensions.ToValueString(value));
        }
    }
}
