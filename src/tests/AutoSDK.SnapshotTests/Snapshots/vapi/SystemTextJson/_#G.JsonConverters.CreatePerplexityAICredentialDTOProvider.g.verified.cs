...
{
    /// <inheritdoc />
    public sealed class CreatePerplexityAICredentialDTOProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreatePerplexityAICredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreatePerplexityAICredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
