...
{
    /// <inheritdoc />
    public sealed class LineInsightFromCallTableGroupByNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LineInsightFromCallTableGroupBy?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.LineInsightFromCallTableGroupByExtensions.ToValueString(value.Value));
            }
        }
    }
}
