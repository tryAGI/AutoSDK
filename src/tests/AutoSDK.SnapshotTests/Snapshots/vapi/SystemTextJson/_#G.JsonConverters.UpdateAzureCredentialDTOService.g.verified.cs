...
{
    /// <inheritdoc />
    public sealed class UpdateAzureCredentialDTOServiceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateAzureCredentialDTOService>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.UpdateAzureCredentialDTOServiceExtensions.ToValueString(value));
        }
    }
}
