//HintName: G.JsonConverters.AuthenticationPlan8.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class AuthenticationPlan8JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AuthenticationPlan8>
    {
        /// <inheritdoc />
        public override global::G.AuthenticationPlan8 Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.UpdateWebhookCredentialDTOAuthenticationPlanDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.UpdateWebhookCredentialDTOAuthenticationPlanDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.UpdateWebhookCredentialDTOAuthenticationPlanDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.OAuth2AuthenticationPlan? oauth2 = default;
            if (discriminator?.Type == global::G.UpdateWebhookCredentialDTOAuthenticationPlanDiscriminatorType.Oauth2)
            {
            ...
            if (discriminator?.Type == global::G.UpdateWebhookCredentialDTOAuthenticationPlanDiscriminatorType.Hmac)
            {
            ...
            if (discriminator?.Type == global::G.UpdateWebhookCredentialDTOAuthenticationPlanDiscriminatorType.Bearer)
            {
            ...
            var __value = new global::G.AuthenticationPlan8(
                discriminator?.Type,
                oauth2,
        ...
        public override void Write(
            ...
            global::G.AuthenticationPlan8 value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
