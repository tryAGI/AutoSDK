...
{
    /// <inheritdoc />
    public sealed class GetEvalPaginatedDTOSortOrderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetEvalPaginatedDTOSortOrder>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.GetEvalPaginatedDTOSortOrderExtensions.ToValueString(value));
        }
    }
}
