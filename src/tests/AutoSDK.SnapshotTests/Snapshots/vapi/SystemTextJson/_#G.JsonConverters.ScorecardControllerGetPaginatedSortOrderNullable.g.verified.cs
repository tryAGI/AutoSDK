...
{
    /// <inheritdoc />
    public sealed class ScorecardControllerGetPaginatedSortOrderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ScorecardControllerGetPaginatedSortOrder?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ScorecardControllerGetPaginatedSortOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
