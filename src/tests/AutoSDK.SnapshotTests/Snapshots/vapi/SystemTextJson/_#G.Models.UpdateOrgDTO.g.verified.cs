//HintName: G.Models.UpdateOrgDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateOrgDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.UpdateOrgDTOChannelJsonConverter))]
        public global::G.UpdateOrgDTOChannel? Channel { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateOrgDTO" /> class.
        /// </summary>
        ...
        public UpdateOrgDTO(
            ...
            string? name,
            global::G.UpdateOrgDTOChannel? channel,
            double? billingLimit,
