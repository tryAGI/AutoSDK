...
{
    /// <inheritdoc />
    public sealed class FallbackAzureSpeechTranscriberLanguageJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FallbackAzureSpeechTranscriberLanguage>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.FallbackAzureSpeechTranscriberLanguageExtensions.ToValueString(value));
        }
    }
}
