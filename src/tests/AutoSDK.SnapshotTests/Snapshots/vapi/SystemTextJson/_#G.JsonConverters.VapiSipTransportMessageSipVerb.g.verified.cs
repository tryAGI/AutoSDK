...
{
    /// <inheritdoc />
    public sealed class VapiSipTransportMessageSipVerbJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.VapiSipTransportMessageSipVerb>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.VapiSipTransportMessageSipVerbExtensions.ToValueString(value));
        }
    }
}
