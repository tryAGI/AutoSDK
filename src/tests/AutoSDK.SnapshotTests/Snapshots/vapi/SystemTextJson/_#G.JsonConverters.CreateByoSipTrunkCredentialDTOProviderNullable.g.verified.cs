...
{
    /// <inheritdoc />
    public sealed class CreateByoSipTrunkCredentialDTOProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateByoSipTrunkCredentialDTOProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.CreateByoSipTrunkCredentialDTOProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
