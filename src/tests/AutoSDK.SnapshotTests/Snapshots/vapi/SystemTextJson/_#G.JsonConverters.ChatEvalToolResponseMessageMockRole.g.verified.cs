...
{
    /// <inheritdoc />
    public sealed class ChatEvalToolResponseMessageMockRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatEvalToolResponseMessageMockRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatEvalToolResponseMessageMockRoleExtensions.ToValueString(value));
        }
    }
}
