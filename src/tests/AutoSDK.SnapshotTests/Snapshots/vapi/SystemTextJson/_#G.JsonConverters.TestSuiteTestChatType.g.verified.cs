...
{
    /// <inheritdoc />
    public sealed class TestSuiteTestChatTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TestSuiteTestChatType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TestSuiteTestChatTypeExtensions.ToValueString(value));
        }
    }
}
