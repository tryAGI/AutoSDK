...
{
    /// <inheritdoc />
    public sealed class LiquidConditionTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.LiquidConditionType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.LiquidConditionTypeExtensions.ToValueString(value));
        }
    }
}
