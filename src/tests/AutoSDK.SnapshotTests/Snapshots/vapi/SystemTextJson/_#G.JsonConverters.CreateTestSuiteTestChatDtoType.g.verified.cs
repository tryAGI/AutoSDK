...
{
    /// <inheritdoc />
    public sealed class CreateTestSuiteTestChatDtoTypeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateTestSuiteTestChatDtoType>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateTestSuiteTestChatDtoTypeExtensions.ToValueString(value));
        }
    }
}
