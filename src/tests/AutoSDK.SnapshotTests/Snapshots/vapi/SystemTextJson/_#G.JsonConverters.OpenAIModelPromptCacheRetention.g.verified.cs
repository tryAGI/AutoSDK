...
{
    /// <inheritdoc />
    public sealed class OpenAIModelPromptCacheRetentionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.OpenAIModelPromptCacheRetention>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.OpenAIModelPromptCacheRetentionExtensions.ToValueString(value));
        }
    }
}
