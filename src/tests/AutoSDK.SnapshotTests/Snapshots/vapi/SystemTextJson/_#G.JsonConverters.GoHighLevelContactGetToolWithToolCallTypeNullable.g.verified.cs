...
{
    /// <inheritdoc />
    public sealed class GoHighLevelContactGetToolWithToolCallTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GoHighLevelContactGetToolWithToolCallType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GoHighLevelContactGetToolWithToolCallTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
