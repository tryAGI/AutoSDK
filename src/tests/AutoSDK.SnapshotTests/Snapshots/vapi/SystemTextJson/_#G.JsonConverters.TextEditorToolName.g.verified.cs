...
{
    /// <inheritdoc />
    public sealed class TextEditorToolNameJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TextEditorToolName>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TextEditorToolNameExtensions.ToValueString(value));
        }
    }
}
