//HintName: G.JsonConverters.PhoneNumberControllerFindOneResponse.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class PhoneNumberControllerFindOneResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PhoneNumberControllerFindOneResponse>
    {
        /// <inheritdoc />
        public override global::G.PhoneNumberControllerFindOneResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.PhoneNumberControllerFindOneResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.PhoneNumberControllerFindOneResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.PhoneNumberControllerFindOneResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.ByoPhoneNumber? byoPhoneNumber = default;
            if (discriminator?.Provider == global::G.PhoneNumberControllerFindOneResponseDiscriminatorProvider.ByoPhoneNumber)
            {
            ...
            if (discriminator?.Provider == global::G.PhoneNumberControllerFindOneResponseDiscriminatorProvider.Twilio)
            {
            ...
            if (discriminator?.Provider == global::G.PhoneNumberControllerFindOneResponseDiscriminatorProvider.Vonage)
            {
            ...
            if (discriminator?.Provider == global::G.PhoneNumberControllerFindOneResponseDiscriminatorProvider.Vapi)
            {
            ...
            if (discriminator?.Provider == global::G.PhoneNumberControllerFindOneResponseDiscriminatorProvider.Telnyx)
            {
            ...
            var __value = new global::G.PhoneNumberControllerFindOneResponse(
        ...
        public override void Write(
            ...
            global::G.PhoneNumberControllerFindOneResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
