//HintName: G.Models.CreateGoogleCalendarCheckAvailabilityToolDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class CreateGoogleCalendarCheckAvailabilityToolDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CreateGoogleCalendarCheckAvailabilityToolDTOTypeJsonConverter))]
        public global::G.CreateGoogleCalendarCheckAvailabilityToolDTOType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateGoogleCalendarCheckAvailabilityToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
...
#endif
        public CreateGoogleCalendarCheckAvailabilityToolDTO(
            ...
            global::G.CreateGoogleCalendarCheckAvailabilityToolDTOType type,
