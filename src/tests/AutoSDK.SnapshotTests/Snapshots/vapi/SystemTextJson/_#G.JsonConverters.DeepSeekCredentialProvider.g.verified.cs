...
{
    /// <inheritdoc />
    public sealed class DeepSeekCredentialProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DeepSeekCredentialProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.DeepSeekCredentialProviderExtensions.ToValueString(value));
        }
    }
}
