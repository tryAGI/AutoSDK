...
{
    /// <inheritdoc />
    public sealed class DeepSeekModelModelJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.DeepSeekModelModel>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.DeepSeekModelModelExtensions.ToValueString(value));
        }
    }
}
