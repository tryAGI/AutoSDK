...
{
    /// <inheritdoc />
    public sealed class TimeRangeStepNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TimeRangeStep?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TimeRangeStepExtensions.ToValueString(value.Value));
            }
        }
    }
}
