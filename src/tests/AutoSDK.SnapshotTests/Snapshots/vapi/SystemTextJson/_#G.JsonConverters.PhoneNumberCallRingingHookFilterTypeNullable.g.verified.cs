...
{
    /// <inheritdoc />
    public sealed class PhoneNumberCallRingingHookFilterTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PhoneNumberCallRingingHookFilterType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PhoneNumberCallRingingHookFilterTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
