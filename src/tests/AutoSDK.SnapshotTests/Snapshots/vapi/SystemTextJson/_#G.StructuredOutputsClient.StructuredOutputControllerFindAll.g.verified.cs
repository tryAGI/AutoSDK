...
namespace G
{
    public partial class StructuredOutputsClient
    {
        ...
        {
            var __response = await StructuredOutputControllerFindAllAsResponseAsync(
                id: id,
                name: name,
                page: page,
                sortOrder: sortOrder,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.StructuredOutputPaginatedResponse>> StructuredOutputControllerFindAllAsResponseAsync(
            string? id = default,
            string? name = default,
            double? page = default,
            global::G.StructuredOutputControllerFindAllSortOrder? sortOrder = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::G.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StructuredOutputControllerFindAll",
                                methodName: "StructuredOutputControllerFindAllAsync",
                    ...
                    await global::G.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::G.StructuredOutputPaginatedResponse.FromJson(__content, JsonSerializerOptions) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::G.AutoSDKHttpResponse<global::G.StructuredOutputPaginatedResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::G.StructuredOutputPaginatedResponse.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
