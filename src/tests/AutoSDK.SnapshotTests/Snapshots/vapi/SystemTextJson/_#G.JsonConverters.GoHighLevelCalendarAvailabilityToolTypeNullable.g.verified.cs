...
{
    /// <inheritdoc />
    public sealed class GoHighLevelCalendarAvailabilityToolTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GoHighLevelCalendarAvailabilityToolType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GoHighLevelCalendarAvailabilityToolTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
