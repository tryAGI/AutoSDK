//HintName: G.Models.TextInsightFromCallTable.g.cs
...
namespace G
{
    ...
    public sealed partial class TextInsightFromCallTable
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.TextInsightFromCallTableTypeJsonConverter))]
        public global::G.TextInsightFromCallTableType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextInsightFromCallTable" /> class.
        /// </summary>
        /// <param name="queries">
        /// These are the queries to run to generate the insight.<br/>
        /// For Text Insights, we only allow a single query, or require a formula if multiple queries are provided
...
#endif
        public TextInsightFromCallTable(
            ...
            string? name,
            global::G.TextInsightFromCallTableType type,
            object? formula,
