//HintName: G.IEvalClient.EvalControllerGetPaginated.g.cs
#nullable enable
...
namespace G
{
    public partial interface IEvalClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.EvalPaginatedResponse> EvalControllerGetPaginatedAsync(
            string? id = default,
            double? page = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.EvalPaginatedResponse>> EvalControllerGetPaginatedAsResponseAsync(
            string? id = default,
            double? page = default,
            global::G.EvalControllerGetPaginatedSortOrder? sortOrder = default,
            double? limit = default,
