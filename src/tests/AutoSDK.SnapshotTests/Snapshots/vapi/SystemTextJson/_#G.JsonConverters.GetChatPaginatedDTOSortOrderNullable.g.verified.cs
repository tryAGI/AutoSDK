...
{
    /// <inheritdoc />
    public sealed class GetChatPaginatedDTOSortOrderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.GetChatPaginatedDTOSortOrder?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.GetChatPaginatedDTOSortOrderExtensions.ToValueString(value.Value));
            }
        }
    }
}
