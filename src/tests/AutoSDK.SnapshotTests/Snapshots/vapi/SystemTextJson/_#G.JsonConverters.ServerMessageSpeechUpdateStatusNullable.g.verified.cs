...
{
    /// <inheritdoc />
    public sealed class ServerMessageSpeechUpdateStatusNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ServerMessageSpeechUpdateStatus?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ServerMessageSpeechUpdateStatusExtensions.ToValueString(value.Value));
            }
        }
    }
}
