...
{
    /// <inheritdoc />
    public sealed class TransferDestinationAssistantTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TransferDestinationAssistantType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.TransferDestinationAssistantTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
