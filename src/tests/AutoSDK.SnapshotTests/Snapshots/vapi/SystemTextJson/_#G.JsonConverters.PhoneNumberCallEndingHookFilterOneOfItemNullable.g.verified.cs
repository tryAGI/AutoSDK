...
{
    /// <inheritdoc />
    public sealed class PhoneNumberCallEndingHookFilterOneOfItemNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.PhoneNumberCallEndingHookFilterOneOfItem?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.PhoneNumberCallEndingHookFilterOneOfItemExtensions.ToValueString(value.Value));
            }
        }
    }
}
