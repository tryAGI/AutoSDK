//HintName: G.JsonConverters.InsightControllerUpdateResponse.g.cs
#nullable enable
...
{
    /// <inheritdoc />
    public class InsightControllerUpdateResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.InsightControllerUpdateResponse>
    {
        /// <inheritdoc />
        public override global::G.InsightControllerUpdateResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::G.InsightControllerUpdateResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::G.InsightControllerUpdateResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::G.InsightControllerUpdateResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::G.BarInsight? bar = default;
            if (discriminator?.Type == global::G.InsightControllerUpdateResponseDiscriminatorType.Bar)
            {
            ...
            if (discriminator?.Type == global::G.InsightControllerUpdateResponseDiscriminatorType.Pie)
            {
            ...
            if (discriminator?.Type == global::G.InsightControllerUpdateResponseDiscriminatorType.Line)
            {
            ...
            if (discriminator?.Type == global::G.InsightControllerUpdateResponseDiscriminatorType.Text)
            {
            ...
            var __value = new global::G.InsightControllerUpdateResponse(
                discriminator?.Type,
                bar,
        ...
        public override void Write(
            ...
            global::G.InsightControllerUpdateResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
