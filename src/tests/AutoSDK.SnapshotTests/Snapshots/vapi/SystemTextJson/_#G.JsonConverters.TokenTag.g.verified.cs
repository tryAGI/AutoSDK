...
{
    /// <inheritdoc />
    public sealed class TokenTagJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.TokenTag>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.TokenTagExtensions.ToValueString(value));
        }
    }
}
