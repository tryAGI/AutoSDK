...
{
    /// <inheritdoc />
    public sealed class SipRequestToolVerbJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SipRequestToolVerb>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.SipRequestToolVerbExtensions.ToValueString(value));
        }
    }
}
