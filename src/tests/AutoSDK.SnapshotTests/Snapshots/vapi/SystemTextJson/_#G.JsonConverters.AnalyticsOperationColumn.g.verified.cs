...
{
    /// <inheritdoc />
    public sealed class AnalyticsOperationColumnJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AnalyticsOperationColumn>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.AnalyticsOperationColumnExtensions.ToValueString(value));
        }
    }
}
