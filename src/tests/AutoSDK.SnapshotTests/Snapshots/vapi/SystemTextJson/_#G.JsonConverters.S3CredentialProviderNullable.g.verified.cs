...
{
    /// <inheritdoc />
    public sealed class S3CredentialProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.S3CredentialProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.S3CredentialProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
