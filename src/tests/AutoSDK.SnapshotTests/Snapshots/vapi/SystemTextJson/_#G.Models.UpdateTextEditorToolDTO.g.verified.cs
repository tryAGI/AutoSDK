//HintName: G.Models.UpdateTextEditorToolDTO.g.cs
...
namespace G
{
    ...
    public sealed partial class UpdateTextEditorToolDTO
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.UpdateTextEditorToolDTOSubTypeJsonConverter))]
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.UpdateTextEditorToolDTONameJsonConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateTextEditorToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
...
#endif
        public UpdateTextEditorToolDTO(
            ...
            global::G.UpdateTextEditorToolDTOSubType? subType,
            global::G.Server? server,
            global::G.ToolRejectionPlan? rejectionPlan,
            global::G.UpdateTextEditorToolDTOName? name)
        {
