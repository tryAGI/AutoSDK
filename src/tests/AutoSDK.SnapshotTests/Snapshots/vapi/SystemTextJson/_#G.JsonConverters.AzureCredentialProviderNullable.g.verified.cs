...
{
    /// <inheritdoc />
    public sealed class AzureCredentialProviderNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.AzureCredentialProvider?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.AzureCredentialProviderExtensions.ToValueString(value.Value));
            }
        }
    }
}
