...
{
    /// <inheritdoc />
    public sealed class HMACAuthenticationPlanAlgorithmNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.HMACAuthenticationPlanAlgorithm?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.HMACAuthenticationPlanAlgorithmExtensions.ToValueString(value.Value));
            }
        }
    }
}
