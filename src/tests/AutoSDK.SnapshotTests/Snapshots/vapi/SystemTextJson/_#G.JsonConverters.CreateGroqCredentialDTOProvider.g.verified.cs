...
{
    /// <inheritdoc />
    public sealed class CreateGroqCredentialDTOProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateGroqCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateGroqCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
