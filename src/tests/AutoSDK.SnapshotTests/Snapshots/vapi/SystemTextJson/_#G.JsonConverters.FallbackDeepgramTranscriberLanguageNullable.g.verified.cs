...
{
    /// <inheritdoc />
    public sealed class FallbackDeepgramTranscriberLanguageNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.FallbackDeepgramTranscriberLanguage?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.FallbackDeepgramTranscriberLanguageExtensions.ToValueString(value.Value));
            }
        }
    }
}
