...
{
    /// <inheritdoc />
    public sealed class UpdateBarInsightFromCallTableDTOTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.UpdateBarInsightFromCallTableDTOType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.UpdateBarInsightFromCallTableDTOTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
