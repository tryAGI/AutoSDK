...
{
    /// <inheritdoc />
    public sealed class SimulationRunTargetSquadTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.SimulationRunTargetSquadType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.SimulationRunTargetSquadTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
