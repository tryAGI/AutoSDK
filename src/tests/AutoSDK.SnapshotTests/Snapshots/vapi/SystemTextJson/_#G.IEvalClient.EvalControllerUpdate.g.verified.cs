//HintName: G.IEvalClient.EvalControllerUpdate.g.cs
#nullable enable
...
namespace G
{
    public partial interface IEvalClient
    {
        ...
        global::System.Threading.Tasks.Task<global::G.Eval> EvalControllerUpdateAsync(
            string id,
        ...
        global::System.Threading.Tasks.Task<global::G.Eval> EvalControllerUpdateAsync(
            ...
            global::G.UpdateEvalDTOType? type = default,
            global::G.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
    }
}