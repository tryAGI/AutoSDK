...
{
    /// <inheritdoc />
    public sealed class CreateCloudflareCredentialDTOProviderJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.CreateCloudflareCredentialDTOProvider>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.CreateCloudflareCredentialDTOProviderExtensions.ToValueString(value));
        }
    }
}
