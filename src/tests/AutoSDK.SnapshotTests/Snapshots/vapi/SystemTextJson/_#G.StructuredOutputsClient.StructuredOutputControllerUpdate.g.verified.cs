...
namespace G
{
    public partial class StructuredOutputsClient
    {
        ...
        {
            var __response = await StructuredOutputControllerUpdateAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::G.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::G.AutoSDKHttpResponse<global::G.StructuredOutput>> StructuredOutputControllerUpdateAsResponseAsync(
            string id,
            string schemaOverride,
