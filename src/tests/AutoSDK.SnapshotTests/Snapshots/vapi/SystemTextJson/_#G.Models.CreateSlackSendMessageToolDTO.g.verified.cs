//HintName: G.Models.CreateSlackSendMessageToolDTO.g.cs
...
namespace G
{
    ...
    /// 
    /// </summary>
    public sealed partial class CreateSlackSendMessageToolDTO
    {
        /// <summary>
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::G.JsonConverters.CreateSlackSendMessageToolDTOTypeJsonConverter))]
        public global::G.CreateSlackSendMessageToolDTOType Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSlackSendMessageToolDTO" /> class.
        /// </summary>
        /// <param name="messages">
        /// These are the messages that will be spoken to the user as the tool is running.<br/>
        /// For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.
...
#endif
        public CreateSlackSendMessageToolDTO(
            ...
            global::G.CreateSlackSendMessageToolDTOType type,
