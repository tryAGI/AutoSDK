...
{
    /// <inheritdoc />
    public sealed class ContextEngineeringPlanUserAndAssistantMessagesTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ContextEngineeringPlanUserAndAssistantMessagesType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ContextEngineeringPlanUserAndAssistantMessagesTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
