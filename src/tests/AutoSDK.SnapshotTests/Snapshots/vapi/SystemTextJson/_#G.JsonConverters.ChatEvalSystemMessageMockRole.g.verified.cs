...
{
    /// <inheritdoc />
    public sealed class ChatEvalSystemMessageMockRoleJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ChatEvalSystemMessageMockRole>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::G.ChatEvalSystemMessageMockRoleExtensions.ToValueString(value));
        }
    }
}
