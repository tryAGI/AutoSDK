//HintName: OneOf7JsonConverter.g.cs
#nullable enable

namespace OpenApiGenerator.JsonConverters
{
    public class OneOfConverterSystemTextJson<T1, T2, T3, T4, T5, T6, T7> : global::System.Text.Json.Serialization.JsonConverter<global::System.OneOf<T1, T2, T3, T4, T5, T6, T7>>
    {
        public override global::System.OneOf<T1, T2, T3, T4, T5, T6, T7> Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var result = new global::System.OneOf<T1, T2, T3, T4, T5, T6, T7>(
                value1,
            ...
            if (!result.Validate())
            {
                throw new global::System.Text.Json.JsonException($"Invalid JSON format for OneOf<{typeof(T1).Name}, {typeof(T2).Name}, {typeof(T3).Name}, {typeof(T4).Name}, {typeof(T5).Name}, {typeof(T6).Name}, {typeof(T7).Name}>");
            }
        ...
        public override void Write(
            ...
            global::System.OneOf<T1, T2, T3, T4, T5, T6, T7> value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            if (!value.Validate())
            {
                throw new global::System.Text.Json.JsonException($"Invalid OneOf<{typeof(T1).Name}, {typeof(T2).Name}, {typeof(T3).Name}, {typeof(T4).Name}, {typeof(T5).Name}, {typeof(T6).Name}, {typeof(T7).Name}> object.");
            }
