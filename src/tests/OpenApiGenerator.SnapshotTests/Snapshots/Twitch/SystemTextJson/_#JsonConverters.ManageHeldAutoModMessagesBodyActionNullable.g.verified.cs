...
namespace OpenApiGenerator.JsonConverters
{
    ...
    public sealed class ManageHeldAutoModMessagesBodyActionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::G.ManageHeldAutoModMessagesBodyAction?>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            switch (reader.TokenType)
            {
                case global::System.Text.Json.JsonTokenType.String:
                {
                    ...
                    if (stringValue != null)
                    {
                        return global::G.ManageHeldAutoModMessagesBodyActionExtensions.ToEnum(stringValue);
                    }
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::G.ManageHeldAutoModMessagesBodyActionExtensions.ToValueString(value.Value));
            }
        }
    }
}
