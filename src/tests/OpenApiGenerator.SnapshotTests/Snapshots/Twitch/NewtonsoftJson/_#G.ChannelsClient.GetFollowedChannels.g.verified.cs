    ...
    public partial class ChannelsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.GetLeftPart(global::System.UriPartial.Authority) + $"/channels/followed?user_id={userId}&broadcaster_id={broadcasterId}&first={first}&after={after}", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::Newtonsoft.Json.JsonConvert.DeserializeObject<global::G.GetFollowedChannelsResponse?>(__content, _jsonSerializerOptions) ??
