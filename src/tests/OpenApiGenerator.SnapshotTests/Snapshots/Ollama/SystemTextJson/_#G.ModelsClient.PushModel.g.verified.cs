    ...
    public partial class ModelsClient
    {
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.GetLeftPart(global::System.UriPartial.Authority) + "/push", global::System.UriKind.RelativeOrAbsolute));
            ...
            while (!reader.EndOfStream && !cancellationToken.IsCancellationRequested)
            {
                ...
                var streamedResponse = global::System.Text.Json.JsonSerializer.Deserialize<global::G.PushModelResponse?>(__content, _jsonSerializerOptions) ??
