    ...
    public partial class UserClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.GetLeftPart(global::System.UriPartial.Authority) + $"/api/v1/user/validate2factor?username={username}&connectionKey={connectionKey}&encryptedAuthToken={encryptedAuthToken}", global::System.UriKind.RelativeOrAbsolute));
