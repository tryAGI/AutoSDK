...
namespace G
{
    public partial class SecurityClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: _httpClient);
            PrepareSecurityGetProjectGroupLinksArguments(
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareSecurityGetProjectGroupLinksRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessSecurityGetProjectGroupLinksResponse(
                httpClient: _httpClient,
            ...
            ProcessSecurityGetProjectGroupLinksResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
