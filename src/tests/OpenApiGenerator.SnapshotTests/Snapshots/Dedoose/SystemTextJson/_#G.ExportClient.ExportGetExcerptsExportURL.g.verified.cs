...
namespace G
{
    public partial class ExportClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: _httpClient);
            PrepareExportGetExcerptsExportURLArguments(
            ...
            PrepareRequest(
                client: _httpClient,
                request: httpRequest);
            PrepareExportGetExcerptsExportURLRequest(
                httpClient: _httpClient,
            ...
            ProcessResponse(
                client: _httpClient,
                response: response);
            ProcessExportGetExcerptsExportURLResponse(
                httpClient: _httpClient,
            ...
            ProcessExportGetExcerptsExportURLResponseContent(
                httpClient: _httpClient,
                httpResponseMessage: response,
                content: ref __content);
