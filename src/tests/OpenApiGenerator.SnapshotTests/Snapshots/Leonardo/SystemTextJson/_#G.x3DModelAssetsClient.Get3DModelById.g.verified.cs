    ...
    public partial class x3DModelAssetsClient
    {
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var httpRequest = new global::System.Net.Http.HttpRequestMessage(
                ...
                requestUri: new global::System.Uri(_httpClient.BaseAddress?.AbsoluteUri.TrimEnd('/') + $"/models-3d/{id}?offset={offset}&limit={limit}", global::System.UriKind.RelativeOrAbsolute));
            ...
            return
                global::System.Text.Json.JsonSerializer.Deserialize<global::G.Get3DModelByIdResponse?>(__content, _jsonSerializerOptions) ??
