...
namespace G
{
    ...
    public sealed partial class WebhookPersonalAccessTokenRequestDenied
    {
        ...
        public WebhookPersonalAccessTokenRequestDeniedAction Action { get; set; } = default!;
        ...
        public PersonalAccessTokenRequest PersonalAccessTokenRequest { get; set; } = default!;
