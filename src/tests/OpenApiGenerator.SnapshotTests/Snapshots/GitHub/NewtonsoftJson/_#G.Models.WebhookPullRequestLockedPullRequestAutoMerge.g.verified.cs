...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestLockedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestLockedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestLockedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
