...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewCommentDeletedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestReviewCommentDeletedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
