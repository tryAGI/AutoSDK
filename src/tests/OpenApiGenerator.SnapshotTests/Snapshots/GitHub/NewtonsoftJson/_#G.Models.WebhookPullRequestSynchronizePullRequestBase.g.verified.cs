...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestSynchronizePullRequestBase
    {
        ...
        public WebhookPullRequestSynchronizePullRequestBaseRepo Repo { get; set; } = default!;
        ...
        public WebhookPullRequestSynchronizePullRequestBaseUser? User { get; set; } = default!;
