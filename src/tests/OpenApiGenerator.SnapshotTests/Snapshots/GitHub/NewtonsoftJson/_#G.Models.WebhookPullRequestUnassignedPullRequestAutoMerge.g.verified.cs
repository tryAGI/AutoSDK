...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestUnassignedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestUnassignedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestUnassignedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
