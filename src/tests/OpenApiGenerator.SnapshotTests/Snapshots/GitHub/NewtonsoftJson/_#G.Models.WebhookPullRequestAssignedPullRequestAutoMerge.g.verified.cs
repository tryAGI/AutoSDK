...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestAssignedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestAssignedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestAssignedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
