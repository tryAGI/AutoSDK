...
namespace G
{
    ...
    public sealed partial class WebhookSponsorshipPendingTierChange
    {
        ...
        public WebhookSponsorshipPendingTierChangeAction Action { get; set; } = default!;

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("changes", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhooksChanges8 Changes { get; set; } = default!;
        ...
        public WebhooksSponsorship Sponsorship { get; set; } = default!;
