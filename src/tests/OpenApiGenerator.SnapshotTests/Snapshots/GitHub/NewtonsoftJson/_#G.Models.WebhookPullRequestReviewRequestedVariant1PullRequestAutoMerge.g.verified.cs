...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewRequestedVariant1PullRequestAutoMerge
    {
        ...
        public global::G.WebhookPullRequestReviewRequestedVariant1PullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public global::G.WebhookPullRequestReviewRequestedVariant1PullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
