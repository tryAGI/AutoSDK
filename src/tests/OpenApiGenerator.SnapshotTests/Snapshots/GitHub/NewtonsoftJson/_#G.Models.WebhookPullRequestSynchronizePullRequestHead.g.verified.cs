...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestSynchronizePullRequestHead
    {
        ...
        public WebhookPullRequestSynchronizePullRequestHeadRepo Repo { get; set; } = default!;
        ...
        public WebhookPullRequestSynchronizePullRequestHeadUser? User { get; set; } = default!;
