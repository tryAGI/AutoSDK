...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestAssigned
    {
        ...
        public WebhookPullRequestAssignedAction Action { get; set; } = default!;

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("assignee", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhooksUser? Assignee { get; set; } = default!;
        ...
        public WebhookPullRequestAssignedPullRequest PullRequest { get; set; } = default!;
