...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewSubmittedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestReviewSubmittedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestReviewSubmittedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
