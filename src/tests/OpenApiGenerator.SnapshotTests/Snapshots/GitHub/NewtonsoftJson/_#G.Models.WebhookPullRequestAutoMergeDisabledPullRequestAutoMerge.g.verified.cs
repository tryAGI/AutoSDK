...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestAutoMergeDisabledPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestAutoMergeDisabledPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestAutoMergeDisabledPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
