...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewThreadResolvedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestReviewThreadResolvedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
