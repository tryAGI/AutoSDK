...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestAutoMergeEnabledPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestAutoMergeEnabledPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
