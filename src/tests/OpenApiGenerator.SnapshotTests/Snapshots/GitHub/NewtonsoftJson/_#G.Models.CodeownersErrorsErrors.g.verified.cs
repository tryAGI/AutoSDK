...
namespace G
{
    ...
    public sealed partial class CodeownersErrorsErrors
    {
        ...
        /// <br/>Example: The pattern `/` will never match anything, did you mean `*` instead?
        /// </summary>
        ...
        /// <br/>Example: Invalid owner on line 7:
        ///   * user
        ///     ^
        /// </summary>
