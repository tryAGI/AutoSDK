...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewEditedPullRequestBase
    {
        ...
        public WebhookPullRequestReviewEditedPullRequestBaseRepo Repo { get; set; } = default!;
        ...
        public WebhookPullRequestReviewEditedPullRequestBaseUser? User { get; set; } = default!;
