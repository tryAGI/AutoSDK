...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestUnlockedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestUnlockedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestUnlockedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
