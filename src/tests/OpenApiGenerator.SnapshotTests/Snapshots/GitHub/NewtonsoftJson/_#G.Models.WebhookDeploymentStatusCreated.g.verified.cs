...
namespace G
{
    ...
    public sealed partial class WebhookDeploymentStatusCreated
    {
        ...
        public WebhookDeploymentStatusCreatedAction Action { get; set; } = default!;

        /// <summary>
        /// 
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("check_run")]
        ...
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("deployment", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookDeploymentStatusCreatedDeployment Deployment { get; set; } = default!;

        /// <summary>
        /// The [deployment status](https://docs.github.com/rest/deployments/statuses#list-deployment-statuses).
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("deployment_status", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookDeploymentStatusCreatedDeploymentStatus DeploymentStatus { get; set; } = default!;
