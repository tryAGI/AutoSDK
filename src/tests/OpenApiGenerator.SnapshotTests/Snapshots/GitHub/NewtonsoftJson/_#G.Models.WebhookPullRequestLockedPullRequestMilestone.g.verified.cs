...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestLockedPullRequestMilestone
    {
        ...
        public WebhookPullRequestLockedPullRequestMilestoneCreator? Creator { get; set; } = default!;
        ...
        public WebhookPullRequestLockedPullRequestMilestoneState State { get; set; } = default!;
