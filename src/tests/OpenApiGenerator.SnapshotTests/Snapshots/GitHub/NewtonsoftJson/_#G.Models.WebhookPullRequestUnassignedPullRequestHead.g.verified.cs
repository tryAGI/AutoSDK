...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestUnassignedPullRequestHead
    {
        ...
        public WebhookPullRequestUnassignedPullRequestHeadRepo? Repo { get; set; } = default!;
        ...
        public WebhookPullRequestUnassignedPullRequestHeadUser? User { get; set; } = default!;
