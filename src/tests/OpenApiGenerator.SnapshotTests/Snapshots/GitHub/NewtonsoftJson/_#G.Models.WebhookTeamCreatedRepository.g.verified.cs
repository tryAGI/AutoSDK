...
namespace G
{
    ...
    public sealed partial class WebhookTeamCreatedRepository
    {
        ...
        public WebhookTeamCreatedRepositoryLicense? License { get; set; } = default!;
        ...
        public WebhookTeamCreatedRepositoryOwner? Owner { get; set; } = default!;
        ...
        public WebhookTeamCreatedRepositoryVisibility Visibility { get; set; } = default!;
