...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewCommentEditedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestReviewCommentEditedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestReviewCommentEditedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
