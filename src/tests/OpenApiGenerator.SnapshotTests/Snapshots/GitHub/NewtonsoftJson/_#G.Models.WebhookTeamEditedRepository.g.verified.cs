...
namespace G
{
    ...
    public sealed partial class WebhookTeamEditedRepository
    {
        ...
        public WebhookTeamEditedRepositoryLicense? License { get; set; } = default!;
        ...
        public WebhookTeamEditedRepositoryOwner? Owner { get; set; } = default!;
        ...
        public WebhookTeamEditedRepositoryVisibility Visibility { get; set; } = default!;
