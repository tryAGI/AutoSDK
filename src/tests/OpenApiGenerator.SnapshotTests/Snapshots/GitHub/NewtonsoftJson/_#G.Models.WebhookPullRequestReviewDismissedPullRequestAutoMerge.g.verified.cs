...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewDismissedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestReviewDismissedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestReviewDismissedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
