...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestLabeledPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestLabeledPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestLabeledPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
