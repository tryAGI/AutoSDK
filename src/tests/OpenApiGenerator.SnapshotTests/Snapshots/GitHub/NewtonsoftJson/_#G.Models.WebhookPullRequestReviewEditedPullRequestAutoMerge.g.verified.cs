...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewEditedPullRequestAutoMerge
    {
        ...
        public WebhookPullRequestReviewEditedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public WebhookPullRequestReviewEditedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
