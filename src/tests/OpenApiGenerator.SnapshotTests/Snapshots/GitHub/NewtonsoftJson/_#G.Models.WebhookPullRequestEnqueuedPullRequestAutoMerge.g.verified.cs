...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestEnqueuedPullRequestAutoMerge
    {
        ...
        public global::G.WebhookPullRequestEnqueuedPullRequestAutoMergeEnabledBy? EnabledBy { get; set; } = default!;

        /// <summary>
        /// The merge method to use.
        /// </summary>
        [global::Newtonsoft.Json.JsonProperty("merge_method", Required = global::Newtonsoft.Json.Required.Always)]
        public global::G.WebhookPullRequestEnqueuedPullRequestAutoMergeMergeMethod MergeMethod { get; set; } = default!;
