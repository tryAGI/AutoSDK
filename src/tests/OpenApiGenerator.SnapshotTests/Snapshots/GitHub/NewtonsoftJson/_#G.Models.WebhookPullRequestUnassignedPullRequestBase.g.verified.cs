...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestUnassignedPullRequestBase
    {
        ...
        public WebhookPullRequestUnassignedPullRequestBaseRepo Repo { get; set; } = default!;
        ...
        public WebhookPullRequestUnassignedPullRequestBaseUser? User { get; set; } = default!;
