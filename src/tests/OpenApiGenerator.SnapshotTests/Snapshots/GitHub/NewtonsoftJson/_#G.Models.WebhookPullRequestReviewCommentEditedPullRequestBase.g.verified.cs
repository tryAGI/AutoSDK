...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestReviewCommentEditedPullRequestBase
    {
        ...
        public WebhookPullRequestReviewCommentEditedPullRequestBaseRepo Repo { get; set; } = default!;
        ...
        public WebhookPullRequestReviewCommentEditedPullRequestBaseUser? User { get; set; } = default!;
