...
namespace G
{
    ...
    public sealed partial class WebhookPullRequestAssignedPullRequestMilestone
    {
        ...
        public WebhookPullRequestAssignedPullRequestMilestoneCreator? Creator { get; set; } = default!;
        ...
        public WebhookPullRequestAssignedPullRequestMilestoneState State { get; set; } = default!;
